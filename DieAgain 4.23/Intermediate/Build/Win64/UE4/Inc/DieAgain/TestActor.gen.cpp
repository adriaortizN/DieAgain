...
#include "DieAgain/Public/TestActor/TestActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	DIEAGAIN_API UClass* Z_Construct_UClass_ATestActor_NoRegister();
	DIEAGAIN_API UClass* Z_Construct_UClass_ATestActor();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATestActor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "TestActor/TestActor.h" },
		{ "ModuleRelativePath", "Public/TestActor/TestActor.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ATestActor_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_ATestActor_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ATestActor_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ATestActor, 2857923722);
	template<> DIEAGAIN_API UClass* StaticClass<ATestActor>()
	{
		return ATestActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ATestActor(Z_Construct_UClass_ATestActor, &ATestActor::StaticClass, TEXT("/Script/DieAgain"), TEXT("ATestActor"), false, nullptr, nullptr, nullptr);
