...
ASniperPickUp_C__pf1651478651::ASniperPickUp_C__pf1651478651(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__WeaponSniper__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("WeaponSniper"));
	...
	bpv__WeaponSniper__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__WeaponSniper__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__WeaponSniper__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__WeaponSniper__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__WeaponSniper__pf->OverrideMaterials.Reserve(1);
	bpv__WeaponSniper__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__WeaponSniper__pf->bReceivesDecals = false;
	auto& __Local__3 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__WeaponSniper__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__3 = ECollisionEnabled::Type::PhysicsOnly;
	auto& __Local__4 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__WeaponSniper__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__13.Channel = FName(TEXT("OverlapShoot"));
	__Local__13.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__14 = __Local__5[8];
	__Local__14.Channel = FName(TEXT("GunShoot"));
	__Local__14.Response = ECollisionResponse::ECR_Ignore;
	bpv__WeaponSniper__pf->BodyInstance.bSimulatePhysics = true;
	bpv__WeaponSniper__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__15 = (*(AccessPrivateProperty<FVector >((bpv__WeaponSniper__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__15 = FVector(15.000000, -5.300044, -0.000025);
	auto& __Local__16 = (*(AccessPrivateProperty<FRotator >((bpv__WeaponSniper__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__16 = FRotator(84.999496, 270.001251, 270.001068);
	auto& __Local__17 = (*(AccessPrivateProperty<FVector >((bpv__WeaponSniper__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__17 = FVector(2.000000, 2.000000, 2.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__WeaponSniper__pf), true, 0));
	bpv__BoxCollision__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__BoxCollision__pf->AttachToComponent(bpv__WeaponSniper__pf, FAttachmentTransformRules::KeepRelativeTransform );
	...
	bpv__SniperCanon__pf->AttachToComponent(bpv__WeaponSniper__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__33 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__SniperCanon__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__33 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__SniperCanon__pf->bReceivesDecals = false;
	auto& __Local__34 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__SniperCanon__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__34 = ECollisionEnabled::Type::PhysicsOnly;
	auto& __Local__35 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__SniperCanon__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__36.AddUninitialized(9);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__36.GetData(), 9);
	auto& __Local__37 = __Local__36[0];
	__Local__37.Channel = FName(TEXT("OverlapShoot"));
	__Local__37.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__38 = __Local__36[1];
	__Local__38.Channel = FName(TEXT("GunShoot"));
	...
	bpv__SniperCanon__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__46 = (*(AccessPrivateProperty<FVector >((bpv__SniperCanon__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__46 = FVector(0.000001, 66.200043, 8.399998);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__SniperCanon__pf), true, 0));
	bpv__SniperScope__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__SniperScope__pf->AttachToComponent(bpv__WeaponSniper__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__47 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__SniperScope__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__47 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	bpv__SniperScope__pf->bReceivesDecals = false;
	auto& __Local__48 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__SniperScope__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__48 = ECollisionEnabled::Type::PhysicsOnly;
	auto& __Local__49 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__SniperScope__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	auto& __Local__50 = (*(AccessPrivateProperty<TArray<FResponseChannel> >(&(__Local__49), FCollisionResponse::__PPO__ResponseArray() )));
	__Local__50 = TArray<FResponseChannel> ();
	__Local__50.AddUninitialized(9);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__50.GetData(), 9);
	auto& __Local__51 = __Local__50[0];
	__Local__51.Channel = FName(TEXT("OverlapShoot"));
	__Local__51.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__52 = __Local__50[1];
	__Local__52.Channel = FName(TEXT("GunShoot"));
	__Local__52.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__53 = __Local__50[2];
	__Local__53.Channel = FName(TEXT("Visibility"));
	__Local__53.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__54 = __Local__50[3];
	__Local__54.Channel = FName(TEXT("Camera"));
	__Local__54.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__55 = __Local__50[4];
	__Local__55.Channel = FName(TEXT("WorldDynamic"));
	__Local__55.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__56 = __Local__50[5];
	__Local__56.Channel = FName(TEXT("PhysicsBody"));
	__Local__56.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__57 = __Local__50[6];
	__Local__57.Channel = FName(TEXT("Pawn"));
	__Local__57.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__58 = __Local__50[7];
	__Local__58.Channel = FName(TEXT("Destructible"));
	__Local__58.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__59 = __Local__50[8];
	__Local__59.Channel = FName(TEXT("Vehicle"));
	__Local__59.Response = ECollisionResponse::ECR_Overlap;
	bpv__SniperScope__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__60 = (*(AccessPrivateProperty<FVector >((bpv__SniperScope__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__60 = FVector(0.000000, 9.000006, 13.999999);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__SniperScope__pf), true, 0));
	bpv__Munition__pf = 1;
	bpv__WeaponType__pf = E__EnumWeapon__pf::NewEnumerator3;
	auto& __Local__61 = (*(AccessPrivateProperty<EActorUpdateOverlapsMethod >((this), AActor::__PPO__DefaultUpdateOverlapsMethodDuringLevelStreaming() )));
	__Local__61 = EActorUpdateOverlapsMethod::OnlyUpdateMovable;
}
PRAGMA_ENABLE_OPTIMIZATION
void ASniperPickUp_C__pf1651478651::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ASniperPickUp_C__pf1651478651::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__62 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"), (EObjectFlags)0x00000000);
	InDynamicClass->DynamicBindingObjects.Add(__Local__62);
	__Local__62->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__62->ComponentDelegateBindings.AddUninitialized(2);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__62->ComponentDelegateBindings.GetData(), 2);
	auto& __Local__63 = __Local__62->ComponentDelegateBindings[0];
	__Local__63.ComponentPropertyName = FName(TEXT("BoxCollision"));
	__Local__63.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__63.FunctionNameToBind = FName(TEXT("BndEvt__BoxCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
	auto& __Local__64 = __Local__62->ComponentDelegateBindings[1];
	__Local__64.ComponentPropertyName = FName(TEXT("BoxCollision"));
	__Local__64.DelegatePropertyName = FName(TEXT("OnComponentEndOverlap"));
	__Local__64.FunctionNameToBind = FName(TEXT("BndEvt__BoxCollision_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ASniperPickUp_C__pf1651478651::bpf__ExecuteUbergraph_SniperPickUp__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpf__SetMaterial__pf(true);
			}
		case 2:
			{
				AActor*  __Local__65 = ((AActor*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_5__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__OverlapingActor__pf) : (__Local__65)), this);
		...
		case 3:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__IsOverlapingActor__pf = false;
				}
			}
		case 4:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf))
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__OverlapingActor__pf = ((AActor*)nullptr);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 9:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf);
		...
		case 10:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_1__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->IsPlayerControlled();
				}
		...
		case 11:
			{
				if(::IsValid(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf) && ::IsValid((*(AccessPrivateProperty<APawn* >((b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf), AActor::__PPO__Instigator() )))))
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_2__pf = (*(AccessPrivateProperty<APawn* >((b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf), AActor::__PPO__Instigator() )))->IsPlayerControlled();
				}
		...
		case 12:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf);
		...
		case 13:
			{
				UBoxComponent*  __Local__66 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_1__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__BoxCollision__pf) : (__Local__66)), b0l__K2Node_ComponentBoundEvent_OtherComp_1__pf);
		...
		case 15:
			{
				...
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_4__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__OverlapingActor__pf) : (__Local__67)), this);
		...
		case 20:
			{
				b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf != nullptr);;
		...
		case 21:
			{
				UBoxComponent*  __Local__68 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__BoxCollision__pf) : (__Local__68)), b0l__K2Node_ComponentBoundEvent_OtherComp_1__pf);
		...
		case 45:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_4__pf))
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_5__pf = b0l__K2Node_DynamicCast_AsThird_Person_Character_4__pf->IsPlayerControlled();
				}
		...
		case 46:
			{
				...
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpfv__CallFunc_GetPlayerCharacter_ReturnValue_1__pf);
				b0l__K2Node_DynamicCast_bSuccess_9__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf != nullptr);;
...
void ASniperPickUp_C__pf1651478651::bpf__ExecuteUbergraph_SniperPickUp__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 23:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
		...
		case 25:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
		...
		case 26:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__IsSlave__pf) : (__Local__69)))
				{
					__CurrentState = 28;
					break;
				}
		...
		case 27:
			{
				bool  __Local__70 = false;
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__IsGodModeActive__pf) : (__Local__70)))
				{
					__CurrentState = -1;
					break;
				}
		...
		case 28:
			{
				UBoxComponent*  __Local__71 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_3__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__BoxCollision__pf) : (__Local__71)), b0l__K2Node_ComponentBoundEvent_OtherComp__pf);
		...
		case 29:
			{
				AActor*  __Local__72 = ((AActor*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__OverlapingActor__pf) : (__Local__72)));
		...
		case 30:
			{
				b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
		...
		case 31:
			{
				UBoxComponent*  __Local__73 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_2__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__BoxCollision__pf) : (__Local__73)), b0l__K2Node_ComponentBoundEvent_OtherComp__pf);
		...
		case 32:
			{
				AActor*  __Local__74 = ((AActor*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__OverlapingActor__pf) : (__Local__74)));
		...
		case 36:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_4__pf = (b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf != nullptr);;
		...
		case 37:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_3__pf = b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf->IsPlayerControlled();
				}
...
void ASniperPickUp_C__pf1651478651::bpf__ExecuteUbergraph_SniperPickUp__pf_2(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_SetStaticMesh_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 41);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__WeaponSniper__pf))
	{
		bpfv__CallFunc_SetStaticMesh_ReturnValue__pf = bpv__WeaponSniper__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
	}
	bpf__SetMaterial__pf(true);
	// optimized KCST_UnconditionalGoto
	bpv__Munition__pf = 1;
...
void ASniperPickUp_C__pf1651478651::bpf__CleanPickUp__pf()
{
	bpf__ExecuteUbergraph_SniperPickUp__pf_0(42);
}
void ASniperPickUp_C__pf1651478651::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_SniperPickUp__pf_2(41);
}
void ASniperPickUp_C__pf1651478651::bpf__BndEvt__BoxCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	typedef FHitResult  T__Local__75;
	T__Local__75& bpp__SweepResult__pf = *const_cast<T__Local__75 *>(&bpp__SweepResult__pf__const);
	...
	bpf__ExecuteUbergraph_SniperPickUp__pf_1(40);
}
void ASniperPickUp_C__pf1651478651::bpf__BndEvt__BoxCollision_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
	...
	bpf__ExecuteUbergraph_SniperPickUp__pf_0(8);
}
void ASniperPickUp_C__pf1651478651::bpf__Construction__pf(E__EnumWeapon__pf bpp__NewParam__pf)
{
		...
		case 2:
			{
				if(::IsValid(bpv__WeaponSniper__pf))
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue__pf = bpv__WeaponSniper__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed));
				}
			}
		case 3:
			{
				if(::IsValid(bpv__WeaponSniper__pf))
				{
					bpv__WeaponSniper__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed));
				}
			}
		case 4:
			{
		...
		case 5:
			{
				if(::IsValid(bpv__WeaponSniper__pf))
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue_1__pf = bpv__WeaponSniper__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed));
				}
			}
		case 6:
			{
				if(::IsValid(bpv__WeaponSniper__pf))
				{
					bpv__WeaponSniper__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed));
				}
			}
		case 7:
			{
...
void ASniperPickUp_C__pf1651478651::bpf__SetMaterial__pf(bool bpp__SetDefaultMaterial__pf)
{
	int32 __CurrentState = 1;
	do
	{
		...
		case 1:
			{
				if (!bpp__SetDefaultMaterial__pf)
				{
					__CurrentState = 7;
					break;
				}
		...
		case 2:
			{
				if(::IsValid(bpv__WeaponSniper__pf))
				{
					bpv__WeaponSniper__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
			}
		case 3:
			{
				if(::IsValid(bpv__WeaponSniper__pf))
				{
					bpv__WeaponSniper__pf->SetMaterial(1, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed));
				}
			}
		case 4:
			{
				if(::IsValid(bpv__WeaponSniper__pf))
				{
					bpv__WeaponSniper__pf->SetMaterial(2, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed));
				}
			}
		case 5:
			{
				...
				{
					bpv__SniperCanon__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed));
				}
			}
		case 6:
			{
				...
				{
					bpv__SniperScope__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 7:
			{
				if(::IsValid(bpv__WeaponSniper__pf))
				{
					bpv__WeaponSniper__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed));
				}
			}
		case 8:
			{
				if(::IsValid(bpv__WeaponSniper__pf))
				{
					bpv__WeaponSniper__pf->SetMaterial(1, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed));
				}
			}
		case 9:
			{
				if(::IsValid(bpv__WeaponSniper__pf))
				{
					bpv__WeaponSniper__pf->SetMaterial(2, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed));
				}
			}
		case 10:
			{
				if(::IsValid(bpv__SniperCanon__pf))
				{
					bpv__SniperCanon__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed));
				}
			}
		case 11:
			{
				if(::IsValid(bpv__SniperScope__pf))
				{
					bpv__SniperScope__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASniperPickUp_C__pf1651478651::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
...
void ASniperPickUp_C__pf1651478651::bpf__OverlapClean__pf(AActor* bpp__OldOverlapActor__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_DynamicCast_AsRifle_Pick_Up__pf = Cast<ARiflePickUp_C__pf1651478651>(bpp__OldOverlapActor__pf);
		...
		case 3:
			{
				bpfv__K2Node_DynamicCast_AsShotgun_Pick_Up__pf = Cast<AShotgunPickUp_C__pf1651478651>(bpp__OldOverlapActor__pf);
		...
		case 5:
			{
				bpfv__K2Node_DynamicCast_AsKnife_Pick_Up__pf = Cast<AKnifePickUp_C__pf1651478651>(bpp__OldOverlapActor__pf);
		...
		case 7:
			{
				bpfv__K2Node_DynamicCast_AsSniper_Pick_Up__pf = Cast<ASniperPickUp_C__pf1651478651>(bpp__OldOverlapActor__pf);
		...
		case 9:
			{
				bpfv__K2Node_DynamicCast_AsRPGPick_Up__pf = Cast<ARPGPickUp_C__pf1651478651>(bpp__OldOverlapActor__pf);
		...
		case 11:
			{
				bpfv__K2Node_DynamicCast_AsAShotgun_Pick_Up__pf = Cast<AAShotgunPickUp_C__pf1651478651>(bpp__OldOverlapActor__pf);
...
PRAGMA_DISABLE_OPTIMIZATION
void ASniperPickUp_C__pf1651478651::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ASniperPickUp_C__pf1651478651::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ASniperPickUp_C__pf1651478651
{
	FRegisterHelper__ASniperPickUp_C__pf1651478651()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/PickUps/SniperPickUp"), &ASniperPickUp_C__pf1651478651::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ASniperPickUp_C__pf1651478651 Instance;
};
FRegisterHelper__ASniperPickUp_C__pf1651478651 FRegisterHelper__ASniperPickUp_C__pf1651478651::Instance;
