...
UControlsGamepadHUD_C__pf3479267681::UControlsGamepadHUD_C__pf3479267681(const FObjectInitializer& ObjectInitializer) : Super()
{
...
void UControlsGamepadHUD_C__pf3479267681::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UControlsGamepadHUD_C__pf3479267681::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__2.ComponentPropertyName = FName(TEXT("Button_66"));
	...
	__Local__5->LayoutData.Offsets.Left = -1127.794434f;
	__Local__5->LayoutData.Offsets.Top = -670.225769f;
	__Local__5->LayoutData.Offsets.Right = 2271.462646f;
	__Local__5->LayoutData.Offsets.Bottom = 1347.823486f;
	...
	auto __Local__6 = NewObject<UImage>(__Local__1, TEXT("Image_45"), (EObjectFlags)0x00280008);
	auto& __Local__7 = (*(AccessPrivateProperty<UObject* >(&(__Local__6->Brush), FSlateBrush::__PPO__ResourceObject() )));
	__Local__7 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__6->Slot = __Local__5;
	__Local__5->Content = __Local__6;
	__Local__4.Add(__Local__5);
	auto __Local__8 = NewObject<UCanvasPanelSlot>(__Local__3, TEXT("CanvasPanelSlot_2"), (EObjectFlags)0x00280008);
	__Local__8->LayoutData.Offsets.Left = -960.000000f;
	__Local__8->LayoutData.Offsets.Top = -540.000000f;
	__Local__8->LayoutData.Offsets.Right = 1920.000000f;
	__Local__8->LayoutData.Offsets.Bottom = 1080.000000f;
	...
	auto __Local__9 = NewObject<UImage>(__Local__1, TEXT("Image_116"), (EObjectFlags)0x00280008);
	__Local__9->Brush.ImageSize = FVector2D(1920.000000, 1080.000000);
	auto& __Local__10 = (*(AccessPrivateProperty<UObject* >(&(__Local__9->Brush), FSlateBrush::__PPO__ResourceObject() )));
	__Local__10 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__9->Slot = __Local__8;
	__Local__8->Content = __Local__9;
	__Local__4.Add(__Local__8);
	auto __Local__11 = NewObject<UCanvasPanelSlot>(__Local__3, TEXT("CanvasPanelSlot_4"), (EObjectFlags)0x00280008);
	__Local__11->LayoutData.Offsets.Left = -168.960938f;
	__Local__11->LayoutData.Offsets.Top = 40.000000f;
	__Local__11->LayoutData.Offsets.Right = 325.631195f;
	__Local__11->LayoutData.Offsets.Bottom = 111.142258f;
	...
	auto __Local__12 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_37"), (EObjectFlags)0x00280008);
	__Local__12->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[A82788494F51A600C0A2E98BCD3D8A8E]\", \"3BF6C2634DD1B2FB37C0FE919EBF0187\", \"Controls\")")	);
	__Local__12->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__12->Font.OutlineSettings.OutlineSize = 5;
	__Local__12->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__12->Font.Size = 60;
	...
	auto __Local__14 = NewObject<UCanvasPanelSlot>(__Local__3, TEXT("CanvasPanelSlot_8"), (EObjectFlags)0x00280008);
	__Local__14->LayoutData.Offsets.Left = -236.960938f;
	__Local__14->LayoutData.Offsets.Top = -173.081055f;
	__Local__14->LayoutData.Offsets.Right = 480.380371f;
	__Local__14->LayoutData.Offsets.Bottom = 96.733398f;
	...
	__Local__14->Parent = __Local__3;
	auto __Local__15 = NewObject<UButton>(__Local__1, TEXT("Button_66"), (EObjectFlags)0x00280008);
	...
	__Local__17 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	...
	__Local__18 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	...
	__Local__19 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	...
	auto __Local__22 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_156"), (EObjectFlags)0x00280008);
	__Local__22->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[A82788494F51A600C0A2E98BCD3D8A8E]\", \"951B37C6431EFD04252461875540D893\", \"Go  back\")")	);
	auto& __Local__23 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__22->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__23 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__22->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	auto __Local__24 = NewObject<UWidgetNavigation>(__Local__22, TEXT("WidgetNavigation_0"), (EObjectFlags)0x00280008);
	__Local__24->Up.Rule = EUINavigationRule::Stop;
	__Local__24->Down.Rule = EUINavigationRule::Stop;
	__Local__22->Navigation = __Local__24;
	...
	__Local__25->Down.Rule = EUINavigationRule::Stop;
	__Local__15->Navigation = __Local__25;
	__Local__14->Content = __Local__15;
	__Local__4.Add(__Local__14);
	__Local__1->RootWidget = __Local__3;
}
PRAGMA_ENABLE_OPTIMIZATION
void UControlsGamepadHUD_C__pf3479267681::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__26;
	SlotNames.Append(__Local__26);
}
void UControlsGamepadHUD_C__pf3479267681::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__27;
	TArray<FDelegateRuntimeBinding>  __Local__28;
	__Local__28.AddUninitialized(1);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__28.GetData(), 1);
	auto& __Local__29 = __Local__28[0];
	__Local__29.ObjectName = FString(TEXT("Image_116"));
	__Local__29.PropertyName = FName(TEXT("Brush"));
	__Local__29.FunctionName = FName(TEXT("GetBrush_0"));
	...
	__Local__31.Name = FName(TEXT("GetBrush_0"));
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->MiscConvertedSubobjects[0]), __Local__27, __Local__28);
}
void UControlsGamepadHUD_C__pf3479267681::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UControlsGamepadHUD_C__pf3479267681::bpf__ExecuteUbergraph_ControlsGamepadHUD__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 12);
	// optimized KCST_UnconditionalGoto
	b1l__K2Node_MakeArray_Array__pf.SetNum(1, true);
	b1l__K2Node_MakeArray_Array__pf[0] = bpv__Button_66__pf;
	bpv__Buttons__pf = b1l__K2Node_MakeArray_Array__pf;
	// optimized KCST_UnconditionalGoto
	Super::bpf__Construct__pf();
	return; // KCST_GotoReturn
}
void UControlsGamepadHUD_C__pf3479267681::bpf__ExecuteUbergraph_ControlsGamepadHUD__pf_1(int32 bpp__EntryPoint__pf)
{
	UPreControlsHUD_C__pf3479267681* bpfv__CallFunc_Create_ReturnValue__pf{};
	AGameModeBase* bpfv__CallFunc_GetGameMode_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	RemoveFromParent();
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UPreControlsHUD_C__pf3479267681>(UWidgetBlueprintLibrary::Create(this, UPreControlsHUD_C__pf3479267681::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	...
	{
		b1l__K2Node_DynamicCast_AsDie_Again_Gamemode__pf->bpf__ResetWidget__pf(bpfv__CallFunc_Create_ReturnValue__pf);
	}
...
void UControlsGamepadHUD_C__pf3479267681::bpf__ExecuteUbergraph_ControlsGamepadHUD__pf_2(int32 bpp__EntryPoint__pf)
{
...
void UControlsGamepadHUD_C__pf3479267681::bpf__BndEvt__Button_66_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_ControlsGamepadHUD__pf_1(1);
}
void UControlsGamepadHUD_C__pf3479267681::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_ControlsGamepadHUD__pf_2(10);
}
void UControlsGamepadHUD_C__pf3479267681::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_ControlsGamepadHUD__pf_0(12);
}
void UControlsGamepadHUD_C__pf3479267681::bpf__GetText_0__pf()
{
	FText bpfv__TextGoBack__pf{};
}
void UControlsGamepadHUD_C__pf3479267681::bpf__GetText_1__pf()
{
	FText bpfv__TextControls__pf{};
}
FSlateBrush  UControlsGamepadHUD_C__pf3479267681::bpf__GetBrush_0__pf()
{
	...
	do
	{
		...
		case 1:
			{
				const UScriptStruct* __Local__33 = FSlateBrush::StaticStruct();
				uint8* __Local__34 = (uint8*)FMemory_Alloca(__Local__33->GetStructureSize());
				__Local__33->InitializeStruct(__Local__34);
				FSlateBrush& __Local__32 = *reinterpret_cast<FSlateBrush*>(__Local__34);
				__Local__32.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__35 = (*(AccessPrivateProperty<UObject* >(&(__Local__32), FSlateBrush::__PPO__ResourceObject() )));
				__Local__35 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
				bpfv__ControlsImage__pf = __Local__32;
			}
		case 2:
			{
				...
				__Local__39 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
				bpfv__ControlsEnglish__pf = __Local__36;
			}
		case 3:
			{
				...
				__Local__43 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
				bpfv__ControlsIta__pf = __Local__40;
			}
		case 4:
			{
				...
				__Local__47 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
				bpfv__ControlsEs__pf = __Local__44;
			}
		case 5:
			{
				...
				__Local__51 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
				bpfv__ControlsPt__pf = __Local__48;
			}
		case 6:
			{
				...
				__Local__55 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
				bpfv__ControlsRu__pf = __Local__52;
			}
		case 7:
			{
				...
				__Local__59 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed);
				bpfv__ControlsZh__pf = __Local__56;
			}
		case 8:
			{
				...
				__Local__63 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsGamepadHUD_C__pf3479267681::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed);
				bpfv__ControlsCa__pf = __Local__60;
			}
		case 9:
			{
...
PRAGMA_DISABLE_OPTIMIZATION
void UControlsGamepadHUD_C__pf3479267681::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UControlsGamepadHUD_C__pf3479267681::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UControlsGamepadHUD_C__pf3479267681
{
	FRegisterHelper__UControlsGamepadHUD_C__pf3479267681()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/ControlsWB/ControlsGamepadHUD"), &UControlsGamepadHUD_C__pf3479267681::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UControlsGamepadHUD_C__pf3479267681 Instance;
};
FRegisterHelper__UControlsGamepadHUD_C__pf3479267681 FRegisterHelper__UControlsGamepadHUD_C__pf3479267681::Instance;
