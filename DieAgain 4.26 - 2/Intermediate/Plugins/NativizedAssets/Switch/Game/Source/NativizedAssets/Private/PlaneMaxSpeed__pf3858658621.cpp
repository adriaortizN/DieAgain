...
#include "PlaneMaxSpeed__pf3858658621.h"
...
APlaneMaxSpeed_C__pf3858658621::APlaneMaxSpeed_C__pf3858658621(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void APlaneMaxSpeed_C__pf3858658621::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APlaneMaxSpeed_C__pf3858658621::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(APlaneCharacter_C__pf3858658621::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
void APlaneMaxSpeed_C__pf3858658621::bpf__ExecuteUbergraph_PlaneMaxSpeed__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 8:
			{
				...
				b0l__K2Node_DynamicCast_AsChameleon_1__pf = Cast<AChameleon_C__pf565858488>(b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsChameleon_1__pf != nullptr);;
		...
		case 9:
			{
				bpv__ChameleonRef__pf = b0l__K2Node_DynamicCast_AsChameleon_1__pf;
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 10:
		...
		case 19:
			{
				...
				UGameplayStatics::GetAllActorsOfClass(this, AChameleon_C__pf565858488::StaticClass(), /*out*/ TArrayCaster<AChameleon_C__pf565858488*>(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
			}
		case 20:
			{
...
void APlaneMaxSpeed_C__pf3858658621::bpf__ExecuteUbergraph_PlaneMaxSpeed__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				b0l__K2Node_DynamicCast_AsChameleon__pf = Cast<AChameleon_C__pf565858488>(bpv__ChameleonRef__pf);
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsChameleon__pf != nullptr);;
		...
		case 2:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsChameleon__pf))
				{
					b0l__K2Node_DynamicCast_AsChameleon__pf->bpv__SpeedxLinesxIntensity__pfTT = 5.000000;
				}
			}
		case 3:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsChameleon__pf))
				{
					b0l__K2Node_DynamicCast_AsChameleon__pf->bpv__SpeedxLinesxSpeed__pfTT = 25.000000;
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 22:
			{
				b0l__K2Node_DynamicCast_AsPlane_Character__pf = Cast<APlaneCharacter_C__pf3858658621>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsPlane_Character__pf != nullptr);;
		...
		case 23:
			{
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(b0l__K2Node_DynamicCast_AsPlane_Character__pf);
...
void APlaneMaxSpeed_C__pf3858658621::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_PlaneMaxSpeed__pf_1(21);
}
void APlaneMaxSpeed_C__pf3858658621::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_PlaneMaxSpeed__pf_0(18);
}
PRAGMA_DISABLE_OPTIMIZATION
void APlaneMaxSpeed_C__pf3858658621::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APlaneMaxSpeed_C__pf3858658621::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{1033, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Objects/PlaneControlled/PlaneCharacter.PlaneCharacter_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APlaneMaxSpeed_C__pf3858658621
{
	FRegisterHelper__APlaneMaxSpeed_C__pf3858658621()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/PlaneControlled/PlaneMaxSpeed"), &APlaneMaxSpeed_C__pf3858658621::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APlaneMaxSpeed_C__pf3858658621 Instance;
};
FRegisterHelper__APlaneMaxSpeed_C__pf3858658621 FRegisterHelper__APlaneMaxSpeed_C__pf3858658621::Instance;
