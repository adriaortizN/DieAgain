...
#include "DeadlyFire__pf3601650849.h"
...
ADeadlyFire_C__pf3601650849::ADeadlyFire_C__pf3601650849(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__ParticleSystem1__pf = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("ParticleSystem1"));
	bpv__ParticleSystem2__pf = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("ParticleSystem2"));
	bpv__ParticleSystem3__pf = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("ParticleSystem3"));
	...
	auto& __Local__2 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__2 = FVector(0.000000, 0.000000, 60.000000);
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__3 = FVector(2.500000, 11.000000, 2.250000);
	...
	bpv__ParticleSystem__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__ParticleSystem__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ADeadlyFire_C__pf3601650849::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__ParticleSystem__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__4 = FVector(0.000000, 87.500000, 0.000000);
	...
	auto& __Local__5 = (*(AccessPrivateProperty<FVector >((bpv__Arrow__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__5 = FVector(85.000000, 0.000000, 0.000000);
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__Arrow__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__6 = FVector(5.000000, 5.000000, 5.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Arrow__pf), false, 0));
	bpv__ParticleSystem1__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ParticleSystem1__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__ParticleSystem1__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ADeadlyFire_C__pf3601650849::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__ParticleSystem1__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__7 = FVector(0.000000, 262.500000, 0.000000);
	bpv__ParticleSystem1__pf->PrimaryComponentTick.bStartWithTickEnabled = false;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__ParticleSystem1__pf), false, 0));
	bpv__ParticleSystem2__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ParticleSystem2__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__ParticleSystem2__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ADeadlyFire_C__pf3601650849::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__8 = (*(AccessPrivateProperty<FVector >((bpv__ParticleSystem2__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__8 = FVector(0.000000, -87.500000, 0.000000);
	bpv__ParticleSystem2__pf->PrimaryComponentTick.bStartWithTickEnabled = false;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__ParticleSystem2__pf), false, 0));
	bpv__ParticleSystem3__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ParticleSystem3__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__ParticleSystem3__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ADeadlyFire_C__pf3601650849::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__9 = (*(AccessPrivateProperty<FVector >((bpv__ParticleSystem3__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__9 = FVector(0.000000, -262.500000, 0.000000);
	bpv__ParticleSystem3__pf->PrimaryComponentTick.bStartWithTickEnabled = false;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__ParticleSystem3__pf), false, 0));
...
void ADeadlyFire_C__pf3601650849::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__ParticleSystem1__pf)
	{
		bpv__ParticleSystem1__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__ParticleSystem2__pf)
	{
		bpv__ParticleSystem2__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__ParticleSystem3__pf)
	{
		bpv__ParticleSystem3__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ADeadlyFire_C__pf3601650849::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__12.ComponentPropertyName = FName(TEXT("Box"));
	__Local__12.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__12.FunctionNameToBind = FName(TEXT("BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ADeadlyFire_C__pf3601650849::bpf__ExecuteUbergraph_DeadlyFire__pf_0(int32 bpp__EntryPoint__pf)
{
		...
		case 3:
			{
				...
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->AActor::K2_GetActorLocation();
				}
				if(::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf))
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpf__TakeDamage__pf(100, FName(TEXT("None")), bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf, ((AActor*)nullptr));
				}
				__CurrentState = -1;
				break;
			}
		...
		case 5:
			{
				...
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->AActor::K2_GetActorLocation();
				}
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf))
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpf__TakeDamage__pf(100, bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, ((AActor*)nullptr));
				}
				__CurrentState = -1;
				break;
			}
...
void ADeadlyFire_C__pf3601650849::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_DeadlyFire__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ADeadlyFire_C__pf3601650849::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{1016, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ParticleSystem /Game/M5VFXVOL2/Particles/Fire/Fire_02_Low.Fire_02_Low 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ADeadlyFire_C__pf3601650849::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ADeadlyFire_C__pf3601650849
{
	FRegisterHelper__ADeadlyFire_C__pf3601650849()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/Fire/DeadlyFire"), &ADeadlyFire_C__pf3601650849::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ADeadlyFire_C__pf3601650849 Instance;
};
FRegisterHelper__ADeadlyFire_C__pf3601650849 FRegisterHelper__ADeadlyFire_C__pf3601650849::Instance;
