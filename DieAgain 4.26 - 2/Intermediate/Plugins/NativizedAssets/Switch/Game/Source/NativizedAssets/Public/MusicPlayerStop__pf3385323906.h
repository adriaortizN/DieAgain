...
#include "MusicPlayerStop__pf3385323906.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Objects/LV11/MusicPlayerStop.MusicPlayerStop_C", OverrideNativeName="MusicPlayerStop_C"))
class AMusicPlayerStop_C__pf3385323906 : public AActor
{
public:
	GENERATED_BODY()
	...
	AMusicPlayerStop_C__pf3385323906(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_MusicPlayerStop__pf_0(int32 bpp__EntryPoint__pf);
