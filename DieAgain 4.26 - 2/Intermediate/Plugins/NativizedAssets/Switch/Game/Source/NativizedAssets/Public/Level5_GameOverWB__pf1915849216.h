...
class UButton;
#include "Level5_GameOverWB__pf1915849216.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/HUD/Level5_GameOver/Level5_GameOverWB.Level5_GameOverWB_C", OverrideNativeName="Level5_GameOverWB_C"))
class ULevel5_GameOverWB_C__pf1915849216 : public UGamepadInteraction_C__pf197907997
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_99", Category="Level5_GameOverWB", OverrideNativeName="Button_99"))
	...
	ULevel5_GameOverWB_C__pf1915849216(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Level5_GameOverWB__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Level5_GameOverWB__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Level5_GameOverWB__pf_2(int32 bpp__EntryPoint__pf);
