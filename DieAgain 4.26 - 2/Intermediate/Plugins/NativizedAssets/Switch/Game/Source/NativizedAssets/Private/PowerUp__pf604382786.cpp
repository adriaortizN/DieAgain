...
#include "PowerUp__pf604382786.h"
...
APowerUp_C__pf604382786::APowerUp_C__pf604382786(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APowerUp_C__pf604382786::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(APowerUp_C__pf604382786::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__StaticMesh__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(10.000000, 0.000005, -0.000004);
	auto& __Local__4 = (*(AccessPrivateProperty<FRotator >((bpv__StaticMesh__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__4 = FRotator(90.000000, 0.000027, 0.000000);
	auto& __Local__5 = (*(AccessPrivateProperty<FVector >((bpv__StaticMesh__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__5 = FVector(0.100000, 0.100000, 0.100000);
	...
	bpv__PointLight__pf->AttenuationRadius = 253.376755f;
	bpv__PointLight__pf->Intensity = 1000.000000f;
	bpv__PointLight__pf->LightColor = FColor(255, 236, 0, 255);
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__PointLight__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__6 = FVector(0.000000, 0.000000, 54.000000);
	bpv__PointLight__pf->Mobility = EComponentMobility::Type::Static;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__PointLight__pf), false, 0));
	bpv__IsTalking__pf = false;
	bpv__Dialogue__pf = CastChecked<UDialogue>(CastChecked<UDynamicClass>(APowerUp_C__pf604382786::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
...
void APowerUp_C__pf604382786::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APowerUp_C__pf604382786::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__9.ComponentPropertyName = FName(TEXT("Box"));
	__Local__9.DelegatePropertyName = FName(TEXT("OnComponentEndOverlap"));
	__Local__9.FunctionNameToBind = FName(TEXT("BndEvt__Box_K2Node_ComponentBoundEvent_4_ComponentEndOverlapSignature__DelegateSignature"));
	auto& __Local__10 = __Local__8->ComponentDelegateBindings[1];
	__Local__10.ComponentPropertyName = FName(TEXT("Box"));
	__Local__10.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__10.FunctionNameToBind = FName(TEXT("BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void APowerUp_C__pf604382786::bpf__ExecuteUbergraph_PowerUp__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 18:
			{
				UKismetSystemLibrary::Delay(this, 2.000000, FLatentActionInfo(7, -2118009154, TEXT("ExecuteUbergraph_PowerUp_0"), this));
				__CurrentState = -1;
				break;
			}
		case 19:
...
void APowerUp_C__pf604382786::bpf__ExecuteUbergraph_PowerUp__pf_1(int32 bpp__EntryPoint__pf)
{
...
void APowerUp_C__pf604382786::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_4_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
	...
	bpf__ExecuteUbergraph_PowerUp__pf_0(15);
}
void APowerUp_C__pf604382786::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_PowerUp__pf_1(9);
}
void APowerUp_C__pf604382786::bpf__ChangeInputs__pf()
{
	bpv__IsTalking__pf = true;
}
void APowerUp_C__pf604382786::bpf__StopConversation__pf()
{
	bpv__IsTalking__pf = false;
}
PRAGMA_DISABLE_OPTIMIZATION
void APowerUp_C__pf604382786::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{1127, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/StarterContent/Props/SM_Rock.SM_Rock 
		{1128, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/StarterContent/Materials/M_Metal_Gold.M_Metal_Gold 
		{1129, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Dialogue /Game/Conversations/LV6/LV6_PowerUp.LV6_PowerUp 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APowerUp_C__pf604382786::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APowerUp_C__pf604382786
{
	FRegisterHelper__APowerUp_C__pf604382786()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/PremiumObjects/PowerUp"), &APowerUp_C__pf604382786::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APowerUp_C__pf604382786 Instance;
};
FRegisterHelper__APowerUp_C__pf604382786 FRegisterHelper__APowerUp_C__pf604382786::Instance;
