...
AAISuicideController_C__pf3889547882::AAISuicideController_C__pf3889547882(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	auto __Local__11 = NewObject<UAISenseConfig_Hearing>(bpv__AIPerception__pf, TEXT("AISenseConfig_Hearing_1"), (EObjectFlags)0x00280009);
	{
		// --- Default subobject 'AISenseConfig_Hearing_1' //
		...
		// --- END default subobject 'AISenseConfig_Hearing_1' //
	}
	...
	bpv__WeaponOfEnemy__pf = E__EnumWeapon__pf::NewEnumerator0;
	bpv__IsVIP__pf = false;
	bpv__LevelCompeter__pf = nullptr;
...
void AAISuicideController_C__pf3889547882::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AAISuicideController_C__pf3889547882::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AAISuicideController_C__pf3889547882::bpf__ExecuteUbergraph_AISuicideController__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 12:
			{
				FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf, b0l__Temp_int_Array_Index_Variable__pf, /*out*/ b0l__CallFunc_Array_Get_Item_2__pf);
		...
		case 13:
			{
				bpv__LevelCompeter__pf = b0l__K2Node_DynamicCast_AsLevel_Completer_BP__pf;
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 14:
		...
		case 16:
			{
				TArray<ATargetPoint*>  __Local__24 = {};
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__PatrolPoints__pf) : (__Local__24)));
		...
		case 19:
			{
				TArray<ATargetPoint*>  __Local__25 = {};
				FCustomThunkTemplates::Array_Get(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__PatrolPoints__pf) : (__Local__25)), b0l__Temp_int_Array_Index_Variable_1__pf, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
		...
		case 20:
			{
				AAlarm_C__pf2693064426*  __Local__26 = ((AAlarm_C__pf2693064426*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__AlarmPoint__pf) : (__Local__26)));
		...
		case 21:
			{
				AAlarm_C__pf2693064426*  __Local__27 = ((AAlarm_C__pf2693064426*)nullptr);
				bpv__AlarmPoint__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__AlarmPoint__pf) : (__Local__27));
			}
		case 22:
			{
				AAlarm_C__pf2693064426*  __Local__28 = ((AAlarm_C__pf2693064426*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__AlarmPoint__pf) : (__Local__28)));
				bpv__CanAIGoToAlarmController__pf = bpfv__CallFunc_IsValid_ReturnValue__pf;
			}
		case 23:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("CanAIGoToAlarm")));
				...
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue__pf, bpv__CanAIGoToAlarmController__pf);
				}
			}
		case 24:
			{
				bpfv__CallFunc_GetBlackboard_ReturnValue__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("CanSeePlayer")));
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf, false);
				}
			}
		case 25:
			{
				bool  __Local__29 = false;
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__IsPlayer__pf) : (__Local__29)))
				{
					__CurrentState = 30;
					break;
				}
		...
		case 30:
			{
				E__EnumWeapon__pf  __Local__30 = E__EnumWeapon__pf::NewEnumerator0;
				bpv__WeaponOfEnemy__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__Weapon__pf) : (__Local__30));
			}
		case 31:
			{
				UKismetSystemLibrary::Delay(this, 0.100000, FLatentActionInfo(1, -1515353953, TEXT("ExecuteUbergraph_AISuicideController_0"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 32:
		...
		case 41:
			{
				bpfv__CallFunc_RunBehaviorTree_ReturnValue__pf = RunBehaviorTree(CastChecked<UBehaviorTree>(CastChecked<UDynamicClass>(AAISuicideController_C__pf3889547882::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
			}
		case 42:
			{
				bool  __Local__32 = false;
				bpv__IsVIP__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__IsVIP__pf) : (__Local__32));
				__CurrentState = 32;
				break;
			}
		default:
...
void AAISuicideController_C__pf3889547882::bpf__ExecuteUbergraph_AISuicideController__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 71);
	return; //KCST_EndOfThread
}
void AAISuicideController_C__pf3889547882::bpf__ExecuteUbergraph_AISuicideController__pf_2(int32 bpp__EntryPoint__pf)
{
...
void AAISuicideController_C__pf3889547882::bpf__ExecuteUbergraph_AISuicideController__pf_3(int32 bpp__EntryPoint__pf)
{
...
void AAISuicideController_C__pf3889547882::bpf__ExecuteUbergraph_AISuicideController__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 63:
			{
				bpfv__CallFunc_Add_IntInt_ReturnValue_2__pf = UKismetMathLibrary::Add_IntInt(bpv__Target__pf, 1);
				bpv__Target__pf = bpfv__CallFunc_Add_IntInt_ReturnValue_2__pf;
			}
		case 64:
			{
		...
		case 66:
			{
				...
				bpfv__CallFunc_MakeLiteralName_ReturnValue_5__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("TargetPointKey")));
				...
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::SetValueAsObject(bpfv__CallFunc_MakeLiteralName_ReturnValue_5__pf, b0l__CallFunc_Array_Get_Item_1__pf);
				}
				__CurrentState = -1;
				break;
			}
...
void AAISuicideController_C__pf3889547882::bpf__ExecuteUbergraph_AISuicideController__pf_5(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				int32  __Local__33 = 0;
				int32  __Local__34 = 0;
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__Squad__pf) : (__Local__33)), ((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__Squad__pf) : (__Local__34)));
		...
		case 6:
			{
				...
				{
					__Local__35 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
					check(__Local__35);
					__Local__36 = __Local__35;
				}
				bpf__MakeFocus__pf(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf, static_cast<E__EnumTypesOfCharacters__pf>(bpfv__CallFunc_MakeLiteralByte_ReturnValue_2__pf), (((FBoolProperty*)__Local__35)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				__CurrentState = -1;
				break;
			}
		case 43:
		...
		case 45:
			{
				bool  __Local__37 = false;
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__IsDeath__pf) : (__Local__37)))
				{
					__CurrentState = 3;
					break;
				}
		...
		case 48:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__IsDeath__pf) : (__Local__38)))
				{
					__CurrentState = 49;
					break;
				}
		...
		case 49:
			{
				int32  __Local__39 = 0;
				int32  __Local__40 = 0;
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue_1__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__Squad__pf) : (__Local__39)), ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__Squad__pf) : (__Local__40)));
		...
		case 51:
			{
				...
				bpf__MakeFocus__pf(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf, static_cast<E__EnumTypesOfCharacters__pf>(bpfv__CallFunc_MakeLiteralByte_ReturnValue_1__pf), (((FBoolProperty*)__Local__41)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				__CurrentState = -1;
				break;
			}
		case 52:
		...
		case 54:
			{
				int32  __Local__43 = 0;
				int32  __Local__44 = 0;
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue_2__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpv__Squad__pf) : (__Local__43)), ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf->bpv__Squad__pf) : (__Local__44)));
		...
		case 55:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpv__IsDeath__pf) : (__Local__45)))
				{
					__CurrentState = 56;
					break;
				}
		...
		case 57:
			{
				...
				{
					__Local__46 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
					check(__Local__46);
					__Local__47 = __Local__46;
				}
				bpf__MakeFocus__pf(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf, static_cast<E__EnumTypesOfCharacters__pf>(bpfv__CallFunc_MakeLiteralByte_ReturnValue__pf), (((FBoolProperty*)__Local__46)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				__CurrentState = -1;
				break;
			}
		case 58:
		...
		case 59:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf))
				{
					...
					{
						__Local__48 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
						check(__Local__48);
						__Local__49 = __Local__48;
					}
					bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf, (((FBoolProperty*)__Local__48)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				}
			}
		case 60:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf->UBlackboardComponent::SetValueAsVector(bpfv__CallFunc_MakeLiteralName_ReturnValue_4__pf, b0l__K2Node_ComponentBoundEvent_Stimulus__pf.StimulusLocation);
				}
				__CurrentState = -1;
				break;
			}
		case 61:
			{
				bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				bpfv__CallFunc_MakeLiteralName_ReturnValue_3__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("CanSeePlayer")));
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf))
				{
					...
					{
						__Local__50 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
						check(__Local__50);
						__Local__51 = __Local__50;
					}
					bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_3__pf, (((FBoolProperty*)__Local__50)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				}
				__CurrentState = -1;
				break;
			}
...
void AAISuicideController_C__pf3889547882::bpf__ExecuteUbergraph_AISuicideController__pf_6(int32 bpp__EntryPoint__pf)
{
...
void AAISuicideController_C__pf3889547882::bpf__ExecuteUbergraph_AISuicideController__pf_7(int32 bpp__EntryPoint__pf)
{
...
void AAISuicideController_C__pf3889547882::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_AISuicideController__pf_1(71);
}
void AAISuicideController_C__pf3889547882::bpf__Suicide__pf()
{
	bpf__ExecuteUbergraph_AISuicideController__pf_3(70);
}
void AAISuicideController_C__pf3889547882::bpf__Attack__pf()
{
	bpf__ExecuteUbergraph_AISuicideController__pf_2(68);
}
void AAISuicideController_C__pf3889547882::bpf__GetNewPoint__pf()
{
	bpf__ExecuteUbergraph_AISuicideController__pf_4(62);
}
void AAISuicideController_C__pf3889547882::bpf__BndEvt__AIPerception_K2Node_ComponentBoundEvent_0_ActorPerceptionUpdatedDelegate__DelegateSignature__pf(AActor* bpp__Actor__pf, FAIStimulus bpp__Stimulus__pf)
{
	b0l__K2Node_ComponentBoundEvent_Actor__pf = bpp__Actor__pf;
	b0l__K2Node_ComponentBoundEvent_Stimulus__pf = bpp__Stimulus__pf;
	bpf__ExecuteUbergraph_AISuicideController__pf_5(43);
}
void AAISuicideController_C__pf3889547882::bpf__ReceivePossess__pf(APawn* bpp__PossessedPawn__pf)
{
	b0l__K2Node_Event_PossessedPawn__pf = bpp__PossessedPawn__pf;
	bpf__ExecuteUbergraph_AISuicideController__pf_0(38);
}
void AAISuicideController_C__pf3889547882::bpf__Run__pf()
{
	bpf__ExecuteUbergraph_AISuicideController__pf_7(36);
}
void AAISuicideController_C__pf3889547882::bpf__Walk__pf()
{
	bpf__ExecuteUbergraph_AISuicideController__pf_6(34);
}
void AAISuicideController_C__pf3889547882::bpf__MakeFocus__pf(AActor* bpp__EnemyCast__pf, E__EnumTypesOfCharacters__pf bpp__TypeOfCharacter__pf, bool bpp__Successfully_Sensed__pf)
{
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue__pf{};
		...
		case 1:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_4__pf, bpp__Successfully_Sensed__pf);
				}
			}
		case 2:
			{
		...
		case 3:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsVector(bpfv__CallFunc_MakeLiteralName_ReturnValue_3__pf, bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf);
				}
			}
		case 4:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("RecentlySighted")));
				bpfv__CallFunc_GetBlackboard_ReturnValue__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf, true);
				}
			}
		case 5:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("TypeOfEnemy")));
				bpfv__CallFunc_GetBlackboard_ReturnValue__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsEnum(bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf, static_cast<uint8>(bpp__TypeOfCharacter__pf));
				}
			}
		case 6:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("PlayerReference")));
				bpfv__CallFunc_GetBlackboard_ReturnValue__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsObject(bpfv__CallFunc_MakeLiteralName_ReturnValue__pf, bpp__EnemyCast__pf);
				}
				__CurrentState = -1;
				break;
			}
...
void AAISuicideController_C__pf3889547882::bpf__DieFunction__pf()
{
	...
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_7__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess_10__pf{};
	...
	AThirdPersonCharacter_C__pf2222656877* bpfv__K2Node_DynamicCast_AsThird_Person_Character_2__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess_11__pf{};
	TArray< int32, TInlineAllocator<8> > __StateStack;
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_7__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
				bpfv__K2Node_DynamicCast_bSuccess_10__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_7__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_10__pf)
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
					break;
				}
		...
		case 2:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_7__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_7__pf->bpv__IsDeath__pf = true;
				}
			}
		case 3:
			{
		...
		case 13:
			{
				...
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__K2Node_DynamicCast_bSuccess_6__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf != nullptr);;
		...
		case 14:
			{
				bpfv__CallFunc_NotEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::NotEqual_ObjectObject(bpv__ControlledCharacter__pf, bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf);
		...
		case 15:
			{
				if(::IsValid(bpv__ControlledCharacter__pf))
				{
					bpfv__CallFunc_GetDistanceTo_ReturnValue_1__pf = bpv__ControlledCharacter__pf->AActor::GetDistanceTo(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf);
				}
				bpfv__CallFunc_Less_FloatFloat_ReturnValue_2__pf = UKismetMathLibrary::Less_FloatFloat(bpfv__CallFunc_GetDistanceTo_ReturnValue_1__pf, bpv__MinDistance__pf);
				bpfv__CallFunc_Less_FloatFloat_ReturnValue_3__pf = UKismetMathLibrary::Less_FloatFloat(bpfv__CallFunc_GetDistanceTo_ReturnValue_1__pf, bpv__ClosestDistance__pf);
				bpfv__CallFunc_BooleanAND_ReturnValue_1__pf = UKismetMathLibrary::BooleanAND(bpfv__CallFunc_Less_FloatFloat_ReturnValue_3__pf, bpfv__CallFunc_Less_FloatFloat_ReturnValue_2__pf);
		...
		case 16:
			{
				...
				bpfv__K2Node_DynamicCast_bSuccess_7__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf != nullptr);;
		...
		case 25:
			{
				if(::IsValid(bpv__ControlledCharacter__pf))
				{
					bpfv__CallFunc_GetDistanceTo_ReturnValue__pf = bpv__ControlledCharacter__pf->AActor::GetDistanceTo(bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf);
				}
				bpfv__CallFunc_Conv_FloatToString_ReturnValue__pf = UKismetStringLibrary::Conv_FloatToString(bpfv__CallFunc_GetDistanceTo_ReturnValue__pf);
		...
		case 27:
			{
				...
				bpfv__K2Node_DynamicCast_AsThird_Person_Character_2__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpfv__CallFunc_Array_Get_Item_1__pf);
				bpfv__K2Node_DynamicCast_bSuccess_11__pf = (bpfv__K2Node_DynamicCast_AsThird_Person_Character_2__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_11__pf)
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
					break;
				}
		...
		case 28:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character_2__pf)) ? (bpfv__K2Node_DynamicCast_AsThird_Person_Character_2__pf->bpv__IsDeath__pf) : (__Local__53)))
				{
					__CurrentState = 54;
					break;
				}
		...
		case 33:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ToPossesActor__pf);
		...
		case 34:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->IsPlayerControlled();
				}
		...
		case 35:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__IsGodModeActive__pf) : (__Local__54)))
				{
					__CurrentState = 68;
					break;
				}
		...
		case 37:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsVIP__pf) : (__Local__55)))
				{
					__CurrentState = 41;
					break;
				}
		...
		case 38:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsVIP__pf = false;
				}
			}
		case 39:
			{
		...
		case 41:
			{
				...
				bpfv__K2Node_DynamicCast_bSuccess_8__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf != nullptr);;
		...
		case 42:
			{
				E__EnumWeapon__pf  __Local__56 = E__EnumWeapon__pf::NewEnumerator0;
				bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue_1__pf = UKismetMathLibrary::EqualEqual_ByteByte(static_cast<uint8>(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf->bpv__Weapon__pf) : (__Local__56))), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator3));
		...
		case 50:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf->bpv__IsSuiciding__pf) : (__Local__57)))
				{
					__CurrentState = 51;
					break;
				}
		...
		case 54:
			{
				bpv__ToPossesActor__pf = bpfv__K2Node_DynamicCast_AsThird_Person_Character_2__pf;
			}
		case 55:
			{
				if(::IsValid(bpv__ControlledCharacter__pf))
		...
		case 56:
			{
				bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpv__ToPossesActor__pf);
				bpfv__K2Node_DynamicCast_bSuccess_4__pf = (bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf != nullptr);;
		...
		case 57:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf))
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_1__pf = bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf->IsPlayerControlled();
				}
		...
		case 58:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf)) ? (bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__IsGodModeActive__pf) : (__Local__58)))
				{
					__CurrentState = 59;
					break;
				}
		...
		case 59:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf))
				{
					bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__IsDeath__pf = true;
				}
			}
		case 60:
			{
				if(::IsValid(bpv__DyingCharacter__pf) && ::IsValid(bpv__DyingCharacter__pf->bpv__SkeletalMesh__pf))
				{
					bpv__DyingCharacter__pf->bpv__SkeletalMesh__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AAISuicideController_C__pf3889547882::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
			}
		case 61:
			{
				...
				bpfv__K2Node_DynamicCast_bSuccess_3__pf = (bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf != nullptr);;
		...
		case 64:
			{
				...
				if (!((::IsValid(bpv__ControlledCharacter__pf)) ? (bpv__ControlledCharacter__pf->bpv__IsPlayer__pf) : (__Local__59)))
				{
					__CurrentState = 36;
					break;
				}
		...
		case 65:
			{
				...
				bpfv__K2Node_DynamicCast_bSuccess_9__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf != nullptr);;
		...
		case 68:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__IsDeath__pf = true;
				}
			}
		case 69:
			{
		...
		case 70:
			{
				E__EnumWeapon__pf  __Local__60 = E__EnumWeapon__pf::NewEnumerator0;
				bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ByteByte(static_cast<uint8>(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf->bpv__Weapon__pf) : (__Local__60))), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator2));
...
void AAISuicideController_C__pf3889547882::bpf__FullDeath__pf(AEnemyShootingCh_C__pf3349424045* bpp__DyingCharacter__pf)
{
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	...
	AKnifePickUp_C__pf1651478651* bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf{};
	...
	AShotgunPickUp_C__pf1651478651* bpfv__CallFunc_FinishSpawningActor_ReturnValue_2__pf{};
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpp__DyingCharacter__pf);
				bpfv__K2Node_DynamicCast_bSuccess__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess__pf)
				{
					__CurrentState = -1;
		...
		case 4:
			{
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__WeaponOfEnemy__pf), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator0));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 5;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__WeaponOfEnemy__pf), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator1));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__WeaponOfEnemy__pf), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator2));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 20;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__WeaponOfEnemy__pf), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator4));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 5;
					break;
		...
		case 7:
			{
				bpfv__K2Node_DynamicCast_AsRifle_Pick_Up__pf = Cast<ARiflePickUp_C__pf1651478651>(bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf);
				bpfv__K2Node_DynamicCast_bSuccess_3__pf = (bpfv__K2Node_DynamicCast_AsRifle_Pick_Up__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_3__pf)
				{
					__CurrentState = -1;
					break;
		...
		case 8:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsRifle_Pick_Up__pf->bpv__WeaponType__pf = bpv__WeaponOfEnemy__pf;
				}
			}
		case 9:
			{
		...
		case 11:
			{
				bpfv__K2Node_DynamicCast_AsLevel_Completer_BP_1__pf = Cast<ALevelCompleterBP_C__pf922009354>(bpv__LevelCompeter__pf);
		...
		case 14:
			{
				bpfv__K2Node_DynamicCast_AsLevel_Completer_BP__pf = Cast<ALevelCompleterBP_C__pf922009354>(bpv__LevelCompeter__pf);
		...
		case 16:
			{
				...
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf, FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_2__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, AShotgunPickUp_C__pf1651478651::StaticClass(), bpfv__CallFunc_MakeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
			}
		case 17:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__FireRifle__pf))
				...
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf, FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_FinishSpawningActor_ReturnValue_2__pf = CastChecked<AShotgunPickUp_C__pf1651478651>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_2__pf, bpfv__CallFunc_MakeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 18:
			{
				bpfv__K2Node_DynamicCast_AsShotgun_Pick_Up__pf = Cast<AShotgunPickUp_C__pf1651478651>(bpfv__CallFunc_FinishSpawningActor_ReturnValue_2__pf);
		...
		case 19:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsShotgun_Pick_Up__pf->bpv__WeaponType__pf = E__EnumWeapon__pf::NewEnumerator1;
				}
				__CurrentState = 9;
				break;
			}
		case 20:
			{
				...
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf, FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, AKnifePickUp_C__pf1651478651::StaticClass(), bpfv__CallFunc_MakeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
			}
		case 21:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__FireRifle__pf))
				...
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf, FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf = CastChecked<AKnifePickUp_C__pf1651478651>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf, bpfv__CallFunc_MakeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 22:
			{
				bpfv__K2Node_DynamicCast_AsKnife_Pick_Up__pf = Cast<AKnifePickUp_C__pf1651478651>(bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf);
				bpfv__K2Node_DynamicCast_bSuccess_4__pf = (bpfv__K2Node_DynamicCast_AsKnife_Pick_Up__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_4__pf)
				{
					__CurrentState = -1;
					break;
		...
		case 23:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsKnife_Pick_Up__pf->bpv__WeaponType__pf = E__EnumWeapon__pf::NewEnumerator2;
				}
				__CurrentState = 9;
				break;
			}
...
void AAISuicideController_C__pf3889547882::bpf__DetectPlayer__pf(AActor* bpp__EnemyCast__pf)
{
	uint8 bpfv__CallFunc_MakeLiteralByte_ReturnValue__pf{};
...
void AAISuicideController_C__pf3889547882::bpf__AddToVision__pf()
{
	int32 bpfv__Temp_int_Array_Index_Variable__pf{};
	int32 bpfv__Temp_int_Loop_Counter_Variable__pf{};
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	...
	do
	{
		...
		case 9:
			{
				TArray<AEnemyShootingCh_C__pf3349424045*>  __Local__61 = {};
				bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__ActorsInVision__pf) : (__Local__61)), bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 10:
...
void AAISuicideController_C__pf3889547882::bpf__PlayerInVision__pf(bool bpp__IsEnteringInSight__pf, AEnemyShootingCh_C__pf3349424045* bpp__Player__pf)
{
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf{};
	...
	do
	{
		...
		case 4:
			{
				TArray<AEnemyShootingCh_C__pf3349424045*>  __Local__62 = {};
				bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__ActorsInVision__pf) : (__Local__62)), bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf);
				__CurrentState = -1;
				break;
			}
		case 5:
		...
		case 7:
			{
				TArray<AEnemyShootingCh_C__pf3349424045*>  __Local__63 = {};
				bpfv__CallFunc_Array_RemoveItem_ReturnValue__pf = FCustomThunkTemplates::Array_RemoveItem(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__ActorsInVision__pf) : (__Local__63)), bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf);
				__CurrentState = -1;
				break;
			}
		default:
...
void AAISuicideController_C__pf3889547882::bpf__GetSoundAlert__pf(AActor* bpp__EnemyCast__pf)
{
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue__pf{};
	FVector bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf(EForceInit::ForceInit);
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf{};
...
void AAISuicideController_C__pf3889547882::bpf__SpawnPossesionPS__pf(AActor* bpp__TargetActor__pf)
{
	FTransform bpfv__CallFunc_MakeTransform_ReturnValue__pf{};
...
PRAGMA_DISABLE_OPTIMIZATION
void AAISuicideController_C__pf3889547882::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AAISuicideController_C__pf3889547882::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AAISuicideController_C__pf3889547882
{
	FRegisterHelper__AAISuicideController_C__pf3889547882()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Enemies/BehaviorSuicide/AISuicideController"), &AAISuicideController_C__pf3889547882::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AAISuicideController_C__pf3889547882 Instance;
};
FRegisterHelper__AAISuicideController_C__pf3889547882 FRegisterHelper__AAISuicideController_C__pf3889547882::Instance;
