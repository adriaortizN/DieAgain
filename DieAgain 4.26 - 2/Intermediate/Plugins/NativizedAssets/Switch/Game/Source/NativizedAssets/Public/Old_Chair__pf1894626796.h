...
#include "Old_Chair__pf1894626796.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Art/DestructibleMesh/Old_Chair.Old_Chair_C", OverrideNativeName="Old_Chair_C"))
class AOld_Chair_C__pf1894626796 : public AActor
{
public:
	GENERATED_BODY()
	...
	AOld_Chair_C__pf1894626796(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_Old_Chair_0"))
	void bpf__ExecuteUbergraph_Old_Chair__pf_0(int32 bpp__EntryPoint__pf);
