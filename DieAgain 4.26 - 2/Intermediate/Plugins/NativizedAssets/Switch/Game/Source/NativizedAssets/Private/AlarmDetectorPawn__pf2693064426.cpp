...
AAlarmDetectorPawn_C__pf2693064426::AAlarmDetectorPawn_C__pf2693064426(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__A__pf = CreateDefaultSubobject<UChildActorComponent>(TEXT("A"));
	bpv__B__pf = CreateDefaultSubobject<UChildActorComponent>(TEXT("B"));
	...
	bpv__A__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__A__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__A__pf), false, 0));
	bpv__B__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__B__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__B__pf), false, 0));
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AAlarmDetectorPawn_C__pf2693064426::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AAlarmDetectorPawn_C__pf2693064426::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__Cube__pf->SetCollisionProfileName(FName(TEXT("OverlapAllDynamic")));
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Cube__pf), true, 0));
	bpv__PreviousSquad__pf = -1;
	bpv__TimeDelayToPutPreviousSquad__pf = 5.000000f;
	bpv__IsActive__pf = false;
	bpv__CooldownIsActive__pf = false;
	bpv__OverTime__pf = 3.000000f;
	bpv__OGMaterial__pf = nullptr;
...
void AAlarmDetectorPawn_C__pf2693064426::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AAlarmDetectorPawn_C__pf2693064426::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto& __Local__5 = __Local__4->ComponentDelegateBindings[0];
	__Local__5.ComponentPropertyName = FName(TEXT("Cube"));
	__Local__5.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__5.FunctionNameToBind = FName(TEXT("BndEvt__Cube_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AAlarmDetectorPawn_C__pf2693064426::bpf__ExecuteUbergraph_AlarmDetectorPawn__pf_0(int32 bpp__EntryPoint__pf)
{
...
void AAlarmDetectorPawn_C__pf2693064426::bpf__ExecuteUbergraph_AlarmDetectorPawn__pf_1(int32 bpp__EntryPoint__pf)
{
		...
		case 3:
			{
				if(::IsValid(bpv__Cube__pf))
				{
					...
					bpv__Cube__pf->USceneComponent::K2_SetRelativeLocation(((::IsValid(bpv__B__pf)) ? ((*(AccessPrivateProperty<FVector >((bpv__B__pf), USceneComponent::__PPO__RelativeLocation() )))) : (__Local__6)), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocation_SweepHitResult__pf, true);
				}
			}
		case 4:
			{
		...
		case 36:
			{
				...
				UKismetSystemLibrary::MoveComponentTo(bpv__Cube__pf, ((::IsValid(bpv__A__pf)) ? ((*(AccessPrivateProperty<FVector >((bpv__A__pf), USceneComponent::__PPO__RelativeLocation() )))) : (__Local__7)), FRotator(0.000000,0.000000,0.000000), true, true, bpv__OverTime__pf, true, b0l__Temp_byte_Variable_1__pf, FLatentActionInfo(1, -220647147, TEXT("ExecuteUbergraph_AlarmDetectorPawn_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void AAlarmDetectorPawn_C__pf2693064426::bpf__ExecuteUbergraph_AlarmDetectorPawn__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 13:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_2__pf = b0l__CallFunc_Array_Get_Item__pf->IsPlayerControlled();
				}
		...
		case 14:
			{
				FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf, b0l__Temp_int_Array_Index_Variable__pf, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__CallFunc_Array_Get_Item__pf);
		...
		case 15:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__Squad__pf = bpv__PreviousSquad__pf;
				}
			}
		case 16:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf))
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__Exposed__pf = false;
				}
			}
		case 17:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf) && ::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__SkeletalMesh__pf))
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__SkeletalMesh__pf->SetMaterial(0, bpv__OGMaterial__pf);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 21:
			{
				...
				b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf);
		...
		case 23:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf))
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__Squad__pf = bpv__PreviousSquad__pf;
				}
			}
		case 24:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf) && ::IsValid((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf), ACharacter::__PPO__Mesh() )))))
				{
					(*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf), ACharacter::__PPO__Mesh() )))->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AAlarmDetectorPawn_C__pf2693064426::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 41:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__IsDeath__pf) : (__Local__9)))
				{
					__CurrentState = 49;
					break;
				}
		...
		case 44:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsDeath__pf) : (__Local__10)))
				{
					__CurrentState = 45;
					break;
				}
		...
		case 45:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__Exposed__pf) : (__Local__11)))
				{
					__CurrentState = 48;
					break;
				}
		...
		case 46:
			{
				int32  __Local__12 = 0;
				bpf__ChangeSquad__pf(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf, ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__PreviousSquad__pf) : (__Local__12)));
			}
		case 47:
			{
				UKismetSystemLibrary::Delay(this, bpv__TimeDelayToPutPreviousSquad__pf, FLatentActionInfo(5, -755259686, TEXT("ExecuteUbergraph_AlarmDetectorPawn_2"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 48:
			{
				int32  __Local__14 = 0;
				bpf__ChangeSquad__pf(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf, ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__Squad__pf) : (__Local__14)));
				__CurrentState = 47;
				break;
			}
		case 49:
			{
				int32  __Local__15 = 0;
				bpf__ChangeSquadThirdPerson__pf(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf, ((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__Squad__pf) : (__Local__15)));
			}
		case 50:
			{
				UKismetSystemLibrary::Delay(this, bpv__TimeDelayToPutPreviousSquad__pf, FLatentActionInfo(19, 1760131480, TEXT("ExecuteUbergraph_AlarmDetectorPawn_2"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		default:
...
void AAlarmDetectorPawn_C__pf2693064426::bpf__ExecuteUbergraph_AlarmDetectorPawn__pf_3(int32 bpp__EntryPoint__pf)
{
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
		...
		case 30:
			{
				...
				UKismetSystemLibrary::MoveComponentTo(bpv__Cube__pf, ((::IsValid(bpv__B__pf)) ? ((*(AccessPrivateProperty<FVector >((bpv__B__pf), USceneComponent::__PPO__RelativeLocation() )))) : (__Local__17)), FRotator(0.000000,0.000000,0.000000), true, true, 3.000000, false, b0l__Temp_byte_Variable__pf, FLatentActionInfo(26, 935108463, TEXT("ExecuteUbergraph_AlarmDetectorPawn_3"), this));
				__CurrentState = -1;
				break;
			}
		case 51:
...
void AAlarmDetectorPawn_C__pf2693064426::bpf__MoveAlarmB__pf()
{
	bpf__ExecuteUbergraph_AlarmDetectorPawn__pf_3(51);
}
void AAlarmDetectorPawn_C__pf2693064426::bpf__BndEvt__Cube_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_AlarmDetectorPawn__pf_2(37);
}
void AAlarmDetectorPawn_C__pf2693064426::bpf__MoveAlarmA__pf()
{
	bpf__ExecuteUbergraph_AlarmDetectorPawn__pf_1(34);
}
void AAlarmDetectorPawn_C__pf2693064426::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_AlarmDetectorPawn__pf_0(31);
}
void AAlarmDetectorPawn_C__pf2693064426::bpf__ChangeSquad__pf(AEnemyShootingCh_C__pf3349424045* bpp__Characterr__pf, int32 bpp__Squad__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpv__CooldownIsActive__pf = true;
			}
		case 2:
			{
				bpv__PreviousSquad__pf = bpp__Squad__pf;
			}
		case 3:
			{
				if(::IsValid(bpp__Characterr__pf))
				{
					bpp__Characterr__pf->bpv__Squad__pf = 0;
				}
			}
		case 4:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpp__Characterr__pf);
		...
		case 5:
			{
				...
				{
					bpfv__CallFunc_GetMaterial_ReturnValue__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__SkeletalMesh__pf->GetMaterial(0);
				}
				bpv__OGMaterial__pf = bpfv__CallFunc_GetMaterial_ReturnValue__pf;
			}
		case 6:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__SkeletalMesh__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__SkeletalMesh__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AAlarmDetectorPawn_C__pf2693064426::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
				}
			}
		case 7:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__Exposed__pf = true;
				}
				__CurrentState = -1;
				break;
			}
...
void AAlarmDetectorPawn_C__pf2693064426::bpf__ChangeSquadThirdPerson__pf(AThirdPersonCharacter_C__pf2222656877* bpp__Characterr__pf, int32 bpp__Squadd__pf)
{
	...
	do
	{
		...
		case 2:
			{
				bpv__PreviousSquad__pf = bpp__Squadd__pf;
			}
		case 3:
			{
				if(::IsValid(bpp__Characterr__pf))
		...
		case 4:
			{
				bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpp__Characterr__pf);
		...
		case 5:
			{
				...
				{
					(*(AccessPrivateProperty<USkeletalMeshComponent* >((bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf), ACharacter::__PPO__Mesh() )))->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AAlarmDetectorPawn_C__pf2693064426::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
...
PRAGMA_DISABLE_OPTIMIZATION
void AAlarmDetectorPawn_C__pf2693064426::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AAlarmDetectorPawn_C__pf2693064426::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{103, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.Pawn 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AAlarmDetectorPawn_C__pf2693064426
{
	FRegisterHelper__AAlarmDetectorPawn_C__pf2693064426()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/Alarm/AlarmDetectorPawn"), &AAlarmDetectorPawn_C__pf2693064426::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AAlarmDetectorPawn_C__pf2693064426 Instance;
};
FRegisterHelper__AAlarmDetectorPawn_C__pf2693064426 FRegisterHelper__AAlarmDetectorPawn_C__pf2693064426::Instance;
