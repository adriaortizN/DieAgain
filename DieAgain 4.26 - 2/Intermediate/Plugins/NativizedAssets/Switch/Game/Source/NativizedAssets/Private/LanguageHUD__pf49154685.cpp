...
#include "LanguageHUD__pf49154685.h"
...
ULanguageHUD_C__pf49154685::ULanguageHUD_C__pf49154685(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Button_Ca__pf = nullptr;
	bpv__Button_English__pf = nullptr;
	bpv__Button_Es__pf = nullptr;
	bpv__Button_Fr__pf = nullptr;
	bpv__Button_Ita__pf = nullptr;
	bpv__Button_Pt__pf = nullptr;
	bpv__Button_Ru__pf = nullptr;
	bpv__Button_Zh__pf = nullptr;
	bpv__Image_16__pf = nullptr;
}
PRAGMA_ENABLE_OPTIMIZATION
void ULanguageHUD_C__pf49154685::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ULanguageHUD_C__pf49154685::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__2.ComponentPropertyName = FName(TEXT("Button_Fr"));
	__Local__2.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__Button_Fr_K2Node_ComponentBoundEvent_7_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__3 = __Local__0->ComponentDelegateBindings[1];
	__Local__3.ComponentPropertyName = FName(TEXT("Button_Ca"));
	__Local__3.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__Button_Ca_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__4 = __Local__0->ComponentDelegateBindings[2];
	__Local__4.ComponentPropertyName = FName(TEXT("Button_Zh"));
	__Local__4.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__Button_Zh_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__5 = __Local__0->ComponentDelegateBindings[3];
	__Local__5.ComponentPropertyName = FName(TEXT("Button_Ru"));
	__Local__5.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__5.FunctionNameToBind = FName(TEXT("BndEvt__Button_Ru_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__6 = __Local__0->ComponentDelegateBindings[4];
	__Local__6.ComponentPropertyName = FName(TEXT("Button_Pt"));
	__Local__6.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__6.FunctionNameToBind = FName(TEXT("BndEvt__Button_2_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__7 = __Local__0->ComponentDelegateBindings[5];
	__Local__7.ComponentPropertyName = FName(TEXT("Button_Es"));
	__Local__7.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__7.FunctionNameToBind = FName(TEXT("BndEvt__Button_1_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__8 = __Local__0->ComponentDelegateBindings[6];
	__Local__8.ComponentPropertyName = FName(TEXT("Button_Ita"));
	__Local__8.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__8.FunctionNameToBind = FName(TEXT("BndEvt__Button_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__9 = __Local__0->ComponentDelegateBindings[7];
	__Local__9.ComponentPropertyName = FName(TEXT("Button_English"));
	__Local__9.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__9.FunctionNameToBind = FName(TEXT("BndEvt__Button_117_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	auto __Local__12 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_5"), (EObjectFlags)0x00280008);
	__Local__12->LayoutData.Offsets.Left = -960.960938f;
	__Local__12->LayoutData.Offsets.Top = -540.540527f;
	__Local__12->LayoutData.Offsets.Right = 1920.000000f;
	__Local__12->LayoutData.Offsets.Bottom = 1080.000000f;
	...
	auto __Local__13 = NewObject<UImage>(__Local__1, TEXT("Image_16"), (EObjectFlags)0x00280008);
	__Local__13->Brush.ImageSize = FVector2D(1920.000000, 1080.000000);
	auto& __Local__14 = (*(AccessPrivateProperty<UObject* >(&(__Local__13->Brush), FSlateBrush::__PPO__ResourceObject() )));
	__Local__14 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__15->LayoutData.Offsets.Left = -340.960938f;
	__Local__15->LayoutData.Offsets.Top = 100.000000f;
	__Local__15->LayoutData.Offsets.Right = 705.049561f;
	__Local__15->LayoutData.Offsets.Bottom = 90.060059f;
	__Local__15->LayoutData.Anchors.Minimum = FVector2D(0.500000, 0.000000);
	__Local__15->LayoutData.Anchors.Maximum = FVector2D(0.500000, 0.000000);
	__Local__15->Parent = __Local__10;
	auto __Local__16 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_64"), (EObjectFlags)0x00280008);
	__Local__16->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[F2E58B774992D2E89D6526BB5C4C4132]\", \"D66F9B4045333465772E6AB48BE3FA3D\", \"Choose the language\")")	);
	__Local__16->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__16->Font.OutlineSettings.OutlineSize = 2;
	...
	auto __Local__17 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_2"), (EObjectFlags)0x00280008);
	__Local__17->LayoutData.Offsets.Left = 64.000000f;
	__Local__17->LayoutData.Offsets.Top = 268.000000f;
	__Local__17->LayoutData.Offsets.Right = 1772.783936f;
	__Local__17->LayoutData.Offsets.Bottom = 210.180176f;
	__Local__17->Parent = __Local__10;
	auto __Local__18 = NewObject<UHorizontalBox>(__Local__1, TEXT("HorizontalBox_326"), (EObjectFlags)0x00280008);
	...
	__Local__19.Reserve(4);
	auto __Local__20 = NewObject<UHorizontalBoxSlot>(__Local__18, TEXT("HorizontalBoxSlot_1"), (EObjectFlags)0x00280008);
	__Local__20->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__20->Parent = __Local__18;
	auto __Local__21 = NewObject<UScaleBox>(__Local__1, TEXT("ScaleBox_142"), (EObjectFlags)0x00280008);
	...
	auto __Local__23 = NewObject<UScaleBoxSlot>(__Local__21, TEXT("ScaleBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__23->Parent = __Local__21;
	auto __Local__24 = NewObject<UButton>(__Local__1, TEXT("Button_Ita"), (EObjectFlags)0x00280008);
	__Local__24->WidgetStyle.Normal.ImageSize = FVector2D(1500.000000, 843.000000);
	auto& __Local__25 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__24->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__25 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__26 = (*(AccessPrivateProperty<UObject* >(&(__Local__24->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__26 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__24->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__24->WidgetStyle.Hovered.ImageSize = FVector2D(1500.000000, 843.000000);
	auto& __Local__27 = (*(AccessPrivateProperty<UObject* >(&(__Local__24->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__27 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__24->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__24->WidgetStyle.Pressed.ImageSize = FVector2D(1500.000000, 843.000000);
	auto& __Local__28 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__24->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__28 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__29 = (*(AccessPrivateProperty<UObject* >(&(__Local__24->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__29 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__24->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	...
	auto __Local__30 = NewObject<UHorizontalBoxSlot>(__Local__18, TEXT("HorizontalBoxSlot_2"), (EObjectFlags)0x00280008);
	__Local__30->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__30->Parent = __Local__18;
	auto __Local__31 = NewObject<UScaleBox>(__Local__1, TEXT("ScaleBox_331"), (EObjectFlags)0x00280008);
	...
	auto __Local__33 = NewObject<UScaleBoxSlot>(__Local__31, TEXT("ScaleBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__33->Parent = __Local__31;
	auto __Local__34 = NewObject<UButton>(__Local__1, TEXT("Button_English"), (EObjectFlags)0x00280008);
	__Local__34->WidgetStyle.Normal.ImageSize = FVector2D(1299.000000, 650.000000);
	...
	__Local__35 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__36 = (*(AccessPrivateProperty<UObject* >(&(__Local__34->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__36 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__34->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__34->WidgetStyle.Hovered.ImageSize = FVector2D(1299.000000, 650.000000);
	auto& __Local__37 = (*(AccessPrivateProperty<UObject* >(&(__Local__34->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__37 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__34->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__34->WidgetStyle.Pressed.ImageSize = FVector2D(1299.000000, 650.000000);
	...
	__Local__38 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__39 = (*(AccessPrivateProperty<UObject* >(&(__Local__34->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__39 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__34->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	...
	__Local__19.Add(__Local__30);
	auto __Local__40 = NewObject<UHorizontalBoxSlot>(__Local__18, TEXT("HorizontalBoxSlot_3"), (EObjectFlags)0x00280008);
	__Local__40->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__40->Parent = __Local__18;
	auto __Local__41 = NewObject<UScaleBox>(__Local__1, TEXT("ScaleBox_511"), (EObjectFlags)0x00280008);
	...
	auto __Local__43 = NewObject<UScaleBoxSlot>(__Local__41, TEXT("ScaleBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__43->Parent = __Local__41;
	auto __Local__44 = NewObject<UButton>(__Local__1, TEXT("Button_Ru"), (EObjectFlags)0x00280008);
	__Local__44->WidgetStyle.Normal.ImageSize = FVector2D(1280.000000, 853.000000);
	...
	__Local__45 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__46 = (*(AccessPrivateProperty<UObject* >(&(__Local__44->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__46 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	__Local__44->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__44->WidgetStyle.Hovered.ImageSize = FVector2D(1280.000000, 853.000000);
	auto& __Local__47 = (*(AccessPrivateProperty<UObject* >(&(__Local__44->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__47 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	__Local__44->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__44->WidgetStyle.Pressed.ImageSize = FVector2D(1280.000000, 853.000000);
	auto& __Local__48 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__44->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__48 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__49 = (*(AccessPrivateProperty<UObject* >(&(__Local__44->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__49 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	__Local__44->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	...
	__Local__19.Add(__Local__40);
	auto __Local__50 = NewObject<UHorizontalBoxSlot>(__Local__18, TEXT("HorizontalBoxSlot_4"), (EObjectFlags)0x00280008);
	__Local__50->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__50->Parent = __Local__18;
	auto __Local__51 = NewObject<UScaleBox>(__Local__1, TEXT("ScaleBox_675"), (EObjectFlags)0x00280008);
	auto& __Local__52 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__51), UPanelWidget::__PPO__Slots() )));
	__Local__52 = TArray<UPanelSlot*> ();
	__Local__52.Reserve(1);
	auto __Local__53 = NewObject<UScaleBoxSlot>(__Local__51, TEXT("ScaleBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__53->Parent = __Local__51;
	auto __Local__54 = NewObject<UButton>(__Local__1, TEXT("Button_Zh"), (EObjectFlags)0x00280008);
	__Local__54->WidgetStyle.Normal.ImageSize = FVector2D(1920.000000, 1280.000000);
	...
	__Local__55 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__56 = (*(AccessPrivateProperty<UObject* >(&(__Local__54->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__56 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	__Local__54->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__54->WidgetStyle.Hovered.ImageSize = FVector2D(1920.000000, 1280.000000);
	auto& __Local__57 = (*(AccessPrivateProperty<UObject* >(&(__Local__54->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__57 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	__Local__54->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__54->WidgetStyle.Pressed.ImageSize = FVector2D(1920.000000, 1280.000000);
	...
	__Local__58 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__59 = (*(AccessPrivateProperty<UObject* >(&(__Local__54->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__59 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	__Local__54->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	...
	__Local__19.Add(__Local__50);
	__Local__18->Slot = __Local__17;
	auto __Local__60 = NewObject<UWidgetNavigation>(__Local__18, TEXT("WidgetNavigation_0"), (EObjectFlags)0x00280008);
	__Local__60->Left.Rule = EUINavigationRule::Stop;
	__Local__60->Right.Rule = EUINavigationRule::Stop;
	__Local__18->Navigation = __Local__60;
	__Local__17->Content = __Local__18;
	__Local__11.Add(__Local__17);
	auto __Local__61 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_9"), (EObjectFlags)0x00280008);
	__Local__61->LayoutData.Offsets.Left = 48.396938f;
	__Local__61->LayoutData.Offsets.Top = 616.000000f;
	__Local__61->LayoutData.Offsets.Right = 1772.783936f;
	__Local__61->LayoutData.Offsets.Bottom = 210.180176f;
	__Local__61->Parent = __Local__10;
	auto __Local__62 = NewObject<UHorizontalBox>(__Local__1, TEXT("HorizontalBox_1452"), (EObjectFlags)0x00280008);
	...
	auto __Local__65 = NewObject<UScaleBox>(__Local__1, TEXT("ScaleBox_1113"), (EObjectFlags)0x00280008);
	...
	auto __Local__67 = NewObject<UScaleBoxSlot>(__Local__65, TEXT("ScaleBoxSlot_1"), (EObjectFlags)0x00280008);
	__Local__67->Parent = __Local__65;
	auto __Local__68 = NewObject<UButton>(__Local__1, TEXT("Button_Es"), (EObjectFlags)0x00280008);
	__Local__68->WidgetStyle.Normal.ImageSize = FVector2D(750.000000, 500.000000);
	auto& __Local__69 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__68->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__69 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__70 = (*(AccessPrivateProperty<UObject* >(&(__Local__68->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__70 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
	__Local__68->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__68->WidgetStyle.Hovered.ImageSize = FVector2D(750.000000, 500.000000);
	auto& __Local__71 = (*(AccessPrivateProperty<UObject* >(&(__Local__68->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__71 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
	__Local__68->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__68->WidgetStyle.Pressed.ImageSize = FVector2D(750.000000, 500.000000);
	auto& __Local__72 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__68->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__72 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__73 = (*(AccessPrivateProperty<UObject* >(&(__Local__68->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__73 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
	__Local__68->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	...
	auto __Local__74 = NewObject<UHorizontalBoxSlot>(__Local__62, TEXT("HorizontalBoxSlot_3"), (EObjectFlags)0x00280008);
	__Local__74->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__74->Parent = __Local__62;
	auto __Local__75 = NewObject<UScaleBox>(__Local__1, TEXT("ScaleBox_1508"), (EObjectFlags)0x00280008);
	...
	auto __Local__78 = NewObject<UButton>(__Local__1, TEXT("Button_Pt"), (EObjectFlags)0x00280008);
	__Local__78->WidgetStyle.Normal.ImageSize = FVector2D(1500.000000, 1000.000000);
	auto& __Local__79 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__78->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__79 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__80 = (*(AccessPrivateProperty<UObject* >(&(__Local__78->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__80 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
	__Local__78->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__78->WidgetStyle.Hovered.ImageSize = FVector2D(1500.000000, 1000.000000);
	auto& __Local__81 = (*(AccessPrivateProperty<UObject* >(&(__Local__78->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__81 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
	__Local__78->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__78->WidgetStyle.Pressed.ImageSize = FVector2D(1500.000000, 1000.000000);
	auto& __Local__82 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__78->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__82 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__83 = (*(AccessPrivateProperty<UObject* >(&(__Local__78->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__83 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
	__Local__78->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	...
	__Local__63.Add(__Local__74);
	auto __Local__84 = NewObject<UHorizontalBoxSlot>(__Local__62, TEXT("HorizontalBoxSlot_4"), (EObjectFlags)0x00280008);
	__Local__84->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__84->Parent = __Local__62;
	auto __Local__85 = NewObject<UScaleBox>(__Local__1, TEXT("ScaleBox_1675"), (EObjectFlags)0x00280008);
	...
	auto __Local__87 = NewObject<UScaleBoxSlot>(__Local__85, TEXT("ScaleBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__87->Parent = __Local__85;
	auto __Local__88 = NewObject<UButton>(__Local__1, TEXT("Button_Ca"), (EObjectFlags)0x00280008);
	__Local__88->WidgetStyle.Normal.ImageSize = FVector2D(810.000000, 539.000000);
	auto& __Local__89 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__88->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__89 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__90 = (*(AccessPrivateProperty<UObject* >(&(__Local__88->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__90 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
	__Local__88->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__88->WidgetStyle.Hovered.ImageSize = FVector2D(810.000000, 539.000000);
	auto& __Local__91 = (*(AccessPrivateProperty<UObject* >(&(__Local__88->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__91 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
	__Local__88->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__88->WidgetStyle.Pressed.ImageSize = FVector2D(810.000000, 539.000000);
	auto& __Local__92 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__88->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__92 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__93 = (*(AccessPrivateProperty<UObject* >(&(__Local__88->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__93 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
	__Local__88->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	...
	__Local__63.Add(__Local__84);
	auto __Local__94 = NewObject<UHorizontalBoxSlot>(__Local__62, TEXT("HorizontalBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__94->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__94->Parent = __Local__62;
	auto __Local__95 = NewObject<UScaleBox>(__Local__1, TEXT("ScaleBox"), (EObjectFlags)0x00280008);
	...
	auto __Local__97 = NewObject<UScaleBoxSlot>(__Local__95, TEXT("ScaleBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__97->Parent = __Local__95;
	auto __Local__98 = NewObject<UButton>(__Local__1, TEXT("Button_Fr"), (EObjectFlags)0x00280008);
	__Local__98->WidgetStyle.Normal.ImageSize = FVector2D(1920.000000, 1280.000000);
	auto& __Local__99 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__98->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__99 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__100 = (*(AccessPrivateProperty<UObject* >(&(__Local__98->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__100 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed);
	__Local__98->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__98->WidgetStyle.Hovered.ImageSize = FVector2D(1920.000000, 1280.000000);
	auto& __Local__101 = (*(AccessPrivateProperty<UObject* >(&(__Local__98->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__101 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed);
	__Local__98->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__98->WidgetStyle.Pressed.ImageSize = FVector2D(1920.000000, 1280.000000);
	auto& __Local__102 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__98->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__102 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__103 = (*(AccessPrivateProperty<UObject* >(&(__Local__98->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__103 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed);
	__Local__98->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	...
	__Local__63.Add(__Local__94);
	__Local__62->Slot = __Local__61;
	__Local__61->Content = __Local__62;
	__Local__11.Add(__Local__61);
	__Local__1->RootWidget = __Local__10;
}
PRAGMA_ENABLE_OPTIMIZATION
void ULanguageHUD_C__pf49154685::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__104;
	SlotNames.Append(__Local__104);
}
void ULanguageHUD_C__pf49154685::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__105;
	TArray<FDelegateRuntimeBinding>  __Local__106;
	__Local__106.AddUninitialized(1);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__106.GetData(), 1);
	auto& __Local__107 = __Local__106[0];
	__Local__107.ObjectName = FString(TEXT("Image_16"));
	__Local__107.PropertyName = FName(TEXT("Brush"));
	__Local__107.FunctionName = FName(TEXT("GetBrush_0"));
	...
	__Local__109.Name = FName(TEXT("GetBrush_0"));
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->MiscConvertedSubobjects[0]), __Local__105, __Local__106);
}
void ULanguageHUD_C__pf49154685::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void ULanguageHUD_C__pf49154685::bpf__ExecuteUbergraph_LanguageHUD__pf_0(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_SetCurrentCulture_ReturnValue__pf{};
	bool bpfv__CallFunc_SetCurrentCulture_ReturnValue_1__pf{};
	bool bpfv__CallFunc_SetCurrentCulture_ReturnValue_2__pf{};
	bool bpfv__CallFunc_SetCurrentCulture_ReturnValue_3__pf{};
	bool bpfv__CallFunc_SetCurrentCulture_ReturnValue_4__pf{};
	bool bpfv__CallFunc_SetCurrentCulture_ReturnValue_5__pf{};
	bool bpfv__CallFunc_SetCurrentCulture_ReturnValue_6__pf{};
	AGameModeBase* bpfv__CallFunc_GetGameMode_ReturnValue__pf{};
	bool bpfv__CallFunc_SetCurrentCulture_ReturnValue_7__pf{};
	...
	do
	{
		...
		case 4:
			{
				bpfv__CallFunc_SetCurrentCulture_ReturnValue__pf = UKismetInternationalizationLibrary::SetCurrentCulture(FString(TEXT("en")), true);
			}
		case 5:
			{
				RemoveFromParent();
		...
		case 21:
			{
				bpfv__CallFunc_SetCurrentCulture_ReturnValue_1__pf = UKismetInternationalizationLibrary::SetCurrentCulture(FString(TEXT("it")), true);
				__CurrentState = 5;
				break;
			}
		case 24:
		...
		case 25:
			{
				bpfv__CallFunc_SetCurrentCulture_ReturnValue_2__pf = UKismetInternationalizationLibrary::SetCurrentCulture(FString(TEXT("es")), true);
				__CurrentState = 5;
				break;
			}
		case 26:
			{
				bpfv__CallFunc_SetCurrentCulture_ReturnValue_3__pf = UKismetInternationalizationLibrary::SetCurrentCulture(FString(TEXT("pt")), true);
				__CurrentState = 5;
				break;
			}
		case 27:
		...
		case 29:
			{
				bpfv__CallFunc_SetCurrentCulture_ReturnValue_4__pf = UKismetInternationalizationLibrary::SetCurrentCulture(FString(TEXT("ru")), true);
				__CurrentState = 5;
				break;
			}
		case 30:
		...
		case 31:
			{
				bpfv__CallFunc_SetCurrentCulture_ReturnValue_5__pf = UKismetInternationalizationLibrary::SetCurrentCulture(FString(TEXT("zh")), true);
				__CurrentState = 5;
				break;
			}
		case 32:
		...
		case 33:
			{
				bpfv__CallFunc_SetCurrentCulture_ReturnValue_6__pf = UKismetInternationalizationLibrary::SetCurrentCulture(FString(TEXT("ca")), true);
				__CurrentState = 5;
				break;
			}
		case 35:
		...
		case 36:
			{
				bpfv__CallFunc_SetCurrentCulture_ReturnValue_7__pf = UKismetInternationalizationLibrary::SetCurrentCulture(FString(TEXT("fr")), true);
				__CurrentState = 5;
				break;
			}
		default:
...
void ULanguageHUD_C__pf49154685::bpf__ExecuteUbergraph_LanguageHUD__pf_1(int32 bpp__EntryPoint__pf)
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	int32 bpfv__CallFunc_Array_Length_ReturnValue__pf{};
	bool bpfv__CallFunc_Less_IntInt_ReturnValue__pf{};
	bool bpfv__CallFunc_HasAnyUserFocus_ReturnValue__pf{};
	...
	do
	{
		...
		case 11:
			{
				...
				{
					bpfv__CallFunc_HasAnyUserFocus_ReturnValue__pf = b1l__CallFunc_Array_Get_Item__pf->UWidget::HasAnyUserFocus();
				}
				if (!bpfv__CallFunc_HasAnyUserFocus_ReturnValue__pf)
				{
					__CurrentState = 16;
					break;
				}
		...
		case 12:
			{
				FCustomThunkTemplates::Array_Get(bpv__Buttons__pf, b1l__Temp_int_Array_Index_Variable__pf, /*out*/ b1l__CallFunc_Array_Get_Item__pf);
				(*(AccessPrivateProperty<FLinearColor >(&(b1l__K2Node_MakeStruct_SlateColor_2__pf), FSlateColor::__PPO__SpecifiedColor() ))) = FLinearColor(1.000000,1.000000,1.000000,1.000000);
				TEnumAsByte<ESlateColorStylingMode::Type>  __Local__110 = ESlateColorStylingMode::UseColor_Specified;
				(*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__K2Node_MakeStruct_SlateColor_2__pf), FSlateColor::__PPO__ColorUseRule() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.TintColor), FSlateColor::__PPO__ColorUseRule() )))) : (__Local__110));
				(*(AccessPrivateProperty<FLinearColor >(&(b1l__K2Node_MakeStruct_SlateColor_3__pf), FSlateColor::__PPO__SpecifiedColor() ))) = FLinearColor(1.000000,1.000000,1.000000,1.000000);
				TEnumAsByte<ESlateColorStylingMode::Type>  __Local__111 = ESlateColorStylingMode::UseColor_Specified;
				(*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__K2Node_MakeStruct_SlateColor_3__pf), FSlateColor::__PPO__ColorUseRule() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__ColorUseRule() )))) : (__Local__111));
				FVector2D  __Local__112 = FVector2D(0.000000,0.000000);
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.ImageSize = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.ImageSize) : (__Local__112));
				auto __Local__114 = FMargin{};
				FMargin  __Local__113 = __Local__114;
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.Margin = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Margin) : (__Local__113));
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.TintColor = b1l__K2Node_MakeStruct_SlateColor_2__pf;
				UObject*  __Local__115 = ((UObject*)nullptr);
				(*(AccessPrivateProperty<UObject* >(&(b1l__K2Node_MakeStruct_SlateBrush_2__pf), FSlateBrush::__PPO__ResourceObject() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<UObject* >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )))) : (__Local__115));
				TEnumAsByte<ESlateBrushDrawType::Type>  __Local__116 = ESlateBrushDrawType::NoDrawType;
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.DrawAs = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.DrawAs) : (__Local__116));
				TEnumAsByte<ESlateBrushTileType::Type>  __Local__117 = ESlateBrushTileType::NoTile;
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.Tiling = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Tiling) : (__Local__117));
				TEnumAsByte<ESlateBrushMirrorType::Type>  __Local__118 = ESlateBrushMirrorType::NoMirror;
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.Mirroring = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Mirroring) : (__Local__118));
				FVector2D  __Local__119 = FVector2D(0.000000,0.000000);
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.ImageSize = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.ImageSize) : (__Local__119));
				auto __Local__121 = FMargin{};
				FMargin  __Local__120 = __Local__121;
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.Margin = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Margin) : (__Local__120));
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.TintColor = b1l__K2Node_MakeStruct_SlateColor_3__pf;
				UObject*  __Local__122 = ((UObject*)nullptr);
				(*(AccessPrivateProperty<UObject* >(&(b1l__K2Node_MakeStruct_SlateBrush_3__pf), FSlateBrush::__PPO__ResourceObject() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<UObject* >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )))) : (__Local__122));
				TEnumAsByte<ESlateBrushDrawType::Type>  __Local__123 = ESlateBrushDrawType::NoDrawType;
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.DrawAs = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.DrawAs) : (__Local__123));
				TEnumAsByte<ESlateBrushTileType::Type>  __Local__124 = ESlateBrushTileType::NoTile;
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.Tiling = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Tiling) : (__Local__124));
				TEnumAsByte<ESlateBrushMirrorType::Type>  __Local__125 = ESlateBrushMirrorType::NoMirror;
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.Mirroring = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Mirroring) : (__Local__125));
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.Normal = b1l__K2Node_MakeStruct_SlateBrush_3__pf;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.Hovered = b1l__K2Node_MakeStruct_SlateBrush_2__pf;
				auto __Local__127 = FSlateBrush{};
				FSlateBrush  __Local__126 = __Local__127;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.Pressed = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Pressed) : (__Local__126));
				auto __Local__129 = FSlateBrush{};
				FSlateBrush  __Local__128 = __Local__129;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.Disabled = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Disabled) : (__Local__128));
				auto __Local__131 = FMargin{};
				FMargin  __Local__130 = __Local__131;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.NormalPadding = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.NormalPadding) : (__Local__130));
				auto __Local__133 = FMargin{};
				FMargin  __Local__132 = __Local__133;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.PressedPadding = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.PressedPadding) : (__Local__132));
				auto __Local__135 = FSlateSound{};
				FSlateSound  __Local__134 = __Local__135;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.PressedSlateSound = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.PressedSlateSound) : (__Local__134));
				auto __Local__137 = FSlateSound{};
				FSlateSound  __Local__136 = __Local__137;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.HoveredSlateSound = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.HoveredSlateSound) : (__Local__136));
				if(::IsValid(b1l__CallFunc_Array_Get_Item__pf))
				{
					b1l__CallFunc_Array_Get_Item__pf->UButton::SetStyle(b1l__K2Node_MakeStruct_ButtonStyle_1__pf);
				}
		...
		case 16:
			{
				...
				TEnumAsByte<ESlateColorStylingMode::Type>  __Local__138 = ESlateColorStylingMode::UseColor_Specified;
				(*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__K2Node_MakeStruct_SlateColor__pf), FSlateColor::__PPO__ColorUseRule() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.TintColor), FSlateColor::__PPO__ColorUseRule() )))) : (__Local__138));
				(*(AccessPrivateProperty<FLinearColor >(&(b1l__K2Node_MakeStruct_SlateColor_1__pf), FSlateColor::__PPO__SpecifiedColor() ))) = FLinearColor(1.000000,1.000000,1.000000,0.250000);
				TEnumAsByte<ESlateColorStylingMode::Type>  __Local__139 = ESlateColorStylingMode::UseColor_Specified;
				(*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__K2Node_MakeStruct_SlateColor_1__pf), FSlateColor::__PPO__ColorUseRule() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__ColorUseRule() )))) : (__Local__139));
				FVector2D  __Local__140 = FVector2D(0.000000,0.000000);
				b1l__K2Node_MakeStruct_SlateBrush__pf.ImageSize = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.ImageSize) : (__Local__140));
				auto __Local__142 = FMargin{};
				FMargin  __Local__141 = __Local__142;
				b1l__K2Node_MakeStruct_SlateBrush__pf.Margin = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Margin) : (__Local__141));
				b1l__K2Node_MakeStruct_SlateBrush__pf.TintColor = b1l__K2Node_MakeStruct_SlateColor__pf;
				UObject*  __Local__143 = ((UObject*)nullptr);
				(*(AccessPrivateProperty<UObject* >(&(b1l__K2Node_MakeStruct_SlateBrush__pf), FSlateBrush::__PPO__ResourceObject() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<UObject* >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )))) : (__Local__143));
				TEnumAsByte<ESlateBrushDrawType::Type>  __Local__144 = ESlateBrushDrawType::NoDrawType;
				b1l__K2Node_MakeStruct_SlateBrush__pf.DrawAs = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.DrawAs) : (__Local__144));
				TEnumAsByte<ESlateBrushTileType::Type>  __Local__145 = ESlateBrushTileType::NoTile;
				b1l__K2Node_MakeStruct_SlateBrush__pf.Tiling = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Tiling) : (__Local__145));
				TEnumAsByte<ESlateBrushMirrorType::Type>  __Local__146 = ESlateBrushMirrorType::NoMirror;
				b1l__K2Node_MakeStruct_SlateBrush__pf.Mirroring = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Mirroring) : (__Local__146));
				FVector2D  __Local__147 = FVector2D(0.000000,0.000000);
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.ImageSize = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.ImageSize) : (__Local__147));
				auto __Local__149 = FMargin{};
				FMargin  __Local__148 = __Local__149;
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.Margin = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Margin) : (__Local__148));
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.TintColor = b1l__K2Node_MakeStruct_SlateColor_1__pf;
				UObject*  __Local__150 = ((UObject*)nullptr);
				(*(AccessPrivateProperty<UObject* >(&(b1l__K2Node_MakeStruct_SlateBrush_1__pf), FSlateBrush::__PPO__ResourceObject() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<UObject* >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )))) : (__Local__150));
				TEnumAsByte<ESlateBrushDrawType::Type>  __Local__151 = ESlateBrushDrawType::NoDrawType;
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.DrawAs = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.DrawAs) : (__Local__151));
				TEnumAsByte<ESlateBrushTileType::Type>  __Local__152 = ESlateBrushTileType::NoTile;
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.Tiling = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Tiling) : (__Local__152));
				TEnumAsByte<ESlateBrushMirrorType::Type>  __Local__153 = ESlateBrushMirrorType::NoMirror;
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.Mirroring = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Mirroring) : (__Local__153));
				b1l__K2Node_MakeStruct_ButtonStyle__pf.Normal = b1l__K2Node_MakeStruct_SlateBrush_1__pf;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.Hovered = b1l__K2Node_MakeStruct_SlateBrush__pf;
				auto __Local__155 = FSlateBrush{};
				FSlateBrush  __Local__154 = __Local__155;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.Pressed = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Pressed) : (__Local__154));
				auto __Local__157 = FSlateBrush{};
				FSlateBrush  __Local__156 = __Local__157;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.Disabled = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Disabled) : (__Local__156));
				auto __Local__159 = FMargin{};
				FMargin  __Local__158 = __Local__159;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.NormalPadding = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.NormalPadding) : (__Local__158));
				auto __Local__161 = FMargin{};
				FMargin  __Local__160 = __Local__161;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.PressedPadding = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.PressedPadding) : (__Local__160));
				auto __Local__163 = FSlateSound{};
				FSlateSound  __Local__162 = __Local__163;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.PressedSlateSound = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.PressedSlateSound) : (__Local__162));
				auto __Local__165 = FSlateSound{};
				FSlateSound  __Local__164 = __Local__165;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.HoveredSlateSound = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.HoveredSlateSound) : (__Local__164));
				if(::IsValid(b1l__CallFunc_Array_Get_Item__pf))
				{
					b1l__CallFunc_Array_Get_Item__pf->UButton::SetStyle(b1l__K2Node_MakeStruct_ButtonStyle__pf);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
void ULanguageHUD_C__pf49154685::bpf__ExecuteUbergraph_LanguageHUD__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 17);
	// optimized KCST_UnconditionalGoto
	b1l__K2Node_MakeArray_Array__pf.SetNum(8, true);
	b1l__K2Node_MakeArray_Array__pf[0] = bpv__Button_Ita__pf;
	b1l__K2Node_MakeArray_Array__pf[1] = bpv__Button_English__pf;
	b1l__K2Node_MakeArray_Array__pf[2] = bpv__Button_Ru__pf;
	b1l__K2Node_MakeArray_Array__pf[3] = bpv__Button_Zh__pf;
	b1l__K2Node_MakeArray_Array__pf[4] = bpv__Button_Es__pf;
	b1l__K2Node_MakeArray_Array__pf[5] = bpv__Button_Pt__pf;
	b1l__K2Node_MakeArray_Array__pf[6] = bpv__Button_Ca__pf;
	b1l__K2Node_MakeArray_Array__pf[7] = bpv__Button_Fr__pf;
	bpv__Buttons__pf = b1l__K2Node_MakeArray_Array__pf;
	Super::bpf__Construct__pf();
	return; //KCST_EndOfThread
}
void ULanguageHUD_C__pf49154685::bpf__ExecuteUbergraph_LanguageHUD__pf_3(int32 bpp__EntryPoint__pf)
{
...
void ULanguageHUD_C__pf49154685::bpf__BndEvt__Button_Fr_K2Node_ComponentBoundEvent_7_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD__pf_0(35);
}
void ULanguageHUD_C__pf49154685::bpf__UpdateFocus__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD__pf_1(34);
}
void ULanguageHUD_C__pf49154685::bpf__BndEvt__Button_Ca_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD__pf_0(32);
}
void ULanguageHUD_C__pf49154685::bpf__BndEvt__Button_Zh_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD__pf_0(30);
}
void ULanguageHUD_C__pf49154685::bpf__BndEvt__Button_Ru_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD__pf_0(28);
}
void ULanguageHUD_C__pf49154685::bpf__BndEvt__Button_2_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD__pf_0(27);
}
void ULanguageHUD_C__pf49154685::bpf__BndEvt__Button_1_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD__pf_0(24);
}
void ULanguageHUD_C__pf49154685::bpf__BndEvt__Button_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD__pf_0(20);
}
void ULanguageHUD_C__pf49154685::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD__pf_2(17);
}
void ULanguageHUD_C__pf49154685::bpf__BndEvt__Button_117_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD__pf_0(3);
}
void ULanguageHUD_C__pf49154685::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_LanguageHUD__pf_3(1);
}
FSlateBrush  ULanguageHUD_C__pf49154685::bpf__GetBrush_0__pf()
{
	...
	do
	{
		...
		case 1:
			{
				const UScriptStruct* __Local__167 = FSlateBrush::StaticStruct();
				uint8* __Local__168 = (uint8*)FMemory_Alloca(__Local__167->GetStructureSize());
				__Local__167->InitializeStruct(__Local__168);
				FSlateBrush& __Local__166 = *reinterpret_cast<FSlateBrush*>(__Local__168);
				__Local__166.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__169 = (*(AccessPrivateProperty<UObject* >(&(__Local__166), FSlateBrush::__PPO__ResourceObject() )));
				__Local__169 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
				bpfv__Default_Slate__pf = __Local__166;
			}
		case 2:
			{
				const UScriptStruct* __Local__171 = FSlateBrush::StaticStruct();
				uint8* __Local__172 = (uint8*)FMemory_Alloca(__Local__171->GetStructureSize());
				__Local__171->InitializeStruct(__Local__172);
				FSlateBrush& __Local__170 = *reinterpret_cast<FSlateBrush*>(__Local__172);
				__Local__170.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__173 = (*(AccessPrivateProperty<UObject* >(&(__Local__170), FSlateBrush::__PPO__ResourceObject() )));
				__Local__173 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed);
				bpfv__LV3_Slate__pf = __Local__170;
			}
		case 3:
			{
				const UScriptStruct* __Local__175 = FSlateBrush::StaticStruct();
				uint8* __Local__176 = (uint8*)FMemory_Alloca(__Local__175->GetStructureSize());
				__Local__175->InitializeStruct(__Local__176);
				FSlateBrush& __Local__174 = *reinterpret_cast<FSlateBrush*>(__Local__176);
				__Local__174.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__177 = (*(AccessPrivateProperty<UObject* >(&(__Local__174), FSlateBrush::__PPO__ResourceObject() )));
				__Local__177 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[11], ECastCheckedType::NullAllowed);
				bpfv__LV6_Slate__pf = __Local__174;
			}
		case 4:
			{
				const UScriptStruct* __Local__179 = FSlateBrush::StaticStruct();
				uint8* __Local__180 = (uint8*)FMemory_Alloca(__Local__179->GetStructureSize());
				__Local__179->InitializeStruct(__Local__180);
				FSlateBrush& __Local__178 = *reinterpret_cast<FSlateBrush*>(__Local__180);
				__Local__178.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__181 = (*(AccessPrivateProperty<UObject* >(&(__Local__178), FSlateBrush::__PPO__ResourceObject() )));
				__Local__181 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[12], ECastCheckedType::NullAllowed);
				bpfv__LV8_Slate__pf = __Local__178;
			}
		case 5:
			{
				const UScriptStruct* __Local__183 = FSlateBrush::StaticStruct();
				uint8* __Local__184 = (uint8*)FMemory_Alloca(__Local__183->GetStructureSize());
				__Local__183->InitializeStruct(__Local__184);
				FSlateBrush& __Local__182 = *reinterpret_cast<FSlateBrush*>(__Local__184);
				__Local__182.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__185 = (*(AccessPrivateProperty<UObject* >(&(__Local__182), FSlateBrush::__PPO__ResourceObject() )));
				__Local__185 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[13], ECastCheckedType::NullAllowed);
				bpfv__LV12_Slate__pf = __Local__182;
			}
		case 6:
			{
				const UScriptStruct* __Local__187 = FSlateBrush::StaticStruct();
				uint8* __Local__188 = (uint8*)FMemory_Alloca(__Local__187->GetStructureSize());
				__Local__187->InitializeStruct(__Local__188);
				FSlateBrush& __Local__186 = *reinterpret_cast<FSlateBrush*>(__Local__188);
				__Local__186.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__189 = (*(AccessPrivateProperty<UObject* >(&(__Local__186), FSlateBrush::__PPO__ResourceObject() )));
				__Local__189 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[14], ECastCheckedType::NullAllowed);
				bpfv__Endgame_Slate__pf = __Local__186;
			}
		case 7:
			{
				const UScriptStruct* __Local__191 = FSlateBrush::StaticStruct();
				uint8* __Local__192 = (uint8*)FMemory_Alloca(__Local__191->GetStructureSize());
				__Local__191->InitializeStruct(__Local__192);
				FSlateBrush& __Local__190 = *reinterpret_cast<FSlateBrush*>(__Local__192);
				__Local__190.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__193 = (*(AccessPrivateProperty<UObject* >(&(__Local__190), FSlateBrush::__PPO__ResourceObject() )));
				__Local__193 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_C__pf49154685::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
				bpfv__FinalSlate__pf = __Local__190;
			}
		case 8:
			{
		...
		case 10:
			{
				int32  __Local__194 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__194)), 0);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				}
				int32  __Local__195 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__195)), 1);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				}
				int32  __Local__196 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__196)), 2);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				}
				int32  __Local__197 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__197)), 3);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				}
				int32  __Local__198 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__198)), 4);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				}
				int32  __Local__199 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__199)), 5);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				}
				int32  __Local__200 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__200)), 6);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				}
				int32  __Local__201 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__201)), 7);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 15;
					break;
				}
				int32  __Local__202 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__202)), 8);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 15;
					break;
				}
				int32  __Local__203 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__203)), 9);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				}
				int32  __Local__204 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__204)), 10);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				}
				int32  __Local__205 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__205)), 11);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				}
				int32  __Local__206 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__206)), 12);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				}
				int32  __Local__207 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__207)), 13);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 17;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__208)), 14);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__209)), 15);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__210)), 16);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__211)), 17);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
...
PRAGMA_DISABLE_OPTIMIZATION
void ULanguageHUD_C__pf49154685::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ULanguageHUD_C__pf49154685::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{208, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/SlateCore.SlateBrush 
		{21, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/SlateCore.ButtonStyle 
		...
		{331, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.HorizontalBox 
		...
		{555, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.ScaleBox 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ULanguageHUD_C__pf49154685
{
	FRegisterHelper__ULanguageHUD_C__pf49154685()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/LanguageHUD/LanguageHUD"), &ULanguageHUD_C__pf49154685::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ULanguageHUD_C__pf49154685 Instance;
};
FRegisterHelper__ULanguageHUD_C__pf49154685 FRegisterHelper__ULanguageHUD_C__pf49154685::Instance;
