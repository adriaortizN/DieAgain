...
#include "GodMode_PutOff__pf575650485.h"
...
UPauseHUD_C__pf197907997::UPauseHUD_C__pf197907997(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Button_GodMode__pf = nullptr;
	bpv__Button_Options__pf = nullptr;
	bpv__Button_Restart__pf = nullptr;
	bpv__Button_Resume__pf = nullptr;
	bpv__Button_ReturnToWorld__pf = nullptr;
	bpv__Button_Twitter__pf = nullptr;
}
PRAGMA_ENABLE_OPTIMIZATION
void UPauseHUD_C__pf197907997::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UPauseHUD_C__pf197907997::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UGodMode_PutOff_C__pf575650485::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UGodMode_WB_C__pf575650485::StaticClass());
	...
	InDynamicClass->ReferencedConvertedFields.Add(UWalkMap_HUDre_C__pf197907997::StaticClass());
	...
	__Local__2.ComponentPropertyName = FName(TEXT("Button_GodMode"));
	__Local__2.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__Button_GodMode_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__3 = __Local__0->ComponentDelegateBindings[1];
	__Local__3.ComponentPropertyName = FName(TEXT("Button_Twitter"));
	__Local__3.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__Button_323_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__4 = __Local__0->ComponentDelegateBindings[2];
	__Local__4.ComponentPropertyName = FName(TEXT("Button_Options"));
	__Local__4.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__Button_397_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__5 = __Local__0->ComponentDelegateBindings[3];
	__Local__5.ComponentPropertyName = FName(TEXT("Button_Restart"));
	__Local__5.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__5.FunctionNameToBind = FName(TEXT("BndEvt__Button_262_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__6 = __Local__0->ComponentDelegateBindings[4];
	__Local__6.ComponentPropertyName = FName(TEXT("Button_ReturnToWorld"));
	__Local__6.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__6.FunctionNameToBind = FName(TEXT("BndEvt__Button_519_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__7 = __Local__0->ComponentDelegateBindings[5];
	__Local__7.ComponentPropertyName = FName(TEXT("Button_Resume"));
	__Local__7.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__7.FunctionNameToBind = FName(TEXT("BndEvt__Button_56_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__9.Reserve(3);
	auto __Local__10 = NewObject<UCanvasPanelSlot>(__Local__8, TEXT("CanvasPanelSlot_5"), (EObjectFlags)0x00280008);
	__Local__10->LayoutData.Offsets.Left = -261.921875f;
	__Local__10->LayoutData.Offsets.Top = 3.459473f;
	__Local__10->LayoutData.Offsets.Right = 120.000000f;
	__Local__10->LayoutData.Offsets.Bottom = 120.000000f;
	__Local__10->LayoutData.Anchors.Minimum = FVector2D(1.000000, 0.500000);
	__Local__10->LayoutData.Anchors.Maximum = FVector2D(1.000000, 0.500000);
	__Local__10->Parent = __Local__8;
	auto __Local__11 = NewObject<UButton>(__Local__1, TEXT("Button_Twitter"), (EObjectFlags)0x00280008);
	__Local__11->WidgetStyle.Normal.ImageSize = FVector2D(1200.000000, 1200.000000);
	auto& __Local__12 = (*(AccessPrivateProperty<UObject* >(&(__Local__11->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__12 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__11->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__11->WidgetStyle.Hovered.ImageSize = FVector2D(1200.000000, 1000.000000);
	auto& __Local__13 = (*(AccessPrivateProperty<UObject* >(&(__Local__11->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__13 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__11->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__11->WidgetStyle.Pressed.ImageSize = FVector2D(1200.000000, 1000.000000);
	auto& __Local__14 = (*(AccessPrivateProperty<UObject* >(&(__Local__11->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__14 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__11->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	...
	auto __Local__15 = NewObject<UCanvasPanelSlot>(__Local__8, TEXT("CanvasPanelSlot_2"), (EObjectFlags)0x00280008);
	__Local__15->LayoutData.Offsets.Left = -380.960938f;
	__Local__15->LayoutData.Offsets.Top = 104.000000f;
	__Local__15->LayoutData.Offsets.Right = 761.283508f;
	__Local__15->LayoutData.Offsets.Bottom = 178.148163f;
	...
	auto __Local__16 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock"), (EObjectFlags)0x00280008);
	__Local__16->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[2D41A0714A12E445CC11B5AE339223FA]\", \"FE8D687C4B00AE874954BF9E3D3AB477\", \"Game Paused\")")	);
	__Local__16->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	...
	auto __Local__18 = NewObject<UCanvasPanelSlot>(__Local__8, TEXT("CanvasPanelSlot_0"), (EObjectFlags)0x00280008);
	__Local__18->LayoutData.Offsets.Left = -4.496246f;
	__Local__18->LayoutData.Offsets.Top = 103.994225f;
	__Local__18->LayoutData.Offsets.Right = 584.929382f;
	__Local__18->LayoutData.Offsets.Bottom = 665.069519f;
	...
	auto __Local__19 = NewObject<UVerticalBox>(__Local__1, TEXT("VerticalBox_258"), (EObjectFlags)0x00280008);
	...
	__Local__20.Reserve(5);
	auto __Local__21 = NewObject<UVerticalBoxSlot>(__Local__19, TEXT("VerticalBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__21->Padding.Bottom = 30.000000f;
	__Local__21->Parent = __Local__19;
	auto __Local__22 = NewObject<UButton>(__Local__1, TEXT("Button_Resume"), (EObjectFlags)0x00280008);
	...
	__Local__24 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	...
	__Local__25 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	...
	__Local__27 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	...
	auto __Local__30 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_195"), (EObjectFlags)0x00280008);
	__Local__30->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[2D41A0714A12E445CC11B5AE339223FA]\", \"CB4BE0544CADB4378EA8F19523F3B118\", \"Resume\")")	);
	...
	__Local__30->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__30->Font.OutlineSettings.OutlineSize = 5;
	__Local__30->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__30->Font.Size = 35;
	auto& __Local__32 = (*(AccessPrivateProperty<FMargin >((__Local__30), UTextLayoutWidget::__PPO__Margin() )));
	__Local__32.Left = 10.000000f;
	__Local__32.Top = 10.000000f;
	__Local__32.Right = 10.000000f;
	__Local__32.Bottom = 10.000000f;
	...
	auto __Local__33 = NewObject<UVerticalBoxSlot>(__Local__19, TEXT("VerticalBoxSlot_1"), (EObjectFlags)0x00280008);
	__Local__33->Padding.Top = 30.000000f;
	__Local__33->Padding.Bottom = 30.000000f;
	__Local__33->Parent = __Local__19;
	auto __Local__34 = NewObject<UButton>(__Local__1, TEXT("Button_Restart"), (EObjectFlags)0x00280008);
	...
	__Local__36 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	...
	__Local__37 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	...
	__Local__39 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	...
	auto __Local__42 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_256"), (EObjectFlags)0x00280008);
	__Local__42->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[2D41A0714A12E445CC11B5AE339223FA]\", \"05B6F7F94566E1E1A6CF64A4BE47BD20\", \"Restart level\")")	);
	...
	__Local__42->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__42->Font.OutlineSettings.OutlineSize = 5;
	__Local__42->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__42->Font.Size = 35;
	auto& __Local__44 = (*(AccessPrivateProperty<FMargin >((__Local__42), UTextLayoutWidget::__PPO__Margin() )));
	__Local__44.Left = 10.000000f;
	__Local__44.Top = 10.000000f;
	__Local__44.Right = 10.000000f;
	__Local__44.Bottom = 10.000000f;
	...
	auto __Local__45 = NewObject<UVerticalBoxSlot>(__Local__19, TEXT("VerticalBoxSlot_2"), (EObjectFlags)0x00280008);
	__Local__45->Padding.Top = 30.000000f;
	__Local__45->Padding.Bottom = 30.000000f;
	__Local__45->Parent = __Local__19;
	auto __Local__46 = NewObject<UButton>(__Local__1, TEXT("Button_Options"), (EObjectFlags)0x00280008);
	__Local__46->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__47 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__46->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__47 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__48 = (*(AccessPrivateProperty<UObject* >(&(__Local__46->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__48 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	__Local__46->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__49 = (*(AccessPrivateProperty<UObject* >(&(__Local__46->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__49 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	__Local__46->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__50 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__46->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__50 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__51 = (*(AccessPrivateProperty<UObject* >(&(__Local__46->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__51 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	auto& __Local__52 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__46), UPanelWidget::__PPO__Slots() )));
	__Local__52 = TArray<UPanelSlot*> ();
	__Local__52.Reserve(1);
	auto __Local__53 = NewObject<UButtonSlot>(__Local__46, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__53->Parent = __Local__46;
	auto __Local__54 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_462"), (EObjectFlags)0x00280008);
	__Local__54->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[2D41A0714A12E445CC11B5AE339223FA]\", \"A03A1A264A083C3F9FAA0493AACCBBD1\", \"Options\")")	);
	auto& __Local__55 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__54->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__55 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__54->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__54->Font.OutlineSettings.OutlineSize = 5;
	__Local__54->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__54->Font.Size = 35;
	auto& __Local__56 = (*(AccessPrivateProperty<FMargin >((__Local__54), UTextLayoutWidget::__PPO__Margin() )));
	__Local__56.Left = 10.000000f;
	__Local__56.Top = 10.000000f;
	__Local__56.Right = 10.000000f;
	__Local__56.Bottom = 10.000000f;
	...
	__Local__20.Add(__Local__45);
	auto __Local__57 = NewObject<UVerticalBoxSlot>(__Local__19, TEXT("VerticalBoxSlot_4"), (EObjectFlags)0x00280008);
	__Local__57->Padding.Top = 30.000000f;
	__Local__57->Padding.Bottom = 30.000000f;
	__Local__57->Parent = __Local__19;
	auto __Local__58 = NewObject<UButton>(__Local__1, TEXT("Button_GodMode"), (EObjectFlags)0x00280008);
	__Local__58->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	...
	__Local__59 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__60 = (*(AccessPrivateProperty<UObject* >(&(__Local__58->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__60 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	__Local__58->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__61 = (*(AccessPrivateProperty<UObject* >(&(__Local__58->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__61 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	__Local__58->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__62 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__58->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__62 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__63 = (*(AccessPrivateProperty<UObject* >(&(__Local__58->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__63 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	auto& __Local__64 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__58), UPanelWidget::__PPO__Slots() )));
	__Local__64 = TArray<UPanelSlot*> ();
	__Local__64.Reserve(1);
	auto __Local__65 = NewObject<UButtonSlot>(__Local__58, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__65->Parent = __Local__58;
	auto __Local__66 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_1"), (EObjectFlags)0x00280008);
	__Local__66->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[2D41A0714A12E445CC11B5AE339223FA]\", \"26F1B5DD4C8D2351D8ACD88D783526A2\", \"God Mode\")")	);
	auto& __Local__67 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__66->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__67 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__66->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__66->Font.OutlineSettings.OutlineSize = 5;
	__Local__66->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__66->Font.Size = 35;
	auto& __Local__68 = (*(AccessPrivateProperty<FMargin >((__Local__66), UTextLayoutWidget::__PPO__Margin() )));
	__Local__68.Left = 10.000000f;
	__Local__68.Top = 10.000000f;
	__Local__68.Right = 10.000000f;
	__Local__68.Bottom = 10.000000f;
	...
	__Local__20.Add(__Local__57);
	auto __Local__69 = NewObject<UVerticalBoxSlot>(__Local__19, TEXT("VerticalBoxSlot_3"), (EObjectFlags)0x00280008);
	__Local__69->Padding.Top = 30.000000f;
	__Local__69->Parent = __Local__19;
	auto __Local__70 = NewObject<UButton>(__Local__1, TEXT("Button_ReturnToWorld"), (EObjectFlags)0x00280008);
	__Local__70->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	...
	__Local__71 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__72 = (*(AccessPrivateProperty<UObject* >(&(__Local__70->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__72 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	__Local__70->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__73 = (*(AccessPrivateProperty<UObject* >(&(__Local__70->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__73 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	__Local__70->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__74 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__70->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__74 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__75 = (*(AccessPrivateProperty<UObject* >(&(__Local__70->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__75 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	auto& __Local__76 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__70), UPanelWidget::__PPO__Slots() )));
	__Local__76 = TArray<UPanelSlot*> ();
	__Local__76.Reserve(1);
	auto __Local__77 = NewObject<UButtonSlot>(__Local__70, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__77->Parent = __Local__70;
	auto __Local__78 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_606"), (EObjectFlags)0x00280008);
	__Local__78->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[2D41A0714A12E445CC11B5AE339223FA]\", \"32C9CD6746306169A5A1C1BB62217BD5\", \"Return to World Map\")")	);
	auto& __Local__79 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__78->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__79 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__78->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__78->Font.OutlineSettings.OutlineSize = 5;
	__Local__78->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__78->Font.Size = 33;
	auto& __Local__80 = (*(AccessPrivateProperty<FMargin >((__Local__78), UTextLayoutWidget::__PPO__Margin() )));
	__Local__80.Left = 10.000000f;
	__Local__80.Top = 10.000000f;
	__Local__80.Right = 10.000000f;
	__Local__80.Bottom = 10.000000f;
	...
	__Local__20.Add(__Local__69);
	__Local__19->Slot = __Local__18;
	auto __Local__81 = NewObject<UWidgetNavigation>(__Local__19, TEXT("WidgetNavigation_0"), (EObjectFlags)0x00280008);
	__Local__81->Up.Rule = EUINavigationRule::Stop;
	__Local__81->Down.Rule = EUINavigationRule::Stop;
	__Local__19->Navigation = __Local__81;
	__Local__18->Content = __Local__19;
	__Local__9.Add(__Local__18);
	__Local__1->RootWidget = __Local__8;
}
PRAGMA_ENABLE_OPTIMIZATION
void UPauseHUD_C__pf197907997::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__82;
	SlotNames.Append(__Local__82);
}
void UPauseHUD_C__pf197907997::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__83;
	TArray<FDelegateRuntimeBinding>  __Local__84;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UPauseHUD_C__pf197907997::StaticClass())->MiscConvertedSubobjects[0]), __Local__83, __Local__84);
}
void UPauseHUD_C__pf197907997::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UPauseHUD_C__pf197907997::bpf__ExecuteUbergraph_PauseHUD__pf_0(int32 bpp__EntryPoint__pf)
{
	UGodMode_PutOff_C__pf575650485* bpfv__CallFunc_Create_ReturnValue__pf{};
	UGodMode_WB_C__pf575650485* bpfv__CallFunc_Create_ReturnValue_1__pf{};
	...
	do
	{
		...
		case 11:
			{
				bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UGodMode_PutOff_C__pf575650485>(UWidgetBlueprintLibrary::Create(this, UGodMode_PutOff_C__pf575650485::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
			}
		case 12:
			{
				...
				b1l__K2Node_DynamicCast_bSuccess_5__pf = (b1l__K2Node_DynamicCast_AsDie_Again_Gamemode_2__pf != nullptr);;
		...
		case 13:
			{
				...
				{
					b1l__K2Node_DynamicCast_AsDie_Again_Gamemode_2__pf->bpf__ResetWidget__pf(bpfv__CallFunc_Create_ReturnValue__pf);
				}
			}
		case 14:
			{
		...
		case 43:
			{
				bpfv__CallFunc_Create_ReturnValue_1__pf = CastChecked<UGodMode_WB_C__pf575650485>(UWidgetBlueprintLibrary::Create(this, UGodMode_WB_C__pf575650485::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
			}
		case 44:
			{
		...
		case 58:
			{
				bool  __Local__85 = false;
				if (!((::IsValid(b1l__K2Node_DynamicCast_AsMy_Game_Instance_1__pf)) ? (b1l__K2Node_DynamicCast_AsMy_Game_Instance_1__pf->bpv__IsGodModeActive__pf) : (__Local__85)))
				{
					__CurrentState = 43;
					break;
				}
...
void UPauseHUD_C__pf197907997::bpf__ExecuteUbergraph_PauseHUD__pf_1(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_SetGamePaused_ReturnValue__pf{};
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	int32 bpfv__CallFunc_Array_Length_ReturnValue__pf{};
	UWalkMap_HUDre_C__pf197907997* bpfv__CallFunc_Create_ReturnValue_2__pf{};
	bool bpfv__CallFunc_Less_IntInt_ReturnValue__pf{};
	bool bpfv__CallFunc_SetGamePaused_ReturnValue_1__pf{};
	bool bpfv__CallFunc_SetGamePaused_ReturnValue_3__pf{};
	UHUDre_C__pf2299784250* bpfv__CallFunc_Create_ReturnValue_4__pf{};
	...
	do
	{
		...
		case 19:
			{
				...
				b1l__K2Node_DynamicCast_AsPlayer_Walk_Map_Character__pf = Cast<APlayerWalkMap_Character_C__pf2222656877>(b1l__CallFunc_Array_Get_Item__pf);
				b1l__K2Node_DynamicCast_bSuccess_2__pf = (b1l__K2Node_DynamicCast_AsPlayer_Walk_Map_Character__pf != nullptr);;
		...
		case 20:
			{
				bpfv__CallFunc_Create_ReturnValue_2__pf = CastChecked<UWalkMap_HUDre_C__pf197907997>(UWidgetBlueprintLibrary::Create(this, UWalkMap_HUDre_C__pf197907997::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
			}
		case 21:
			{
		...
		case 23:
			{
				if(::IsValid(b1l__K2Node_DynamicCast_AsPlayer_Walk_Map_Character__pf) && ::IsValid(b1l__K2Node_DynamicCast_AsPlayer_Walk_Map_Character__pf->bpv__WalkMapMusic__pf))
				{
					b1l__K2Node_DynamicCast_AsPlayer_Walk_Map_Character__pf->bpv__WalkMapMusic__pf->UFMODAudioComponent::SetVolume(1.000000);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 24:
			{
				bpfv__CallFunc_SetGamePaused_ReturnValue_3__pf = UGameplayStatics::SetGamePaused(this, false);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 25:
			{
				bpfv__CallFunc_Create_ReturnValue_4__pf = CastChecked<UHUDre_C__pf2299784250>(UWidgetBlueprintLibrary::Create(this, UHUDre_C__pf2299784250::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
			}
		case 26:
			{
		...
		case 47:
			{
				...
				UGameplayStatics::GetAllActorsOfClass(this, APlayerWalkMap_Character_C__pf2222656877::StaticClass(), /*out*/ TArrayCaster<APlayerWalkMap_Character_C__pf2222656877*>(b1l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
			}
		case 48:
			{
...
void UPauseHUD_C__pf197907997::bpf__ExecuteUbergraph_PauseHUD__pf_2(int32 bpp__EntryPoint__pf)
{
	UOptionsHUD_C__pf3479267681* bpfv__CallFunc_Create_ReturnValue_3__pf{};
	AGameModeBase* bpfv__CallFunc_GetGameMode_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 37);
	// optimized KCST_UnconditionalGoto
	RemoveFromParent();
	bpfv__CallFunc_Create_ReturnValue_3__pf = CastChecked<UOptionsHUD_C__pf3479267681>(UWidgetBlueprintLibrary::Create(this, UOptionsHUD_C__pf3479267681::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
...
void UPauseHUD_C__pf197907997::bpf__ExecuteUbergraph_PauseHUD__pf_3(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue__pf{};
	bool bpfv__CallFunc_SetGamePaused_ReturnValue_2__pf{};
	...
	b1l__K2Node_MakeArray_Array__pf[0] = bpv__Button_Resume__pf;
	b1l__K2Node_MakeArray_Array__pf[1] = bpv__Button_Restart__pf;
	b1l__K2Node_MakeArray_Array__pf[2] = bpv__Button_Twitter__pf;
	b1l__K2Node_MakeArray_Array__pf[3] = bpv__Button_Options__pf;
	b1l__K2Node_MakeArray_Array__pf[4] = bpv__Button_ReturnToWorld__pf;
	b1l__K2Node_MakeArray_Array__pf[5] = bpv__Button_GodMode__pf;
	bpv__Buttons__pf = b1l__K2Node_MakeArray_Array__pf;
	Super::bpf__Construct__pf();
	bpfv__CallFunc_SetGamePaused_ReturnValue_2__pf = UGameplayStatics::SetGamePaused(this, true);
	return; //KCST_EndOfThread
}
void UPauseHUD_C__pf197907997::bpf__ExecuteUbergraph_PauseHUD__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 8);
	// optimized KCST_UnconditionalGoto
	bpf__ClosexMenu__pfT();
	return; //KCST_EndOfThread
}
void UPauseHUD_C__pf197907997::bpf__ExecuteUbergraph_PauseHUD__pf_5(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_CanLaunchURL_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 50);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_CanLaunchURL_ReturnValue__pf = UKismetSystemLibrary::CanLaunchURL(FString(TEXT("https://twitter.com/DieAgain_Game")));
	if (!bpfv__CallFunc_CanLaunchURL_ReturnValue__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	UKismetSystemLibrary::LaunchURL(FString(TEXT("https://twitter.com/DieAgain_Game")));
	return; //KCST_EndOfThread
}
void UPauseHUD_C__pf197907997::bpf__ExecuteUbergraph_PauseHUD__pf_6(int32 bpp__EntryPoint__pf)
{
...
void UPauseHUD_C__pf197907997::bpf__ExecuteUbergraph_PauseHUD__pf_7(int32 bpp__EntryPoint__pf)
{
	...
	{
		b1l__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpf__ResetPoints__pf();
	}
...
void UPauseHUD_C__pf197907997::bpf__ExecuteUbergraph_PauseHUD__pf_8(int32 bpp__EntryPoint__pf)
{
...
void UPauseHUD_C__pf197907997::bpf__BndEvt__Button_GodMode_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PauseHUD__pf_0(55);
}
void UPauseHUD_C__pf197907997::bpf__ClosexMenu__pfT()
{
	bpf__ExecuteUbergraph_PauseHUD__pf_1(54);
}
void UPauseHUD_C__pf197907997::bpf__BndEvt__Button_323_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PauseHUD__pf_5(50);
}
void UPauseHUD_C__pf197907997::bpf__BndEvt__Button_397_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PauseHUD__pf_2(37);
}
void UPauseHUD_C__pf197907997::bpf__BndEvt__Button_262_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PauseHUD__pf_7(32);
}
void UPauseHUD_C__pf197907997::bpf__BndEvt__Button_519_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PauseHUD__pf_6(29);
}
void UPauseHUD_C__pf197907997::bpf__BndEvt__Button_56_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PauseHUD__pf_4(8);
}
void UPauseHUD_C__pf197907997::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_PauseHUD__pf_8(6);
}
void UPauseHUD_C__pf197907997::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_PauseHUD__pf_3(1);
}
void UPauseHUD_C__pf197907997::bpf__GetText_0__pf()
{
	FText bpfv__TextPause__pf{};
}
void UPauseHUD_C__pf197907997::bpf__GetText_1__pf()
{
	FText bpfv__TextResume__pf{};
}
void UPauseHUD_C__pf197907997::bpf__GetText_2__pf()
{
	FText bpfv__TextReturn__pf{};
}
void UPauseHUD_C__pf197907997::bpf__GetText_3__pf()
{
	FText bpfv__TextControlsTips__pf{};
}
void UPauseHUD_C__pf197907997::bpf__GetText_4__pf()
{
	FText bpfv__TextWorldMap__pf{};
}
PRAGMA_DISABLE_OPTIMIZATION
void UPauseHUD_C__pf197907997::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UPauseHUD_C__pf197907997::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{743, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/GodMode/GodMode_PutOff.GodMode_PutOff_C 
		{744, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/GodMode/GodMode_WB.GodMode_WB_C 
		...
		{745, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/WalkMap_HUDre.WalkMap_HUDre_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UPauseHUD_C__pf197907997
{
	FRegisterHelper__UPauseHUD_C__pf197907997()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/PauseHUD"), &UPauseHUD_C__pf197907997::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UPauseHUD_C__pf197907997 Instance;
};
FRegisterHelper__UPauseHUD_C__pf197907997 FRegisterHelper__UPauseHUD_C__pf197907997::Instance;
