...
#include "SaveShaldDeath__pf3264546738.h"
...
USaveShaldDeath_C__pf3264546738::USaveShaldDeath_C__pf3264546738(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__MatineeToPlay__pf = nullptr;
	bpv__TestSave__pf = nullptr;
	bpv__UnlockedLevel__pf = E__EnumLevelsUnlockeds__pf::NewEnumerator5;
}
PRAGMA_ENABLE_OPTIMIZATION
void USaveShaldDeath_C__pf3264546738::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void USaveShaldDeath_C__pf3264546738::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void USaveShaldDeath_C__pf3264546738::bpf__ExecuteUbergraph_SaveShaldDeath__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsSave_Game_BP__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess_2__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	bpv__TestSave__pf = b0l__K2Node_DynamicCast_AsSave_Game_BP__pf;
	if(::IsValid(b0l__K2Node_DynamicCast_AsSave_Game_BP__pf))
	{
		b0l__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__ShaldIsInVaria__pf = false;
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsSave_Game_BP__pf))
	{
		b0l__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__ShaldInVariaForCyber__pf = false;
	}
	...
	b0l__K2Node_DynamicCast_AsConversation_Actor__pf = Cast<AConversation_Actor_C__pf2744501483>(b0l__K2Node_Event_NPCActor__pf);
	b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsConversation_Actor__pf != nullptr);;
	...
	{
		b0l__K2Node_DynamicCast_AsConversation_Actor__pf->bpf__LoadLevel__pf(bpv__MatineeToPlay__pf);
	}
	return; // KCST_GotoReturn
}
void USaveShaldDeath_C__pf3264546738::RecieveEventTriggered_Implementation(APlayerController* bpp__ConsideringPlayer__pf, AActor* bpp__NPCActor__pf)
{
	b0l__K2Node_Event_ConsideringPlayer__pf = bpp__ConsideringPlayer__pf;
	b0l__K2Node_Event_NPCActor__pf = bpp__NPCActor__pf;
	bpf__ExecuteUbergraph_SaveShaldDeath__pf_0(5);
}
PRAGMA_DISABLE_OPTIMIZATION
void USaveShaldDeath_C__pf3264546738::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void USaveShaldDeath_C__pf3264546738::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__USaveShaldDeath_C__pf3264546738
{
	FRegisterHelper__USaveShaldDeath_C__pf3264546738()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Conversations/Events/SaveShaldDeath"), &USaveShaldDeath_C__pf3264546738::__StaticDependenciesAssets);
	}
	static FRegisterHelper__USaveShaldDeath_C__pf3264546738 Instance;
};
FRegisterHelper__USaveShaldDeath_C__pf3264546738 FRegisterHelper__USaveShaldDeath_C__pf3264546738::Instance;
