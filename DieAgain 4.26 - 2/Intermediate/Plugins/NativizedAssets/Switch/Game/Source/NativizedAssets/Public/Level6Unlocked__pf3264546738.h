...
class AActor;
#include "Level6Unlocked__pf3264546738.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Conversations/Events/Level6Unlocked.Level6Unlocked_C", OverrideNativeName="Level6Unlocked_C"))
class ULevel6Unlocked_C__pf3264546738 : public UDialogueEvents
{
public:
	GENERATED_BODY()
	...
	ULevel6Unlocked_C__pf3264546738(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Level6Unlocked__pf_0(int32 bpp__EntryPoint__pf);
