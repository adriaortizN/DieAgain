...
#include "BP_Locker06__pf213629045.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/ScienceLab/Blueprints/Furniture/BP_Locker06.BP_Locker06_C", OverrideNativeName="BP_Locker06_C"))
class ABP_Locker06_C__pf213629045 : public AActor
{
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Locker06Drawer04"))
	UStaticMeshComponent* bpv__Locker06Drawer04__pf;
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Locker06"))
	UStaticMeshComponent* bpv__Locker06__pf;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(DisplayName="Drawer 04Position", Category="Default", UIMin="0", UIMax="30", OverrideNativeName="Drawer04Position"))
	...
	ABP_Locker06_C__pf213629045(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
