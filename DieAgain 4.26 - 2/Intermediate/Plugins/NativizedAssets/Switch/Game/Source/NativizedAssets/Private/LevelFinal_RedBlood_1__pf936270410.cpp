...
#include "LevelFinal_RedBlood_1__pf936270410.h"
...
#include "LevelFinal_RedBlood_2__pf936270410.h"
...
ULevelFinal_RedBlood_1_C__pf936270410::ULevelFinal_RedBlood_1_C__pf936270410(const FObjectInitializer& ObjectInitializer) : Super()
{
...
void ULevelFinal_RedBlood_1_C__pf936270410::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ULevelFinal_RedBlood_1_C__pf936270410::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(ULevelFinal_RedBlood_2_C__pf936270410::StaticClass());
	...
	__Local__4.ComponentPropertyName = FName(TEXT("Button_99"));
	__Local__4.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__Button_99_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	auto __Local__7 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_1"), (EObjectFlags)0x00280008);
	__Local__7->LayoutData.Offsets.Left = -967.634277f;
	__Local__7->LayoutData.Offsets.Top = -547.213867f;
	__Local__7->LayoutData.Offsets.Right = 1946.290771f;
	__Local__7->LayoutData.Offsets.Bottom = 1099.958862f;
	...
	auto __Local__8 = NewObject<UImage>(__Local__1, TEXT("Image_27"), (EObjectFlags)0x00280008);
	__Local__8->ColorAndOpacity = FLinearColor(1.000000, 1.000000, 1.000000, 0.000000);
	__Local__8->Slot = __Local__7;
	__Local__7->Content = __Local__8;
	__Local__6.Add(__Local__7);
	auto __Local__9 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_2"), (EObjectFlags)0x00280008);
	__Local__9->LayoutData.Offsets.Left = -796.960938f;
	__Local__9->LayoutData.Offsets.Top = -324.540527f;
	__Local__9->LayoutData.Offsets.Right = 1614.848267f;
	__Local__9->LayoutData.Offsets.Bottom = 585.333130f;
	...
	auto __Local__10 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_329"), (EObjectFlags)0x00280008);
	__Local__10->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[BC5D7070440706A5E09420A6F3581D38]\", \"FEA0DC234E8904DB58AD499C19C96BF5\", \"Red blood returned to what was left of humanity\\r\\nThe k12 and slavery was progressively reduced\\r\\n\\r\\nMankind began a slow reconstruction\\r\\nIt was never kn")
		TEXT("own how and why the disease was cured\\r\\nThe story didnt remember the red blooded one\\r\\nwho died after a long and quiet life\")")	);
	__Local__10->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_RedBlood_1_C__pf936270410::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__10->Font.OutlineSettings.OutlineSize = 3;
	__Local__10->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__10->Font.Size = 45;
	...
	auto __Local__14 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_3"), (EObjectFlags)0x00280008);
	__Local__14->LayoutData.Offsets.Left = -200.000000f;
	__Local__14->LayoutData.Offsets.Top = -229.081055f;
	__Local__14->LayoutData.Offsets.Right = 402.524719f;
	__Local__14->LayoutData.Offsets.Bottom = 121.202309f;
	__Local__14->LayoutData.Anchors.Minimum = FVector2D(0.500000, 1.000000);
	__Local__14->LayoutData.Anchors.Maximum = FVector2D(0.500000, 1.000000);
	__Local__14->Parent = __Local__5;
	auto __Local__15 = NewObject<UButton>(__Local__1, TEXT("Button_99"), (EObjectFlags)0x00280008);
	__Local__15->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	...
	__Local__16 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__17 = (*(AccessPrivateProperty<UObject* >(&(__Local__15->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__17 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_RedBlood_1_C__pf936270410::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__15->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__18 = (*(AccessPrivateProperty<UObject* >(&(__Local__15->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__18 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_RedBlood_1_C__pf936270410::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__15->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__19 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__15->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__19 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__20 = (*(AccessPrivateProperty<UObject* >(&(__Local__15->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__20 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_RedBlood_1_C__pf936270410::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	auto& __Local__21 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__15), UPanelWidget::__PPO__Slots() )));
	__Local__21 = TArray<UPanelSlot*> ();
	__Local__21.Reserve(1);
	auto __Local__22 = NewObject<UButtonSlot>(__Local__15, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__22->Parent = __Local__15;
	auto __Local__23 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_511"), (EObjectFlags)0x00280008);
	__Local__23->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[BC5D7070440706A5E09420A6F3581D38]\", \"DBF586C84835B38CCC6091941366F16A\", \"Next\")")	);
	auto& __Local__24 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__23->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__24 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__23->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_RedBlood_1_C__pf936270410::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__23->Font.OutlineSettings.OutlineSize = 4;
	__Local__23->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__23->Font.Size = 65;
	...
	auto __Local__25 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_8"), (EObjectFlags)0x00280008);
	__Local__25->LayoutData.Offsets.Left = -200.000000f;
	__Local__25->LayoutData.Offsets.Top = 64.000000f;
	__Local__25->LayoutData.Offsets.Right = 369.158051f;
	__Local__25->LayoutData.Offsets.Bottom = 114.528969f;
	...
	auto __Local__26 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_116"), (EObjectFlags)0x00280008);
	__Local__26->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[BC5D7070440706A5E09420A6F3581D38]\", \"2CF2697D49412BD4253335BC16317B69\", \"Ending E\")")	);
	__Local__26->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_RedBlood_1_C__pf936270410::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__26->Font.OutlineSettings.OutlineSize = 3;
	__Local__26->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__26->Font.Size = 75;
	__Local__26->Slot = __Local__25;
	__Local__25->Content = __Local__26;
	__Local__6.Add(__Local__25);
	__Local__1->RootWidget = __Local__5;
	auto __Local__27 = NewObject<UMovieScene>(__Local__2, TEXT("FadeInText"), (EObjectFlags)0x00280008);
	...
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__28.GetData(), 1);
	...
	__Local__30 = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__31 = (*(AccessPrivateProperty<FString >(&(__Local__29), FMovieScenePossessable::__PPO__Name() )));
	__Local__31 = FString(TEXT("TextBlock_329"));
	auto& __Local__32 = (*(AccessPrivateProperty<UClass* >(&(__Local__29), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__32 = UTextBlock::StaticClass();
	auto& __Local__33 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__27), UMovieScene::__PPO__ObjectBindings() )));
	__Local__33 = TArray<FMovieSceneBinding> ();
	__Local__33.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__33.GetData(), 1);
	auto& __Local__34 = __Local__33[0];
	auto& __Local__35 = (*(AccessPrivateProperty<FGuid >(&(__Local__34), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__35 = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__36 = (*(AccessPrivateProperty<FString >(&(__Local__34), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__36 = FString(TEXT("TextBlock_329"));
	auto& __Local__37 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__34), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__37 = TArray<UMovieSceneTrack*> ();
	__Local__37.Reserve(2);
	auto __Local__38 = NewObject<UMovieSceneColorTrack>(__Local__27, TEXT("MovieSceneColorTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__39 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__38), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__39.PropertyName = FName(TEXT("ColorAndOpacity"));
	__Local__39.PropertyPath = FName(TEXT("ColorAndOpacity"));
	__Local__39.bCanUseClassLookup = true;
	auto& __Local__40 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__38), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__40 = TArray<UMovieSceneSection*> ();
	__Local__40.Reserve(1);
	auto __Local__41 = NewObject<UMovieSceneColorSection>(__Local__38, TEXT("MovieSceneColorSection_0"), (EObjectFlags)0x00280008);
	auto __Local__42 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__41->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__43 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__41->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__42)
	{
	...
	__Local__41->Easing.EaseIn = __Local__42;
	__Local__41->Easing.EaseOut = __Local__43;
	__Local__41->Easing.bManualEaseOut = true;
	__Local__41->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(120000)));
	auto& __Local__44 = (*(AccessPrivateProperty<FGuid >((__Local__41), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__44 = FGuid(0xBA46693B, 0x414FEC4B, 0xF98EC09C, 0x4E774243);
	__Local__40.Add(__Local__41);
	auto& __Local__45 = (*(AccessPrivateProperty<FGuid >((__Local__38), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__45 = FGuid(0xDDDC1926, 0x47539219, 0x2B574EA3, 0xA5310AF4);
	auto& __Local__46 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__38), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__46.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__46.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__46.Entries.GetData(), 1);
	auto& __Local__47 = __Local__46.Entries[0];
	__Local__47.Section = __Local__41;
	static TWeakFieldPtr<FProperty> __Local__49{};
	const FProperty* __Local__48 = __Local__49.Get();
	if (nullptr == __Local__48)
	{
		__Local__48 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("LowerBound")));
		check(__Local__48);
		__Local__49 = __Local__48;
	}
	auto& __Local__50 = (*(__Local__48->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__47.Range), 0)));
	static TWeakFieldPtr<FProperty> __Local__52{};
	const FProperty* __Local__51 = __Local__52.Get();
	if (nullptr == __Local__51)
	{
		__Local__51 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Type")));
		check(__Local__51);
		__Local__52 = __Local__51;
	}
	auto& __Local__53 = (*(__Local__51->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__50), 0)));
	__Local__53 = ERangeBoundTypes::Type::Inclusive;
	static TWeakFieldPtr<FProperty> __Local__55{};
	const FProperty* __Local__54 = __Local__55.Get();
	if (nullptr == __Local__54)
	{
		__Local__54 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("UpperBound")));
		check(__Local__54);
		__Local__55 = __Local__54;
	}
	auto& __Local__56 = (*(__Local__54->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__47.Range), 0)));
	auto& __Local__57 = (*(__Local__51->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__56), 0)));
	__Local__57 = ERangeBoundTypes::Type::Inclusive;
	static TWeakFieldPtr<FProperty> __Local__59{};
	const FProperty* __Local__58 = __Local__59.Get();
	if (nullptr == __Local__58)
	{
		__Local__58 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Value")));
		check(__Local__58);
		__Local__59 = __Local__58;
	}
	auto& __Local__60 = (*(__Local__58->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__56), 0)));
	__Local__60.Value = 120000;
	__Local__47.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__61 = (*(AccessPrivateProperty<FGuid >((__Local__38), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__61 = FGuid(0xDDDC1926, 0x47539219, 0x2B574EA3, 0xA5310AF4);
	__Local__37.Add(__Local__38);
	auto __Local__62 = NewObject<UMovieSceneFloatTrack>(__Local__27, TEXT("MovieSceneFloatTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__63 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__62), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__63.PropertyName = FName(TEXT("RenderOpacity"));
	__Local__63.PropertyPath = FName(TEXT("RenderOpacity"));
	__Local__63.bCanUseClassLookup = true;
	auto& __Local__64 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__62), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__64 = TArray<UMovieSceneSection*> ();
	__Local__64.Reserve(1);
	auto __Local__65 = NewObject<UMovieSceneFloatSection>(__Local__62, TEXT("MovieSceneFloatSection_0"), (EObjectFlags)0x00280008);
	auto __Local__66 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__65->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__67 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__65->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__66)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__68 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__65), UMovieSceneFloatSection::__PPO__FloatCurve() )));
	auto& __Local__69 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__68), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__69 = TArray<FFrameNumber> ();
	__Local__69.Reserve(2);
	__Local__69.Add(FFrameNumber{});
	__Local__69.Add(FFrameNumber{});
	__Local__69[1].Value = 150000;
	auto& __Local__70 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__68), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__70 = TArray<FMovieSceneFloatValue> ();
	__Local__70.AddUninitialized(2);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__70.GetData(), 2);
	auto& __Local__71 = __Local__70[0];
	auto& __Local__72 = __Local__70[1];
	__Local__72.Value = 1.000000f;
	__Local__65->Easing.EaseIn = __Local__66;
	__Local__65->Easing.EaseOut = __Local__67;
	__Local__65->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(150000)));
	auto& __Local__73 = (*(AccessPrivateProperty<FGuid >((__Local__65), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__73 = FGuid(0xC95851B7, 0x46762F9C, 0x7F26C993, 0x8DA70E1F);
	__Local__64.Add(__Local__65);
	auto& __Local__74 = (*(AccessPrivateProperty<FGuid >((__Local__62), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__74 = FGuid(0xF65A7B0B, 0x4A5DAF9A, 0xAC0E88BB, 0x8F9C4DB0);
	auto& __Local__75 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__62), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__75.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__75.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__75.Entries.GetData(), 1);
	auto& __Local__76 = __Local__75.Entries[0];
	__Local__76.Section = __Local__65;
	auto& __Local__77 = (*(__Local__48->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__76.Range), 0)));
	auto& __Local__78 = (*(__Local__51->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__77), 0)));
	__Local__78 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__79 = (*(__Local__54->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__76.Range), 0)));
	auto& __Local__80 = (*(__Local__51->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__79), 0)));
	__Local__80 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__81 = (*(__Local__58->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__79), 0)));
	__Local__81.Value = 150000;
	__Local__76.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__82 = (*(AccessPrivateProperty<FGuid >((__Local__62), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__82 = FGuid(0xF65A7B0B, 0x4A5DAF9A, 0xAC0E88BB, 0x8F9C4DB0);
	__Local__37.Add(__Local__62);
	auto& __Local__83 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__27), UMovieScene::__PPO__PlaybackRange() )));
	__Local__83 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(150001)));
	auto& __Local__84 = (*(AccessPrivateProperty<FFrameRate >((__Local__27), UMovieScene::__PPO__DisplayRate() )));
	static TWeakFieldPtr<FProperty> __Local__86{};
	const FProperty* __Local__85 = __Local__86.Get();
	if (nullptr == __Local__85)
	{
		__Local__85 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameRate"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Numerator")));
		check(__Local__85);
		__Local__86 = __Local__85;
	}
	auto& __Local__87 = (*(__Local__85->ContainerPtrToValuePtr<int32 >(&(__Local__84), 0)));
	__Local__87 = 20;
	auto& __Local__88 = (*(AccessPrivateProperty<FGuid >((__Local__27), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__88 = FGuid(0x48326375, 0x4A890F90, 0x6E722BA6, 0x422E1F11);
	...
	auto& __Local__89 = __Local__2->AnimationBindings[0];
	__Local__89.WidgetName = FName(TEXT("TextBlock_329"));
	__Local__89.AnimationGuid = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__90 = (*(AccessPrivateProperty<FString >((__Local__2), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__90 = FString(TEXT("FadeInText"));
	__Local__2->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__91 = (*(AccessPrivateProperty<FGuid >((__Local__2), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__91 = FGuid(0x4B9B3784, 0x4F020096, 0x0CF533B7, 0x260DBDA5);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__2);
	auto __Local__92 = NewObject<UMovieScene>(__Local__3, TEXT("FadeInButton"), (EObjectFlags)0x00280008);
	auto& __Local__93 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__92), UMovieScene::__PPO__Possessables() )));
	__Local__93 = TArray<FMovieScenePossessable> ();
	__Local__93.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__93.GetData(), 1);
	auto& __Local__94 = __Local__93[0];
	auto& __Local__95 = (*(AccessPrivateProperty<FGuid >(&(__Local__94), FMovieScenePossessable::__PPO__Guid() )));
	__Local__95 = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__96 = (*(AccessPrivateProperty<FString >(&(__Local__94), FMovieScenePossessable::__PPO__Name() )));
	__Local__96 = FString(TEXT("Button_99"));
	auto& __Local__97 = (*(AccessPrivateProperty<UClass* >(&(__Local__94), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__97 = UButton::StaticClass();
	auto& __Local__98 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__92), UMovieScene::__PPO__ObjectBindings() )));
	__Local__98 = TArray<FMovieSceneBinding> ();
	__Local__98.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__98.GetData(), 1);
	auto& __Local__99 = __Local__98[0];
	auto& __Local__100 = (*(AccessPrivateProperty<FGuid >(&(__Local__99), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__100 = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__101 = (*(AccessPrivateProperty<FString >(&(__Local__99), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__101 = FString(TEXT("Button_99"));
	auto& __Local__102 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__99), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__102 = TArray<UMovieSceneTrack*> ();
	__Local__102.Reserve(1);
	auto __Local__103 = NewObject<UMovieSceneFloatTrack>(__Local__92, TEXT("MovieSceneFloatTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__104 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__103), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__104.PropertyName = FName(TEXT("RenderOpacity"));
	__Local__104.PropertyPath = FName(TEXT("RenderOpacity"));
	__Local__104.bCanUseClassLookup = true;
	auto& __Local__105 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__103), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__105 = TArray<UMovieSceneSection*> ();
	__Local__105.Reserve(1);
	auto __Local__106 = NewObject<UMovieSceneFloatSection>(__Local__103, TEXT("MovieSceneFloatSection_0"), (EObjectFlags)0x00280008);
	auto __Local__107 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__106->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__108 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__106->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__107)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__109 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__106), UMovieSceneFloatSection::__PPO__FloatCurve() )));
	...
	__Local__110.Add(FFrameNumber{});
	__Local__110[1].Value = 150000;
	auto& __Local__111 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__109), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__111 = TArray<FMovieSceneFloatValue> ();
	__Local__111.AddUninitialized(2);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__111.GetData(), 2);
	auto& __Local__112 = __Local__111[0];
	auto& __Local__113 = __Local__111[1];
	__Local__113.Value = 1.000000f;
	__Local__106->Easing.EaseIn = __Local__107;
	__Local__106->Easing.EaseOut = __Local__108;
	__Local__106->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(150000)));
	auto& __Local__114 = (*(AccessPrivateProperty<FGuid >((__Local__106), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__114 = FGuid(0x8A291EDF, 0x40499572, 0x7FE33A97, 0x85CCD425);
	__Local__105.Add(__Local__106);
	auto& __Local__115 = (*(AccessPrivateProperty<FGuid >((__Local__103), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__115 = FGuid(0x6591925F, 0x45B0957F, 0xD13F0E93, 0xD1A0EFD6);
	auto& __Local__116 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__103), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__116.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__116.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__116.Entries.GetData(), 1);
	auto& __Local__117 = __Local__116.Entries[0];
	__Local__117.Section = __Local__106;
	auto& __Local__118 = (*(__Local__48->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__117.Range), 0)));
	auto& __Local__119 = (*(__Local__51->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__118), 0)));
	__Local__119 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__120 = (*(__Local__54->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__117.Range), 0)));
	auto& __Local__121 = (*(__Local__51->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__120), 0)));
	__Local__121 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__122 = (*(__Local__58->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__120), 0)));
	__Local__122.Value = 150000;
	__Local__117.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__123 = (*(AccessPrivateProperty<FGuid >((__Local__103), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__123 = FGuid(0x6591925F, 0x45B0957F, 0xD13F0E93, 0xD1A0EFD6);
	__Local__102.Add(__Local__103);
	auto& __Local__124 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__92), UMovieScene::__PPO__PlaybackRange() )));
	__Local__124 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(150001)));
	auto& __Local__125 = (*(AccessPrivateProperty<FFrameRate >((__Local__92), UMovieScene::__PPO__DisplayRate() )));
	auto& __Local__126 = (*(__Local__85->ContainerPtrToValuePtr<int32 >(&(__Local__125), 0)));
	__Local__126 = 20;
	auto& __Local__127 = (*(AccessPrivateProperty<FGuid >((__Local__92), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__127 = FGuid(0xF6308FCB, 0x47CE842C, 0x382F799D, 0xB956E79A);
	__Local__3->MovieScene = __Local__92;
	...
	auto& __Local__128 = __Local__3->AnimationBindings[0];
	__Local__128.WidgetName = FName(TEXT("Button_99"));
	__Local__128.AnimationGuid = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__129 = (*(AccessPrivateProperty<FString >((__Local__3), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__129 = FString(TEXT("FadeInButton"));
	__Local__3->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__130 = (*(AccessPrivateProperty<FGuid >((__Local__3), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__130 = FGuid(0x305CD7E5, 0x4C327CF7, 0x1FD3FB8A, 0x71967EDB);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__3);
}
PRAGMA_ENABLE_OPTIMIZATION
void ULevelFinal_RedBlood_1_C__pf936270410::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__131;
	SlotNames.Append(__Local__131);
}
void ULevelFinal_RedBlood_1_C__pf936270410::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__132;
	__Local__132.Reserve(2);
	__Local__132.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(ULevelFinal_RedBlood_1_C__pf936270410::StaticClass())->MiscConvertedSubobjects[1]));
	__Local__132.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(ULevelFinal_RedBlood_1_C__pf936270410::StaticClass())->MiscConvertedSubobjects[2]));
	TArray<FDelegateRuntimeBinding>  __Local__133;
	__Local__133.AddUninitialized(1);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__133.GetData(), 1);
	auto& __Local__134 = __Local__133[0];
	__Local__134.ObjectName = FString(TEXT("Image_27"));
	__Local__134.PropertyName = FName(TEXT("Brush"));
	__Local__134.FunctionName = FName(TEXT("GetBrush_0"));
	auto& __Local__135 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__134.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__135 = TArray<FPropertyPathSegment> ();
	__Local__135.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__135.GetData(), 1);
	auto& __Local__136 = __Local__135[0];
	__Local__136.Name = FName(TEXT("GetBrush_0"));
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(ULevelFinal_RedBlood_1_C__pf936270410::StaticClass())->MiscConvertedSubobjects[0]), __Local__132, __Local__133);
}
void ULevelFinal_RedBlood_1_C__pf936270410::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				...
				b1l__K2Node_MakeArray_Array__pf[0] = bpv__Button_99__pf;
		...
		case 3:
			{
				bpfv__CallFunc_PlayAnimation_ReturnValue__pf = UUserWidget::PlayAnimation(bpv__FadeInText__pf, 0.000000, 1, EUMGSequencePlayMode::Forward, 1.000000, false);
			}
		case 4:
			{
				bpfv__CallFunc_PlayAnimation_ReturnValue_1__pf = UUserWidget::PlayAnimation(bpv__FadeInButton__pf, 0.000000, 1, EUMGSequencePlayMode::Forward, 1.000000, false);
			}
		case 5:
			{
				bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
				b1l__CallFunc_CacheAchievements_ReturnValue__pf = UAchievementQueryCallbackProxy::CacheAchievements(this, bpfv__CallFunc_GetPlayerController_ReturnValue__pf);
			}
		case 6:
			{
				b1l__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(b1l__CallFunc_CacheAchievements_ReturnValue__pf);
				if (!b1l__CallFunc_IsValid_ReturnValue_1__pf)
				{
					__CurrentState = 10;
					break;
				}
		...
		case 7:
			{
				b1l__K2Node_CreateDelegate_OutputDelegate_1__pf.BindUFunction(this,FName(TEXT("OnSuccess_7974172D46DC2B2474CE2E9039FC9C5C")));
				if(::IsValid(b1l__CallFunc_CacheAchievements_ReturnValue__pf))
				{
					b1l__CallFunc_CacheAchievements_ReturnValue__pf->OnSuccess.AddUnique(b1l__K2Node_CreateDelegate_OutputDelegate_1__pf);
				}
			}
		case 8:
			{
				b1l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("OnFailure_7974172D46DC2B2474CE2E9039FC9C5C")));
				if(::IsValid(b1l__CallFunc_CacheAchievements_ReturnValue__pf))
				{
					b1l__CallFunc_CacheAchievements_ReturnValue__pf->OnFailure.AddUnique(b1l__K2Node_CreateDelegate_OutputDelegate__pf);
				}
			}
		case 9:
			{
				if(::IsValid(b1l__CallFunc_CacheAchievements_ReturnValue__pf))
				{
					b1l__CallFunc_CacheAchievements_ReturnValue__pf->Activate();
				}
			}
		case 10:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("TRYING TO GET ACH")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		case 33:
...
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_1(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue__pf{};
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
		...
		case 14:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("SUCCEES!")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 15:
			{
				bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
				b1l__CallFunc_WriteAchievementProgress_ReturnValue__pf = UAchievementWriteCallbackProxy::WriteAchievementProgress(this, bpfv__CallFunc_GetPlayerController_ReturnValue__pf, FName(TEXT("ACH_F_RED")), 100.000000, 0);
			}
		case 16:
			{
				b1l__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(b1l__CallFunc_WriteAchievementProgress_ReturnValue__pf);
		...
		case 17:
			{
				b1l__K2Node_CreateDelegate_OutputDelegate_3__pf.BindUFunction(this,FName(TEXT("OnSuccess_7AC27BDE4DBF6C90105DB4BEA4D01E4D")));
				if(::IsValid(b1l__CallFunc_WriteAchievementProgress_ReturnValue__pf))
				{
					b1l__CallFunc_WriteAchievementProgress_ReturnValue__pf->OnSuccess.AddUnique(b1l__K2Node_CreateDelegate_OutputDelegate_3__pf);
				}
			}
		case 18:
			{
				b1l__K2Node_CreateDelegate_OutputDelegate_2__pf.BindUFunction(this,FName(TEXT("OnFailure_7AC27BDE4DBF6C90105DB4BEA4D01E4D")));
				if(::IsValid(b1l__CallFunc_WriteAchievementProgress_ReturnValue__pf))
				{
					b1l__CallFunc_WriteAchievementProgress_ReturnValue__pf->OnFailure.AddUnique(b1l__K2Node_CreateDelegate_OutputDelegate_2__pf);
				}
			}
		case 19:
			{
				if(::IsValid(b1l__CallFunc_WriteAchievementProgress_ReturnValue__pf))
				{
					b1l__CallFunc_WriteAchievementProgress_ReturnValue__pf->Activate();
				}
			}
		case 20:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("LOADING NEW ACH")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		default:
...
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 21);
	// optimized KCST_UnconditionalGoto
	b1l__Temp_name_Variable__pf = b1l__K2Node_CustomEvent_WrittenAchievementName_1__pf;
	b1l__Temp_float_Variable__pf = b1l__K2Node_CustomEvent_WrittenProgress_1__pf;
	b1l__Temp_int_Variable__pf = b1l__K2Node_CustomEvent_WrittenUserTag_1__pf;
	UKismetSystemLibrary::PrintString(this, FString(TEXT("FAIL ACH")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	return; // KCST_GotoReturn
}
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 26);
	// optimized KCST_UnconditionalGoto
	b1l__Temp_name_Variable__pf = b1l__K2Node_CustomEvent_WrittenAchievementName__pf;
	b1l__Temp_float_Variable__pf = b1l__K2Node_CustomEvent_WrittenProgress__pf;
	b1l__Temp_int_Variable__pf = b1l__K2Node_CustomEvent_WrittenUserTag__pf;
	UKismetSystemLibrary::PrintString(this, FString(TEXT("NEW ACH")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	return; // KCST_GotoReturn
}
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_4(int32 bpp__EntryPoint__pf)
{
	ULevelFinal_RedBlood_2_C__pf936270410* bpfv__CallFunc_Create_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 34);
	// optimized KCST_UnconditionalGoto
	UWidgetLayoutLibrary::RemoveAllWidgets(this);
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<ULevelFinal_RedBlood_2_C__pf936270410>(UWidgetBlueprintLibrary::Create(this, ULevelFinal_RedBlood_2_C__pf936270410::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
...
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_5(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 11);
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::PrintString(this, FString(TEXT("FAIL")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
	return; // KCST_GotoReturn
}
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_6(int32 bpp__EntryPoint__pf)
{
...
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__BndEvt__Button_99_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_4(34);
}
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_0(33);
}
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_6(31);
}
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__OnSuccess_7AC27BDE4DBF6C90105DB4BEA4D01E4D__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf)
{
	b1l__K2Node_CustomEvent_WrittenAchievementName__pf = bpp__WrittenAchievementName__pf;
	b1l__K2Node_CustomEvent_WrittenProgress__pf = bpp__WrittenProgress__pf;
	b1l__K2Node_CustomEvent_WrittenUserTag__pf = bpp__WrittenUserTag__pf;
	bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_3(26);
}
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__OnFailure_7AC27BDE4DBF6C90105DB4BEA4D01E4D__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf)
{
	b1l__K2Node_CustomEvent_WrittenAchievementName_1__pf = bpp__WrittenAchievementName__pf;
	b1l__K2Node_CustomEvent_WrittenProgress_1__pf = bpp__WrittenProgress__pf;
	b1l__K2Node_CustomEvent_WrittenUserTag_1__pf = bpp__WrittenUserTag__pf;
	bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_2(21);
}
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__OnSuccess_7974172D46DC2B2474CE2E9039FC9C5C__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_1(13);
}
void ULevelFinal_RedBlood_1_C__pf936270410::bpf__OnFailure_7974172D46DC2B2474CE2E9039FC9C5C__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_RedBlood_1__pf_5(11);
}
FText  ULevelFinal_RedBlood_1_C__pf936270410::bpf__GetText_0__pf()
{
	FText bpp__ReturnValue__pf{};
	bpp__ReturnValue__pf = bpv__TextDescription__pf;
	return bpp__ReturnValue__pf;
}
FText  ULevelFinal_RedBlood_1_C__pf936270410::bpf__GetText_1__pf()
{
	FText bpp__ReturnValue__pf{};
	bpp__ReturnValue__pf = bpv__TextButton__pf;
	return bpp__ReturnValue__pf;
}
FSlateBrush  ULevelFinal_RedBlood_1_C__pf936270410::bpf__GetBrush_0__pf()
{
	FSlateBrush bpp__ReturnValue__pf{};
	FSlateBrush bpfv__FinalSlateBrush__pf{};
	FSlateBrush bpfv__RedBlood_M__pf{};
	FSlateBrush bpfv__RedBlood_F__pf{};
	...
	do
	{
		...
		case 1:
			{
				const UScriptStruct* __Local__138 = FSlateBrush::StaticStruct();
				uint8* __Local__139 = (uint8*)FMemory_Alloca(__Local__138->GetStructureSize());
				__Local__138->InitializeStruct(__Local__139);
				FSlateBrush& __Local__137 = *reinterpret_cast<FSlateBrush*>(__Local__139);
				__Local__137.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__140 = (*(AccessPrivateProperty<UObject* >(&(__Local__137), FSlateBrush::__PPO__ResourceObject() )));
				__Local__140 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_RedBlood_1_C__pf936270410::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
				bpfv__RedBlood_F__pf = __Local__137;
			}
		case 2:
			{
				const UScriptStruct* __Local__142 = FSlateBrush::StaticStruct();
				uint8* __Local__143 = (uint8*)FMemory_Alloca(__Local__142->GetStructureSize());
				__Local__142->InitializeStruct(__Local__143);
				FSlateBrush& __Local__141 = *reinterpret_cast<FSlateBrush*>(__Local__143);
				__Local__141.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__144 = (*(AccessPrivateProperty<UObject* >(&(__Local__141), FSlateBrush::__PPO__ResourceObject() )));
				__Local__144 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_RedBlood_1_C__pf936270410::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
				bpfv__RedBlood_M__pf = __Local__141;
			}
		case 3:
			{
		...
		case 5:
			{
				bool  __Local__145 = false;
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__IsMale__pf) : (__Local__145)))
				{
					__CurrentState = 9;
					break;
				}
		...
		case 6:
			{
				bpfv__FinalSlateBrush__pf = bpfv__RedBlood_M__pf;
			}
		case 7:
			{
				bpp__ReturnValue__pf = bpfv__FinalSlateBrush__pf;
				__CurrentState = -1;
				break;
			}
		case 8:
		...
		case 9:
			{
				bpfv__FinalSlateBrush__pf = bpfv__RedBlood_F__pf;
				__CurrentState = 7;
				break;
			}
		default:
...
PRAGMA_DISABLE_OPTIMIZATION
void ULevelFinal_RedBlood_1_C__pf936270410::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{1081, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Texture2D /Game/Art/2D_Art/Endings/EndingRedBlood_F.EndingRedBlood_F 
		{1082, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Texture2D /Game/Art/2D_Art/Endings/EndingRedBlood_M.EndingRedBlood_M 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ULevelFinal_RedBlood_1_C__pf936270410::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{1083, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/LevelFinal/LevelFinal_RedBlood_2.LevelFinal_RedBlood_2_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ULevelFinal_RedBlood_1_C__pf936270410
{
	FRegisterHelper__ULevelFinal_RedBlood_1_C__pf936270410()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/LevelFinal/LevelFinal_RedBlood_1"), &ULevelFinal_RedBlood_1_C__pf936270410::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ULevelFinal_RedBlood_1_C__pf936270410 Instance;
};
FRegisterHelper__ULevelFinal_RedBlood_1_C__pf936270410 FRegisterHelper__ULevelFinal_RedBlood_1_C__pf936270410::Instance;
