...
#include "SaveFemaleCharacter__pf3264546738.h"
...
USaveFemaleCharacter_C__pf3264546738::USaveFemaleCharacter_C__pf3264546738(const FObjectInitializer& ObjectInitializer) : Super()
{
...
void USaveFemaleCharacter_C__pf3264546738::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void USaveFemaleCharacter_C__pf3264546738::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void USaveFemaleCharacter_C__pf3264546738::bpf__ExecuteUbergraph_SaveFemaleCharacter__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	UGameplayStatics::OpenLevel(this, FName(TEXT("Tutorial_Final")), true, FString(TEXT("")));
	return; // KCST_GotoReturn
}
void USaveFemaleCharacter_C__pf3264546738::RecieveEventTriggered_Implementation(APlayerController* bpp__ConsideringPlayer__pf, AActor* bpp__NPCActor__pf)
{
	b0l__K2Node_Event_ConsideringPlayer__pf = bpp__ConsideringPlayer__pf;
	b0l__K2Node_Event_NPCActor__pf = bpp__NPCActor__pf;
	bpf__ExecuteUbergraph_SaveFemaleCharacter__pf_0(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void USaveFemaleCharacter_C__pf3264546738::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void USaveFemaleCharacter_C__pf3264546738::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__USaveFemaleCharacter_C__pf3264546738
{
	FRegisterHelper__USaveFemaleCharacter_C__pf3264546738()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Conversations/Events/SaveFemaleCharacter"), &USaveFemaleCharacter_C__pf3264546738::__StaticDependenciesAssets);
	}
	static FRegisterHelper__USaveFemaleCharacter_C__pf3264546738 Instance;
};
FRegisterHelper__USaveFemaleCharacter_C__pf3264546738 FRegisterHelper__USaveFemaleCharacter_C__pf3264546738::Instance;
