...
#include "../Plugins/Runtime/ApexDestruction/Source/ApexDestruction/Public/DestructibleFractureSettings.h"
...
AExplosiveBarrel_C__pf3544028049::AExplosiveBarrel_C__pf3544028049(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__Destructible__pf = CreateDefaultSubobject<UDestructibleComponent>(TEXT("Destructible"));
	bpv__Box__pf = CreateDefaultSubobject<UBoxComponent>(TEXT("Box"));
	bpv__Actor__pf = CreateDefaultSubobject<UChildActorComponent>(TEXT("Actor"));
	bpv__SoundExplosion__pf = CreateDefaultSubobject<UFMODAudioComponent>(TEXT("SoundExplosion"));
	bpv__Explosion_Audio__pf = CreateDefaultSubobject<UAudioComponent>(TEXT("Explosion_Audio"));
	...
	bpv__Destructible__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Destructible__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Destructible__pf->FractureEffects = TArray<FFractureEffect> ();
	bpv__Destructible__pf->FractureEffects.AddUninitialized(2);
	FFractureEffect::StaticStruct()->InitializeStruct(bpv__Destructible__pf->FractureEffects.GetData(), 2);
	auto& __Local__2 = bpv__Destructible__pf->FractureEffects[0];
	auto& __Local__3 = bpv__Destructible__pf->FractureEffects[1];
	bpv__Destructible__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(AExplosiveBarrel_C__pf3544028049::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Destructible__pf->VisibilityBasedAnimTickOption = EVisibilityBasedAnimTickOption::AlwaysTickPoseAndRefreshBones;
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__Destructible__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__4 = FVector(0.850000, 0.850000, 0.950000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Destructible__pf), true, 0));
	bpv__Box__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Box__pf->AttachToComponent(bpv__Destructible__pf, FAttachmentTransformRules::KeepRelativeTransform );
	...
	auto& __Local__6 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__Box__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__6 = ECollisionEnabled::Type::QueryAndPhysics;
	...
	__Local__8.AddUninitialized(2);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__8.GetData(), 2);
	...
	auto& __Local__11 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__11 = FVector(0.000000, 0.000000, 167.368484);
	auto& __Local__12 = (*(AccessPrivateProperty<FVector >((bpv__Box__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__12 = FVector(1.426470, 1.426470, 5.302631);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Box__pf), false, 0));
	bpv__Actor__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Actor__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__13 = (*(AccessPrivateProperty<FVector >((bpv__Actor__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__13 = FVector(0.000000, 0.000000, 124.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Actor__pf), false, 0));
	bpv__SoundExplosion__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__SoundExplosion__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__SoundExplosion__pf->Event = CastChecked<UFMODEvent>(CastChecked<UDynamicClass>(AExplosiveBarrel_C__pf3544028049::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__SoundExplosion__pf->bAutoActivate = false;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__SoundExplosion__pf), false, 0));
	bpv__Explosion_Audio__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Explosion_Audio__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Explosion_Audio__pf->bAutoActivate = false;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Explosion_Audio__pf), false, 0));
	bpv__Angle__pf = 0.000000f;
	bpv__BarrelActor__pf = nullptr;
...
void AExplosiveBarrel_C__pf3544028049::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__SoundExplosion__pf)
	{
		bpv__SoundExplosion__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Explosion_Audio__pf)
	{
		bpv__Explosion_Audio__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AExplosiveBarrel_C__pf3544028049::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__15 = NewObject<UFMODAudioComponent>(InDynamicClass, UFMODAudioComponent::StaticClass(), TEXT("NODE_AddFMODAudioComponent-0"), (EObjectFlags)0x00280029);
...
PRAGMA_ENABLE_OPTIMIZATION
void AExplosiveBarrel_C__pf3544028049::bpf__ExecuteUbergraph_ExplosiveBarrel__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 16);
	// optimized KCST_UnconditionalGoto
	bpv__BarrelActor__pf = this;
	return; //KCST_EndOfThread
}
void AExplosiveBarrel_C__pf3544028049::bpf__ExecuteUbergraph_ExplosiveBarrel__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				UKismetSystemLibrary::Delay(this, 0.200000, FLatentActionInfo(2, 1818063909, TEXT("ExecuteUbergraph_ExplosiveBarrel_1"), this));
		...
		case 7:
			{
				if(::IsValid(bpv__Destructible__pf))
				{
					bpv__Destructible__pf->ApplyRadiusDamage(1000.000000, b0l__K2Node_CustomEvent_HitOrigin__pf, 180.000000, 10000.000000, true);
				}
			}
		case 8:
			{
				if(::IsValid(bpv__Destructible__pf))
				{
					bpv__Destructible__pf->SetCollisionResponseToAllChannels(ECollisionResponse::ECR_Ignore);
				}
			}
		case 9:
			{
				bpf__ExplosionBarrel__pf();
			}
		case 10:
			{
				UKismetSystemLibrary::Delay(this, 0.500000, FLatentActionInfo(11, -1628309942, TEXT("ExecuteUbergraph_ExplosiveBarrel_1"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 11:
		...
		case 12:
			{
				if(::IsValid(bpv__Destructible__pf))
				{
					bpv__Destructible__pf->SetCollisionEnabled(ECollisionEnabled::PhysicsOnly);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
void AExplosiveBarrel_C__pf3544028049::bpf__DestroyFunction__pf(FVector bpp__HitOrigin__pf)
{
	b0l__K2Node_CustomEvent_HitOrigin__pf = bpp__HitOrigin__pf;
	bpf__ExecuteUbergraph_ExplosiveBarrel__pf_1(18);
}
void AExplosiveBarrel_C__pf3544028049::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_ExplosiveBarrel__pf_0(16);
}
void AExplosiveBarrel_C__pf3544028049::bpf__ExplosionBarrel__pf()
{
	...
	do
	{
		...
		case 3:
			{
				...
				bpfv__K2Node_MakeArray_Array__pf[0] = bpv__BarrelActor__pf;
				if(::IsValid(bpv__Actor__pf))
				{
					bpfv__CallFunc_GetForwardVector_ReturnValue__pf = bpv__Actor__pf->USceneComponent::GetForwardVector();
				}
				if(::IsValid(bpv__Actor__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__Actor__pf->USceneComponent::K2_GetComponentLocation();
				}
				if(::IsValid(bpv__Actor__pf))
				{
					bpfv__CallFunc_GetUpVector_ReturnValue__pf = bpv__Actor__pf->USceneComponent::GetUpVector();
				}
				...
				bpfv__CallFunc_Multiply_VectorInt_ReturnValue__pf = UKismetMathLibrary::Multiply_VectorInt(bpfv__CallFunc_RotateAngleAxis_ReturnValue__pf, 400);
		...
		case 6:
			{
				...
				bpfv__CallFunc_Add_VectorVector_ReturnValue__pf = UKismetMathLibrary::Add_VectorVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_3__pf, FVector(0.000000,500.000000,0.000000));
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpf__TakeDamage__pf(100, FName(TEXT("None")), bpfv__CallFunc_Add_VectorVector_ReturnValue__pf, ((AActor*)nullptr));
				}
			}
		case 7:
			{
				bool  __Local__20 = false;
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsSlave__pf) : (__Local__20)))
				{
					__CurrentState = 21;
					break;
				}
		...
		case 9:
			{
				...
				{
					bpv__Box__pf->SetCollisionEnabled(ECollisionEnabled::NoCollision);
				}
			}
		case 10:
			{
				bpfv__CallFunc_K2_GetActorLocation_ReturnValue_2__pf = AActor::K2_GetActorLocation();
				bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AExplosiveBarrel_C__pf3544028049::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue_2__pf, FRotator(0.000000,0.000000,0.000000), FVector(1.500000,1.500000,1.500000), true, EPSCPoolMethod::None, true);
			}
		case 11:
			{
				bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf = AActor::K2_GetActorLocation();
				AActor::MakeNoise(1.000000, ((APawn*)nullptr), bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf, 0.000000, FName(TEXT("Noise")));
			}
		case 12:
			{
				bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = AActor::K2_GetActorLocation();
				UGameplayStatics::PlayWorldCameraShake(this, CastChecked<UClass>(CastChecked<UDynamicClass>(AExplosiveBarrel_C__pf3544028049::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, 0.000000, 10000.000000, 1.000000, true);
			}
		case 13:
			{
				if(::IsValid(bpv__SoundExplosion__pf))
				{
					bpv__SoundExplosion__pf->UFMODAudioComponent::Play();
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 15:
			{
				UGameplayStatics::BreakHitResult(bpfv__CallFunc_LineTraceSingle_OutHit__pf, /*out*/ bpfv__CallFunc_BreakHitResult_bBlockingHit__pf, /*out*/ bpfv__CallFunc_BreakHitResult_bInitialOverlap__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Time__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Distance__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Location__pf, /*out*/ bpfv__CallFunc_BreakHitResult_ImpactPoint__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Normal__pf, /*out*/ bpfv__CallFunc_BreakHitResult_ImpactNormal__pf, /*out*/ bpfv__CallFunc_BreakHitResult_PhysMat__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitActor__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitComponent__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitBoneName__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitItem__pf, /*out*/ bpfv__CallFunc_BreakHitResult_FaceIndex__pf, /*out*/ bpfv__CallFunc_BreakHitResult_TraceStart__pf, /*out*/ bpfv__CallFunc_BreakHitResult_TraceEnd__pf);
				USkeletalMeshComponent*  __Local__21 = ((USkeletalMeshComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpv__SkeletalMesh__pf) : (__Local__21)), bpfv__CallFunc_BreakHitResult_HitComponent__pf);
		...
		case 20:
			{
				...
				bpfv__CallFunc_Add_VectorVector_ReturnValue_1__pf = UKismetMathLibrary::Add_VectorVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_4__pf, FVector(0.000000,-500.000000,0.000000));
				if(::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf))
				{
					bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf->bpf__TakeDamage__pf(200, bpfv__CallFunc_Add_VectorVector_ReturnValue_1__pf, ((AActor*)nullptr));
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
void AExplosiveBarrel_C__pf3544028049::bpf__DestroyerFunction__pf(AActor* bpp__Actor__pf, FVector bpp__Vector__pf)
{
		...
		case 2:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsGlass__pf->bpf__GlassBreaked__pf(bpp__Vector__pf);
				}
			}
		case 3:
			{
		...
		case 5:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsTable_Lamp__pf->bpf__DestroyFunction__pf(bpp__Vector__pf);
				}
				__CurrentState = 3;
				break;
			}
		...
		case 7:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsOld_Chair__pf->bpf__DestroyFunction__pf(bpp__Vector__pf);
				}
				__CurrentState = 3;
				break;
			}
		...
		case 9:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsLight_01__pf->bpf__DestroyFunction__pf(bpp__Vector__pf);
				}
				__CurrentState = 3;
				break;
			}
		...
		case 11:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsExplosive_Barrel__pf->bpf__DestroyFunction__pf(bpp__Vector__pf);
				}
				__CurrentState = 3;
				break;
			}
		...
		case 13:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsPipe__pf->bpf__DestroyFunction__pf(bpp__Vector__pf);
				}
				__CurrentState = 3;
				break;
			}
		...
		case 15:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsCurved_Pipe__pf->bpf__DestroyFunction__pf(bpp__Vector__pf);
				}
				__CurrentState = 3;
				break;
			}
		...
		case 17:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsDestructive_Plane__pf->bpf__DestroyFunction__pf(bpp__Vector__pf);
				}
				__CurrentState = 3;
				break;
			}
...
void AExplosiveBarrel_C__pf3544028049::bpf__SumPoints__pf(AActor* bpp__ActorDeath__pf)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AExplosiveBarrel_C__pf3544028049::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AExplosiveBarrel_C__pf3544028049::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{272, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/ApexDestruction.DestructibleComponent 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AExplosiveBarrel_C__pf3544028049
{
	FRegisterHelper__AExplosiveBarrel_C__pf3544028049()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/Barrel/ExplosiveBarrel"), &AExplosiveBarrel_C__pf3544028049::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AExplosiveBarrel_C__pf3544028049 Instance;
};
FRegisterHelper__AExplosiveBarrel_C__pf3544028049 FRegisterHelper__AExplosiveBarrel_C__pf3544028049::Instance;
