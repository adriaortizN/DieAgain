...
AAIShootingController_C__pf681293266::AAIShootingController_C__pf681293266(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__AIPerception__pf = CreateDefaultSubobject<UAIPerceptionComponent>(TEXT("AIPerception"));
	bpv__AIPerception__pf->CreationMethod = EComponentCreationMethod::Native;
	auto& __Local__9 = (*(AccessPrivateProperty<TArray<UAISenseConfig*> >((bpv__AIPerception__pf), UAIPerceptionComponent::__PPO__SensesConfig() )));
	__Local__9 = TArray<UAISenseConfig*> ();
	__Local__9.Reserve(2);
	auto __Local__10 = NewObject<UAISenseConfig_Sight>(bpv__AIPerception__pf, TEXT("AISenseConfig_Sight_0"), (EObjectFlags)0x00280009);
	{
		// --- Default subobject 'AISenseConfig_Sight_0' //
		__Local__10->Implementation = UAISense_Sight::StaticClass();
		__Local__10->SightRadius = 1000.000000f;
		__Local__10->LoseSightRadius = 1000.000000f;
		__Local__10->PeripheralVisionAngleDegrees = 60.000000f;
		__Local__10->DetectionByAffiliation.bDetectNeutrals = true;
		__Local__10->DetectionByAffiliation.bDetectFriendlies = true;
		__Local__10->AutoSuccessRangeFromLastSeenLocation = -1.000000f;
		__Local__10->PointOfViewBackwardOffset = 0.000000f;
		__Local__10->NearClippingRadius = 0.000000f;
		// --- END default subobject 'AISenseConfig_Sight_0' //
	}
	__Local__9.Add(__Local__10);
	auto __Local__11 = NewObject<UAISenseConfig_Hearing>(bpv__AIPerception__pf, TEXT("AISenseConfig_Hearing_0"), (EObjectFlags)0x00280009);
	{
		// --- Default subobject 'AISenseConfig_Hearing_0' //
		__Local__11->Implementation = UAISense_Hearing::StaticClass();
		__Local__11->HearingRange = 1600.000000f;
		__Local__11->DetectionByAffiliation.bDetectNeutrals = true;
		__Local__11->DetectionByAffiliation.bDetectFriendlies = true;
		// --- END default subobject 'AISenseConfig_Hearing_0' //
	}
	__Local__9.Add(__Local__11);
	auto& __Local__12 = (*(AccessPrivateProperty<TSubclassOf<UAISense>  >((bpv__AIPerception__pf), UAIPerceptionComponent::__PPO__DominantSense() )));
	__Local__12 = UAISense_Sight::StaticClass();
	...
	(((FBoolProperty*)__Local__13)->SetPropertyValue_InContainer((bpv__AIPerception__pf), false, 0));
	bpv__ControlledCharacter__pf = nullptr;
	bpv__PatrolPoints__pf = TArray<ATargetPoint*> ();
	bpv__Target__pf = -1;
	bpv__AlarmPoint__pf = nullptr;
	bpv__CanAIGoToAlarmController__pf = false;
	bpv__EnemyReference__pf = nullptr;
	bpv__ClosestDistance__pf = 10000.000000f;
	bpv__ToPossesActor__pf = nullptr;
	bpv__MinDistance__pf = 410.000000f;
	bpv__DefaultMinDistance__pf = 410.000000f;
	bpv__IsEnemyAttackedDeath__pf = false;
	bpv__WeaponOfEnemeyController__pf = E__EnumWeapon__pf::NewEnumerator0;
	bpv__DyingCharacter__pf = nullptr;
	bpv__IsVIP__pf = false;
	bpv__LevelCompleter__pf = nullptr;
	auto& __Local__15 = (*(AccessPrivateProperty<UPathFollowingComponent*>((this), AAIController::__PPO__PathFollowingComponent() )));
	__Local__15 = __Local__1;
	auto& __Local__16 = (*(AccessPrivateProperty<UPawnActionsComponent*>((this), AAIController::__PPO__ActionsComp() )));
	__Local__16 = __Local__2;
	auto& __Local__17 = (*(AccessPrivateProperty<USceneComponent*>((this), AController::__PPO__TransformComponent() )));
...
void AAIShootingController_C__pf681293266::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__AIPerception__pf)
	{
		bpv__AIPerception__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AAIShootingController_C__pf681293266::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__23.ComponentPropertyName = FName(TEXT("AIPerception"));
	__Local__23.DelegatePropertyName = FName(TEXT("OnTargetPerceptionUpdated"));
	__Local__23.FunctionNameToBind = FName(TEXT("BndEvt__AIPerception_K2Node_ComponentBoundEvent_0_ActorPerceptionUpdatedDelegate__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AAIShootingController_C__pf681293266::bpf__ExecuteUbergraph_AIShootingController__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	UBlackboardComponent* bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf{};
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf{};
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_3__pf{};
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_6__pf{};
	bool bpfv__CallFunc_GetValueAsBool_ReturnValue__pf{};
	bool bpfv__CallFunc_NotEqual_IntInt_ReturnValue_2__pf{};
	...
	do
	{
		...
		case 41:
			{
				bpfv__CallFunc_EqualEqual_NameName_ReturnValue__pf = UKismetMathLibrary::EqualEqual_NameName(b0l__K2Node_ComponentBoundEvent_Stimulus__pf.Tag, FName(TEXT("Noise")));
		...
		case 42:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("NOISE")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 43:
			{
				bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("IsInvestigatingSound")));
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf))
				{
					static TWeakFieldPtr<FProperty> __Local__25{};
					const FProperty* __Local__24 = __Local__25.Get();
					if (nullptr == __Local__24)
					{
						__Local__24 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
						check(__Local__24);
						__Local__25 = __Local__24;
					}
					bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf, (((FBoolProperty*)__Local__24)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				}
			}
		case 44:
			{
				bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				bpfv__CallFunc_MakeLiteralName_ReturnValue_3__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("PlayerLocation")));
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::SetValueAsVector(bpfv__CallFunc_MakeLiteralName_ReturnValue_3__pf, b0l__K2Node_ComponentBoundEvent_Stimulus__pf.StimulusLocation);
				}
			}
		case 45:
			{
				bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				bpfv__CallFunc_MakeLiteralName_ReturnValue_6__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("CanSeePlayer")));
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf))
				{
					bpfv__CallFunc_GetValueAsBool_ReturnValue__pf = bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::GetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_6__pf);
				}
				if (!bpfv__CallFunc_GetValueAsBool_ReturnValue__pf)
				{
					__CurrentState = 46;
					break;
				}
		...
		case 46:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_6__pf, false);
				}
			}
		case 47:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("NOTSEE")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		case 48:
			{
				b0l__K2Node_DynamicCast_AsThird_Person_Character__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(b0l__K2Node_ComponentBoundEvent_Actor__pf);
				b0l__K2Node_DynamicCast_bSuccess_4__pf = (b0l__K2Node_DynamicCast_AsThird_Person_Character__pf != nullptr);;
		...
		case 49:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__IsDeath__pf) : (__Local__26)))
				{
					__CurrentState = 50;
					break;
				}
		...
		case 50:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
				b0l__K2Node_DynamicCast_bSuccess_9__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf != nullptr);;
		...
		case 51:
			{
				int32  __Local__27 = 0;
				int32  __Local__28 = 0;
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue_2__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf->bpv__Squad__pf) : (__Local__27)), ((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__Squad__pf) : (__Local__28)));
				if (!bpfv__CallFunc_NotEqual_IntInt_ReturnValue_2__pf)
				{
					__CurrentState = -1;
					break;
				}
		...
		case 52:
			{
				bpv__EnemyReference__pf = b0l__K2Node_DynamicCast_AsThird_Person_Character__pf;
			}
		case 53:
			{
				bpfv__CallFunc_MakeLiteralByte_ReturnValue_2__pf = UKismetSystemLibrary::MakeLiteralByte(0);
				static TWeakFieldPtr<FProperty> __Local__30{};
				const FProperty* __Local__29 = __Local__30.Get();
				if (nullptr == __Local__29)
				{
					__Local__29 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
					check(__Local__29);
					__Local__30 = __Local__29;
				}
				bpf__MakeFocus__pf(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf, static_cast<E__EnumTypesOfCharacters__pf>(bpfv__CallFunc_MakeLiteralByte_ReturnValue_2__pf), (((FBoolProperty*)__Local__29)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				__CurrentState = -1;
				break;
			}
		case 54:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__K2Node_ComponentBoundEvent_Actor__pf);
				b0l__K2Node_DynamicCast_bSuccess_3__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf != nullptr);;
		...
		case 55:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
				b0l__K2Node_DynamicCast_bSuccess_5__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf != nullptr);;
		...
		case 56:
			{
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf);
		...
		case 57:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__IsDeath__pf) : (__Local__31)))
				{
					__CurrentState = 58;
					break;
				}
		...
		case 58:
			{
				int32  __Local__32 = 0;
				int32  __Local__33 = 0;
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__Squad__pf) : (__Local__32)), ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__Squad__pf) : (__Local__33)));
		...
		case 59:
			{
				bpv__EnemyReference__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf;
			}
		case 60:
			{
				bpfv__CallFunc_MakeLiteralByte_ReturnValue_1__pf = UKismetSystemLibrary::MakeLiteralByte(1);
				static TWeakFieldPtr<FProperty> __Local__35{};
				const FProperty* __Local__34 = __Local__35.Get();
				if (nullptr == __Local__34)
				{
					__Local__34 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
					check(__Local__34);
					__Local__35 = __Local__34;
				}
				bpf__MakeFocus__pf(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf, static_cast<E__EnumTypesOfCharacters__pf>(bpfv__CallFunc_MakeLiteralByte_ReturnValue_1__pf), (((FBoolProperty*)__Local__34)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				__CurrentState = -1;
				break;
			}
		case 61:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->IsPlayerControlled();
				}
		...
		case 62:
			{
				...
				{
					__Local__36 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
					check(__Local__36);
					__Local__37 = __Local__36;
				}
				bpf__PlayerInVision__pf((((FBoolProperty*)__Local__36)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)), b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf);
				__CurrentState = -1;
				break;
			}
		case 63:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf = Cast<AEnemyDogCh_C__pf3349424045>(b0l__K2Node_ComponentBoundEvent_Actor__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf != nullptr);;
		...
		case 64:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
				b0l__K2Node_DynamicCast_bSuccess_6__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf != nullptr);;
		...
		case 65:
			{
				int32  __Local__38 = 0;
				int32  __Local__39 = 0;
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue_1__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpv__Squad__pf) : (__Local__38)), ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf->bpv__Squad__pf) : (__Local__39)));
		...
		case 66:
			{
				bool  __Local__40 = false;
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpv__IsDeath__pf) : (__Local__40)))
				{
					__CurrentState = 67;
					break;
				}
		...
		case 67:
			{
				bpv__EnemyReference__pf = b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf;
			}
		case 68:
			{
				bpfv__CallFunc_MakeLiteralByte_ReturnValue__pf = UKismetSystemLibrary::MakeLiteralByte(6);
				static TWeakFieldPtr<FProperty> __Local__42{};
				const FProperty* __Local__41 = __Local__42.Get();
				if (nullptr == __Local__41)
				{
					__Local__41 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
					check(__Local__41);
					__Local__42 = __Local__41;
				}
				bpf__MakeFocus__pf(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf, static_cast<E__EnumTypesOfCharacters__pf>(bpfv__CallFunc_MakeLiteralByte_ReturnValue__pf), (((FBoolProperty*)__Local__41)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				__CurrentState = -1;
				break;
			}
		default:
...
void AAIShootingController_C__pf681293266::bpf__ExecuteUbergraph_AIShootingController__pf_1(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_RunBehaviorTree_ReturnValue__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue__pf{};
	int32 bpfv__CallFunc_Array_Length_ReturnValue__pf{};
	int32 bpfv__CallFunc_Array_Add_ReturnValue__pf{};
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf{};
	UBlackboardComponent* bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf{};
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue_1__pf{};
	bool bpfv__CallFunc_Less_IntInt_ReturnValue__pf{};
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue_2__pf{};
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_4__pf{};
	...
	do
	{
		...
		case 10:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__K2Node_Event_PossessedPawn__pf);
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf != nullptr);;
		...
		case 11:
			{
				bpv__ControlledCharacter__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf;
			}
		case 12:
			{
				bpfv__CallFunc_RunBehaviorTree_ReturnValue__pf = RunBehaviorTree(CastChecked<UBehaviorTree>(CastChecked<UDynamicClass>(AAIShootingController_C__pf681293266::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
			}
		case 13:
			{
				bool  __Local__43 = false;
				bpv__IsVIP__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__IsVIP__pf) : (__Local__43));
			}
		case 14:
			{
		...
		case 17:
			{
				bpfv__CallFunc_Array_Length_ReturnValue_2__pf = FCustomThunkTemplates::Array_Length(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf);
				bpfv__CallFunc_Less_IntInt_ReturnValue_1__pf = UKismetMathLibrary::Less_IntInt(b0l__Temp_int_Loop_Counter_Variable_1__pf, bpfv__CallFunc_Array_Length_ReturnValue_2__pf);
		...
		case 20:
			{
				FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf, b0l__Temp_int_Array_Index_Variable_1__pf, /*out*/ b0l__CallFunc_Array_Get_Item_2__pf);
				b0l__K2Node_DynamicCast_AsLevel_Completer_BP__pf = Cast<ALevelCompleterBP_C__pf922009354>(b0l__CallFunc_Array_Get_Item_2__pf);
				b0l__K2Node_DynamicCast_bSuccess_8__pf = (b0l__K2Node_DynamicCast_AsLevel_Completer_BP__pf != nullptr);;
		...
		case 21:
			{
				bpv__LevelCompleter__pf = b0l__K2Node_DynamicCast_AsLevel_Completer_BP__pf;
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 22:
		...
		case 24:
			{
				TArray<ATargetPoint*>  __Local__44 = {};
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__PatrolPoints__pf) : (__Local__44)));
		...
		case 27:
			{
				TArray<ATargetPoint*>  __Local__45 = {};
				FCustomThunkTemplates::Array_Get(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__PatrolPoints__pf) : (__Local__45)), b0l__Temp_int_Array_Index_Variable__pf, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
				bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(bpv__PatrolPoints__pf, b0l__CallFunc_Array_Get_Item__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 28:
			{
				AAlarm_C__pf2693064426*  __Local__46 = ((AAlarm_C__pf2693064426*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__AlarmPoint__pf) : (__Local__46)));
		...
		case 29:
			{
				AAlarm_C__pf2693064426*  __Local__47 = ((AAlarm_C__pf2693064426*)nullptr);
				bpv__AlarmPoint__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__AlarmPoint__pf) : (__Local__47));
			}
		case 30:
			{
				AAlarm_C__pf2693064426*  __Local__48 = ((AAlarm_C__pf2693064426*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__AlarmPoint__pf) : (__Local__48)));
				bpv__CanAIGoToAlarmController__pf = bpfv__CallFunc_IsValid_ReturnValue__pf;
			}
		case 31:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("CanAIGoToAlarm")));
				bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf, bpv__CanAIGoToAlarmController__pf);
				}
			}
		case 32:
			{
				bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				bpfv__CallFunc_MakeLiteralName_ReturnValue_4__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("CanSeePlayer")));
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_4__pf, false);
				}
			}
		case 33:
			{
				bool  __Local__49 = false;
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__IsPlayer__pf) : (__Local__49)))
				{
					__CurrentState = 38;
					break;
				}
		...
		case 34:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_7__pf = (b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf != nullptr);;
		...
		case 35:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpf__PlayerDeath__pf(((AActor*)nullptr));
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 38:
			{
				E__EnumWeapon__pf  __Local__50 = E__EnumWeapon__pf::NewEnumerator0;
				bpv__WeaponOfEnemeyController__pf = ((::IsValid(bpv__ControlledCharacter__pf)) ? (bpv__ControlledCharacter__pf->bpv__Weapon__pf) : (__Local__50));
			}
		case 39:
			{
				UKismetSystemLibrary::Delay(this, 0.100000, FLatentActionInfo(1, 840863299, TEXT("ExecuteUbergraph_AIShootingController_1"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		default:
...
void AAIShootingController_C__pf681293266::bpf__ExecuteUbergraph_AIShootingController__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 81);
	return; //KCST_EndOfThread
}
void AAIShootingController_C__pf681293266::bpf__ExecuteUbergraph_AIShootingController__pf_3(int32 bpp__EntryPoint__pf)
{
	FVector bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf(EForceInit::ForceInit);
	UBlackboardComponent* bpfv__CallFunc_GetBlackboard_ReturnValue_3__pf{};
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_5__pf{};
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
		switch( __CurrentState )
		...
		case 70:
			{
				bpf__IsAttackedEnemyDeath__pf(bpv__EnemyReference__pf, /*out*/ b0l__CallFunc_IsAttackedEnemyDeath_IsDeath__pf);
			}
		case 71:
			{
				if (!b0l__CallFunc_IsAttackedEnemyDeath_IsDeath__pf)
				{
					__CurrentState = 73;
					break;
				}
		...
		case 72:
			{
				bpfv__CallFunc_GetBlackboard_ReturnValue_3__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				bpfv__CallFunc_MakeLiteralName_ReturnValue_5__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("CanSeePlayer")));
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_3__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_3__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_5__pf, false);
				}
				__CurrentState = -1;
				break;
			}
		case 73:
			{
				if(::IsValid(bpv__EnemyReference__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = bpv__EnemyReference__pf->AActor::K2_GetActorLocation();
				}
				if(::IsValid(bpv__ControlledCharacter__pf))
				{
					bpv__ControlledCharacter__pf->bpf__Attack__pf(E__EnumTypesOfCharacters__pf::NewEnumerator1, bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf);
				}
				__CurrentState = -1;
				break;
			}
...
void AAIShootingController_C__pf681293266::bpf__ExecuteUbergraph_AIShootingController__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 80);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__ControlledCharacter__pf))
	{
		bpv__ControlledCharacter__pf->bpf__Walk__pf();
	}
	return; //KCST_EndOfThread
}
void AAIShootingController_C__pf681293266::bpf__ExecuteUbergraph_AIShootingController__pf_5(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 79);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__ControlledCharacter__pf))
	{
		bpv__ControlledCharacter__pf->bpf__Run__pf();
	}
	return; //KCST_EndOfThread
}
void AAIShootingController_C__pf681293266::bpf__ExecuteUbergraph_AIShootingController__pf_6(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 3:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf != nullptr);;
		...
		case 4:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf))
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__AttackAim__pf = 0;
				}
			}
		case 5:
			{
				bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__Target__pf, 1);
				bpv__Target__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
			}
		case 6:
			{
				bpfv__CallFunc_Array_Length_ReturnValue_1__pf = FCustomThunkTemplates::Array_Length(bpv__PatrolPoints__pf);
				bpfv__CallFunc_GreaterEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::GreaterEqual_IntInt(bpv__Target__pf, bpfv__CallFunc_Array_Length_ReturnValue_1__pf);
		...
		case 8:
			{
				...
				bpfv__CallFunc_MakeLiteralName_ReturnValue__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("TargetPointKey")));
				FCustomThunkTemplates::Array_Get(bpv__PatrolPoints__pf, bpv__Target__pf, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsObject(bpfv__CallFunc_MakeLiteralName_ReturnValue__pf, b0l__CallFunc_Array_Get_Item_1__pf);
				}
				__CurrentState = -1;
				break;
			}
...
void AAIShootingController_C__pf681293266::bpf__ExecuteUbergraph_AIShootingController__pf_7(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 76);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__ControlledCharacter__pf))
	{
		bpv__ControlledCharacter__pf->bpf__SuicideEvent__pf();
	}
	return; //KCST_EndOfThread
}
void AAIShootingController_C__pf681293266::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_AIShootingController__pf_2(81);
}
void AAIShootingController_C__pf681293266::bpf__Suicide__pf()
{
	bpf__ExecuteUbergraph_AIShootingController__pf_7(76);
}
void AAIShootingController_C__pf681293266::bpf__GetNewPoint__pf()
{
	bpf__ExecuteUbergraph_AIShootingController__pf_6(75);
}
void AAIShootingController_C__pf681293266::bpf__Attack__pf()
{
	bpf__ExecuteUbergraph_AIShootingController__pf_3(69);
}
void AAIShootingController_C__pf681293266::bpf__BndEvt__AIPerception_K2Node_ComponentBoundEvent_0_ActorPerceptionUpdatedDelegate__DelegateSignature__pf(AActor* bpp__Actor__pf, FAIStimulus bpp__Stimulus__pf)
{
	b0l__K2Node_ComponentBoundEvent_Actor__pf = bpp__Actor__pf;
	b0l__K2Node_ComponentBoundEvent_Stimulus__pf = bpp__Stimulus__pf;
	bpf__ExecuteUbergraph_AIShootingController__pf_0(40);
}
void AAIShootingController_C__pf681293266::bpf__ReceivePossess__pf(APawn* bpp__PossessedPawn__pf)
{
	b0l__K2Node_Event_PossessedPawn__pf = bpp__PossessedPawn__pf;
	bpf__ExecuteUbergraph_AIShootingController__pf_1(9);
}
void AAIShootingController_C__pf681293266::bpf__Run__pf()
{
	bpf__ExecuteUbergraph_AIShootingController__pf_5(79);
}
void AAIShootingController_C__pf681293266::bpf__Walk__pf()
{
	bpf__ExecuteUbergraph_AIShootingController__pf_4(80);
}
void AAIShootingController_C__pf681293266::bpf__MakeFocus__pf(AActor* bpp__EnemyCast__pf, E__EnumTypesOfCharacters__pf bpp__TypeOfCharacter__pf, bool bpp__Successfully_Sensed__pf)
{
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue__pf{};
	FVector bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf(EForceInit::ForceInit);
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf{};
	...
	do
	{
		...
		case 1:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_5__pf, bpp__Successfully_Sensed__pf);
				}
			}
		case 2:
			{
				if (!bpp__Successfully_Sensed__pf)
				{
					__CurrentState = 3;
					break;
				}
		...
		case 3:
			{
				if(::IsValid(bpp__EnemyCast__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = bpp__EnemyCast__pf->AActor::K2_GetActorLocation();
				}
				bpfv__CallFunc_MakeLiteralName_ReturnValue_4__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("PlayerLocation")));
				bpfv__CallFunc_GetBlackboard_ReturnValue__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsVector(bpfv__CallFunc_MakeLiteralName_ReturnValue_4__pf, bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf);
				}
			}
		case 4:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue_3__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("RecentlySighted")));
				bpfv__CallFunc_GetBlackboard_ReturnValue__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_3__pf, true);
				}
			}
		case 5:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("TypeOfEnemy")));
				bpfv__CallFunc_GetBlackboard_ReturnValue__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsEnum(bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf, static_cast<uint8>(bpp__TypeOfCharacter__pf));
				}
			}
		case 6:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("PlayerReference")));
				bpfv__CallFunc_GetBlackboard_ReturnValue__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsObject(bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf, bpp__EnemyCast__pf);
				}
			}
		case 7:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("IsEnemyOfDogAlive")));
				bpfv__CallFunc_GetBlackboard_ReturnValue__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
...
void AAIShootingController_C__pf681293266::bpf__DieFunction__pf()
{
	...
	bool bpfv__Temp_bool_Has_Been_Initd_Variable__pf{};
	UGameInstance* bpfv__CallFunc_GetGameInstance_ReturnValue__pf{};
	...
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess_5__pf{};
	float bpfv__CallFunc_GetDistanceTo_ReturnValue__pf{};
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf{};
	...
	bool bpfv__CallFunc_IsPlayerControlled_ReturnValue__pf{};
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess_8__pf{};
	int32 bpfv__CallFunc_Array_Length_ReturnValue__pf{};
	bool bpfv__CallFunc_Less_IntInt_ReturnValue__pf{};
	bool bpfv__Temp_bool_IsClosed_Variable__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue__pf{};
	...
	AThirdPersonCharacter_C__pf2222656877* bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess_9__pf{};
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
		...
		case 2:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsDeath__pf = true;
				}
			}
		case 3:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpf__DyingAnimation__pf();
				}
			}
		case 4:
			{
		...
		case 5:
			{
				if (!bpfv__Temp_bool_Has_Been_Initd_Variable__pf)
				{
					__CurrentState = 38;
					break;
				}
		...
		case 6:
			{
				if (!bpfv__Temp_bool_IsClosed_Variable__pf)
				{
					__CurrentState = 7;
					break;
				}
		...
		case 7:
			{
				bpfv__Temp_bool_IsClosed_Variable__pf = true;
			}
		case 8:
			{
		...
		case 14:
			{
				...
				bpfv__CallFunc_NotEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::NotEqual_ObjectObject(bpv__ControlledCharacter__pf, bpfv__CallFunc_Array_Get_Item__pf);
		...
		case 15:
			{
				...
				if(::IsValid(bpv__ControlledCharacter__pf))
				{
					bpfv__CallFunc_GetDistanceTo_ReturnValue__pf = bpv__ControlledCharacter__pf->AActor::GetDistanceTo(bpfv__CallFunc_Array_Get_Item__pf);
				}
				...
				bpfv__CallFunc_Less_FloatFloat_ReturnValue_3__pf = UKismetMathLibrary::Less_FloatFloat(bpfv__CallFunc_GetDistanceTo_ReturnValue__pf, bpv__ClosestDistance__pf);
				bpfv__CallFunc_BooleanAND_ReturnValue_1__pf = UKismetMathLibrary::BooleanAND(bpfv__CallFunc_Less_FloatFloat_ReturnValue_3__pf, bpfv__CallFunc_Less_FloatFloat_ReturnValue__pf);
		...
		case 16:
			{
				FCustomThunkTemplates::Array_Get(bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf, bpfv__Temp_int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__K2Node_DynamicCast_bSuccess_5__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf != nullptr);;
		...
		case 17:
			{
				bool  __Local__52 = false;
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf->bpv__IsDeath__pf) : (__Local__52)))
				{
					__CurrentState = 42;
					break;
				}
		...
		case 24:
			{
				...
				bpfv__CallFunc_NotEqual_ObjectObject_ReturnValue_1__pf = UKismetMathLibrary::NotEqual_ObjectObject(bpv__ControlledCharacter__pf, bpfv__CallFunc_Array_Get_Item_1__pf);
		...
		case 25:
			{
				...
				if(::IsValid(bpv__ControlledCharacter__pf))
				{
					bpfv__CallFunc_GetDistanceTo_ReturnValue_1__pf = bpv__ControlledCharacter__pf->AActor::GetDistanceTo(bpfv__CallFunc_Array_Get_Item_1__pf);
				}
				bpfv__CallFunc_Less_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::Less_FloatFloat(bpfv__CallFunc_GetDistanceTo_ReturnValue_1__pf, bpv__MinDistance__pf);
				bpfv__CallFunc_Less_FloatFloat_ReturnValue_2__pf = UKismetMathLibrary::Less_FloatFloat(bpfv__CallFunc_GetDistanceTo_ReturnValue_1__pf, bpv__ClosestDistance__pf);
				bpfv__CallFunc_BooleanAND_ReturnValue__pf = UKismetMathLibrary::BooleanAND(bpfv__CallFunc_Less_FloatFloat_ReturnValue_2__pf, bpfv__CallFunc_Less_FloatFloat_ReturnValue_1__pf);
		...
		case 26:
			{
				FCustomThunkTemplates::Array_Get(bpfv__CallFunc_GetAllActorsOfClass_OutActors_1__pf, bpfv__Temp_int_Array_Index_Variable_1__pf, /*out*/ bpfv__CallFunc_Array_Get_Item_1__pf);
				bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpfv__CallFunc_Array_Get_Item_1__pf);
				bpfv__K2Node_DynamicCast_bSuccess_9__pf = (bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_9__pf)
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
					break;
				}
		...
		case 27:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf)) ? (bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__IsDeath__pf) : (__Local__53)))
				{
					__CurrentState = 46;
					break;
				}
		...
		case 28:
			{
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(bpv__ToPossesActor__pf);
				if (!bpfv__CallFunc_IsValid_ReturnValue__pf)
				{
					__CurrentState = 37;
					break;
		...
		case 29:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("Up")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 30:
			{
				bpv__DyingCharacter__pf = bpv__ControlledCharacter__pf;
			}
		case 31:
			{
				bpf__SpawnPossesionPS__pf(bpv__ToPossesActor__pf);
			}
		case 32:
			{
				if(::IsValid(bpv__ToPossesActor__pf))
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue__pf = bpv__ToPossesActor__pf->IsPlayerControlled();
				}
				if (!bpfv__CallFunc_IsPlayerControlled_ReturnValue__pf)
				{
					__CurrentState = 48;
		...
		case 33:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("PossesingPlayer")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 34:
			{
				bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpv__ToPossesActor__pf);
				bpfv__K2Node_DynamicCast_bSuccess_7__pf = (bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf != nullptr);;
		...
		case 35:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__IsGodModeActive__pf) : (__Local__54)))
				{
					__CurrentState = 67;
					break;
				}
		...
		case 36:
			{
				bpf__FullDeath__pf(bpv__ControlledCharacter__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 37:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("Down")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = 36;
				break;
			}
		case 38:
			{
				bpfv__Temp_bool_Has_Been_Initd_Variable__pf = true;
			}
		case 39:
			{
				if (!false)
		...
		case 42:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf->bpv__IsSuiciding__pf) : (__Local__55)))
				{
					__CurrentState = 43;
					break;
				}
		...
		case 43:
			{
				bpv__ToPossesActor__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf;
			}
		case 44:
			{
				FCustomThunkTemplates::Array_Get(bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf, bpfv__Temp_int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
		...
		case 46:
			{
				bpv__ToPossesActor__pf = bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf;
			}
		case 47:
			{
				FCustomThunkTemplates::Array_Get(bpfv__CallFunc_GetAllActorsOfClass_OutActors_1__pf, bpfv__Temp_int_Array_Index_Variable_1__pf, /*out*/ bpfv__CallFunc_Array_Get_Item_1__pf);
				...
				bpv__ClosestDistance__pf = bpfv__CallFunc_GetDistanceTo_ReturnValue_1__pf;
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 48:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("PossessingAnotherAI")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 49:
			{
				bool  __Local__56 = false;
				if (!((::IsValid(bpv__ControlledCharacter__pf)) ? (bpv__ControlledCharacter__pf->bpv__IsPlayer__pf) : (__Local__56)))
				{
					__CurrentState = 54;
					break;
				}
		...
		case 50:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ToPossesActor__pf);
				bpfv__K2Node_DynamicCast_bSuccess_8__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf != nullptr);;
		...
		case 51:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf) && ::IsValid((*(AccessPrivateProperty<UCharacterMovementComponent* >((bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf), ACharacter::__PPO__CharacterMovement() )))))
				{
					(*(AccessPrivateProperty<UCharacterMovementComponent* >((bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf), ACharacter::__PPO__CharacterMovement() )))->MaxWalkSpeed = 800.000000;
				}
			}
		case 52:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf->bpv__IsPlayer__pf = true;
				}
			}
		case 53:
			{
				bpf__FullDeath__pf(bpv__DyingCharacter__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 54:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
				bpfv__K2Node_DynamicCast_bSuccess_2__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf != nullptr);;
		...
		case 55:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__IsVIP__pf) : (__Local__57)))
				{
					__CurrentState = 59;
					break;
				}
		...
		case 56:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__IsVIP__pf = false;
				}
			}
		case 57:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ToPossesActor__pf);
		...
		case 58:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__IsVIP__pf = true;
				}
			}
		case 59:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ToPossesActor__pf);
				bpfv__K2Node_DynamicCast_bSuccess_3__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf != nullptr);;
		...
		case 60:
			{
				E__EnumWeapon__pf  __Local__58 = E__EnumWeapon__pf::NewEnumerator0;
				bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue_1__pf = UKismetMathLibrary::EqualEqual_ByteByte(static_cast<uint8>(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__Weapon__pf) : (__Local__58))), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator3));
		...
		case 61:
			{
				E__EnumWeapon__pf  __Local__59 = E__EnumWeapon__pf::NewEnumerator0;
				bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ByteByte(static_cast<uint8>(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__Weapon__pf) : (__Local__59))), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator2));
		...
		case 62:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ToPossesActor__pf);
				bpfv__K2Node_DynamicCast_bSuccess_6__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf != nullptr);;
		...
		case 63:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf->bpv__IsGodModeActive__pf) : (__Local__60)))
				{
					__CurrentState = 64;
					break;
				}
		...
		case 64:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf->bpv__IsDeath__pf = true;
				}
			}
		case 65:
			{
				...
				bpfv__K2Node_DynamicCast_bSuccess_4__pf = (bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf != nullptr);;
		...
		case 66:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpf__PlayerDeath__pf(bpv__ControlledCharacter__pf);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 67:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__IsDeath__pf = true;
				}
				__CurrentState = 65;
				break;
			}
...
void AAIShootingController_C__pf681293266::bpf__FullDeath__pf(AEnemyShootingCh_C__pf3349424045* bpp__NewParam__pf)
{
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	...
	AShotgunPickUp_C__pf1651478651* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	...
	ARiflePickUp_C__pf1651478651* bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf{};
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpp__NewParam__pf);
				bpfv__K2Node_DynamicCast_bSuccess__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess__pf)
				{
					__CurrentState = -1;
		...
		case 2:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->AActor::SetActorEnableCollision(false);
				}
			}
		case 3:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid((*(AccessPrivateProperty<UCapsuleComponent* >((bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf), ACharacter::__PPO__CapsuleComponent() )))))
				{
					(*(AccessPrivateProperty<UCapsuleComponent* >((bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf), ACharacter::__PPO__CapsuleComponent() )))->SetCollisionEnabled(ECollisionEnabled::NoCollision);
				}
			}
		case 4:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__WeaponEnemy__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__WeaponEnemy__pf->USceneComponent::SetVisibility(false, true);
				}
			}
		case 5:
			{
				E__EnumWeapon__pf  __Local__61 = E__EnumWeapon__pf::NewEnumerator0;
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__Weapon__pf) : (__Local__61))), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator0));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 6;
					break;
				}
				E__EnumWeapon__pf  __Local__62 = E__EnumWeapon__pf::NewEnumerator0;
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__Weapon__pf) : (__Local__62))), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator1));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
		...
		case 6:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__FireRifle__pf))
				{
					bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__FireRifle__pf->USceneComponent::K2_GetComponentRotation();
				}
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__FireRifle__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__FireRifle__pf->USceneComponent::K2_GetComponentLocation();
				}
				...
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, ARiflePickUp_C__pf1651478651::StaticClass(), bpfv__CallFunc_MakeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
			}
		case 7:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__FireRifle__pf))
				...
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf, FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf = CastChecked<ARiflePickUp_C__pf1651478651>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf, bpfv__CallFunc_MakeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 8:
			{
				bpfv__K2Node_DynamicCast_AsRifle_Pick_Up__pf = Cast<ARiflePickUp_C__pf1651478651>(bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf);
				bpfv__K2Node_DynamicCast_bSuccess_4__pf = (bpfv__K2Node_DynamicCast_AsRifle_Pick_Up__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_4__pf)
				{
					__CurrentState = -1;
					break;
		...
		case 9:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsRifle_Pick_Up__pf->bpv__WeaponType__pf = bpv__WeaponOfEnemeyController__pf;
				}
			}
		case 10:
			{
		...
		case 12:
			{
				bpfv__K2Node_DynamicCast_AsLevel_Completer_BP_1__pf = Cast<ALevelCompleterBP_C__pf922009354>(bpv__LevelCompleter__pf);
				bpfv__K2Node_DynamicCast_bSuccess_2__pf = (bpfv__K2Node_DynamicCast_AsLevel_Completer_BP_1__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_2__pf)
				{
					__CurrentState = -1;
					break;
		...
		case 16:
			{
				bpfv__K2Node_DynamicCast_AsLevel_Completer_BP__pf = Cast<ALevelCompleterBP_C__pf922009354>(bpv__LevelCompleter__pf);
				bpfv__K2Node_DynamicCast_bSuccess_1__pf = (bpfv__K2Node_DynamicCast_AsLevel_Completer_BP__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_1__pf)
				{
					__CurrentState = -1;
					break;
		...
		case 17:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsLevel_Completer_BP__pf))
				{
					bpfv__K2Node_DynamicCast_AsLevel_Completer_BP__pf->bpf__EnemyDeath__pf();
				}
				__CurrentState = 15;
				break;
			}
		case 18:
			{
				...
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf, FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, AShotgunPickUp_C__pf1651478651::StaticClass(), bpfv__CallFunc_MakeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
			}
		case 19:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__FireRifle__pf))
				...
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf, FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<AShotgunPickUp_C__pf1651478651>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_MakeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 20:
			{
				bpfv__K2Node_DynamicCast_AsShotgun_Pick_Up__pf = Cast<AShotgunPickUp_C__pf1651478651>(bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf);
				bpfv__K2Node_DynamicCast_bSuccess_3__pf = (bpfv__K2Node_DynamicCast_AsShotgun_Pick_Up__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_3__pf)
				{
					__CurrentState = -1;
					break;
		...
		case 21:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsShotgun_Pick_Up__pf->bpv__WeaponType__pf = bpv__WeaponOfEnemeyController__pf;
				}
				__CurrentState = 10;
				break;
			}
...
void AAIShootingController_C__pf681293266::bpf__IsAttackedEnemyDeath__pf(AActor* bpp__EnemyReference__pf, /*out*/ bool& bpp__IsDeath__pf)
{
	AThirdPersonCharacter_C__pf2222656877* bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpp__EnemyReference__pf);
		...
		case 2:
			{
				...
				bpv__IsEnemyAttackedDeath__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsDeath__pf) : (__Local__63));
			}
		case 3:
			{
				bpp__IsDeath__pf = bpv__IsEnemyAttackedDeath__pf;
				__CurrentState = -1;
				break;
			}
		case 4:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf = Cast<AEnemyDogCh_C__pf3349424045>(bpp__EnemyReference__pf);
		...
		case 5:
			{
				...
				bpv__IsEnemyAttackedDeath__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpv__IsDeath__pf) : (__Local__64));
				__CurrentState = 3;
				break;
			}
		case 6:
			{
				bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpp__EnemyReference__pf);
		...
		case 7:
			{
				...
				bpv__IsEnemyAttackedDeath__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__IsDeath__pf) : (__Local__65));
				__CurrentState = 3;
				break;
			}
		case 8:
...
void AAIShootingController_C__pf681293266::bpf__DetectPlayer__pf(AActor* bpp__EnemyCast__pf)
{
	uint8 bpfv__CallFunc_MakeLiteralByte_ReturnValue__pf{};
	bpv__EnemyReference__pf = bpp__EnemyCast__pf;
	bpfv__CallFunc_MakeLiteralByte_ReturnValue__pf = UKismetSystemLibrary::MakeLiteralByte(1);
	bpf__MakeFocus__pf(bpv__EnemyReference__pf, static_cast<E__EnumTypesOfCharacters__pf>(bpfv__CallFunc_MakeLiteralByte_ReturnValue__pf), true);
}
void AAIShootingController_C__pf681293266::bpf__AddToVision__pf()
{
	int32 bpfv__Temp_int_Array_Index_Variable__pf{};
	int32 bpfv__Temp_int_Loop_Counter_Variable__pf{};
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	UAIPerceptionComponent* bpfv__K2Node_DynamicCast_AsAIPerception_Component__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess_1__pf{};
	TArray<AActor*> bpfv__CallFunc_GetPerceivedActors_OutActors__pf{};
	int32 bpfv__CallFunc_Array_Length_ReturnValue__pf{};
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_DynamicCast_AsAIPerception_Component__pf = Cast<UAIPerceptionComponent>(bpv__AIPerception__pf);
				bpfv__K2Node_DynamicCast_bSuccess_1__pf = (bpfv__K2Node_DynamicCast_AsAIPerception_Component__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_1__pf)
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
					break;
		...
		case 4:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsAIPerception_Component__pf))
				{
					(bpfv__CallFunc_GetPerceivedActors_OutActors__pf).Reset();
					bpfv__K2Node_DynamicCast_AsAIPerception_Component__pf->UAIPerceptionComponent::GetPerceivedActors(UAISense_Sight::StaticClass(), /*out*/ bpfv__CallFunc_GetPerceivedActors_OutActors__pf);
				}
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(bpfv__CallFunc_GetPerceivedActors_OutActors__pf);
				bpfv__CallFunc_Less_IntInt_ReturnValue__pf = UKismetMathLibrary::Less_IntInt(bpfv__Temp_int_Loop_Counter_Variable__pf, bpfv__CallFunc_Array_Length_ReturnValue__pf);
				if (!bpfv__CallFunc_Less_IntInt_ReturnValue__pf)
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
		...
		case 7:
			{
				...
				FCustomThunkTemplates::Array_Get(bpfv__CallFunc_GetPerceivedActors_OutActors__pf, bpfv__Temp_int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__K2Node_DynamicCast_bSuccess_2__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_2__pf)
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
					break;
		...
		case 9:
			{
				TArray<AEnemyShootingCh_C__pf3349424045*>  __Local__66 = {};
				bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__ActorsInVision__pf) : (__Local__66)), bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 10:
...
void AAIShootingController_C__pf681293266::bpf__PlayerInVision__pf(bool bpp__IsEnteringInSight__pf, AEnemyShootingCh_C__pf3349424045* bpp__Player__pf)
{
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf{};
	...
	do
	{
		...
		case 2:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpp__Player__pf);
				bpfv__K2Node_DynamicCast_bSuccess_2__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_2__pf)
				{
					__CurrentState = -1;
		...
		case 3:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
				bpfv__K2Node_DynamicCast_bSuccess_3__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_3__pf)
				{
					__CurrentState = -1;
		...
		case 4:
			{
				TArray<AEnemyShootingCh_C__pf3349424045*>  __Local__67 = {};
				bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__ActorsInVision__pf) : (__Local__67)), bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf);
				__CurrentState = -1;
				break;
			}
		case 5:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpp__Player__pf);
				bpfv__K2Node_DynamicCast_bSuccess__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess__pf)
				{
					__CurrentState = -1;
		...
		case 6:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
				bpfv__K2Node_DynamicCast_bSuccess_1__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_1__pf)
				{
					__CurrentState = -1;
		...
		case 7:
			{
				TArray<AEnemyShootingCh_C__pf3349424045*>  __Local__68 = {};
				bpfv__CallFunc_Array_RemoveItem_ReturnValue__pf = FCustomThunkTemplates::Array_RemoveItem(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__ActorsInVision__pf) : (__Local__68)), bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf);
				__CurrentState = -1;
				break;
			}
		default:
...
void AAIShootingController_C__pf681293266::bpf__GetSoundAlert__pf(AActor* bpp__EnemyCast__pf)
{
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue__pf{};
	FVector bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf(EForceInit::ForceInit);
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf{};
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("CanSeePlayer")));
				bpfv__CallFunc_GetBlackboard_ReturnValue__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetValueAsBool_ReturnValue__pf = bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::GetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf);
				}
				if (!bpfv__CallFunc_GetValueAsBool_ReturnValue__pf)
				{
					__CurrentState = 2;
		...
		case 2:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("IsInvestigatingSound")));
				bpfv__CallFunc_GetBlackboard_ReturnValue__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf, true);
				}
			}
		case 3:
			{
				bpfv__CallFunc_MakeLiteralName_ReturnValue__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("PlayerLocation")));
				if(::IsValid(bpp__EnemyCast__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = bpp__EnemyCast__pf->AActor::K2_GetActorLocation();
				}
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsVector(bpfv__CallFunc_MakeLiteralName_ReturnValue__pf, bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf);
				}
				__CurrentState = -1;
				break;
			}
...
void AAIShootingController_C__pf681293266::bpf__SpawnPossesionPS__pf(AActor* bpp__TargetActor__pf)
{
	FTransform bpfv__CallFunc_MakeTransform_ReturnValue__pf{};
	...
	bpfv__K2Node_MakeStruct_ParticleSysParam_1__pf.Actor = bpv__ControlledCharacter__pf;
...
PRAGMA_DISABLE_OPTIMIZATION
void AAIShootingController_C__pf681293266::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AAIShootingController_C__pf681293266::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{625, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/AIModule.AIPerceptionComponent 
		...
		{629, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/AIModule.AIStimulus 
		...
		{196, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/AIModule.AIController 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AAIShootingController_C__pf681293266
{
	FRegisterHelper__AAIShootingController_C__pf681293266()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Enemies/BehaviorShooting/AIShootingController"), &AAIShootingController_C__pf681293266::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AAIShootingController_C__pf681293266 Instance;
};
FRegisterHelper__AAIShootingController_C__pf681293266 FRegisterHelper__AAIShootingController_C__pf681293266::Instance;
