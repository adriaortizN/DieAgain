...
#include "PlaneCharacter__pf3858658621.h"
...
APlaneCharacter_C__pf3858658621::APlaneCharacter_C__pf3858658621(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__1)
	{
		...
		__Local__1->MaxWalkSpeed = 3000.000000f;
		__Local__1->MaxAcceleration = 3000.000000f;
		__Local__1->BrakingFrictionFactor = 0.000000f;
	...
	bpv__Steiner__pf = CreateDefaultSubobject<USkeletalMeshComponent>(TEXT("Steiner"));
	bpv__RotatingMovement__pf = CreateDefaultSubobject<URotatingMovementComponent>(TEXT("RotatingMovement"));
	bpv__PlaneSong__pf = CreateDefaultSubobject<UFMODAudioComponent>(TEXT("PlaneSong"));
	bpv__PlaneMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__PlaneMesh__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__14 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__PlaneMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__14 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APlaneCharacter_C__pf3858658621::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	(((FBoolProperty*)__Local__15)->SetPropertyValue_InContainer((bpv__PlaneMesh__pf), false, 0));
	bpv__Camera__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Camera__pf->AttachToComponent(bpv__PlaneMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__17 = (*(AccessPrivateProperty<FVector >((bpv__Camera__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__17 = FVector(-0.000041, -300.000000, 110.000000);
	...
	(((FBoolProperty*)__Local__15)->SetPropertyValue_InContainer((bpv__Camera__pf), false, 0));
	bpv__ParticleSystem__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ParticleSystem__pf->AttachToComponent(bpv__PlaneMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__ParticleSystem__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(APlaneCharacter_C__pf3858658621::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	auto& __Local__19 = (*(AccessPrivateProperty<FVector >((bpv__ParticleSystem__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__19 = FVector(0.000000, 505.000000, -3.000000);
	bpv__ParticleSystem__pf->PrimaryComponentTick.bStartWithTickEnabled = false;
	(((FBoolProperty*)__Local__15)->SetPropertyValue_InContainer((bpv__ParticleSystem__pf), false, 0));
	bpv__Steiner__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Steiner__pf->AttachToComponent(bpv__PlaneMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Steiner__pf->AnimationData.AnimToPlay = CastChecked<UAnimationAsset>(CastChecked<UDynamicClass>(APlaneCharacter_C__pf3858658621::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	auto& __Local__20 = (*(AccessPrivateProperty<TEnumAsByte<EAnimationMode::Type> >((bpv__Steiner__pf), USkeletalMeshComponent::__PPO__AnimationMode() )));
	__Local__20 = EAnimationMode::Type::AnimationSingleNode;
	bpv__Steiner__pf->ClothingSimulationFactory = UClothingSimulationFactoryNv::StaticClass();
	bpv__Steiner__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(APlaneCharacter_C__pf3858658621::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	bpv__Steiner__pf->VisibilityBasedAnimTickOption = EVisibilityBasedAnimTickOption::AlwaysTickPoseAndRefreshBones;
	auto& __Local__21 = (*(AccessPrivateProperty<FVector >((bpv__Steiner__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__21 = FVector(2.999137, -268.000000, 51.000000);
	auto& __Local__22 = (*(AccessPrivateProperty<FRotator >((bpv__Steiner__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__22 = FRotator(0.000000, -180.000183, 0.000000);
	(((FBoolProperty*)__Local__15)->SetPropertyValue_InContainer((bpv__Steiner__pf), false, 0));
	bpv__RotatingMovement__pf->CreationMethod = EComponentCreationMethod::Native;
	(((FBoolProperty*)__Local__15)->SetPropertyValue_InContainer((bpv__RotatingMovement__pf), false, 0));
	bpv__PlaneSong__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__PlaneSong__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__PlaneSong__pf->Event = CastChecked<UFMODEvent>(CastChecked<UDynamicClass>(APlaneCharacter_C__pf3858658621::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	bpv__PlaneSong__pf->bAutoActivate = false;
	(((FBoolProperty*)__Local__15)->SetPropertyValue_InContainer((bpv__PlaneSong__pf), false, 0));
...
void APlaneCharacter_C__pf3858658621::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__PlaneSong__pf)
	{
		bpv__PlaneSong__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void APlaneCharacter_C__pf3858658621::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void APlaneCharacter_C__pf3858658621::bpf__ExecuteUbergraph_PlaneCharacter__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 15:
			{
				bpv__Dialogue__pf = CastChecked<UDialogue>(CastChecked<UDynamicClass>(APlaneCharacter_C__pf3858658621::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
			}
		case 16:
			{
				bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
		...
		case 40:
			{
				...
				bpfv__CallFunc_EqualEqual_VectorVector_ReturnValue__pf = UKismetMathLibrary::EqualEqual_VectorVector(bpfv__CallFunc_GetCameraLocation_ReturnValue__pf, FVector(-73898.476563,-3006.800049,14943.650391), 100.000000);
		...
		case 46:
			{
				b1l__K2Node_DynamicCast_AsChameleon__pf = Cast<AChameleon_C__pf565858488>(bpv__ChameleonRef__pf);
				b1l__K2Node_DynamicCast_bSuccess__pf = (b1l__K2Node_DynamicCast_AsChameleon__pf != nullptr);;
		...
		case 47:
			{
				if(::IsValid(b1l__K2Node_DynamicCast_AsChameleon__pf))
				{
					b1l__K2Node_DynamicCast_AsChameleon__pf->bpv__SpeedxLines__pfT = true;
				}
			}
		case 48:
			{
				UKismetSystemLibrary::Delay(this, 0.800000, FLatentActionInfo(13, 491521955, TEXT("ExecuteUbergraph_PlaneCharacter_0"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		default:
...
void APlaneCharacter_C__pf3858658621::bpf__ExecuteUbergraph_PlaneCharacter__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				...
				UGameplayStatics::GetAllActorsOfClass(this, AChameleon_C__pf565858488::StaticClass(), /*out*/ TArrayCaster<AChameleon_C__pf565858488*>(b1l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
			}
		case 5:
			{
		...
		case 7:
			{
				...
				bpfv__CallFunc_Less_IntInt_ReturnValue_1__pf = UKismetMathLibrary::Less_IntInt(b1l__Temp_int_Loop_Counter_Variable__pf, bpfv__CallFunc_Array_Length_ReturnValue_1__pf);
		...
		case 10:
			{
				FCustomThunkTemplates::Array_Get(b1l__CallFunc_GetAllActorsOfClass_OutActors__pf, b1l__Temp_int_Array_Index_Variable__pf, /*out*/ b1l__CallFunc_Array_Get_Item_1__pf);
				b1l__K2Node_DynamicCast_AsChameleon_1__pf = Cast<AChameleon_C__pf565858488>(b1l__CallFunc_Array_Get_Item_1__pf);
				b1l__K2Node_DynamicCast_bSuccess_1__pf = (b1l__K2Node_DynamicCast_AsChameleon_1__pf != nullptr);;
		...
		case 11:
			{
				bpv__ChameleonRef__pf = b1l__K2Node_DynamicCast_AsChameleon_1__pf;
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 12:
		...
		case 23:
			{
				if(::IsValid(bpv__PlaneSong__pf))
				{
					bpv__PlaneSong__pf->UFMODAudioComponent::Play();
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 24:
			{
				UKismetSystemLibrary::Delay(this, 0.100000, FLatentActionInfo(3, 1785242561, TEXT("ExecuteUbergraph_PlaneCharacter_1"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		default:
...
void APlaneCharacter_C__pf3858658621::bpf__ExecuteUbergraph_PlaneCharacter__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 27:
			{
				b1l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("CheckRotation")));
				bpfv__CallFunc_K2_SetTimerDelegate_ReturnValue__pf = UKismetSystemLibrary::K2_SetTimerDelegate(b1l__K2Node_CreateDelegate_OutputDelegate__pf, 0.050000, true, 0.000000, 0.000000);
			}
		case 28:
			{
				if(::IsValid((*(AccessPrivateProperty<UCharacterMovementComponent* >((this), ACharacter::__PPO__CharacterMovement() )))))
				{
					(*(AccessPrivateProperty<UCharacterMovementComponent* >((this), ACharacter::__PPO__CharacterMovement() )))->MaxWalkSpeed = 10000000.000000;
				}
			}
		case 29:
			{
		...
		case 32:
			{
				bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__Target__pf, 1);
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::NotEqual_IntInt(bpfv__CallFunc_Add_IntInt_ReturnValue__pf, 3);
		...
		case 33:
			{
				if(::IsValid(bpv__RotatingMovement__pf))
				{
					bpv__RotatingMovement__pf->RotationRate = FRotator(0.000000,0.000000,-10.000000);
				}
				__CurrentState = 27;
				break;
			}
...
void APlaneCharacter_C__pf3858658621::bpf__ExecuteUbergraph_PlaneCharacter__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	{
		bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf = bpv__PlaneMesh__pf->USceneComponent::K2_GetComponentRotation();
	}
	UKismetMathLibrary::BreakRotator(bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf, /*out*/ b1l__CallFunc_BreakRotator_Roll__pf, /*out*/ b1l__CallFunc_BreakRotator_Pitch__pf, /*out*/ b1l__CallFunc_BreakRotator_Yaw__pf);
	bpfv__CallFunc_Less_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Less_FloatFloat(b1l__CallFunc_BreakRotator_Roll__pf, -25.000000);
...
void APlaneCharacter_C__pf3858658621::bpf__ExecuteUbergraph_PlaneCharacter__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	FCustomThunkTemplates::Array_Get(bpv__ArrayTargetPoints__pf, bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf, /*out*/ b1l__CallFunc_Array_Get_Item__pf);
	if(::IsValid(b1l__CallFunc_Array_Get_Item__pf))
	{
		bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = b1l__CallFunc_Array_Get_Item__pf->AActor::K2_GetActorLocation();
	}
...
void APlaneCharacter_C__pf3858658621::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b1l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_PlaneCharacter__pf_0(38);
}
void APlaneCharacter_C__pf3858658621::bpf__MoveTo__pf()
{
	bpf__ExecuteUbergraph_PlaneCharacter__pf_2(37);
}
void APlaneCharacter_C__pf3858658621::bpf__CheckRotation__pf()
{
	bpf__ExecuteUbergraph_PlaneCharacter__pf_3(34);
}
void APlaneCharacter_C__pf3858658621::bpf__MoveToTarget__pf()
{
	bpf__ExecuteUbergraph_PlaneCharacter__pf_4(25);
}
void APlaneCharacter_C__pf3858658621::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_PlaneCharacter__pf_1(20);
}
PRAGMA_DISABLE_OPTIMIZATION
void APlaneCharacter_C__pf3858658621::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{936, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/scifi_kitbash/meshes/SM_Plane.SM_Plane 
		...
		{937, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  FMODEvent /Game/FMOD/Events/Sounds/LevelsMusic/PlaneLV/PlaneLV_Music.PlaneLV_Music 
		{1031, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Dialogue /Game/Conversations/LVTutorial/PlaneConversation.PlaneConversation 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APlaneCharacter_C__pf3858658621::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{1032, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.PlayerCameraManager 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APlaneCharacter_C__pf3858658621
{
	FRegisterHelper__APlaneCharacter_C__pf3858658621()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/PlaneControlled/PlaneCharacter"), &APlaneCharacter_C__pf3858658621::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APlaneCharacter_C__pf3858658621 Instance;
};
FRegisterHelper__APlaneCharacter_C__pf3858658621 FRegisterHelper__APlaneCharacter_C__pf3858658621::Instance;
