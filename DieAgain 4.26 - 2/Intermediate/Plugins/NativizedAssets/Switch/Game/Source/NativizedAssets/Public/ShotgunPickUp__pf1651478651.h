...
#include "ShotgunPickUp__pf1651478651.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Objects/PickUps/ShotgunPickUp.ShotgunPickUp_C", OverrideNativeName="ShotgunPickUp_C"))
class AShotgunPickUp_C__pf1651478651 : public AActor
{
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="BarrelCover"))
	UStaticMeshComponent* bpv__BarrelCover__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="ExtraAmmo"))
	UStaticMeshComponent* bpv__ExtraAmmo__pf;
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="WeaponShotgun"))
	UStaticMeshComponent* bpv__WeaponShotgun__pf;
	...
	AShotgunPickUp_C__pf1651478651(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_ShotgunPickUp__pf_0(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_ShotgunPickUp_1"))
	void bpf__ExecuteUbergraph_ShotgunPickUp__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ShotgunPickUp__pf_2(int32 bpp__EntryPoint__pf);
	...
	virtual void bpf__OverlapClean__pf(AActor* bpp__OldOverlappingActor__pf);
public:
};
