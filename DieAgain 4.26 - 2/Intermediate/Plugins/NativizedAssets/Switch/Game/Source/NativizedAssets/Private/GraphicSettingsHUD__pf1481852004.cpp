...
UGraphicSettingsHUD_C__pf1481852004::UGraphicSettingsHUD_C__pf1481852004(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Button__pf = nullptr;
	bpv__Button_56__pf = nullptr;
	bpv__Button_262__pf = nullptr;
	bpv__Button_397__pf = nullptr;
	bpv__Button_519__pf = nullptr;
	bpv__ItsComingFromMainMenu__pf = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UGraphicSettingsHUD_C__pf1481852004::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UGraphicSettingsHUD_C__pf1481852004::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__2.ComponentPropertyName = FName(TEXT("Button_56"));
	__Local__2.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__Button_56_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__Button_K2Node_ComponentBoundEvent_7_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__4 = __Local__0->ComponentDelegateBindings[2];
	__Local__4.ComponentPropertyName = FName(TEXT("Button_519"));
	__Local__4.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__Button_519_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__5 = __Local__0->ComponentDelegateBindings[3];
	__Local__5.ComponentPropertyName = FName(TEXT("Button_397"));
	__Local__5.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__5.FunctionNameToBind = FName(TEXT("BndEvt__Button_397_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__6 = __Local__0->ComponentDelegateBindings[4];
	__Local__6.ComponentPropertyName = FName(TEXT("Button_262"));
	__Local__6.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__6.FunctionNameToBind = FName(TEXT("BndEvt__Button_262_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
	...
	auto __Local__9 = NewObject<UCanvasPanelSlot>(__Local__7, TEXT("CanvasPanelSlot_10"), (EObjectFlags)0x00280008);
	__Local__9->LayoutData.Offsets.Left = -308.960938f;
	__Local__9->LayoutData.Offsets.Top = 104.000000f;
	__Local__9->LayoutData.Offsets.Right = 623.367798f;
	__Local__9->LayoutData.Offsets.Bottom = 93.619179f;
	...
	auto __Local__10 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_1"), (EObjectFlags)0x00280008);
	__Local__10->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[25B0FEAC42F976DCF2E4D98B283FDD47]\", \"C6773BCF4B72F9090E987EA9BB2CAD24\", \"Graphics settings\")")	);
	__Local__10->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__10->Font.OutlineSettings.OutlineSize = 5;
	__Local__10->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__10->Font.Size = 60;
	__Local__10->Slot = __Local__9;
	__Local__9->Content = __Local__10;
	__Local__8.Add(__Local__9);
	auto __Local__11 = NewObject<UCanvasPanelSlot>(__Local__7, TEXT("CanvasPanelSlot_7"), (EObjectFlags)0x00280008);
	__Local__11->LayoutData.Offsets.Top = 108.997887f;
	__Local__11->LayoutData.Offsets.Right = 607.173767f;
	__Local__11->LayoutData.Offsets.Bottom = 707.333984f;
	...
	auto __Local__12 = NewObject<UVerticalBox>(__Local__1, TEXT("VerticalBox_304"), (EObjectFlags)0x00280008);
	...
	auto __Local__14 = NewObject<UVerticalBoxSlot>(__Local__12, TEXT("VerticalBoxSlot_1"), (EObjectFlags)0x00280008);
	__Local__14->Padding.Bottom = 35.000000f;
	__Local__14->Parent = __Local__12;
	auto __Local__15 = NewObject<UButton>(__Local__1, TEXT("Button_56"), (EObjectFlags)0x00280008);
	...
	__Local__17 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__15->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__18 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__15->WidgetStyle.Hovered.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__18 = FLinearColor(1.000000, 0.226966, 0.219526, 1.000000);
	auto& __Local__19 = (*(AccessPrivateProperty<UObject* >(&(__Local__15->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__19 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__15->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__20 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__15->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__20 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__21 = (*(AccessPrivateProperty<UObject* >(&(__Local__15->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__21 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	auto __Local__23 = NewObject<UButtonSlot>(__Local__15, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__23->Parent = __Local__15;
	auto __Local__24 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_195"), (EObjectFlags)0x00280008);
	__Local__24->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[25B0FEAC42F976DCF2E4D98B283FDD47]\", \"5D7146B243244FB51A097DB66391DBFD\", \"HIgh\")")	);
	...
	__Local__24->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto& __Local__26 = (*(AccessPrivateProperty<FMargin >((__Local__24), UTextLayoutWidget::__PPO__Margin() )));
	...
	auto __Local__27 = NewObject<UVerticalBoxSlot>(__Local__12, TEXT("VerticalBoxSlot_3"), (EObjectFlags)0x00280008);
	__Local__27->Padding.Top = 35.000000f;
	__Local__27->Padding.Bottom = 35.000000f;
	__Local__27->Parent = __Local__12;
	auto __Local__28 = NewObject<UButton>(__Local__1, TEXT("Button_262"), (EObjectFlags)0x00280008);
	...
	__Local__30 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__28->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__31 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__28->WidgetStyle.Hovered.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__31 = FLinearColor(1.000000, 0.226966, 0.219526, 1.000000);
	auto& __Local__32 = (*(AccessPrivateProperty<UObject* >(&(__Local__28->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__32 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__28->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__33 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__28->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__33 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__34 = (*(AccessPrivateProperty<UObject* >(&(__Local__28->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__34 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	auto __Local__36 = NewObject<UButtonSlot>(__Local__28, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__36->Parent = __Local__28;
	auto __Local__37 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_256"), (EObjectFlags)0x00280008);
	__Local__37->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[25B0FEAC42F976DCF2E4D98B283FDD47]\", \"179AB34944A55E692E1AD68C94854228\", \"Medium\")")	);
	auto& __Local__38 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__37->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__38 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__37->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__37->Font.OutlineSettings.OutlineSize = 5;
	__Local__37->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__37->Font.Size = 35;
	auto& __Local__39 = (*(AccessPrivateProperty<FMargin >((__Local__37), UTextLayoutWidget::__PPO__Margin() )));
	__Local__39.Left = 10.000000f;
	__Local__39.Top = 10.000000f;
	__Local__39.Right = 10.000000f;
	__Local__39.Bottom = 10.000000f;
	...
	auto __Local__40 = NewObject<UVerticalBoxSlot>(__Local__12, TEXT("VerticalBoxSlot_4"), (EObjectFlags)0x00280008);
	__Local__40->Padding.Top = 35.000000f;
	__Local__40->Padding.Bottom = 35.000000f;
	__Local__40->Parent = __Local__12;
	auto __Local__41 = NewObject<UButton>(__Local__1, TEXT("Button_397"), (EObjectFlags)0x00280008);
	__Local__41->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__42 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__41->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__42 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__43 = (*(AccessPrivateProperty<UObject* >(&(__Local__41->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__43 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__41->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__44 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__41->WidgetStyle.Hovered.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__44 = FLinearColor(1.000000, 0.226966, 0.219526, 1.000000);
	auto& __Local__45 = (*(AccessPrivateProperty<UObject* >(&(__Local__41->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__45 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__41->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__46 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__41->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__46 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__47 = (*(AccessPrivateProperty<UObject* >(&(__Local__41->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__47 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	auto __Local__49 = NewObject<UButtonSlot>(__Local__41, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__49->Parent = __Local__41;
	auto __Local__50 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_462"), (EObjectFlags)0x00280008);
	__Local__50->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[25B0FEAC42F976DCF2E4D98B283FDD47]\", \"9456079C4968BFBA1BA65991AAA8EA3E\", \"Low\")")	);
	auto& __Local__51 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__50->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__51 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__50->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto __Local__53 = NewObject<UVerticalBoxSlot>(__Local__12, TEXT("VerticalBoxSlot_5"), (EObjectFlags)0x00280008);
	__Local__53->Padding.Top = 35.000000f;
	__Local__53->Padding.Bottom = 35.000000f;
	__Local__53->Parent = __Local__12;
	auto __Local__54 = NewObject<UButton>(__Local__1, TEXT("Button_519"), (EObjectFlags)0x00280008);
	...
	__Local__56 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__54->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__57 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__54->WidgetStyle.Hovered.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__57 = FLinearColor(1.000000, 0.226966, 0.219526, 1.000000);
	auto& __Local__58 = (*(AccessPrivateProperty<UObject* >(&(__Local__54->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__58 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__54->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__59 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__54->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__59 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__60 = (*(AccessPrivateProperty<UObject* >(&(__Local__54->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__60 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	auto& __Local__61 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__54), UPanelWidget::__PPO__Slots() )));
	__Local__61 = TArray<UPanelSlot*> ();
	__Local__61.Reserve(1);
	auto __Local__62 = NewObject<UButtonSlot>(__Local__54, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__62->Parent = __Local__54;
	auto __Local__63 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_606"), (EObjectFlags)0x00280008);
	__Local__63->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[25B0FEAC42F976DCF2E4D98B283FDD47]\", \"B5C1ACA0459869C1C29EAE8CBC5EE568\", \"Very Low\")")	);
	auto& __Local__64 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__63->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__64 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__63->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__63->Font.OutlineSettings.OutlineSize = 5;
	__Local__63->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__63->Font.Size = 35;
	auto& __Local__65 = (*(AccessPrivateProperty<FMargin >((__Local__63), UTextLayoutWidget::__PPO__Margin() )));
	__Local__65.Left = 10.000000f;
	__Local__65.Top = 10.000000f;
	__Local__65.Right = 10.000000f;
	__Local__65.Bottom = 10.000000f;
	...
	auto __Local__66 = NewObject<UVerticalBoxSlot>(__Local__12, TEXT("VerticalBoxSlot_6"), (EObjectFlags)0x00280008);
	__Local__66->Padding.Top = 35.000000f;
	__Local__66->Parent = __Local__12;
	auto __Local__67 = NewObject<UButton>(__Local__1, TEXT("Button"), (EObjectFlags)0x00280008);
	__Local__67->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__68 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__67->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__68 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__69 = (*(AccessPrivateProperty<UObject* >(&(__Local__67->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__69 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__67->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__70 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__67->WidgetStyle.Hovered.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__70 = FLinearColor(1.000000, 0.226966, 0.219526, 1.000000);
	auto& __Local__71 = (*(AccessPrivateProperty<UObject* >(&(__Local__67->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__71 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__67->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__72 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__67->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__72 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__73 = (*(AccessPrivateProperty<UObject* >(&(__Local__67->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__73 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	auto& __Local__74 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__67), UPanelWidget::__PPO__Slots() )));
	__Local__74 = TArray<UPanelSlot*> ();
	__Local__74.Reserve(1);
	auto __Local__75 = NewObject<UButtonSlot>(__Local__67, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__75->Parent = __Local__67;
	auto __Local__76 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock"), (EObjectFlags)0x00280008);
	__Local__76->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[25B0FEAC42F976DCF2E4D98B283FDD47]\", \"A660DA7C49E13FE02E48E68753549845\", \"Go Back\")")	);
	auto& __Local__77 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__76->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__77 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__76->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__76->Font.OutlineSettings.OutlineSize = 5;
	__Local__76->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__76->Font.Size = 35;
	auto& __Local__78 = (*(AccessPrivateProperty<FMargin >((__Local__76), UTextLayoutWidget::__PPO__Margin() )));
	__Local__78.Left = 10.000000f;
	__Local__78.Top = 10.000000f;
	__Local__78.Right = 10.000000f;
	__Local__78.Bottom = 10.000000f;
	...
	__Local__13.Add(__Local__66);
	__Local__12->Slot = __Local__11;
	auto __Local__79 = NewObject<UWidgetNavigation>(__Local__12, TEXT("WidgetNavigation_0"), (EObjectFlags)0x00280008);
	__Local__79->Up.Rule = EUINavigationRule::Stop;
	__Local__79->Down.Rule = EUINavigationRule::Stop;
	__Local__12->Navigation = __Local__79;
	__Local__11->Content = __Local__12;
	__Local__8.Add(__Local__11);
	__Local__1->RootWidget = __Local__7;
}
PRAGMA_ENABLE_OPTIMIZATION
void UGraphicSettingsHUD_C__pf1481852004::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__80;
	SlotNames.Append(__Local__80);
}
void UGraphicSettingsHUD_C__pf1481852004::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__81;
	TArray<FDelegateRuntimeBinding>  __Local__82;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->MiscConvertedSubobjects[0]), __Local__81, __Local__82);
}
void UGraphicSettingsHUD_C__pf1481852004::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UGraphicSettingsHUD_C__pf1481852004::bpf__ExecuteUbergraph_GraphicSettingsHUD__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				if(::IsValid(b1l__CallFunc_GetGameUserSettings_ReturnValue__pf))
				{
					b1l__CallFunc_GetGameUserSettings_ReturnValue__pf->SetOverallScalabilityLevel(2);
				}
			}
		case 3:
			{
				if(::IsValid(b1l__CallFunc_GetGameUserSettings_ReturnValue__pf))
				{
					b1l__CallFunc_GetGameUserSettings_ReturnValue__pf->ApplySettings(true);
				}
			}
		case 4:
			{
		...
		case 6:
			{
				...
				{
					b1l__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__GraphicQuality__pf = 2;
				}
			}
		case 7:
			{
		...
		case 8:
			{
				if (!bpfv__CallFunc_SaveGameToSlot_ReturnValue_1__pf)
				{
					__CurrentState = -1;
					break;
				}
		...
		case 11:
			{
				b1l__CallFunc_Create_ReturnValue__pf = CastChecked<UOptionsHUD_C__pf3479267681>(UWidgetBlueprintLibrary::Create(this, UOptionsHUD_C__pf3479267681::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
			}
		case 12:
			{
				...
				b1l__K2Node_DynamicCast_bSuccess_4__pf = (b1l__K2Node_DynamicCast_AsDie_Again_Gamemode__pf != nullptr);;
		...
		case 15:
			{
				if(::IsValid(b1l__CallFunc_Create_ReturnValue__pf))
				{
					b1l__CallFunc_Create_ReturnValue__pf->bpv__ItsComingFromMainMenu__pf = bpv__ItsComingFromMainMenu__pf;
				}
				__CurrentState = -1;
				break;
			}
		...
		case 17:
			{
				if(::IsValid(b1l__CallFunc_GetGameUserSettings_ReturnValue_1__pf))
				{
					b1l__CallFunc_GetGameUserSettings_ReturnValue_1__pf->SetOverallScalabilityLevel(3);
				}
			}
		case 18:
			{
				if(::IsValid(b1l__CallFunc_GetGameUserSettings_ReturnValue_1__pf))
				{
					b1l__CallFunc_GetGameUserSettings_ReturnValue_1__pf->ApplySettings(true);
				}
			}
		case 19:
			{
		...
		case 21:
			{
				...
				{
					b1l__K2Node_DynamicCast_AsSave_Game_BP_1__pf->bpv__GraphicQuality__pf = 3;
				}
			}
		case 22:
			{
		...
		case 23:
			{
				if (!bpfv__CallFunc_SaveGameToSlot_ReturnValue__pf)
				{
					__CurrentState = -1;
					break;
				}
		...
		case 25:
			{
				if(::IsValid(b1l__CallFunc_GetGameUserSettings_ReturnValue_2__pf))
				{
					b1l__CallFunc_GetGameUserSettings_ReturnValue_2__pf->SetOverallScalabilityLevel(1);
				}
			}
		case 26:
			{
				if(::IsValid(b1l__CallFunc_GetGameUserSettings_ReturnValue_2__pf))
				{
					b1l__CallFunc_GetGameUserSettings_ReturnValue_2__pf->ApplySettings(true);
				}
			}
		case 27:
			{
		...
		case 28:
			{
				b1l__K2Node_DynamicCast_AsSave_Game_BP_3__pf = Cast<USaveGameBP_C__pf4030252459>(bpfv__CallFunc_LoadGameFromSlot_ReturnValue_2__pf);
				b1l__K2Node_DynamicCast_bSuccess_3__pf = (b1l__K2Node_DynamicCast_AsSave_Game_BP_3__pf != nullptr);;
		...
		case 29:
			{
				if(::IsValid(b1l__K2Node_DynamicCast_AsSave_Game_BP_3__pf))
				{
					b1l__K2Node_DynamicCast_AsSave_Game_BP_3__pf->bpv__GraphicQuality__pf = 1;
				}
			}
		case 30:
			{
		...
		case 31:
			{
				if (!bpfv__CallFunc_SaveGameToSlot_ReturnValue_2__pf)
				{
					__CurrentState = -1;
					break;
				}
		...
		case 33:
			{
				if(::IsValid(b1l__CallFunc_GetGameUserSettings_ReturnValue_3__pf))
				{
					b1l__CallFunc_GetGameUserSettings_ReturnValue_3__pf->SetOverallScalabilityLevel(0);
				}
			}
		case 34:
			{
				if(::IsValid(b1l__CallFunc_GetGameUserSettings_ReturnValue_3__pf))
				{
					b1l__CallFunc_GetGameUserSettings_ReturnValue_3__pf->ApplySettings(true);
				}
			}
		case 35:
			{
		...
		case 36:
			{
				b1l__K2Node_DynamicCast_AsSave_Game_BP_2__pf = Cast<USaveGameBP_C__pf4030252459>(bpfv__CallFunc_LoadGameFromSlot_ReturnValue_3__pf);
		...
		case 37:
			{
				...
				{
					b1l__K2Node_DynamicCast_AsSave_Game_BP_2__pf->bpv__GraphicQuality__pf = 0;
				}
			}
		case 38:
			{
				bpfv__CallFunc_SaveGameToSlot_ReturnValue_3__pf = UGameplayStatics::SaveGameToSlot(bpfv__CallFunc_LoadGameFromSlot_ReturnValue_3__pf, FString(TEXT("Save_File")), 0);
			}
		case 39:
			{
				if (!bpfv__CallFunc_SaveGameToSlot_ReturnValue_3__pf)
				{
					__CurrentState = -1;
					break;
				}
		...
		case 41:
			{
				b1l__CallFunc_GetGameUserSettings_ReturnValue__pf = UGameUserSettings::GetGameUserSettings();
			}
		case 42:
			{
				UKismetSystemLibrary::Delay(this, 0.500000, FLatentActionInfo(1, -698901425, TEXT("ExecuteUbergraph_GraphicSettingsHUD_0"), this));
				__CurrentState = -1;
				break;
			}
		case 47:
			{
				b1l__CallFunc_GetGameUserSettings_ReturnValue_1__pf = UGameUserSettings::GetGameUserSettings();
			}
		case 48:
			{
				UKismetSystemLibrary::Delay(this, 0.500000, FLatentActionInfo(16, 303871655, TEXT("ExecuteUbergraph_GraphicSettingsHUD_0"), this));
				__CurrentState = -1;
				break;
			}
		case 49:
			{
				b1l__CallFunc_GetGameUserSettings_ReturnValue_2__pf = UGameUserSettings::GetGameUserSettings();
			}
		case 50:
			{
				UKismetSystemLibrary::Delay(this, 0.500000, FLatentActionInfo(24, -1296323408, TEXT("ExecuteUbergraph_GraphicSettingsHUD_0"), this));
				__CurrentState = -1;
				break;
			}
		case 51:
			{
				b1l__CallFunc_GetGameUserSettings_ReturnValue_3__pf = UGameUserSettings::GetGameUserSettings();
			}
		case 52:
			{
				UKismetSystemLibrary::Delay(this, 0.500000, FLatentActionInfo(32, -2121602488, TEXT("ExecuteUbergraph_GraphicSettingsHUD_0"), this));
				__CurrentState = -1;
				break;
			}
		case 53:
...
void UGraphicSettingsHUD_C__pf1481852004::bpf__ExecuteUbergraph_GraphicSettingsHUD__pf_1(int32 bpp__EntryPoint__pf)
{
...
void UGraphicSettingsHUD_C__pf1481852004::bpf__ExecuteUbergraph_GraphicSettingsHUD__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	b1l__K2Node_MakeArray_Array__pf.SetNum(5, true);
	b1l__K2Node_MakeArray_Array__pf[0] = bpv__Button_56__pf;
	b1l__K2Node_MakeArray_Array__pf[1] = bpv__Button_262__pf;
	b1l__K2Node_MakeArray_Array__pf[2] = bpv__Button_397__pf;
	b1l__K2Node_MakeArray_Array__pf[3] = bpv__Button_519__pf;
	b1l__K2Node_MakeArray_Array__pf[4] = bpv__Button__pf;
...
void UGraphicSettingsHUD_C__pf1481852004::bpf__BndEvt__Button_K2Node_ComponentBoundEvent_7_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_GraphicSettingsHUD__pf_0(55);
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__BndEvt__Button_519_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_GraphicSettingsHUD__pf_0(54);
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__BndEvt__Button_397_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_GraphicSettingsHUD__pf_0(53);
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__BndEvt__Button_262_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_GraphicSettingsHUD__pf_0(40);
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__BndEvt__Button_56_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_GraphicSettingsHUD__pf_0(56);
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_GraphicSettingsHUD__pf_1(57);
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_GraphicSettingsHUD__pf_2(59);
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__GetText_0__pf()
{
	FText bpfv__TextPause__pf{};
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__GetText_1__pf()
{
	FText bpfv__TextResume__pf{};
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__GetText_2__pf()
{
	FText bpfv__TextReturn__pf{};
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__GetText_3__pf()
{
	FText bpfv__TextControlsTips__pf{};
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__GetText_4__pf()
{
	FText bpfv__TextWorldMap__pf{};
}
void UGraphicSettingsHUD_C__pf1481852004::bpf__GetText_5__pf()
{
	FText bpfv__TextGoBack__pf{};
}
FSlateBrush  UGraphicSettingsHUD_C__pf1481852004::bpf__GetBrush_0__pf()
{
	...
	do
	{
		...
		case 1:
			{
				const UScriptStruct* __Local__88 = FSlateBrush::StaticStruct();
				uint8* __Local__89 = (uint8*)FMemory_Alloca(__Local__88->GetStructureSize());
				__Local__88->InitializeStruct(__Local__89);
				FSlateBrush& __Local__87 = *reinterpret_cast<FSlateBrush*>(__Local__89);
				__Local__87.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__90 = (*(AccessPrivateProperty<UObject* >(&(__Local__87), FSlateBrush::__PPO__ResourceObject() )));
				__Local__90 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
				bpfv__Default_Slate__pf = __Local__87;
			}
		case 2:
			{
				const UScriptStruct* __Local__92 = FSlateBrush::StaticStruct();
				uint8* __Local__93 = (uint8*)FMemory_Alloca(__Local__92->GetStructureSize());
				__Local__92->InitializeStruct(__Local__93);
				FSlateBrush& __Local__91 = *reinterpret_cast<FSlateBrush*>(__Local__93);
				__Local__91.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__94 = (*(AccessPrivateProperty<UObject* >(&(__Local__91), FSlateBrush::__PPO__ResourceObject() )));
				__Local__94 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
				bpfv__LV3_Slate__pf = __Local__91;
			}
		case 3:
			{
				const UScriptStruct* __Local__96 = FSlateBrush::StaticStruct();
				uint8* __Local__97 = (uint8*)FMemory_Alloca(__Local__96->GetStructureSize());
				__Local__96->InitializeStruct(__Local__97);
				FSlateBrush& __Local__95 = *reinterpret_cast<FSlateBrush*>(__Local__97);
				__Local__95.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__98 = (*(AccessPrivateProperty<UObject* >(&(__Local__95), FSlateBrush::__PPO__ResourceObject() )));
				__Local__98 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
				bpfv__LV6_Slate__pf = __Local__95;
			}
		case 4:
			{
				const UScriptStruct* __Local__100 = FSlateBrush::StaticStruct();
				uint8* __Local__101 = (uint8*)FMemory_Alloca(__Local__100->GetStructureSize());
				__Local__100->InitializeStruct(__Local__101);
				FSlateBrush& __Local__99 = *reinterpret_cast<FSlateBrush*>(__Local__101);
				__Local__99.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__102 = (*(AccessPrivateProperty<UObject* >(&(__Local__99), FSlateBrush::__PPO__ResourceObject() )));
				__Local__102 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
				bpfv__LV8_Slate__pf = __Local__99;
			}
		case 5:
			{
				const UScriptStruct* __Local__104 = FSlateBrush::StaticStruct();
				uint8* __Local__105 = (uint8*)FMemory_Alloca(__Local__104->GetStructureSize());
				__Local__104->InitializeStruct(__Local__105);
				FSlateBrush& __Local__103 = *reinterpret_cast<FSlateBrush*>(__Local__105);
				__Local__103.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__106 = (*(AccessPrivateProperty<UObject* >(&(__Local__103), FSlateBrush::__PPO__ResourceObject() )));
				__Local__106 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
				bpfv__LV12_Slate__pf = __Local__103;
			}
		case 6:
			{
				const UScriptStruct* __Local__108 = FSlateBrush::StaticStruct();
				uint8* __Local__109 = (uint8*)FMemory_Alloca(__Local__108->GetStructureSize());
				__Local__108->InitializeStruct(__Local__109);
				FSlateBrush& __Local__107 = *reinterpret_cast<FSlateBrush*>(__Local__109);
				__Local__107.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__110 = (*(AccessPrivateProperty<UObject* >(&(__Local__107), FSlateBrush::__PPO__ResourceObject() )));
				__Local__110 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
				bpfv__Endgame_Slate__pf = __Local__107;
			}
		case 7:
			{
				...
				__Local__111.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__114 = (*(AccessPrivateProperty<UObject* >(&(__Local__111), FSlateBrush::__PPO__ResourceObject() )));
				__Local__114 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGraphicSettingsHUD_C__pf1481852004::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
				bpfv__FinalSlate__pf = __Local__111;
			}
		case 8:
			{
				bpfv__CallFunc_LoadGameFromSlot_ReturnValue__pf = UGameplayStatics::LoadGameFromSlot(FString(TEXT("Save_File")), 0);
		...
		case 10:
			{
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__115)), 0);
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__116)), 1);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__117)), 2);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__118)), 3);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__119)), 4);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__120)), 5);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__121)), 6);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__122)), 7);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 15;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__123)), 8);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 15;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__124)), 9);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__125)), 10);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__126)), 11);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__127)), 12);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__128)), 13);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 17;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__129)), 14);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				}
				int32  __Local__130 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__130)), 15);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				}
				int32  __Local__131 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__131)), 16);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				}
				int32  __Local__132 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__132)), 17);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
...
ESlateVisibility  UGraphicSettingsHUD_C__pf1481852004::bpf__GetVisibility_0__pf()
{
	ESlateVisibility bpp__ReturnValue__pf{};
	ESlateVisibility bpfv__VisibiltyImage__pf{};
	int32 __CurrentState = 1;
	do
	{
		switch( __CurrentState )
		...
		case 1:
			{
				bpfv__VisibiltyImage__pf = ESlateVisibility::Visible;
			}
		case 2:
			{
				if (!bpv__ItsComingFromMainMenu__pf)
		...
		case 4:
			{
				bpp__ReturnValue__pf = bpfv__VisibiltyImage__pf;
				__CurrentState = -1;
				break;
			}
		case 5:
			{
				bpfv__VisibiltyImage__pf = ESlateVisibility::Hidden;
				__CurrentState = 4;
				break;
			}
		default:
...
PRAGMA_DISABLE_OPTIMIZATION
void UGraphicSettingsHUD_C__pf1481852004::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UGraphicSettingsHUD_C__pf1481852004::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UGraphicSettingsHUD_C__pf1481852004
{
	FRegisterHelper__UGraphicSettingsHUD_C__pf1481852004()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/GraphicsSettingsHUD/GraphicSettingsHUD"), &UGraphicSettingsHUD_C__pf1481852004::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UGraphicSettingsHUD_C__pf1481852004 Instance;
};
FRegisterHelper__UGraphicSettingsHUD_C__pf1481852004 FRegisterHelper__UGraphicSettingsHUD_C__pf1481852004::Instance;
