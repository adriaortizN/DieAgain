...
#include "LevelFinal_BlueBlood_1__pf936270410.h"
...
#include "LevelFinal_BlueBlood_2__pf936270410.h"
...
ULevelFinal_BlueBlood_1_C__pf936270410::ULevelFinal_BlueBlood_1_C__pf936270410(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Button_99__pf = nullptr;
	bpv__Image_41__pf = nullptr;
	bpv__TextDescription__pf = FText::GetEmpty();
	bpv__TextButton__pf = FText::GetEmpty();
	bpv__TimesCount__pf = 0;
}
PRAGMA_ENABLE_OPTIMIZATION
void ULevelFinal_BlueBlood_1_C__pf936270410::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ULevelFinal_BlueBlood_1_C__pf936270410::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(ULevelFinal_BlueBlood_2_C__pf936270410::StaticClass());
	...
	auto __Local__8 = NewObject<UImage>(__Local__1, TEXT("Image_41"), (EObjectFlags)0x00280008);
	__Local__8->Brush.ImageSize = FVector2D(3840.000000, 2080.000000);
	auto& __Local__9 = (*(AccessPrivateProperty<UObject* >(&(__Local__8->Brush), FSlateBrush::__PPO__ResourceObject() )));
	__Local__9 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto __Local__10 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_7"), (EObjectFlags)0x00280008);
	__Local__10->LayoutData.Offsets.Left = -800.960938f;
	__Local__10->LayoutData.Offsets.Top = -336.540527f;
	__Local__10->LayoutData.Offsets.Right = 1611.261841f;
	__Local__10->LayoutData.Offsets.Bottom = 588.714722f;
	...
	auto __Local__11 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_329"), (EObjectFlags)0x00280008);
	__Local__11->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[F287BD8045404704B3DDB49210934E0F]\", \"4E4ECF9249DEDB9A8C4DE389286A8421\", \"The red blooded one was known as an invincible warrior \\r\\nwho lived longer than any original\\r\\n\\r\\nThe fighter tried to improve the world and in the end \\r\\")
		TEXT("nthis warrior was the last human to die\")")	);
	__Local__11->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__11->Font.OutlineSettings.OutlineSize = 3;
	__Local__11->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__11->Font.Size = 45;
	...
	auto __Local__15 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_2"), (EObjectFlags)0x00280008);
	__Local__15->LayoutData.Offsets.Left = -200.000000f;
	__Local__15->LayoutData.Offsets.Top = -229.081055f;
	__Local__15->LayoutData.Offsets.Right = 402.524719f;
	__Local__15->LayoutData.Offsets.Bottom = 121.202309f;
	__Local__15->LayoutData.Anchors.Minimum = FVector2D(0.500000, 1.000000);
	__Local__15->LayoutData.Anchors.Maximum = FVector2D(0.500000, 1.000000);
	__Local__15->Parent = __Local__5;
	auto __Local__16 = NewObject<UButton>(__Local__1, TEXT("Button_99"), (EObjectFlags)0x00280008);
	__Local__16->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	...
	__Local__17 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__18 = (*(AccessPrivateProperty<UObject* >(&(__Local__16->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__18 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__16->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__19 = (*(AccessPrivateProperty<UObject* >(&(__Local__16->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__19 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__16->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__20 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__16->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__20 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__21 = (*(AccessPrivateProperty<UObject* >(&(__Local__16->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__21 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	auto& __Local__22 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__16), UPanelWidget::__PPO__Slots() )));
	__Local__22 = TArray<UPanelSlot*> ();
	__Local__22.Reserve(1);
	auto __Local__23 = NewObject<UButtonSlot>(__Local__16, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
...
TEXT("NSLOCTEXT(\"[F287BD8045404704B3DDB49210934E0F]\", \"D0BEA5B54D2C616A1DF99E94BD86A458\", \"Next\")")	);
	...
	__Local__24->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__24->Font.OutlineSettings.OutlineSize = 4;
	__Local__24->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__24->Font.Size = 65;
	...
	auto __Local__26 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_1"), (EObjectFlags)0x00280008);
	__Local__26->LayoutData.Offsets.Left = -200.000000f;
	__Local__26->LayoutData.Offsets.Top = 64.000000f;
	__Local__26->LayoutData.Offsets.Right = 369.158051f;
	__Local__26->LayoutData.Offsets.Bottom = 114.528969f;
	...
	__Local__26->Parent = __Local__5;
	auto __Local__27 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_116"), (EObjectFlags)0x00280008);
	__Local__27->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[F287BD8045404704B3DDB49210934E0F]\", \"943ABCA1423E945FB7E14E911BAAD690\", \"Ending L\")")	);
	__Local__27->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__27->Font.OutlineSettings.OutlineSize = 3;
	__Local__27->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__27->Font.Size = 75;
	__Local__27->Slot = __Local__26;
	__Local__26->Content = __Local__27;
	__Local__6.Add(__Local__26);
	__Local__1->RootWidget = __Local__5;
	auto __Local__28 = NewObject<UMovieScene>(__Local__2, TEXT("FadeInText"), (EObjectFlags)0x00280008);
	auto& __Local__29 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__28), UMovieScene::__PPO__Possessables() )));
	__Local__29 = TArray<FMovieScenePossessable> ();
	__Local__29.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__29.GetData(), 1);
	...
	__Local__31 = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__32 = (*(AccessPrivateProperty<FString >(&(__Local__30), FMovieScenePossessable::__PPO__Name() )));
	__Local__32 = FString(TEXT("TextBlock_329"));
	auto& __Local__33 = (*(AccessPrivateProperty<UClass* >(&(__Local__30), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__33 = UTextBlock::StaticClass();
	auto& __Local__34 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__28), UMovieScene::__PPO__ObjectBindings() )));
	__Local__34 = TArray<FMovieSceneBinding> ();
	__Local__34.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__34.GetData(), 1);
	...
	__Local__36 = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__37 = (*(AccessPrivateProperty<FString >(&(__Local__35), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__37 = FString(TEXT("TextBlock_329"));
	...
	auto __Local__39 = NewObject<UMovieSceneColorTrack>(__Local__28, TEXT("MovieSceneColorTrack_0"), (EObjectFlags)0x00280008);
	...
	__Local__40.PropertyName = FName(TEXT("ColorAndOpacity"));
	__Local__40.PropertyPath = FName(TEXT("ColorAndOpacity"));
	...
	auto __Local__42 = NewObject<UMovieSceneColorSection>(__Local__39, TEXT("MovieSceneColorSection_0"), (EObjectFlags)0x00280008);
	...
	__Local__42->Easing.bManualEaseOut = true;
	__Local__42->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(120000)));
	auto& __Local__45 = (*(AccessPrivateProperty<FGuid >((__Local__42), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__45 = FGuid(0xBA46693B, 0x414FEC4B, 0xF98EC09C, 0x4E774243);
	__Local__41.Add(__Local__42);
	auto& __Local__46 = (*(AccessPrivateProperty<FGuid >((__Local__39), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__46 = FGuid(0xDDDC1926, 0x47539219, 0x2B574EA3, 0xA5310AF4);
	auto& __Local__47 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__39), UMovieSceneTrack::__PPO__EvaluationField() )));
	...
	__Local__48.Section = __Local__42;
	...
	__Local__61.Value = 120000;
	__Local__48.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__62 = (*(AccessPrivateProperty<FGuid >((__Local__39), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__62 = FGuid(0xDDDC1926, 0x47539219, 0x2B574EA3, 0xA5310AF4);
	__Local__38.Add(__Local__39);
	auto __Local__63 = NewObject<UMovieSceneFloatTrack>(__Local__28, TEXT("MovieSceneFloatTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__64 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__63), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__64.PropertyName = FName(TEXT("RenderOpacity"));
	__Local__64.PropertyPath = FName(TEXT("RenderOpacity"));
	__Local__64.bCanUseClassLookup = true;
	auto& __Local__65 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__63), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__65 = TArray<UMovieSceneSection*> ();
	__Local__65.Reserve(1);
	auto __Local__66 = NewObject<UMovieSceneFloatSection>(__Local__63, TEXT("MovieSceneFloatSection_0"), (EObjectFlags)0x00280008);
	auto __Local__67 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__66->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__68 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__66->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__67)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__69 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__66), UMovieSceneFloatSection::__PPO__FloatCurve() )));
	auto& __Local__70 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__69), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__70 = TArray<FFrameNumber> ();
	__Local__70.Reserve(2);
	__Local__70.Add(FFrameNumber{});
	__Local__70.Add(FFrameNumber{});
	__Local__70[1].Value = 150000;
	auto& __Local__71 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__69), FMovieSceneFloatChannel::__PPO__Values() )));
	...
	__Local__66->Easing.EaseIn = __Local__67;
	__Local__66->Easing.EaseOut = __Local__68;
	__Local__66->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(150000)));
	auto& __Local__74 = (*(AccessPrivateProperty<FGuid >((__Local__66), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__74 = FGuid(0xC95851B7, 0x46762F9C, 0x7F26C993, 0x8DA70E1F);
	__Local__65.Add(__Local__66);
	auto& __Local__75 = (*(AccessPrivateProperty<FGuid >((__Local__63), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__75 = FGuid(0xF65A7B0B, 0x4A5DAF9A, 0xAC0E88BB, 0x8F9C4DB0);
	auto& __Local__76 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__63), UMovieSceneTrack::__PPO__EvaluationField() )));
	...
	__Local__77.Section = __Local__66;
	auto& __Local__78 = (*(__Local__49->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__77.Range), 0)));
	auto& __Local__79 = (*(__Local__52->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__78), 0)));
	__Local__79 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__80 = (*(__Local__55->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__77.Range), 0)));
	auto& __Local__81 = (*(__Local__52->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__80), 0)));
	__Local__81 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__82 = (*(__Local__59->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__80), 0)));
	__Local__82.Value = 150000;
	__Local__77.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__83 = (*(AccessPrivateProperty<FGuid >((__Local__63), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__83 = FGuid(0xF65A7B0B, 0x4A5DAF9A, 0xAC0E88BB, 0x8F9C4DB0);
	__Local__38.Add(__Local__63);
	auto& __Local__84 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__28), UMovieScene::__PPO__PlaybackRange() )));
	__Local__84 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(150001)));
	auto& __Local__85 = (*(AccessPrivateProperty<FFrameRate >((__Local__28), UMovieScene::__PPO__DisplayRate() )));
	...
	__Local__88 = 20;
	auto& __Local__89 = (*(AccessPrivateProperty<FGuid >((__Local__28), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__89 = FGuid(0x48326375, 0x4A890F90, 0x6E722BA6, 0x422E1F11);
	__Local__2->MovieScene = __Local__28;
	...
	auto& __Local__90 = __Local__2->AnimationBindings[0];
	__Local__90.WidgetName = FName(TEXT("TextBlock_329"));
	__Local__90.AnimationGuid = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__91 = (*(AccessPrivateProperty<FString >((__Local__2), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__91 = FString(TEXT("FadeInText"));
	__Local__2->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__92 = (*(AccessPrivateProperty<FGuid >((__Local__2), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__92 = FGuid(0x4B9B3784, 0x4F020096, 0x0CF533B7, 0x260DBDA5);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__2);
	auto __Local__93 = NewObject<UMovieScene>(__Local__3, TEXT("FadeInButton"), (EObjectFlags)0x00280008);
	auto& __Local__94 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__93), UMovieScene::__PPO__Possessables() )));
	__Local__94 = TArray<FMovieScenePossessable> ();
	__Local__94.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__94.GetData(), 1);
	auto& __Local__95 = __Local__94[0];
	auto& __Local__96 = (*(AccessPrivateProperty<FGuid >(&(__Local__95), FMovieScenePossessable::__PPO__Guid() )));
	__Local__96 = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__97 = (*(AccessPrivateProperty<FString >(&(__Local__95), FMovieScenePossessable::__PPO__Name() )));
	__Local__97 = FString(TEXT("Button_99"));
	auto& __Local__98 = (*(AccessPrivateProperty<UClass* >(&(__Local__95), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__98 = UButton::StaticClass();
	auto& __Local__99 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__93), UMovieScene::__PPO__ObjectBindings() )));
	__Local__99 = TArray<FMovieSceneBinding> ();
	__Local__99.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__99.GetData(), 1);
	auto& __Local__100 = __Local__99[0];
	auto& __Local__101 = (*(AccessPrivateProperty<FGuid >(&(__Local__100), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__101 = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__102 = (*(AccessPrivateProperty<FString >(&(__Local__100), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__102 = FString(TEXT("Button_99"));
	auto& __Local__103 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__100), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__103 = TArray<UMovieSceneTrack*> ();
	__Local__103.Reserve(1);
	auto __Local__104 = NewObject<UMovieSceneFloatTrack>(__Local__93, TEXT("MovieSceneFloatTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__105 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__104), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__105.PropertyName = FName(TEXT("RenderOpacity"));
	__Local__105.PropertyPath = FName(TEXT("RenderOpacity"));
	__Local__105.bCanUseClassLookup = true;
	auto& __Local__106 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__104), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__106 = TArray<UMovieSceneSection*> ();
	__Local__106.Reserve(1);
	auto __Local__107 = NewObject<UMovieSceneFloatSection>(__Local__104, TEXT("MovieSceneFloatSection_0"), (EObjectFlags)0x00280008);
	auto __Local__108 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__107->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__109 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__107->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__108)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__110 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__107), UMovieSceneFloatSection::__PPO__FloatCurve() )));
	...
	__Local__107->Easing.EaseIn = __Local__108;
	__Local__107->Easing.EaseOut = __Local__109;
	__Local__107->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(150000)));
	auto& __Local__115 = (*(AccessPrivateProperty<FGuid >((__Local__107), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__115 = FGuid(0x8A291EDF, 0x40499572, 0x7FE33A97, 0x85CCD425);
	__Local__106.Add(__Local__107);
	auto& __Local__116 = (*(AccessPrivateProperty<FGuid >((__Local__104), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__116 = FGuid(0x6591925F, 0x45B0957F, 0xD13F0E93, 0xD1A0EFD6);
	auto& __Local__117 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__104), UMovieSceneTrack::__PPO__EvaluationField() )));
	...
	__Local__118.Section = __Local__107;
	auto& __Local__119 = (*(__Local__49->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__118.Range), 0)));
	auto& __Local__120 = (*(__Local__52->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__119), 0)));
	__Local__120 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__121 = (*(__Local__55->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__118.Range), 0)));
	auto& __Local__122 = (*(__Local__52->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__121), 0)));
	__Local__122 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__123 = (*(__Local__59->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__121), 0)));
	__Local__123.Value = 150000;
	__Local__118.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__124 = (*(AccessPrivateProperty<FGuid >((__Local__104), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__124 = FGuid(0x6591925F, 0x45B0957F, 0xD13F0E93, 0xD1A0EFD6);
	__Local__103.Add(__Local__104);
	auto& __Local__125 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__93), UMovieScene::__PPO__PlaybackRange() )));
	__Local__125 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(150001)));
	auto& __Local__126 = (*(AccessPrivateProperty<FFrameRate >((__Local__93), UMovieScene::__PPO__DisplayRate() )));
	auto& __Local__127 = (*(__Local__86->ContainerPtrToValuePtr<int32 >(&(__Local__126), 0)));
	__Local__127 = 20;
	auto& __Local__128 = (*(AccessPrivateProperty<FGuid >((__Local__93), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__128 = FGuid(0xF6308FCB, 0x47CE842C, 0x382F799D, 0xB956E79A);
	__Local__3->MovieScene = __Local__93;
	...
	auto& __Local__129 = __Local__3->AnimationBindings[0];
	__Local__129.WidgetName = FName(TEXT("Button_99"));
	__Local__129.AnimationGuid = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__130 = (*(AccessPrivateProperty<FString >((__Local__3), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__130 = FString(TEXT("FadeInButton"));
	__Local__3->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__131 = (*(AccessPrivateProperty<FGuid >((__Local__3), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__131 = FGuid(0x305CD7E5, 0x4C327CF7, 0x1FD3FB8A, 0x71967EDB);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__3);
}
PRAGMA_ENABLE_OPTIMIZATION
void ULevelFinal_BlueBlood_1_C__pf936270410::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__132;
	SlotNames.Append(__Local__132);
}
void ULevelFinal_BlueBlood_1_C__pf936270410::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__133;
	__Local__133.Reserve(2);
	__Local__133.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->MiscConvertedSubobjects[1]));
	__Local__133.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->MiscConvertedSubobjects[2]));
	TArray<FDelegateRuntimeBinding>  __Local__134;
	__Local__134.AddUninitialized(1);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__134.GetData(), 1);
	auto& __Local__135 = __Local__134[0];
	__Local__135.ObjectName = FString(TEXT("Image_41"));
	__Local__135.PropertyName = FName(TEXT("Brush"));
	__Local__135.FunctionName = FName(TEXT("GetBrush_0"));
	...
	__Local__137.Name = FName(TEXT("GetBrush_0"));
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->MiscConvertedSubobjects[0]), __Local__133, __Local__134);
}
void ULevelFinal_BlueBlood_1_C__pf936270410::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b1l__K2Node_CreateDelegate_OutputDelegate_1__pf.BindUFunction(this,FName(TEXT("OnSuccess_56992EE44A3CB4EE82B62E8E5D9B3C83")));
	...
	b1l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("OnFailure_56992EE44A3CB4EE82B62E8E5D9B3C83")));
	if(::IsValid(b1l__CallFunc_CacheAchievements_ReturnValue__pf))
	{
...
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_1(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 11);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
	b1l__CallFunc_WriteAchievementProgress_ReturnValue__pf = UAchievementWriteCallbackProxy::WriteAchievementProgress(this, bpfv__CallFunc_GetPlayerController_ReturnValue__pf, FName(TEXT("ACH_F_BLUE")), 100.000000, 0);
	...
	b1l__K2Node_CreateDelegate_OutputDelegate_3__pf.BindUFunction(this,FName(TEXT("OnSuccess_BE53D5CD4BDE1E56CF4CF8B034E16CB3")));
	...
	b1l__K2Node_CreateDelegate_OutputDelegate_2__pf.BindUFunction(this,FName(TEXT("OnFailure_BE53D5CD4BDE1E56CF4CF8B034E16CB3")));
	if(::IsValid(b1l__CallFunc_WriteAchievementProgress_ReturnValue__pf))
	{
...
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_2(int32 bpp__EntryPoint__pf)
{
	ULevelFinal_BlueBlood_2_C__pf936270410* bpfv__CallFunc_Create_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 28);
	// optimized KCST_UnconditionalGoto
	UWidgetLayoutLibrary::RemoveAllWidgets(this);
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<ULevelFinal_BlueBlood_2_C__pf936270410>(UWidgetBlueprintLibrary::Create(this, ULevelFinal_BlueBlood_2_C__pf936270410::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
...
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_3(int32 bpp__EntryPoint__pf)
{
...
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_4(int32 bpp__EntryPoint__pf)
{
...
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_5(int32 bpp__EntryPoint__pf)
{
...
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_6(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 10);
	return; // KCST_GotoReturn
}
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__BndEvt__Button_99_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_2(28);
}
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_0(27);
}
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_3(25);
}
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__OnSuccess_BE53D5CD4BDE1E56CF4CF8B034E16CB3__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf)
{
	...
	bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_4(21);
}
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__OnFailure_BE53D5CD4BDE1E56CF4CF8B034E16CB3__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf)
{
	...
	bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_5(17);
}
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__OnSuccess_56992EE44A3CB4EE82B62E8E5D9B3C83__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_1(11);
}
void ULevelFinal_BlueBlood_1_C__pf936270410::bpf__OnFailure_56992EE44A3CB4EE82B62E8E5D9B3C83__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_6(10);
}
FText  ULevelFinal_BlueBlood_1_C__pf936270410::bpf__GetText_0__pf()
{
	FText bpp__ReturnValue__pf{};
	bpp__ReturnValue__pf = bpv__TextDescription__pf;
	return bpp__ReturnValue__pf;
}
FText  ULevelFinal_BlueBlood_1_C__pf936270410::bpf__GetText_1__pf()
{
	FText bpp__ReturnValue__pf{};
	bpp__ReturnValue__pf = bpv__TextButton__pf;
	return bpp__ReturnValue__pf;
}
FSlateBrush  ULevelFinal_BlueBlood_1_C__pf936270410::bpf__GetBrush_0__pf()
{
	FSlateBrush bpp__ReturnValue__pf{};
	FSlateBrush bpfv__FinalSlateBrush__pf{};
	FSlateBrush bpfv__BlueBlood_M__pf{};
	FSlateBrush bpfv__BlueBlood_F__pf{};
	...
	do
	{
		...
		case 1:
			{
				...
				__Local__138.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__141 = (*(AccessPrivateProperty<UObject* >(&(__Local__138), FSlateBrush::__PPO__ResourceObject() )));
				__Local__141 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
				bpfv__BlueBlood_F__pf = __Local__138;
			}
		case 2:
			{
				const UScriptStruct* __Local__143 = FSlateBrush::StaticStruct();
				uint8* __Local__144 = (uint8*)FMemory_Alloca(__Local__143->GetStructureSize());
				__Local__143->InitializeStruct(__Local__144);
				FSlateBrush& __Local__142 = *reinterpret_cast<FSlateBrush*>(__Local__144);
				__Local__142.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__145 = (*(AccessPrivateProperty<UObject* >(&(__Local__142), FSlateBrush::__PPO__ResourceObject() )));
				__Local__145 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_BlueBlood_1_C__pf936270410::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
				bpfv__BlueBlood_M__pf = __Local__142;
			}
		case 3:
			{
		...
		case 5:
			{
				bool  __Local__146 = false;
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__IsMale__pf) : (__Local__146)))
				{
					__CurrentState = 9;
					break;
				}
		...
		case 6:
			{
				bpfv__FinalSlateBrush__pf = bpfv__BlueBlood_M__pf;
			}
		case 7:
			{
		...
		case 9:
			{
				bpfv__FinalSlateBrush__pf = bpfv__BlueBlood_F__pf;
				__CurrentState = 7;
				break;
			}
		default:
...
PRAGMA_DISABLE_OPTIMIZATION
void ULevelFinal_BlueBlood_1_C__pf936270410::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{1089, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Texture2D /Game/Art/2D_Art/Endings/EndingBlueBlood_M.EndingBlueBlood_M 
		...
		{1088, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Texture2D /Game/Art/2D_Art/Endings/EndingBlueBlood_F.EndingBlueBlood_F 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ULevelFinal_BlueBlood_1_C__pf936270410::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{1090, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/LevelFinal/LevelFinal_BlueBlood_2.LevelFinal_BlueBlood_2_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ULevelFinal_BlueBlood_1_C__pf936270410
{
	FRegisterHelper__ULevelFinal_BlueBlood_1_C__pf936270410()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/LevelFinal/LevelFinal_BlueBlood_1"), &ULevelFinal_BlueBlood_1_C__pf936270410::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ULevelFinal_BlueBlood_1_C__pf936270410 Instance;
};
FRegisterHelper__ULevelFinal_BlueBlood_1_C__pf936270410 FRegisterHelper__ULevelFinal_BlueBlood_1_C__pf936270410::Instance;
