...
#include "CrashPlane__pf3858658621.h"
...
ACrashPlane_C__pf3858658621::ACrashPlane_C__pf3858658621(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__Box__pf->BodyInstance.bUseCCD = true;
...
void ACrashPlane_C__pf3858658621::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ACrashPlane_C__pf3858658621::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(ULVTut_Plane_C__pf42449109::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
void ACrashPlane_C__pf3858658621::bpf__ExecuteUbergraph_CrashPlane__pf_0(int32 bpp__EntryPoint__pf)
{
	FFMODEventInstance bpfv__CallFunc_PlayEvent2D_ReturnValue__pf{};
	ULVTut_Plane_C__pf42449109* bpfv__CallFunc_Create_ReturnValue__pf{};
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_PlayEvent2D_ReturnValue__pf = UFMODBlueprintStatics::PlayEvent2D(this, CastChecked<UFMODEvent>(CastChecked<UDynamicClass>(ACrashPlane_C__pf3858658621::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed), true);
			}
		case 2:
			{
				UKismetSystemLibrary::Delay(this, 1.000000, FLatentActionInfo(3, -349639985, TEXT("ExecuteUbergraph_CrashPlane_0"), this));
		...
		case 4:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("OPEN")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 5:
			{
		...
		case 10:
			{
				bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<ULVTut_Plane_C__pf42449109>(UWidgetBlueprintLibrary::Create(this, ULVTut_Plane_C__pf42449109::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
			}
		case 11:
			{
		...
		case 16:
			{
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
...
void ACrashPlane_C__pf3858658621::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_CrashPlane__pf_0(15);
}
PRAGMA_DISABLE_OPTIMIZATION
void ACrashPlane_C__pf3858658621::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ACrashPlane_C__pf3858658621::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{1034, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/LVTut_Plane/LVTut_Plane.LVTut_Plane_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ACrashPlane_C__pf3858658621
{
	FRegisterHelper__ACrashPlane_C__pf3858658621()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/PlaneControlled/CrashPlane"), &ACrashPlane_C__pf3858658621::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ACrashPlane_C__pf3858658621 Instance;
};
FRegisterHelper__ACrashPlane_C__pf3858658621 FRegisterHelper__ACrashPlane_C__pf3858658621::Instance;
