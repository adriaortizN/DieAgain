...
UControlsKeyboardHUD_C__pf3479267681::UControlsKeyboardHUD_C__pf3479267681(const FObjectInitializer& ObjectInitializer) : Super()
{
...
void UControlsKeyboardHUD_C__pf3479267681::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UControlsKeyboardHUD_C__pf3479267681::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__5->LayoutData.Offsets.Left = -960.000000f;
	__Local__5->LayoutData.Offsets.Top = -540.000000f;
	...
	auto __Local__6 = NewObject<UImage>(__Local__1, TEXT("Image_116"), (EObjectFlags)0x00280008);
	...
	__Local__7 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__6->Slot = __Local__5;
	__Local__5->Content = __Local__6;
	__Local__4.Add(__Local__5);
	auto __Local__8 = NewObject<UCanvasPanelSlot>(__Local__3, TEXT("CanvasPanelSlot_4"), (EObjectFlags)0x00280008);
	__Local__8->LayoutData.Offsets.Left = -168.960938f;
	__Local__8->LayoutData.Offsets.Top = 40.000000f;
	__Local__8->LayoutData.Offsets.Right = 325.631195f;
	__Local__8->LayoutData.Offsets.Bottom = 111.142258f;
...
TEXT("NSLOCTEXT(\"[588ACF3B4C1C16E755236FAF6C515022]\", \"E5469EDF4B988FF149DFFFA44F3505BD\", \"Controls\")")	);
	__Local__9->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	auto __Local__11 = NewObject<UCanvasPanelSlot>(__Local__3, TEXT("CanvasPanelSlot_8"), (EObjectFlags)0x00280008);
	__Local__11->LayoutData.Offsets.Left = -236.960938f;
	__Local__11->LayoutData.Offsets.Top = -173.081055f;
	__Local__11->LayoutData.Offsets.Right = 480.380371f;
	__Local__11->LayoutData.Offsets.Bottom = 96.733398f;
	...
	auto __Local__12 = NewObject<UButton>(__Local__1, TEXT("Button_66"), (EObjectFlags)0x00280008);
	...
	__Local__14 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	__Local__15 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	...
	__Local__16 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	auto __Local__19 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_156"), (EObjectFlags)0x00280008);
	__Local__19->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[588ACF3B4C1C16E755236FAF6C515022]\", \"75C08FCC4BFA99AA1326D3B4790828BA\", \"Go  back\")")	);
	...
	__Local__19->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	auto __Local__21 = NewObject<UWidgetNavigation>(__Local__12, TEXT("WidgetNavigation_0"), (EObjectFlags)0x00280008);
	__Local__21->Up.Rule = EUINavigationRule::Stop;
	__Local__21->Down.Rule = EUINavigationRule::Stop;
	__Local__12->Navigation = __Local__21;
	__Local__11->Content = __Local__12;
	__Local__4.Add(__Local__11);
	__Local__1->RootWidget = __Local__3;
}
PRAGMA_ENABLE_OPTIMIZATION
void UControlsKeyboardHUD_C__pf3479267681::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__22;
	SlotNames.Append(__Local__22);
}
void UControlsKeyboardHUD_C__pf3479267681::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__23;
	TArray<FDelegateRuntimeBinding>  __Local__24;
	__Local__24.AddUninitialized(1);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__24.GetData(), 1);
	auto& __Local__25 = __Local__24[0];
	__Local__25.ObjectName = FString(TEXT("Image_116"));
	__Local__25.PropertyName = FName(TEXT("Brush"));
	__Local__25.FunctionName = FName(TEXT("GetBrush_0"));
	auto& __Local__26 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__25.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__26 = TArray<FPropertyPathSegment> ();
	__Local__26.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__26.GetData(), 1);
	auto& __Local__27 = __Local__26[0];
	__Local__27.Name = FName(TEXT("GetBrush_0"));
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->MiscConvertedSubobjects[0]), __Local__23, __Local__24);
}
void UControlsKeyboardHUD_C__pf3479267681::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UControlsKeyboardHUD_C__pf3479267681::bpf__ExecuteUbergraph_ControlsKeyboardHUD__pf_0(int32 bpp__EntryPoint__pf)
{
...
void UControlsKeyboardHUD_C__pf3479267681::bpf__ExecuteUbergraph_ControlsKeyboardHUD__pf_1(int32 bpp__EntryPoint__pf)
{
...
void UControlsKeyboardHUD_C__pf3479267681::bpf__ExecuteUbergraph_ControlsKeyboardHUD__pf_2(int32 bpp__EntryPoint__pf)
{
...
void UControlsKeyboardHUD_C__pf3479267681::bpf__BndEvt__Button_66_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_ControlsKeyboardHUD__pf_1(8);
}
void UControlsKeyboardHUD_C__pf3479267681::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_ControlsKeyboardHUD__pf_2(10);
}
void UControlsKeyboardHUD_C__pf3479267681::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_ControlsKeyboardHUD__pf_0(12);
}
void UControlsKeyboardHUD_C__pf3479267681::bpf__GetText_0__pf()
{
	FText bpfv__TextGoBack__pf{};
}
void UControlsKeyboardHUD_C__pf3479267681::bpf__GetText_1__pf()
{
	FText bpfv__TextControls__pf{};
}
FSlateBrush  UControlsKeyboardHUD_C__pf3479267681::bpf__GetBrush_0__pf()
{
	...
	do
	{
		...
		case 1:
			{
				const UScriptStruct* __Local__29 = FSlateBrush::StaticStruct();
				uint8* __Local__30 = (uint8*)FMemory_Alloca(__Local__29->GetStructureSize());
				__Local__29->InitializeStruct(__Local__30);
				FSlateBrush& __Local__28 = *reinterpret_cast<FSlateBrush*>(__Local__30);
				__Local__28.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__31 = (*(AccessPrivateProperty<UObject* >(&(__Local__28), FSlateBrush::__PPO__ResourceObject() )));
				__Local__31 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
				bpfv__ControlsEnglish__pf = __Local__28;
			}
		case 2:
			{
				...
				__Local__35 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
				bpfv__ControlsIta__pf = __Local__32;
			}
		case 3:
			{
				...
				__Local__39 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
				bpfv__ControlsEs__pf = __Local__36;
			}
		case 4:
			{
				...
				__Local__43 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
				bpfv__ControlsPt__pf = __Local__40;
			}
		case 5:
			{
				...
				__Local__47 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
				bpfv__ControlsRu__pf = __Local__44;
			}
		case 6:
			{
				...
				__Local__51 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
				bpfv__ControlsZh__pf = __Local__48;
			}
		case 7:
			{
				...
				__Local__55 = CastChecked<UObject>(CastChecked<UDynamicClass>(UControlsKeyboardHUD_C__pf3479267681::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed);
				bpfv__ControlsCa__pf = __Local__52;
			}
		case 8:
			{
...
PRAGMA_DISABLE_OPTIMIZATION
void UControlsKeyboardHUD_C__pf3479267681::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UControlsKeyboardHUD_C__pf3479267681::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UControlsKeyboardHUD_C__pf3479267681
{
	FRegisterHelper__UControlsKeyboardHUD_C__pf3479267681()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/ControlsWB/ControlsKeyboardHUD"), &UControlsKeyboardHUD_C__pf3479267681::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UControlsKeyboardHUD_C__pf3479267681 Instance;
};
FRegisterHelper__UControlsKeyboardHUD_C__pf3479267681 FRegisterHelper__UControlsKeyboardHUD_C__pf3479267681::Instance;
