...
#include "GhostSpawn__pf3385323906.h"
...
AGhostSpawn_C__pf3385323906::AGhostSpawn_C__pf3385323906(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__Ghost__pf = CreateDefaultSubobject<USkeletalMeshComponent>(TEXT("Ghost"));
	bpv__GhostCollision__pf = CreateDefaultSubobject<UBoxComponent>(TEXT("GhostCollision"));
	bpv__SpawnCollision__pf = CreateDefaultSubobject<UBoxComponent>(TEXT("SpawnCollision"));
	bpv__DeleteCollision__pf = CreateDefaultSubobject<UBoxComponent>(TEXT("DeleteCollision"));
	...
	bpv__Ghost__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Ghost__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Ghost__pf->AnimationData.AnimToPlay = CastChecked<UAnimationAsset>(CastChecked<UDynamicClass>(AGhostSpawn_C__pf3385323906::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__2 = (*(AccessPrivateProperty<TEnumAsByte<EAnimationMode::Type> >((bpv__Ghost__pf), USkeletalMeshComponent::__PPO__AnimationMode() )));
	__Local__2 = EAnimationMode::Type::AnimationSingleNode;
	bpv__Ghost__pf->ClothingSimulationFactory = UClothingSimulationFactoryNv::StaticClass();
	bpv__Ghost__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(AGhostSpawn_C__pf3385323906::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__Ghost__pf->VisibilityBasedAnimTickOption = EVisibilityBasedAnimTickOption::AlwaysTickPoseAndRefreshBones;
	bpv__Ghost__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Ghost__pf->OverrideMaterials.Reserve(1);
	bpv__Ghost__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AGhostSpawn_C__pf3385323906::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__Ghost__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(0.000000, 0.000000, -30.000000);
	...
	(((FBoolProperty*)__Local__4)->SetPropertyValue_InContainer((bpv__Ghost__pf), false, 0));
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Ghost__pf), false, 0));
	bpv__GhostCollision__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__GhostCollision__pf->AttachToComponent(bpv__Ghost__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__GhostCollision__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__GhostCollision__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__6 = FVector(0.000000, 300.000000, 120.000000);
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__GhostCollision__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__7 = FVector(1.000000, 1.000000, 4.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__GhostCollision__pf), true, 0));
	bpv__SpawnCollision__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__SpawnCollision__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__SpawnCollision__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__SpawnCollision__pf), true, 0));
	bpv__DeleteCollision__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__DeleteCollision__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__DeleteCollision__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__DeleteCollision__pf), true, 0));
	bpv__IsVisible__pf = false;
	bpv__IsFinalGhost__pf = false;
...
void AGhostSpawn_C__pf3385323906::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__GhostCollision__pf)
	{
		bpv__GhostCollision__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__SpawnCollision__pf)
	{
		bpv__SpawnCollision__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__DeleteCollision__pf)
	{
		bpv__DeleteCollision__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AGhostSpawn_C__pf3385323906::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__9->ComponentDelegateBindings.AddUninitialized(3);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__9->ComponentDelegateBindings.GetData(), 3);
	auto& __Local__10 = __Local__9->ComponentDelegateBindings[0];
	__Local__10.ComponentPropertyName = FName(TEXT("GhostCollision"));
	__Local__10.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__10.FunctionNameToBind = FName(TEXT("BndEvt__GhostCollision_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature"));
	auto& __Local__11 = __Local__9->ComponentDelegateBindings[1];
	__Local__11.ComponentPropertyName = FName(TEXT("DeleteCollision"));
	__Local__11.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__11.FunctionNameToBind = FName(TEXT("BndEvt__DeleteCollision_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature"));
	auto& __Local__12 = __Local__9->ComponentDelegateBindings[2];
	__Local__12.ComponentPropertyName = FName(TEXT("SpawnCollision"));
	__Local__12.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__12.FunctionNameToBind = FName(TEXT("BndEvt__SpawnCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AGhostSpawn_C__pf3385323906::bpf__ExecuteUbergraph_GhostSpawn__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				UGameplayStatics::OpenLevel(this, FName(TEXT("LevelFinal_2")), true, FString(TEXT("")));
				__CurrentState = -1;
				break;
			}
		case 15:
			{
				if(::IsValid(bpv__Ghost__pf))
				{
					bpv__Ghost__pf->USceneComponent::SetVisibility(false, false);
				}
			}
		case 16:
			{
		...
		case 18:
			{
				b0l__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_1__pf = Cast<APlayerWalkMap_Character_C__pf2222656877>(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf);
		...
		case 20:
			{
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(b0l__K2Node_ComponentBoundEvent_OtherComp_1__pf, bpv__GhostCollision__pf);
		...
		case 25:
			{
				b0l__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_2__pf = Cast<APlayerWalkMap_Character_C__pf2222656877>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_2__pf != nullptr);;
...
void AGhostSpawn_C__pf3385323906::bpf__ExecuteUbergraph_GhostSpawn__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	if(::IsValid(bpv__Ghost__pf))
	{
		bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__Ghost__pf->USceneComponent::K2_GetComponentLocation();
	}
	bpfv__CallFunc_Add_VectorVector_ReturnValue__pf = UKismetMathLibrary::Add_VectorVector(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, FVector(0.000000,0.060000,0.000000));
	if(::IsValid(bpv__Ghost__pf))
	{
		bpv__Ghost__pf->USceneComponent::K2_SetWorldLocation(bpfv__CallFunc_Add_VectorVector_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetWorldLocation_SweepHitResult__pf, false);
	}
	return; //KCST_EndOfThread
}
void AGhostSpawn_C__pf3385323906::bpf__ExecuteUbergraph_GhostSpawn__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 3:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("MoveGhost")));
				bpfv__CallFunc_K2_SetTimerDelegate_ReturnValue__pf = UKismetSystemLibrary::K2_SetTimerDelegate(b0l__K2Node_CreateDelegate_OutputDelegate__pf, 0.000300, true, 0.000000, 0.000000);
		...
		case 11:
			{
				if(::IsValid(bpv__Ghost__pf))
				{
					bpv__Ghost__pf->USceneComponent::SetVisibility(true, false);
				}
			}
		case 12:
			{
				bpv__IsVisible__pf = true;
				__CurrentState = 3;
				break;
			}
		case 13:
		...
		case 14:
			{
				b0l__K2Node_DynamicCast_AsPlayer_Walk_Map_Character__pf = Cast<APlayerWalkMap_Character_C__pf2222656877>(b0l__K2Node_ComponentBoundEvent_OtherActor_2__pf);
...
void AGhostSpawn_C__pf3385323906::bpf__BndEvt__GhostCollision_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_GhostSpawn__pf_0(24);
}
void AGhostSpawn_C__pf3385323906::bpf__MoveGhost__pf()
{
	bpf__ExecuteUbergraph_GhostSpawn__pf_1(21);
}
void AGhostSpawn_C__pf3385323906::bpf__BndEvt__DeleteCollision_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_GhostSpawn__pf_0(17);
}
void AGhostSpawn_C__pf3385323906::bpf__BndEvt__SpawnCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_GhostSpawn__pf_2(13);
}
PRAGMA_DISABLE_OPTIMIZATION
void AGhostSpawn_C__pf3385323906::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{1079, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  AnimSequence /Game/Art/Enemies/Animations/Sword_And_Shield_Walk.Sword_And_Shield_Walk 
		...
		{1080, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/VFX_Toolkit_V1/Materials/Generic/M_BlackMat.M_BlackMat 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AGhostSpawn_C__pf3385323906::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AGhostSpawn_C__pf3385323906
{
	FRegisterHelper__AGhostSpawn_C__pf3385323906()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/LV11/GhostSpawn"), &AGhostSpawn_C__pf3385323906::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AGhostSpawn_C__pf3385323906 Instance;
};
FRegisterHelper__AGhostSpawn_C__pf3385323906 FRegisterHelper__AGhostSpawn_C__pf3385323906::Instance;
