...
ADieAgainGamemode_C__pf1010915279::ADieAgainGamemode_C__pf1010915279(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	bpv__focusLost__pf = true;
	bpv__CurrentWidget__pf = nullptr;
	PlayerControllerClass = CastChecked<UClass>(CastChecked<UDynamicClass>(ADieAgainGamemode_C__pf1010915279::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
void ADieAgainGamemode_C__pf1010915279::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ADieAgainGamemode_C__pf1010915279::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UMouseUI_C__pf3372741074::StaticClass());
	...
	__Local__4.InputChord.Key = FKey(TEXT("AnyKey"));
	__Local__4.FunctionNameToBind = FName(TEXT("InpActEvt_AnyKey_K2Node_InputKeyEvent_0"));
	__Local__4.bConsumeInput = false;
	__Local__4.bExecuteWhenPaused = true;
}
PRAGMA_ENABLE_OPTIMIZATION
void ADieAgainGamemode_C__pf1010915279::bpf__ExecuteUbergraph_DieAgainGamemode__pf_0(int32 bpp__EntryPoint__pf)
{
	UGameInstance* bpfv__CallFunc_GetGameInstance_ReturnValue__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue__pf{};
	bool bpfv__CallFunc_IsValid_ReturnValue_1__pf{};
	bool bpfv__CallFunc_Key_IsGamepadKey_ReturnValue__pf{};
	...
	do
	{
		...
		case 2:
			{
				bpfv__CallFunc_Key_IsGamepadKey_ReturnValue__pf = UKismetInputLibrary::Key_IsGamepadKey(b0l__K2Node_InputKeyEvent_Key__pf);
				if(::IsValid(b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf))
				{
					b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__isGamepad__pf = bpfv__CallFunc_Key_IsGamepadKey_ReturnValue__pf;
				}
			}
		case 3:
			{
				bool  __Local__5 = false;
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__isGamepad__pf) : (__Local__5)))
				{
					__CurrentState = 9;
					break;
				}
		...
		case 5:
			{
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(bpv__CurrentWidget__pf);
		...
		case 6:
			{
				if(::IsValid(bpv__CurrentWidget__pf))
				{
					bpv__CurrentWidget__pf->bpf__InitFocus__pf();
				}
			}
		case 7:
			{
				bpv__focusLost__pf = false;
			}
		case 8:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("keep")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		case 9:
		...
		case 11:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("gamepad not detected")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 12:
			{
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(bpv__CurrentWidget__pf);
		...
		case 13:
			{
				if(::IsValid(bpv__CurrentWidget__pf))
				{
					bpv__CurrentWidget__pf->bpf__RemoveFocus__pf();
				}
			}
		case 14:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("lost")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		case 23:
...
void ADieAgainGamemode_C__pf1010915279::bpf__ExecuteUbergraph_DieAgainGamemode__pf_1(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue_1__pf{};
	UMouseUI_C__pf3372741074* bpfv__CallFunc_Create_ReturnValue__pf{};
	...
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UMouseUI_C__pf3372741074>(UWidgetBlueprintLibrary::Create(this, UMouseUI_C__pf3372741074::StaticClass(), bpfv__CallFunc_GetPlayerController_ReturnValue_1__pf), ECastCheckedType::NullAllowed);
	bpfv__CallFunc_GetPlayerController_ReturnValue_1__pf = UGameplayStatics::GetPlayerController(this, 0);
	if(::IsValid(bpfv__CallFunc_GetPlayerController_ReturnValue_1__pf))
	{
		bpfv__CallFunc_GetPlayerController_ReturnValue_1__pf->APlayerController::SetMouseCursorWidget(EMouseCursor::Default, bpfv__CallFunc_Create_ReturnValue__pf);
	}
	return; // KCST_GotoReturn
}
void ADieAgainGamemode_C__pf1010915279::bpf__ExecuteUbergraph_DieAgainGamemode__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 17);
	// optimized KCST_UnconditionalGoto
	bpv__CurrentWidget__pf = b0l__K2Node_CustomEvent_Widget__pf;
	bpv__focusLost__pf = true;
	return; // KCST_GotoReturn
}
void ADieAgainGamemode_C__pf1010915279::bpf__ExecuteUbergraph_DieAgainGamemode__pf_3(int32 bpp__EntryPoint__pf)
{
...
void ADieAgainGamemode_C__pf1010915279::bpf__AddCustomCursor__pf()
{
	bpf__ExecuteUbergraph_DieAgainGamemode__pf_1(20);
}
void ADieAgainGamemode_C__pf1010915279::bpf__ResetWidget__pf(UGamepadInteraction_C__pf197907997* bpp__Widget__pf)
{
	b0l__K2Node_CustomEvent_Widget__pf = bpp__Widget__pf;
	bpf__ExecuteUbergraph_DieAgainGamemode__pf_2(17);
}
void ADieAgainGamemode_C__pf1010915279::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_DieAgainGamemode__pf_3(15);
}
void ADieAgainGamemode_C__pf1010915279::bpf__InpActEvt_AnyKey_K2Node_InputKeyEvent_0__pf(FKey bpp__Key__pf)
{
	b0l__K2Node_InputKeyEvent_Key__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_DieAgainGamemode__pf_0(23);
}
PRAGMA_DISABLE_OPTIMIZATION
void ADieAgainGamemode_C__pf1010915279::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ADieAgainGamemode_C__pf1010915279::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{13, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.GameModeBase 
		...
		{768, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Art/Mouse/MouseUI.MouseUI_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ADieAgainGamemode_C__pf1010915279
{
	FRegisterHelper__ADieAgainGamemode_C__pf1010915279()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/DieAgainGamemode"), &ADieAgainGamemode_C__pf1010915279::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ADieAgainGamemode_C__pf1010915279 Instance;
};
FRegisterHelper__ADieAgainGamemode_C__pf1010915279 FRegisterHelper__ADieAgainGamemode_C__pf1010915279::Instance;
