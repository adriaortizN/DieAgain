...
#include "DeadlyFire__pf3601650849.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Objects/Fire/DeadlyFire.DeadlyFire_C", OverrideNativeName="DeadlyFire_C"))
class ADeadlyFire_C__pf3601650849 : public AActor
{
public:
	GENERATED_BODY()
	...
	ADeadlyFire_C__pf3601650849(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_DeadlyFire__pf_0(int32 bpp__EntryPoint__pf);
