...
#include "AttackAnimation__pf681293266.h"
...
UAttackAnimation_C__pf681293266::UAttackAnimation_C__pf681293266(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__DelayAnimationShooting__pf = 0.100000f;
	bpv__DelayAnimationSuicide__pf = 2.000000f;
	bpv__DelayAnimationDog__pf = 0.050000f;
	bpv__DistanceToFlee__pf = 370.000000f;
}
PRAGMA_ENABLE_OPTIMIZATION
void UAttackAnimation_C__pf681293266::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UAttackAnimation_C__pf681293266::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UAttackAnimation_C__pf681293266::bpf__ExecuteUbergraph_AttackAnimation__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				AActor*  __Local__0 = ((AActor*)nullptr);
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf = Cast<AEnemyShootingCh_C__pf3349424045>(((::IsValid(b0l__K2Node_DynamicCast_AsAIDog_Controller__pf)) ? (b0l__K2Node_DynamicCast_AsAIDog_Controller__pf->bpv__EnemyReference__pf) : (__Local__0)));
		...
		case 3:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__IsDeath__pf) : (__Local__1)))
				{
					__CurrentState = 5;
					break;
				}
		...
		case 4:
			{
				UBTFunctionLibrary::SetBlackboardValueAsBool(this, bpv__IsEnemyOfDogAlive__pf, false);
			}
		case 5:
			{
		...
		case 9:
			{
				...
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf = Cast<AEnemyShootingCh_C__pf3349424045>(((::IsValid(b0l__K2Node_DynamicCast_AsAIShooting_Controller__pf)) ? (b0l__K2Node_DynamicCast_AsAIShooting_Controller__pf->bpv__ControlledCharacter__pf) : (__Local__2)));
		...
		case 10:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__IsDeath__pf) : (__Local__3)))
				{
					__CurrentState = 12;
					break;
				}
		...
		case 13:
			{
				UKismetSystemLibrary::Delay(this, bpv__DelayAnimationShooting__pf, FLatentActionInfo(8, -235226816, TEXT("ExecuteUbergraph_AttackAnimation_0"), this));
				__CurrentState = -1;
				break;
			}
		case 14:
			{
				bpv__DelayAnimationShooting__pf = 0.100000;
				__CurrentState = 13;
				break;
			}
		case 15:
			{
				bpv__DelayAnimationShooting__pf = 1.500000;
				__CurrentState = 13;
				break;
			}
		case 16:
		...
		case 17:
			{
				UBTFunctionLibrary::SetBlackboardValueAsBool(this, bpv__BBEnemyTooClose__pf, true);
				__CurrentState = 16;
				break;
			}
		case 18:
		...
		case 20:
			{
				AEnemyShootingCh_C__pf3349424045*  __Local__5 = ((AEnemyShootingCh_C__pf3349424045*)nullptr);
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf = Cast<AEnemyShootingCh_C__pf3349424045>(((::IsValid(b0l__K2Node_DynamicCast_AsAIShooting_Controller__pf)) ? (b0l__K2Node_DynamicCast_AsAIShooting_Controller__pf->bpv__ControlledCharacter__pf) : (__Local__5)));
				b0l__K2Node_DynamicCast_bSuccess_6__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf != nullptr);;
		...
		case 21:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__IsDeath__pf) : (__Local__6)))
				{
					__CurrentState = 22;
					break;
				}
		...
		case 22:
			{
				...
				bpf__IsTooClose__pf(((::IsValid(b0l__K2Node_DynamicCast_AsAIShooting_Controller__pf)) ? (b0l__K2Node_DynamicCast_AsAIShooting_Controller__pf->bpv__EnemyReference__pf) : (__Local__7)), b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf, /*out*/ b0l__CallFunc_IsTooClose_IsTooClose__pf);
			}
		case 23:
			{
				if (!b0l__CallFunc_IsTooClose_IsTooClose__pf)
				{
					__CurrentState = 24;
					break;
				}
		...
		case 24:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsAIShooting_Controller__pf->bpf__Attack__pf();
				}
			}
		case 25:
			{
				E__EnumWeapon__pf  __Local__8 = E__EnumWeapon__pf::NewEnumerator0;
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__Weapon__pf) : (__Local__8))), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator0));
				...
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__Weapon__pf) : (__Local__9))), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator1));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 15;
					break;
		...
		case 26:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsAISuicide_Controller__pf != nullptr);;
		...
		case 27:
			{
				...
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(((::IsValid(b0l__K2Node_DynamicCast_AsAISuicide_Controller__pf)) ? (b0l__K2Node_DynamicCast_AsAISuicide_Controller__pf->bpv__ControlledCharacter__pf) : (__Local__10)));
		...
		case 28:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsDeath__pf) : (__Local__11)))
				{
					__CurrentState = 29;
					break;
				}
		...
		case 29:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsAISuicide_Controller__pf->bpf__Attack__pf();
				}
				__CurrentState = -1;
				break;
			}
		...
		case 31:
			{
				AEnemyDogCh_C__pf3349424045*  __Local__12 = ((AEnemyDogCh_C__pf3349424045*)nullptr);
				b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf = Cast<AEnemyDogCh_C__pf3349424045>(((::IsValid(b0l__K2Node_DynamicCast_AsAIDog_Controller__pf)) ? (b0l__K2Node_DynamicCast_AsAIDog_Controller__pf->bpv__ControlledCharacter__pf) : (__Local__12)));
				b0l__K2Node_DynamicCast_bSuccess_3__pf = (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf != nullptr);;
		...
		case 32:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpv__IsDeath__pf) : (__Local__13)))
				{
					__CurrentState = 33;
					break;
				}
		...
		case 33:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsAIDog_Controller__pf->bpf__Attack__pf();
				}
			}
		case 34:
			{
				UKismetSystemLibrary::Delay(this, bpv__DelayAnimationDog__pf, FLatentActionInfo(1, -677146167, TEXT("ExecuteUbergraph_AttackAnimation_0"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void UAttackAnimation_C__pf681293266::bpf__ReceiveExecute__pf(AActor* bpp__OwnerActor__pf)
{
	b0l__K2Node_Event_OwnerActor__pf = bpp__OwnerActor__pf;
	bpf__ExecuteUbergraph_AttackAnimation__pf_0(18);
}
void UAttackAnimation_C__pf681293266::bpf__IsTooClose__pf(AActor* bpp__Enemy__pf, AActor* bpp__SelfActor__pf, /*out*/ bool& bpp__IsTooClose__pf)
{
	float bpfv__CallFunc_GetDistanceTo_ReturnValue__pf{};
	bool bpfv__CallFunc_Less_FloatFloat_ReturnValue__pf{};
	if(::IsValid(bpp__Enemy__pf))
	{
		bpfv__CallFunc_GetDistanceTo_ReturnValue__pf = bpp__Enemy__pf->AActor::GetDistanceTo(bpp__SelfActor__pf);
	}
	bpfv__CallFunc_Less_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Less_FloatFloat(bpfv__CallFunc_GetDistanceTo_ReturnValue__pf, bpv__DistanceToFlee__pf);
	bpp__IsTooClose__pf = bpfv__CallFunc_Less_FloatFloat_ReturnValue__pf;
}
PRAGMA_DISABLE_OPTIMIZATION
void UAttackAnimation_C__pf681293266::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UAttackAnimation_C__pf681293266::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UAttackAnimation_C__pf681293266
{
	FRegisterHelper__UAttackAnimation_C__pf681293266()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Enemies/BehaviorShooting/AttackAnimation"), &UAttackAnimation_C__pf681293266::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UAttackAnimation_C__pf681293266 Instance;
};
FRegisterHelper__UAttackAnimation_C__pf681293266 FRegisterHelper__UAttackAnimation_C__pf681293266::Instance;
