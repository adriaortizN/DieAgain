...
class ABuilding_04_C__pf1894626796;
class APlayerWalkMap_Character_C__pf2222656877;
#include "Plane__pf602138253.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Art/Lobby/Plane.Plane_C", OverrideNativeName="Plane_C"))
class APlane_C__pf602138253 : public ACharacter
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Bombs Fired", Category="Default", MultiLine="true", OverrideNativeName="BombsFired"))
	int32 bpv__BombsFired__pf;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(DisplayName="Max Bombs", Category="Default", MultiLine="true", OverrideNativeName="MaxBombs"))
	int32 bpv__MaxBombs__pf;
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="K2Node_DynamicCast_AsBuilding_04"))
	ABuilding_04_C__pf1894626796* b0l__K2Node_DynamicCast_AsBuilding_04__pf;
	...
	APlane_C__pf602138253(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_Plane_0"))
	void bpf__ExecuteUbergraph_Plane__pf_0(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_Plane_1"))
	void bpf__ExecuteUbergraph_Plane__pf_1(int32 bpp__EntryPoint__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="BombEvent"))
	virtual void bpf__BombEvent__pf();
