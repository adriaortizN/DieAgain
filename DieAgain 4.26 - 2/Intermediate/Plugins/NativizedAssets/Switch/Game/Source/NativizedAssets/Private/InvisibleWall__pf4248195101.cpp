...
#include "InvisibleWall__pf4248195101.h"
...
AInvisibleWall_C__pf4248195101::AInvisibleWall_C__pf4248195101(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AInvisibleWall_C__pf4248195101::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	(((FBoolProperty*)__Local__3)->SetPropertyValue_InContainer((bpv__StaticMesh__pf), false, 0));
	auto& __Local__5 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__StaticMesh__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__5 = ECollisionChannel::ECC_WorldStatic;
	auto& __Local__6 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__StaticMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__6 = ECollisionEnabled::Type::QueryOnly;
	auto& __Local__7 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__StaticMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__8.AddUninitialized(10);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__8.GetData(), 10);
	...
	__Local__16.Channel = FName(TEXT("OverlapShoot"));
...
void AInvisibleWall_C__pf4248195101::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AInvisibleWall_C__pf4248195101::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AInvisibleWall_C__pf4248195101::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AInvisibleWall_C__pf4248195101::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AInvisibleWall_C__pf4248195101
{
	FRegisterHelper__AInvisibleWall_C__pf4248195101()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/Wall/InvisibleWall"), &AInvisibleWall_C__pf4248195101::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AInvisibleWall_C__pf4248195101 Instance;
};
FRegisterHelper__AInvisibleWall_C__pf4248195101 FRegisterHelper__AInvisibleWall_C__pf4248195101::Instance;
