...
#include "AttackToSoundLocation__pf1156381827.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Enemies/BehaviorSniper/AttackToSoundLocation.AttackToSoundLocation_C", OverrideNativeName="AttackToSoundLocation_C"))
class UAttackToSoundLocation_C__pf1156381827 : public UBTTask_BlueprintBase
{
public:
	GENERATED_BODY()
	...
	UAttackToSoundLocation_C__pf1156381827(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_AttackToSoundLocation__pf_0(int32 bpp__EntryPoint__pf);
