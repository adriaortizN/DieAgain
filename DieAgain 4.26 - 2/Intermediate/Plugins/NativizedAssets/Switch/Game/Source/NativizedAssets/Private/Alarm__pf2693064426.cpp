...
AAlarm_C__pf2693064426::AAlarm_C__pf2693064426(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__14 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AAlarm_C__pf2693064426::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(nullptr);
	auto& __Local__15 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__StaticMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__16.AddUninitialized(2);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__16.GetData(), 2);
	...
	__Local__18.Channel = FName(TEXT("GunShoot"));
	__Local__18.Response = ECollisionResponse::ECR_Ignore;
	bpv__StaticMesh__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__19 = (*(AccessPrivateProperty<FVector >((bpv__StaticMesh__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__19 = FVector(0.500000, 0.500000, 0.500000);
	...
	auto& __Local__20 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Box1__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__21.AddUninitialized(10);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__21.GetData(), 10);
	...
	__Local__30.Channel = FName(TEXT("OverlapShoot"));
	__Local__30.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__31 = __Local__21[9];
	__Local__31.Channel = FName(TEXT("GunShoot"));
	__Local__31.Response = ECollisionResponse::ECR_Ignore;
	bpv__Box1__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__32 = (*(AccessPrivateProperty<FVector >((bpv__Box1__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__32 = FVector(4.125000, 4.125000, 4.125000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Box1__pf), true, 0));
	bpv__AlarmDetectorPawn__pf = nullptr;
...
void AAlarm_C__pf2693064426::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AAlarm_C__pf2693064426::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__34->ComponentDelegateBindings.AddUninitialized(1);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__34->ComponentDelegateBindings.GetData(), 1);
	auto& __Local__35 = __Local__34->ComponentDelegateBindings[0];
	__Local__35.ComponentPropertyName = FName(TEXT("Box1"));
	__Local__35.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__35.FunctionNameToBind = FName(TEXT("BndEvt__Box1_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AAlarm_C__pf2693064426::bpf__ExecuteUbergraph_Alarm__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__ActivatingAlarm__pf) : (__Local__36)))
	{
		return; //KCST_GotoReturnIfNot
	}
	b0l__K2Node_DynamicCast_AsAlarm_Detector_Pawn__pf = Cast<AAlarmDetectorPawn_C__pf2693064426>(bpv__AlarmDetectorPawn__pf);
	b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsAlarm_Detector_Pawn__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess_1__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsAlarm_Detector_Pawn__pf))
	{
		b0l__K2Node_DynamicCast_AsAlarm_Detector_Pawn__pf->bpv__IsActive__pf = true;
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsAlarm_Detector_Pawn__pf))
	{
		b0l__K2Node_DynamicCast_AsAlarm_Detector_Pawn__pf->bpf__MoveAlarmA__pf();
	}
	return; // KCST_GotoReturn
}
void AAlarm_C__pf2693064426::bpf__ExecuteUbergraph_Alarm__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 7);
	return; // KCST_GotoReturn
}
void AAlarm_C__pf2693064426::bpf__BndEvt__Box1_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	typedef FHitResult  T__Local__37;
	T__Local__37& bpp__SweepResult__pf = *const_cast<T__Local__37 *>(&bpp__SweepResult__pf__const);
	...
	bpf__ExecuteUbergraph_Alarm__pf_0(1);
}
void AAlarm_C__pf2693064426::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Alarm__pf_1(7);
}
PRAGMA_DISABLE_OPTIMIZATION
void AAlarm_C__pf2693064426::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AAlarm_C__pf2693064426::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AAlarm_C__pf2693064426
{
	FRegisterHelper__AAlarm_C__pf2693064426()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/Alarm/Alarm"), &AAlarm_C__pf2693064426::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AAlarm_C__pf2693064426 Instance;
};
FRegisterHelper__AAlarm_C__pf2693064426 FRegisterHelper__AAlarm_C__pf2693064426::Instance;
