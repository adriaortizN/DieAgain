...
#include "AvatarPose_BlueBlood__pf2345688672.h"
...
AAvatarPose_BlueBlood_C__pf2345688672::AAvatarPose_BlueBlood_C__pf2345688672(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__Rifle__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Rifle"));
	...
	bpv__SkeletalMesh__pf->AnimationData.AnimToPlay = CastChecked<UAnimationAsset>(CastChecked<UDynamicClass>(AAvatarPose_BlueBlood_C__pf2345688672::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	bpv__SkeletalMesh__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(AAvatarPose_BlueBlood_C__pf2345688672::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	__Local__3 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AAvatarPose_BlueBlood_C__pf2345688672::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__Mask_SM__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__4 = FVector(3.000019, -20.000008, -8.000000);
	...
	bpv__Rifle__pf->AttachToComponent(bpv__SkeletalMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__6 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Rifle__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__6 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AAvatarPose_BlueBlood_C__pf2345688672::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__Rifle__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__7 = FVector(57.000000, 1.325080, 177.559616);
	auto& __Local__8 = (*(AccessPrivateProperty<FRotator >((bpv__Rifle__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__8 = FRotator(79.999527, 89.999725, 89.999779);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Rifle__pf), true, 0));
	...
	auto& __Local__9 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Knife__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__9 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AAvatarPose_BlueBlood_C__pf2345688672::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	auto& __Local__10 = (*(AccessPrivateProperty<FVector >((bpv__Knife__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__10 = FVector(-33.389538, -32.805851, 87.735611);
	auto& __Local__11 = (*(AccessPrivateProperty<FRotator >((bpv__Knife__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__11 = FRotator(-14.705026, 94.856537, -126.674149);
	auto& __Local__12 = (*(AccessPrivateProperty<FVector >((bpv__Knife__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__12 = FVector(1.500000, 1.500000, 1.500000);
...
void AAvatarPose_BlueBlood_C__pf2345688672::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AAvatarPose_BlueBlood_C__pf2345688672::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AAvatarPose_BlueBlood_C__pf2345688672::bpf__ExecuteUbergraph_AvatarPose_BlueBlood__pf_0(int32 bpp__EntryPoint__pf)
{
		...
		case 4:
			{
				...
				{
					bpv__Rifle__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(46.000000,-2.000000,175.000000), FRotator(69.999847,-90.000000,-90.000000), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult__pf, true);
				}
			}
		case 5:
			{
				...
				{
					bpv__Knife__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(-23.776217,-33.229050,92.573441), FRotator(4.999924,90.000343,-84.999947), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult_1__pf, true);
				}
				__CurrentState = -1;
				break;
			}
		...
		case 7:
			{
				...
				{
					bpv__SkeletalMesh__pf->SetSkeletalMesh(CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(AAvatarPose_BlueBlood_C__pf2345688672::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed), false);
				}
			}
		case 8:
			{
				if(::IsValid(bpv__SkeletalMesh__pf))
				{
					bpv__SkeletalMesh__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AAvatarPose_BlueBlood_C__pf2345688672::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed));
				}
			}
		case 9:
			{
				if(::IsValid(bpv__Rifle__pf))
				{
					bpv__Rifle__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(57.000000,1.325080,177.559616), FRotator(79.999527,89.999725,89.999779), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult_2__pf, true);
				}
			}
		case 10:
			{
				if(::IsValid(bpv__Knife__pf))
				{
					bpv__Knife__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(-31.776367,-33.229004,85.573441), FRotator(-9.527417,67.231987,-109.329063), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult_3__pf, true);
				}
				__CurrentState = -1;
				break;
			}
		...
		case 14:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (b0l__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__IsMale__pf) : (__Local__14)))
				{
					__CurrentState = 1;
					break;
				}
...
void AAvatarPose_BlueBlood_C__pf2345688672::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_AvatarPose_BlueBlood__pf_0(16);
}
PRAGMA_DISABLE_OPTIMIZATION
void AAvatarPose_BlueBlood_C__pf2345688672::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{1091, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  AnimSequence /Game/Art/PostApocAnimations/Pose_BlueBlood_PostApoc.Pose_BlueBlood_PostApoc 
		...
		{1092, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/FPS_Weapon_Bundle/Weapons/Meshes/KA74U/SM_KA74U_X.SM_KA74U_X 
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AAvatarPose_BlueBlood_C__pf2345688672::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AAvatarPose_BlueBlood_C__pf2345688672
{
	FRegisterHelper__AAvatarPose_BlueBlood_C__pf2345688672()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/AvatarPose/AvatarPose_BlueBlood"), &AAvatarPose_BlueBlood_C__pf2345688672::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AAvatarPose_BlueBlood_C__pf2345688672 Instance;
};
FRegisterHelper__AAvatarPose_BlueBlood_C__pf2345688672 FRegisterHelper__AAvatarPose_BlueBlood_C__pf2345688672::Instance;
