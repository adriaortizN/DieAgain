...
class UButton;
#include "LanguageHUD_Init__pf49154685.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/HUD/LanguageHUD/LanguageHUD_Init.LanguageHUD_Init_C", OverrideNativeName="LanguageHUD_Init_C"))
class ULanguageHUD_Init_C__pf49154685 : public UGamepadInteraction_C__pf197907997
{
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_Ca", Category="LanguageHUD_Init", OverrideNativeName="Button_Ca"))
	UButton* bpv__Button_Ca__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_En", Category="LanguageHUD_Init", OverrideNativeName="Button_En"))
	UButton* bpv__Button_En__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_Es", Category="LanguageHUD_Init", OverrideNativeName="Button_Es"))
	UButton* bpv__Button_Es__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_Fr", Category="LanguageHUD_Init", OverrideNativeName="Button_Fr"))
	UButton* bpv__Button_Fr__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_Ita", Category="LanguageHUD_Init", OverrideNativeName="Button_Ita"))
	UButton* bpv__Button_Ita__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_pt", Category="LanguageHUD_Init", OverrideNativeName="Button_pt"))
	UButton* bpv__Button_pt__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_Ru", Category="LanguageHUD_Init", OverrideNativeName="Button_Ru"))
	UButton* bpv__Button_Ru__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_Zh", Category="LanguageHUD_Init", OverrideNativeName="Button_Zh"))
	...
	ULanguageHUD_Init_C__pf49154685(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_LanguageHUD_Init__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LanguageHUD_Init__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LanguageHUD_Init__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LanguageHUD_Init__pf_3(int32 bpp__EntryPoint__pf);
