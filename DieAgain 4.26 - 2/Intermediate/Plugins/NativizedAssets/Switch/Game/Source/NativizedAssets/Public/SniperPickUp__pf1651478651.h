...
#include "SniperPickUp__pf1651478651.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Objects/PickUps/SniperPickUp.SniperPickUp_C", OverrideNativeName="SniperPickUp_C"))
class ASniperPickUp_C__pf1651478651 : public AActor
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="WeaponSniper"))
	UStaticMeshComponent* bpv__WeaponSniper__pf;
	...
	ASniperPickUp_C__pf1651478651(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_SniperPickUp__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_SniperPickUp__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_SniperPickUp__pf_2(int32 bpp__EntryPoint__pf);
	...
	virtual void bpf__SetMaterial__pf(bool bpp__SetDefaultMaterial__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OverlapClean"))
	virtual void bpf__OverlapClean__pf(AActor* bpp__OldOverlapActor__pf);
public:
};
