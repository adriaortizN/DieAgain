...
AFlyingPlane_C__pf270550447::AFlyingPlane_C__pf270550447(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	if(__Local__1)
	{
		...
		__Local__1->GroundFriction = 0.000000f;
		__Local__1->BrakingFrictionFactor = 0.000000f;
		__Local__1->BrakingDecelerationWalking = 0.000000f;
		__Local__1->DefaultLandMovementMode = EMovementMode::MOVE_Flying;
		__Local__1->DefaultWaterMovementMode = EMovementMode::MOVE_Flying;
		__Local__1->NavAgentProps.bCanFly = true;
		...
		__Local__1->Velocity = FVector(1000.000000, 1000.000000, 1000.000000);
	...
	auto& __Local__14 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__StaticMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__14 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AFlyingPlane_C__pf270550447::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	(((FBoolProperty*)__Local__15)->SetPropertyValue_InContainer((bpv__StaticMesh__pf), false, 0));
	bpv__StaticMesh__pf->SetCollisionProfileName(FName(TEXT("NoCollision")));
	auto& __Local__17 = (*(AccessPrivateProperty<FRotator >((bpv__StaticMesh__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__17 = FRotator(0.000000, -90.000114, 0.000000);
	...
	bpv__ParticleSystem__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AFlyingPlane_C__pf270550447::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	auto& __Local__20 = (*(AccessPrivateProperty<FVector >((bpv__ParticleSystem__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__20 = FVector(0.000018, 510.999969, -13.000000);
	bpv__ParticleSystem__pf->PrimaryComponentTick.bStartWithTickEnabled = false;
	(((FBoolProperty*)__Local__18)->SetPropertyValue_InContainer((bpv__ParticleSystem__pf), false, 0));
	bpv__Velocity__pf = FVector(0.000000, 0.000000, 0.000000);
	bpv__TrueSpeed__pf = FVector(0.000000, 0.000000, 0.000000);
...
void AFlyingPlane_C__pf270550447::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AFlyingPlane_C__pf270550447::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AFlyingPlane_C__pf270550447::bpf__ExecuteUbergraph_FlyingPlane__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	{
		(*(AccessPrivateProperty<UCharacterMovementComponent* >((this), ACharacter::__PPO__CharacterMovement() )))->Velocity = bpv__TrueSpeed__pf;
	}
	return; //KCST_EndOfThread
}
void AFlyingPlane_C__pf270550447::bpf__ExecuteUbergraph_FlyingPlane__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				bpv__TrueSpeed__pf = bpv__Velocity__pf;
			}
		case 5:
			{
				if(::IsValid((*(AccessPrivateProperty<UCharacterMovementComponent* >((this), ACharacter::__PPO__CharacterMovement() )))))
				{
					(*(AccessPrivateProperty<UCharacterMovementComponent* >((this), ACharacter::__PPO__CharacterMovement() )))->Velocity = bpv__Velocity__pf;
				}
			}
		case 6:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("ReDo Velocity")));
		...
		case 7:
			{
				UKismetSystemLibrary::Delay(this, 50.000000, FLatentActionInfo(1, -835224670, TEXT("ExecuteUbergraph_FlyingPlane_1"), this));
				__CurrentState = -1;
				break;
			}
		case 8:
		...
		case 9:
			{
				UKismetSystemLibrary::Delay(this, 0.100000, FLatentActionInfo(3, 1864243243, TEXT("ExecuteUbergraph_FlyingPlane_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void AFlyingPlane_C__pf270550447::bpf__ExecuteUbergraph_FlyingPlane__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 10);
	return; //KCST_EndOfThread
}
void AFlyingPlane_C__pf270550447::bpf__ReDoxVelocity__pfT()
{
	bpf__ExecuteUbergraph_FlyingPlane__pf_0(11);
}
void AFlyingPlane_C__pf270550447::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_FlyingPlane__pf_2(10);
}
void AFlyingPlane_C__pf270550447::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_FlyingPlane__pf_1(8);
}
PRAGMA_DISABLE_OPTIMIZATION
void AFlyingPlane_C__pf270550447::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AFlyingPlane_C__pf270550447::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AFlyingPlane_C__pf270550447
{
	FRegisterHelper__AFlyingPlane_C__pf270550447()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/FlyingPlane/FlyingPlane"), &AFlyingPlane_C__pf270550447::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AFlyingPlane_C__pf270550447 Instance;
};
FRegisterHelper__AFlyingPlane_C__pf270550447 FRegisterHelper__AFlyingPlane_C__pf270550447::Instance;
