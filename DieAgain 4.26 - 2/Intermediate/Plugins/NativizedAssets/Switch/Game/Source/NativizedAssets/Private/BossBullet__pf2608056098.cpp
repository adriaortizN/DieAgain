...
ABossBullet_C__pf2608056098::ABossBullet_C__pf2608056098(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__RocketMesh__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("RocketMesh"));
	...
	bpv__RocketMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__RocketMesh__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__RocketMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABossBullet_C__pf2608056098::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__3 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__RocketMesh__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__3 = ECollisionChannel::ECC_WorldStatic;
	auto& __Local__4 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__RocketMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__4 = ECollisionEnabled::Type::QueryOnly;
	auto& __Local__5 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__RocketMesh__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__6.AddUninitialized(11);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__6.GetData(), 11);
	...
	__Local__15.Channel = FName(TEXT("OverlapShoot"));
	__Local__15.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__16 = __Local__6[9];
	__Local__16.Channel = FName(TEXT("GunShoot"));
	__Local__16.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__17 = __Local__6[10];
	__Local__17.Channel = FName(TEXT("ExplosionMissile"));
	__Local__17.Response = ECollisionResponse::ECR_Ignore;
	bpv__RocketMesh__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__18 = (*(AccessPrivateProperty<FRotator >((bpv__RocketMesh__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__18 = FRotator(-80.000000, 0.000000, 0.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__RocketMesh__pf), true, 0));
	bpv__ParticleSystem__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ParticleSystem__pf->AttachToComponent(bpv__RocketMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__ParticleSystem__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ABossBullet_C__pf2608056098::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	auto& __Local__19 = (*(AccessPrivateProperty<FVector >((bpv__ParticleSystem__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__19 = FVector(-30.000008, 0.000000, 0.000000);
	auto& __Local__20 = (*(AccessPrivateProperty<FVector >((bpv__ParticleSystem__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__20 = FVector(0.500000, 0.500000, 0.500000);
	...
	bpv__FMODAudio__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__FMODAudio__pf->Event = CastChecked<UFMODEvent>(CastChecked<UDynamicClass>(ABossBullet_C__pf2608056098::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	auto& __Local__21 = (*(AccessPrivateProperty<FRotator >((bpv__FMODAudio__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__21 = FRotator(80.000008, 0.000000, 0.000000);
	bpv__FMODAudio__pf->bAutoActivate = false;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__FMODAudio__pf), false, 0));
	...
	auto& __Local__22 = (*(AccessPrivateProperty<FVector >((bpv__ChildActor__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__22 = FVector(0.000000, 0.000000, 45.000000);
	...
	bpv__ProjectileMovement__pf->bIsHomingProjectile = true;
	bpv__ProjectileMovement__pf->HomingAccelerationMagnitude = 1.000000f;
	...
	bpv__BulletLocationRef__pf = nullptr;
...
void ABossBullet_C__pf2608056098::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABossBullet_C__pf2608056098::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(ABossBulletLocation_C__pf2608056098::StaticClass());
	...
	InDynamicClass->ReferencedConvertedFields.Add(AFloorBoss_C__pf2608056098::StaticClass());
	...
	auto& __Local__25 = __Local__24->ComponentDelegateBindings[0];
	__Local__25.ComponentPropertyName = FName(TEXT("RocketMesh"));
	__Local__25.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__25.FunctionNameToBind = FName(TEXT("BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABossBullet_C__pf2608056098::bpf__ExecuteUbergraph_BossBullet__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 9:
			{
				b0l__K2Node_DynamicCast_AsFloor_Boss__pf = Cast<AFloorBoss_C__pf2608056098>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsFloor_Boss__pf != nullptr);;
		...
		case 10:
			{
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(b0l__K2Node_DynamicCast_AsFloor_Boss__pf);
		...
		case 13:
			{
				...
				bpfv__CallFunc_Add_VectorVector_ReturnValue_1__pf = UKismetMathLibrary::Add_VectorVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_2__pf, FVector(0.000000,500.000000,0.000000));
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf))
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpf__TakeDamage__pf(100, bpfv__CallFunc_Add_VectorVector_ReturnValue_1__pf, ((AActor*)nullptr));
				}
				__CurrentState = 11;
				break;
			}
		...
		case 15:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpf__TakeDamage__pf(100, FName(TEXT("None")), bpfv__CallFunc_Add_VectorVector_ReturnValue__pf, ((AActor*)nullptr));
				}
				__CurrentState = 11;
				break;
			}
...
void ABossBullet_C__pf2608056098::bpf__ExecuteUbergraph_BossBullet__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	ABossBulletLocation_C__pf2608056098* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	...
	bool bpfv__CallFunc_SuggestProjectileVelocity_CustomArc_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_FloatFloat(b0l__K2Node_CustomEvent_Dispersion__pf, -1.000000);
	bpfv__CallFunc_RandomFloatInRange_ReturnValue__pf = UKismetMathLibrary::RandomFloatInRange(bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf, b0l__K2Node_CustomEvent_Dispersion__pf);
	bpfv__CallFunc_RandomFloatInRange_ReturnValue_1__pf = UKismetMathLibrary::RandomFloatInRange(bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf, b0l__K2Node_CustomEvent_Dispersion__pf);
	UKismetMathLibrary::BreakVector(bpv__EndLocation__pf, /*out*/ b0l__CallFunc_BreakVector_X_1__pf, /*out*/ b0l__CallFunc_BreakVector_Y_1__pf, /*out*/ b0l__CallFunc_BreakVector_Z_1__pf);
	bpfv__CallFunc_Add_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::Add_FloatFloat(b0l__CallFunc_BreakVector_Y_1__pf, bpfv__CallFunc_RandomFloatInRange_ReturnValue__pf);
	bpfv__CallFunc_Add_FloatFloat_ReturnValue_2__pf = UKismetMathLibrary::Add_FloatFloat(b0l__CallFunc_BreakVector_X_1__pf, bpfv__CallFunc_RandomFloatInRange_ReturnValue_1__pf);
	bpfv__CallFunc_MakeVector_ReturnValue_1__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_Add_FloatFloat_ReturnValue_2__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_1__pf, b0l__CallFunc_BreakVector_Z_1__pf);
	bpv__EndLocation__pf = bpfv__CallFunc_MakeVector_ReturnValue_1__pf;
	bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf = AActor::K2_GetActorLocation();
	bpfv__CallFunc_SuggestProjectileVelocity_CustomArc_ReturnValue__pf = UGameplayStatics::SuggestProjectileVelocity_CustomArc(this, /*out*/ b0l__CallFunc_SuggestProjectileVelocity_CustomArc_OutLaunchVelocity__pf, bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf, bpv__EndLocation__pf, 0.000000, 0.600000);
	if(::IsValid(bpv__ProjectileMovement__pf))
	{
		bpv__ProjectileMovement__pf->Velocity = b0l__CallFunc_SuggestProjectileVelocity_CustomArc_OutLaunchVelocity__pf;
	}
	UKismetMathLibrary::BreakVector(bpv__EndLocation__pf, /*out*/ b0l__CallFunc_BreakVector_X__pf, /*out*/ b0l__CallFunc_BreakVector_Y__pf, /*out*/ b0l__CallFunc_BreakVector_Z__pf);
	bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(b0l__CallFunc_BreakVector_X__pf, -50.000000);
	bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf, b0l__CallFunc_BreakVector_Y__pf, 131.000000);
	...
	bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, ABossBulletLocation_C__pf2608056098::StaticClass(), bpfv__CallFunc_MakeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AdjustIfPossibleButAlwaysSpawn, ((AActor*)nullptr));
	UKismetMathLibrary::BreakVector(bpv__EndLocation__pf, /*out*/ b0l__CallFunc_BreakVector_X__pf, /*out*/ b0l__CallFunc_BreakVector_Y__pf, /*out*/ b0l__CallFunc_BreakVector_Z__pf);
	bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(b0l__CallFunc_BreakVector_X__pf, -50.000000);
	bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf, b0l__CallFunc_BreakVector_Y__pf, 131.000000);
	bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_MakeVector_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000));
	bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<ABossBulletLocation_C__pf2608056098>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_MakeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
	bpv__BulletLocationRef__pf = bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf;
	return; // KCST_GotoReturn
}
void ABossBullet_C__pf2608056098::bpf__BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BossBullet__pf_0(8);
}
void ABossBullet_C__pf2608056098::bpf__LaunchEvent__pf(float bpp__Dispersion__pf)
{
	b0l__K2Node_CustomEvent_Dispersion__pf = bpp__Dispersion__pf;
	bpf__ExecuteUbergraph_BossBullet__pf_1(1);
}
void ABossBullet_C__pf2608056098::bpf__ExplosionEvent__pf()
{
	...
	ABossBulletLocation_C__pf2608056098* bpfv__K2Node_DynamicCast_AsBoss_Bullet_Location__pf{};
	...
	do
	{
		...
		case 7:
			{
				...
				{
					bpfv__CallFunc_GetUpVector_ReturnValue__pf = bpv__ChildActor__pf->USceneComponent::GetUpVector();
				}
				if(::IsValid(bpv__ChildActor__pf))
				{
					bpfv__CallFunc_GetForwardVector_ReturnValue__pf = bpv__ChildActor__pf->USceneComponent::GetForwardVector();
				}
				if(::IsValid(bpv__ChildActor__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__ChildActor__pf->USceneComponent::K2_GetComponentLocation();
				}
				bpfv__CallFunc_RotateAngleAxis_ReturnValue__pf = UKismetMathLibrary::RotateAngleAxis(bpfv__CallFunc_GetForwardVector_ReturnValue__pf, bpv__Angle__pf, bpfv__CallFunc_GetUpVector_ReturnValue__pf);
				bpfv__CallFunc_Multiply_VectorInt_ReturnValue__pf = UKismetMathLibrary::Multiply_VectorInt(bpfv__CallFunc_RotateAngleAxis_ReturnValue__pf, 175);
				bpfv__CallFunc_Add_VectorVector_ReturnValue_2__pf = UKismetMathLibrary::Add_VectorVector(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_Multiply_VectorInt_ReturnValue__pf);
				bpfv__CallFunc_LineTraceSingle_ReturnValue__pf = UKismetSystemLibrary::LineTraceSingle(this, bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_Add_VectorVector_ReturnValue_2__pf, ETraceTypeQuery::TraceTypeQuery5, false, bpfv__Temp_object_Variable__pf, EDrawDebugTrace::None, /*out*/ bpfv__CallFunc_LineTraceSingle_OutHit__pf, true, FLinearColor(1.000000,0.000000,0.000000,1.000000), FLinearColor(0.000000,1.000000,0.000000,1.000000), 5.000000);
			}
		case 8:
			{
		...
		case 9:
			{
				...
				bpfv__K2Node_DynamicCast_bSuccess_3__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf != nullptr);;
		...
		case 10:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpf__TakeDamage__pf(100, FName(TEXT("None")), bpfv__CallFunc_Add_VectorVector_ReturnValue__pf, this);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 11:
			{
				bpfv__CallFunc_K2_GetActorLocation_ReturnValue_2__pf = AActor::K2_GetActorLocation();
				bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ABossBullet_C__pf2608056098::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue_2__pf, FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000), true, EPSCPoolMethod::None, true);
			}
		case 12:
			{
		...
		case 13:
			{
				...
				UGameplayStatics::PlayWorldCameraShake(this, CastChecked<UClass>(CastChecked<UDynamicClass>(ABossBullet_C__pf2608056098::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf, 20000.000000, 20000.000000, 1.000000, false);
			}
		case 14:
			{
				bpfv__K2Node_DynamicCast_AsBoss_Bullet_Location__pf = Cast<ABossBulletLocation_C__pf2608056098>(bpv__BulletLocationRef__pf);
				bpfv__K2Node_DynamicCast_bSuccess__pf = (bpfv__K2Node_DynamicCast_AsBoss_Bullet_Location__pf != nullptr);;
		...
		case 15:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsBoss_Bullet_Location__pf))
				{
					bpfv__K2Node_DynamicCast_AsBoss_Bullet_Location__pf->K2_DestroyActor();
				}
			}
		case 16:
			{
		...
		case 18:
			{
				if(::IsValid(bpv__RocketMesh__pf))
				{
					bpv__RocketMesh__pf->USceneComponent::SetVisibility(false, false);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 23:
			{
				UGameplayStatics::BreakHitResult(bpfv__CallFunc_LineTraceSingle_OutHit__pf, /*out*/ bpfv__CallFunc_BreakHitResult_bBlockingHit__pf, /*out*/ bpfv__CallFunc_BreakHitResult_bInitialOverlap__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Time__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Distance__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Location__pf, /*out*/ bpfv__CallFunc_BreakHitResult_ImpactPoint__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Normal__pf, /*out*/ bpfv__CallFunc_BreakHitResult_ImpactNormal__pf, /*out*/ bpfv__CallFunc_BreakHitResult_PhysMat__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitActor__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitComponent__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitBoneName__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitItem__pf, /*out*/ bpfv__CallFunc_BreakHitResult_FaceIndex__pf, /*out*/ bpfv__CallFunc_BreakHitResult_TraceStart__pf, /*out*/ bpfv__CallFunc_BreakHitResult_TraceEnd__pf);
				USkeletalMeshComponent*  __Local__27 = ((USkeletalMeshComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpv__SkeletalMesh__pf) : (__Local__27)), bpfv__CallFunc_BreakHitResult_HitComponent__pf);
		...
		case 26:
			{
				bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf = AActor::K2_GetActorLocation();
				bpfv__CallFunc_Add_VectorVector_ReturnValue_1__pf = UKismetMathLibrary::Add_VectorVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf, FVector(0.000000,-500.000000,0.000000));
				if(::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf))
				{
					bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf->bpf__TakeDamage__pf(200, bpfv__CallFunc_Add_VectorVector_ReturnValue_1__pf, this);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
PRAGMA_DISABLE_OPTIMIZATION
void ABossBullet_C__pf2608056098::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABossBullet_C__pf2608056098::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{953, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Objects/Boss/BossBulletLocation.BossBulletLocation_C 
		...
		{954, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Objects/Boss/FloorBoss.FloorBoss_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABossBullet_C__pf2608056098
{
	FRegisterHelper__ABossBullet_C__pf2608056098()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/Boss/BossBullet"), &ABossBullet_C__pf2608056098::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABossBullet_C__pf2608056098 Instance;
};
FRegisterHelper__ABossBullet_C__pf2608056098 FRegisterHelper__ABossBullet_C__pf2608056098::Instance;
