...
class AActor;
#include "ACH_POWERup__pf3264546738.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Conversations/Events/ACH_POWERup.ACH_POWERUP_C", OverrideNativeName="ACH_POWERUP_C"))
class UACH_POWERUP_C__pf3264546738 : public UDialogueEvents
{
public:
	GENERATED_BODY()
	...
	UACH_POWERUP_C__pf3264546738(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_ACH_POWERUP__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_POWERUP__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_POWERUP__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_POWERUP__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_POWERUP__pf_4(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_BB86090C474E0AE5DA4A1198779B22DF"))
	virtual void bpf__OnSuccess_BB86090C474E0AE5DA4A1198779B22DF__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_BB86090C474E0AE5DA4A1198779B22DF"))
	virtual void bpf__OnFailure_BB86090C474E0AE5DA4A1198779B22DF__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_34A2EFF64CBB2CD6C84E1F8700D2C490"))
	virtual void bpf__OnSuccess_34A2EFF64CBB2CD6C84E1F8700D2C490__pf();
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_34A2EFF64CBB2CD6C84E1F8700D2C490"))
	virtual void bpf__OnFailure_34A2EFF64CBB2CD6C84E1F8700D2C490__pf();
public:
};
