...
#include "Door_A_Close_BP__pf1034369011.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/ModSciInteriors/Blueprints/Door_A_Close_BP.Door_A_Close_BP_C", OverrideNativeName="Door_A_Close_BP_C"))
class ADoor_A_Close_BP_C__pf1034369011 : public AActor
{
public:
	GENERATED_BODY()
	...
	ADoor_A_Close_BP_C__pf1034369011(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
