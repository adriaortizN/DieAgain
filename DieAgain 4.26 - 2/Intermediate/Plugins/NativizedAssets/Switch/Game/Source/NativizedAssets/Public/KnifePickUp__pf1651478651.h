...
#include "KnifePickUp__pf1651478651.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Objects/PickUps/KnifePickUp.KnifePickUp_C", OverrideNativeName="KnifePickUp_C"))
class AKnifePickUp_C__pf1651478651 : public AActor
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="WeaponKnife"))
	UStaticMeshComponent* bpv__WeaponKnife__pf;
	...
	AKnifePickUp_C__pf1651478651(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_KnifePickUp__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_KnifePickUp__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_KnifePickUp__pf_2(int32 bpp__EntryPoint__pf);
