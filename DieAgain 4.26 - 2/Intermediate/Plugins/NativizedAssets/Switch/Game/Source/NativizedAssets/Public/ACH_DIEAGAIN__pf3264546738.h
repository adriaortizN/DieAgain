...
#include "ACH_DIEAGAIN__pf3264546738.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Conversations/Events/ACH_DIEAGAIN.ACH_DIEAGAIN_C", OverrideNativeName="ACH_DIEAGAIN_C"))
class UACH_DIEAGAIN_C__pf3264546738 : public UDialogueEvents
{
public:
	GENERATED_BODY()
	...
	UACH_DIEAGAIN_C__pf3264546738(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_ACH_DIEAGAIN__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_DIEAGAIN__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_DIEAGAIN__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_DIEAGAIN__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_DIEAGAIN__pf_4(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_87A639C84BECB3F216C46BB42DB89BF9"))
	virtual void bpf__OnSuccess_87A639C84BECB3F216C46BB42DB89BF9__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_87A639C84BECB3F216C46BB42DB89BF9"))
	virtual void bpf__OnFailure_87A639C84BECB3F216C46BB42DB89BF9__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_FAD7B2BB44A277B151B1A4B3E4E41D16"))
	virtual void bpf__OnSuccess_FAD7B2BB44A277B151B1A4B3E4E41D16__pf();
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_FAD7B2BB44A277B151B1A4B3E4E41D16"))
	virtual void bpf__OnFailure_FAD7B2BB44A277B151B1A4B3E4E41D16__pf();
public:
};
