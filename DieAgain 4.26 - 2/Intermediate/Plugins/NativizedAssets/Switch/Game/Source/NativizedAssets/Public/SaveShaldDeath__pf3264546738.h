...
#include "SaveShaldDeath__pf3264546738.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Conversations/Events/SaveShaldDeath.SaveShaldDeath_C", OverrideNativeName="SaveShaldDeath_C"))
class USaveShaldDeath_C__pf3264546738 : public UDialogueEvents
{
public:
	GENERATED_BODY()
	...
	USaveShaldDeath_C__pf3264546738(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_SaveShaldDeath__pf_0(int32 bpp__EntryPoint__pf);
