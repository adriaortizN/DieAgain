...
#include "FallingPlane__pf3705925838.h"
...
AFallingPlane_C__pf3705925838::AFallingPlane_C__pf3705925838(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__Destructible__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(AFallingPlane_C__pf3705925838::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	(((FBoolProperty*)__Local__4)->SetPropertyValue_InContainer((bpv__Destructible__pf), false, 0));
	bpv__Destructible__pf->BodyInstance.bNotifyRigidBodyCollision = true;
	auto& __Local__6 = (*(AccessPrivateProperty<FRotator >((bpv__Destructible__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__6 = FRotator(0.000000, 90.000542, 0.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Destructible__pf), false, 0));
	bpv__ChildActor__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ChildActor__pf->AttachToComponent(bpv__Destructible__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__ChildActor__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__7 = FVector(0.000000, -510.999969, 47.000000);
...
void AFallingPlane_C__pf3705925838::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AFallingPlane_C__pf3705925838::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__9->ComponentDelegateBindings.AddUninitialized(4);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__9->ComponentDelegateBindings.GetData(), 4);
	auto& __Local__10 = __Local__9->ComponentDelegateBindings[0];
	__Local__10.ComponentPropertyName = FName(TEXT("ProjectileMovement"));
	__Local__10.DelegatePropertyName = FName(TEXT("OnProjectileStop"));
	__Local__10.FunctionNameToBind = FName(TEXT("BndEvt__ProjectileMovement_K2Node_ComponentBoundEvent_3_OnProjectileStopDelegate__DelegateSignature"));
	auto& __Local__11 = __Local__9->ComponentDelegateBindings[1];
	__Local__11.ComponentPropertyName = FName(TEXT("ProjectileMovement"));
	__Local__11.DelegatePropertyName = FName(TEXT("OnProjectileBounce"));
	__Local__11.FunctionNameToBind = FName(TEXT("BndEvt__ProjectileMovement_K2Node_ComponentBoundEvent_2_OnProjectileBounceDelegate__DelegateSignature"));
	auto& __Local__12 = __Local__9->ComponentDelegateBindings[2];
	__Local__12.ComponentPropertyName = FName(TEXT("Cube"));
	__Local__12.DelegatePropertyName = FName(TEXT("OnComponentHit"));
	__Local__12.FunctionNameToBind = FName(TEXT("BndEvt__Cube_K2Node_ComponentBoundEvent_1_ComponentHitSignature__DelegateSignature"));
	auto& __Local__13 = __Local__9->ComponentDelegateBindings[3];
	__Local__13.ComponentPropertyName = FName(TEXT("Destructible"));
	__Local__13.DelegatePropertyName = FName(TEXT("OnComponentHit"));
	__Local__13.FunctionNameToBind = FName(TEXT("BndEvt__Destructible_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AFallingPlane_C__pf3705925838::bpf__ExecuteUbergraph_FallingPlane__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_PlayEvent2D_ReturnValue__pf = UFMODBlueprintStatics::PlayEvent2D(this, CastChecked<UFMODEvent>(CastChecked<UDynamicClass>(AFallingPlane_C__pf3705925838::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed), true);
			}
		case 2:
			{
		...
		case 3:
			{
				...
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = b0l__K2Node_DynamicCast_AsPlayer_Walk_Map_Character__pf->AActor::K2_GetActorLocation();
				}
				UGameplayStatics::PlayWorldCameraShake(this, CastChecked<UClass>(CastChecked<UDynamicClass>(AFallingPlane_C__pf3705925838::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, 10000.000000, 10000.000000, 1.000000, false);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 4:
		...
		case 9:
			{
				...
				{
					bpv__Destructible__pf->ApplyRadiusDamage(10000.000000, bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, 1000.000000, 100000.000000, true);
				}
			}
		case 10:
			{
				if(::IsValid(bpv__ChildActor__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf = bpv__ChildActor__pf->USceneComponent::K2_GetComponentLocation();
				}
				bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AFallingPlane_C__pf3705925838::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf, FRotator(0.000000,0.000000,0.000000), FVector(3.000000,3.000000,3.000000), true, EPSCPoolMethod::None, true);
				__CurrentState = 1;
				break;
			}
		case 11:
		...
		case 15:
			{
				UKismetSystemLibrary::Delay(this, 2.000000, FLatentActionInfo(4, 71011293, TEXT("ExecuteUbergraph_FallingPlane_0"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		default:
...
void AFallingPlane_C__pf3705925838::bpf__ExecuteUbergraph_FallingPlane__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 20);
	return; //KCST_EndOfThread
}
void AFallingPlane_C__pf3705925838::bpf__ExecuteUbergraph_FallingPlane__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 19);
	return; //KCST_EndOfThread
}
void AFallingPlane_C__pf3705925838::bpf__ExecuteUbergraph_FallingPlane__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 18);
	return; //KCST_EndOfThread
}
void AFallingPlane_C__pf3705925838::bpf__ExecuteUbergraph_FallingPlane__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 17);
	return; //KCST_EndOfThread
}
void AFallingPlane_C__pf3705925838::bpf__ExecuteUbergraph_FallingPlane__pf_5(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 16);
	return; //KCST_EndOfThread
}
void AFallingPlane_C__pf3705925838::bpf__BndEvt__ProjectileMovement_K2Node_ComponentBoundEvent_3_OnProjectileStopDelegate__DelegateSignature__pf(FHitResult const& bpp__ImpactResult__pf__const)
{
	typedef FHitResult  T__Local__15;
	T__Local__15& bpp__ImpactResult__pf = *const_cast<T__Local__15 *>(&bpp__ImpactResult__pf__const);
	b0l__K2Node_ComponentBoundEvent_ImpactResult__pf = bpp__ImpactResult__pf;
	bpf__ExecuteUbergraph_FallingPlane__pf_1(20);
}
void AFallingPlane_C__pf3705925838::bpf__BndEvt__ProjectileMovement_K2Node_ComponentBoundEvent_2_OnProjectileBounceDelegate__DelegateSignature__pf(FHitResult const& bpp__ImpactResult__pf__const, FVector const& bpp__ImpactVelocity__pf__const)
{
	typedef FHitResult  T__Local__16;
	T__Local__16& bpp__ImpactResult__pf = *const_cast<T__Local__16 *>(&bpp__ImpactResult__pf__const);
	typedef FVector  T__Local__17;
	T__Local__17& bpp__ImpactVelocity__pf = *const_cast<T__Local__17 *>(&bpp__ImpactVelocity__pf__const);
	b0l__K2Node_ComponentBoundEvent_ImpactResult_1__pf = bpp__ImpactResult__pf;
	b0l__K2Node_ComponentBoundEvent_ImpactVelocity__pf = bpp__ImpactVelocity__pf;
	bpf__ExecuteUbergraph_FallingPlane__pf_2(19);
}
void AFallingPlane_C__pf3705925838::bpf__BndEvt__Cube_K2Node_ComponentBoundEvent_1_ComponentHitSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__HitComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	...
	bpf__ExecuteUbergraph_FallingPlane__pf_3(18);
}
void AFallingPlane_C__pf3705925838::bpf__BndEvt__Destructible_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__HitComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	...
	bpf__ExecuteUbergraph_FallingPlane__pf_4(17);
}
void AFallingPlane_C__pf3705925838::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_FallingPlane__pf_5(16);
}
void AFallingPlane_C__pf3705925838::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_FallingPlane__pf_0(14);
}
PRAGMA_DISABLE_OPTIMIZATION
void AFallingPlane_C__pf3705925838::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AFallingPlane_C__pf3705925838::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AFallingPlane_C__pf3705925838
{
	FRegisterHelper__AFallingPlane_C__pf3705925838()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/FallingPlane/FallingPlane"), &AFallingPlane_C__pf3705925838::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AFallingPlane_C__pf3705925838 Instance;
};
FRegisterHelper__AFallingPlane_C__pf3705925838 FRegisterHelper__AFallingPlane_C__pf3705925838::Instance;
