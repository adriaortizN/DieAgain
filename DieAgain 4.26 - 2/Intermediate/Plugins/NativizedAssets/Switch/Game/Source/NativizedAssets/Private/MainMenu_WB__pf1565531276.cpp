...
UMainMenu_WB_C__pf1565531276::UMainMenu_WB_C__pf1565531276(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__ChangeAvatar_Button__pf = nullptr;
	bpv__ChangeLanguage_Button__pf = nullptr;
	bpv__CloseGame_Button__pf = nullptr;
	bpv__FinalCredits_Button__pf = nullptr;
	bpv__Graphics_Button__pf = nullptr;
	bpv__Play_Button__pf = nullptr;
	bpv__defaultButton__pf.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__0 = (*(AccessPrivateProperty<UObject* >(&(bpv__defaultButton__pf.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__0 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__defaultButton__pf.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__1 = (*(AccessPrivateProperty<UObject* >(&(bpv__defaultButton__pf.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__1 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__defaultButton__pf.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__2 = (*(AccessPrivateProperty<UObject* >(&(bpv__defaultButton__pf.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__2 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__hoverButton__pf.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__3 = (*(AccessPrivateProperty<UObject* >(&(bpv__hoverButton__pf.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__3 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__hoverButton__pf.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__4 = (*(AccessPrivateProperty<UObject* >(&(bpv__hoverButton__pf.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__4 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__hoverButton__pf.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__5 = (*(AccessPrivateProperty<UObject* >(&(bpv__hoverButton__pf.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__5 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
}
PRAGMA_ENABLE_OPTIMIZATION
void UMainMenu_WB_C__pf1565531276::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UMainMenu_WB_C__pf1565531276::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UChangeAvatarHUD_C__pf1376575910::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(ULanguageHUD_C__pf49154685::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UOptionsHUD_C__pf3479267681::StaticClass());
	...
	auto __Local__7 = NewObject<UWidgetTree>(InDynamicClass, UWidgetTree::StaticClass(), TEXT("WidgetTree"), (EObjectFlags)0x00000008);
	InDynamicClass->MiscConvertedSubobjects.Add(__Local__7);
	auto __Local__8 = NewObject<UWidgetAnimation>(InDynamicClass, UWidgetAnimation::StaticClass(), TEXT("ChangeAvatarAnim_INST"), (EObjectFlags)0x00280008);
	...
	__Local__6->ComponentDelegateBindings.AddUninitialized(6);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__6->ComponentDelegateBindings.GetData(), 6);
	auto& __Local__9 = __Local__6->ComponentDelegateBindings[0];
	__Local__9.ComponentPropertyName = FName(TEXT("ChangeLanguage_Button"));
	__Local__9.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__9.FunctionNameToBind = FName(TEXT("BndEvt__ChangeLanguage_Button_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__10 = __Local__6->ComponentDelegateBindings[1];
	__Local__10.ComponentPropertyName = FName(TEXT("FinalCredits_Button"));
	__Local__10.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__10.FunctionNameToBind = FName(TEXT("BndEvt__FinalCredits_Button_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__11 = __Local__6->ComponentDelegateBindings[2];
	__Local__11.ComponentPropertyName = FName(TEXT("ChangeAvatar_Button"));
	__Local__11.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__11.FunctionNameToBind = FName(TEXT("BndEvt__ChangeAvatar_Button_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__12 = __Local__6->ComponentDelegateBindings[3];
	__Local__12.ComponentPropertyName = FName(TEXT("Graphics_Button"));
	__Local__12.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__12.FunctionNameToBind = FName(TEXT("BndEvt__Graphics_Button_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__13 = __Local__6->ComponentDelegateBindings[4];
	__Local__13.ComponentPropertyName = FName(TEXT("Play_Button"));
	__Local__13.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__13.FunctionNameToBind = FName(TEXT("BndEvt__Play_Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__14 = __Local__6->ComponentDelegateBindings[5];
	__Local__14.ComponentPropertyName = FName(TEXT("CloseGame_Button"));
	__Local__14.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__14.FunctionNameToBind = FName(TEXT("BndEvt__CloseGame_Button_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	auto __Local__15 = NewObject<UCanvasPanel>(__Local__7, TEXT("CanvasPanel_0"), (EObjectFlags)0x00280008);
	...
	auto __Local__17 = NewObject<UCanvasPanelSlot>(__Local__15, TEXT("CanvasPanelSlot_25"), (EObjectFlags)0x00280008);
	__Local__17->LayoutData.Offsets.Left = -553.921875f;
	__Local__17->LayoutData.Offsets.Top = 220.000000f;
	__Local__17->LayoutData.Offsets.Right = 500.000000f;
	__Local__17->LayoutData.Offsets.Bottom = 90.000000f;
	__Local__17->LayoutData.Anchors.Minimum = FVector2D(1.000000, 0.000000);
	__Local__17->LayoutData.Anchors.Maximum = FVector2D(1.000000, 0.000000);
	__Local__17->Parent = __Local__15;
	auto __Local__18 = NewObject<UButton>(__Local__7, TEXT("ChangeAvatar_Button"), (EObjectFlags)0x00280008);
	__Local__18->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__19 = (*(AccessPrivateProperty<UObject* >(&(__Local__18->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__19 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__18->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__20 = (*(AccessPrivateProperty<UObject* >(&(__Local__18->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__20 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__18->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__21 = (*(AccessPrivateProperty<UObject* >(&(__Local__18->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__21 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__22 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__18), UPanelWidget::__PPO__Slots() )));
	__Local__22 = TArray<UPanelSlot*> ();
	__Local__22.Reserve(1);
	auto __Local__23 = NewObject<UButtonSlot>(__Local__18, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__23->Parent = __Local__18;
	auto __Local__24 = NewObject<UTextBlock>(__Local__7, TEXT("TextBlock_630"), (EObjectFlags)0x00280008);
	__Local__24->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[56307C5E43048D3FAE4CF08BF790A676]\", \"A6CD7CFF417155E59955208382C4C329\", \"Change Avatar\")")	);
	__Local__24->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__24->Font.OutlineSettings.OutlineSize = 5;
	__Local__24->Font.TypefaceFontName = FName(TEXT("Regular"));
	__Local__24->Font.Size = 35;
	...
	__Local__24->RenderTransform.Scale = FVector2D(1.150000, 1.150000);
	__Local__23->Content = __Local__24;
	__Local__22.Add(__Local__23);
	__Local__18->Slot = __Local__17;
	__Local__18->RenderTransform.Angle = 24.000000f;
	auto __Local__26 = NewObject<UWidgetNavigation>(__Local__18, TEXT("WidgetNavigation_1"), (EObjectFlags)0x00280008);
	__Local__26->Left.Rule = EUINavigationRule::Explicit;
	__Local__26->Left.WidgetToFocus = FName(TEXT("Play_Button"));
	__Local__18->Navigation = __Local__26;
	__Local__17->Content = __Local__18;
	__Local__16.Add(__Local__17);
	auto __Local__27 = NewObject<UCanvasPanelSlot>(__Local__15, TEXT("CanvasPanelSlot_20"), (EObjectFlags)0x00280008);
	__Local__27->LayoutData.Offsets.Left = -328.960938f;
	__Local__27->LayoutData.Offsets.Top = 76.000000f;
	__Local__27->LayoutData.Offsets.Right = 671.682800f;
	__Local__27->LayoutData.Offsets.Bottom = 190.160156f;
	__Local__27->LayoutData.Anchors.Minimum = FVector2D(0.500000, 0.000000);
	__Local__27->LayoutData.Anchors.Maximum = FVector2D(0.500000, 0.000000);
	__Local__27->Parent = __Local__15;
	auto __Local__28 = NewObject<UTextBlock>(__Local__7, TEXT("TextBlock_126"), (EObjectFlags)0x00280008);
	__Local__28->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[56307C5E43048D3FAE4CF08BF790A676]\", \"82D9CFC045D848B1C3375DB1E86B202F\", \"Die Again\")")	);
	__Local__28->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__28->Font.OutlineSettings.OutlineSize = 5;
	__Local__28->Font.TypefaceFontName = FName(TEXT("Regular"));
	__Local__28->Font.Size = 125;
	...
	auto __Local__30 = NewObject<UCanvasPanelSlot>(__Local__15, TEXT("CanvasPanelSlot_7"), (EObjectFlags)0x00280008);
	__Local__30->LayoutData.Offsets.Top = 114.000000f;
	__Local__30->LayoutData.Offsets.Right = 596.000000f;
	__Local__30->LayoutData.Offsets.Bottom = 642.000000f;
	...
	__Local__30->LayoutData.Alignment = FVector2D(0.500000, 0.500000);
	__Local__30->Parent = __Local__15;
	auto __Local__31 = NewObject<UVerticalBox>(__Local__7, TEXT("VerticalBox_273"), (EObjectFlags)0x00280008);
	...
	auto __Local__33 = NewObject<UVerticalBoxSlot>(__Local__31, TEXT("VerticalBoxSlot_21"), (EObjectFlags)0x00280008);
	__Local__33->Padding.Bottom = 25.000000f;
	__Local__33->Parent = __Local__31;
	auto __Local__34 = NewObject<UButton>(__Local__7, TEXT("Play_Button"), (EObjectFlags)0x00280008);
	...
	__Local__35 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__36 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	__Local__37 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__38 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__34), UPanelWidget::__PPO__Slots() )));
	__Local__38 = TArray<UPanelSlot*> ();
	__Local__38.Reserve(1);
	auto __Local__39 = NewObject<UButtonSlot>(__Local__34, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__39->Parent = __Local__34;
	auto __Local__40 = NewObject<UTextBlock>(__Local__7, TEXT("TextBlock_197"), (EObjectFlags)0x00280008);
	__Local__40->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[56307C5E43048D3FAE4CF08BF790A676]\", \"B54060B142379770B464DB9DB7026F24\", \"Play\")")	);
	__Local__40->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__40->Font.OutlineSettings.OutlineSize = 5;
	__Local__40->Font.TypefaceFontName = FName(TEXT("Regular"));
	__Local__40->Font.Size = 35;
	...
	auto& __Local__42 = (*(AccessPrivateProperty<FMargin >((__Local__40), UTextLayoutWidget::__PPO__Margin() )));
	__Local__42.Left = 10.000000f;
	__Local__42.Top = 10.000000f;
	__Local__42.Right = 10.000000f;
	__Local__42.Bottom = 10.000000f;
	...
	auto __Local__43 = NewObject<UVerticalBoxSlot>(__Local__31, TEXT("VerticalBoxSlot_22"), (EObjectFlags)0x00280008);
	__Local__43->Padding.Top = 25.000000f;
	__Local__43->Padding.Bottom = 25.000000f;
	__Local__43->Parent = __Local__31;
	auto __Local__44 = NewObject<UButton>(__Local__7, TEXT("ChangeLanguage_Button"), (EObjectFlags)0x00280008);
	__Local__44->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__45 = (*(AccessPrivateProperty<UObject* >(&(__Local__44->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__45 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__44->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__46 = (*(AccessPrivateProperty<UObject* >(&(__Local__44->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__46 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__44->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__47 = (*(AccessPrivateProperty<UObject* >(&(__Local__44->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__47 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto __Local__50 = NewObject<UTextBlock>(__Local__7, TEXT("TextBlock_280"), (EObjectFlags)0x00280008);
	__Local__50->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[56307C5E43048D3FAE4CF08BF790A676]\", \"0709587B485A1311019D118A2C52EE7E\", \"Change Language\")")	);
	__Local__50->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__50->Font.OutlineSettings.OutlineSize = 5;
	__Local__50->Font.TypefaceFontName = FName(TEXT("Regular"));
	__Local__50->Font.Size = 35;
	...
	auto& __Local__52 = (*(AccessPrivateProperty<FMargin >((__Local__50), UTextLayoutWidget::__PPO__Margin() )));
	__Local__52.Left = 10.000000f;
	__Local__52.Top = 10.000000f;
	__Local__52.Right = 10.000000f;
	__Local__52.Bottom = 10.000000f;
	...
	__Local__32.Add(__Local__43);
	auto __Local__53 = NewObject<UVerticalBoxSlot>(__Local__31, TEXT("VerticalBoxSlot_23"), (EObjectFlags)0x00280008);
	__Local__53->Padding.Top = 25.000000f;
	__Local__53->Padding.Bottom = 25.000000f;
	__Local__53->Parent = __Local__31;
	auto __Local__54 = NewObject<UButton>(__Local__7, TEXT("Graphics_Button"), (EObjectFlags)0x00280008);
	__Local__54->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__55 = (*(AccessPrivateProperty<UObject* >(&(__Local__54->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__55 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__54->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__56 = (*(AccessPrivateProperty<UObject* >(&(__Local__54->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__56 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__54->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__57 = (*(AccessPrivateProperty<UObject* >(&(__Local__54->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__57 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__58 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__54), UPanelWidget::__PPO__Slots() )));
	__Local__58 = TArray<UPanelSlot*> ();
	__Local__58.Reserve(1);
	auto __Local__59 = NewObject<UButtonSlot>(__Local__54, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__59->Parent = __Local__54;
	auto __Local__60 = NewObject<UTextBlock>(__Local__7, TEXT("TextBlock_335"), (EObjectFlags)0x00280008);
	__Local__60->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[56307C5E43048D3FAE4CF08BF790A676]\", \"ED81A5294D6348BB98347488305C4859\", \"Options\")")	);
	__Local__60->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__60->Font.OutlineSettings.OutlineSize = 5;
	__Local__60->Font.TypefaceFontName = FName(TEXT("Regular"));
	__Local__60->Font.Size = 35;
	...
	auto& __Local__62 = (*(AccessPrivateProperty<FMargin >((__Local__60), UTextLayoutWidget::__PPO__Margin() )));
	__Local__62.Left = 10.000000f;
	__Local__62.Top = 10.000000f;
	__Local__62.Right = 10.000000f;
	__Local__62.Bottom = 10.000000f;
	...
	__Local__32.Add(__Local__53);
	auto __Local__63 = NewObject<UVerticalBoxSlot>(__Local__31, TEXT("VerticalBoxSlot_24"), (EObjectFlags)0x00280008);
	__Local__63->Padding.Top = 25.000000f;
	__Local__63->Padding.Bottom = 25.000000f;
	__Local__63->Parent = __Local__31;
	auto __Local__64 = NewObject<UButton>(__Local__7, TEXT("FinalCredits_Button"), (EObjectFlags)0x00280008);
	__Local__64->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__65 = (*(AccessPrivateProperty<UObject* >(&(__Local__64->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__65 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__64->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__66 = (*(AccessPrivateProperty<UObject* >(&(__Local__64->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__66 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__64->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__67 = (*(AccessPrivateProperty<UObject* >(&(__Local__64->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__67 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__68 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__64), UPanelWidget::__PPO__Slots() )));
	__Local__68 = TArray<UPanelSlot*> ();
	__Local__68.Reserve(1);
	auto __Local__69 = NewObject<UButtonSlot>(__Local__64, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__69->Parent = __Local__64;
	auto __Local__70 = NewObject<UTextBlock>(__Local__7, TEXT("TextBlock_452"), (EObjectFlags)0x00280008);
	__Local__70->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[56307C5E43048D3FAE4CF08BF790A676]\", \"299D648744303191D052039B80E90F1F\", \"Final Credits\")")	);
	__Local__70->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__70->Font.OutlineSettings.OutlineSize = 5;
	__Local__70->Font.TypefaceFontName = FName(TEXT("Regular"));
	__Local__70->Font.Size = 35;
	...
	auto& __Local__72 = (*(AccessPrivateProperty<FMargin >((__Local__70), UTextLayoutWidget::__PPO__Margin() )));
	__Local__72.Left = 10.000000f;
	__Local__72.Top = 10.000000f;
	__Local__72.Right = 10.000000f;
	__Local__72.Bottom = 10.000000f;
	...
	__Local__32.Add(__Local__63);
	auto __Local__73 = NewObject<UVerticalBoxSlot>(__Local__31, TEXT("VerticalBoxSlot_25"), (EObjectFlags)0x00280008);
	__Local__73->Padding.Top = 25.000000f;
	__Local__73->Parent = __Local__31;
	auto __Local__74 = NewObject<UButton>(__Local__7, TEXT("CloseGame_Button"), (EObjectFlags)0x00280008);
	__Local__74->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__75 = (*(AccessPrivateProperty<UObject* >(&(__Local__74->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__75 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__74->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__76 = (*(AccessPrivateProperty<UObject* >(&(__Local__74->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__76 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__74->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__77 = (*(AccessPrivateProperty<UObject* >(&(__Local__74->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__77 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__78 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__74), UPanelWidget::__PPO__Slots() )));
	__Local__78 = TArray<UPanelSlot*> ();
	__Local__78.Reserve(1);
	auto __Local__79 = NewObject<UButtonSlot>(__Local__74, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__79->Parent = __Local__74;
	auto __Local__80 = NewObject<UTextBlock>(__Local__7, TEXT("TextBlock_505"), (EObjectFlags)0x00280008);
	__Local__80->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[56307C5E43048D3FAE4CF08BF790A676]\", \"D566BDDE4A80FBFF29A443A90333F260\", \"Close the game\")")	);
	__Local__80->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__80->Font.OutlineSettings.OutlineSize = 5;
	__Local__80->Font.TypefaceFontName = FName(TEXT("Regular"));
	__Local__80->Font.Size = 35;
	auto& __Local__81 = (*(AccessPrivateProperty<TEnumAsByte<ETextJustify::Type> >((__Local__80), UTextLayoutWidget::__PPO__Justification() )));
	__Local__81 = ETextJustify::Type::Center;
	auto& __Local__82 = (*(AccessPrivateProperty<FMargin >((__Local__80), UTextLayoutWidget::__PPO__Margin() )));
	__Local__82.Left = 10.000000f;
	__Local__82.Top = 10.000000f;
	__Local__82.Right = 10.000000f;
	__Local__82.Bottom = 10.000000f;
	...
	__Local__32.Add(__Local__73);
	__Local__31->Slot = __Local__30;
	auto __Local__83 = NewObject<UWidgetNavigation>(__Local__31, TEXT("WidgetNavigation_0"), (EObjectFlags)0x00280008);
	__Local__83->Up.Rule = EUINavigationRule::Stop;
	__Local__83->Down.Rule = EUINavigationRule::Stop;
	__Local__83->Right.Rule = EUINavigationRule::Explicit;
	__Local__83->Right.WidgetToFocus = FName(TEXT("ChangeAvatar_Button"));
	__Local__31->Navigation = __Local__83;
	__Local__30->Content = __Local__31;
	__Local__16.Add(__Local__30);
	__Local__7->RootWidget = __Local__15;
	auto __Local__84 = NewObject<UMovieScene>(__Local__8, TEXT("ChangeAvatarAnim"), (EObjectFlags)0x00280008);
	auto& __Local__85 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__84), UMovieScene::__PPO__Possessables() )));
	__Local__85 = TArray<FMovieScenePossessable> ();
	__Local__85.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__85.GetData(), 1);
	auto& __Local__86 = __Local__85[0];
	auto& __Local__87 = (*(AccessPrivateProperty<FGuid >(&(__Local__86), FMovieScenePossessable::__PPO__Guid() )));
	__Local__87 = FGuid(0x0A03E5EB, 0x4C8E4F9C, 0x7DE7FF96, 0x3015E3DD);
	auto& __Local__88 = (*(AccessPrivateProperty<FString >(&(__Local__86), FMovieScenePossessable::__PPO__Name() )));
	__Local__88 = FString(TEXT("TextBlock_630"));
	auto& __Local__89 = (*(AccessPrivateProperty<UClass* >(&(__Local__86), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__89 = UTextBlock::StaticClass();
	auto& __Local__90 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__84), UMovieScene::__PPO__ObjectBindings() )));
	__Local__90 = TArray<FMovieSceneBinding> ();
	__Local__90.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__90.GetData(), 1);
	auto& __Local__91 = __Local__90[0];
	auto& __Local__92 = (*(AccessPrivateProperty<FGuid >(&(__Local__91), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__92 = FGuid(0x0A03E5EB, 0x4C8E4F9C, 0x7DE7FF96, 0x3015E3DD);
	auto& __Local__93 = (*(AccessPrivateProperty<FString >(&(__Local__91), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__93 = FString(TEXT("TextBlock_630"));
	auto& __Local__94 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__91), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__94 = TArray<UMovieSceneTrack*> ();
	__Local__94.Reserve(1);
	auto __Local__95 = NewObject<UMovieScene2DTransformTrack>(__Local__84, TEXT("MovieScene2DTransformTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__96 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__95), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__96.PropertyName = FName(TEXT("RenderTransform"));
	__Local__96.PropertyPath = FName(TEXT("RenderTransform"));
	__Local__96.bCanUseClassLookup = true;
	auto& __Local__97 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__95), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__97 = TArray<UMovieSceneSection*> ();
	__Local__97.Reserve(1);
	auto __Local__98 = NewObject<UMovieScene2DTransformSection>(__Local__95, TEXT("MovieScene2DTransformSection_0"), (EObjectFlags)0x00280008);
	auto __Local__99 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__98->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__100 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__98->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__99)
	{
	...
	auto& __Local__101 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__98->Scale[0]), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__101 = TArray<FFrameNumber> ();
	__Local__101.Reserve(3);
	__Local__101.Add(FFrameNumber{});
	__Local__101.Add(FFrameNumber{});
	__Local__101[1].Value = 90000;
	__Local__101.Add(FFrameNumber{});
	__Local__101[2].Value = 180000;
	auto& __Local__102 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__98->Scale[0]), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__102 = TArray<FMovieSceneFloatValue> ();
	__Local__102.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__102.GetData(), 3);
	auto& __Local__103 = __Local__102[0];
	__Local__103.Value = 1.000000f;
	auto& __Local__104 = __Local__102[1];
	__Local__104.Value = 1.150000f;
	auto& __Local__105 = __Local__102[2];
	__Local__105.Value = 1.000000f;
	auto& __Local__106 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__98->Scale[1]), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__106 = TArray<FFrameNumber> ();
	__Local__106.Reserve(3);
	__Local__106.Add(FFrameNumber{});
	__Local__106.Add(FFrameNumber{});
	__Local__106[1].Value = 90000;
	__Local__106.Add(FFrameNumber{});
	__Local__106[2].Value = 180000;
	auto& __Local__107 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__98->Scale[1]), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__107 = TArray<FMovieSceneFloatValue> ();
	__Local__107.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__107.GetData(), 3);
	auto& __Local__108 = __Local__107[0];
	__Local__108.Value = 1.000000f;
	auto& __Local__109 = __Local__107[1];
	__Local__109.Value = 1.150000f;
	auto& __Local__110 = __Local__107[2];
	__Local__110.Value = 1.000000f;
	__Local__98->Easing.EaseIn = __Local__99;
	__Local__98->Easing.EaseOut = __Local__100;
	__Local__98->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(180000)));
	auto& __Local__111 = (*(AccessPrivateProperty<FGuid >((__Local__98), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__111 = FGuid(0xC5D2D761, 0x42FE555F, 0x46E2A581, 0xF6D605A5);
	__Local__97.Add(__Local__98);
	auto& __Local__112 = (*(AccessPrivateProperty<FGuid >((__Local__95), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__112 = FGuid(0x04B4CA87, 0x4EF6A8E9, 0xED0EAC89, 0xBCD16DBC);
	auto& __Local__113 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__95), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__113.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__113.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__113.Entries.GetData(), 1);
	auto& __Local__114 = __Local__113.Entries[0];
	__Local__114.Section = __Local__98;
	static TWeakFieldPtr<FProperty> __Local__116{};
	const FProperty* __Local__115 = __Local__116.Get();
	if (nullptr == __Local__115)
	{
		__Local__115 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("LowerBound")));
		check(__Local__115);
		__Local__116 = __Local__115;
	}
	auto& __Local__117 = (*(__Local__115->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__114.Range), 0)));
	static TWeakFieldPtr<FProperty> __Local__119{};
	const FProperty* __Local__118 = __Local__119.Get();
	if (nullptr == __Local__118)
	{
		__Local__118 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Type")));
		check(__Local__118);
		__Local__119 = __Local__118;
	}
	auto& __Local__120 = (*(__Local__118->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__117), 0)));
	__Local__120 = ERangeBoundTypes::Type::Inclusive;
	static TWeakFieldPtr<FProperty> __Local__122{};
	const FProperty* __Local__121 = __Local__122.Get();
	if (nullptr == __Local__121)
	{
		__Local__121 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("UpperBound")));
		check(__Local__121);
		__Local__122 = __Local__121;
	}
	auto& __Local__123 = (*(__Local__121->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__114.Range), 0)));
	auto& __Local__124 = (*(__Local__118->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__123), 0)));
	...
	{
		__Local__125 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Value")));
		check(__Local__125);
		__Local__126 = __Local__125;
	}
	auto& __Local__127 = (*(__Local__125->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__123), 0)));
	__Local__127.Value = 180000;
	__Local__114.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__128 = (*(AccessPrivateProperty<FGuid >((__Local__95), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__128 = FGuid(0x04B4CA87, 0x4EF6A8E9, 0xED0EAC89, 0xBCD16DBC);
	__Local__94.Add(__Local__95);
	auto& __Local__129 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__84), UMovieScene::__PPO__PlaybackRange() )));
	__Local__129 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(180001)));
	auto& __Local__130 = (*(AccessPrivateProperty<FFrameRate >((__Local__84), UMovieScene::__PPO__DisplayRate() )));
	...
	__Local__133 = 20;
	auto& __Local__134 = (*(AccessPrivateProperty<FGuid >((__Local__84), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__134 = FGuid(0xD9706D95, 0x49EF6559, 0x4A3EF397, 0x227CFA0F);
	__Local__8->MovieScene = __Local__84;
	...
	auto& __Local__135 = __Local__8->AnimationBindings[0];
	__Local__135.WidgetName = FName(TEXT("TextBlock_630"));
	__Local__135.AnimationGuid = FGuid(0x0A03E5EB, 0x4C8E4F9C, 0x7DE7FF96, 0x3015E3DD);
	auto& __Local__136 = (*(AccessPrivateProperty<FString >((__Local__8), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__136 = FString(TEXT("ChangeAvatarAnim"));
	__Local__8->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__137 = (*(AccessPrivateProperty<FGuid >((__Local__8), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__137 = FGuid(0x0211CFBD, 0x4802FE25, 0x427E70B9, 0xA2075A98);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__8);
}
PRAGMA_ENABLE_OPTIMIZATION
void UMainMenu_WB_C__pf1565531276::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__138;
	SlotNames.Append(__Local__138);
}
void UMainMenu_WB_C__pf1565531276::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__139;
	__Local__139.Reserve(1);
	__Local__139.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->MiscConvertedSubobjects[1]));
	TArray<FDelegateRuntimeBinding>  __Local__140;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->MiscConvertedSubobjects[0]), __Local__139, __Local__140);
}
void UMainMenu_WB_C__pf1565531276::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UMainMenu_WB_C__pf1565531276::bpf__ExecuteUbergraph_MainMenu_WB__pf_0(int32 bpp__EntryPoint__pf)
{
	AGameModeBase* bpfv__CallFunc_GetGameMode_ReturnValue_2__pf{};
	UOptionsHUD_C__pf3479267681* bpfv__CallFunc_Create_ReturnValue_2__pf{};
	check(bpp__EntryPoint__pf == 23);
	// optimized KCST_UnconditionalGoto
	RemoveFromParent();
	bpfv__CallFunc_Create_ReturnValue_2__pf = CastChecked<UOptionsHUD_C__pf3479267681>(UWidgetBlueprintLibrary::Create(this, UOptionsHUD_C__pf3479267681::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	...
	{
		b1l__K2Node_DynamicCast_AsDie_Again_Gamemode_2__pf->bpf__ResetWidget__pf(bpfv__CallFunc_Create_ReturnValue_2__pf);
	}
	...
	if(::IsValid(bpfv__CallFunc_Create_ReturnValue_2__pf))
	{
		bpfv__CallFunc_Create_ReturnValue_2__pf->bpv__ItsComingFromMainMenu__pf = true;
	}
	return; // KCST_GotoReturn
}
void UMainMenu_WB_C__pf1565531276::bpf__ExecuteUbergraph_MainMenu_WB__pf_1(int32 bpp__EntryPoint__pf)
{
	AGameModeBase* bpfv__CallFunc_GetGameMode_ReturnValue__pf{};
	ULanguageHUD_C__pf49154685* bpfv__CallFunc_Create_ReturnValue_1__pf{};
	check(bpp__EntryPoint__pf == 35);
	// optimized KCST_UnconditionalGoto
	RemoveFromParent();
	bpfv__CallFunc_Create_ReturnValue_1__pf = CastChecked<ULanguageHUD_C__pf49154685>(UWidgetBlueprintLibrary::Create(this, ULanguageHUD_C__pf49154685::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	// optimized KCST_UnconditionalGoto
	...
	b1l__K2Node_DynamicCast_bSuccess_1__pf = (b1l__K2Node_DynamicCast_AsDie_Again_Gamemode__pf != nullptr);;
	...
	{
		b1l__K2Node_DynamicCast_AsDie_Again_Gamemode__pf->bpf__ResetWidget__pf(bpfv__CallFunc_Create_ReturnValue_1__pf);
	}
...
void UMainMenu_WB_C__pf1565531276::bpf__ExecuteUbergraph_MainMenu_WB__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	b1l__K2Node_DynamicCast_bSuccess_2__pf = (b1l__K2Node_DynamicCast_AsMy_Game_Instance_1__pf != nullptr);;
	...
	{
		b1l__K2Node_DynamicCast_AsMy_Game_Instance_1__pf->bpf__LevelLoadingFunction__pf(FName(TEXT("CreditsScene")));
	}
	return; // KCST_GotoReturn
}
void UMainMenu_WB_C__pf1565531276::bpf__ExecuteUbergraph_MainMenu_WB__pf_3(int32 bpp__EntryPoint__pf)
{
	UChangeAvatarHUD_C__pf1376575910* bpfv__CallFunc_Create_ReturnValue__pf{};
	AGameModeBase* bpfv__CallFunc_GetGameMode_ReturnValue_1__pf{};
	check(bpp__EntryPoint__pf == 33);
	// optimized KCST_UnconditionalGoto
	RemoveFromParent();
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UChangeAvatarHUD_C__pf1376575910>(UWidgetBlueprintLibrary::Create(this, UChangeAvatarHUD_C__pf1376575910::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	...
	{
		b1l__K2Node_DynamicCast_AsDie_Again_Gamemode_1__pf->bpf__ResetWidget__pf(bpfv__CallFunc_Create_ReturnValue__pf);
	}
...
void UMainMenu_WB_C__pf1565531276::bpf__ExecuteUbergraph_MainMenu_WB__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	b1l__K2Node_MakeArray_Array__pf.SetNum(6, true);
	b1l__K2Node_MakeArray_Array__pf[0] = bpv__Play_Button__pf;
	b1l__K2Node_MakeArray_Array__pf[1] = bpv__ChangeLanguage_Button__pf;
	b1l__K2Node_MakeArray_Array__pf[2] = bpv__Graphics_Button__pf;
	b1l__K2Node_MakeArray_Array__pf[3] = bpv__FinalCredits_Button__pf;
	b1l__K2Node_MakeArray_Array__pf[4] = bpv__CloseGame_Button__pf;
	b1l__K2Node_MakeArray_Array__pf[5] = bpv__ChangeAvatar_Button__pf;
	bpv__Buttons__pf = b1l__K2Node_MakeArray_Array__pf;
	// optimized KCST_UnconditionalGoto
	Super::bpf__Construct__pf();
	bpfv__CallFunc_PlayAnimation_ReturnValue__pf = UUserWidget::PlayAnimation(bpv__ChangeAvatarAnim__pf, 0.000000, 0, EUMGSequencePlayMode::Forward, 1.000000, false);
	return; // KCST_GotoReturn
}
void UMainMenu_WB_C__pf1565531276::bpf__ExecuteUbergraph_MainMenu_WB__pf_5(int32 bpp__EntryPoint__pf)
{
	...
	{
		b1l__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpf__LevelLoadingFunction__pf(FName(TEXT("CheckSaveFile")));
	}
	return; // KCST_GotoReturn
}
void UMainMenu_WB_C__pf1565531276::bpf__ExecuteUbergraph_MainMenu_WB__pf_6(int32 bpp__EntryPoint__pf)
{
...
void UMainMenu_WB_C__pf1565531276::bpf__ExecuteUbergraph_MainMenu_WB__pf_7(int32 bpp__EntryPoint__pf)
{
...
void UMainMenu_WB_C__pf1565531276::bpf__BndEvt__Graphics_Button_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_MainMenu_WB__pf_0(23);
}
void UMainMenu_WB_C__pf1565531276::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_MainMenu_WB__pf_4(20);
}
void UMainMenu_WB_C__pf1565531276::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_MainMenu_WB__pf_7(13);
}
void UMainMenu_WB_C__pf1565531276::bpf__BndEvt__Play_Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_MainMenu_WB__pf_5(9);
}
void UMainMenu_WB_C__pf1565531276::bpf__BndEvt__CloseGame_Button_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_MainMenu_WB__pf_6(1);
}
void UMainMenu_WB_C__pf1565531276::bpf__BndEvt__ChangeAvatar_Button_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_MainMenu_WB__pf_3(33);
}
void UMainMenu_WB_C__pf1565531276::bpf__BndEvt__FinalCredits_Button_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_MainMenu_WB__pf_2(34);
}
void UMainMenu_WB_C__pf1565531276::bpf__BndEvt__ChangeLanguage_Button_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_MainMenu_WB__pf_1(35);
}
ESlateVisibility  UMainMenu_WB_C__pf1565531276::bpf__Get_ChangeAvatar_Button_Visibility_0__pf()
{
		...
		case 4:
			{
				...
				bool  __Local__141 = false;
				bool  __Local__142 = false;
				bpfv__CallFunc_BooleanOR_ReturnValue__pf = UKismetMathLibrary::BooleanOR(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__IsRobotUnlocked__pf) : (__Local__141)), ((::IsValid(bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__IsNorthernFrontActive__pf) : (__Local__142)));
...
FSlateBrush  UMainMenu_WB_C__pf1565531276::bpf__Get_ImagenFondo_Brush_0__pf()
{
	...
	do
	{
		...
		case 1:
			{
				const UScriptStruct* __Local__144 = FSlateBrush::StaticStruct();
				uint8* __Local__145 = (uint8*)FMemory_Alloca(__Local__144->GetStructureSize());
				__Local__144->InitializeStruct(__Local__145);
				FSlateBrush& __Local__143 = *reinterpret_cast<FSlateBrush*>(__Local__145);
				__Local__143.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__146 = (*(AccessPrivateProperty<UObject* >(&(__Local__143), FSlateBrush::__PPO__ResourceObject() )));
				__Local__146 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
				bpfv__Default_Slate__pf = __Local__143;
			}
		case 2:
			{
				const UScriptStruct* __Local__148 = FSlateBrush::StaticStruct();
				uint8* __Local__149 = (uint8*)FMemory_Alloca(__Local__148->GetStructureSize());
				__Local__148->InitializeStruct(__Local__149);
				FSlateBrush& __Local__147 = *reinterpret_cast<FSlateBrush*>(__Local__149);
				__Local__147.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__150 = (*(AccessPrivateProperty<UObject* >(&(__Local__147), FSlateBrush::__PPO__ResourceObject() )));
				__Local__150 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
				bpfv__LV3_Slate__pf = __Local__147;
			}
		case 3:
			{
				const UScriptStruct* __Local__152 = FSlateBrush::StaticStruct();
				uint8* __Local__153 = (uint8*)FMemory_Alloca(__Local__152->GetStructureSize());
				__Local__152->InitializeStruct(__Local__153);
				FSlateBrush& __Local__151 = *reinterpret_cast<FSlateBrush*>(__Local__153);
				__Local__151.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__154 = (*(AccessPrivateProperty<UObject* >(&(__Local__151), FSlateBrush::__PPO__ResourceObject() )));
				__Local__154 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
				bpfv__LV6_Slate__pf = __Local__151;
			}
		case 4:
			{
				const UScriptStruct* __Local__156 = FSlateBrush::StaticStruct();
				uint8* __Local__157 = (uint8*)FMemory_Alloca(__Local__156->GetStructureSize());
				__Local__156->InitializeStruct(__Local__157);
				FSlateBrush& __Local__155 = *reinterpret_cast<FSlateBrush*>(__Local__157);
				__Local__155.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__158 = (*(AccessPrivateProperty<UObject* >(&(__Local__155), FSlateBrush::__PPO__ResourceObject() )));
				__Local__158 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
				bpfv__LV8_Slate__pf = __Local__155;
			}
		case 5:
			{
				const UScriptStruct* __Local__160 = FSlateBrush::StaticStruct();
				uint8* __Local__161 = (uint8*)FMemory_Alloca(__Local__160->GetStructureSize());
				__Local__160->InitializeStruct(__Local__161);
				FSlateBrush& __Local__159 = *reinterpret_cast<FSlateBrush*>(__Local__161);
				__Local__159.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__162 = (*(AccessPrivateProperty<UObject* >(&(__Local__159), FSlateBrush::__PPO__ResourceObject() )));
				__Local__162 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
				bpfv__LV12_Slate__pf = __Local__159;
			}
		case 6:
			{
				const UScriptStruct* __Local__164 = FSlateBrush::StaticStruct();
				uint8* __Local__165 = (uint8*)FMemory_Alloca(__Local__164->GetStructureSize());
				__Local__164->InitializeStruct(__Local__165);
				FSlateBrush& __Local__163 = *reinterpret_cast<FSlateBrush*>(__Local__165);
				__Local__163.ImageSize = FVector2D(3840.000000, 2080.000000);
				auto& __Local__166 = (*(AccessPrivateProperty<UObject* >(&(__Local__163), FSlateBrush::__PPO__ResourceObject() )));
				__Local__166 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
				bpfv__Endgame_Slate__pf = __Local__163;
			}
		case 7:
			{
				const UScriptStruct* __Local__168 = FSlateBrush::StaticStruct();
				uint8* __Local__169 = (uint8*)FMemory_Alloca(__Local__168->GetStructureSize());
				__Local__168->InitializeStruct(__Local__169);
				FSlateBrush& __Local__167 = *reinterpret_cast<FSlateBrush*>(__Local__169);
				__Local__167.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__170 = (*(AccessPrivateProperty<UObject* >(&(__Local__167), FSlateBrush::__PPO__ResourceObject() )));
				__Local__170 = CastChecked<UObject>(CastChecked<UDynamicClass>(UMainMenu_WB_C__pf1565531276::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
				bpfv__FinalSlate__pf = __Local__167;
			}
		case 8:
			{
				bpfv__CallFunc_LoadGameFromSlot_ReturnValue__pf = UGameplayStatics::LoadGameFromSlot(FString(TEXT("Save_File")), 0);
		...
		case 10:
			{
				int32  __Local__171 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__171)), 0);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				}
				int32  __Local__172 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__172)), 1);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				}
				int32  __Local__173 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__173)), 2);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				}
				int32  __Local__174 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__174)), 3);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				}
				int32  __Local__175 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__175)), 4);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				}
				int32  __Local__176 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__176)), 5);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				}
				int32  __Local__177 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__177)), 6);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				}
				int32  __Local__178 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__178)), 7);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 15;
					break;
				}
				int32  __Local__179 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__179)), 8);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 15;
					break;
				}
				int32  __Local__180 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__180)), 9);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				}
				int32  __Local__181 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__181)), 10);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				}
				int32  __Local__182 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__182)), 11);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				}
				int32  __Local__183 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__183)), 12);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				}
				int32  __Local__184 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__184)), 13);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 17;
					break;
				}
				int32  __Local__185 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__185)), 14);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				}
				int32  __Local__186 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__186)), 15);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				}
				int32  __Local__187 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__187)), 16);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				}
				int32  __Local__188 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__LevelsUnlocked_Save__pf) : (__Local__188)), 17);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
...
PRAGMA_DISABLE_OPTIMIZATION
void UMainMenu_WB_C__pf1565531276::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UMainMenu_WB_C__pf1565531276::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{401, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.VerticalBoxSlot 
		...
		{405, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.VerticalBox 
		...
		{729, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/ChangeAvatar/ChangeAvatarHUD.ChangeAvatarHUD_C 
		{730, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/LanguageHUD/LanguageHUD.LanguageHUD_C 
		{683, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/ControlsWB/OptionsHUD.OptionsHUD_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UMainMenu_WB_C__pf1565531276
{
	FRegisterHelper__UMainMenu_WB_C__pf1565531276()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/MainMenu/MainMenu_WB"), &UMainMenu_WB_C__pf1565531276::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UMainMenu_WB_C__pf1565531276 Instance;
};
FRegisterHelper__UMainMenu_WB_C__pf1565531276 FRegisterHelper__UMainMenu_WB_C__pf1565531276::Instance;
