...
class AActor;
#include "PlayerStopDance__pf3264546738.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Conversations/Events/PlayerStopDance.PlayerStopDance_C", OverrideNativeName="PlayerStopDance_C"))
class UPlayerStopDance_C__pf3264546738 : public UDialogueEvents
{
public:
	GENERATED_BODY()
	...
	UPlayerStopDance_C__pf3264546738(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_PlayerStopDance__pf_0(int32 bpp__EntryPoint__pf);
