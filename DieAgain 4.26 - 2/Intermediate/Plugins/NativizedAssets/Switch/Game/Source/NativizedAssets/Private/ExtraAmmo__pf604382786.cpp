...
#include "ExtraAmmo__pf604382786.h"
...
AExtraAmmo_C__pf604382786::AExtraAmmo_C__pf604382786(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AExtraAmmo_C__pf604382786::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
void AExtraAmmo_C__pf604382786::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AExtraAmmo_C__pf604382786::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__6.FunctionNameToBind = FName(TEXT("BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AExtraAmmo_C__pf604382786::bpf__ExecuteUbergraph_ExtraAmmo__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 38:
			{
				b0l__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(b0l__CallFunc_CacheAchievements_ReturnValue__pf);
		...
		case 39:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("OnSuccess_BA76C1DD4D7B0996A4F287A6287A02DA")));
				if(::IsValid(b0l__CallFunc_CacheAchievements_ReturnValue__pf))
				{
					b0l__CallFunc_CacheAchievements_ReturnValue__pf->OnSuccess.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate__pf);
				}
			}
		case 40:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate_7__pf.BindUFunction(this,FName(TEXT("OnFailure_BA76C1DD4D7B0996A4F287A6287A02DA")));
				if(::IsValid(b0l__CallFunc_CacheAchievements_ReturnValue__pf))
				{
					b0l__CallFunc_CacheAchievements_ReturnValue__pf->OnFailure.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate_7__pf);
				}
			}
		case 41:
			{
		...
		case 44:
			{
				b0l__CallFunc_IsValid_ReturnValue_3__pf = UKismetSystemLibrary::IsValid(b0l__CallFunc_CacheAchievements_ReturnValue_1__pf);
		...
		case 45:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate_4__pf.BindUFunction(this,FName(TEXT("OnSuccess_5D8AE760431ADD79A6D2438BC003A426")));
				if(::IsValid(b0l__CallFunc_CacheAchievements_ReturnValue_1__pf))
				{
					b0l__CallFunc_CacheAchievements_ReturnValue_1__pf->OnSuccess.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate_4__pf);
				}
			}
		case 46:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate_3__pf.BindUFunction(this,FName(TEXT("OnFailure_5D8AE760431ADD79A6D2438BC003A426")));
				if(::IsValid(b0l__CallFunc_CacheAchievements_ReturnValue_1__pf))
				{
					b0l__CallFunc_CacheAchievements_ReturnValue_1__pf->OnFailure.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate_3__pf);
				}
			}
		case 47:
			{
...
void AExtraAmmo_C__pf604382786::bpf__ExecuteUbergraph_ExtraAmmo__pf_1(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue_1__pf{};
	check(bpp__EntryPoint__pf == 17);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_GetPlayerController_ReturnValue_1__pf = UGameplayStatics::GetPlayerController(this, 0);
	b0l__CallFunc_WriteAchievementProgress_ReturnValue_1__pf = UAchievementWriteCallbackProxy::WriteAchievementProgress(this, bpfv__CallFunc_GetPlayerController_ReturnValue_1__pf, FName(TEXT("ACH_SHOTGUN")), 100.000000, 0);
	b0l__CallFunc_IsValid_ReturnValue_2__pf = UKismetSystemLibrary::IsValid(b0l__CallFunc_WriteAchievementProgress_ReturnValue_1__pf);
	if (!b0l__CallFunc_IsValid_ReturnValue_2__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	b0l__K2Node_CreateDelegate_OutputDelegate_6__pf.BindUFunction(this,FName(TEXT("OnSuccess_03FB607343524F3AC906ED93A50FA711")));
	if(::IsValid(b0l__CallFunc_WriteAchievementProgress_ReturnValue_1__pf))
	{
		b0l__CallFunc_WriteAchievementProgress_ReturnValue_1__pf->OnSuccess.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate_6__pf);
	}
	b0l__K2Node_CreateDelegate_OutputDelegate_5__pf.BindUFunction(this,FName(TEXT("OnFailure_03FB607343524F3AC906ED93A50FA711")));
	if(::IsValid(b0l__CallFunc_WriteAchievementProgress_ReturnValue_1__pf))
	{
		b0l__CallFunc_WriteAchievementProgress_ReturnValue_1__pf->OnFailure.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate_5__pf);
	}
	if(::IsValid(b0l__CallFunc_WriteAchievementProgress_ReturnValue_1__pf))
	{
...
void AExtraAmmo_C__pf604382786::bpf__ExecuteUbergraph_ExtraAmmo__pf_2(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
	b0l__CallFunc_WriteAchievementProgress_ReturnValue__pf = UAchievementWriteCallbackProxy::WriteAchievementProgress(this, bpfv__CallFunc_GetPlayerController_ReturnValue__pf, FName(TEXT("ACH_RIFLE")), 100.000000, 0);
	b0l__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(b0l__CallFunc_WriteAchievementProgress_ReturnValue__pf);
	if (!b0l__CallFunc_IsValid_ReturnValue_1__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	b0l__K2Node_CreateDelegate_OutputDelegate_2__pf.BindUFunction(this,FName(TEXT("OnSuccess_5C416D0C4CEC75953C3C53B48F45D974")));
	if(::IsValid(b0l__CallFunc_WriteAchievementProgress_ReturnValue__pf))
	{
		b0l__CallFunc_WriteAchievementProgress_ReturnValue__pf->OnSuccess.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate_2__pf);
	}
	b0l__K2Node_CreateDelegate_OutputDelegate_1__pf.BindUFunction(this,FName(TEXT("OnFailure_5C416D0C4CEC75953C3C53B48F45D974")));
	if(::IsValid(b0l__CallFunc_WriteAchievementProgress_ReturnValue__pf))
	{
		b0l__CallFunc_WriteAchievementProgress_ReturnValue__pf->OnFailure.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate_1__pf);
	}
	if(::IsValid(b0l__CallFunc_WriteAchievementProgress_ReturnValue__pf))
	{
...
void AExtraAmmo_C__pf604382786::bpf__ExecuteUbergraph_ExtraAmmo__pf_3(int32 bpp__EntryPoint__pf)
{
		...
		case 61:
			{
				...
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue_1__pf = bpv__StaticMesh__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AExtraAmmo_C__pf604382786::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
			}
		case 62:
			{
				if(::IsValid(bpv__StaticMesh__pf))
				{
					bpv__StaticMesh__pf->USceneComponent::SetRelativeScale3D(FVector(5.000000,5.000000,5.000000));
				}
				__CurrentState = -1;
				break;
			}
		...
		case 64:
			{
				if(::IsValid(bpv__StaticMesh__pf))
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue__pf = bpv__StaticMesh__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AExtraAmmo_C__pf604382786::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
				}
			}
		case 65:
			{
		...
		case 66:
			{
				if(::IsValid(bpv__StaticMesh__pf))
				{
					bpv__StaticMesh__pf->USceneComponent::K2_SetRelativeRotation(FRotator(0.000000,0.000000,0.000000), false, /*out*/ b0l__CallFunc_K2_SetRelativeRotation_SweepHitResult__pf, false);
				}
				__CurrentState = -1;
				break;
			}
...
void AExtraAmmo_C__pf604382786::bpf__ExecuteUbergraph_ExtraAmmo__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 67);
	return; //KCST_EndOfThread
}
void AExtraAmmo_C__pf604382786::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	typedef FHitResult  T__Local__7;
	T__Local__7& bpp__SweepResult__pf = *const_cast<T__Local__7 *>(&bpp__SweepResult__pf__const);
	...
	bpf__ExecuteUbergraph_ExtraAmmo__pf_0(68);
}
void AExtraAmmo_C__pf604382786::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_ExtraAmmo__pf_4(67);
}
void AExtraAmmo_C__pf604382786::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_ExtraAmmo__pf_3(59);
}
void AExtraAmmo_C__pf604382786::bpf__OnSuccess_03FB607343524F3AC906ED93A50FA711__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf)
{
	...
	bpf__ExecuteUbergraph_ExtraAmmo__pf_0(27);
}
void AExtraAmmo_C__pf604382786::bpf__OnFailure_03FB607343524F3AC906ED93A50FA711__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf)
{
	...
	bpf__ExecuteUbergraph_ExtraAmmo__pf_0(23);
}
void AExtraAmmo_C__pf604382786::bpf__OnSuccess_5D8AE760431ADD79A6D2438BC003A426__pf()
{
	bpf__ExecuteUbergraph_ExtraAmmo__pf_1(17);
}
void AExtraAmmo_C__pf604382786::bpf__OnFailure_5D8AE760431ADD79A6D2438BC003A426__pf()
{
	bpf__ExecuteUbergraph_ExtraAmmo__pf_0(16);
}
void AExtraAmmo_C__pf604382786::bpf__OnSuccess_5C416D0C4CEC75953C3C53B48F45D974__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf)
{
	...
	bpf__ExecuteUbergraph_ExtraAmmo__pf_0(12);
}
void AExtraAmmo_C__pf604382786::bpf__OnFailure_5C416D0C4CEC75953C3C53B48F45D974__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf)
{
	...
	bpf__ExecuteUbergraph_ExtraAmmo__pf_0(7);
}
void AExtraAmmo_C__pf604382786::bpf__OnSuccess_BA76C1DD4D7B0996A4F287A6287A02DA__pf()
{
	bpf__ExecuteUbergraph_ExtraAmmo__pf_2(1);
}
void AExtraAmmo_C__pf604382786::bpf__OnFailure_BA76C1DD4D7B0996A4F287A6287A02DA__pf()
{
	bpf__ExecuteUbergraph_ExtraAmmo__pf_0(73);
}
void AExtraAmmo_C__pf604382786::bpf__ExtraAmmoFunction__pf()
{
		...
		case 9:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsLevel_Completer_BP_1__pf->bpv__ExtraAmmoRifle__pf = true;
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 18:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsLevel_Completer_BP__pf->bpv__ExtraAmmoShotgun__pf = true;
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
PRAGMA_DISABLE_OPTIMIZATION
void AExtraAmmo_C__pf604382786::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AExtraAmmo_C__pf604382786::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AExtraAmmo_C__pf604382786
{
	FRegisterHelper__AExtraAmmo_C__pf604382786()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/PremiumObjects/ExtraAmmo"), &AExtraAmmo_C__pf604382786::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AExtraAmmo_C__pf604382786 Instance;
};
FRegisterHelper__AExtraAmmo_C__pf604382786 FRegisterHelper__AExtraAmmo_C__pf604382786::Instance;
