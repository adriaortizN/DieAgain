...
#include "ControlsGamepadHUD__pf3479267681.h"
...
#include "ControlsKeyboardHUD__pf3479267681.h"
...
UPreControlsHUD_C__pf3479267681::UPreControlsHUD_C__pf3479267681(const FObjectInitializer& ObjectInitializer) : Super()
{
...
void UPreControlsHUD_C__pf3479267681::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UPreControlsHUD_C__pf3479267681::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UControlsGamepadHUD_C__pf3479267681::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UOptionsHUD_C__pf3479267681::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UControlsKeyboardHUD_C__pf3479267681::StaticClass());
	...
	__Local__3.ComponentPropertyName = FName(TEXT("Exit_Button"));
	__Local__3.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__Exit_Button_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__7->LayoutData.Offsets.Top = -200.000000f;
	__Local__7->LayoutData.Offsets.Right = 600.000000f;
	__Local__7->LayoutData.Offsets.Bottom = 100.000000f;
	...
	auto __Local__8 = NewObject<UButton>(__Local__1, TEXT("Controls_Button"), (EObjectFlags)0x00280008);
	__Local__8->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__9 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__8->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__9 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__10 = (*(AccessPrivateProperty<UObject* >(&(__Local__8->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__10 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__8->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__11 = (*(AccessPrivateProperty<UObject* >(&(__Local__8->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__11 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__8->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__12 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__8->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__12 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__13 = (*(AccessPrivateProperty<UObject* >(&(__Local__8->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__13 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__14 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__8), UPanelWidget::__PPO__Slots() )));
	__Local__14 = TArray<UPanelSlot*> ();
	__Local__14.Reserve(1);
	auto __Local__15 = NewObject<UButtonSlot>(__Local__8, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__15->Parent = __Local__8;
	auto __Local__16 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_105"), (EObjectFlags)0x00280008);
	__Local__16->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3890F73342BAA5AA8179B08CA0B999DA]\", \"7AF3F27149A0EDB4268EE29059314DD8\", \"Keyboard\")")	);
	auto& __Local__17 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__16->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__17 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__16->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__16->Font.OutlineSettings.OutlineSize = 5;
	__Local__16->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__16->Font.Size = 40;
	...
	auto __Local__19 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_13"), (EObjectFlags)0x00280008);
	__Local__19->LayoutData.Offsets.Left = -300.000000f;
	__Local__19->LayoutData.Offsets.Top = 280.000000f;
	__Local__19->LayoutData.Offsets.Right = 600.000000f;
	__Local__19->LayoutData.Offsets.Bottom = 100.000000f;
	...
	auto __Local__20 = NewObject<UButton>(__Local__1, TEXT("Exit_Button"), (EObjectFlags)0x00280008);
	__Local__20->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	...
	__Local__21 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__22 = (*(AccessPrivateProperty<UObject* >(&(__Local__20->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__22 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__20->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__23 = (*(AccessPrivateProperty<UObject* >(&(__Local__20->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__23 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__20->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	...
	__Local__24 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__25 = (*(AccessPrivateProperty<UObject* >(&(__Local__20->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__25 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__26 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__20), UPanelWidget::__PPO__Slots() )));
	__Local__26 = TArray<UPanelSlot*> ();
	__Local__26.Reserve(1);
	auto __Local__27 = NewObject<UButtonSlot>(__Local__20, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__27->Parent = __Local__20;
	auto __Local__28 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_3"), (EObjectFlags)0x00280008);
	__Local__28->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3890F73342BAA5AA8179B08CA0B999DA]\", \"C037397E42C21E114761D0BB784530BC\", \"Go  back\")")	);
	...
	__Local__28->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	auto __Local__31 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_0"), (EObjectFlags)0x00280008);
	__Local__31->LayoutData.Offsets.Left = -300.960938f;
	__Local__31->LayoutData.Offsets.Top = 40.000000f;
	__Local__31->LayoutData.Offsets.Right = 600.000000f;
	__Local__31->LayoutData.Offsets.Bottom = 100.000000f;
	...
	auto __Local__32 = NewObject<UButton>(__Local__1, TEXT("Area_Button"), (EObjectFlags)0x00280008);
	__Local__32->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__33 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__32->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__33 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__34 = (*(AccessPrivateProperty<UObject* >(&(__Local__32->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__34 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__32->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__35 = (*(AccessPrivateProperty<UObject* >(&(__Local__32->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__35 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__32->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__36 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__32->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__36 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__37 = (*(AccessPrivateProperty<UObject* >(&(__Local__32->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__37 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__38 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__32), UPanelWidget::__PPO__Slots() )));
	__Local__38 = TArray<UPanelSlot*> ();
	__Local__38.Reserve(1);
	auto __Local__39 = NewObject<UButtonSlot>(__Local__32, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__39->Parent = __Local__32;
	auto __Local__40 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock"), (EObjectFlags)0x00280008);
	__Local__40->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3890F73342BAA5AA8179B08CA0B999DA]\", \"1A99376A44A108225B5101B0BD68603D\", \"Gamepad\")")	);
	...
	__Local__40->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	auto& __Local__42 = (*(AccessPrivateProperty<TEnumAsByte<ETextJustify::Type> >((__Local__40), UTextLayoutWidget::__PPO__Justification() )));
	...
	auto __Local__43 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_5"), (EObjectFlags)0x00280008);
	__Local__43->LayoutData.Offsets.Left = -180.960938f;
	__Local__43->LayoutData.Offsets.Top = 100.000000f;
	__Local__43->LayoutData.Offsets.Right = 375.831329f;
	__Local__43->LayoutData.Offsets.Bottom = 96.733406f;
	__Local__43->LayoutData.Anchors.Minimum = FVector2D(0.500000, 0.000000);
	__Local__43->LayoutData.Anchors.Maximum = FVector2D(0.500000, 0.000000);
	__Local__43->Parent = __Local__5;
	auto __Local__44 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_65"), (EObjectFlags)0x00280008);
	__Local__44->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3890F73342BAA5AA8179B08CA0B999DA]\", \"5535BEF4485E33D53BDB539FF16918CB\", \"Controls\")")	);
	__Local__44->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__44->Font.OutlineSettings.OutlineSize = 5;
	__Local__44->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__44->Font.Size = 60;
...
PRAGMA_ENABLE_OPTIMIZATION
void UPreControlsHUD_C__pf3479267681::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__46;
	SlotNames.Append(__Local__46);
}
void UPreControlsHUD_C__pf3479267681::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__47;
	TArray<FDelegateRuntimeBinding>  __Local__48;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UPreControlsHUD_C__pf3479267681::StaticClass())->MiscConvertedSubobjects[0]), __Local__47, __Local__48);
}
void UPreControlsHUD_C__pf3479267681::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UPreControlsHUD_C__pf3479267681::bpf__ExecuteUbergraph_PreControlsHUD__pf_0(int32 bpp__EntryPoint__pf)
{
	AGameModeBase* bpfv__CallFunc_GetGameMode_ReturnValue__pf{};
	UOptionsHUD_C__pf3479267681* bpfv__CallFunc_Create_ReturnValue_1__pf{};
	check(bpp__EntryPoint__pf == 23);
	// optimized KCST_UnconditionalGoto
	RemoveFromParent();
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Create_ReturnValue_1__pf = CastChecked<UOptionsHUD_C__pf3479267681>(UWidgetBlueprintLibrary::Create(this, UOptionsHUD_C__pf3479267681::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	// optimized KCST_UnconditionalGoto
...
void UPreControlsHUD_C__pf3479267681::bpf__ExecuteUbergraph_PreControlsHUD__pf_1(int32 bpp__EntryPoint__pf)
{
	UControlsGamepadHUD_C__pf3479267681* bpfv__CallFunc_Create_ReturnValue__pf{};
	AGameModeBase* bpfv__CallFunc_GetGameMode_ReturnValue_2__pf{};
	check(bpp__EntryPoint__pf == 26);
	// optimized KCST_UnconditionalGoto
	RemoveFromParent();
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UControlsGamepadHUD_C__pf3479267681>(UWidgetBlueprintLibrary::Create(this, UControlsGamepadHUD_C__pf3479267681::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	...
	b1l__K2Node_DynamicCast_bSuccess_2__pf = (b1l__K2Node_DynamicCast_AsDie_Again_Gamemode_2__pf != nullptr);;
...
void UPreControlsHUD_C__pf3479267681::bpf__ExecuteUbergraph_PreControlsHUD__pf_2(int32 bpp__EntryPoint__pf)
{
	UControlsKeyboardHUD_C__pf3479267681* bpfv__CallFunc_Create_ReturnValue_2__pf{};
	AGameModeBase* bpfv__CallFunc_GetGameMode_ReturnValue_1__pf{};
	check(bpp__EntryPoint__pf == 15);
	// optimized KCST_UnconditionalGoto
	RemoveFromParent();
	bpfv__CallFunc_Create_ReturnValue_2__pf = CastChecked<UControlsKeyboardHUD_C__pf3479267681>(UWidgetBlueprintLibrary::Create(this, UControlsKeyboardHUD_C__pf3479267681::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	...
	b1l__K2Node_DynamicCast_bSuccess_1__pf = (b1l__K2Node_DynamicCast_AsDie_Again_Gamemode_1__pf != nullptr);;
...
void UPreControlsHUD_C__pf3479267681::bpf__ExecuteUbergraph_PreControlsHUD__pf_3(int32 bpp__EntryPoint__pf)
{
...
void UPreControlsHUD_C__pf3479267681::bpf__ExecuteUbergraph_PreControlsHUD__pf_4(int32 bpp__EntryPoint__pf)
{
...
void UPreControlsHUD_C__pf3479267681::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_PreControlsHUD__pf_3(8);
}
void UPreControlsHUD_C__pf3479267681::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_PreControlsHUD__pf_4(6);
}
void UPreControlsHUD_C__pf3479267681::bpf__BndEvt__Button_44_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PreControlsHUD__pf_2(15);
}
void UPreControlsHUD_C__pf3479267681::bpf__BndEvt__Exit_Button_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PreControlsHUD__pf_0(23);
}
void UPreControlsHUD_C__pf3479267681::bpf__BndEvt__Area_Button_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PreControlsHUD__pf_1(26);
}
FText  UPreControlsHUD_C__pf3479267681::bpf__GetText_AreaVisible__pf()
{
		...
		case 2:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__AreaVisible__pf) : (__Local__49)))
				{
					__CurrentState = 5;
					break;
				}
...
TEXT("NSLOCTEXT(\"[3890F73342BAA5AA8179B08CA0B999DA]\", \"90EB98BC468BB04F6FD51181ABA4ED64\", \" AREA VISIBLE ON\")")	);
			}
		case 4:
			{
		...
		case 5:
			{
				bpv__TextAreaVisible__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3890F73342BAA5AA8179B08CA0B999DA]\", \"24E1E5104D9C9AC50C8CD9A4F010510E\", \"AREA VISIBLE OFF\")")	);
				__CurrentState = 4;
				break;
			}
		default:
...
void UPreControlsHUD_C__pf3479267681::bpf__SetVisibilityPlayerArea__pf(bool bpp__Visibility__pf)
{
...
void UPreControlsHUD_C__pf3479267681::bpf__GetText_0__pf()
{
	FText bpfv__TextControlsTips__pf{};
}
void UPreControlsHUD_C__pf3479267681::bpf__GetText_1__pf()
{
	FText bpfv__TextControls__pf{};
}
void UPreControlsHUD_C__pf3479267681::bpf__GetText_2__pf()
{
	FText bpfv__TextTips__pf{};
}
void UPreControlsHUD_C__pf3479267681::bpf__GetText_3__pf()
{
	FText bpfv__TextGoBack__pf{};
}
FEventReply  UPreControlsHUD_C__pf3479267681::bpf__OnMouseButtonDown_0__pf(FGeometry bpp__MyGeometry__pf, FPointerEvent const& bpp__MouseEvent__pf__const)
{
	typedef FPointerEvent  T__Local__50;
	T__Local__50& bpp__MouseEvent__pf = *const_cast<T__Local__50 *>(&bpp__MouseEvent__pf__const);
...
FText  UPreControlsHUD_C__pf3479267681::bpf__GetText_4__pf()
{
	FText bpp__ReturnValue__pf{};
	UGameInstance* bpfv__CallFunc_GetGameInstance_ReturnValue__pf{};
	UMyGameInstance_C__pf2410127383* bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf{};
	...
	do
	{
		...
		case 2:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__AreaVisible__pf) : (__Local__51)))
				{
					__CurrentState = 5;
					break;
				}
		...
		case 3:
			{
				bpv__TextAreaVisible__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3890F73342BAA5AA8179B08CA0B999DA]\", \"4CA8B6194F32E4DAB0312C9399193B71\", \" AREA VISIBLE ON\")")	);
			}
		case 4:
			{
				bpp__ReturnValue__pf = bpv__TextAreaVisible__pf;
		...
		case 5:
			{
				bpv__TextAreaVisible__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3890F73342BAA5AA8179B08CA0B999DA]\", \"73CE756440ED7DB04A07F380D4FC1713\", \"AREA VISIBLE OFF\")")	);
				__CurrentState = 4;
				break;
			}
		default:
...
PRAGMA_DISABLE_OPTIMIZATION
void UPreControlsHUD_C__pf3479267681::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UPreControlsHUD_C__pf3479267681::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{724, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/ControlsWB/ControlsGamepadHUD.ControlsGamepadHUD_C 
		...
		{725, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/ControlsWB/ControlsKeyboardHUD.ControlsKeyboardHUD_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UPreControlsHUD_C__pf3479267681
{
	FRegisterHelper__UPreControlsHUD_C__pf3479267681()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/ControlsWB/PreControlsHUD"), &UPreControlsHUD_C__pf3479267681::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UPreControlsHUD_C__pf3479267681 Instance;
};
FRegisterHelper__UPreControlsHUD_C__pf3479267681 FRegisterHelper__UPreControlsHUD_C__pf3479267681::Instance;
