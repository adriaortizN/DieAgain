...
#include "AvatarPose_Answers__pf2345688672.h"
...
AAvatarPose_Answers_C__pf2345688672::AAvatarPose_Answers_C__pf2345688672(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__SkeletalMesh__pf->AnimationData.AnimToPlay = CastChecked<UAnimationAsset>(CastChecked<UDynamicClass>(AAvatarPose_Answers_C__pf2345688672::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__SkeletalMesh__pf->AnimationData.bSavedLooping = false;
	bpv__SkeletalMesh__pf->AnimationData.bSavedPlaying = false;
	bpv__SkeletalMesh__pf->AnimationData.SavedPosition = 2.000000f;
	...
	bpv__SkeletalMesh__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(AAvatarPose_Answers_C__pf2345688672::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	__Local__3 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AAvatarPose_Answers_C__pf2345688672::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__Mask_SM__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__4 = FVector(7.436653, -53.715214, 47.498375);
	auto& __Local__5 = (*(AccessPrivateProperty<FRotator >((bpv__Mask_SM__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__5 = FRotator(-0.713951, -4.048070, -101.310890);
	...
	__Local__6 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AAvatarPose_Answers_C__pf2345688672::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__Knife__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__7 = FVector(0.286418, -167.863022, 38.810787);
	auto& __Local__8 = (*(AccessPrivateProperty<FRotator >((bpv__Knife__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__8 = FRotator(-10.002769, 49.220917, 32.986687);
	...
	auto& __Local__10 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Rifle__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__10 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AAvatarPose_Answers_C__pf2345688672::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	auto& __Local__11 = (*(AccessPrivateProperty<FVector >((bpv__Rifle__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__11 = FVector(-66.951530, -154.753021, 11.424651);
	auto& __Local__12 = (*(AccessPrivateProperty<FRotator >((bpv__Rifle__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__12 = FRotator(62.842987, 47.153774, 361.175934);
...
void AAvatarPose_Answers_C__pf2345688672::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AAvatarPose_Answers_C__pf2345688672::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AAvatarPose_Answers_C__pf2345688672::bpf__ExecuteUbergraph_AvatarPose_Answers__pf_0(int32 bpp__EntryPoint__pf)
{
		...
		case 4:
			{
				...
				{
					bpv__Rifle__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(-59.290321,-158.132919,13.394991), FRotator(62.842987,47.153805,356.175934), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult_2__pf, true);
				}
			}
		case 5:
			{
				...
				{
					bpv__Knife__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(2.336302,-157.848724,37.580990), FRotator(-10.002769,49.220917,32.986687), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult__pf, true);
				}
				__CurrentState = -1;
				break;
			}
		...
		case 7:
			{
				...
				{
					bpv__SkeletalMesh__pf->SetSkeletalMesh(CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(AAvatarPose_Answers_C__pf2345688672::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed), false);
				}
			}
		case 8:
			{
				if(::IsValid(bpv__SkeletalMesh__pf))
				{
					bpv__SkeletalMesh__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AAvatarPose_Answers_C__pf2345688672::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed));
				}
			}
		case 9:
			{
				if(::IsValid(bpv__Rifle__pf))
				{
					bpv__Rifle__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(-66.951530,-154.753021,11.424651), FRotator(62.842987,47.153774,361.175934), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult_3__pf, true);
				}
			}
		case 10:
			{
				if(::IsValid(bpv__Knife__pf))
				{
					bpv__Knife__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(0.286418,-167.863022,38.810787), FRotator(-10.002769,49.220917,32.986687), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult_1__pf, true);
				}
				__CurrentState = -1;
				break;
			}
...
void AAvatarPose_Answers_C__pf2345688672::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_AvatarPose_Answers__pf_0(16);
}
PRAGMA_DISABLE_OPTIMIZATION
void AAvatarPose_Answers_C__pf2345688672::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{1097, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  AnimSequence /Game/Post_Apoca_Character/AnimDemoScene/Animations/Death_2.Death_2 
		...
		{1098, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/FPS_Weapon_Bundle/Weapons/Meshes/AR4/SM_AR4.SM_AR4 
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AAvatarPose_Answers_C__pf2345688672::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AAvatarPose_Answers_C__pf2345688672
{
	FRegisterHelper__AAvatarPose_Answers_C__pf2345688672()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/AvatarPose/AvatarPose_Answers"), &AAvatarPose_Answers_C__pf2345688672::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AAvatarPose_Answers_C__pf2345688672 Instance;
};
FRegisterHelper__AAvatarPose_Answers_C__pf2345688672 FRegisterHelper__AAvatarPose_Answers_C__pf2345688672::Instance;
