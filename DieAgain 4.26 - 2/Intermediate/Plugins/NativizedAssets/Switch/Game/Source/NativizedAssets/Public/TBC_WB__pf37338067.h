...
#include "TBC_WB__pf37338067.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/HUD/TBC/TBC_WB.TBC_WB_C", OverrideNativeName="TBC_WB_C"))
class UTBC_WB_C__pf37338067 : public UUserWidget
{
public:
	GENERATED_BODY()
	...
	UTBC_WB_C__pf37338067(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_TBC_WB_0"))
	void bpf__ExecuteUbergraph_TBC_WB__pf_0(int32 bpp__EntryPoint__pf);
