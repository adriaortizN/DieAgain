...
class UClass;
class APlaneCharacter_C__pf3858658621;
class APlayerController;
class AActor;
#include "PlaneCrash__pf3264546738.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Conversations/Events/PlaneCrash.PlaneCrash_C", OverrideNativeName="PlaneCrash_C"))
class UPlaneCrash_C__pf3264546738 : public UDialogueEvents
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="K2Node_DynamicCast_AsPlane_Character"))
	APlaneCharacter_C__pf3858658621* b0l__K2Node_DynamicCast_AsPlane_Character__pf;
	...
	UPlaneCrash_C__pf3264546738(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_PlaneCrash__pf_0(int32 bpp__EntryPoint__pf);
