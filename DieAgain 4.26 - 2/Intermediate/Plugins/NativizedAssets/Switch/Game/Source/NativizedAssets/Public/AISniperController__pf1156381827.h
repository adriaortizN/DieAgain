...
#include "AISniperController__pf1156381827.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Enemies/BehaviorSniper/AISniperController.AISniperController_C", OverrideNativeName="AISniperController_C"))
class AAISniperController_C__pf1156381827 : public AAIController
{
public:
	GENERATED_BODY()
	...
	bool bpv__IsVIP__pf;
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Level Competer", Category="Default", MultiLine="true", OverrideNativeName="LevelCompeter"))
	ALevelCompleterBP_C__pf922009354* bpv__LevelCompeter__pf;
	...
	AAISniperController_C__pf1156381827(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_AISniperController__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISniperController__pf_1(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_AISniperController_2"))
	void bpf__ExecuteUbergraph_AISniperController__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISniperController__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISniperController__pf_4(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISniperController__pf_5(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISniperController__pf_6(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISniperController__pf_7(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="AimToEnemy"))
	virtual void bpf__AimToEnemy__pf();
