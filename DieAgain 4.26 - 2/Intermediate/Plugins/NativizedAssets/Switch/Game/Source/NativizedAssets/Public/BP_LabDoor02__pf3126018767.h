...
class AActor;
#include "BP_LabDoor02__pf3126018767.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/ScienceLab/Blueprints/Rooms/Doors/BP_LabDoor02.BP_LabDoor02_C", OverrideNativeName="BP_LabDoor02_C"))
class ABP_LabDoor02_C__pf3126018767 : public AActor
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="LabDoor02"))
	UStaticMeshComponent* bpv__LabDoor02__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="LabDoorjamb02"))
	UStaticMeshComponent* bpv__LabDoorjamb02__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="DefaultSceneRoot"))
	USceneComponent* bpv__DefaultSceneRoot__pf;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(DisplayName="Door Position", Category="Default", UIMin="0", UIMax="120", OverrideNativeName="DoorPosition"))
	...
	ABP_LabDoor02_C__pf3126018767(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BP_LabDoor02__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_LabDoor02__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_LabDoor02__pf_2(int32 bpp__EntryPoint__pf);
