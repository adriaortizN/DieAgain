...
#include "LevelFinal_BlueBlood_1__pf936270410.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/HUD/LevelFinal/LevelFinal_BlueBlood_1.LevelFinal_BlueBlood_1_C", OverrideNativeName="LevelFinal_BlueBlood_1_C"))
class ULevelFinal_BlueBlood_1_C__pf936270410 : public UGamepadInteraction_C__pf197907997
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_99", Category="LevelFinal_BlueBlood_1", OverrideNativeName="Button_99"))
	UButton* bpv__Button_99__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Image_41", Category="LevelFinal_BlueBlood_1", OverrideNativeName="Image_41"))
	...
	ULevelFinal_BlueBlood_1_C__pf936270410(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_4(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_5(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_BlueBlood_1__pf_6(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_BE53D5CD4BDE1E56CF4CF8B034E16CB3"))
	virtual void bpf__OnSuccess_BE53D5CD4BDE1E56CF4CF8B034E16CB3__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_BE53D5CD4BDE1E56CF4CF8B034E16CB3"))
	virtual void bpf__OnFailure_BE53D5CD4BDE1E56CF4CF8B034E16CB3__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_56992EE44A3CB4EE82B62E8E5D9B3C83"))
	virtual void bpf__OnSuccess_56992EE44A3CB4EE82B62E8E5D9B3C83__pf();
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_56992EE44A3CB4EE82B62E8E5D9B3C83"))
	virtual void bpf__OnFailure_56992EE44A3CB4EE82B62E8E5D9B3C83__pf();
