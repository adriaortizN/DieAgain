...
UTipsHUD_C__pf3479267681::UTipsHUD_C__pf3479267681(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Button_101__pf = nullptr;
	bpv__Button_276__pf = nullptr;
...
void UTipsHUD_C__pf3479267681::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UTipsHUD_C__pf3479267681::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__2.ComponentPropertyName = FName(TEXT("Button_276"));
	__Local__2.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__Button_276_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__3 = __Local__0->ComponentDelegateBindings[1];
	__Local__3.ComponentPropertyName = FName(TEXT("Button_101"));
	__Local__3.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__Button_101_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	auto __Local__6 = NewObject<UCanvasPanelSlot>(__Local__4, TEXT("CanvasPanelSlot_12"), (EObjectFlags)0x00280008);
	...
	auto __Local__7 = NewObject<UImage>(__Local__1, TEXT("Image_123"), (EObjectFlags)0x00280008);
	__Local__7->Slot = __Local__6;
	__Local__6->Content = __Local__7;
	__Local__5.Add(__Local__6);
	auto __Local__8 = NewObject<UCanvasPanelSlot>(__Local__4, TEXT("CanvasPanelSlot_4"), (EObjectFlags)0x00280008);
	__Local__8->LayoutData.Offsets.Left = -152.960938f;
	__Local__8->LayoutData.Offsets.Top = 64.000000f;
	__Local__8->LayoutData.Offsets.Right = 296.713379f;
	__Local__8->LayoutData.Offsets.Bottom = 91.122231f;
	...
	auto __Local__9 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_37"), (EObjectFlags)0x00280008);
	__Local__9->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[FF43925449C1963CE68274B09824C093]\", \"2ED29D944BF5C42B5106D5B48A6D5ACB\", \"Tips\")")	);
	__Local__9->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__9->Font.OutlineSettings.OutlineSize = 5;
	__Local__9->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__9->Font.Size = 60;
	auto& __Local__10 = (*(AccessPrivateProperty<TEnumAsByte<ETextJustify::Type> >((__Local__9), UTextLayoutWidget::__PPO__Justification() )));
	__Local__10 = ETextJustify::Type::Center;
	__Local__9->Slot = __Local__8;
	__Local__8->Content = __Local__9;
	__Local__5.Add(__Local__8);
	auto __Local__11 = NewObject<UCanvasPanelSlot>(__Local__4, TEXT("CanvasPanelSlot_9"), (EObjectFlags)0x00280008);
	__Local__11->LayoutData.Offsets.Left = 200.000000f;
	__Local__11->LayoutData.Offsets.Top = -200.000000f;
	__Local__11->LayoutData.Offsets.Right = 350.000000f;
	__Local__11->LayoutData.Offsets.Bottom = 100.000000f;
	...
	auto __Local__12 = NewObject<UButton>(__Local__1, TEXT("Button_101"), (EObjectFlags)0x00280008);
	__Local__12->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	...
	__Local__13 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__14 = (*(AccessPrivateProperty<UObject* >(&(__Local__12->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__14 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__12->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__15 = (*(AccessPrivateProperty<UObject* >(&(__Local__12->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__15 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__12->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__16 = (*(AccessPrivateProperty<UObject* >(&(__Local__12->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__16 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	auto& __Local__17 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__12), UPanelWidget::__PPO__Slots() )));
	__Local__17 = TArray<UPanelSlot*> ();
	__Local__17.Reserve(1);
	auto __Local__18 = NewObject<UButtonSlot>(__Local__12, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__18->Parent = __Local__12;
	auto __Local__19 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_129"), (EObjectFlags)0x00280008);
	__Local__19->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[FF43925449C1963CE68274B09824C093]\", \"87EA062E46FA9548331B53BB274E4A71\", \"Go  back\")")	);
	auto& __Local__20 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__19->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__20 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__19->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__19->Font.OutlineSettings.OutlineSize = 5;
	__Local__19->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__19->Font.Size = 50;
	...
	__Local__21->LayoutData.Offsets.Left = -500.000000f;
	__Local__21->LayoutData.Offsets.Top = -200.000000f;
	__Local__21->LayoutData.Offsets.Right = 350.000000f;
	...
	auto __Local__22 = NewObject<UButton>(__Local__1, TEXT("Button_276"), (EObjectFlags)0x00280008);
	...
	__Local__23 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	__Local__24 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	auto& __Local__25 = (*(AccessPrivateProperty<UObject* >(&(__Local__22->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__25 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	auto __Local__28 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_257"), (EObjectFlags)0x00280008);
	__Local__28->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[FF43925449C1963CE68274B09824C093]\", \"1CD47F144278B453CE4BFE9A64C00D69\", \"Next\")")	);
	auto& __Local__29 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__28->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__29 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__28->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
PRAGMA_ENABLE_OPTIMIZATION
void UTipsHUD_C__pf3479267681::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__30;
	SlotNames.Append(__Local__30);
}
void UTipsHUD_C__pf3479267681::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__31;
	TArray<FDelegateRuntimeBinding>  __Local__32;
	__Local__32.AddUninitialized(1);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__32.GetData(), 1);
	auto& __Local__33 = __Local__32[0];
	__Local__33.ObjectName = FString(TEXT("Image_123"));
	__Local__33.PropertyName = FName(TEXT("Brush"));
	__Local__33.FunctionName = FName(TEXT("GetBrush_0"));
	auto& __Local__34 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__33.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__34 = TArray<FPropertyPathSegment> ();
	__Local__34.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__34.GetData(), 1);
	auto& __Local__35 = __Local__34[0];
	__Local__35.Name = FName(TEXT("GetTipImage"));
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->MiscConvertedSubobjects[0]), __Local__31, __Local__32);
}
void UTipsHUD_C__pf3479267681::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UTipsHUD_C__pf3479267681::bpf__ExecuteUbergraph_TipsHUD__pf_0(int32 bpp__EntryPoint__pf)
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	bool bpfv__CallFunc_Greater_IntInt_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 6);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__Tips__pf, 1);
	b0l__Temp_int_Variable__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
	bpv__Tips__pf = b0l__Temp_int_Variable__pf;
	bpfv__CallFunc_Greater_IntInt_ReturnValue__pf = UKismetMathLibrary::Greater_IntInt(b0l__Temp_int_Variable__pf, bpv__MaxTips__pf);
...
void UTipsHUD_C__pf3479267681::bpf__ExecuteUbergraph_TipsHUD__pf_1(int32 bpp__EntryPoint__pf)
{
	UOptionsHUD_C__pf3479267681* bpfv__CallFunc_Create_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 2);
	// optimized KCST_UnconditionalGoto
	RemoveFromParent();
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UOptionsHUD_C__pf3479267681>(UWidgetBlueprintLibrary::Create(this, UOptionsHUD_C__pf3479267681::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
...
void UTipsHUD_C__pf3479267681::bpf__BndEvt__Button_276_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_TipsHUD__pf_0(6);
}
void UTipsHUD_C__pf3479267681::bpf__BndEvt__Button_101_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_TipsHUD__pf_1(2);
}
FSlateBrush  UTipsHUD_C__pf3479267681::bpf__GetTipImage__pf()
{
	FSlateBrush bpp__ReturnValue__pf{};
	FSlateBrush bpfv__Tip12__pf{};
	FSlateBrush bpfv__Tip11__pf{};
	FSlateBrush bpfv__Tip10__pf{};
	FSlateBrush bpfv__Tip9__pf{};
	FSlateBrush bpfv__Tip8__pf{};
	FSlateBrush bpfv__Tip7__pf{};
	FSlateBrush bpfv__Tip6__pf{};
	FSlateBrush bpfv__Tip5__pf{};
	FSlateBrush bpfv__Tip4__pf{};
	FSlateBrush bpfv__Tip3__pf{};
	FSlateBrush bpfv__Tip2__pf{};
	FSlateBrush bpfv__Tip1__pf{};
	...
	do
	{
		...
		case 1:
			{
				const UScriptStruct* __Local__37 = FSlateBrush::StaticStruct();
				uint8* __Local__38 = (uint8*)FMemory_Alloca(__Local__37->GetStructureSize());
				__Local__37->InitializeStruct(__Local__38);
				FSlateBrush& __Local__36 = *reinterpret_cast<FSlateBrush*>(__Local__38);
				__Local__36.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__39 = (*(AccessPrivateProperty<UObject* >(&(__Local__36), FSlateBrush::__PPO__ResourceObject() )));
				__Local__39 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
				bpfv__Tip1__pf = __Local__36;
			}
		case 2:
			{
				const UScriptStruct* __Local__41 = FSlateBrush::StaticStruct();
				uint8* __Local__42 = (uint8*)FMemory_Alloca(__Local__41->GetStructureSize());
				__Local__41->InitializeStruct(__Local__42);
				FSlateBrush& __Local__40 = *reinterpret_cast<FSlateBrush*>(__Local__42);
				__Local__40.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__43 = (*(AccessPrivateProperty<UObject* >(&(__Local__40), FSlateBrush::__PPO__ResourceObject() )));
				__Local__43 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
				bpfv__Tip2__pf = __Local__40;
			}
		case 3:
			{
				const UScriptStruct* __Local__45 = FSlateBrush::StaticStruct();
				uint8* __Local__46 = (uint8*)FMemory_Alloca(__Local__45->GetStructureSize());
				__Local__45->InitializeStruct(__Local__46);
				FSlateBrush& __Local__44 = *reinterpret_cast<FSlateBrush*>(__Local__46);
				__Local__44.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__47 = (*(AccessPrivateProperty<UObject* >(&(__Local__44), FSlateBrush::__PPO__ResourceObject() )));
				__Local__47 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
				bpfv__Tip3__pf = __Local__44;
			}
		case 4:
			{
				const UScriptStruct* __Local__49 = FSlateBrush::StaticStruct();
				uint8* __Local__50 = (uint8*)FMemory_Alloca(__Local__49->GetStructureSize());
				__Local__49->InitializeStruct(__Local__50);
				FSlateBrush& __Local__48 = *reinterpret_cast<FSlateBrush*>(__Local__50);
				__Local__48.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__51 = (*(AccessPrivateProperty<UObject* >(&(__Local__48), FSlateBrush::__PPO__ResourceObject() )));
				__Local__51 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
				bpfv__Tip4__pf = __Local__48;
			}
		case 5:
			{
				const UScriptStruct* __Local__53 = FSlateBrush::StaticStruct();
				uint8* __Local__54 = (uint8*)FMemory_Alloca(__Local__53->GetStructureSize());
				__Local__53->InitializeStruct(__Local__54);
				FSlateBrush& __Local__52 = *reinterpret_cast<FSlateBrush*>(__Local__54);
				__Local__52.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__55 = (*(AccessPrivateProperty<UObject* >(&(__Local__52), FSlateBrush::__PPO__ResourceObject() )));
				__Local__55 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
				bpfv__Tip5__pf = __Local__52;
			}
		case 6:
			{
				const UScriptStruct* __Local__57 = FSlateBrush::StaticStruct();
				uint8* __Local__58 = (uint8*)FMemory_Alloca(__Local__57->GetStructureSize());
				__Local__57->InitializeStruct(__Local__58);
				FSlateBrush& __Local__56 = *reinterpret_cast<FSlateBrush*>(__Local__58);
				__Local__56.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__59 = (*(AccessPrivateProperty<UObject* >(&(__Local__56), FSlateBrush::__PPO__ResourceObject() )));
				__Local__59 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
				bpfv__Tip6__pf = __Local__56;
			}
		case 7:
			{
				const UScriptStruct* __Local__61 = FSlateBrush::StaticStruct();
				uint8* __Local__62 = (uint8*)FMemory_Alloca(__Local__61->GetStructureSize());
				__Local__61->InitializeStruct(__Local__62);
				FSlateBrush& __Local__60 = *reinterpret_cast<FSlateBrush*>(__Local__62);
				__Local__60.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__63 = (*(AccessPrivateProperty<UObject* >(&(__Local__60), FSlateBrush::__PPO__ResourceObject() )));
				__Local__63 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed);
				bpfv__Tip7__pf = __Local__60;
			}
		case 8:
			{
				const UScriptStruct* __Local__65 = FSlateBrush::StaticStruct();
				uint8* __Local__66 = (uint8*)FMemory_Alloca(__Local__65->GetStructureSize());
				__Local__65->InitializeStruct(__Local__66);
				FSlateBrush& __Local__64 = *reinterpret_cast<FSlateBrush*>(__Local__66);
				__Local__64.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__67 = (*(AccessPrivateProperty<UObject* >(&(__Local__64), FSlateBrush::__PPO__ResourceObject() )));
				__Local__67 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed);
				bpfv__Tip8__pf = __Local__64;
			}
		case 9:
			{
				const UScriptStruct* __Local__69 = FSlateBrush::StaticStruct();
				uint8* __Local__70 = (uint8*)FMemory_Alloca(__Local__69->GetStructureSize());
				__Local__69->InitializeStruct(__Local__70);
				FSlateBrush& __Local__68 = *reinterpret_cast<FSlateBrush*>(__Local__70);
				__Local__68.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__71 = (*(AccessPrivateProperty<UObject* >(&(__Local__68), FSlateBrush::__PPO__ResourceObject() )));
				__Local__71 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[11], ECastCheckedType::NullAllowed);
				bpfv__Tip9__pf = __Local__68;
			}
		case 10:
			{
				const UScriptStruct* __Local__73 = FSlateBrush::StaticStruct();
				uint8* __Local__74 = (uint8*)FMemory_Alloca(__Local__73->GetStructureSize());
				__Local__73->InitializeStruct(__Local__74);
				FSlateBrush& __Local__72 = *reinterpret_cast<FSlateBrush*>(__Local__74);
				__Local__72.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__75 = (*(AccessPrivateProperty<UObject* >(&(__Local__72), FSlateBrush::__PPO__ResourceObject() )));
				__Local__75 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[12], ECastCheckedType::NullAllowed);
				bpfv__Tip10__pf = __Local__72;
			}
		case 11:
			{
				const UScriptStruct* __Local__77 = FSlateBrush::StaticStruct();
				uint8* __Local__78 = (uint8*)FMemory_Alloca(__Local__77->GetStructureSize());
				__Local__77->InitializeStruct(__Local__78);
				FSlateBrush& __Local__76 = *reinterpret_cast<FSlateBrush*>(__Local__78);
				__Local__76.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__79 = (*(AccessPrivateProperty<UObject* >(&(__Local__76), FSlateBrush::__PPO__ResourceObject() )));
				__Local__79 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[13], ECastCheckedType::NullAllowed);
				bpfv__Tip11__pf = __Local__76;
			}
		case 12:
			{
				const UScriptStruct* __Local__81 = FSlateBrush::StaticStruct();
				uint8* __Local__82 = (uint8*)FMemory_Alloca(__Local__81->GetStructureSize());
				__Local__81->InitializeStruct(__Local__82);
				FSlateBrush& __Local__80 = *reinterpret_cast<FSlateBrush*>(__Local__82);
				__Local__80.ImageSize = FVector2D(1920.000000, 1080.000000);
				auto& __Local__83 = (*(AccessPrivateProperty<UObject* >(&(__Local__80), FSlateBrush::__PPO__ResourceObject() )));
				__Local__83 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTipsHUD_C__pf3479267681::StaticClass())->UsedAssets[14], ECastCheckedType::NullAllowed);
				bpfv__Tip12__pf = __Local__80;
			}
		case 13:
			{
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 0);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				}
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 1);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				}
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 2);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 17;
					break;
				}
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 3);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				}
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 4);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 19;
					break;
				}
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 5);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 20;
					break;
				}
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 6);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 21;
					break;
				}
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 7);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 22;
					break;
				}
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 8);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 23;
					break;
				}
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 9);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 24;
					break;
				}
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 10);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 25;
					break;
				}
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Tips__pf, 11);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 26;
					break;
		...
		case 14:
			{
				bpv__TipImage__pf = bpfv__Tip1__pf;
			}
		case 15:
			{
				bpp__ReturnValue__pf = bpv__TipImage__pf;
				__CurrentState = -1;
				break;
			}
		case 16:
			{
				bpv__TipImage__pf = bpfv__Tip2__pf;
				__CurrentState = 15;
				break;
			}
		case 17:
			{
				bpv__TipImage__pf = bpfv__Tip3__pf;
				__CurrentState = 15;
				break;
			}
		case 18:
			{
				bpv__TipImage__pf = bpfv__Tip4__pf;
				__CurrentState = 15;
				break;
			}
		case 19:
			{
				bpv__TipImage__pf = bpfv__Tip5__pf;
				__CurrentState = 15;
				break;
			}
		case 20:
			{
				bpv__TipImage__pf = bpfv__Tip6__pf;
				__CurrentState = 15;
				break;
			}
		case 21:
			{
				bpv__TipImage__pf = bpfv__Tip7__pf;
				__CurrentState = 15;
				break;
			}
		case 22:
			{
				bpv__TipImage__pf = bpfv__Tip8__pf;
				__CurrentState = 15;
				break;
			}
		case 23:
			{
				bpv__TipImage__pf = bpfv__Tip9__pf;
				__CurrentState = 15;
				break;
			}
		case 24:
			{
				bpv__TipImage__pf = bpfv__Tip10__pf;
				__CurrentState = 15;
				break;
			}
		case 25:
			{
				bpv__TipImage__pf = bpfv__Tip11__pf;
				__CurrentState = 15;
				break;
			}
		case 26:
			{
				bpv__TipImage__pf = bpfv__Tip12__pf;
				__CurrentState = 15;
				break;
			}
		default:
...
void UTipsHUD_C__pf3479267681::bpf__GetText_0__pf()
{
	FText bpfv__TextGoBack__pf{};
}
void UTipsHUD_C__pf3479267681::bpf__GetText_1__pf()
{
	FText bpfv__TextNext__pf{};
}
void UTipsHUD_C__pf3479267681::bpf__GetText_2__pf()
{
	FText bpfv__TextTips__pf{};
}
PRAGMA_DISABLE_OPTIMIZATION
void UTipsHUD_C__pf3479267681::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UTipsHUD_C__pf3479267681::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UTipsHUD_C__pf3479267681
{
	FRegisterHelper__UTipsHUD_C__pf3479267681()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/ControlsWB/TipsHUD"), &UTipsHUD_C__pf3479267681::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UTipsHUD_C__pf3479267681 Instance;
};
FRegisterHelper__UTipsHUD_C__pf3479267681 FRegisterHelper__UTipsHUD_C__pf3479267681::Instance;
