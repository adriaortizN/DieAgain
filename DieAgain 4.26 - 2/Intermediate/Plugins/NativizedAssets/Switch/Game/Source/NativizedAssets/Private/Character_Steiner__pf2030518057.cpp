...
#include "PossesionPT_Cutscene__pf2030518057.h"
...
ACharacter_Steiner_C__pf2030518057::ACharacter_Steiner_C__pf2030518057(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	if(__Local__1)
	{
		...
		__Local__1->MaxAcceleration = 10000.000000f;
	...
	if(__Local__2)
	{
		...
		__Local__2->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(ACharacter_Steiner_C__pf2030518057::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	bpv__Blood__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Blood"));
	...
	bpv__Blood__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Blood__pf->AttachToComponent(__Local__2, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__14 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Blood__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__14 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ACharacter_Steiner_C__pf2030518057::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__Blood__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Blood__pf->OverrideMaterials.Reserve(1);
	bpv__Blood__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ACharacter_Steiner_C__pf2030518057::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	auto& __Local__15 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Blood__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__16.AddUninitialized(11);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__16.GetData(), 11);
	...
	__Local__25.Channel = FName(TEXT("OverlapShoot"));
	__Local__25.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__26 = __Local__16[9];
	__Local__26.Channel = FName(TEXT("GunShoot"));
	__Local__26.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__27 = __Local__16[10];
	__Local__27.Channel = FName(TEXT("ExplosionMissile"));
	__Local__27.Response = ECollisionResponse::ECR_Ignore;
	bpv__Blood__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__28 = (*(AccessPrivateProperty<FVector >((bpv__Blood__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__28 = FVector(-50.020561, 94.993423, 0.000000);
	auto& __Local__29 = (*(AccessPrivateProperty<FRotator >((bpv__Blood__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__29 = FRotator(0.000000, 90.000214, 0.000000);
	static TWeakFieldPtr<FProperty> __Local__31{};
	const FProperty* __Local__30 = __Local__31.Get();
	if (nullptr == __Local__30)
	{
		__Local__30 = (USceneComponent::StaticClass())->FindPropertyByName(FName(TEXT("bVisible")));
		check(__Local__30);
		__Local__31 = __Local__30;
	}
	(((FBoolProperty*)__Local__30)->SetPropertyValue_InContainer((bpv__Blood__pf), false, 0));
	...
	(((FBoolProperty*)__Local__32)->SetPropertyValue_InContainer((bpv__Blood__pf), false, 0));
	...
	auto& __Local__34 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__GasMask__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__34 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ACharacter_Steiner_C__pf2030518057::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	(((FBoolProperty*)__Local__32)->SetPropertyValue_InContainer((bpv__GasMask__pf), false, 0));
	...
	auto& __Local__35 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Weapon__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__35 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ACharacter_Steiner_C__pf2030518057::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	bpv__Weapon__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Weapon__pf->OverrideMaterials.Reserve(2);
	bpv__Weapon__pf->OverrideMaterials.Add(nullptr);
	bpv__Weapon__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ACharacter_Steiner_C__pf2030518057::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed));
	auto& __Local__36 = (*(AccessPrivateProperty<FVector >((bpv__Weapon__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__36 = FVector(0.000000, 0.000000, 85.000000);
	auto& __Local__37 = (*(AccessPrivateProperty<FRotator >((bpv__Weapon__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__37 = FRotator(0.000000, 90.000214, 0.000000);
	(((FBoolProperty*)__Local__32)->SetPropertyValue_InContainer((bpv__Weapon__pf), false, 0));
	bpv__PointLight__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__PointLight__pf->AttachToComponent(__Local__2, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__PointLight__pf->AttenuationRadius = 4.000000f;
	bpv__PointLight__pf->Intensity = 0.000000f;
	bpv__PointLight__pf->LightColor = FColor(66, 255, 0, 255);
	auto& __Local__38 = (*(AccessPrivateProperty<FVector >((bpv__PointLight__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__38 = FVector(31.594999, 10.018000, 49.092999);
	(((FBoolProperty*)__Local__32)->SetPropertyValue_InContainer((bpv__PointLight__pf), false, 0));
	bpv__FirstTarget__pf = nullptr;
	bpv__IsDeath__pf = false;
	bpv__IntensityLight__pf = 0.000000f;
	auto& __Local__39 = (*(AccessPrivateProperty<USkeletalMeshComponent*>((this), ACharacter::__PPO__Mesh() )));
	__Local__39 = __Local__2;
	auto& __Local__40 = (*(AccessPrivateProperty<UCharacterMovementComponent*>((this), ACharacter::__PPO__CharacterMovement() )));
	__Local__40 = __Local__1;
	auto& __Local__41 = (*(AccessPrivateProperty<UCapsuleComponent*>((this), ACharacter::__PPO__CapsuleComponent() )));
	__Local__41 = __Local__0;
...
void ACharacter_Steiner_C__pf2030518057::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ACharacter_Steiner_C__pf2030518057::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(APossesionPT_Cutscene_C__pf2030518057::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UAnimBP_ChSteiner_C__pf1595061710::StaticClass());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
	auto __Local__43 = NewObject<USceneComponent>(InDynamicClass, USceneComponent::StaticClass(), TEXT("DefaultSceneRoot_GEN_VARIABLE"), (EObjectFlags)0x00280029);
	...
	(((FBoolProperty*)__Local__44)->SetPropertyValue_InContainer((__Local__43), false, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
void ACharacter_Steiner_C__pf2030518057::bpf__ExecuteUbergraph_Character_Steiner__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 3:
			{
				bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(bpv__IntensityLight__pf, -2.500000);
		...
		case 9:
			{
				if(::IsValid(bpv__FirstTarget__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = bpv__FirstTarget__pf->AActor::K2_GetActorLocation();
				}
...
void ACharacter_Steiner_C__pf2030518057::bpf__ExecuteUbergraph_Character_Steiner__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 18:
			{
				bpfv__CallFunc_LessEqual_FloatFloat_ReturnValue__pf = UKismetMathLibrary::LessEqual_FloatFloat(bpv__IntensityLight__pf, 1000.000000);
		...
		case 19:
			{
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::Add_FloatFloat(bpv__IntensityLight__pf, 5.000000);
...
void ACharacter_Steiner_C__pf2030518057::bpf__ExecuteUbergraph_Character_Steiner__pf_2(int32 bpp__EntryPoint__pf)
{
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
		...
		case 14:
			{
				bpf__AttachEverything__pf();
			}
		case 15:
			{
				UKismetSystemLibrary::Delay(this, 25.000000, FLatentActionInfo(1, 43256325, TEXT("ExecuteUbergraph_Character_Steiner_2"), this));
				__CurrentState = -1;
				break;
			}
		case 16:
...
void ACharacter_Steiner_C__pf2030518057::bpf__ExecuteUbergraph_Character_Steiner__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue__pf = UKismetMaterialLibrary::CreateDynamicMaterialInstance(this, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ACharacter_Steiner_C__pf2030518057::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), FName(TEXT("None")), EMIDCreationFlags::None);
...
void ACharacter_Steiner_C__pf2030518057::bpf__ExecuteUbergraph_Character_Steiner__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 7);
	return; //KCST_EndOfThread
}
void ACharacter_Steiner_C__pf2030518057::bpf__OffLightFunction__pf()
{
	bpf__ExecuteUbergraph_Character_Steiner__pf_0(21);
}
void ACharacter_Steiner_C__pf2030518057::bpf__LightFunction__pf()
{
	bpf__ExecuteUbergraph_Character_Steiner__pf_1(17);
}
void ACharacter_Steiner_C__pf2030518057::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Character_Steiner__pf_2(16);
}
void ACharacter_Steiner_C__pf2030518057::bpf__BloodEvent__pf(FName bpp__EventName__pf, float bpp__EmitterTime__pf, int32 bpp__ParticleTime__pf, FVector bpp__Location__pf, FVector bpp__Velocity__pf, FVector bpp__Direction__pf, FVector bpp__Normal__pf, FName bpp__BoneName__pf, UPhysicalMaterial* bpp__PhysMat__pf)
{
	...
	bpf__ExecuteUbergraph_Character_Steiner__pf_3(13);
}
void ACharacter_Steiner_C__pf2030518057::bpf__DeathEvent__pf()
{
	bpf__ExecuteUbergraph_Character_Steiner__pf_4(7);
}
void ACharacter_Steiner_C__pf2030518057::bpf__UnPossesCharacter__pf()
{
	int32 bpfv__Temp_int_Array_Index_Variable__pf{};
	TArray<ACharacter_Alfa_C__pf2030518057*> bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf{};
	AActor* bpfv__CallFunc_Array_Get_Item__pf{};
	FParticleSysParam bpfv__K2Node_MakeStruct_ParticleSysParam__pf{};
	ACharacter_Alfa_C__pf2030518057* bpfv__K2Node_DynamicCast_AsCharacter_Alfa__pf{};
	...
	APossesionPT_Cutscene_C__pf2030518057* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
		...
		case 1:
			{
				...
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = (*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() )))->USceneComponent::K2_GetComponentLocation();
				}
				bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ACharacter_Steiner_C__pf2030518057::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000), true, EPSCPoolMethod::None, true);
			}
		case 2:
			{
				if(::IsValid(bpv__Blood__pf))
				{
					bpv__Blood__pf->USceneComponent::SetVisibility(true, false);
				}
			}
		case 3:
			{
				(bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf).Reset();
				UGameplayStatics::GetAllActorsOfClass(this, ACharacter_Alfa_C__pf2030518057::StaticClass(), /*out*/ TArrayCaster<ACharacter_Alfa_C__pf2030518057*>(bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
			}
		case 4:
			{
		...
		case 9:
			{
				...
				bpfv__K2Node_DynamicCast_AsCharacter_Alfa__pf = Cast<ACharacter_Alfa_C__pf2030518057>(bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__K2Node_DynamicCast_bSuccess__pf = (bpfv__K2Node_DynamicCast_AsCharacter_Alfa__pf != nullptr);;
		...
		case 10:
			{
				...
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, APossesionPT_Cutscene_C__pf2030518057::StaticClass(), bpfv__CallFunc_GetTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AdjustIfPossibleButAlwaysSpawn, ((AActor*)nullptr));
			}
		case 11:
			{
				bpfv__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<APossesionPT_Cutscene_C__pf2030518057>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_GetTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 12:
			{
				bpfv__K2Node_MakeStruct_ParticleSysParam__pf.Name = FName(TEXT("Source"));
				...
				bpfv__K2Node_MakeStruct_ParticleSysParam__pf.Actor = this;
				bpfv__K2Node_MakeStruct_ParticleSysParam__pf.Material = ((UMaterialInterface*)nullptr);
				bpfv__K2Node_MakeStruct_ParticleSysParam_1__pf.Name = FName(TEXT("Target"));
				...
				bpfv__K2Node_MakeStruct_ParticleSysParam_1__pf.Actor = bpfv__K2Node_DynamicCast_AsCharacter_Alfa__pf;
				...
				bpfv__K2Node_MakeArray_Array__pf[0] = bpfv__K2Node_MakeStruct_ParticleSysParam__pf;
				bpfv__K2Node_MakeArray_Array__pf[1] = bpfv__K2Node_MakeStruct_ParticleSysParam_1__pf;
...
void ACharacter_Steiner_C__pf2030518057::bpf__AttachEverything__pf()
{
	...
	{
		bpfv__CallFunc_K2_AttachToComponent_ReturnValue_2__pf = bpv__GasMask__pf->USceneComponent::K2_AttachToComponent((*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() ))), FName(TEXT("Head")), EAttachmentRule::KeepRelative, EAttachmentRule::KeepRelative, EAttachmentRule::KeepRelative, true);
	}
	if(::IsValid(bpv__GasMask__pf))
	{
		bpv__GasMask__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(-167.360001,5.403351,-10.862000), FRotator(4.236657,-92.024696,87.662491), false, /*out*/ bpfv__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult_2__pf, true);
	}
	if(::IsValid(bpv__Weapon__pf))
	{
		bpfv__CallFunc_K2_AttachToComponent_ReturnValue_1__pf = bpv__Weapon__pf->USceneComponent::K2_AttachToComponent((*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() ))), FName(TEXT("Neck")), EAttachmentRule::KeepRelative, EAttachmentRule::KeepRelative, EAttachmentRule::KeepRelative, true);
	}
	if(::IsValid(bpv__Weapon__pf))
	{
		bpv__Weapon__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(-8.021246,17.536156,9.114654), FRotator(79.085381,168.539597,65.527275), false, /*out*/ bpfv__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult_1__pf, true);
	}
	if(::IsValid(bpv__PointLight__pf))
	{
		bpfv__CallFunc_K2_AttachToComponent_ReturnValue__pf = bpv__PointLight__pf->USceneComponent::K2_AttachToComponent((*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() ))), FName(TEXT("Head")), EAttachmentRule::KeepRelative, EAttachmentRule::KeepRelative, EAttachmentRule::KeepRelative, true);
	}
	if(::IsValid(bpv__PointLight__pf))
	{
		bpv__PointLight__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(7.010639,3.255990,-11.070000), FRotator(0.000000,0.000000,0.000000), false, /*out*/ bpfv__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult__pf, true);
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ACharacter_Steiner_C__pf2030518057::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ACharacter_Steiner_C__pf2030518057::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{984, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Objects/Cutscene/PossesionPT_Cutscene.PossesionPT_Cutscene_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ACharacter_Steiner_C__pf2030518057
{
	FRegisterHelper__ACharacter_Steiner_C__pf2030518057()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/Cutscene/Character_Steiner"), &ACharacter_Steiner_C__pf2030518057::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ACharacter_Steiner_C__pf2030518057 Instance;
};
FRegisterHelper__ACharacter_Steiner_C__pf2030518057 FRegisterHelper__ACharacter_Steiner_C__pf2030518057::Instance;
