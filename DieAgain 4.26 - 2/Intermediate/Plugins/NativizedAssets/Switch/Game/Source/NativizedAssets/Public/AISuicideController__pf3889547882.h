...
#include "AISuicideController__pf3889547882.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Enemies/BehaviorSuicide/AISuicideController.AISuicideController_C", OverrideNativeName="AISuicideController_C"))
class AAISuicideController_C__pf3889547882 : public AAIController
{
public:
	GENERATED_BODY()
	...
	AAISuicideController_C__pf3889547882(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_AISuicideController_0"))
	void bpf__ExecuteUbergraph_AISuicideController__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISuicideController__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISuicideController__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISuicideController__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISuicideController__pf_4(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISuicideController__pf_5(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISuicideController__pf_6(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_AISuicideController__pf_7(int32 bpp__EntryPoint__pf);
