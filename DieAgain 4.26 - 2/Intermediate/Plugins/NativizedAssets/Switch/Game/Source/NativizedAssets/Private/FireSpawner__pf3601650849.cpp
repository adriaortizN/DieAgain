...
#include "FireSpawner__pf3601650849.h"
...
AFireSpawner_C__pf3601650849::AFireSpawner_C__pf3601650849(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__SpawnPoint__pf = CreateDefaultSubobject<UChildActorComponent>(TEXT("SpawnPoint"));
	bpv__Arrow__pf = CreateDefaultSubobject<UArrowComponent>(TEXT("Arrow"));
	bpv__InitSpawn__pf = CreateDefaultSubobject<UBoxComponent>(TEXT("InitSpawn"));
	...
	auto& __Local__2 = (*(AccessPrivateProperty<FVector >((bpv__Arrow__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__2 = FVector(5.000000, 5.000000, 5.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Arrow__pf), false, 0));
	bpv__InitSpawn__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__InitSpawn__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__InitSpawn__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__InitSpawn__pf), true, 0));
	bpv__ActiveFire__pf = false;
...
void AFireSpawner_C__pf3601650849::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__InitSpawn__pf)
	{
		bpv__InitSpawn__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AFireSpawner_C__pf3601650849::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(ADeadlyFire_C__pf3601650849::StaticClass());
	...
	__Local__5.ComponentPropertyName = FName(TEXT("InitSpawn"));
	__Local__5.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__5.FunctionNameToBind = FName(TEXT("BndEvt__InitSpawn_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AFireSpawner_C__pf3601650849::bpf__ExecuteUbergraph_FireSpawner__pf_0(int32 bpp__EntryPoint__pf)
{
...
void AFireSpawner_C__pf3601650849::bpf__ExecuteUbergraph_FireSpawner__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	ADeadlyFire_C__pf3601650849* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	...
	bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, ADeadlyFire_C__pf3601650849::StaticClass(), bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AdjustIfPossibleButAlwaysSpawn, ((AActor*)nullptr));
	if(::IsValid(bpv__SpawnPoint__pf))
	{
		bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf = bpv__SpawnPoint__pf->USceneComponent::K2_GetComponentToWorld();
	}
	bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<ADeadlyFire_C__pf3601650849>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf), ECastCheckedType::NullAllowed);
	if(::IsValid(bpv__SpawnPoint__pf))
	{
		bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__SpawnPoint__pf->USceneComponent::K2_GetComponentLocation();
	}
	bpfv__CallFunc_Add_VectorVector_ReturnValue__pf = UKismetMathLibrary::Add_VectorVector(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, FVector(0.000000,150.000000,0.000000));
	if(::IsValid(bpv__SpawnPoint__pf))
	{
		bpv__SpawnPoint__pf->USceneComponent::K2_SetWorldLocation(bpfv__CallFunc_Add_VectorVector_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetWorldLocation_SweepHitResult__pf, false);
	}
	return; //KCST_EndOfThread
}
void AFireSpawner_C__pf3601650849::bpf__ExecuteUbergraph_FireSpawner__pf_2(int32 bpp__EntryPoint__pf)
{
	FTimerHandle bpfv__CallFunc_K2_SetTimerDelegate_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 11);
	// optimized KCST_UnconditionalGoto
	b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("SpawnFire")));
	bpfv__CallFunc_K2_SetTimerDelegate_ReturnValue__pf = UKismetSystemLibrary::K2_SetTimerDelegate(b0l__K2Node_CreateDelegate_OutputDelegate__pf, 3.000000, true, 0.000000, 0.000000);
	return; //KCST_EndOfThread
}
void AFireSpawner_C__pf3601650849::bpf__BndEvt__InitSpawn_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_FireSpawner__pf_0(17);
}
void AFireSpawner_C__pf3601650849::bpf__SpawnFire__pf()
{
	bpf__ExecuteUbergraph_FireSpawner__pf_1(13);
}
void AFireSpawner_C__pf3601650849::bpf__InitEvent__pf()
{
	bpf__ExecuteUbergraph_FireSpawner__pf_2(11);
}
void AFireSpawner_C__pf3601650849::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_FireSpawner__pf_0(10);
}
PRAGMA_DISABLE_OPTIMIZATION
void AFireSpawner_C__pf3601650849::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AFireSpawner_C__pf3601650849::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{1017, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Objects/Fire/DeadlyFire.DeadlyFire_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AFireSpawner_C__pf3601650849
{
	FRegisterHelper__AFireSpawner_C__pf3601650849()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/Fire/FireSpawner"), &AFireSpawner_C__pf3601650849::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AFireSpawner_C__pf3601650849 Instance;
};
FRegisterHelper__AFireSpawner_C__pf3601650849 FRegisterHelper__AFireSpawner_C__pf3601650849::Instance;
