...
ACameraActor_C__pf1295471953::ACameraActor_C__pf1295471953(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	auto __Local__0 = CastChecked<USceneComponent>(this->GetDefaultSubobjectByName(TEXT("SceneComponent")), ECastCheckedType::NullAllowed);
	auto __Local__1 = CastChecked<UCameraComponent>(this->GetDefaultSubobjectByName(TEXT("CameraComponent")), ECastCheckedType::NullAllowed);
	if(__Local__0)
	{
		// --- Default subobject 'SceneComponent' //
		...
		// --- END default subobject 'SceneComponent' //
	}
	if(__Local__1)
	{
		// --- Default subobject 'CameraComponent' //
		...
		// --- END default subobject 'CameraComponent' //
	}
	bpv__ApproachingComponent__pf = CreateDefaultSubobject<UChildActorComponent>(TEXT("ApproachingComponent"));
	bpv__ApproachingComponent__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ApproachingComponent__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__ApproachingComponent__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__7 = FVector(547.000000, 0.000000, 58.000000);
	...
	(((FBoolProperty*)__Local__8)->SetPropertyValue_InContainer((bpv__ApproachingComponent__pf), false, 0));
	bpv__CameraOffset__pf = FVector(0.000000, 0.000000, 0.000000);
	bpv__CameraType__pf = E__EnumCameraType__pf::NewEnumerator1;
	bpv__Player__pf = nullptr;
	bpv__CameraHeight__pf = 1000.000000f;
	bpv__IsMapCamera__pf = false;
	bpv__CameraHeightNF__pf = 1250.000000f;
	auto& __Local__10 = (*(AccessPrivateProperty<UCameraComponent*>((this), ACameraActor::__PPO__CameraComponent() )));
	__Local__10 = __Local__1;
	auto& __Local__11 = (*(AccessPrivateProperty<USceneComponent*>((this), ACameraActor::__PPO__SceneComponent() )));
...
void ACameraActor_C__pf1295471953::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__ApproachingComponent__pf)
	{
		bpv__ApproachingComponent__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ACameraActor_C__pf1295471953::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ACameraActor_C__pf1295471953::bpf__ExecuteUbergraph_CameraActor__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	UKismetSystemLibrary::MoveComponentTo((*(AccessPrivateProperty<UCameraComponent* >((this), ACameraActor::__PPO__CameraComponent() ))), ((::IsValid(bpv__ApproachingComponent__pf)) ? ((*(AccessPrivateProperty<FVector >((bpv__ApproachingComponent__pf), USceneComponent::__PPO__RelativeLocation() )))) : (__Local__16)), FRotator(0.000000,0.000000,0.000000), true, true, 1.000000, true, b0l__Temp_byte_Variable__pf, FLatentActionInfo(-1, -1494365820, TEXT("ExecuteUbergraph_CameraActor"), this));
	return; //KCST_EndOfThread
}
void ACameraActor_C__pf1295471953::bpf__ExecuteUbergraph_CameraActor__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator0));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 5;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator1));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 6;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator2));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 7;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator3));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 8;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator6));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 9;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator4));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 10;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator8));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 11;
					break;
				}
				b0l__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator9));
				if (!b0l__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 12;
					break;
		...
		case 5:
			{
				if(::IsValid((*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))))
				{
					(*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))->USceneComponent::K2_SetWorldLocationAndRotation(FVector(-1690.989014,2085.125977,415.156555), FRotator(0.000000,-90.000122,0.000000), false, /*out*/ b0l__CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult_4__pf, false);
				}
				__CurrentState = -1;
				break;
			}
		case 6:
			{
				if(::IsValid((*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))))
				{
					(*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))->USceneComponent::K2_SetWorldLocationAndRotation(FVector(-1690.989014,2085.125977,415.156555), FRotator(-90.000000,0.000000,0.000000), false, /*out*/ b0l__CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult_3__pf, false);
				}
				__CurrentState = -1;
				break;
			}
		case 7:
			{
				if(::IsValid((*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))))
				{
					(*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))->USceneComponent::K2_SetWorldLocationAndRotation(FVector(-456.000000,961.000000,953.000000), FRotator(-90.000000,0.000000,0.000000), false, /*out*/ b0l__CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult_2__pf, false);
				}
				__CurrentState = -1;
				break;
			}
		case 8:
			{
				if(::IsValid((*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))))
				{
					(*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))->USceneComponent::K2_SetWorldRotation(FRotator(0.000000,0.000000,0.000000), false, /*out*/ b0l__CallFunc_K2_SetWorldRotation_SweepHitResult_2__pf, true);
				}
				__CurrentState = -1;
				break;
			}
		case 9:
			{
				if(::IsValid((*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))))
				{
					(*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))->USceneComponent::K2_SetWorldRotation(FRotator(0.000000,0.000000,0.000000), false, /*out*/ b0l__CallFunc_K2_SetWorldRotation_SweepHitResult__pf, true);
				}
				__CurrentState = -1;
				break;
			}
		case 10:
			{
				if(::IsValid((*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))))
				{
					(*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))->USceneComponent::K2_SetWorldRotation(FRotator(0.000000,-180.000000,0.000000), false, /*out*/ b0l__CallFunc_K2_SetWorldRotation_SweepHitResult_1__pf, true);
				}
				__CurrentState = -1;
				break;
			}
		case 11:
			{
				if(::IsValid((*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))))
				{
					(*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))->USceneComponent::K2_SetWorldLocationAndRotation(FVector(-1690.989014,2085.125977,415.156555), FRotator(-90.000000,0.000000,0.000000), false, /*out*/ b0l__CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult_1__pf, true);
				}
				__CurrentState = -1;
				break;
			}
		case 12:
			{
				if(::IsValid((*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))))
				{
					(*(AccessPrivateProperty<USceneComponent* >((this), ACameraActor::__PPO__SceneComponent() )))->USceneComponent::K2_SetWorldLocationAndRotation(FVector(880.000000,1085.000000,760.000000), FRotator(-90.000000,0.000000,0.000000), false, /*out*/ b0l__CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult__pf, false);
				}
				__CurrentState = -1;
				break;
			}
...
void ACameraActor_C__pf1295471953::bpf__ExecuteUbergraph_CameraActor__pf_2(int32 bpp__EntryPoint__pf)
{
	FTimerHandle bpfv__CallFunc_K2_SetTimerDelegate_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 15);
	// optimized KCST_UnconditionalGoto
	b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("Event")));
	bpfv__CallFunc_K2_SetTimerDelegate_ReturnValue__pf = UKismetSystemLibrary::K2_SetTimerDelegate(b0l__K2Node_CreateDelegate_OutputDelegate__pf, 0.100000, false, 0.000000, 0.000000);
	return; //KCST_EndOfThread
}
void ACameraActor_C__pf1295471953::bpf__ExecuteUbergraph_CameraActor__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 14);
	return; //KCST_EndOfThread
}
void ACameraActor_C__pf1295471953::bpf__ExecuteUbergraph_CameraActor__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 13);
	return; //KCST_EndOfThread
}
void ACameraActor_C__pf1295471953::bpf__EnteringLevel__pf()
{
	bpf__ExecuteUbergraph_CameraActor__pf_0(17);
}
void ACameraActor_C__pf1295471953::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_CameraActor__pf_2(15);
}
void ACameraActor_C__pf1295471953::bpf__Event__pf()
{
	bpf__ExecuteUbergraph_CameraActor__pf_3(14);
}
void ACameraActor_C__pf1295471953::bpf__MoveCamera__pf()
{
	bpf__ExecuteUbergraph_CameraActor__pf_4(13);
}
void ACameraActor_C__pf1295471953::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_CameraActor__pf_1(3);
}
void ACameraActor_C__pf1295471953::bpf__MoveCam__pf()
{
	...
	FHitResult bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_1__pf{};
	...
	APlayerWalkMap_Character_C__pf2222656877* bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_1__pf{};
	...
	FHitResult bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_2__pf{};
	...
	FHitResult bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_3__pf{};
	bool bpfv__CallFunc_K2_SetActorLocation_ReturnValue_3__pf{};
	APlayerWalkMap_Character_C__pf2222656877* bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_2__pf{};
	...
	APlayerWalkMap_Character_C__pf2222656877* bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_3__pf{};
	...
	FHitResult bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_4__pf{};
	bool bpfv__CallFunc_K2_SetActorLocation_ReturnValue_4__pf{};
	FVector bpfv__CallFunc_MakeVector_ReturnValue_5__pf(EForceInit::ForceInit);
	FHitResult bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_5__pf{};
	bool bpfv__CallFunc_K2_SetActorLocation_ReturnValue_5__pf{};
	float bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf{};
	float bpfv__CallFunc_Add_FloatFloat_ReturnValue_10__pf{};
	APlayerWalkMap_Character_C__pf2222656877* bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_4__pf{};
	...
	FHitResult bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_6__pf{};
	bool bpfv__CallFunc_K2_SetActorLocation_ReturnValue_6__pf{};
	...
	FHitResult bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_7__pf{};
	bool bpfv__CallFunc_K2_SetActorLocation_ReturnValue_7__pf{};
	...
	FHitResult bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_8__pf{};
	bool bpfv__CallFunc_K2_SetActorLocation_ReturnValue_8__pf{};
	...
	FHitResult bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_9__pf{};
	bool bpfv__CallFunc_K2_SetActorLocation_ReturnValue_9__pf{};
	...
	FHitResult bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_10__pf{};
	bool bpfv__CallFunc_K2_SetActorLocation_ReturnValue_10__pf{};
	...
	FHitResult bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_11__pf{};
	bool bpfv__CallFunc_K2_SetActorLocation_ReturnValue_11__pf{};
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator0));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 2;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator1));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 4;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator2));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 8;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator3));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 11;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator6));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator4));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 15;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator5));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 17;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator8));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 20;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpv__CameraType__pf), static_cast<uint8>(E__EnumCameraType__pf::NewEnumerator9));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 24;
					break;
		...
		case 2:
			{
				bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_4__pf = Cast<APlayerWalkMap_Character_C__pf2222656877>(bpv__Player__pf);
				bpfv__K2Node_DynamicCast_bSuccess_8__pf = (bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_4__pf != nullptr);;
		...
		case 3:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_4__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_8__pf = bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_4__pf->AActor::K2_GetActorLocation();
				}
				UKismetMathLibrary::BreakVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_8__pf, /*out*/ bpfv__CallFunc_BreakVector_X_8__pf, /*out*/ bpfv__CallFunc_BreakVector_Y_8__pf, /*out*/ bpfv__CallFunc_BreakVector_Z_8__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_11__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z_8__pf, 150.000000);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_12__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Y_8__pf, 1000.000000);
				bpfv__CallFunc_MakeVector_ReturnValue_7__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_BreakVector_X_8__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_12__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_11__pf);
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue_7__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_MakeVector_ReturnValue_7__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_7__pf, false);
				__CurrentState = -1;
				break;
			}
		case 4:
			{
				bpfv__K2Node_DynamicCast_AsThird_Person_Character_2__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpv__Player__pf);
		...
		case 5:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character_2__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_11__pf = bpfv__K2Node_DynamicCast_AsThird_Person_Character_2__pf->AActor::K2_GetActorLocation();
				}
				UKismetMathLibrary::BreakVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_11__pf, /*out*/ bpfv__CallFunc_BreakVector_X_11__pf, /*out*/ bpfv__CallFunc_BreakVector_Y_11__pf, /*out*/ bpfv__CallFunc_BreakVector_Z_11__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_17__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z_11__pf, bpv__CameraHeight__pf);
				bpfv__CallFunc_MakeVector_ReturnValue_11__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_BreakVector_X_11__pf, bpfv__CallFunc_BreakVector_Y_11__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_17__pf);
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue_11__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_MakeVector_ReturnValue_11__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_11__pf, false);
				__CurrentState = -1;
				break;
			}
		case 6:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__Player__pf);
				bpfv__K2Node_DynamicCast_bSuccess_10__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf != nullptr);;
		...
		case 7:
			{
				...
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_10__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->AActor::K2_GetActorLocation();
				}
				UKismetMathLibrary::BreakVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_10__pf, /*out*/ bpfv__CallFunc_BreakVector_X_10__pf, /*out*/ bpfv__CallFunc_BreakVector_Y_10__pf, /*out*/ bpfv__CallFunc_BreakVector_Z_10__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_16__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z_10__pf, bpv__CameraHeight__pf);
				bpfv__CallFunc_MakeVector_ReturnValue_10__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_BreakVector_X_10__pf, bpfv__CallFunc_BreakVector_Y_10__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_16__pf);
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue_10__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_MakeVector_ReturnValue_10__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_10__pf, false);
				__CurrentState = -1;
				break;
			}
		case 8:
			{
				bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf = Cast<APlayerWorldMap_Character_C__pf2222656877>(bpv__Player__pf);
				bpfv__K2Node_DynamicCast_bSuccess_9__pf = (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf != nullptr);;
		...
		case 9:
			{
				bpfv__CallFunc_K2_SetActorRotation_ReturnValue_1__pf = AActor::K2_SetActorRotation(FRotator(-60.000000,0.000000,0.000000), false);
			}
		case 10:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_9__pf = bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->AActor::K2_GetActorLocation();
				}
				UKismetMathLibrary::BreakVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_9__pf, /*out*/ bpfv__CallFunc_BreakVector_X_9__pf, /*out*/ bpfv__CallFunc_BreakVector_Y_9__pf, /*out*/ bpfv__CallFunc_BreakVector_Z_9__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_13__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z_9__pf, 700.000000);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_14__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_X_9__pf, -500.000000);
				bpfv__CallFunc_MakeVector_ReturnValue_8__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_Add_FloatFloat_ReturnValue_14__pf, bpfv__CallFunc_BreakVector_Y_9__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_13__pf);
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue_8__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_MakeVector_ReturnValue_8__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_8__pf, false);
				__CurrentState = -1;
				break;
			}
		case 11:
			{
				bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_3__pf = Cast<APlayerWalkMap_Character_C__pf2222656877>(bpv__Player__pf);
				bpfv__K2Node_DynamicCast_bSuccess_7__pf = (bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_3__pf != nullptr);;
		...
		case 12:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_3__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_7__pf = bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_3__pf->AActor::K2_GetActorLocation();
				}
				UKismetMathLibrary::BreakVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_7__pf, /*out*/ bpfv__CallFunc_BreakVector_X_7__pf, /*out*/ bpfv__CallFunc_BreakVector_Y_7__pf, /*out*/ bpfv__CallFunc_BreakVector_Z_7__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_8__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z_7__pf, 150.000000);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_9__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_X_7__pf, -1000.000000);
				bpfv__CallFunc_MakeVector_ReturnValue_5__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_Add_FloatFloat_ReturnValue_9__pf, bpfv__CallFunc_BreakVector_Y_7__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_8__pf);
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue_5__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_MakeVector_ReturnValue_5__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_5__pf, true);
				__CurrentState = -1;
				break;
			}
		case 13:
			{
				bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character__pf = Cast<APlayerWalkMap_Character_C__pf2222656877>(bpv__Player__pf);
				bpfv__K2Node_DynamicCast_bSuccess_4__pf = (bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character__pf != nullptr);;
		...
		case 14:
			{
				...
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_4__pf = bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character__pf->AActor::K2_GetActorLocation();
				}
				UKismetMathLibrary::BreakVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_4__pf, /*out*/ bpfv__CallFunc_BreakVector_X_4__pf, /*out*/ bpfv__CallFunc_BreakVector_Y_4__pf, /*out*/ bpfv__CallFunc_BreakVector_Z_4__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_2__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z_4__pf, 75.000000);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_3__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_X_4__pf, -250.000000);
				bpfv__CallFunc_MakeVector_ReturnValue_2__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_Add_FloatFloat_ReturnValue_3__pf, bpfv__CallFunc_BreakVector_Y_4__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_2__pf);
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue_2__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_MakeVector_ReturnValue_2__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_2__pf, true);
				__CurrentState = -1;
				break;
			}
		case 15:
			{
				bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_2__pf = Cast<APlayerWalkMap_Character_C__pf2222656877>(bpv__Player__pf);
				bpfv__K2Node_DynamicCast_bSuccess_6__pf = (bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_2__pf != nullptr);;
		...
		case 16:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_2__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_6__pf = bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_2__pf->AActor::K2_GetActorLocation();
				}
				UKismetMathLibrary::BreakVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_6__pf, /*out*/ bpfv__CallFunc_BreakVector_X_6__pf, /*out*/ bpfv__CallFunc_BreakVector_Y_6__pf, /*out*/ bpfv__CallFunc_BreakVector_Z_6__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_6__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z_6__pf, 150.000000);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_7__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_X_6__pf, 1000.000000);
				bpfv__CallFunc_MakeVector_ReturnValue_4__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_Add_FloatFloat_ReturnValue_7__pf, bpfv__CallFunc_BreakVector_Y_6__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_6__pf);
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue_4__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_MakeVector_ReturnValue_4__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_4__pf, true);
				__CurrentState = -1;
				break;
			}
		case 17:
			{
				bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_1__pf = Cast<APlayerWalkMap_Character_C__pf2222656877>(bpv__Player__pf);
				bpfv__K2Node_DynamicCast_bSuccess_5__pf = (bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_1__pf != nullptr);;
		...
		case 19:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_1__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_5__pf = bpfv__K2Node_DynamicCast_AsPlayer_Walk_Map_Character_1__pf->AActor::K2_GetActorLocation();
				}
				UKismetMathLibrary::BreakVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_5__pf, /*out*/ bpfv__CallFunc_BreakVector_X_5__pf, /*out*/ bpfv__CallFunc_BreakVector_Y_5__pf, /*out*/ bpfv__CallFunc_BreakVector_Z_5__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_4__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z_5__pf, 150.000000);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_5__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Y_5__pf, -1000.000000);
				bpfv__CallFunc_MakeVector_ReturnValue_3__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_BreakVector_X_5__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_5__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_4__pf);
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue_3__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_MakeVector_ReturnValue_3__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_3__pf, false);
				__CurrentState = -1;
				break;
			}
		case 20:
			{
				bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpv__Player__pf);
				bpfv__K2Node_DynamicCast_bSuccess_3__pf = (bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf != nullptr);;
		...
		case 21:
			{
				...
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_3__pf = bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf->AActor::K2_GetActorLocation();
				}
				UKismetMathLibrary::BreakVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_3__pf, /*out*/ bpfv__CallFunc_BreakVector_X_3__pf, /*out*/ bpfv__CallFunc_BreakVector_Y_3__pf, /*out*/ bpfv__CallFunc_BreakVector_Z_3__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z_3__pf, bpv__CameraHeightNF__pf);
				bpfv__CallFunc_MakeVector_ReturnValue_1__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_BreakVector_X_3__pf, bpfv__CallFunc_BreakVector_Y_3__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_1__pf);
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue_1__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_MakeVector_ReturnValue_1__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_1__pf, false);
				__CurrentState = -1;
				break;
			}
		case 22:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__Player__pf);
		...
		case 23:
			{
				...
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_2__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->AActor::K2_GetActorLocation();
				}
				UKismetMathLibrary::BreakVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_2__pf, /*out*/ bpfv__CallFunc_BreakVector_X_2__pf, /*out*/ bpfv__CallFunc_BreakVector_Y_2__pf, /*out*/ bpfv__CallFunc_BreakVector_Z_2__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z_2__pf, bpv__CameraHeightNF__pf);
				bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_BreakVector_X_2__pf, bpfv__CallFunc_BreakVector_Y_2__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf);
		...
		case 24:
			{
				bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpv__Player__pf);
		...
		case 25:
			{
				...
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf = bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf->AActor::K2_GetActorLocation();
				}
				UKismetMathLibrary::BreakVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf, /*out*/ bpfv__CallFunc_BreakVector_X_1__pf, /*out*/ bpfv__CallFunc_BreakVector_Y_1__pf, /*out*/ bpfv__CallFunc_BreakVector_Z_1__pf);
				bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_FloatFloat(bpv__CameraHeight__pf, 1.250000);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_10__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z_1__pf, bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf);
				bpfv__CallFunc_MakeVector_ReturnValue_6__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_BreakVector_X_1__pf, bpfv__CallFunc_BreakVector_Y_1__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_10__pf);
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue_6__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_MakeVector_ReturnValue_6__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_6__pf, false);
				__CurrentState = -1;
				break;
			}
		case 26:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__Player__pf);
		...
		case 27:
			{
				...
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->AActor::K2_GetActorLocation();
				}
				...
				bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::Multiply_FloatFloat(bpv__CameraHeight__pf, 1.250000);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_15__pf = UKismetMathLibrary::Add_FloatFloat(bpfv__CallFunc_BreakVector_Z__pf, bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_1__pf);
				bpfv__CallFunc_MakeVector_ReturnValue_9__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_BreakVector_X__pf, bpfv__CallFunc_BreakVector_Y__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_15__pf);
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue_9__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_MakeVector_ReturnValue_9__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocation_SweepHitResult_9__pf, false);
				__CurrentState = -1;
				break;
			}
		default:
...
PRAGMA_DISABLE_OPTIMIZATION
void ACameraActor_C__pf1295471953::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ACameraActor_C__pf1295471953::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{199, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Enum /Script/Engine.EMoveComponentAction 
		...
		{317, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.CameraComponent 
		{318, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.CameraActor 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ACameraActor_C__pf1295471953
{
	FRegisterHelper__ACameraActor_C__pf1295471953()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/CameraActor/CameraActor"), &ACameraActor_C__pf1295471953::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ACameraActor_C__pf1295471953 Instance;
};
FRegisterHelper__ACameraActor_C__pf1295471953 FRegisterHelper__ACameraActor_C__pf1295471953::Instance;
