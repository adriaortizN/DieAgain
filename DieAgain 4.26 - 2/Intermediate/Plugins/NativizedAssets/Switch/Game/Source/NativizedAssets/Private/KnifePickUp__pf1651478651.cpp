...
AKnifePickUp_C__pf1651478651::AKnifePickUp_C__pf1651478651(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__WeaponKnife__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("WeaponKnife"));
	...
	bpv__WeaponKnife__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__WeaponKnife__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__WeaponKnife__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AKnifePickUp_C__pf1651478651::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__WeaponKnife__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__WeaponKnife__pf->OverrideMaterials.Reserve(1);
	bpv__WeaponKnife__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AKnifePickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__WeaponKnife__pf->bReceivesDecals = false;
	auto& __Local__3 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__WeaponKnife__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__3 = ECollisionEnabled::Type::PhysicsOnly;
	auto& __Local__4 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__WeaponKnife__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__13.Channel = FName(TEXT("GunShoot"));
	...
	bpv__WeaponKnife__pf->BodyInstance.bSimulatePhysics = true;
	bpv__WeaponKnife__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__15 = (*(AccessPrivateProperty<FRotator >((bpv__WeaponKnife__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__15 = FRotator(0.000130, -0.000198, 269.999847);
	auto& __Local__16 = (*(AccessPrivateProperty<FVector >((bpv__WeaponKnife__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__16 = FVector(3.000000, 3.000000, 3.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__WeaponKnife__pf), true, 0));
	bpv__BoxCollision__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__BoxCollision__pf->AttachToComponent(bpv__WeaponKnife__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__BoxCollision__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__17 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__BoxCollision__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	auto& __Local__29 = (*(AccessPrivateProperty<FVector >((bpv__BoxCollision__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__29 = FVector(0.258345, 0.016492, -4.960228);
	auto& __Local__30 = (*(AccessPrivateProperty<FRotator >((bpv__BoxCollision__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__30 = FRotator(0.000109, -90.000092, 90.000191);
	auto& __Local__31 = (*(AccessPrivateProperty<FVector >((bpv__BoxCollision__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__31 = FVector(0.937500, 1.781250, 1.000000);
...
void AKnifePickUp_C__pf1651478651::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AKnifePickUp_C__pf1651478651::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto& __Local__34 = __Local__33->ComponentDelegateBindings[0];
	...
	__Local__34.FunctionNameToBind = FName(TEXT("BndEvt__BoxCollision_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
	auto& __Local__35 = __Local__33->ComponentDelegateBindings[1];
	...
	__Local__35.FunctionNameToBind = FName(TEXT("BndEvt__BoxCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AKnifePickUp_C__pf1651478651::bpf__ExecuteUbergraph_KnifePickUp__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 20:
			{
				if(::IsValid(bpv__WeaponKnife__pf))
				{
					bpv__WeaponKnife__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AKnifePickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
			}
		case 21:
			{
				AActor*  __Local__36 = ((AActor*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_5__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__OverlapingActor__pf) : (__Local__36)), this);
		...
		case 22:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__IsOverlapingActor__pf = false;
				}
			}
		case 23:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf))
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__OverlapingActor__pf = ((AActor*)nullptr);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 25:
			{
				AActor*  __Local__37 = ((AActor*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_4__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__OverlapingActor__pf) : (__Local__37)), this);
		...
		case 26:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__IsOverlapingActor__pf = false;
				}
			}
		case 27:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf))
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__OverlapingActor__pf = ((AActor*)nullptr);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 30:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_3__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->IsPlayerControlled();
				}
		...
		case 31:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_4__pf = (*(AccessPrivateProperty<APawn* >((b0l__K2Node_ComponentBoundEvent_OtherActor__pf), AActor::__PPO__Instigator() )))->IsPlayerControlled();
				}
		...
		case 33:
			{
				UBoxComponent*  __Local__38 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_2__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__BoxCollision__pf) : (__Local__38)), b0l__K2Node_ComponentBoundEvent_OtherComp__pf);
		...
		case 35:
			{
				...
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_3__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__BoxCollision__pf) : (__Local__39)), b0l__K2Node_ComponentBoundEvent_OtherComp__pf);
		...
		case 37:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_2__pf = b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf->IsPlayerControlled();
				}
...
void AKnifePickUp_C__pf1651478651::bpf__ExecuteUbergraph_KnifePickUp__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 6:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__IsSlave__pf) : (__Local__40)))
				{
					__CurrentState = 8;
					break;
				}
		...
		case 7:
			{
				bool  __Local__41 = false;
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__IsGodModeActive__pf) : (__Local__41)))
				{
					__CurrentState = -1;
					break;
				}
		...
		case 8:
			{
				UBoxComponent*  __Local__42 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__BoxCollision__pf) : (__Local__42)), b0l__K2Node_ComponentBoundEvent_OtherComp_1__pf);
		...
		case 9:
			{
				AActor*  __Local__43 = ((AActor*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__OverlapingActor__pf) : (__Local__43)));
		...
		case 13:
			{
				UBoxComponent*  __Local__44 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_1__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__BoxCollision__pf) : (__Local__44)), b0l__K2Node_ComponentBoundEvent_OtherComp_1__pf);
		...
		case 14:
			{
				AActor*  __Local__45 = ((AActor*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__OverlapingActor__pf) : (__Local__45)));
		...
		case 15:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__IsOverlapingActor__pf = true;
				}
			}
		case 16:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf))
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__OverlapingActor__pf = this;
				}
			}
		case 17:
			{
				if(::IsValid(bpv__WeaponKnife__pf))
				{
					bpv__WeaponKnife__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AKnifePickUp_C__pf1651478651::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 18:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__IsOverlapingActor__pf = true;
				}
			}
		case 19:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf))
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__OverlapingActor__pf = this;
				}
				__CurrentState = 17;
				break;
			}
...
void AKnifePickUp_C__pf1651478651::bpf__ExecuteUbergraph_KnifePickUp__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	if(::IsValid(bpv__WeaponKnife__pf))
	{
		bpfv__CallFunc_SetStaticMesh_ReturnValue__pf = bpv__WeaponKnife__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AKnifePickUp_C__pf1651478651::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
	}
	if(::IsValid(bpv__WeaponKnife__pf))
	{
		bpv__WeaponKnife__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AKnifePickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
...
void AKnifePickUp_C__pf1651478651::bpf__CleanPickUp__pf()
{
	bpf__ExecuteUbergraph_KnifePickUp__pf_0(42);
}
void AKnifePickUp_C__pf1651478651::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_KnifePickUp__pf_2(38);
}
void AKnifePickUp_C__pf1651478651::bpf__BndEvt__BoxCollision_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
...
void AKnifePickUp_C__pf1651478651::bpf__BndEvt__BoxCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_KnifePickUp__pf_1(1);
}
void AKnifePickUp_C__pf1651478651::bpf__Construction__pf(E__EnumWeapon__pf bpp__NewParam__pf)
{
		...
		case 2:
			{
				if(::IsValid(bpv__WeaponKnife__pf))
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue__pf = bpv__WeaponKnife__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AKnifePickUp_C__pf1651478651::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
				}
			}
		case 3:
			{
				if(::IsValid(bpv__WeaponKnife__pf))
				{
					bpv__WeaponKnife__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AKnifePickUp_C__pf1651478651::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed));
				}
			}
		case 4:
			{
		...
		case 5:
			{
				if(::IsValid(bpv__WeaponKnife__pf))
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue_1__pf = bpv__WeaponKnife__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AKnifePickUp_C__pf1651478651::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed));
				}
			}
		case 6:
			{
				if(::IsValid(bpv__WeaponKnife__pf))
				{
					bpv__WeaponKnife__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AKnifePickUp_C__pf1651478651::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed));
				}
			}
		case 7:
			{
...
void AKnifePickUp_C__pf1651478651::bpf__OverlapClean__pf(AActor* bpp__OldOverlapActor__pf)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AKnifePickUp_C__pf1651478651::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AKnifePickUp_C__pf1651478651::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AKnifePickUp_C__pf1651478651
{
	FRegisterHelper__AKnifePickUp_C__pf1651478651()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/PickUps/KnifePickUp"), &AKnifePickUp_C__pf1651478651::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AKnifePickUp_C__pf1651478651 Instance;
};
FRegisterHelper__AKnifePickUp_C__pf1651478651 FRegisterHelper__AKnifePickUp_C__pf1651478651::Instance;
