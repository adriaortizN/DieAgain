...
#include "LevelFinal_UnFinish_1__pf936270410.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/HUD/LevelFinal/LevelFinal_UnFinish_1.LevelFinal_UnFinish_1_C", OverrideNativeName="LevelFinal_UnFinish_1_C"))
class ULevelFinal_UnFinish_1_C__pf936270410 : public UGamepadInteraction_C__pf197907997
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_99", Category="LevelFinal_UnFinish_1", OverrideNativeName="Button_99"))
	...
	ULevelFinal_UnFinish_1_C__pf936270410(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_LevelFinal_UnFinish_1__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_UnFinish_1__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_UnFinish_1__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_UnFinish_1__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_UnFinish_1__pf_4(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_UnFinish_1__pf_5(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_UnFinish_1__pf_6(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_9BF65F5342D089E724814B851A6E1B75"))
	virtual void bpf__OnSuccess_9BF65F5342D089E724814B851A6E1B75__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_9BF65F5342D089E724814B851A6E1B75"))
	virtual void bpf__OnFailure_9BF65F5342D089E724814B851A6E1B75__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_E0FA66CA403D4944D7FB1FAC8DD8A6B4"))
	virtual void bpf__OnSuccess_E0FA66CA403D4944D7FB1FAC8DD8A6B4__pf();
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_E0FA66CA403D4944D7FB1FAC8DD8A6B4"))
	virtual void bpf__OnFailure_E0FA66CA403D4944D7FB1FAC8DD8A6B4__pf();
