...
#include "Table_Lamp__pf1894626796.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Art/DestructibleMesh/Table_Lamp.Table_Lamp_C", OverrideNativeName="Table_Lamp_C"))
class ATable_Lamp_C__pf1894626796 : public AActor
{
public:
	GENERATED_BODY()
	...
	ATable_Lamp_C__pf1894626796(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_Table_Lamp_0"))
	void bpf__ExecuteUbergraph_Table_Lamp__pf_0(int32 bpp__EntryPoint__pf);
