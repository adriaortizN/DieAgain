...
APossesionEffect_C__pf2815001878::APossesionEffect_C__pf2815001878(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__ParticleSystem__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(APossesionEffect_C__pf2815001878::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__2 = (*(AccessPrivateProperty<FVector >((bpv__ParticleSystem__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__2 = FVector(0.400000, 0.400000, 0.400000);
...
void APossesionEffect_C__pf2815001878::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APossesionEffect_C__pf2815001878::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void APossesionEffect_C__pf2815001878::bpf__ExecuteUbergraph_PossesionEffect__pf_0(int32 bpp__EntryPoint__pf)
{
	FVector bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf(EForceInit::ForceInit);
	bool bpfv__CallFunc_K2_SetActorLocation_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 6);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__ActorRef__pf))
	{
		bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = bpv__ActorRef__pf->AActor::K2_GetActorLocation();
	}
...
void APossesionEffect_C__pf2815001878::bpf__ExecuteUbergraph_PossesionEffect__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("FollowActor")));
		...
		case 5:
			{
				UKismetSystemLibrary::Delay(this, 2.000000, FLatentActionInfo(2, 885293681, TEXT("ExecuteUbergraph_PossesionEffect_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void APossesionEffect_C__pf2815001878::bpf__FollowActor__pf()
{
	bpf__ExecuteUbergraph_PossesionEffect__pf_0(6);
}
void APossesionEffect_C__pf2815001878::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_PossesionEffect__pf_1(3);
}
PRAGMA_DISABLE_OPTIMIZATION
void APossesionEffect_C__pf2815001878::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APossesionEffect_C__pf2815001878::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APossesionEffect_C__pf2815001878
{
	FRegisterHelper__APossesionEffect_C__pf2815001878()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/PossesionEffect/PossesionEffect"), &APossesionEffect_C__pf2815001878::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APossesionEffect_C__pf2815001878 Instance;
};
FRegisterHelper__APossesionEffect_C__pf2815001878 FRegisterHelper__APossesionEffect_C__pf2815001878::Instance;
