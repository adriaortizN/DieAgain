...
#include "LanguageHUD_Init__pf49154685.h"
...
ULanguageHUD_Init_C__pf49154685::ULanguageHUD_Init_C__pf49154685(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Button_Ca__pf = nullptr;
	bpv__Button_En__pf = nullptr;
...
void ULanguageHUD_Init_C__pf49154685::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ULanguageHUD_Init_C__pf49154685::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__8.ComponentPropertyName = FName(TEXT("Button_En"));
	__Local__8.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__8.FunctionNameToBind = FName(TEXT("BndEvt__Button_117_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__9 = __Local__0->ComponentDelegateBindings[7];
	__Local__9.ComponentPropertyName = FName(TEXT("Button_Ita"));
	__Local__9.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__9.FunctionNameToBind = FName(TEXT("BndEvt__Button_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__11.Reserve(9);
	auto __Local__12 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_6"), (EObjectFlags)0x00280008);
	__Local__12->LayoutData.Offsets.Left = -450.000000f;
	__Local__12->LayoutData.Offsets.Top = -276.540527f;
	__Local__12->LayoutData.Offsets.Right = 382.504700f;
	__Local__12->LayoutData.Offsets.Bottom = 214.629089f;
	...
	auto __Local__13 = NewObject<UButton>(__Local__1, TEXT("Button_En"), (EObjectFlags)0x00280008);
	__Local__13->WidgetStyle.Normal.ImageSize = FVector2D(1299.000000, 650.000000);
	...
	__Local__15 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__13->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__13->WidgetStyle.Hovered.ImageSize = FVector2D(1299.000000, 650.000000);
	auto& __Local__16 = (*(AccessPrivateProperty<UObject* >(&(__Local__13->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__16 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__13->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__13->WidgetStyle.Pressed.ImageSize = FVector2D(1299.000000, 650.000000);
	auto& __Local__17 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__13->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__17 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__18 = (*(AccessPrivateProperty<UObject* >(&(__Local__13->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__18 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__13->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__13->Slot = __Local__12;
	__Local__12->Content = __Local__13;
	__Local__11.Add(__Local__12);
	auto __Local__19 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_9"), (EObjectFlags)0x00280008);
	__Local__19->LayoutData.Offsets.Left = 56.000000f;
	__Local__19->LayoutData.Offsets.Top = -276.540527f;
	__Local__19->LayoutData.Offsets.Right = 382.504700f;
	__Local__19->LayoutData.Offsets.Bottom = 214.629089f;
	__Local__19->LayoutData.Anchors.Minimum = FVector2D(0.000000, 0.500000);
	__Local__19->LayoutData.Anchors.Maximum = FVector2D(0.000000, 0.500000);
	__Local__19->Parent = __Local__10;
	auto __Local__20 = NewObject<UButton>(__Local__1, TEXT("Button_Ita"), (EObjectFlags)0x00280008);
	__Local__20->WidgetStyle.Normal.ImageSize = FVector2D(1500.000000, 843.000000);
	...
	__Local__21 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__22 = (*(AccessPrivateProperty<UObject* >(&(__Local__20->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__22 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__20->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__20->WidgetStyle.Hovered.ImageSize = FVector2D(1500.000000, 843.000000);
	auto& __Local__23 = (*(AccessPrivateProperty<UObject* >(&(__Local__20->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__23 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__20->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__20->WidgetStyle.Pressed.ImageSize = FVector2D(1500.000000, 843.000000);
	auto& __Local__24 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__20->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__24 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__25 = (*(AccessPrivateProperty<UObject* >(&(__Local__20->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__25 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__20->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__20->Slot = __Local__19;
	__Local__19->Content = __Local__20;
	__Local__11.Add(__Local__19);
	auto __Local__26 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_2"), (EObjectFlags)0x00280008);
	__Local__26->LayoutData.Offsets.Left = -340.960938f;
	__Local__26->LayoutData.Offsets.Top = 100.000000f;
	__Local__26->LayoutData.Offsets.Right = 705.049561f;
	__Local__26->LayoutData.Offsets.Bottom = 90.060059f;
	__Local__26->LayoutData.Anchors.Minimum = FVector2D(0.500000, 0.000000);
	__Local__26->LayoutData.Anchors.Maximum = FVector2D(0.500000, 0.000000);
	__Local__26->Parent = __Local__10;
	auto __Local__27 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_64"), (EObjectFlags)0x00280008);
	__Local__27->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[F6D163684C72CDF46A3EF88E8EA757B9]\", \"859640F74D825B6A2C680AB276C5F056\", \"Choose the language\")")	);
	__Local__27->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__27->Font.OutlineSettings.OutlineSize = 2;
	...
	__Local__11.Add(__Local__26);
	auto __Local__28 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_7"), (EObjectFlags)0x00280008);
	__Local__28->LayoutData.Offsets.Left = 56.000000f;
	__Local__28->LayoutData.Offsets.Top = 70.000000f;
	__Local__28->LayoutData.Offsets.Right = 382.504700f;
	__Local__28->LayoutData.Offsets.Bottom = 214.629089f;
	__Local__28->LayoutData.Anchors.Minimum = FVector2D(0.000000, 0.500000);
	__Local__28->LayoutData.Anchors.Maximum = FVector2D(0.000000, 0.500000);
	__Local__28->Parent = __Local__10;
	auto __Local__29 = NewObject<UButton>(__Local__1, TEXT("Button_Es"), (EObjectFlags)0x00280008);
	__Local__29->WidgetStyle.Normal.ImageSize = FVector2D(750.000000, 500.000000);
	auto& __Local__30 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__29->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__30 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__31 = (*(AccessPrivateProperty<UObject* >(&(__Local__29->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__31 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__29->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__29->WidgetStyle.Hovered.ImageSize = FVector2D(750.000000, 500.000000);
	auto& __Local__32 = (*(AccessPrivateProperty<UObject* >(&(__Local__29->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__32 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__29->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__29->WidgetStyle.Pressed.ImageSize = FVector2D(750.000000, 500.000000);
	auto& __Local__33 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__29->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__33 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__34 = (*(AccessPrivateProperty<UObject* >(&(__Local__29->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__34 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	...
	auto __Local__35 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_3"), (EObjectFlags)0x00280008);
	__Local__35->LayoutData.Offsets.Left = -450.000000f;
	__Local__35->LayoutData.Offsets.Top = 70.000000f;
	__Local__35->LayoutData.Offsets.Right = 382.504700f;
	__Local__35->LayoutData.Offsets.Bottom = 214.629089f;
	...
	auto __Local__36 = NewObject<UButton>(__Local__1, TEXT("Button_pt"), (EObjectFlags)0x00280008);
	__Local__36->WidgetStyle.Normal.ImageSize = FVector2D(1500.000000, 1000.000000);
	...
	__Local__37 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__38 = (*(AccessPrivateProperty<UObject* >(&(__Local__36->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__38 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	__Local__36->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__36->WidgetStyle.Hovered.ImageSize = FVector2D(1500.000000, 1000.000000);
	auto& __Local__39 = (*(AccessPrivateProperty<UObject* >(&(__Local__36->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__39 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	__Local__36->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__36->WidgetStyle.Pressed.ImageSize = FVector2D(1500.000000, 1000.000000);
	auto& __Local__40 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__36->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__40 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__41 = (*(AccessPrivateProperty<UObject* >(&(__Local__36->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__41 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	...
	auto __Local__42 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_4"), (EObjectFlags)0x00280008);
	__Local__42->LayoutData.Offsets.Left = 19.000000f;
	__Local__42->LayoutData.Offsets.Top = -276.540527f;
	__Local__42->LayoutData.Offsets.Right = 382.504700f;
	__Local__42->LayoutData.Offsets.Bottom = 214.629089f;
	...
	__Local__42->Parent = __Local__10;
	auto __Local__43 = NewObject<UButton>(__Local__1, TEXT("Button_Ru"), (EObjectFlags)0x00280008);
	__Local__43->WidgetStyle.Normal.ImageSize = FVector2D(1280.000000, 853.000000);
	...
	__Local__44 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__45 = (*(AccessPrivateProperty<UObject* >(&(__Local__43->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__45 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	__Local__43->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__43->WidgetStyle.Hovered.ImageSize = FVector2D(1280.000000, 853.000000);
	auto& __Local__46 = (*(AccessPrivateProperty<UObject* >(&(__Local__43->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__46 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	__Local__43->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__43->WidgetStyle.Pressed.ImageSize = FVector2D(1280.000000, 853.000000);
	...
	__Local__47 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__48 = (*(AccessPrivateProperty<UObject* >(&(__Local__43->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__48 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	...
	__Local__11.Add(__Local__42);
	auto __Local__49 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_5"), (EObjectFlags)0x00280008);
	__Local__49->LayoutData.Offsets.Left = -470.000000f;
	__Local__49->LayoutData.Offsets.Top = -276.540527f;
	__Local__49->LayoutData.Offsets.Right = 382.504700f;
	__Local__49->LayoutData.Offsets.Bottom = 214.629089f;
	__Local__49->LayoutData.Anchors.Minimum = FVector2D(1.000000, 0.500000);
	__Local__49->LayoutData.Anchors.Maximum = FVector2D(1.000000, 0.500000);
	__Local__49->Parent = __Local__10;
	auto __Local__50 = NewObject<UButton>(__Local__1, TEXT("Button_Zh"), (EObjectFlags)0x00280008);
	__Local__50->WidgetStyle.Normal.ImageSize = FVector2D(1920.000000, 1280.000000);
	auto& __Local__51 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__50->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__51 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__52 = (*(AccessPrivateProperty<UObject* >(&(__Local__50->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__52 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
	__Local__50->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__50->WidgetStyle.Hovered.ImageSize = FVector2D(1920.000000, 1280.000000);
	auto& __Local__53 = (*(AccessPrivateProperty<UObject* >(&(__Local__50->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__53 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
	__Local__50->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__50->WidgetStyle.Pressed.ImageSize = FVector2D(1920.000000, 1280.000000);
	auto& __Local__54 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__50->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__54 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__55 = (*(AccessPrivateProperty<UObject* >(&(__Local__50->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__55 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
	__Local__50->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__50->Slot = __Local__49;
	__Local__49->Content = __Local__50;
	__Local__11.Add(__Local__49);
	auto __Local__56 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_0"), (EObjectFlags)0x00280008);
	__Local__56->LayoutData.Offsets.Left = 19.000000f;
	__Local__56->LayoutData.Offsets.Top = 70.000000f;
	__Local__56->LayoutData.Offsets.Right = 382.504700f;
	__Local__56->LayoutData.Offsets.Bottom = 214.629089f;
	...
	auto __Local__57 = NewObject<UButton>(__Local__1, TEXT("Button_Ca"), (EObjectFlags)0x00280008);
	__Local__57->WidgetStyle.Normal.ImageSize = FVector2D(810.000000, 539.000000);
	...
	__Local__58 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__59 = (*(AccessPrivateProperty<UObject* >(&(__Local__57->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__59 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
	__Local__57->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__57->WidgetStyle.Hovered.ImageSize = FVector2D(810.000000, 539.000000);
	auto& __Local__60 = (*(AccessPrivateProperty<UObject* >(&(__Local__57->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__60 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
	__Local__57->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__57->WidgetStyle.Pressed.ImageSize = FVector2D(810.000000, 539.000000);
	...
	__Local__61 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__62 = (*(AccessPrivateProperty<UObject* >(&(__Local__57->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__62 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
	...
	auto __Local__63 = NewObject<UCanvasPanelSlot>(__Local__10, TEXT("CanvasPanelSlot_8"), (EObjectFlags)0x00280008);
	__Local__63->LayoutData.Offsets.Left = -470.000000f;
	__Local__63->LayoutData.Offsets.Top = 70.000000f;
	__Local__63->LayoutData.Offsets.Right = 382.504700f;
	__Local__63->LayoutData.Offsets.Bottom = 214.629089f;
	__Local__63->LayoutData.Anchors.Minimum = FVector2D(1.000000, 0.500000);
	__Local__63->LayoutData.Anchors.Maximum = FVector2D(1.000000, 0.500000);
	__Local__63->Parent = __Local__10;
	auto __Local__64 = NewObject<UButton>(__Local__1, TEXT("Button_Fr"), (EObjectFlags)0x00280008);
	__Local__64->WidgetStyle.Normal.ImageSize = FVector2D(1920.000000, 1280.000000);
	...
	__Local__65 = FLinearColor(1.000000, 1.000000, 1.000000, 0.500000);
	auto& __Local__66 = (*(AccessPrivateProperty<UObject* >(&(__Local__64->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__66 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
	__Local__64->WidgetStyle.Normal.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__64->WidgetStyle.Hovered.ImageSize = FVector2D(1920.000000, 1280.000000);
	auto& __Local__67 = (*(AccessPrivateProperty<UObject* >(&(__Local__64->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__67 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
	__Local__64->WidgetStyle.Hovered.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__64->WidgetStyle.Pressed.ImageSize = FVector2D(1920.000000, 1280.000000);
	auto& __Local__68 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__64->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__68 = FLinearColor(1.000000, 1.000000, 1.000000, 0.250000);
	auto& __Local__69 = (*(AccessPrivateProperty<UObject* >(&(__Local__64->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__69 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
	__Local__64->WidgetStyle.Pressed.DrawAs = ESlateBrushDrawType::Type::Image;
	__Local__64->Slot = __Local__63;
	__Local__63->Content = __Local__64;
	__Local__11.Add(__Local__63);
	__Local__1->RootWidget = __Local__10;
}
PRAGMA_ENABLE_OPTIMIZATION
void ULanguageHUD_Init_C__pf49154685::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__70;
	SlotNames.Append(__Local__70);
}
void ULanguageHUD_Init_C__pf49154685::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__71;
	TArray<FDelegateRuntimeBinding>  __Local__72;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(ULanguageHUD_Init_C__pf49154685::StaticClass())->MiscConvertedSubobjects[0]), __Local__71, __Local__72);
}
void ULanguageHUD_Init_C__pf49154685::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void ULanguageHUD_Init_C__pf49154685::bpf__ExecuteUbergraph_LanguageHUD_Init__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 11:
			{
				UGameplayStatics::OpenLevel(this, FName(TEXT("MainMenu_LV")), true, FString(TEXT("")));
				__CurrentState = -1;
				break;
			}
		case 12:
...
void ULanguageHUD_Init_C__pf49154685::bpf__ExecuteUbergraph_LanguageHUD_Init__pf_1(int32 bpp__EntryPoint__pf)
{
		...
		case 3:
			{
				...
				TEnumAsByte<ESlateColorStylingMode::Type>  __Local__73 = ESlateColorStylingMode::UseColor_Specified;
				(*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__K2Node_MakeStruct_SlateColor_2__pf), FSlateColor::__PPO__ColorUseRule() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.TintColor), FSlateColor::__PPO__ColorUseRule() )))) : (__Local__73));
				...
				TEnumAsByte<ESlateColorStylingMode::Type>  __Local__74 = ESlateColorStylingMode::UseColor_Specified;
				(*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__K2Node_MakeStruct_SlateColor_3__pf), FSlateColor::__PPO__ColorUseRule() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__ColorUseRule() )))) : (__Local__74));
				FVector2D  __Local__75 = FVector2D(0.000000,0.000000);
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.ImageSize = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.ImageSize) : (__Local__75));
				auto __Local__77 = FMargin{};
				FMargin  __Local__76 = __Local__77;
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.Margin = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Margin) : (__Local__76));
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.TintColor = b1l__K2Node_MakeStruct_SlateColor_2__pf;
				UObject*  __Local__78 = ((UObject*)nullptr);
				(*(AccessPrivateProperty<UObject* >(&(b1l__K2Node_MakeStruct_SlateBrush_2__pf), FSlateBrush::__PPO__ResourceObject() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<UObject* >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )))) : (__Local__78));
				TEnumAsByte<ESlateBrushDrawType::Type>  __Local__79 = ESlateBrushDrawType::NoDrawType;
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.DrawAs = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.DrawAs) : (__Local__79));
				TEnumAsByte<ESlateBrushTileType::Type>  __Local__80 = ESlateBrushTileType::NoTile;
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.Tiling = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Tiling) : (__Local__80));
				TEnumAsByte<ESlateBrushMirrorType::Type>  __Local__81 = ESlateBrushMirrorType::NoMirror;
				b1l__K2Node_MakeStruct_SlateBrush_2__pf.Mirroring = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Mirroring) : (__Local__81));
				FVector2D  __Local__82 = FVector2D(0.000000,0.000000);
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.ImageSize = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.ImageSize) : (__Local__82));
				auto __Local__84 = FMargin{};
				FMargin  __Local__83 = __Local__84;
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.Margin = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Margin) : (__Local__83));
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.TintColor = b1l__K2Node_MakeStruct_SlateColor_3__pf;
				UObject*  __Local__85 = ((UObject*)nullptr);
				(*(AccessPrivateProperty<UObject* >(&(b1l__K2Node_MakeStruct_SlateBrush_3__pf), FSlateBrush::__PPO__ResourceObject() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<UObject* >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )))) : (__Local__85));
				TEnumAsByte<ESlateBrushDrawType::Type>  __Local__86 = ESlateBrushDrawType::NoDrawType;
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.DrawAs = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.DrawAs) : (__Local__86));
				TEnumAsByte<ESlateBrushTileType::Type>  __Local__87 = ESlateBrushTileType::NoTile;
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.Tiling = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Tiling) : (__Local__87));
				TEnumAsByte<ESlateBrushMirrorType::Type>  __Local__88 = ESlateBrushMirrorType::NoMirror;
				b1l__K2Node_MakeStruct_SlateBrush_3__pf.Mirroring = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Mirroring) : (__Local__88));
				...
				auto __Local__90 = FSlateBrush{};
				FSlateBrush  __Local__89 = __Local__90;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.Pressed = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Pressed) : (__Local__89));
				auto __Local__92 = FSlateBrush{};
				FSlateBrush  __Local__91 = __Local__92;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.Disabled = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Disabled) : (__Local__91));
				auto __Local__94 = FMargin{};
				FMargin  __Local__93 = __Local__94;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.NormalPadding = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.NormalPadding) : (__Local__93));
				auto __Local__96 = FMargin{};
				FMargin  __Local__95 = __Local__96;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.PressedPadding = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.PressedPadding) : (__Local__95));
				auto __Local__98 = FSlateSound{};
				FSlateSound  __Local__97 = __Local__98;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.PressedSlateSound = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.PressedSlateSound) : (__Local__97));
				auto __Local__100 = FSlateSound{};
				FSlateSound  __Local__99 = __Local__100;
				b1l__K2Node_MakeStruct_ButtonStyle_1__pf.HoveredSlateSound = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.HoveredSlateSound) : (__Local__99));
				if(::IsValid(b1l__CallFunc_Array_Get_Item__pf))
				{
		...
		case 7:
			{
				...
				TEnumAsByte<ESlateColorStylingMode::Type>  __Local__101 = ESlateColorStylingMode::UseColor_Specified;
				(*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__K2Node_MakeStruct_SlateColor__pf), FSlateColor::__PPO__ColorUseRule() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.TintColor), FSlateColor::__PPO__ColorUseRule() )))) : (__Local__101));
				...
				TEnumAsByte<ESlateColorStylingMode::Type>  __Local__102 = ESlateColorStylingMode::UseColor_Specified;
				(*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__K2Node_MakeStruct_SlateColor_1__pf), FSlateColor::__PPO__ColorUseRule() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<TEnumAsByte<ESlateColorStylingMode::Type> >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__ColorUseRule() )))) : (__Local__102));
				FVector2D  __Local__103 = FVector2D(0.000000,0.000000);
				b1l__K2Node_MakeStruct_SlateBrush__pf.ImageSize = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.ImageSize) : (__Local__103));
				auto __Local__105 = FMargin{};
				FMargin  __Local__104 = __Local__105;
				b1l__K2Node_MakeStruct_SlateBrush__pf.Margin = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Margin) : (__Local__104));
				b1l__K2Node_MakeStruct_SlateBrush__pf.TintColor = b1l__K2Node_MakeStruct_SlateColor__pf;
				UObject*  __Local__106 = ((UObject*)nullptr);
				(*(AccessPrivateProperty<UObject* >(&(b1l__K2Node_MakeStruct_SlateBrush__pf), FSlateBrush::__PPO__ResourceObject() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<UObject* >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )))) : (__Local__106));
				TEnumAsByte<ESlateBrushDrawType::Type>  __Local__107 = ESlateBrushDrawType::NoDrawType;
				b1l__K2Node_MakeStruct_SlateBrush__pf.DrawAs = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.DrawAs) : (__Local__107));
				TEnumAsByte<ESlateBrushTileType::Type>  __Local__108 = ESlateBrushTileType::NoTile;
				b1l__K2Node_MakeStruct_SlateBrush__pf.Tiling = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Tiling) : (__Local__108));
				TEnumAsByte<ESlateBrushMirrorType::Type>  __Local__109 = ESlateBrushMirrorType::NoMirror;
				b1l__K2Node_MakeStruct_SlateBrush__pf.Mirroring = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Hovered.Mirroring) : (__Local__109));
				FVector2D  __Local__110 = FVector2D(0.000000,0.000000);
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.ImageSize = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.ImageSize) : (__Local__110));
				auto __Local__112 = FMargin{};
				FMargin  __Local__111 = __Local__112;
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.Margin = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Margin) : (__Local__111));
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.TintColor = b1l__K2Node_MakeStruct_SlateColor_1__pf;
				UObject*  __Local__113 = ((UObject*)nullptr);
				(*(AccessPrivateProperty<UObject* >(&(b1l__K2Node_MakeStruct_SlateBrush_1__pf), FSlateBrush::__PPO__ResourceObject() ))) = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? ((*(AccessPrivateProperty<UObject* >(&(b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )))) : (__Local__113));
				TEnumAsByte<ESlateBrushDrawType::Type>  __Local__114 = ESlateBrushDrawType::NoDrawType;
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.DrawAs = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.DrawAs) : (__Local__114));
				TEnumAsByte<ESlateBrushTileType::Type>  __Local__115 = ESlateBrushTileType::NoTile;
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.Tiling = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Tiling) : (__Local__115));
				TEnumAsByte<ESlateBrushMirrorType::Type>  __Local__116 = ESlateBrushMirrorType::NoMirror;
				b1l__K2Node_MakeStruct_SlateBrush_1__pf.Mirroring = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Normal.Mirroring) : (__Local__116));
				...
				auto __Local__118 = FSlateBrush{};
				FSlateBrush  __Local__117 = __Local__118;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.Pressed = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Pressed) : (__Local__117));
				auto __Local__120 = FSlateBrush{};
				FSlateBrush  __Local__119 = __Local__120;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.Disabled = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.Disabled) : (__Local__119));
				auto __Local__122 = FMargin{};
				FMargin  __Local__121 = __Local__122;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.NormalPadding = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.NormalPadding) : (__Local__121));
				auto __Local__124 = FMargin{};
				FMargin  __Local__123 = __Local__124;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.PressedPadding = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.PressedPadding) : (__Local__123));
				auto __Local__126 = FSlateSound{};
				FSlateSound  __Local__125 = __Local__126;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.PressedSlateSound = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.PressedSlateSound) : (__Local__125));
				auto __Local__128 = FSlateSound{};
				FSlateSound  __Local__127 = __Local__128;
				b1l__K2Node_MakeStruct_ButtonStyle__pf.HoveredSlateSound = ((::IsValid(b1l__CallFunc_Array_Get_Item__pf)) ? (b1l__CallFunc_Array_Get_Item__pf->WidgetStyle.HoveredSlateSound) : (__Local__127));
				if(::IsValid(b1l__CallFunc_Array_Get_Item__pf))
				{
...
void ULanguageHUD_Init_C__pf49154685::bpf__ExecuteUbergraph_LanguageHUD_Init__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	b1l__K2Node_MakeArray_Array__pf[1] = bpv__Button_Ca__pf;
	b1l__K2Node_MakeArray_Array__pf[2] = bpv__Button_En__pf;
	b1l__K2Node_MakeArray_Array__pf[3] = bpv__Button_Es__pf;
	b1l__K2Node_MakeArray_Array__pf[4] = bpv__Button_pt__pf;
	b1l__K2Node_MakeArray_Array__pf[5] = bpv__Button_Ru__pf;
	b1l__K2Node_MakeArray_Array__pf[6] = bpv__Button_Zh__pf;
...
void ULanguageHUD_Init_C__pf49154685::bpf__ExecuteUbergraph_LanguageHUD_Init__pf_3(int32 bpp__EntryPoint__pf)
{
...
void ULanguageHUD_Init_C__pf49154685::bpf__BndEvt__Button_Fr_K2Node_ComponentBoundEvent_7_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD_Init__pf_0(31);
}
void ULanguageHUD_Init_C__pf49154685::bpf__UpdateFocus__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD_Init__pf_1(30);
}
void ULanguageHUD_Init_C__pf49154685::bpf__BndEvt__Button_Ca_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD_Init__pf_0(28);
}
void ULanguageHUD_Init_C__pf49154685::bpf__BndEvt__Button_Zh_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD_Init__pf_0(26);
}
void ULanguageHUD_Init_C__pf49154685::bpf__BndEvt__Button_Ru_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD_Init__pf_0(24);
}
void ULanguageHUD_Init_C__pf49154685::bpf__BndEvt__Button_2_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD_Init__pf_0(23);
}
void ULanguageHUD_Init_C__pf49154685::bpf__BndEvt__Button_1_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD_Init__pf_0(21);
}
void ULanguageHUD_Init_C__pf49154685::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD_Init__pf_2(17);
}
void ULanguageHUD_Init_C__pf49154685::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_LanguageHUD_Init__pf_3(15);
}
void ULanguageHUD_Init_C__pf49154685::bpf__BndEvt__Button_117_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD_Init__pf_0(12);
}
void ULanguageHUD_Init_C__pf49154685::bpf__BndEvt__Button_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LanguageHUD_Init__pf_0(9);
}
PRAGMA_DISABLE_OPTIMIZATION
void ULanguageHUD_Init_C__pf49154685::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ULanguageHUD_Init_C__pf49154685::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ULanguageHUD_Init_C__pf49154685
{
	FRegisterHelper__ULanguageHUD_Init_C__pf49154685()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/LanguageHUD/LanguageHUD_Init"), &ULanguageHUD_Init_C__pf49154685::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ULanguageHUD_Init_C__pf49154685 Instance;
};
FRegisterHelper__ULanguageHUD_Init_C__pf49154685 FRegisterHelper__ULanguageHUD_Init_C__pf49154685::Instance;
