...
class AActor;
#include "BP_LabDoor01__pf3126018767.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/ScienceLab/Blueprints/Rooms/Doors/BP_LabDoor01.BP_LabDoor01_C", OverrideNativeName="BP_LabDoor01_C"))
class ABP_LabDoor01_C__pf3126018767 : public AActor
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="LabDoor01"))
	UStaticMeshComponent* bpv__LabDoor01__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="LabDoorjamb01"))
	UStaticMeshComponent* bpv__LabDoorjamb01__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="DefaultSceneRoot"))
	USceneComponent* bpv__DefaultSceneRoot__pf;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(DisplayName="Door Position", Category="Default", UIMin="0", UIMax="105", OverrideNativeName="DoorPosition"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(DisplayName="Door Mesh", Category="Default", UIMin="0", UIMax="1", OverrideNativeName="Door Mesh"))
	int32 bpv__DoorxMesh__pfT;
	...
	ABP_LabDoor01_C__pf3126018767(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BP_LabDoor01__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_LabDoor01__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_LabDoor01__pf_2(int32 bpp__EntryPoint__pf);
