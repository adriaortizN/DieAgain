...
ARPGPickUp_C__pf1651478651::ARPGPickUp_C__pf1651478651(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__WeaponRPG__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("WeaponRPG"));
	...
	bpv__WeaponRPG__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__WeaponRPG__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__WeaponRPG__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__WeaponRPG__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__WeaponRPG__pf->OverrideMaterials.Reserve(2);
	bpv__WeaponRPG__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__WeaponRPG__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	bpv__WeaponRPG__pf->bReceivesDecals = false;
	auto& __Local__3 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__WeaponRPG__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__3 = ECollisionEnabled::Type::PhysicsOnly;
	auto& __Local__4 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__WeaponRPG__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__12.Channel = FName(TEXT("OverlapShoot"));
	...
	bpv__WeaponRPG__pf->BodyInstance.bSimulatePhysics = true;
	bpv__WeaponRPG__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__15 = (*(AccessPrivateProperty<FRotator >((bpv__WeaponRPG__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__15 = FRotator(0.000266, 0.000526, 630.000000);
	auto& __Local__16 = (*(AccessPrivateProperty<FVector >((bpv__WeaponRPG__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__16 = FVector(6.000000, 6.000000, 6.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__WeaponRPG__pf), false, 0));
	bpv__BoxCollision__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__BoxCollision__pf->AttachToComponent(bpv__WeaponRPG__pf, FAttachmentTransformRules::KeepRelativeTransform );
	...
	__Local__29 = FVector(4.467143, 21.332752, 0.000011);
	auto& __Local__30 = (*(AccessPrivateProperty<FRotator >((bpv__BoxCollision__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__30 = FRotator(-0.000014, 0.000000, 0.000005);
	auto& __Local__31 = (*(AccessPrivateProperty<FVector >((bpv__BoxCollision__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__31 = FVector(1.312500, 0.843750, 0.500000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__BoxCollision__pf), false, 0));
	bpv__Munition__pf = 1;
	bpv__WeaponType__pf = E__EnumWeapon__pf::NewEnumerator5;
...
void ARPGPickUp_C__pf1651478651::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ARPGPickUp_C__pf1651478651::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ARPGPickUp_C__pf1651478651::bpf__ExecuteUbergraph_RPGPickUp__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 9:
			{
				if(::IsValid(bpv__WeaponRPG__pf))
				{
					bpv__WeaponRPG__pf->SetMaterial(2, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
				}
			}
		case 10:
			{
				AActor*  __Local__36 = ((AActor*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_5__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf->bpv__OverlapingActor__pf) : (__Local__36)), this);
		...
		case 13:
			{
				if(::IsValid(bpv__WeaponRPG__pf))
				{
					bpv__WeaponRPG__pf->SetMaterial(1, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
				}
				__CurrentState = 9;
				break;
			}
		case 14:
			{
				if(::IsValid(bpv__WeaponRPG__pf))
				{
					bpv__WeaponRPG__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
				__CurrentState = 13;
				break;
			}
		...
		case 16:
			{
				...
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_4__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__OverlapingActor__pf) : (__Local__37)), this);
		...
		case 46:
			{
				...
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_1__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__BoxCollision__pf) : (__Local__38)), b0l__K2Node_ComponentBoundEvent_OtherComp__pf);
		...
		case 48:
			{
				...
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf->bpv__BoxCollision__pf) : (__Local__39)), b0l__K2Node_ComponentBoundEvent_OtherComp__pf);
		...
		case 56:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_4__pf = b0l__K2Node_DynamicCast_AsThird_Person_Character_4__pf->IsPlayerControlled();
				}
		...
		case 58:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_5__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf->IsPlayerControlled();
				}
...
void ARPGPickUp_C__pf1651478651::bpf__ExecuteUbergraph_RPGPickUp__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__Munition__pf, 0);
		...
		case 3:
			{
				if(::IsValid(bpv__WeaponRPG__pf))
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue_1__pf = bpv__WeaponRPG__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
				}
			}
		case 4:
			{
		...
		case 7:
			{
				bpv__Munition__pf = bpv__Munition__pf;
				__CurrentState = -1;
				break;
			}
		case 8:
			{
				if(::IsValid(bpv__WeaponRPG__pf))
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue__pf = bpv__WeaponRPG__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed));
				}
				__CurrentState = 4;
				break;
			}
		...
		case 52:
			{
				UKismetSystemLibrary::Delay(this, 0.030000, FLatentActionInfo(1, 50889092, TEXT("ExecuteUbergraph_RPGPickUp_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void ARPGPickUp_C__pf1651478651::bpf__ExecuteUbergraph_RPGPickUp__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 26:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__IsSlave__pf) : (__Local__41)))
				{
					__CurrentState = 28;
					break;
				}
		...
		case 27:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__IsGodModeActive__pf) : (__Local__42)))
				{
					__CurrentState = -1;
					break;
				}
		...
		case 28:
			{
				UBoxComponent*  __Local__43 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_2__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__BoxCollision__pf) : (__Local__43)), b0l__K2Node_ComponentBoundEvent_OtherComp_1__pf);
		...
		case 29:
			{
				AActor*  __Local__44 = ((AActor*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__OverlapingActor__pf) : (__Local__44)));
		...
		case 33:
			{
				UBoxComponent*  __Local__45 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_3__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__BoxCollision__pf) : (__Local__45)), b0l__K2Node_ComponentBoundEvent_OtherComp_1__pf);
		...
		case 34:
			{
				AActor*  __Local__46 = ((AActor*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__OverlapingActor__pf) : (__Local__46)));
		...
		case 37:
			{
				if(::IsValid(bpv__WeaponRPG__pf))
				{
					bpv__WeaponRPG__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed));
				}
			}
		case 38:
			{
				if(::IsValid(bpv__WeaponRPG__pf))
				{
					bpv__WeaponRPG__pf->SetMaterial(1, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed));
				}
			}
		case 39:
			{
				if(::IsValid(bpv__WeaponRPG__pf))
				{
					bpv__WeaponRPG__pf->SetMaterial(2, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
...
void ARPGPickUp_C__pf1651478651::bpf__CleanPickUp__pf()
{
	bpf__ExecuteUbergraph_RPGPickUp__pf_0(53);
}
void ARPGPickUp_C__pf1651478651::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_RPGPickUp__pf_1(51);
}
void ARPGPickUp_C__pf1651478651::bpf__BndEvt__BoxCollision_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
	...
	bpf__ExecuteUbergraph_RPGPickUp__pf_0(42);
}
void ARPGPickUp_C__pf1651478651::bpf__BndEvt__BoxCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	typedef FHitResult  T__Local__47;
	T__Local__47& bpp__SweepResult__pf = *const_cast<T__Local__47 *>(&bpp__SweepResult__pf__const);
	...
	bpf__ExecuteUbergraph_RPGPickUp__pf_2(21);
}
void ARPGPickUp_C__pf1651478651::bpf__Construction__pf(E__EnumWeapon__pf bpp__NewParam__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator0), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator0));
		...
		case 2:
			{
				if(::IsValid(bpv__WeaponRPG__pf))
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue__pf = bpv__WeaponRPG__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed));
				}
			}
		case 3:
			{
				if(::IsValid(bpv__WeaponRPG__pf))
				{
					bpv__WeaponRPG__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARPGPickUp_C__pf1651478651::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed));
				}
			}
		case 4:
			{
...
void ARPGPickUp_C__pf1651478651::bpf__OverlapClean__pf(AActor* bpp__OldOverlapActor__pf)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ARPGPickUp_C__pf1651478651::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ARPGPickUp_C__pf1651478651::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ARPGPickUp_C__pf1651478651
{
	FRegisterHelper__ARPGPickUp_C__pf1651478651()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/PickUps/RPGPickUp"), &ARPGPickUp_C__pf1651478651::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ARPGPickUp_C__pf1651478651 Instance;
};
FRegisterHelper__ARPGPickUp_C__pf1651478651 FRegisterHelper__ARPGPickUp_C__pf1651478651::Instance;
