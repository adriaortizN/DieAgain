...
#include "NorthernFront_ActivateDLC__pf1010915279.h"
...
ANorthernFront_ActivateDLC_C__pf1010915279::ANorthernFront_ActivateDLC_C__pf1010915279(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ANorthernFront_ActivateDLC_C__pf1010915279::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ANorthernFront_ActivateDLC_C__pf1010915279::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	bpv__FMODAudio__pf->Event = CastChecked<UFMODEvent>(CastChecked<UDynamicClass>(ANorthernFront_ActivateDLC_C__pf1010915279::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
...
void ANorthernFront_ActivateDLC_C__pf1010915279::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ANorthernFront_ActivateDLC_C__pf1010915279::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ANorthernFront_ActivateDLC_C__pf1010915279::bpf__ExecuteUbergraph_NorthernFront_ActivateDLC__pf_0(int32 bpp__EntryPoint__pf)
{
	UGameInstance* bpfv__CallFunc_GetGameInstance_ReturnValue__pf{};
	bool bpfv__CallFunc_FileExists_ReturnValue__pf{};
	...
	do
	{
		...
		case 1:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("DLC IS NOT ACTIVE")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		case 2:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("DLC IS ACTIVE")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		case 3:
		...
		case 4:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__IsNorthernFrontActive__pf = true;
				}
				__CurrentState = 2;
				break;
			}
		...
		case 6:
			{
				bpfv__CallFunc_FileExists_ReturnValue__pf = UBlueprintPathsLibrary::FileExists(FString(TEXT("../../../DieAgain/Content/Paks/NorthernFront.pak")));
				if (!bpfv__CallFunc_FileExists_ReturnValue__pf)
				{
					__CurrentState = 7;
					break;
				}
		...
		case 7:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsMy_Game_Instance_1__pf != nullptr);;
		...
		case 8:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMy_Game_Instance_1__pf->bpv__IsNorthernFrontActive__pf = false;
				}
				__CurrentState = 1;
				break;
			}
...
void ANorthernFront_ActivateDLC_C__pf1010915279::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_NorthernFront_ActivateDLC__pf_0(5);
}
PRAGMA_DISABLE_OPTIMIZATION
void ANorthernFront_ActivateDLC_C__pf1010915279::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{1029, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  FMODEvent /Game/FMOD/Events/Sounds/LevelsMusic/MainMenu/MainMenuMusic.MainMenuMusic 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ANorthernFront_ActivateDLC_C__pf1010915279::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{1030, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.BlueprintPathsLibrary 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ANorthernFront_ActivateDLC_C__pf1010915279
{
	FRegisterHelper__ANorthernFront_ActivateDLC_C__pf1010915279()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/NorthernFront_ActivateDLC"), &ANorthernFront_ActivateDLC_C__pf1010915279::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ANorthernFront_ActivateDLC_C__pf1010915279 Instance;
};
FRegisterHelper__ANorthernFront_ActivateDLC_C__pf1010915279 FRegisterHelper__ANorthernFront_ActivateDLC_C__pf1010915279::Instance;
