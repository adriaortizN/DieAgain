...
#include "FlyingPlaneSpawner__pf270550447.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Objects/FlyingPlane/FlyingPlaneSpawner.FlyingPlaneSpawner_C", OverrideNativeName="FlyingPlaneSpawner_C"))
class AFlyingPlaneSpawner_C__pf270550447 : public AActor
{
public:
	GENERATED_BODY()
	...
	float bpv__Time__pf;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(DisplayName="Is Only One Plane", Category="Default", MultiLine="true", OverrideNativeName="IsOnlyOnePlane"))
	bool bpv__IsOnlyOnePlane__pf;
	...
	AFlyingPlaneSpawner_C__pf270550447(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_FlyingPlaneSpawner__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_FlyingPlaneSpawner__pf_1(int32 bpp__EntryPoint__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="SpawnPlane"))
	virtual void bpf__SpawnPlane__pf();
