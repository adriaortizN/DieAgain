...
#include "SetPlayerFocus__pf681293266.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Enemies/BehaviorShooting/SetPlayerFocus.SetPlayerFocus_C", OverrideNativeName="SetPlayerFocus_C"))
class USetPlayerFocus_C__pf681293266 : public UBTTask_BlueprintBase
{
public:
	GENERATED_BODY()
	...
	USetPlayerFocus_C__pf681293266(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_SetPlayerFocus__pf_0(int32 bpp__EntryPoint__pf);
