...
#include "LevelFinal_Delete_3__pf936270410.h"
...
ULevelFinal_Delete_3_C__pf936270410::ULevelFinal_Delete_3_C__pf936270410(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Button_Answers__pf = nullptr;
	bpv__Button_BlueBlood__pf = nullptr;
	bpv__Button_RedBlood__pf = nullptr;
	bpv__TextDescription__pf = FText::GetEmpty();
	bpv__TextButton__pf = FText::GetEmpty();
	bpv__TextButton2__pf = FText::GetEmpty();
	bpv__TextButton3__pf = FText::GetEmpty();
	bpv__TimesCount__pf = 0;
}
PRAGMA_ENABLE_OPTIMIZATION
void ULevelFinal_Delete_3_C__pf936270410::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ULevelFinal_Delete_3_C__pf936270410::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__5 = NewObject<UWidgetAnimation>(InDynamicClass, UWidgetAnimation::StaticClass(), TEXT("FadeInButton3_INST"), (EObjectFlags)0x00280008);
	...
	auto& __Local__6 = __Local__0->ComponentDelegateBindings[0];
	__Local__6.ComponentPropertyName = FName(TEXT("Button_Answers"));
	__Local__6.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__6.FunctionNameToBind = FName(TEXT("BndEvt__Button_1_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__7 = __Local__0->ComponentDelegateBindings[1];
	__Local__7.ComponentPropertyName = FName(TEXT("Button_BlueBlood"));
	__Local__7.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__7.FunctionNameToBind = FName(TEXT("BndEvt__Button_99_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__8 = __Local__0->ComponentDelegateBindings[2];
	__Local__8.ComponentPropertyName = FName(TEXT("Button_RedBlood"));
	__Local__8.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__8.FunctionNameToBind = FName(TEXT("BndEvt__Button_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__10.Reserve(4);
	auto __Local__11 = NewObject<UCanvasPanelSlot>(__Local__9, TEXT("CanvasPanelSlot_9"), (EObjectFlags)0x00280008);
	__Local__11->LayoutData.Offsets.Left = -704.960938f;
	__Local__11->LayoutData.Offsets.Top = -184.540527f;
	__Local__11->LayoutData.Offsets.Right = 1465.810303f;
	__Local__11->LayoutData.Offsets.Bottom = 356.993652f;
	...
	auto __Local__12 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_329"), (EObjectFlags)0x00280008);
	__Local__12->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[A7DC18D544276749754EFCBBE0CC7AD4]\", \"19F8E0624BC0FE55ABE988BD7E66CCD1\", \"You have proven your worth\\r\\n\\r\\nAs a reward you can get a wish and get out of here alive\")")	);
	__Local__12->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__12->Font.OutlineSettings.OutlineSize = 3;
	__Local__12->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__12->Font.Size = 45;
	...
	auto __Local__16 = NewObject<UCanvasPanelSlot>(__Local__9, TEXT("CanvasPanelSlot_1"), (EObjectFlags)0x00280008);
	__Local__16->LayoutData.Offsets.Left = 211.039063f;
	__Local__16->LayoutData.Offsets.Top = -413.081055f;
	__Local__16->LayoutData.Offsets.Right = 616.071594f;
	__Local__16->LayoutData.Offsets.Bottom = 141.222336f;
	...
	auto __Local__17 = NewObject<UButton>(__Local__1, TEXT("Button_BlueBlood"), (EObjectFlags)0x00280008);
	...
	__Local__18 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__17->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__19 = (*(AccessPrivateProperty<UObject* >(&(__Local__17->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__19 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	__Local__21 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
...
TEXT("NSLOCTEXT(\"[A7DC18D544276749754EFCBBE0CC7AD4]\", \"3EA9788E4930A6C82A10959A955C2AF4\", \"May my blood be blue\")")	);
	...
	__Local__24->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto __Local__26 = NewObject<UCanvasPanelSlot>(__Local__9, TEXT("CanvasPanelSlot_0"), (EObjectFlags)0x00280008);
	__Local__26->LayoutData.Offsets.Left = -792.960938f;
	__Local__26->LayoutData.Offsets.Top = -413.081055f;
	__Local__26->LayoutData.Offsets.Right = 589.378235f;
	__Local__26->LayoutData.Offsets.Bottom = 141.222336f;
	__Local__26->LayoutData.Anchors.Minimum = FVector2D(0.500000, 1.000000);
	__Local__26->LayoutData.Anchors.Maximum = FVector2D(0.500000, 1.000000);
	__Local__26->Parent = __Local__9;
	auto __Local__27 = NewObject<UButton>(__Local__1, TEXT("Button_RedBlood"), (EObjectFlags)0x00280008);
	__Local__27->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__28 = (*(AccessPrivateProperty<UObject* >(&(__Local__27->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__28 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__27->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__29 = (*(AccessPrivateProperty<UObject* >(&(__Local__27->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__29 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__27->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	...
	__Local__30 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__31 = (*(AccessPrivateProperty<UObject* >(&(__Local__27->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__31 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	auto __Local__34 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock"), (EObjectFlags)0x00280008);
	__Local__34->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[A7DC18D544276749754EFCBBE0CC7AD4]\", \"5AD30F4B455D2177A4C99F8FD16FA6F5\", \"End the blue blood\")")	);
	auto& __Local__35 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__34->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__35 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__34->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__34->Font.OutlineSettings.OutlineSize = 4;
	__Local__34->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__34->Font.Size = 50;
	__Local__34->Slot = __Local__33;
	__Local__33->Content = __Local__34;
	__Local__32.Add(__Local__33);
	__Local__27->Slot = __Local__26;
	__Local__27->RenderOpacity = 0.000000f;
	__Local__26->Content = __Local__27;
	__Local__10.Add(__Local__26);
	auto __Local__36 = NewObject<UCanvasPanelSlot>(__Local__9, TEXT("CanvasPanelSlot_5"), (EObjectFlags)0x00280008);
	__Local__36->LayoutData.Offsets.Left = -340.960938f;
	__Local__36->LayoutData.Offsets.Top = -225.081055f;
	__Local__36->LayoutData.Offsets.Right = 616.071594f;
	__Local__36->LayoutData.Offsets.Bottom = 141.222336f;
	...
	__Local__36->Parent = __Local__9;
	auto __Local__37 = NewObject<UButton>(__Local__1, TEXT("Button_Answers"), (EObjectFlags)0x00280008);
	__Local__37->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__38 = (*(AccessPrivateProperty<UObject* >(&(__Local__37->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__38 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__37->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__39 = (*(AccessPrivateProperty<UObject* >(&(__Local__37->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__39 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__37->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	...
	__Local__40 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__41 = (*(AccessPrivateProperty<UObject* >(&(__Local__37->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__41 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	auto& __Local__42 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__37), UPanelWidget::__PPO__Slots() )));
	__Local__42 = TArray<UPanelSlot*> ();
	__Local__42.Reserve(1);
	auto __Local__43 = NewObject<UButtonSlot>(__Local__37, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__43->Parent = __Local__37;
	auto __Local__44 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_1"), (EObjectFlags)0x00280008);
	__Local__44->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[A7DC18D544276749754EFCBBE0CC7AD4]\", \"5D825CCB43B77049195F4DB053953F0D\", \"I want answers\")")	);
	auto& __Local__45 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__44->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__45 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__44->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__44->Font.OutlineSettings.OutlineSize = 4;
	__Local__44->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__44->Font.Size = 50;
	__Local__44->Slot = __Local__43;
	__Local__43->Content = __Local__44;
	__Local__42.Add(__Local__43);
	__Local__37->Slot = __Local__36;
	__Local__37->RenderOpacity = 0.000000f;
	__Local__36->Content = __Local__37;
	__Local__10.Add(__Local__36);
	__Local__1->RootWidget = __Local__9;
	auto __Local__46 = NewObject<UMovieScene>(__Local__2, TEXT("FadeInText"), (EObjectFlags)0x00280008);
	auto& __Local__47 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__46), UMovieScene::__PPO__Possessables() )));
	__Local__47 = TArray<FMovieScenePossessable> ();
	__Local__47.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__47.GetData(), 1);
	auto& __Local__48 = __Local__47[0];
	auto& __Local__49 = (*(AccessPrivateProperty<FGuid >(&(__Local__48), FMovieScenePossessable::__PPO__Guid() )));
	__Local__49 = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__50 = (*(AccessPrivateProperty<FString >(&(__Local__48), FMovieScenePossessable::__PPO__Name() )));
	__Local__50 = FString(TEXT("TextBlock_329"));
	auto& __Local__51 = (*(AccessPrivateProperty<UClass* >(&(__Local__48), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__51 = UTextBlock::StaticClass();
	auto& __Local__52 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__46), UMovieScene::__PPO__ObjectBindings() )));
	__Local__52 = TArray<FMovieSceneBinding> ();
	__Local__52.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__52.GetData(), 1);
	auto& __Local__53 = __Local__52[0];
	auto& __Local__54 = (*(AccessPrivateProperty<FGuid >(&(__Local__53), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__54 = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__55 = (*(AccessPrivateProperty<FString >(&(__Local__53), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__55 = FString(TEXT("TextBlock_329"));
	auto& __Local__56 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__53), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__56 = TArray<UMovieSceneTrack*> ();
	__Local__56.Reserve(2);
	auto __Local__57 = NewObject<UMovieSceneColorTrack>(__Local__46, TEXT("MovieSceneColorTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__58 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__57), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__58.PropertyName = FName(TEXT("ColorAndOpacity"));
	__Local__58.PropertyPath = FName(TEXT("ColorAndOpacity"));
	__Local__58.bCanUseClassLookup = true;
	auto& __Local__59 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__57), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__59 = TArray<UMovieSceneSection*> ();
	__Local__59.Reserve(1);
	auto __Local__60 = NewObject<UMovieSceneColorSection>(__Local__57, TEXT("MovieSceneColorSection_0"), (EObjectFlags)0x00280008);
	auto __Local__61 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__60->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__62 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__60->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__61)
	{
	...
	__Local__60->Easing.EaseIn = __Local__61;
	__Local__60->Easing.EaseOut = __Local__62;
	__Local__60->Easing.bManualEaseOut = true;
	__Local__60->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(120000)));
	auto& __Local__63 = (*(AccessPrivateProperty<FGuid >((__Local__60), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__63 = FGuid(0xBA46693B, 0x414FEC4B, 0xF98EC09C, 0x4E774243);
	__Local__59.Add(__Local__60);
	auto& __Local__64 = (*(AccessPrivateProperty<FGuid >((__Local__57), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__64 = FGuid(0xDDDC1926, 0x47539219, 0x2B574EA3, 0xA5310AF4);
	auto& __Local__65 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__57), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__65.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__65.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__65.Entries.GetData(), 1);
	auto& __Local__66 = __Local__65.Entries[0];
	__Local__66.Section = __Local__60;
	static TWeakFieldPtr<FProperty> __Local__68{};
	const FProperty* __Local__67 = __Local__68.Get();
	if (nullptr == __Local__67)
	{
		__Local__67 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("LowerBound")));
		check(__Local__67);
		__Local__68 = __Local__67;
	}
	auto& __Local__69 = (*(__Local__67->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__66.Range), 0)));
	static TWeakFieldPtr<FProperty> __Local__71{};
	const FProperty* __Local__70 = __Local__71.Get();
	if (nullptr == __Local__70)
	{
		__Local__70 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Type")));
		check(__Local__70);
		__Local__71 = __Local__70;
	}
	auto& __Local__72 = (*(__Local__70->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__69), 0)));
	__Local__72 = ERangeBoundTypes::Type::Inclusive;
	static TWeakFieldPtr<FProperty> __Local__74{};
	const FProperty* __Local__73 = __Local__74.Get();
	if (nullptr == __Local__73)
	{
		__Local__73 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("UpperBound")));
		check(__Local__73);
		__Local__74 = __Local__73;
	}
	auto& __Local__75 = (*(__Local__73->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__66.Range), 0)));
	auto& __Local__76 = (*(__Local__70->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__75), 0)));
	__Local__76 = ERangeBoundTypes::Type::Inclusive;
	static TWeakFieldPtr<FProperty> __Local__78{};
	const FProperty* __Local__77 = __Local__78.Get();
	if (nullptr == __Local__77)
	{
		__Local__77 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Value")));
		check(__Local__77);
		__Local__78 = __Local__77;
	}
	auto& __Local__79 = (*(__Local__77->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__75), 0)));
	__Local__79.Value = 120000;
	__Local__66.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__80 = (*(AccessPrivateProperty<FGuid >((__Local__57), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__80 = FGuid(0xDDDC1926, 0x47539219, 0x2B574EA3, 0xA5310AF4);
	__Local__56.Add(__Local__57);
	auto __Local__81 = NewObject<UMovieSceneFloatTrack>(__Local__46, TEXT("MovieSceneFloatTrack_0"), (EObjectFlags)0x00280008);
	...
	__Local__82.PropertyName = FName(TEXT("RenderOpacity"));
	__Local__82.PropertyPath = FName(TEXT("RenderOpacity"));
	...
	auto __Local__84 = NewObject<UMovieSceneFloatSection>(__Local__81, TEXT("MovieSceneFloatSection_0"), (EObjectFlags)0x00280008);
	...
	auto& __Local__87 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__84), UMovieSceneFloatSection::__PPO__FloatCurve() )));
	auto& __Local__88 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__87), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__88 = TArray<FFrameNumber> ();
	__Local__88.Reserve(2);
	__Local__88.Add(FFrameNumber{});
	__Local__88.Add(FFrameNumber{});
	__Local__88[1].Value = 150000;
	auto& __Local__89 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__87), FMovieSceneFloatChannel::__PPO__Values() )));
	...
	__Local__91.Value = 1.000000f;
	__Local__84->Easing.EaseIn = __Local__85;
	__Local__84->Easing.EaseOut = __Local__86;
	__Local__84->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(150000)));
	auto& __Local__92 = (*(AccessPrivateProperty<FGuid >((__Local__84), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__92 = FGuid(0xC95851B7, 0x46762F9C, 0x7F26C993, 0x8DA70E1F);
	__Local__83.Add(__Local__84);
	auto& __Local__93 = (*(AccessPrivateProperty<FGuid >((__Local__81), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__93 = FGuid(0xF65A7B0B, 0x4A5DAF9A, 0xAC0E88BB, 0x8F9C4DB0);
	auto& __Local__94 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__81), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__94.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__94.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__94.Entries.GetData(), 1);
	auto& __Local__95 = __Local__94.Entries[0];
	__Local__95.Section = __Local__84;
	auto& __Local__96 = (*(__Local__67->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__95.Range), 0)));
	auto& __Local__97 = (*(__Local__70->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__96), 0)));
	__Local__97 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__98 = (*(__Local__73->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__95.Range), 0)));
	auto& __Local__99 = (*(__Local__70->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__98), 0)));
	__Local__99 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__100 = (*(__Local__77->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__98), 0)));
	__Local__100.Value = 150000;
	__Local__95.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__101 = (*(AccessPrivateProperty<FGuid >((__Local__81), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__101 = FGuid(0xF65A7B0B, 0x4A5DAF9A, 0xAC0E88BB, 0x8F9C4DB0);
	__Local__56.Add(__Local__81);
	auto& __Local__102 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__46), UMovieScene::__PPO__PlaybackRange() )));
	__Local__102 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(150001)));
	auto& __Local__103 = (*(AccessPrivateProperty<FFrameRate >((__Local__46), UMovieScene::__PPO__DisplayRate() )));
	static TWeakFieldPtr<FProperty> __Local__105{};
	const FProperty* __Local__104 = __Local__105.Get();
	if (nullptr == __Local__104)
	{
		__Local__104 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameRate"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Numerator")));
		check(__Local__104);
		__Local__105 = __Local__104;
	}
	auto& __Local__106 = (*(__Local__104->ContainerPtrToValuePtr<int32 >(&(__Local__103), 0)));
	__Local__106 = 20;
	auto& __Local__107 = (*(AccessPrivateProperty<FGuid >((__Local__46), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__107 = FGuid(0x48326375, 0x4A890F90, 0x6E722BA6, 0x422E1F11);
	__Local__2->MovieScene = __Local__46;
	...
	auto& __Local__108 = __Local__2->AnimationBindings[0];
	__Local__108.WidgetName = FName(TEXT("TextBlock_329"));
	__Local__108.AnimationGuid = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__109 = (*(AccessPrivateProperty<FString >((__Local__2), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__109 = FString(TEXT("FadeInText"));
	__Local__2->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__110 = (*(AccessPrivateProperty<FGuid >((__Local__2), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__110 = FGuid(0x4B9B3784, 0x4F020096, 0x0CF533B7, 0x260DBDA5);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__2);
	auto __Local__111 = NewObject<UMovieScene>(__Local__3, TEXT("FadeInButton"), (EObjectFlags)0x00280008);
	auto& __Local__112 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__111), UMovieScene::__PPO__Possessables() )));
	__Local__112 = TArray<FMovieScenePossessable> ();
	__Local__112.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__112.GetData(), 1);
	auto& __Local__113 = __Local__112[0];
	auto& __Local__114 = (*(AccessPrivateProperty<FGuid >(&(__Local__113), FMovieScenePossessable::__PPO__Guid() )));
	__Local__114 = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__115 = (*(AccessPrivateProperty<FString >(&(__Local__113), FMovieScenePossessable::__PPO__Name() )));
	__Local__115 = FString(TEXT("Button_BlueBlood"));
	auto& __Local__116 = (*(AccessPrivateProperty<UClass* >(&(__Local__113), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__116 = UButton::StaticClass();
	auto& __Local__117 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__111), UMovieScene::__PPO__ObjectBindings() )));
	__Local__117 = TArray<FMovieSceneBinding> ();
	__Local__117.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__117.GetData(), 1);
	auto& __Local__118 = __Local__117[0];
	auto& __Local__119 = (*(AccessPrivateProperty<FGuid >(&(__Local__118), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__119 = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__120 = (*(AccessPrivateProperty<FString >(&(__Local__118), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__120 = FString(TEXT("Button_99"));
	auto& __Local__121 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__118), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__121 = TArray<UMovieSceneTrack*> ();
	__Local__121.Reserve(1);
	auto __Local__122 = NewObject<UMovieSceneFloatTrack>(__Local__111, TEXT("MovieSceneFloatTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__123 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__122), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__123.PropertyName = FName(TEXT("RenderOpacity"));
	__Local__123.PropertyPath = FName(TEXT("RenderOpacity"));
	__Local__123.bCanUseClassLookup = true;
	auto& __Local__124 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__122), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__124 = TArray<UMovieSceneSection*> ();
	__Local__124.Reserve(1);
	auto __Local__125 = NewObject<UMovieSceneFloatSection>(__Local__122, TEXT("MovieSceneFloatSection_0"), (EObjectFlags)0x00280008);
	auto __Local__126 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__125->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__127 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__125->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__126)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__128 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__125), UMovieSceneFloatSection::__PPO__FloatCurve() )));
	auto& __Local__129 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__128), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__129 = TArray<FFrameNumber> ();
	__Local__129.Reserve(2);
	__Local__129.Add(FFrameNumber{});
	__Local__129.Add(FFrameNumber{});
	__Local__129[1].Value = 150000;
	auto& __Local__130 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__128), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__130 = TArray<FMovieSceneFloatValue> ();
	__Local__130.AddUninitialized(2);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__130.GetData(), 2);
	auto& __Local__131 = __Local__130[0];
	auto& __Local__132 = __Local__130[1];
	__Local__132.Value = 1.000000f;
	__Local__125->Easing.EaseIn = __Local__126;
	__Local__125->Easing.EaseOut = __Local__127;
	__Local__125->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(150000)));
	auto& __Local__133 = (*(AccessPrivateProperty<FGuid >((__Local__125), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__133 = FGuid(0x8A291EDF, 0x40499572, 0x7FE33A97, 0x85CCD425);
	__Local__124.Add(__Local__125);
	auto& __Local__134 = (*(AccessPrivateProperty<FGuid >((__Local__122), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__134 = FGuid(0x6591925F, 0x45B0957F, 0xD13F0E93, 0xD1A0EFD6);
	auto& __Local__135 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__122), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__135.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__135.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__135.Entries.GetData(), 1);
	auto& __Local__136 = __Local__135.Entries[0];
	__Local__136.Section = __Local__125;
	auto& __Local__137 = (*(__Local__67->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__136.Range), 0)));
	auto& __Local__138 = (*(__Local__70->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__137), 0)));
	__Local__138 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__139 = (*(__Local__73->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__136.Range), 0)));
	auto& __Local__140 = (*(__Local__70->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__139), 0)));
	__Local__140 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__141 = (*(__Local__77->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__139), 0)));
	__Local__141.Value = 150000;
	__Local__136.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__142 = (*(AccessPrivateProperty<FGuid >((__Local__122), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__142 = FGuid(0x6591925F, 0x45B0957F, 0xD13F0E93, 0xD1A0EFD6);
	__Local__121.Add(__Local__122);
	auto& __Local__143 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__111), UMovieScene::__PPO__PlaybackRange() )));
	__Local__143 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(150001)));
	auto& __Local__144 = (*(AccessPrivateProperty<FFrameRate >((__Local__111), UMovieScene::__PPO__DisplayRate() )));
	auto& __Local__145 = (*(__Local__104->ContainerPtrToValuePtr<int32 >(&(__Local__144), 0)));
	__Local__145 = 20;
	auto& __Local__146 = (*(AccessPrivateProperty<FGuid >((__Local__111), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__146 = FGuid(0x588A37A7, 0x4B79D37F, 0x014BDAAC, 0x8EBB22D7);
	__Local__3->MovieScene = __Local__111;
	...
	auto& __Local__147 = __Local__3->AnimationBindings[0];
	__Local__147.WidgetName = FName(TEXT("Button_BlueBlood"));
	__Local__147.AnimationGuid = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__148 = (*(AccessPrivateProperty<FString >((__Local__3), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__148 = FString(TEXT("FadeInButton"));
	__Local__3->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__149 = (*(AccessPrivateProperty<FGuid >((__Local__3), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__149 = FGuid(0x540D2277, 0x4D297ABB, 0xBA63F1BA, 0x6DDBAABF);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__3);
	auto __Local__150 = NewObject<UMovieScene>(__Local__4, TEXT("FadeInButton2"), (EObjectFlags)0x00280008);
	auto& __Local__151 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__150), UMovieScene::__PPO__Possessables() )));
	__Local__151 = TArray<FMovieScenePossessable> ();
	__Local__151.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__151.GetData(), 1);
	...
	__Local__153 = FGuid(0x66494D87, 0x4354A11D, 0xBD094482, 0xB50BD581);
	auto& __Local__154 = (*(AccessPrivateProperty<FString >(&(__Local__152), FMovieScenePossessable::__PPO__Name() )));
	__Local__154 = FString(TEXT("Button_RedBlood"));
	auto& __Local__155 = (*(AccessPrivateProperty<UClass* >(&(__Local__152), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__155 = UButton::StaticClass();
	auto& __Local__156 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__150), UMovieScene::__PPO__ObjectBindings() )));
	__Local__156 = TArray<FMovieSceneBinding> ();
	__Local__156.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__156.GetData(), 1);
	...
	auto __Local__161 = NewObject<UMovieSceneFloatTrack>(__Local__150, TEXT("MovieSceneFloatTrack_0"), (EObjectFlags)0x00280008);
	...
	__Local__162.PropertyName = FName(TEXT("RenderOpacity"));
	__Local__162.PropertyPath = FName(TEXT("RenderOpacity"));
	...
	auto __Local__164 = NewObject<UMovieSceneFloatSection>(__Local__161, TEXT("MovieSceneFloatSection_0"), (EObjectFlags)0x00280008);
	...
	auto& __Local__167 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__164), UMovieSceneFloatSection::__PPO__FloatCurve() )));
	auto& __Local__168 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__167), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__168 = TArray<FFrameNumber> ();
	__Local__168.Reserve(2);
	__Local__168.Add(FFrameNumber{});
	__Local__168.Add(FFrameNumber{});
	__Local__168[1].Value = 150000;
	auto& __Local__169 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__167), FMovieSceneFloatChannel::__PPO__Values() )));
	...
	auto& __Local__172 = (*(AccessPrivateProperty<FGuid >((__Local__164), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__172 = FGuid(0x82FEE337, 0x4B44369C, 0x65727391, 0xF4FA1807);
	__Local__163.Add(__Local__164);
	auto& __Local__173 = (*(AccessPrivateProperty<FGuid >((__Local__161), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__173 = FGuid(0x3492FC77, 0x4AA62766, 0xF95F5280, 0xC67E551E);
	auto& __Local__174 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__161), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__174.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__174.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__174.Entries.GetData(), 1);
	auto& __Local__175 = __Local__174.Entries[0];
	__Local__175.Section = __Local__164;
	auto& __Local__176 = (*(__Local__67->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__175.Range), 0)));
	auto& __Local__177 = (*(__Local__70->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__176), 0)));
	__Local__177 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__178 = (*(__Local__73->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__175.Range), 0)));
	auto& __Local__179 = (*(__Local__70->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__178), 0)));
	__Local__179 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__180 = (*(__Local__77->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__178), 0)));
	__Local__180.Value = 150000;
	__Local__175.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__181 = (*(AccessPrivateProperty<FGuid >((__Local__161), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__181 = FGuid(0x3492FC77, 0x4AA62766, 0xF95F5280, 0xC67E551E);
	__Local__160.Add(__Local__161);
	auto& __Local__182 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__150), UMovieScene::__PPO__PlaybackRange() )));
	__Local__182 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(150001)));
	auto& __Local__183 = (*(AccessPrivateProperty<FFrameRate >((__Local__150), UMovieScene::__PPO__DisplayRate() )));
	auto& __Local__184 = (*(__Local__104->ContainerPtrToValuePtr<int32 >(&(__Local__183), 0)));
	__Local__184 = 20;
	auto& __Local__185 = (*(AccessPrivateProperty<FGuid >((__Local__150), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__185 = FGuid(0x35805696, 0x40E3E4A3, 0xA4A59D81, 0x1DAE5ECD);
	__Local__4->MovieScene = __Local__150;
	...
	auto& __Local__186 = __Local__4->AnimationBindings[0];
	__Local__186.WidgetName = FName(TEXT("Button_RedBlood"));
	__Local__186.AnimationGuid = FGuid(0x66494D87, 0x4354A11D, 0xBD094482, 0xB50BD581);
	auto& __Local__187 = (*(AccessPrivateProperty<FString >((__Local__4), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__187 = FString(TEXT("FadeInButton2"));
	__Local__4->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__188 = (*(AccessPrivateProperty<FGuid >((__Local__4), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__188 = FGuid(0xECCB93BF, 0x4F5C8CD9, 0x199E0E8B, 0x82FCAA56);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__4);
	auto __Local__189 = NewObject<UMovieScene>(__Local__5, TEXT("FadeInButton3"), (EObjectFlags)0x00280008);
	...
	__Local__190.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__190.GetData(), 1);
	...
	__Local__192 = FGuid(0xA17BC491, 0x473886BE, 0xBF2DF39C, 0x04B52A36);
	auto& __Local__193 = (*(AccessPrivateProperty<FString >(&(__Local__191), FMovieScenePossessable::__PPO__Name() )));
	__Local__193 = FString(TEXT("Button_Answers"));
	auto& __Local__194 = (*(AccessPrivateProperty<UClass* >(&(__Local__191), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__194 = UButton::StaticClass();
	auto& __Local__195 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__189), UMovieScene::__PPO__ObjectBindings() )));
	__Local__195 = TArray<FMovieSceneBinding> ();
	__Local__195.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__195.GetData(), 1);
	auto& __Local__196 = __Local__195[0];
	auto& __Local__197 = (*(AccessPrivateProperty<FGuid >(&(__Local__196), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__197 = FGuid(0xA17BC491, 0x473886BE, 0xBF2DF39C, 0x04B52A36);
	auto& __Local__198 = (*(AccessPrivateProperty<FString >(&(__Local__196), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__198 = FString(TEXT("Button_1"));
	auto& __Local__199 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__196), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__199 = TArray<UMovieSceneTrack*> ();
	__Local__199.Reserve(1);
	auto __Local__200 = NewObject<UMovieSceneFloatTrack>(__Local__189, TEXT("MovieSceneFloatTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__201 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__200), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__201.PropertyName = FName(TEXT("RenderOpacity"));
	__Local__201.PropertyPath = FName(TEXT("RenderOpacity"));
	__Local__201.bCanUseClassLookup = true;
	auto& __Local__202 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__200), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__202 = TArray<UMovieSceneSection*> ();
	__Local__202.Reserve(1);
	auto __Local__203 = NewObject<UMovieSceneFloatSection>(__Local__200, TEXT("MovieSceneFloatSection_0"), (EObjectFlags)0x00280008);
	auto __Local__204 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__203->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__205 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__203->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__204)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__206 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__203), UMovieSceneFloatSection::__PPO__FloatCurve() )));
	...
	__Local__208.AddUninitialized(2);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__208.GetData(), 2);
	auto& __Local__209 = __Local__208[0];
	auto& __Local__210 = __Local__208[1];
	__Local__210.Value = 1.000000f;
	__Local__203->Easing.EaseIn = __Local__204;
	__Local__203->Easing.EaseOut = __Local__205;
	__Local__203->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(150000)));
	auto& __Local__211 = (*(AccessPrivateProperty<FGuid >((__Local__203), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__211 = FGuid(0x354516EE, 0x4ECF0EFE, 0xD4F69598, 0xDC6D4624);
	__Local__202.Add(__Local__203);
	auto& __Local__212 = (*(AccessPrivateProperty<FGuid >((__Local__200), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__212 = FGuid(0xE5E8316D, 0x48AD0786, 0xB60C91A2, 0x1F8B7BFC);
	auto& __Local__213 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__200), UMovieSceneTrack::__PPO__EvaluationField() )));
	...
	__Local__214.Section = __Local__203;
	auto& __Local__215 = (*(__Local__67->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__214.Range), 0)));
	auto& __Local__216 = (*(__Local__70->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__215), 0)));
	__Local__216 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__217 = (*(__Local__73->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__214.Range), 0)));
	auto& __Local__218 = (*(__Local__70->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__217), 0)));
	__Local__218 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__219 = (*(__Local__77->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__217), 0)));
	__Local__219.Value = 150000;
	__Local__214.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__220 = (*(AccessPrivateProperty<FGuid >((__Local__200), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__220 = FGuid(0xE5E8316D, 0x48AD0786, 0xB60C91A2, 0x1F8B7BFC);
	__Local__199.Add(__Local__200);
	auto& __Local__221 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__189), UMovieScene::__PPO__PlaybackRange() )));
	__Local__221 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(150001)));
	auto& __Local__222 = (*(AccessPrivateProperty<FFrameRate >((__Local__189), UMovieScene::__PPO__DisplayRate() )));
	auto& __Local__223 = (*(__Local__104->ContainerPtrToValuePtr<int32 >(&(__Local__222), 0)));
	__Local__223 = 20;
	auto& __Local__224 = (*(AccessPrivateProperty<FGuid >((__Local__189), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__224 = FGuid(0x77A8F50C, 0x41018A33, 0xE4500AAF, 0x70AE08C9);
	__Local__5->MovieScene = __Local__189;
	...
	auto& __Local__225 = __Local__5->AnimationBindings[0];
	__Local__225.WidgetName = FName(TEXT("Button_Answers"));
	__Local__225.AnimationGuid = FGuid(0xA17BC491, 0x473886BE, 0xBF2DF39C, 0x04B52A36);
	auto& __Local__226 = (*(AccessPrivateProperty<FString >((__Local__5), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__226 = FString(TEXT("FadeInButton3"));
	__Local__5->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__227 = (*(AccessPrivateProperty<FGuid >((__Local__5), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__227 = FGuid(0x3081520C, 0x4F09EE6B, 0x18705FB8, 0x30891E38);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__5);
}
PRAGMA_ENABLE_OPTIMIZATION
void ULevelFinal_Delete_3_C__pf936270410::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__228;
	SlotNames.Append(__Local__228);
}
void ULevelFinal_Delete_3_C__pf936270410::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__229;
	__Local__229.Reserve(4);
	__Local__229.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->MiscConvertedSubobjects[1]));
	__Local__229.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->MiscConvertedSubobjects[2]));
	__Local__229.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->MiscConvertedSubobjects[3]));
	__Local__229.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->MiscConvertedSubobjects[4]));
	TArray<FDelegateRuntimeBinding>  __Local__230;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(ULevelFinal_Delete_3_C__pf936270410::StaticClass())->MiscConvertedSubobjects[0]), __Local__229, __Local__230);
}
void ULevelFinal_Delete_3_C__pf936270410::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void ULevelFinal_Delete_3_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_Delete_3__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b1l__K2Node_DynamicCast_AsSave_Game_BP__pf = Cast<USaveGameBP_C__pf4030252459>(bpfv__CallFunc_LoadGameFromSlot_ReturnValue_1__pf);
	...
	{
		b1l__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__IsLevel11UnFinish__pf = false;
	}
	...
	UGameplayStatics::OpenLevel(this, FName(TEXT("LevelEndingRedBlood")), true, FString(TEXT("")));
	return; // KCST_GotoReturn
}
void ULevelFinal_Delete_3_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_Delete_3__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	b1l__K2Node_MakeArray_Array__pf.SetNum(3, true);
	b1l__K2Node_MakeArray_Array__pf[0] = bpv__Button_BlueBlood__pf;
	b1l__K2Node_MakeArray_Array__pf[1] = bpv__Button_RedBlood__pf;
	b1l__K2Node_MakeArray_Array__pf[2] = bpv__Button_Answers__pf;
	...
	bpfv__CallFunc_PlayAnimation_ReturnValue_3__pf = UUserWidget::PlayAnimation(bpv__FadeInButton3__pf, 0.000000, 1, EUMGSequencePlayMode::Forward, 1.000000, false);
	bpfv__CallFunc_PlayAnimation_ReturnValue_2__pf = UUserWidget::PlayAnimation(bpv__FadeInText__pf, 0.000000, 1, EUMGSequencePlayMode::Forward, 1.000000, false);
	return; // KCST_GotoReturn
}
void ULevelFinal_Delete_3_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_Delete_3__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	b1l__K2Node_DynamicCast_AsSave_Game_BP_1__pf = Cast<USaveGameBP_C__pf4030252459>(bpfv__CallFunc_LoadGameFromSlot_ReturnValue__pf);
	...
	{
		b1l__K2Node_DynamicCast_AsSave_Game_BP_1__pf->bpv__IsLevel11UnFinish__pf = false;
	}
	...
	// optimized KCST_UnconditionalGoto
	UWidgetLayoutLibrary::RemoveAllWidgets(this);
	UGameplayStatics::OpenLevel(this, FName(TEXT("LevelEndingBlueBlood")), true, FString(TEXT("")));
	return; // KCST_GotoReturn
}
void ULevelFinal_Delete_3_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_Delete_3__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	b1l__K2Node_DynamicCast_bSuccess_2__pf = (b1l__K2Node_DynamicCast_AsSave_Game_BP_2__pf != nullptr);;
	...
	{
		b1l__K2Node_DynamicCast_AsSave_Game_BP_2__pf->bpv__IsLevel11UnFinish__pf = false;
	}
	...
	UWidgetLayoutLibrary::RemoveAllWidgets(this);
	// optimized KCST_UnconditionalGoto
	UGameplayStatics::OpenLevel(this, FName(TEXT("LevelEndingAnswers")), true, FString(TEXT("")));
	return; // KCST_GotoReturn
}
void ULevelFinal_Delete_3_C__pf936270410::bpf__ExecuteUbergraph_LevelFinal_Delete_3__pf_4(int32 bpp__EntryPoint__pf)
{
...
void ULevelFinal_Delete_3_C__pf936270410::bpf__BndEvt__Button_1_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_Delete_3__pf_3(26);
}
void ULevelFinal_Delete_3_C__pf936270410::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_Delete_3__pf_1(23);
}
void ULevelFinal_Delete_3_C__pf936270410::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_LevelFinal_Delete_3__pf_4(20);
}
void ULevelFinal_Delete_3_C__pf936270410::bpf__BndEvt__Button_99_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_Delete_3__pf_2(15);
}
void ULevelFinal_Delete_3_C__pf936270410::bpf__BndEvt__Button_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_LevelFinal_Delete_3__pf_0(8);
}
void ULevelFinal_Delete_3_C__pf936270410::bpf__GetText_0__pf()
{
}
FText  ULevelFinal_Delete_3_C__pf936270410::bpf__GetText_1__pf()
{
	FText bpp__ReturnValue__pf{};
	bpp__ReturnValue__pf = bpv__TextButton__pf;
	return bpp__ReturnValue__pf;
}
void ULevelFinal_Delete_3_C__pf936270410::bpf__GetText_2__pf()
{
	FText bpfv__TextGameOver__pf{};
}
FText  ULevelFinal_Delete_3_C__pf936270410::bpf__GetText_3__pf()
{
	FText bpp__ReturnValue__pf{};
	bpp__ReturnValue__pf = bpv__TextButton2__pf;
	return bpp__ReturnValue__pf;
}
void ULevelFinal_Delete_3_C__pf936270410::bpf__GetText_4__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void ULevelFinal_Delete_3_C__pf936270410::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ULevelFinal_Delete_3_C__pf936270410::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ULevelFinal_Delete_3_C__pf936270410
{
	FRegisterHelper__ULevelFinal_Delete_3_C__pf936270410()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/LevelFinal/LevelFinal_Delete_3"), &ULevelFinal_Delete_3_C__pf936270410::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ULevelFinal_Delete_3_C__pf936270410 Instance;
};
FRegisterHelper__ULevelFinal_Delete_3_C__pf936270410 FRegisterHelper__ULevelFinal_Delete_3_C__pf936270410::Instance;
