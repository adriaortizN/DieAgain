...
#include "PlayerHeavyInEnemyAnimBP__pf2266844876.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Art/Enemies/PlayerAnimations/PlayerHeavyInEnemyAnimBP.PlayerHeavyInEnemyAnimBP_C", OverrideNativeName="PlayerHeavyInEnemyAnimBP_C"))
class UPlayerHeavyInEnemyAnimBP_C__pf2266844876 : public UAnimInstance
{
public:
	GENERATED_BODY()
	...
	UPlayerHeavyInEnemyAnimBP_C__pf2266844876(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	void bpf__ExecuteUbergraph_PlayerHeavyInEnemyAnimBP__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_PlayerHeavyInEnemyAnimBP__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_PlayerHeavyInEnemyAnimBP__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_PlayerHeavyInEnemyAnimBP__pf_3(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="EvaluateGraphExposedInputs_ExecuteUbergraph_PlayerHeavyInEnemyAnimBP_AnimGraphNode_BlendSpacePlayer_C7F2D2BA4C9129C607BED6913CF8F697"))
	virtual void bpf__EvaluateGraphExposedInputs_ExecuteUbergraph_PlayerHeavyInEnemyAnimBP_AnimGraphNode_BlendSpacePlayer_C7F2D2BA4C9129C607BED6913CF8F697__pf();
	UFUNCTION(meta=(OverrideNativeName="EvaluateGraphExposedInputs_ExecuteUbergraph_PlayerHeavyInEnemyAnimBP_AnimGraphNode_TransitionResult_8120345F4BA319479814B7A686AB07F7"))
	virtual void bpf__EvaluateGraphExposedInputs_ExecuteUbergraph_PlayerHeavyInEnemyAnimBP_AnimGraphNode_TransitionResult_8120345F4BA319479814B7A686AB07F7__pf();
	UFUNCTION(meta=(OverrideNativeName="EvaluateGraphExposedInputs_ExecuteUbergraph_PlayerHeavyInEnemyAnimBP_AnimGraphNode_TransitionResult_237A654847F9D926841D9F9522B52889"))
	virtual void bpf__EvaluateGraphExposedInputs_ExecuteUbergraph_PlayerHeavyInEnemyAnimBP_AnimGraphNode_TransitionResult_237A654847F9D926841D9F9522B52889__pf();
