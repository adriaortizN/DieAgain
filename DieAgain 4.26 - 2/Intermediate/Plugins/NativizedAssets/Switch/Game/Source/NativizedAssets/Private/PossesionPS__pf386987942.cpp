...
APossesionPS_C__pf386987942::APossesionPS_C__pf386987942(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__ParticleSystem__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(APossesionPS_C__pf386987942::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
void APossesionPS_C__pf386987942::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APossesionPS_C__pf386987942::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void APossesionPS_C__pf386987942::bpf__ExecuteUbergraph_PossesionPS__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				UKismetSystemLibrary::Delay(this, 1.250000, FLatentActionInfo(2, -2118365672, TEXT("ExecuteUbergraph_PossesionPS_0"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void APossesionPS_C__pf386987942::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_PossesionPS__pf_0(3);
}
PRAGMA_DISABLE_OPTIMIZATION
void APossesionPS_C__pf386987942::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APossesionPS_C__pf386987942::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APossesionPS_C__pf386987942
{
	FRegisterHelper__APossesionPS_C__pf386987942()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/Possesion_PS/PossesionPS"), &APossesionPS_C__pf386987942::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APossesionPS_C__pf386987942 Instance;
};
FRegisterHelper__APossesionPS_C__pf386987942 FRegisterHelper__APossesionPS_C__pf386987942::Instance;
