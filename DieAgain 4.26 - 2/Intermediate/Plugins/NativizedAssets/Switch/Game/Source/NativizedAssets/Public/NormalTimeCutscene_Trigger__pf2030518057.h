...
#include "NormalTimeCutscene_Trigger__pf2030518057.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Objects/Cutscene/NormalTimeCutscene_Trigger.NormalTimeCutscene_Trigger_C", OverrideNativeName="NormalTimeCutscene_Trigger_C"))
class ANormalTimeCutscene_Trigger_C__pf2030518057 : public AActor
{
public:
	GENERATED_BODY()
	...
	ANormalTimeCutscene_Trigger_C__pf2030518057(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_NormalTimeCutscene_Trigger__pf_0(int32 bpp__EntryPoint__pf);
