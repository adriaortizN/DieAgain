...
class AActor;
#include "ACH_REDBLOOD__pf3264546738.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Conversations/Events/ACH_REDBLOOD.ACH_REDBLOOD_C", OverrideNativeName="ACH_REDBLOOD_C"))
class UACH_REDBLOOD_C__pf3264546738 : public UDialogueEvents
{
public:
	GENERATED_BODY()
	...
	UACH_REDBLOOD_C__pf3264546738(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_ACH_REDBLOOD__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_REDBLOOD__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_REDBLOOD__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_REDBLOOD__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_REDBLOOD__pf_4(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_2B88FA27472C06A545D56B9C97944994"))
	virtual void bpf__OnSuccess_2B88FA27472C06A545D56B9C97944994__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_2B88FA27472C06A545D56B9C97944994"))
	virtual void bpf__OnFailure_2B88FA27472C06A545D56B9C97944994__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_1F28E7E24B7303558A60B29DAB7FEC71"))
	virtual void bpf__OnSuccess_1F28E7E24B7303558A60B29DAB7FEC71__pf();
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_1F28E7E24B7303558A60B29DAB7FEC71"))
	virtual void bpf__OnFailure_1F28E7E24B7303558A60B29DAB7FEC71__pf();
public:
};
