...
#include "PlaneCharacter__pf2222656877.h"
...
#include "PlaneTrail__pf702804625.h"
...
APlaneCharacter_C__pf2222656877::APlaneCharacter_C__pf2222656877(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	if(__Local__1)
	{
		...
		__Local__1->MaxWalkSpeed = 2000.000000f;
	...
	bpv__TrailPlane__pf = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("TrailPlane"));
	...
	auto& __Local__14 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Plane__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__14 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APlaneCharacter_C__pf2222656877::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__15 = (*(AccessPrivateProperty<FRotator >((bpv__Plane__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__15 = FRotator(0.000000, 90.000252, -0.000038);
	...
	(((FBoolProperty*)__Local__16)->SetPropertyValue_InContainer((bpv__Plane__pf), true, 0));
	bpv__TrailPlane__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__TrailPlane__pf->AttachToComponent(bpv__Plane__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__TrailPlane__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(APlaneCharacter_C__pf2222656877::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	auto& __Local__18 = (*(AccessPrivateProperty<FVector >((bpv__TrailPlane__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__18 = FVector(0.000013, 515.000000, 0.000000);
	bpv__TrailPlane__pf->PrimaryComponentTick.bStartWithTickEnabled = false;
	(((FBoolProperty*)__Local__16)->SetPropertyValue_InContainer((bpv__TrailPlane__pf), false, 0));
	bpv__ChildActor__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ChildActor__pf->AttachToComponent(bpv__Plane__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__19 = (*(AccessPrivateProperty<FVector >((bpv__ChildActor__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__19 = FVector(-0.004250, -80.000000, 0.000000);
	auto& __Local__20 = (*(AccessPrivateProperty<FRotator >((bpv__ChildActor__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__20 = FRotator(0.000000, -270.000671, 0.000000);
	(((FBoolProperty*)__Local__16)->SetPropertyValue_InContainer((bpv__ChildActor__pf), false, 0));
	...
	(((FBoolProperty*)__Local__16)->SetPropertyValue_InContainer((bpv__RotatingMovement__pf), false, 0));
	...
	bpv__PlaneSong__pf->Event = CastChecked<UFMODEvent>(CastChecked<UDynamicClass>(APlaneCharacter_C__pf2222656877::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__PlaneSong__pf->bAutoActivate = false;
	(((FBoolProperty*)__Local__16)->SetPropertyValue_InContainer((bpv__PlaneSong__pf), false, 0));
	...
	bpv__IsReadyToMove__pf = true;
	bpv__UnlockedLevels__pf = 0;
	bpv__CanSpawn__pf = false;
	auto& __Local__21 = (*(AccessPrivateProperty<USkeletalMeshComponent*>((this), ACharacter::__PPO__Mesh() )));
	__Local__21 = __Local__2;
	auto& __Local__22 = (*(AccessPrivateProperty<UCharacterMovementComponent*>((this), ACharacter::__PPO__CharacterMovement() )));
	__Local__22 = __Local__1;
	auto& __Local__23 = (*(AccessPrivateProperty<UCapsuleComponent*>((this), ACharacter::__PPO__CapsuleComponent() )));
...
void APlaneCharacter_C__pf2222656877::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APlaneCharacter_C__pf2222656877::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(APlaneTrail_C__pf702804625::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
void APlaneCharacter_C__pf2222656877::bpf__ExecuteUbergraph_PlaneCharacter__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 11:
			{
				...
				b0l__K2Node_DynamicCast_AsCamera_Actor_1__pf = Cast<ACameraActor_C__pf1295471953>(b0l__CallFunc_Array_Get_Item_1__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsCamera_Actor_1__pf != nullptr);;
		...
		case 12:
			{
				bpv__CameraActor__pf = b0l__K2Node_DynamicCast_AsCamera_Actor_1__pf;
			}
		case 13:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsCamera_Actor_1__pf))
				{
					b0l__K2Node_DynamicCast_AsCamera_Actor_1__pf->bpv__Player__pf = this;
				}
			}
		case 14:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsCamera_Actor_1__pf))
				{
					b0l__K2Node_DynamicCast_AsCamera_Actor_1__pf->bpf__MoveCam__pf();
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 23:
			{
				int32  __Local__28 = 0;
				bpv__UnlockedLevels__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__LevelsUnlocked__pf) : (__Local__28));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 24:
			{
				UKismetSystemLibrary::Delay(this, 0.100000, FLatentActionInfo(1, 1629199579, TEXT("ExecuteUbergraph_PlaneCharacter_0"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 25:
...
void APlaneCharacter_C__pf2222656877::bpf__ExecuteUbergraph_PlaneCharacter__pf_1(int32 bpp__EntryPoint__pf)
{
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
		...
		case 5:
			{
				...
				{
					bpv__RotatingMovement__pf->RotationRate = FRotator(-22.000000,0.000000,0.000000);
				}
			}
		case 6:
			{
		...
		case 41:
			{
				UKismetSystemLibrary::Delay(this, 0.400000, FLatentActionInfo(4, 17116905, TEXT("ExecuteUbergraph_PlaneCharacter_1"), this));
				__CurrentState = -1;
				break;
			}
		case 42:
...
void APlaneCharacter_C__pf2222656877::bpf__ExecuteUbergraph_PlaneCharacter__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	APlaneTrail_C__pf702804625* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 34);
	// optimized KCST_UnconditionalGoto
	if (!bpv__CanSpawn__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	if(::IsValid(bpv__ChildActor__pf))
	{
		bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf = bpv__ChildActor__pf->USceneComponent::K2_GetComponentToWorld();
	}
	bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, APlaneTrail_C__pf702804625::StaticClass(), bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AdjustIfPossibleButAlwaysSpawn, ((AActor*)nullptr));
	if(::IsValid(bpv__ChildActor__pf))
	{
		bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf = bpv__ChildActor__pf->USceneComponent::K2_GetComponentToWorld();
	}
	bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<APlaneTrail_C__pf702804625>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf), ECastCheckedType::NullAllowed);
	return; //KCST_EndOfThread
}
void APlaneCharacter_C__pf2222656877::bpf__ExecuteUbergraph_PlaneCharacter__pf_3(int32 bpp__EntryPoint__pf)
{
...
void APlaneCharacter_C__pf2222656877::bpf__ExecuteUbergraph_PlaneCharacter__pf_4(int32 bpp__EntryPoint__pf)
{
...
void APlaneCharacter_C__pf2222656877::bpf__ExecuteUbergraph_PlaneCharacter__pf_5(int32 bpp__EntryPoint__pf)
{
...
void APlaneCharacter_C__pf2222656877::bpf__MoveEvent__pf()
{
	bpf__ExecuteUbergraph_PlaneCharacter__pf_1(42);
}
void APlaneCharacter_C__pf2222656877::bpf__Follow__pf()
{
	bpf__ExecuteUbergraph_PlaneCharacter__pf_3(39);
}
void APlaneCharacter_C__pf2222656877::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_PlaneCharacter__pf_0(38);
}
void APlaneCharacter_C__pf2222656877::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_PlaneCharacter__pf_2(34);
}
void APlaneCharacter_C__pf2222656877::bpf__MoveCamera__pf()
{
	bpf__ExecuteUbergraph_PlaneCharacter__pf_4(27);
}
void APlaneCharacter_C__pf2222656877::bpf__MoveToTarget__pf()
{
	bpf__ExecuteUbergraph_PlaneCharacter__pf_5(7);
}
PRAGMA_DISABLE_OPTIMIZATION
void APlaneCharacter_C__pf2222656877::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APlaneCharacter_C__pf2222656877::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{938, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Art/PlaneTrail/PlaneTrail.PlaneTrail_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APlaneCharacter_C__pf2222656877
{
	FRegisterHelper__APlaneCharacter_C__pf2222656877()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/ThirdPersonBP/Blueprints/PlaneCharacter"), &APlaneCharacter_C__pf2222656877::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APlaneCharacter_C__pf2222656877 Instance;
};
FRegisterHelper__APlaneCharacter_C__pf2222656877 FRegisterHelper__APlaneCharacter_C__pf2222656877::Instance;
