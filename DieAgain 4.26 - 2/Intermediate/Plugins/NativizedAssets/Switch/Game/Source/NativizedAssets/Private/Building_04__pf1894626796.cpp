...
ABuilding_04_C__pf1894626796::ABuilding_04_C__pf1894626796(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__DestructibleMesh__pf = CreateDefaultSubobject<UDestructibleComponent>(TEXT("DestructibleMesh"));
	...
	bpv__DestructibleMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__DestructibleMesh__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__DestructibleMesh__pf->FractureEffects = TArray<FFractureEffect> ();
	bpv__DestructibleMesh__pf->FractureEffects.AddUninitialized(2);
	FFractureEffect::StaticStruct()->InitializeStruct(bpv__DestructibleMesh__pf->FractureEffects.GetData(), 2);
	auto& __Local__2 = bpv__DestructibleMesh__pf->FractureEffects[0];
	auto& __Local__3 = bpv__DestructibleMesh__pf->FractureEffects[1];
	bpv__DestructibleMesh__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(ABuilding_04_C__pf1894626796::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__DestructibleMesh__pf->VisibilityBasedAnimTickOption = EVisibilityBasedAnimTickOption::AlwaysTickPoseAndRefreshBones;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__DestructibleMesh__pf), false, 0));
...
void ABuilding_04_C__pf1894626796::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__DestructibleMesh__pf)
	{
		bpv__DestructibleMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ABuilding_04_C__pf1894626796::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABuilding_04_C__pf1894626796::bpf__ExecuteUbergraph_Building_04__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 7:
			{
				...
				b0l__K2Node_DynamicCast_AsCamera_Actor__pf = Cast<ACameraActor_C__pf1295471953>(b0l__CallFunc_Array_Get_Item__pf);
		...
		case 8:
			{
				...
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = b0l__K2Node_DynamicCast_AsCamera_Actor__pf->AActor::K2_GetActorLocation();
				}
				UGameplayStatics::PlayWorldCameraShake(this, CastChecked<UClass>(CastChecked<UDynamicClass>(ABuilding_04_C__pf1894626796::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, 0.000000, 10.000000, 1.000000, false);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 9:
			{
				UKismetSystemLibrary::Delay(this, 0.250000, FLatentActionInfo(10, 1068085295, TEXT("ExecuteUbergraph_Building_04_0"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 10:
		...
		case 11:
			{
				if(::IsValid(bpv__DestructibleMesh__pf))
				{
					bpv__DestructibleMesh__pf->SetCollisionEnabled(ECollisionEnabled::PhysicsOnly);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 26:
			{
				if(::IsValid(bpv__DestructibleMesh__pf))
				{
					bpv__DestructibleMesh__pf->ApplyRadiusDamage(100000.000000, b0l__K2Node_CustomEvent_HitOrigin__pf, 180000.000000, 10000.000000, true);
				}
			}
		case 27:
			{
				if(::IsValid(bpv__DestructibleMesh__pf))
				{
					bpv__DestructibleMesh__pf->SetCollisionResponseToAllChannels(ECollisionResponse::ECR_Ignore);
				}
			}
		case 28:
			{
				UKismetSystemLibrary::Delay(this, 0.250000, FLatentActionInfo(15, -20858344, TEXT("ExecuteUbergraph_Building_04_0"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		default:
...
void ABuilding_04_C__pf1894626796::bpf__ExecuteUbergraph_Building_04__pf_1(int32 bpp__EntryPoint__pf)
{
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
		...
		case 14:
			{
				bpf__DestroyFunction__pf(FVector(0.000000,0.000000,0.000000));
				__CurrentState = -1;
				break;
			}
		case 16:
		...
		case 17:
			{
				UKismetSystemLibrary::Delay(this, 3.500000, FLatentActionInfo(13, 96887784, TEXT("ExecuteUbergraph_Building_04_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void ABuilding_04_C__pf1894626796::bpf__DestroyFunction__pf(FVector bpp__HitOrigin__pf)
{
	b0l__K2Node_CustomEvent_HitOrigin__pf = bpp__HitOrigin__pf;
	bpf__ExecuteUbergraph_Building_04__pf_0(18);
}
void ABuilding_04_C__pf1894626796::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Building_04__pf_1(16);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABuilding_04_C__pf1894626796::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABuilding_04_C__pf1894626796::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABuilding_04_C__pf1894626796
{
	FRegisterHelper__ABuilding_04_C__pf1894626796()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Art/DestructibleMesh/Building_04"), &ABuilding_04_C__pf1894626796::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABuilding_04_C__pf1894626796 Instance;
};
FRegisterHelper__ABuilding_04_C__pf1894626796 FRegisterHelper__ABuilding_04_C__pf1894626796::Instance;
