...
AShotgunPickUp_C__pf1651478651::AShotgunPickUp_C__pf1651478651(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__WeaponShotgun__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("WeaponShotgun"));
	...
	bpv__ExtraAmmo__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("ExtraAmmo"));
	bpv__BarrelCover__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("BarrelCover"));
	...
	bpv__WeaponShotgun__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__WeaponShotgun__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__WeaponShotgun__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__WeaponShotgun__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__WeaponShotgun__pf->OverrideMaterials.Reserve(1);
	bpv__WeaponShotgun__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__WeaponShotgun__pf->bReceivesDecals = false;
	auto& __Local__3 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__WeaponShotgun__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__3 = ECollisionEnabled::Type::PhysicsOnly;
	auto& __Local__4 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__WeaponShotgun__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__5.AddUninitialized(9);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__5.GetData(), 9);
	...
	__Local__9.Channel = FName(TEXT("GunShoot"));
	...
	bpv__WeaponShotgun__pf->BodyInstance.bSimulatePhysics = true;
	bpv__WeaponShotgun__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__15 = (*(AccessPrivateProperty<FVector >((bpv__WeaponShotgun__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__15 = FVector(0.000088, 30.000000, 33.999992);
	auto& __Local__16 = (*(AccessPrivateProperty<FRotator >((bpv__WeaponShotgun__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__16 = FRotator(89.999992, -628.281616, 2341.718018);
	auto& __Local__17 = (*(AccessPrivateProperty<FVector >((bpv__WeaponShotgun__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__17 = FVector(2.000000, 2.000000, 2.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__WeaponShotgun__pf), true, 0));
	bpv__BoxCollision__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__BoxCollision__pf->AttachToComponent(bpv__WeaponShotgun__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__BoxCollision__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__18 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__BoxCollision__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__19.AddUninitialized(10);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__19.GetData(), 10);
	...
	__Local__28.Channel = FName(TEXT("OverlapShoot"));
	__Local__28.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__29 = __Local__19[9];
	__Local__29.Channel = FName(TEXT("GunShoot"));
	__Local__29.Response = ECollisionResponse::ECR_Ignore;
	bpv__BoxCollision__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__30 = (*(AccessPrivateProperty<FVector >((bpv__BoxCollision__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__30 = FVector(38.000015, 18.499985, 6.999801);
	auto& __Local__31 = (*(AccessPrivateProperty<FRotator >((bpv__BoxCollision__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__31 = FRotator(-0.000206, -0.000069, 0.000210);
	auto& __Local__32 = (*(AccessPrivateProperty<FVector >((bpv__BoxCollision__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__32 = FVector(1.312500, 1.843750, 1.000000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__BoxCollision__pf), true, 0));
	bpv__HandGuard__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__HandGuard__pf->AttachToComponent(bpv__WeaponShotgun__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__33 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__HandGuard__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__33 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	static TWeakFieldPtr<FProperty> __Local__35{};
	const FProperty* __Local__34 = __Local__35.Get();
	if (nullptr == __Local__34)
	{
		__Local__34 = (UPrimitiveComponent::StaticClass())->FindPropertyByName(FName(TEXT("bGenerateOverlapEvents")));
		check(__Local__34);
		__Local__35 = __Local__34;
	}
	(((FBoolProperty*)__Local__34)->SetPropertyValue_InContainer((bpv__HandGuard__pf), false, 0));
	bpv__HandGuard__pf->bReceivesDecals = false;
	auto& __Local__36 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__HandGuard__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__36 = ECollisionChannel::ECC_WorldStatic;
	auto& __Local__37 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__HandGuard__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__37 = ECollisionEnabled::Type::PhysicsOnly;
	auto& __Local__38 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__HandGuard__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__39.AddUninitialized(9);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__39.GetData(), 9);
	...
	__Local__48.Channel = FName(TEXT("PhysicsBody"));
	__Local__48.Response = ECollisionResponse::ECR_Overlap;
	bpv__HandGuard__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__49 = (*(AccessPrivateProperty<FVector >((bpv__HandGuard__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__49 = FVector(-0.000000, 42.000000, 7.999998);
	...
	bpv__Buttstock__pf->AttachToComponent(bpv__WeaponShotgun__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__50 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Buttstock__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__50 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	(((FBoolProperty*)__Local__34)->SetPropertyValue_InContainer((bpv__Buttstock__pf), false, 0));
	bpv__Buttstock__pf->bReceivesDecals = false;
	auto& __Local__51 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__Buttstock__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__51 = ECollisionChannel::ECC_WorldStatic;
	auto& __Local__52 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__Buttstock__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__52 = ECollisionEnabled::Type::PhysicsOnly;
	auto& __Local__53 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Buttstock__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	auto& __Local__54 = (*(AccessPrivateProperty<TArray<FResponseChannel> >(&(__Local__53), FCollisionResponse::__PPO__ResponseArray() )));
	__Local__54 = TArray<FResponseChannel> ();
	__Local__54.AddUninitialized(9);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__54.GetData(), 9);
	auto& __Local__55 = __Local__54[0];
	__Local__55.Channel = FName(TEXT("Visibility"));
	__Local__55.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__56 = __Local__54[1];
	__Local__56.Channel = FName(TEXT("Camera"));
	__Local__56.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__57 = __Local__54[2];
	__Local__57.Channel = FName(TEXT("OverlapShoot"));
	__Local__57.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__58 = __Local__54[3];
	__Local__58.Channel = FName(TEXT("GunShoot"));
	__Local__58.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__59 = __Local__54[4];
	__Local__59.Channel = FName(TEXT("WorldDynamic"));
	__Local__59.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__60 = __Local__54[5];
	__Local__60.Channel = FName(TEXT("Pawn"));
	__Local__60.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__61 = __Local__54[6];
	__Local__61.Channel = FName(TEXT("Vehicle"));
	__Local__61.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__62 = __Local__54[7];
	__Local__62.Channel = FName(TEXT("Destructible"));
	__Local__62.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__63 = __Local__54[8];
	__Local__63.Channel = FName(TEXT("PhysicsBody"));
	__Local__63.Response = ECollisionResponse::ECR_Overlap;
	bpv__Buttstock__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__64 = (*(AccessPrivateProperty<FVector >((bpv__Buttstock__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__64 = FVector(0.000000, -8.000000, 8.999998);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Buttstock__pf), true, 0));
	bpv__ExtraAmmo__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ExtraAmmo__pf->AttachToComponent(bpv__WeaponShotgun__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__65 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__ExtraAmmo__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__65 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	(((FBoolProperty*)__Local__34)->SetPropertyValue_InContainer((bpv__ExtraAmmo__pf), false, 0));
	bpv__ExtraAmmo__pf->bReceivesDecals = false;
	auto& __Local__66 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__ExtraAmmo__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__66 = ECollisionChannel::ECC_WorldStatic;
	auto& __Local__67 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__ExtraAmmo__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__67 = ECollisionEnabled::Type::PhysicsOnly;
	auto& __Local__68 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__ExtraAmmo__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	auto& __Local__69 = (*(AccessPrivateProperty<TArray<FResponseChannel> >(&(__Local__68), FCollisionResponse::__PPO__ResponseArray() )));
	__Local__69 = TArray<FResponseChannel> ();
	__Local__69.AddUninitialized(9);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__69.GetData(), 9);
	...
	auto& __Local__72 = __Local__69[2];
	__Local__72.Channel = FName(TEXT("OverlapShoot"));
	__Local__72.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__73 = __Local__69[3];
	__Local__73.Channel = FName(TEXT("GunShoot"));
	__Local__73.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__74 = __Local__69[4];
	__Local__74.Channel = FName(TEXT("WorldDynamic"));
	__Local__74.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__75 = __Local__69[5];
	__Local__75.Channel = FName(TEXT("Pawn"));
	__Local__75.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__76 = __Local__69[6];
	__Local__76.Channel = FName(TEXT("Vehicle"));
	__Local__76.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__77 = __Local__69[7];
	__Local__77.Channel = FName(TEXT("Destructible"));
	__Local__77.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__78 = __Local__69[8];
	__Local__78.Channel = FName(TEXT("PhysicsBody"));
	__Local__78.Response = ECollisionResponse::ECR_Overlap;
	bpv__ExtraAmmo__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__79 = (*(AccessPrivateProperty<FVector >((bpv__ExtraAmmo__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__79 = FVector(-0.000000, 17.000000, 10.499998);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__ExtraAmmo__pf), true, 0));
	bpv__BarrelCover__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__BarrelCover__pf->AttachToComponent(bpv__WeaponShotgun__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__80 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__BarrelCover__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__80 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	(((FBoolProperty*)__Local__34)->SetPropertyValue_InContainer((bpv__BarrelCover__pf), false, 0));
	bpv__BarrelCover__pf->bReceivesDecals = false;
	auto& __Local__81 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__BarrelCover__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__81 = ECollisionChannel::ECC_WorldStatic;
	auto& __Local__82 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__BarrelCover__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__82 = ECollisionEnabled::Type::PhysicsOnly;
	auto& __Local__83 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__BarrelCover__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	auto& __Local__84 = (*(AccessPrivateProperty<TArray<FResponseChannel> >(&(__Local__83), FCollisionResponse::__PPO__ResponseArray() )));
	__Local__84 = TArray<FResponseChannel> ();
	__Local__84.AddUninitialized(9);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__84.GetData(), 9);
	auto& __Local__85 = __Local__84[0];
	__Local__85.Channel = FName(TEXT("Visibility"));
	__Local__85.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__86 = __Local__84[1];
	__Local__86.Channel = FName(TEXT("Camera"));
	__Local__86.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__87 = __Local__84[2];
	__Local__87.Channel = FName(TEXT("OverlapShoot"));
	__Local__87.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__88 = __Local__84[3];
	__Local__88.Channel = FName(TEXT("GunShoot"));
	__Local__88.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__89 = __Local__84[4];
	__Local__89.Channel = FName(TEXT("WorldDynamic"));
	__Local__89.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__90 = __Local__84[5];
	__Local__90.Channel = FName(TEXT("Pawn"));
	__Local__90.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__91 = __Local__84[6];
	__Local__91.Channel = FName(TEXT("Vehicle"));
	__Local__91.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__92 = __Local__84[7];
	__Local__92.Channel = FName(TEXT("Destructible"));
	__Local__92.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__93 = __Local__84[8];
	__Local__93.Channel = FName(TEXT("PhysicsBody"));
	__Local__93.Response = ECollisionResponse::ECR_Overlap;
	bpv__BarrelCover__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__94 = (*(AccessPrivateProperty<FVector >((bpv__BarrelCover__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__94 = FVector(-0.000000, 41.500000, 12.499998);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__BarrelCover__pf), true, 0));
	bpv__Munition__pf = 8;
	bpv__WeaponType__pf = E__EnumWeapon__pf::NewEnumerator1;
	bpv__NeedFullAmmo__pf = true;
...
void AShotgunPickUp_C__pf1651478651::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__ExtraAmmo__pf)
	{
		bpv__ExtraAmmo__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__BarrelCover__pf)
	{
		bpv__BarrelCover__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AShotgunPickUp_C__pf1651478651::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__96 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"), (EObjectFlags)0x00000000);
	InDynamicClass->DynamicBindingObjects.Add(__Local__96);
	__Local__96->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__96->ComponentDelegateBindings.AddUninitialized(2);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__96->ComponentDelegateBindings.GetData(), 2);
	auto& __Local__97 = __Local__96->ComponentDelegateBindings[0];
	__Local__97.ComponentPropertyName = FName(TEXT("BoxCollision"));
	__Local__97.DelegatePropertyName = FName(TEXT("OnComponentEndOverlap"));
	__Local__97.FunctionNameToBind = FName(TEXT("BndEvt__BoxCollision_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
	auto& __Local__98 = __Local__96->ComponentDelegateBindings[1];
	__Local__98.ComponentPropertyName = FName(TEXT("BoxCollision"));
	__Local__98.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__98.FunctionNameToBind = FName(TEXT("BndEvt__BoxCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AShotgunPickUp_C__pf1651478651::bpf__ExecuteUbergraph_ShotgunPickUp__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bool bpfv__CallFunc_IsPlayerControlled_ReturnValue_5__pf{};
	bool bpfv__CallFunc_IsPlayerControlled_ReturnValue_6__pf{};
	...
	do
	{
		...
		case 7:
			{
				if(::IsValid(bpv__BarrelCover__pf))
				{
					bpv__BarrelCover__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
			}
		case 8:
			{
				AActor*  __Local__99 = ((AActor*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_5__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf->bpv__OverlapingActor__pf) : (__Local__99)), this);
		...
		case 9:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf->bpv__IsOverlapingActor__pf = false;
				}
			}
		case 10:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf))
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf->bpv__OverlapingActor__pf = ((AActor*)nullptr);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 36:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf != nullptr);;
		...
		case 37:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_2__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->IsPlayerControlled();
				}
		...
		case 38:
			{
				if(::IsValid(b0l__K2Node_ComponentBoundEvent_OtherActor__pf) && ::IsValid((*(AccessPrivateProperty<APawn* >((b0l__K2Node_ComponentBoundEvent_OtherActor__pf), AActor::__PPO__Instigator() )))))
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_3__pf = (*(AccessPrivateProperty<APawn* >((b0l__K2Node_ComponentBoundEvent_OtherActor__pf), AActor::__PPO__Instigator() )))->IsPlayerControlled();
				}
		...
		case 39:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
				b0l__K2Node_DynamicCast_bSuccess_4__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf != nullptr);;
		...
		case 40:
			{
				UBoxComponent*  __Local__100 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__BoxCollision__pf) : (__Local__100)), b0l__K2Node_ComponentBoundEvent_OtherComp__pf);
		...
		case 41:
			{
				if(::IsValid(bpv__WeaponShotgun__pf))
				{
					bpv__WeaponShotgun__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
			}
		case 42:
			{
				if(::IsValid(bpv__WeaponShotgun__pf))
				{
					bpv__WeaponShotgun__pf->SetMaterial(1, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed));
				}
			}
		case 43:
			{
				if(::IsValid(bpv__HandGuard__pf))
				{
					bpv__HandGuard__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
			}
		case 44:
			{
				if(::IsValid(bpv__Buttstock__pf))
				{
					bpv__Buttstock__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed));
				}
			}
		case 45:
			{
				if(::IsValid(bpv__ExtraAmmo__pf))
				{
					bpv__ExtraAmmo__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
			}
		case 46:
			{
		...
		case 47:
			{
				AActor*  __Local__101 = ((AActor*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_4__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__OverlapingActor__pf) : (__Local__101)), this);
		...
		case 48:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__IsOverlapingActor__pf = false;
				}
			}
		case 49:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf))
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->bpv__OverlapingActor__pf = ((AActor*)nullptr);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 50:
			{
				b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
				b0l__K2Node_DynamicCast_bSuccess_3__pf = (b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf != nullptr);;
		...
		case 51:
			{
				UBoxComponent*  __Local__102 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_1__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_2__pf->bpv__BoxCollision__pf) : (__Local__102)), b0l__K2Node_ComponentBoundEvent_OtherComp__pf);
		...
		case 57:
			{
				b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
		...
		case 58:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_1__pf = b0l__K2Node_DynamicCast_AsThird_Person_Character_1__pf->IsPlayerControlled();
				}
		...
		case 70:
			{
				...
				b0l__K2Node_DynamicCast_AsThird_Person_Character_5__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpfv__CallFunc_GetPlayerCharacter_ReturnValue_1__pf);
				b0l__K2Node_DynamicCast_bSuccess_9__pf = (b0l__K2Node_DynamicCast_AsThird_Person_Character_5__pf != nullptr);;
		...
		case 71:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_5__pf))
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_5__pf = b0l__K2Node_DynamicCast_AsThird_Person_Character_5__pf->IsPlayerControlled();
				}
				if (!bpfv__CallFunc_IsPlayerControlled_ReturnValue_5__pf)
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
					break;
				}
		...
		case 72:
			{
				...
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpfv__CallFunc_GetPlayerCharacter_ReturnValue_2__pf);
				b0l__K2Node_DynamicCast_bSuccess_10__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf != nullptr);;
		...
		case 73:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf))
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_6__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf->IsPlayerControlled();
				}
				if (!bpfv__CallFunc_IsPlayerControlled_ReturnValue_6__pf)
				{
					__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
					break;
				}
...
void AShotgunPickUp_C__pf1651478651::bpf__ExecuteUbergraph_ShotgunPickUp__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 3:
			{
				...
				b0l__K2Node_DynamicCast_AsThird_Person_Character_4__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf);
				b0l__K2Node_DynamicCast_bSuccess_8__pf = (b0l__K2Node_DynamicCast_AsThird_Person_Character_4__pf != nullptr);;
		...
		case 4:
			{
				bool  __Local__103 = false;
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_4__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_4__pf->bpv__ExtraAmmoShotgun__pf) : (__Local__103)))
				{
					__CurrentState = 6;
					break;
				}
		...
		case 60:
			{
				if(::IsValid(bpv__WeaponShotgun__pf))
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue__pf = bpv__WeaponShotgun__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
				}
			}
		case 61:
			{
		...
		case 67:
			{
				UKismetSystemLibrary::Delay(this, 0.100000, FLatentActionInfo(1, -1476732201, TEXT("ExecuteUbergraph_ShotgunPickUp_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void AShotgunPickUp_C__pf1651478651::bpf__ExecuteUbergraph_ShotgunPickUp__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 12:
			{
				bpfv__CallFunc_LessEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::LessEqual_IntInt(bpv__Munition__pf, 0);
		...
		case 13:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf);
				b0l__K2Node_DynamicCast_bSuccess_5__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf != nullptr);;
		...
		case 14:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue_4__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->IsPlayerControlled();
				}
		...
		case 15:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf);
				b0l__K2Node_DynamicCast_bSuccess_7__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf != nullptr);;
		...
		case 16:
			{
				bool  __Local__105 = false;
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__IsSlave__pf) : (__Local__105)))
				{
					__CurrentState = 18;
					break;
				}
		...
		case 17:
			{
				bool  __Local__106 = false;
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__IsGodModeActive__pf) : (__Local__106)))
				{
					__CurrentState = -1;
					break;
				}
		...
		case 18:
			{
				UBoxComponent*  __Local__107 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_2__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__BoxCollision__pf) : (__Local__107)), b0l__K2Node_ComponentBoundEvent_OtherComp_1__pf);
		...
		case 19:
			{
				AActor*  __Local__108 = ((AActor*)nullptr);
				bpf__OverlapClean__pf(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__OverlapingActor__pf) : (__Local__108)));
			}
		case 20:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf))
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__IsOverlapingActor__pf = true;
				}
			}
		case 21:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf))
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpv__OverlapingActor__pf = this;
				}
			}
		case 22:
			{
				if(::IsValid(bpv__WeaponShotgun__pf))
				{
					bpv__WeaponShotgun__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed));
				}
			}
		case 23:
			{
				if(::IsValid(bpv__WeaponShotgun__pf))
				{
					bpv__WeaponShotgun__pf->SetMaterial(1, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed));
				}
			}
		case 24:
			{
				if(::IsValid(bpv__HandGuard__pf))
				{
					bpv__HandGuard__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed));
				}
			}
		case 25:
			{
				if(::IsValid(bpv__Buttstock__pf))
				{
					bpv__Buttstock__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed));
				}
			}
		case 26:
			{
				if(::IsValid(bpv__ExtraAmmo__pf))
				{
					bpv__ExtraAmmo__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed));
				}
			}
		case 27:
			{
				if(::IsValid(bpv__BarrelCover__pf))
				{
					bpv__BarrelCover__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 28:
			{
				b0l__K2Node_DynamicCast_AsThird_Person_Character__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf);
		...
		case 29:
			{
				...
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue__pf = b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->IsPlayerControlled();
				}
		...
		case 30:
			{
				b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf);
				b0l__K2Node_DynamicCast_bSuccess_6__pf = (b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf != nullptr);;
		...
		case 31:
			{
				UBoxComponent*  __Local__109 = ((UBoxComponent*)nullptr);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue_3__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__BoxCollision__pf) : (__Local__109)), b0l__K2Node_ComponentBoundEvent_OtherComp_1__pf);
		...
		case 32:
			{
				AActor*  __Local__110 = ((AActor*)nullptr);
				bpf__OverlapClean__pf(((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__OverlapingActor__pf) : (__Local__110)));
			}
		case 33:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf))
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__IsOverlapingActor__pf = true;
				}
			}
		case 34:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf))
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character_3__pf->bpv__OverlapingActor__pf = this;
				}
				__CurrentState = 22;
				break;
			}
...
void AShotgunPickUp_C__pf1651478651::bpf__CleanPickUp__pf()
{
	bpf__ExecuteUbergraph_ShotgunPickUp__pf_0(68);
}
void AShotgunPickUp_C__pf1651478651::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_ShotgunPickUp__pf_1(59);
}
void AShotgunPickUp_C__pf1651478651::bpf__BndEvt__BoxCollision_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
	...
	bpf__ExecuteUbergraph_ShotgunPickUp__pf_0(35);
}
void AShotgunPickUp_C__pf1651478651::bpf__BndEvt__BoxCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	typedef FHitResult  T__Local__111;
	T__Local__111& bpp__SweepResult__pf = *const_cast<T__Local__111 *>(&bpp__SweepResult__pf__const);
	...
	bpf__ExecuteUbergraph_ShotgunPickUp__pf_2(11);
}
void AShotgunPickUp_C__pf1651478651::bpf__Construction__pf(E__EnumWeapon__pf bpp__NewParam__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpp__NewParam__pf), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator0));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 2;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpp__NewParam__pf), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator1));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 5;
					break;
				}
				bpfv__K2Node_SwitchEnum_CmpSuccess__pf = UKismetMathLibrary::NotEqual_ByteByte(static_cast<uint8>(bpp__NewParam__pf), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator4));
				if (!bpfv__K2Node_SwitchEnum_CmpSuccess__pf)
				{
					__CurrentState = 8;
					break;
		...
		case 2:
			{
				if(::IsValid(bpv__WeaponShotgun__pf))
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue__pf = bpv__WeaponShotgun__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed));
				}
			}
		case 3:
			{
				if(::IsValid(bpv__WeaponShotgun__pf))
				{
					bpv__WeaponShotgun__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed));
				}
			}
		case 4:
			{
				bpv__Munition__pf = 30;
				__CurrentState = -1;
				break;
			}
		case 5:
			{
				if(::IsValid(bpv__WeaponShotgun__pf))
				{
					bpfv__CallFunc_SetStaticMesh_ReturnValue_1__pf = bpv__WeaponShotgun__pf->SetStaticMesh(CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed));
				}
			}
		case 6:
			{
				if(::IsValid(bpv__WeaponShotgun__pf))
				{
					bpv__WeaponShotgun__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AShotgunPickUp_C__pf1651478651::StaticClass())->UsedAssets[11], ECastCheckedType::NullAllowed));
				}
			}
		case 7:
			{
		...
		case 8:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("ERROR SPAWING WEAPON")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
				__CurrentState = -1;
				break;
			}
		default:
...
void AShotgunPickUp_C__pf1651478651::bpf__OverlapClean__pf(AActor* bpp__OldOverlappingActor__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__K2Node_DynamicCast_AsRifle_Pick_Up__pf = Cast<ARiflePickUp_C__pf1651478651>(bpp__OldOverlappingActor__pf);
		...
		case 2:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsRifle_Pick_Up__pf->bpf__CleanPickUp__pf();
				}
				__CurrentState = -1;
				break;
			}
		case 3:
			{
				bpfv__K2Node_DynamicCast_AsShotgun_Pick_Up__pf = Cast<AShotgunPickUp_C__pf1651478651>(bpp__OldOverlappingActor__pf);
		...
		case 4:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsShotgun_Pick_Up__pf->bpf__CleanPickUp__pf();
				}
				__CurrentState = -1;
				break;
			}
		case 5:
			{
				bpfv__K2Node_DynamicCast_AsKnife_Pick_Up__pf = Cast<AKnifePickUp_C__pf1651478651>(bpp__OldOverlappingActor__pf);
		...
		case 6:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsKnife_Pick_Up__pf->bpf__CleanPickUp__pf();
				}
				__CurrentState = -1;
				break;
			}
		case 7:
			{
				bpfv__K2Node_DynamicCast_AsSniper_Pick_Up__pf = Cast<ASniperPickUp_C__pf1651478651>(bpp__OldOverlappingActor__pf);
		...
		case 8:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsSniper_Pick_Up__pf->bpf__CleanPickUp__pf();
				}
				__CurrentState = -1;
				break;
			}
		case 9:
			{
				bpfv__K2Node_DynamicCast_AsRPGPick_Up__pf = Cast<ARPGPickUp_C__pf1651478651>(bpp__OldOverlappingActor__pf);
		...
		case 10:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsRPGPick_Up__pf->bpf__CleanPickUp__pf();
				}
				__CurrentState = -1;
				break;
			}
		case 11:
			{
				bpfv__K2Node_DynamicCast_AsAShotgun_Pick_Up__pf = Cast<AAShotgunPickUp_C__pf1651478651>(bpp__OldOverlappingActor__pf);
		...
		case 12:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsAShotgun_Pick_Up__pf->bpf__CleanPickUp__pf();
				}
				__CurrentState = -1;
				break;
			}
...
PRAGMA_DISABLE_OPTIMIZATION
void AShotgunPickUp_C__pf1651478651::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AShotgunPickUp_C__pf1651478651::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AShotgunPickUp_C__pf1651478651
{
	FRegisterHelper__AShotgunPickUp_C__pf1651478651()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/PickUps/ShotgunPickUp"), &AShotgunPickUp_C__pf1651478651::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AShotgunPickUp_C__pf1651478651 Instance;
};
FRegisterHelper__AShotgunPickUp_C__pf1651478651 FRegisterHelper__AShotgunPickUp_C__pf1651478651::Instance;
