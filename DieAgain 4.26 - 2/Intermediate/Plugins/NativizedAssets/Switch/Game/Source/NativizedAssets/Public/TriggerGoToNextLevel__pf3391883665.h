...
#include "TriggerGoToNextLevel__pf3391883665.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Levels/PrototypeLevel/TriggerGoToNextLevel.TriggerGoToNextLevel_C", OverrideNativeName="TriggerGoToNextLevel_C"))
class ATriggerGoToNextLevel_C__pf3391883665 : public AActor
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(DisplayName="Name Of the Level", Category="Default", MultiLine="true", OverrideNativeName="NameOfTheLevel"))
	FName bpv__NameOfTheLevel__pf;
	...
	ATriggerGoToNextLevel_C__pf3391883665(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_TriggerGoToNextLevel__pf_0(int32 bpp__EntryPoint__pf);
