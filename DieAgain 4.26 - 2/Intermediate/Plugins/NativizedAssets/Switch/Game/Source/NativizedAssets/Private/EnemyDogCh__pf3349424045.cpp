...
#include "Dog_AnimBP__pf497756500.h"
...
AEnemyDogCh_C__pf3349424045::AEnemyDogCh_C__pf3349424045(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	if(__Local__0)
	{
		...
		__Local__10.Channel = FName(TEXT("ExplosionMissile"));
	...
	if(__Local__2)
	{
		...
		__Local__18.AddUninitialized(6);
		FResponseChannel::StaticStruct()->InitializeStruct(__Local__18.GetData(), 6);
		...
		auto& __Local__26 = (*(AccessPrivateProperty<FVector >((__Local__2), USceneComponent::__PPO__RelativeLocation() )));
		__Local__26 = FVector(0.000000, 0.000000, -80.000000);
		...
		(((FBoolProperty*)__Local__27)->SetPropertyValue_InContainer((__Local__2), false, 0));
	...
	bpv__Collar__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Collar"));
	bpv__Collision__pf = CreateDefaultSubobject<UBoxComponent>(TEXT("Collision"));
	bpv__FMODAudio__pf = CreateDefaultSubobject<UFMODAudioComponent>(TEXT("FMODAudio"));
	...
	bpv__SkeletalMesh__pf->AnimClass = UDog_AnimBP_C__pf497756500::StaticClass();
	bpv__SkeletalMesh__pf->ClothingSimulationFactory = UClothingSimulationFactoryNv::StaticClass();
	bpv__SkeletalMesh__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	bpv__SkeletalMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__SkeletalMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__SkeletalMesh__pf->bReceivesDecals = false;
	bpv__SkeletalMesh__pf->SetCollisionProfileName(FName(TEXT("Ragdoll")));
	auto& __Local__29 = (*(AccessPrivateProperty<FVector >((bpv__SkeletalMesh__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__29 = FVector(-28.124037, 0.001921, -22.212990);
	auto& __Local__30 = (*(AccessPrivateProperty<FRotator >((bpv__SkeletalMesh__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__30 = FRotator(0.000000, -90.000183, 0.000000);
	...
	(((FBoolProperty*)__Local__31)->SetPropertyValue_InContainer((bpv__SkeletalMesh__pf), false, 0));
	bpv__ChildActor__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ChildActor__pf->AttachToComponent(bpv__SkeletalMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__33 = (*(AccessPrivateProperty<FVector >((bpv__ChildActor__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__33 = FVector(-0.000471, 87.384689, 61.001396);
	(((FBoolProperty*)__Local__31)->SetPropertyValue_InContainer((bpv__ChildActor__pf), false, 0));
	bpv__Collar__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Collar__pf->AttachToComponent(bpv__SkeletalMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__34 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Collar__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__34 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__Collar__pf->SetCollisionProfileName(FName(TEXT("NoCollision")));
	auto& __Local__35 = (*(AccessPrivateProperty<FVector >((bpv__Collar__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__35 = FVector(8.742061, -1.926984, -0.810899);
	auto& __Local__36 = (*(AccessPrivateProperty<FRotator >((bpv__Collar__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__36 = FRotator(62.363121, -83.835701, -83.216797);
	auto& __Local__37 = (*(AccessPrivateProperty<FVector >((bpv__Collar__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__37 = FVector(0.400000, 0.400000, 0.150000);
	(((FBoolProperty*)__Local__31)->SetPropertyValue_InContainer((bpv__Collar__pf), false, 0));
	bpv__Collision__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Collision__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Collision__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__38 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__Collision__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__38 = ECollisionChannel::ECC_WorldStatic;
	auto& __Local__39 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Collision__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	auto& __Local__40 = (*(AccessPrivateProperty<TArray<FResponseChannel> >(&(__Local__39), FCollisionResponse::__PPO__ResponseArray() )));
	__Local__40 = TArray<FResponseChannel> ();
	__Local__40.AddUninitialized(10);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__40.GetData(), 10);
	auto& __Local__41 = __Local__40[0];
	__Local__41.Channel = FName(TEXT("WorldStatic"));
	...
	__Local__43.Channel = FName(TEXT("Pawn"));
	__Local__43.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__44 = __Local__40[3];
	__Local__44.Channel = FName(TEXT("Camera"));
	__Local__44.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__45 = __Local__40[4];
	__Local__45.Channel = FName(TEXT("PhysicsBody"));
	__Local__45.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__46 = __Local__40[5];
	__Local__46.Channel = FName(TEXT("Vehicle"));
	__Local__46.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__47 = __Local__40[6];
	__Local__47.Channel = FName(TEXT("Destructible"));
	__Local__47.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__48 = __Local__40[7];
	__Local__48.Channel = FName(TEXT("GunShoot"));
	__Local__48.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__49 = __Local__40[8];
	__Local__49.Channel = FName(TEXT("OverlapShoot"));
	__Local__49.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__50 = __Local__40[9];
	__Local__50.Channel = FName(TEXT("ExplosionMissile"));
	__Local__50.Response = ECollisionResponse::ECR_Ignore;
	bpv__Collision__pf->SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__51 = (*(AccessPrivateProperty<FVector >((bpv__Collision__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__51 = FVector(-40.136181, 0.000946, -7.622982);
	auto& __Local__52 = (*(AccessPrivateProperty<FVector >((bpv__Collision__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__52 = FVector(3.156250, 0.687500, 2.656250);
	(((FBoolProperty*)__Local__31)->SetPropertyValue_InContainer((bpv__Collision__pf), true, 0));
	bpv__FMODAudio__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__FMODAudio__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__FMODAudio__pf->Event = CastChecked<UFMODEvent>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	(((FBoolProperty*)__Local__31)->SetPropertyValue_InContainer((bpv__FMODAudio__pf), false, 0));
	...
	bpv__CanBork__pf = false;
	auto& __Local__53 = (*(AccessPrivateProperty<USkeletalMeshComponent*>((this), ACharacter::__PPO__Mesh() )));
	__Local__53 = __Local__2;
	auto& __Local__54 = (*(AccessPrivateProperty<UCharacterMovementComponent*>((this), ACharacter::__PPO__CharacterMovement() )));
	__Local__54 = __Local__1;
	auto& __Local__55 = (*(AccessPrivateProperty<UCapsuleComponent*>((this), ACharacter::__PPO__CapsuleComponent() )));
	__Local__55 = __Local__0;
	bUseControllerRotationYaw = false;
	AIControllerClass = AAIDogController_C__pf60788051::StaticClass();
	auto& __Local__56 = (*(AccessPrivateProperty<EActorUpdateOverlapsMethod >((this), AActor::__PPO__DefaultUpdateOverlapsMethodDuringLevelStreaming() )));
	__Local__56 = EActorUpdateOverlapsMethod::OnlyUpdateMovable;
}
PRAGMA_ENABLE_OPTIMIZATION
void AEnemyDogCh_C__pf3349424045::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__FMODAudio__pf)
	{
		bpv__FMODAudio__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AEnemyDogCh_C__pf3349424045::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UDog_AnimBP_C__pf497756500::StaticClass());
	...
	auto __Local__57 = NewObject<USceneComponent>(InDynamicClass, USceneComponent::StaticClass(), TEXT("DefaultSceneRoot_GEN_VARIABLE"), (EObjectFlags)0x00280029);
	InDynamicClass->ComponentTemplates.Add(__Local__57);
	auto __Local__58 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"), (EObjectFlags)0x00000000);
	InDynamicClass->DynamicBindingObjects.Add(__Local__58);
	...
	(((FBoolProperty*)__Local__59)->SetPropertyValue_InContainer((__Local__57), false, 0));
	__Local__58->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__58->ComponentDelegateBindings.AddUninitialized(1);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__58->ComponentDelegateBindings.GetData(), 1);
	auto& __Local__61 = __Local__58->ComponentDelegateBindings[0];
	__Local__61.ComponentPropertyName = FName(TEXT("BoxWeaponCollision"));
	__Local__61.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__61.FunctionNameToBind = FName(TEXT("BndEvt__BoxWeaponCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AEnemyDogCh_C__pf3349424045::bpf__ExecuteUbergraph_EnemyDogCh__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 45:
			{
				if(::IsValid(bpv__FMODAudio__pf))
				{
					bpv__FMODAudio__pf->UFMODAudioComponent::Play();
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
void AEnemyDogCh_C__pf3349424045::bpf__ExecuteUbergraph_EnemyDogCh__pf_1(int32 bpp__EntryPoint__pf)
{
...
void AEnemyDogCh_C__pf3349424045::bpf__ExecuteUbergraph_EnemyDogCh__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 3:
			{
				UKismetSystemLibrary::Delay(this, 0.050000, FLatentActionInfo(4, -762026838, TEXT("ExecuteUbergraph_EnemyDogCh_2"), this));
				__CurrentState = -1;
				break;
			}
		case 4:
		...
		case 6:
			{
				...
				{
					bpv__Collision__pf->SetCollisionEnabled(ECollisionEnabled::NoCollision);
				}
			}
		case 7:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetCollisionEnabled(ECollisionEnabled::NoCollision);
				}
				__CurrentState = -1;
				break;
			}
		...
		case 25:
			{
				UKismetSystemLibrary::Delay(this, 0.050000, FLatentActionInfo(1, 617506609, TEXT("ExecuteUbergraph_EnemyDogCh_2"), this));
				__CurrentState = -1;
				break;
			}
		case 26:
		...
		case 60:
			{
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(bpv__HP__pf, b0l__K2Node_CustomEvent_Damage_Taken__pf);
...
void AEnemyDogCh_C__pf3349424045::bpf__ExecuteUbergraph_EnemyDogCh__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 58);
	return; //KCST_EndOfThread
}
void AEnemyDogCh_C__pf3349424045::bpf__ExecuteUbergraph_EnemyDogCh__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 13:
			{
				if(::IsValid(bpv__ChildActor__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__ChildActor__pf->USceneComponent::K2_GetComponentLocation();
				}
				if(::IsValid(b0l__K2Node_CustomEvent_EnemyActor__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = b0l__K2Node_CustomEvent_EnemyActor__pf->AActor::K2_GetActorLocation();
				}
				bpfv__CallFunc_LineTraceSingle_ReturnValue__pf = UKismetSystemLibrary::LineTraceSingle(this, bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, ETraceTypeQuery::TraceTypeQuery1, false, b0l__Temp_object_Variable__pf, EDrawDebugTrace::None, /*out*/ b0l__CallFunc_LineTraceSingle_OutHit__pf, true, FLinearColor(1.000000,0.000000,0.000000,1.000000), FLinearColor(0.000000,1.000000,0.000000,1.000000), 5.000000);
			}
		case 14:
			{
				...
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__CallFunc_BreakHitResult_HitActor__pf);
		...
		case 15:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpf__TakeDamage__pf(100, FName(TEXT("None")), FVector(0.000000,0.000000,0.000000), this);
				}
			}
		case 16:
			{
				UKismetSystemLibrary::Delay(this, 1.500000, FLatentActionInfo(8, -927644737, TEXT("ExecuteUbergraph_EnemyDogCh_4"), this));
				__CurrentState = -1;
				break;
			}
		case 17:
			{
				UGameplayStatics::BreakHitResult(b0l__CallFunc_LineTraceSingle_OutHit__pf, /*out*/ b0l__CallFunc_BreakHitResult_bBlockingHit__pf, /*out*/ b0l__CallFunc_BreakHitResult_bInitialOverlap__pf, /*out*/ b0l__CallFunc_BreakHitResult_Time__pf, /*out*/ b0l__CallFunc_BreakHitResult_Distance__pf, /*out*/ b0l__CallFunc_BreakHitResult_Location__pf, /*out*/ b0l__CallFunc_BreakHitResult_ImpactPoint__pf, /*out*/ b0l__CallFunc_BreakHitResult_Normal__pf, /*out*/ b0l__CallFunc_BreakHitResult_ImpactNormal__pf, /*out*/ b0l__CallFunc_BreakHitResult_PhysMat__pf, /*out*/ b0l__CallFunc_BreakHitResult_HitActor__pf, /*out*/ b0l__CallFunc_BreakHitResult_HitComponent__pf, /*out*/ b0l__CallFunc_BreakHitResult_HitBoneName__pf, /*out*/ b0l__CallFunc_BreakHitResult_HitItem__pf, /*out*/ b0l__CallFunc_BreakHitResult_FaceIndex__pf, /*out*/ b0l__CallFunc_BreakHitResult_TraceStart__pf, /*out*/ b0l__CallFunc_BreakHitResult_TraceEnd__pf);
				b0l__K2Node_DynamicCast_AsThird_Person_Character__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(b0l__CallFunc_BreakHitResult_HitActor__pf);
		...
		case 18:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpf__TakeDamage__pf(100, FVector(0.000000,0.000000,0.000000), this);
				}
				__CurrentState = 16;
				break;
			}
		case 19:
			{
				UGameplayStatics::BreakHitResult(b0l__CallFunc_LineTraceSingle_OutHit__pf, /*out*/ b0l__CallFunc_BreakHitResult_bBlockingHit__pf, /*out*/ b0l__CallFunc_BreakHitResult_bInitialOverlap__pf, /*out*/ b0l__CallFunc_BreakHitResult_Time__pf, /*out*/ b0l__CallFunc_BreakHitResult_Distance__pf, /*out*/ b0l__CallFunc_BreakHitResult_Location__pf, /*out*/ b0l__CallFunc_BreakHitResult_ImpactPoint__pf, /*out*/ b0l__CallFunc_BreakHitResult_Normal__pf, /*out*/ b0l__CallFunc_BreakHitResult_ImpactNormal__pf, /*out*/ b0l__CallFunc_BreakHitResult_PhysMat__pf, /*out*/ b0l__CallFunc_BreakHitResult_HitActor__pf, /*out*/ b0l__CallFunc_BreakHitResult_HitComponent__pf, /*out*/ b0l__CallFunc_BreakHitResult_HitBoneName__pf, /*out*/ b0l__CallFunc_BreakHitResult_HitItem__pf, /*out*/ b0l__CallFunc_BreakHitResult_FaceIndex__pf, /*out*/ b0l__CallFunc_BreakHitResult_TraceStart__pf, /*out*/ b0l__CallFunc_BreakHitResult_TraceEnd__pf);
				b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf = Cast<AEnemyDogCh_C__pf3349424045>(b0l__CallFunc_BreakHitResult_HitActor__pf);
		...
		case 20:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf))
				{
					b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpf__TakeDamage__pf(100, FName(TEXT("None")));
				}
				__CurrentState = 16;
				break;
			}
...
void AEnemyDogCh_C__pf3349424045::bpf__ExecuteUbergraph_EnemyDogCh__pf_5(int32 bpp__EntryPoint__pf)
{
		...
		case 37:
			{
				if(::IsValid(bpv__FMODAudio__pf))
				{
					bpv__FMODAudio__pf->UFMODAudioComponent::Stop();
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 38:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpfv__CallFunc_K2_AttachToComponent_ReturnValue__pf = bpv__Collar__pf->USceneComponent::K2_AttachToComponent(bpv__SkeletalMesh__pf, FName(TEXT("Wolf_-Neck1")), EAttachmentRule::KeepRelative, EAttachmentRule::KeepRelative, EAttachmentRule::KeepRelative, true);
				}
			}
		case 39:
			{
				bpf__SetMaterialCollar__pf();
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		default:
...
void AEnemyDogCh_C__pf3349424045::bpf__ExecuteUbergraph_EnemyDogCh__pf_6(int32 bpp__EntryPoint__pf)
{
	UParticleSystemComponent* bpfv__CallFunc_SpawnEmitterAttached_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 51);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_SpawnEmitterAttached_ReturnValue__pf = UGameplayStatics::SpawnEmitterAttached(CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed), (*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() ))), FName(TEXT("None")), FVector(0.000000,0.000000,150.000000), FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000), EAttachLocation::KeepRelativeOffset, true, EPSCPoolMethod::None, true);
	b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("OnCollideEvent")));
	if(::IsValid(bpfv__CallFunc_SpawnEmitterAttached_ReturnValue__pf))
	{
		bpfv__CallFunc_SpawnEmitterAttached_ReturnValue__pf->OnParticleCollide.AddUnique(b0l__K2Node_CreateDelegate_OutputDelegate__pf);
	}
	return; //KCST_EndOfThread
}
void AEnemyDogCh_C__pf3349424045::bpf__ExecuteUbergraph_EnemyDogCh__pf_7(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue__pf = UKismetMaterialLibrary::CreateDynamicMaterialInstance(this, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed), FName(TEXT("None")), EMIDCreationFlags::None);
	...
	bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_VectorFloat(b0l__K2Node_CustomEvent_Normal__pf, -1.000000);
	...
	bpfv__CallFunc_Conv_FloatToVector_ReturnValue__pf = UKismetMathLibrary::Conv_FloatToVector(bpfv__CallFunc_RandomFloatInRange_ReturnValue__pf);
	bpfv__CallFunc_SpawnDecalAtLocation_ReturnValue__pf = UGameplayStatics::SpawnDecalAtLocation(this, bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue__pf, bpfv__CallFunc_Conv_FloatToVector_ReturnValue__pf, b0l__K2Node_CustomEvent_Location__pf, bpfv__CallFunc_Conv_VectorToRotator_ReturnValue__pf, 0.000000);
	return; //KCST_EndOfThread
}
void AEnemyDogCh_C__pf3349424045::bpf__ExecuteUbergraph_EnemyDogCh__pf_8(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 49);
	// optimized KCST_UnconditionalGoto
	if(::IsValid((*(AccessPrivateProperty<UCharacterMovementComponent* >((this), ACharacter::__PPO__CharacterMovement() )))))
	{
		(*(AccessPrivateProperty<UCharacterMovementComponent* >((this), ACharacter::__PPO__CharacterMovement() )))->MaxWalkSpeed = 700.000000;
	}
	return; //KCST_EndOfThread
}
void AEnemyDogCh_C__pf3349424045::bpf__TakeDamage__pf(int32 bpp__Damage_Taken__pf, FName bpp__HitBoneName__pf)
{
	b0l__K2Node_CustomEvent_Damage_Taken__pf = bpp__Damage_Taken__pf;
	b0l__K2Node_CustomEvent_HitBoneName__pf = bpp__HitBoneName__pf;
	bpf__ExecuteUbergraph_EnemyDogCh__pf_2(59);
}
void AEnemyDogCh_C__pf3349424045::bpf__BndEvt__BoxWeaponCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	typedef FHitResult  T__Local__65;
	T__Local__65& bpp__SweepResult__pf = *const_cast<T__Local__65 *>(&bpp__SweepResult__pf__const);
	...
	bpf__ExecuteUbergraph_EnemyDogCh__pf_3(58);
}
void AEnemyDogCh_C__pf3349424045::bpf__OnCollideEvent__pf(FName bpp__EventName__pf, float bpp__EmitterTime__pf, int32 bpp__ParticleTime__pf, FVector bpp__Location__pf, FVector bpp__Velocity__pf, FVector bpp__Direction__pf, FVector bpp__Normal__pf, FName bpp__BoneName__pf, UPhysicalMaterial* bpp__PhysMat__pf)
{
	b0l__K2Node_CustomEvent_EventName__pf = bpp__EventName__pf;
	b0l__K2Node_CustomEvent_EmitterTime__pf = bpp__EmitterTime__pf;
	b0l__K2Node_CustomEvent_ParticleTime__pf = bpp__ParticleTime__pf;
	b0l__K2Node_CustomEvent_Location__pf = bpp__Location__pf;
	b0l__K2Node_CustomEvent_Velocity__pf = bpp__Velocity__pf;
	b0l__K2Node_CustomEvent_Direction__pf = bpp__Direction__pf;
	b0l__K2Node_CustomEvent_Normal__pf = bpp__Normal__pf;
	b0l__K2Node_CustomEvent_BoneName__pf = bpp__BoneName__pf;
	b0l__K2Node_CustomEvent_PhysMat__pf = bpp__PhysMat__pf;
	bpf__ExecuteUbergraph_EnemyDogCh__pf_7(54);
}
void AEnemyDogCh_C__pf3349424045::bpf__SplatterBlood__pf()
{
	bpf__ExecuteUbergraph_EnemyDogCh__pf_6(51);
}
void AEnemyDogCh_C__pf3349424045::bpf__Attack__pf(AActor* bpp__EnemyActor__pf)
{
	b0l__K2Node_CustomEvent_EnemyActor__pf = bpp__EnemyActor__pf;
	bpf__ExecuteUbergraph_EnemyDogCh__pf_4(50);
}
void AEnemyDogCh_C__pf3349424045::bpf__Run__pf()
{
	bpf__ExecuteUbergraph_EnemyDogCh__pf_8(49);
}
void AEnemyDogCh_C__pf3349424045::bpf__EnemyDetected__pf()
{
	bpf__ExecuteUbergraph_EnemyDogCh__pf_0(40);
}
void AEnemyDogCh_C__pf3349424045::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_EnemyDogCh__pf_5(35);
}
void AEnemyDogCh_C__pf3349424045::bpf__Walk__pf()
{
	bpf__ExecuteUbergraph_EnemyDogCh__pf_1(34);
}
void AEnemyDogCh_C__pf3349424045::bpf__DieFunction__pf()
{
	...
	AAIDogController_C__pf60788051* bpfv__K2Node_DynamicCast_AsAIDog_Controller__pf{};
	...
	do
	{
		...
		case 13:
			{
				if(::IsValid(bpv__SkeletalMesh__pf))
				{
					bpv__SkeletalMesh__pf->USkeletalMeshComponent::PlayAnimation(CastChecked<UAnimationAsset>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed), false);
				}
			}
		case 14:
			{
		...
		case 15:
			{
				...
				bpfv__K2Node_DynamicCast_AsAIDog_Controller__pf = Cast<AAIDogController_C__pf60788051>(bpfv__CallFunc_GetController_ReturnValue__pf);
				bpfv__K2Node_DynamicCast_bSuccess__pf = (bpfv__K2Node_DynamicCast_AsAIDog_Controller__pf != nullptr);;
		...
		case 16:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsAIDog_Controller__pf))
				{
					bpfv__K2Node_DynamicCast_AsAIDog_Controller__pf->AController::UnPossess();
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
void AEnemyDogCh_C__pf3349424045::bpf__SetMaterialCollar__pf()
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_11__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 1);
				if (!bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_11__pf)
				{
					__CurrentState = 3;
					break;
				}
		...
		case 2:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 3:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_10__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 2);
				if (!bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_10__pf)
				{
					__CurrentState = 5;
					break;
				}
		...
		case 4:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 5:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_9__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 3);
		...
		case 6:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 7:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_8__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 4);
				if (!bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_8__pf)
				{
					__CurrentState = 9;
					break;
				}
		...
		case 8:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 9:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_7__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 5);
				if (!bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_7__pf)
				{
					__CurrentState = 11;
					break;
				}
		...
		case 10:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[11], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 11:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_6__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 6);
		...
		case 12:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[12], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 13:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_5__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 7);
		...
		case 14:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[13], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 15:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_4__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 8);
		...
		case 16:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[14], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 17:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_3__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 9);
		...
		case 18:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[15], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 19:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_2__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 10);
		...
		case 20:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[16], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 21:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue_1__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 11);
		...
		case 22:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[17], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
		case 23:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__Squad__pf, 12);
		...
		case 24:
			{
				if(::IsValid(bpv__Collar__pf))
				{
					bpv__Collar__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AEnemyDogCh_C__pf3349424045::StaticClass())->UsedAssets[18], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
...
PRAGMA_DISABLE_OPTIMIZATION
void AEnemyDogCh_C__pf3349424045::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AEnemyDogCh_C__pf3349424045::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{767, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  AnimBlueprintGeneratedClass /Game/Art/Enemies/DogAnimation/Dog_AnimBP.Dog_AnimBP_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AEnemyDogCh_C__pf3349424045
{
	FRegisterHelper__AEnemyDogCh_C__pf3349424045()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Enemies/EnemyDogCh"), &AEnemyDogCh_C__pf3349424045::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AEnemyDogCh_C__pf3349424045 Instance;
};
FRegisterHelper__AEnemyDogCh_C__pf3349424045 FRegisterHelper__AEnemyDogCh_C__pf3349424045::Instance;
