...
AAISniperController_C__pf1156381827::AAISniperController_C__pf1156381827(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	auto __Local__10 = NewObject<UAISenseConfig_Hearing>(bpv__AIPerception__pf, TEXT("AISenseConfig_Hearing_3"), (EObjectFlags)0x00280009);
	{
		// --- Default subobject 'AISenseConfig_Hearing_3' //
		__Local__10->Implementation = UAISense_Hearing::StaticClass();
		__Local__10->HearingRange = 6000.000000f;
		__Local__10->DetectionByAffiliation.bDetectNeutrals = true;
		__Local__10->DetectionByAffiliation.bDetectFriendlies = true;
		// --- END default subobject 'AISenseConfig_Hearing_3' //
	}
	...
	(((FBoolProperty*)__Local__11)->SetPropertyValue_InContainer((bpv__AIPerception__pf), false, 0));
	...
	auto& __Local__13 = (*(AccessPrivateProperty<UPathFollowingComponent*>((this), AAIController::__PPO__PathFollowingComponent() )));
	__Local__13 = __Local__1;
	auto& __Local__14 = (*(AccessPrivateProperty<UPawnActionsComponent*>((this), AAIController::__PPO__ActionsComp() )));
	__Local__14 = __Local__2;
	auto& __Local__15 = (*(AccessPrivateProperty<USceneComponent*>((this), AController::__PPO__TransformComponent() )));
...
void AAISniperController_C__pf1156381827::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AAISniperController_C__pf1156381827::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__18 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"), (EObjectFlags)0x00000000);
	...
	(((FBoolProperty*)__Local__19)->SetPropertyValue_InContainer((__Local__17), false, 0));
	__Local__18->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__18->ComponentDelegateBindings.AddUninitialized(1);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__18->ComponentDelegateBindings.GetData(), 1);
	auto& __Local__21 = __Local__18->ComponentDelegateBindings[0];
	__Local__21.ComponentPropertyName = FName(TEXT("AIPerception"));
	__Local__21.DelegatePropertyName = FName(TEXT("OnTargetPerceptionUpdated"));
	__Local__21.FunctionNameToBind = FName(TEXT("BndEvt__AIPerception_K2Node_ComponentBoundEvent_0_ActorPerceptionUpdatedDelegate__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AAISniperController_C__pf1156381827::bpf__ExecuteUbergraph_AISniperController__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 39:
			{
				...
				bpfv__CallFunc_MakeLiteralName_ReturnValue_4__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("IsInvestigatingSound")));
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf))
				{
					...
					{
						__Local__22 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
						check(__Local__22);
						__Local__23 = __Local__22;
					}
					bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_4__pf, (((FBoolProperty*)__Local__22)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				}
			}
		case 40:
			{
				bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
				bpfv__CallFunc_MakeLiteralName_ReturnValue_6__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("PlayerLocation")));
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::SetValueAsVector(bpfv__CallFunc_MakeLiteralName_ReturnValue_6__pf, b0l__K2Node_ComponentBoundEvent_Stimulus__pf.StimulusLocation);
				}
			}
		case 41:
			{
		...
		case 43:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::SetValueAsObject(bpfv__CallFunc_MakeLiteralName_ReturnValue__pf, bpv__EnemyReference__pf);
				}
				__CurrentState = -1;
				break;
			}
		case 44:
			{
				bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf = UGameplayStatics::GetPlayerCharacter(this, 0);
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf);
				b0l__K2Node_DynamicCast_bSuccess_3__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf != nullptr);;
		...
		case 45:
			{
				bpv__EnemyReference__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf;
				__CurrentState = 43;
				break;
			}
		case 46:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_5__pf, false);
				}
				__CurrentState = -1;
				break;
			}
...
void AAISniperController_C__pf1156381827::bpf__ExecuteUbergraph_AISniperController__pf_1(int32 bpp__EntryPoint__pf)
{
		...
		case 57:
			{
				...
				{
					bpv__ControlledCharacter__pf->bpf__Attack__pf(E__EnumTypesOfCharacters__pf::NewEnumerator5, bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf);
				}
				__CurrentState = -1;
				break;
			}
...
void AAISniperController_C__pf1156381827::bpf__ExecuteUbergraph_AISniperController__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 3:
			{
				...
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf, false);
				}
			}
		case 4:
			{
				bool  __Local__24 = false;
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsPlayer__pf) : (__Local__24)))
				{
					__CurrentState = 7;
					break;
				}
		...
		case 5:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf != nullptr);;
		...
		case 7:
			{
				E__EnumWeapon__pf  __Local__25 = E__EnumWeapon__pf::NewEnumerator0;
				bpv__WeaponOfEnemy__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__Weapon__pf) : (__Local__25));
			}
		case 8:
			{
				UKismetSystemLibrary::Delay(this, 0.100000, FLatentActionInfo(1, 1026563841, TEXT("ExecuteUbergraph_AISniperController_2"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 9:
			{
				bpfv__CallFunc_RunBehaviorTree_ReturnValue__pf = RunBehaviorTree(CastChecked<UBehaviorTree>(CastChecked<UDynamicClass>(AAISniperController_C__pf1156381827::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
			}
		case 10:
			{
				bool  __Local__27 = false;
				bpv__IsVIP__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsVIP__pf) : (__Local__27));
			}
		case 11:
			{
		...
		case 17:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsLevel_Completer_BP__pf != nullptr);;
		...
		case 21:
			{
				TArray<ATargetPoint*>  __Local__28 = {};
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__PatrolPoints__pf) : (__Local__28)));
		...
		case 24:
			{
				TArray<ATargetPoint*>  __Local__29 = {};
				FCustomThunkTemplates::Array_Get(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__PatrolPoints__pf) : (__Local__29)), b0l__Temp_int_Array_Index_Variable__pf, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
		...
		case 25:
			{
				AAlarm_C__pf2693064426*  __Local__30 = ((AAlarm_C__pf2693064426*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__AlarmPoint__pf) : (__Local__30)));
		...
		case 26:
			{
				AAlarm_C__pf2693064426*  __Local__31 = ((AAlarm_C__pf2693064426*)nullptr);
				bpv__AlarmPoint__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__AlarmPoint__pf) : (__Local__31));
			}
		case 27:
			{
				AAlarm_C__pf2693064426*  __Local__32 = ((AAlarm_C__pf2693064426*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__AlarmPoint__pf) : (__Local__32)));
		...
		case 28:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf, bpv__CanAIGoToAlarmController__pf);
				}
				__CurrentState = 3;
				break;
			}
		...
		case 32:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf = Cast<AEnemyShootingCh_C__pf3349424045>(b0l__K2Node_Event_PossessedPawn__pf);
		...
		case 33:
			{
				bpv__ControlledCharacter__pf = b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf;
				__CurrentState = 9;
				break;
			}
		default:
...
void AAISniperController_C__pf1156381827::bpf__ExecuteUbergraph_AISniperController__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 59);
	return; //KCST_EndOfThread
}
void AAISniperController_C__pf1156381827::bpf__ExecuteUbergraph_AISniperController__pf_4(int32 bpp__EntryPoint__pf)
{
...
void AAISniperController_C__pf1156381827::bpf__ExecuteUbergraph_AISniperController__pf_5(int32 bpp__EntryPoint__pf)
{
		...
		case 52:
			{
				...
				bpfv__CallFunc_MakeLiteralName_ReturnValue_3__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("TargetPointKey")));
				...
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_1__pf->UBlackboardComponent::SetValueAsObject(bpfv__CallFunc_MakeLiteralName_ReturnValue_3__pf, b0l__CallFunc_Array_Get_Item_1__pf);
				}
				__CurrentState = -1;
				break;
			}
...
void AAISniperController_C__pf1156381827::bpf__ExecuteUbergraph_AISniperController__pf_6(int32 bpp__EntryPoint__pf)
{
...
void AAISniperController_C__pf1156381827::bpf__ExecuteUbergraph_AISniperController__pf_7(int32 bpp__EntryPoint__pf)
{
...
void AAISniperController_C__pf1156381827::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_AISniperController__pf_3(59);
}
void AAISniperController_C__pf1156381827::bpf__Suicide__pf()
{
	bpf__ExecuteUbergraph_AISniperController__pf_4(58);
}
void AAISniperController_C__pf1156381827::bpf__Attack__pf()
{
	bpf__ExecuteUbergraph_AISniperController__pf_1(54);
}
void AAISniperController_C__pf1156381827::bpf__GetNewPoint__pf()
{
	bpf__ExecuteUbergraph_AISniperController__pf_5(48);
}
void AAISniperController_C__pf1156381827::bpf__Walk__pf()
{
	bpf__ExecuteUbergraph_AISniperController__pf_6(47);
}
void AAISniperController_C__pf1156381827::bpf__BndEvt__AIPerception_K2Node_ComponentBoundEvent_0_ActorPerceptionUpdatedDelegate__DelegateSignature__pf(AActor* bpp__Actor__pf, FAIStimulus bpp__Stimulus__pf)
{
	b0l__K2Node_ComponentBoundEvent_Actor__pf = bpp__Actor__pf;
	b0l__K2Node_ComponentBoundEvent_Stimulus__pf = bpp__Stimulus__pf;
	bpf__ExecuteUbergraph_AISniperController__pf_0(37);
}
void AAISniperController_C__pf1156381827::bpf__Run__pf()
{
	bpf__ExecuteUbergraph_AISniperController__pf_7(36);
}
void AAISniperController_C__pf1156381827::bpf__ReceivePossess__pf(APawn* bpp__PossessedPawn__pf)
{
	b0l__K2Node_Event_PossessedPawn__pf = bpp__PossessedPawn__pf;
	bpf__ExecuteUbergraph_AISniperController__pf_2(31);
}
void AAISniperController_C__pf1156381827::bpf__MakeFocus__pf(AActor* bpp__EnemyCast__pf, E__EnumTypesOfCharacters__pf bpp__TypeOfCharacter__pf, bool bpp__Successfully_Sensed__pf)
{
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue__pf{};
	FVector bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf(EForceInit::ForceInit);
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf{};
...
void AAISniperController_C__pf1156381827::bpf__DieFunction__pf()
{
	...
	do
	{
		...
		case 1:
			{
				...
				bpfv__K2Node_DynamicCast_bSuccess_4__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf != nullptr);;
		...
		case 2:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf->bpf__DyingAnimation__pf();
				}
			}
		case 3:
			{
		...
		case 13:
			{
				...
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpfv__CallFunc_Array_Get_Item__pf);
		...
		case 14:
			{
				bpfv__CallFunc_NotEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::NotEqual_ObjectObject(bpv__ControlledCharacter__pf, bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf);
		...
		case 15:
			{
				if(::IsValid(bpv__ControlledCharacter__pf))
				{
					bpfv__CallFunc_GetDistanceTo_ReturnValue_1__pf = bpv__ControlledCharacter__pf->AActor::GetDistanceTo(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_6__pf);
				}
		...
		case 16:
			{
				FCustomThunkTemplates::Array_Get(bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf, bpfv__Temp_int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_7__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpfv__CallFunc_Array_Get_Item__pf);
		...
		case 17:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_7__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_7__pf->bpv__IsDeath__pf) : (__Local__33)))
				{
					__CurrentState = 50;
					break;
				}
		...
		case 24:
			{
				...
				bpfv__K2Node_DynamicCast_bSuccess_3__pf = (bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf != nullptr);;
		...
		case 28:
			{
				bool  __Local__34 = false;
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character_2__pf)) ? (bpfv__K2Node_DynamicCast_AsThird_Person_Character_2__pf->bpv__IsDeath__pf) : (__Local__34)))
				{
					__CurrentState = 54;
					break;
				}
		...
		case 33:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__ToPossesActor__pf);
		...
		case 34:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf))
				{
					bpfv__CallFunc_IsPlayerControlled_ReturnValue__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf->IsPlayerControlled();
				}
		...
		case 35:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf->bpv__IsGodModeActive__pf) : (__Local__35)))
				{
					__CurrentState = 71;
					break;
				}
		...
		case 37:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsVIP__pf) : (__Local__36)))
				{
					__CurrentState = 41;
					break;
				}
		...
		case 42:
			{
				E__EnumWeapon__pf  __Local__37 = E__EnumWeapon__pf::NewEnumerator0;
				bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue_1__pf = UKismetMathLibrary::EqualEqual_ByteByte(static_cast<uint8>(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__Weapon__pf) : (__Local__37))), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator3));
		...
		case 50:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_7__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_7__pf->bpv__IsSuiciding__pf) : (__Local__38)))
				{
					__CurrentState = 51;
					break;
				}
		...
		case 51:
			{
				bpv__ToPossesActor__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_7__pf;
			}
		case 52:
			{
				if(::IsValid(bpv__ControlledCharacter__pf))
		...
		case 56:
			{
				...
				bpfv__K2Node_DynamicCast_bSuccess_6__pf = (bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf != nullptr);;
		...
		case 58:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf)) ? (bpfv__K2Node_DynamicCast_AsThird_Person_Character_1__pf->bpv__IsGodModeActive__pf) : (__Local__39)))
				{
					__CurrentState = 59;
					break;
				}
		...
		case 60:
			{
				...
				{
					bpv__DyingCharacter__pf->bpv__SkeletalMesh__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AAISniperController_C__pf1156381827::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
				}
			}
		case 61:
			{
		...
		case 64:
			{
				...
				if (!((::IsValid(bpv__ControlledCharacter__pf)) ? (bpv__ControlledCharacter__pf->bpv__IsPlayer__pf) : (__Local__40)))
				{
					__CurrentState = 36;
					break;
				}
		...
		case 66:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf) && ::IsValid((*(AccessPrivateProperty<UCharacterMovementComponent* >((bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf), ACharacter::__PPO__CharacterMovement() )))))
				{
					(*(AccessPrivateProperty<UCharacterMovementComponent* >((bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf), ACharacter::__PPO__CharacterMovement() )))->MaxWalkSpeed = 800.000000;
				}
			}
		case 67:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_5__pf->bpv__IsPlayer__pf = true;
				}
			}
		case 68:
			{
				...
				{
					bpv__ToPossesActor__pf->AIControllerClass = GetClass();
				}
			}
		case 69:
			{
				bpfv__CallFunc_GetDisplayName_ReturnValue__pf = UKismetSystemLibrary::GetDisplayName(bpv__ToPossesActor__pf);
		...
		case 70:
			{
				AController::Possess(bpv__ToPossesActor__pf);
				__CurrentState = 43;
				break;
			}
		case 71:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_4__pf->bpv__IsDeath__pf = true;
				}
			}
		case 72:
			{
		...
		case 73:
			{
				E__EnumWeapon__pf  __Local__41 = E__EnumWeapon__pf::NewEnumerator0;
				bpfv__CallFunc_EqualEqual_ByteByte_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ByteByte(static_cast<uint8>(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__Weapon__pf) : (__Local__41))), static_cast<uint8>(E__EnumWeapon__pf::NewEnumerator2));
...
void AAISniperController_C__pf1156381827::bpf__FullDeath__pf(AEnemyShootingCh_C__pf3349424045* bpp__DyingCharacter__pf)
{
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	...
	ASniperPickUp_C__pf1651478651* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	...
	do
	{
		...
		case 2:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__SniperPreBeam__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__SniperPreBeam__pf->SetActive(false, false);
				}
			}
		case 3:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__SniperPreBeam__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__SniperPreBeam__pf->USceneComponent::SetVisibility(false, false);
				}
			}
		case 4:
			{
		...
		case 6:
			{
				...
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, ASniperPickUp_C__pf1651478651::StaticClass(), bpfv__CallFunc_MakeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
			}
		case 7:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__FireRifle__pf))
				...
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf, FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<ASniperPickUp_C__pf1651478651>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_MakeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 8:
			{
				bpfv__K2Node_DynamicCast_AsSniper_Pick_Up__pf = Cast<ASniperPickUp_C__pf1651478651>(bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf);
				bpfv__K2Node_DynamicCast_bSuccess_3__pf = (bpfv__K2Node_DynamicCast_AsSniper_Pick_Up__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_3__pf)
				{
					__CurrentState = -1;
					break;
		...
		case 9:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsSniper_Pick_Up__pf->bpv__WeaponType__pf = bpv__WeaponOfEnemy__pf;
				}
			}
		case 10:
			{
...
void AAISniperController_C__pf1156381827::bpf__DetectPlayer__pf(AActor* bpp__EnemyCast__pf)
{
...
void AAISniperController_C__pf1156381827::bpf__AddToVision__pf()
{
	int32 bpfv__Temp_int_Array_Index_Variable__pf{};
	int32 bpfv__Temp_int_Loop_Counter_Variable__pf{};
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	...
	do
	{
		...
		case 9:
			{
				TArray<AEnemyShootingCh_C__pf3349424045*>  __Local__42 = {};
				bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__ActorsInVision__pf) : (__Local__42)), bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 10:
...
void AAISniperController_C__pf1156381827::bpf__PlayerInVision__pf(bool bpp__IsEnteringInSight__pf, AEnemyShootingCh_C__pf3349424045* bpp__Player__pf)
{
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf{};
	...
	do
	{
		...
		case 4:
			{
				TArray<AEnemyShootingCh_C__pf3349424045*>  __Local__43 = {};
				bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_2__pf->bpv__ActorsInVision__pf) : (__Local__43)), bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_3__pf);
				__CurrentState = -1;
				break;
			}
		case 5:
		...
		case 7:
			{
				TArray<AEnemyShootingCh_C__pf3349424045*>  __Local__44 = {};
				bpfv__CallFunc_Array_RemoveItem_ReturnValue__pf = FCustomThunkTemplates::Array_RemoveItem(((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__ActorsInVision__pf) : (__Local__44)), bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf);
				__CurrentState = -1;
				break;
			}
		default:
...
void AAISniperController_C__pf1156381827::bpf__GetSoundAlert__pf(AActor* bpp__EnemyCast__pf)
{
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue__pf{};
	FVector bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf(EForceInit::ForceInit);
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf{};
...
void AAISniperController_C__pf1156381827::bpf__IsAttackedEnemyDeath__pf(AActor* bpp__EnemyReference__pf, /*out*/ bool& bpp__IsDeath__pf)
{
	AThirdPersonCharacter_C__pf2222656877* bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
		...
		case 2:
			{
				...
				bpv__IsEnemyAttackedDeath__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsDeath__pf) : (__Local__45));
			}
		case 3:
			{
		...
		case 5:
			{
				...
				bpv__IsEnemyAttackedDeath__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpv__IsDeath__pf) : (__Local__46));
				__CurrentState = 3;
				break;
			}
		case 6:
		...
		case 7:
			{
				...
				bpv__IsEnemyAttackedDeath__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__IsDeath__pf) : (__Local__47));
				__CurrentState = 3;
				break;
			}
		case 8:
...
void AAISniperController_C__pf1156381827::bpf__AimToEnemy__pf()
{
	AThirdPersonCharacter_C__pf2222656877* bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	AEnemyShootingCh_C__pf3349424045* bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf{};
	...
	do
	{
		...
		case 2:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsDeath__pf) : (__Local__48)))
				{
					__CurrentState = 3;
					break;
				}
		...
		case 3:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf = Cast<AEnemyShootingCh_C__pf3349424045>(bpv__EnemyReference__pf);
				bpfv__K2Node_DynamicCast_bSuccess_2__pf = (bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess_2__pf)
				{
					__CurrentState = 6;
		...
		case 4:
			{
				...
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__SkeletalMesh__pf->USceneComponent::K2_GetComponentLocation();
				}
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch_1__pf->AActor::K2_GetActorLocation();
				}
				bpfv__CallFunc_FindLookAtRotation_ReturnValue_1__pf = UKismetMathLibrary::FindLookAtRotation(bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf);
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf))
				{
					bpfv__CallFunc_K2_SetActorRotation_ReturnValue_1__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->AActor::K2_SetActorRotation(bpfv__CallFunc_FindLookAtRotation_ReturnValue_1__pf, true);
				}
			}
		case 5:
			{
				...
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpf__SniperMakePreBeamPartycle__pf(bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf, false);
				}
				__CurrentState = -1;
				break;
			}
		case 6:
			{
				bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf = Cast<AThirdPersonCharacter_C__pf2222656877>(bpv__EnemyReference__pf);
				bpfv__K2Node_DynamicCast_bSuccess__pf = (bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf != nullptr);;
				if (!bpfv__K2Node_DynamicCast_bSuccess__pf)
				{
					__CurrentState = -1;
		...
		case 7:
			{
				...
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = bpfv__K2Node_DynamicCast_AsThird_Person_Character__pf->AActor::K2_GetActorLocation();
				}
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf) && ::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__SkeletalMesh__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__SkeletalMesh__pf->USceneComponent::K2_GetComponentLocation();
				...
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf))
				{
					bpfv__CallFunc_K2_SetActorRotation_ReturnValue__pf = bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->AActor::K2_SetActorRotation(bpfv__CallFunc_FindLookAtRotation_ReturnValue__pf, true);
				}
			}
		case 8:
			{
				...
				if(::IsValid(bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf))
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpf__SniperMakePreBeamPartycle__pf(bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, false);
				}
				__CurrentState = -1;
				break;
			}
...
void AAISniperController_C__pf1156381827::bpf__SpawnPossesionPS__pf(AActor* bpp__TargetActor__pf)
{
	FTransform bpfv__CallFunc_MakeTransform_ReturnValue__pf{};
...
PRAGMA_DISABLE_OPTIMIZATION
void AAISniperController_C__pf1156381827::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AAISniperController_C__pf1156381827::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AAISniperController_C__pf1156381827
{
	FRegisterHelper__AAISniperController_C__pf1156381827()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Enemies/BehaviorSniper/AISniperController"), &AAISniperController_C__pf1156381827::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AAISniperController_C__pf1156381827 Instance;
};
FRegisterHelper__AAISniperController_C__pf1156381827 FRegisterHelper__AAISniperController_C__pf1156381827::Instance;
