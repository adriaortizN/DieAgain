...
#include "Level5_GameOverWB__pf1915849216.h"
...
ULevel5_GameOverWB_C__pf1915849216::ULevel5_GameOverWB_C__pf1915849216(const FObjectInitializer& ObjectInitializer) : Super()
{
...
void ULevel5_GameOverWB_C__pf1915849216::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ULevel5_GameOverWB_C__pf1915849216::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__7 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_4"), (EObjectFlags)0x00280008);
	__Local__7->LayoutData.Offsets.Left = -220.960938f;
	__Local__7->LayoutData.Offsets.Top = 88.000000f;
	__Local__7->LayoutData.Offsets.Right = 451.462585f;
	__Local__7->LayoutData.Offsets.Bottom = 114.528969f;
	...
	auto __Local__8 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_116"), (EObjectFlags)0x00280008);
	__Local__8->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[AA1FE3C44121631FAFEB6F8C473A0814]\", \"6D384D3D4D48E63DB975DAA477A1028E\", \"Game Over\")")	);
	__Local__8->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevel5_GameOverWB_C__pf1915849216::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__8->Font.OutlineSettings.OutlineSize = 3;
	__Local__8->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__8->Font.Size = 75;
	...
	__Local__9->LayoutData.Offsets.Left = -724.960938f;
	__Local__9->LayoutData.Offsets.Top = -264.540527f;
	__Local__9->LayoutData.Offsets.Right = 1465.810303f;
...
TEXT("NSLOCTEXT(\"[AA1FE3C44121631FAFEB6F8C473A0814]\", \"801E61A14240B8E19DA3F6B3C81460F4\", \"You chose the wrong person and your mistake \\r\\nhas caused the group to be decimated by Ridgway\\r\\n\\r\\n\\r\\nYour journey has ended here\")")	);
	__Local__10->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevel5_GameOverWB_C__pf1915849216::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto __Local__14 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_1"), (EObjectFlags)0x00280008);
	__Local__14->LayoutData.Offsets.Left = -360.960938f;
	__Local__14->LayoutData.Offsets.Top = -213.081055f;
	__Local__14->LayoutData.Offsets.Right = 717.569946f;
	__Local__14->LayoutData.Offsets.Bottom = 87.835617f;
	...
	__Local__17 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevel5_GameOverWB_C__pf1915849216::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	__Local__18 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevel5_GameOverWB_C__pf1915849216::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	__Local__20 = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevel5_GameOverWB_C__pf1915849216::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
...
TEXT("NSLOCTEXT(\"[AA1FE3C44121631FAFEB6F8C473A0814]\", \"A95640C14CD918EEC4088DA9743C1DB2\", \"Next\")")	);
	...
	__Local__23->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(ULevel5_GameOverWB_C__pf1915849216::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto __Local__25 = NewObject<UWidgetNavigation>(__Local__15, TEXT("WidgetNavigation_0"), (EObjectFlags)0x00280008);
	__Local__25->Up.Rule = EUINavigationRule::Stop;
	__Local__25->Right.Rule = EUINavigationRule::Stop;
	__Local__15->Navigation = __Local__25;
	__Local__14->Content = __Local__15;
	__Local__6.Add(__Local__14);
	__Local__1->RootWidget = __Local__5;
	auto __Local__26 = NewObject<UMovieScene>(__Local__2, TEXT("FadeInText"), (EObjectFlags)0x00280008);
	auto& __Local__27 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__26), UMovieScene::__PPO__Possessables() )));
	__Local__27 = TArray<FMovieScenePossessable> ();
	__Local__27.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__27.GetData(), 1);
	auto& __Local__28 = __Local__27[0];
	auto& __Local__29 = (*(AccessPrivateProperty<FGuid >(&(__Local__28), FMovieScenePossessable::__PPO__Guid() )));
	__Local__29 = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__30 = (*(AccessPrivateProperty<FString >(&(__Local__28), FMovieScenePossessable::__PPO__Name() )));
	__Local__30 = FString(TEXT("TextBlock_329"));
	auto& __Local__31 = (*(AccessPrivateProperty<UClass* >(&(__Local__28), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__31 = UTextBlock::StaticClass();
	auto& __Local__32 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__26), UMovieScene::__PPO__ObjectBindings() )));
	__Local__32 = TArray<FMovieSceneBinding> ();
	__Local__32.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__32.GetData(), 1);
	auto& __Local__33 = __Local__32[0];
	auto& __Local__34 = (*(AccessPrivateProperty<FGuid >(&(__Local__33), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__34 = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__35 = (*(AccessPrivateProperty<FString >(&(__Local__33), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__35 = FString(TEXT("TextBlock_329"));
	auto& __Local__36 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__33), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__36 = TArray<UMovieSceneTrack*> ();
	__Local__36.Reserve(2);
	auto __Local__37 = NewObject<UMovieSceneColorTrack>(__Local__26, TEXT("MovieSceneColorTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__38 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__37), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__38.PropertyName = FName(TEXT("ColorAndOpacity"));
	__Local__38.PropertyPath = FName(TEXT("ColorAndOpacity"));
	__Local__38.bCanUseClassLookup = true;
	auto& __Local__39 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__37), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__39 = TArray<UMovieSceneSection*> ();
	__Local__39.Reserve(1);
	auto __Local__40 = NewObject<UMovieSceneColorSection>(__Local__37, TEXT("MovieSceneColorSection_0"), (EObjectFlags)0x00280008);
	auto __Local__41 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__40->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__42 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__40->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__41)
	{
	...
	__Local__40->Easing.EaseIn = __Local__41;
	__Local__40->Easing.EaseOut = __Local__42;
	__Local__40->Easing.bManualEaseOut = true;
	__Local__40->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(120000)));
	auto& __Local__43 = (*(AccessPrivateProperty<FGuid >((__Local__40), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__43 = FGuid(0xBA46693B, 0x414FEC4B, 0xF98EC09C, 0x4E774243);
	__Local__39.Add(__Local__40);
	auto& __Local__44 = (*(AccessPrivateProperty<FGuid >((__Local__37), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__44 = FGuid(0xDDDC1926, 0x47539219, 0x2B574EA3, 0xA5310AF4);
	auto& __Local__45 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__37), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__45.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__45.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__45.Entries.GetData(), 1);
	auto& __Local__46 = __Local__45.Entries[0];
	__Local__46.Section = __Local__40;
	static TWeakFieldPtr<FProperty> __Local__48{};
	const FProperty* __Local__47 = __Local__48.Get();
	if (nullptr == __Local__47)
	{
		__Local__47 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("LowerBound")));
		check(__Local__47);
		__Local__48 = __Local__47;
	}
	auto& __Local__49 = (*(__Local__47->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__46.Range), 0)));
	static TWeakFieldPtr<FProperty> __Local__51{};
	const FProperty* __Local__50 = __Local__51.Get();
	if (nullptr == __Local__50)
	{
		__Local__50 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Type")));
		check(__Local__50);
		__Local__51 = __Local__50;
	}
	auto& __Local__52 = (*(__Local__50->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__49), 0)));
	__Local__52 = ERangeBoundTypes::Type::Inclusive;
	static TWeakFieldPtr<FProperty> __Local__54{};
	const FProperty* __Local__53 = __Local__54.Get();
	if (nullptr == __Local__53)
	{
		__Local__53 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("UpperBound")));
		check(__Local__53);
		__Local__54 = __Local__53;
	}
	auto& __Local__55 = (*(__Local__53->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__46.Range), 0)));
	auto& __Local__56 = (*(__Local__50->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__55), 0)));
	__Local__56 = ERangeBoundTypes::Type::Inclusive;
	static TWeakFieldPtr<FProperty> __Local__58{};
	const FProperty* __Local__57 = __Local__58.Get();
	if (nullptr == __Local__57)
	{
		__Local__57 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Value")));
		check(__Local__57);
		__Local__58 = __Local__57;
	}
	auto& __Local__59 = (*(__Local__57->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__55), 0)));
	__Local__59.Value = 120000;
	__Local__46.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__60 = (*(AccessPrivateProperty<FGuid >((__Local__37), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__60 = FGuid(0xDDDC1926, 0x47539219, 0x2B574EA3, 0xA5310AF4);
	__Local__36.Add(__Local__37);
	auto __Local__61 = NewObject<UMovieSceneFloatTrack>(__Local__26, TEXT("MovieSceneFloatTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__62 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__61), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__62.PropertyName = FName(TEXT("RenderOpacity"));
	__Local__62.PropertyPath = FName(TEXT("RenderOpacity"));
	__Local__62.bCanUseClassLookup = true;
	auto& __Local__63 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__61), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__63 = TArray<UMovieSceneSection*> ();
	__Local__63.Reserve(1);
	auto __Local__64 = NewObject<UMovieSceneFloatSection>(__Local__61, TEXT("MovieSceneFloatSection_0"), (EObjectFlags)0x00280008);
	auto __Local__65 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__64->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__66 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__64->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__65)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__67 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__64), UMovieSceneFloatSection::__PPO__FloatCurve() )));
	auto& __Local__68 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__67), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__68 = TArray<FFrameNumber> ();
	__Local__68.Reserve(2);
	__Local__68.Add(FFrameNumber{});
	__Local__68.Add(FFrameNumber{});
	__Local__68[1].Value = 150000;
	auto& __Local__69 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__67), FMovieSceneFloatChannel::__PPO__Values() )));
	...
	__Local__64->Easing.EaseIn = __Local__65;
	__Local__64->Easing.EaseOut = __Local__66;
	__Local__64->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(150000)));
	auto& __Local__72 = (*(AccessPrivateProperty<FGuid >((__Local__64), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__72 = FGuid(0xC95851B7, 0x46762F9C, 0x7F26C993, 0x8DA70E1F);
	__Local__63.Add(__Local__64);
	auto& __Local__73 = (*(AccessPrivateProperty<FGuid >((__Local__61), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__73 = FGuid(0xF65A7B0B, 0x4A5DAF9A, 0xAC0E88BB, 0x8F9C4DB0);
	auto& __Local__74 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__61), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__74.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__74.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__74.Entries.GetData(), 1);
	auto& __Local__75 = __Local__74.Entries[0];
	__Local__75.Section = __Local__64;
	auto& __Local__76 = (*(__Local__47->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__75.Range), 0)));
	auto& __Local__77 = (*(__Local__50->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__76), 0)));
	__Local__77 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__78 = (*(__Local__53->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__75.Range), 0)));
	auto& __Local__79 = (*(__Local__50->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__78), 0)));
	__Local__79 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__80 = (*(__Local__57->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__78), 0)));
	__Local__80.Value = 150000;
	__Local__75.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__81 = (*(AccessPrivateProperty<FGuid >((__Local__61), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__81 = FGuid(0xF65A7B0B, 0x4A5DAF9A, 0xAC0E88BB, 0x8F9C4DB0);
	__Local__36.Add(__Local__61);
	auto& __Local__82 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__26), UMovieScene::__PPO__PlaybackRange() )));
	__Local__82 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(150001)));
	auto& __Local__83 = (*(AccessPrivateProperty<FFrameRate >((__Local__26), UMovieScene::__PPO__DisplayRate() )));
	static TWeakFieldPtr<FProperty> __Local__85{};
	const FProperty* __Local__84 = __Local__85.Get();
	if (nullptr == __Local__84)
	{
		__Local__84 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameRate"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Numerator")));
		check(__Local__84);
		__Local__85 = __Local__84;
	}
	auto& __Local__86 = (*(__Local__84->ContainerPtrToValuePtr<int32 >(&(__Local__83), 0)));
	__Local__86 = 20;
	auto& __Local__87 = (*(AccessPrivateProperty<FGuid >((__Local__26), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__87 = FGuid(0x48326375, 0x4A890F90, 0x6E722BA6, 0x422E1F11);
	__Local__2->MovieScene = __Local__26;
	...
	auto& __Local__88 = __Local__2->AnimationBindings[0];
	__Local__88.WidgetName = FName(TEXT("TextBlock_329"));
	__Local__88.AnimationGuid = FGuid(0x19E6346C, 0x4789D37B, 0x7F726E86, 0x503CFA96);
	auto& __Local__89 = (*(AccessPrivateProperty<FString >((__Local__2), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__89 = FString(TEXT("FadeInText"));
	__Local__2->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__90 = (*(AccessPrivateProperty<FGuid >((__Local__2), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__90 = FGuid(0x4B9B3784, 0x4F020096, 0x0CF533B7, 0x260DBDA5);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__2);
	auto __Local__91 = NewObject<UMovieScene>(__Local__3, TEXT("FadeInButton"), (EObjectFlags)0x00280008);
	auto& __Local__92 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__91), UMovieScene::__PPO__Possessables() )));
	__Local__92 = TArray<FMovieScenePossessable> ();
	__Local__92.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__92.GetData(), 1);
	auto& __Local__93 = __Local__92[0];
	auto& __Local__94 = (*(AccessPrivateProperty<FGuid >(&(__Local__93), FMovieScenePossessable::__PPO__Guid() )));
	__Local__94 = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__95 = (*(AccessPrivateProperty<FString >(&(__Local__93), FMovieScenePossessable::__PPO__Name() )));
	__Local__95 = FString(TEXT("Button_99"));
	auto& __Local__96 = (*(AccessPrivateProperty<UClass* >(&(__Local__93), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__96 = UButton::StaticClass();
	auto& __Local__97 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__91), UMovieScene::__PPO__ObjectBindings() )));
	__Local__97 = TArray<FMovieSceneBinding> ();
	__Local__97.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__97.GetData(), 1);
	auto& __Local__98 = __Local__97[0];
	auto& __Local__99 = (*(AccessPrivateProperty<FGuid >(&(__Local__98), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__99 = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__100 = (*(AccessPrivateProperty<FString >(&(__Local__98), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__100 = FString(TEXT("Button_99"));
	auto& __Local__101 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__98), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__101 = TArray<UMovieSceneTrack*> ();
	__Local__101.Reserve(1);
	auto __Local__102 = NewObject<UMovieSceneFloatTrack>(__Local__91, TEXT("MovieSceneFloatTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__103 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__102), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__103.PropertyName = FName(TEXT("RenderOpacity"));
	__Local__103.PropertyPath = FName(TEXT("RenderOpacity"));
	__Local__103.bCanUseClassLookup = true;
	auto& __Local__104 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__102), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__104 = TArray<UMovieSceneSection*> ();
	__Local__104.Reserve(1);
	auto __Local__105 = NewObject<UMovieSceneFloatSection>(__Local__102, TEXT("MovieSceneFloatSection_0"), (EObjectFlags)0x00280008);
	auto __Local__106 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__105->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__107 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__105->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__106)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__108 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__105), UMovieSceneFloatSection::__PPO__FloatCurve() )));
	auto& __Local__109 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__108), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__109 = TArray<FFrameNumber> ();
	__Local__109.Reserve(2);
	__Local__109.Add(FFrameNumber{});
	__Local__109.Add(FFrameNumber{});
	__Local__109[1].Value = 150000;
	auto& __Local__110 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__108), FMovieSceneFloatChannel::__PPO__Values() )));
	...
	__Local__112.Value = 1.000000f;
	__Local__105->Easing.EaseIn = __Local__106;
	__Local__105->Easing.EaseOut = __Local__107;
	__Local__105->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(150000)));
	auto& __Local__113 = (*(AccessPrivateProperty<FGuid >((__Local__105), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__113 = FGuid(0x8A291EDF, 0x40499572, 0x7FE33A97, 0x85CCD425);
	__Local__104.Add(__Local__105);
	auto& __Local__114 = (*(AccessPrivateProperty<FGuid >((__Local__102), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__114 = FGuid(0x6591925F, 0x45B0957F, 0xD13F0E93, 0xD1A0EFD6);
	auto& __Local__115 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__102), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__115.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__115.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__115.Entries.GetData(), 1);
	auto& __Local__116 = __Local__115.Entries[0];
	__Local__116.Section = __Local__105;
	auto& __Local__117 = (*(__Local__47->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__116.Range), 0)));
	auto& __Local__118 = (*(__Local__50->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__117), 0)));
	__Local__118 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__119 = (*(__Local__53->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__116.Range), 0)));
	auto& __Local__120 = (*(__Local__50->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__119), 0)));
	__Local__120 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__121 = (*(__Local__57->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__119), 0)));
	__Local__121.Value = 150000;
	__Local__116.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__122 = (*(AccessPrivateProperty<FGuid >((__Local__102), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__122 = FGuid(0x6591925F, 0x45B0957F, 0xD13F0E93, 0xD1A0EFD6);
	__Local__101.Add(__Local__102);
	auto& __Local__123 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__91), UMovieScene::__PPO__PlaybackRange() )));
	__Local__123 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(150001)));
	auto& __Local__124 = (*(AccessPrivateProperty<FFrameRate >((__Local__91), UMovieScene::__PPO__DisplayRate() )));
	auto& __Local__125 = (*(__Local__84->ContainerPtrToValuePtr<int32 >(&(__Local__124), 0)));
	__Local__125 = 20;
	auto& __Local__126 = (*(AccessPrivateProperty<FGuid >((__Local__91), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__126 = FGuid(0xF6308FCB, 0x47CE842C, 0x382F799D, 0xB956E79A);
	__Local__3->MovieScene = __Local__91;
	...
	auto& __Local__127 = __Local__3->AnimationBindings[0];
	__Local__127.WidgetName = FName(TEXT("Button_99"));
	__Local__127.AnimationGuid = FGuid(0x0A34ECE0, 0x42A20AD1, 0xD3CEAE82, 0x875987A0);
	auto& __Local__128 = (*(AccessPrivateProperty<FString >((__Local__3), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__128 = FString(TEXT("FadeInButton"));
	__Local__3->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__129 = (*(AccessPrivateProperty<FGuid >((__Local__3), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__129 = FGuid(0x305CD7E5, 0x4C327CF7, 0x1FD3FB8A, 0x71967EDB);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__3);
}
PRAGMA_ENABLE_OPTIMIZATION
void ULevel5_GameOverWB_C__pf1915849216::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__130;
	SlotNames.Append(__Local__130);
}
void ULevel5_GameOverWB_C__pf1915849216::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__131;
	__Local__131.Reserve(2);
	__Local__131.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(ULevel5_GameOverWB_C__pf1915849216::StaticClass())->MiscConvertedSubobjects[1]));
	__Local__131.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(ULevel5_GameOverWB_C__pf1915849216::StaticClass())->MiscConvertedSubobjects[2]));
	TArray<FDelegateRuntimeBinding>  __Local__132;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(ULevel5_GameOverWB_C__pf1915849216::StaticClass())->MiscConvertedSubobjects[0]), __Local__131, __Local__132);
}
void ULevel5_GameOverWB_C__pf1915849216::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void ULevel5_GameOverWB_C__pf1915849216::bpf__ExecuteUbergraph_Level5_GameOverWB__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpv__TextDescription__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[AA1FE3C44121631FAFEB6F8C473A0814]\", \"4B1F88AD404CA408275DC6B6268B4A0C\", \"You chose the wrong person and your mistake \\r\\nhas caused the group to be decimated by Ridgway\\r\\n\\r\\n\\r\\nYour journey has ended here\")")	);
	bpv__TextButton__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[AA1FE3C44121631FAFEB6F8C473A0814]\", \"E56013764D4CEE65FCC6AB813EA42D6F\", \"NEXT\")")	);
...
void ULevel5_GameOverWB_C__pf1915849216::bpf__ExecuteUbergraph_Level5_GameOverWB__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 11:
			{
				bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__TimesCount__pf, 1);
				bpv__TimesCount__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
			}
		case 12:
			{
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::EqualEqual_IntInt(bpv__TimesCount__pf, 1);
		...
		case 13:
			{
				bpv__TextDescription__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[AA1FE3C44121631FAFEB6F8C473A0814]\", \"5950835643B5ABC78F46A78858D905AD\", \"ENDING W\\r\\n\\r\\n\\r\\n\\r\\nWrong decision\")")	);
			}
		case 14:
			{
				bpv__TextButton__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[AA1FE3C44121631FAFEB6F8C473A0814]\", \"F5CFAE1D43166AA9FD8942B09408EB62\", \"Click here to try again\")")	);
			}
		case 15:
			{
		...
		case 16:
			{
				bpfv__CallFunc_PlayAnimation_ReturnValue_3__pf = UUserWidget::PlayAnimation(bpv__FadeInButton__pf, 0.000000, 1, EUMGSequencePlayMode::Forward, 1.000000, false);
				__CurrentState = -1;
				break;
			}
		case 17:
			{
				bpfv__CallFunc_GreaterEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::GreaterEqual_IntInt(bpv__TimesCount__pf, 2);
		...
		case 18:
			{
				UGameplayStatics::OpenLevel(this, FName(TEXT("Level5_Walk_2")), true, FString(TEXT("")));
				__CurrentState = -1;
				break;
			}
		default:
...
void ULevel5_GameOverWB_C__pf1915849216::bpf__ExecuteUbergraph_Level5_GameOverWB__pf_2(int32 bpp__EntryPoint__pf)
{
...
void ULevel5_GameOverWB_C__pf1915849216::bpf__BndEvt__Button_99_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Level5_GameOverWB__pf_1(10);
}
void ULevel5_GameOverWB_C__pf1915849216::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_Level5_GameOverWB__pf_2(8);
}
void ULevel5_GameOverWB_C__pf1915849216::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_Level5_GameOverWB__pf_0(6);
}
FText  ULevel5_GameOverWB_C__pf1915849216::bpf__GetText_0__pf()
{
	FText bpp__ReturnValue__pf{};
	bpp__ReturnValue__pf = bpv__TextDescription__pf;
	return bpp__ReturnValue__pf;
}
FText  ULevel5_GameOverWB_C__pf1915849216::bpf__GetText_1__pf()
{
	FText bpp__ReturnValue__pf{};
...
PRAGMA_DISABLE_OPTIMIZATION
void ULevel5_GameOverWB_C__pf1915849216::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ULevel5_GameOverWB_C__pf1915849216::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ULevel5_GameOverWB_C__pf1915849216
{
	FRegisterHelper__ULevel5_GameOverWB_C__pf1915849216()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/Level5_GameOver/Level5_GameOverWB"), &ULevel5_GameOverWB_C__pf1915849216::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ULevel5_GameOverWB_C__pf1915849216 Instance;
};
FRegisterHelper__ULevel5_GameOverWB_C__pf1915849216 FRegisterHelper__ULevel5_GameOverWB_C__pf1915849216::Instance;
