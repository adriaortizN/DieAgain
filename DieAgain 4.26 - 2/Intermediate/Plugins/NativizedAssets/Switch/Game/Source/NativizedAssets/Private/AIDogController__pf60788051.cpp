...
AAIDogController_C__pf60788051::AAIDogController_C__pf60788051(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void AAIDogController_C__pf60788051::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AAIDogController_C__pf60788051::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__23.DelegatePropertyName = FName(TEXT("OnPerceptionUpdated"));
	__Local__23.FunctionNameToBind = FName(TEXT("BndEvt__AIPerception_K2Node_ComponentBoundEvent_1_PerceptionUpdatedDelegate__DelegateSignature"));
	auto& __Local__24 = __Local__20->ComponentDelegateBindings[1];
	__Local__24.ComponentPropertyName = FName(TEXT("AIPerception"));
	__Local__24.DelegatePropertyName = FName(TEXT("OnTargetPerceptionUpdated"));
	__Local__24.FunctionNameToBind = FName(TEXT("BndEvt__AIPerception_K2Node_ComponentBoundEvent_0_ActorPerceptionUpdatedDelegate__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AAIDogController_C__pf60788051::bpf__ExecuteUbergraph_AIDogController__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	{
		bpv__ControlledCharacter__pf->bpf__Attack__pf(bpv__EnemyReference__pf);
	}
	bpfv__CallFunc_GetBlackboard_ReturnValue_3__pf = UAIBlueprintHelperLibrary::GetBlackboard(this);
	bpfv__CallFunc_MakeLiteralName_ReturnValue_5__pf = UKismetSystemLibrary::MakeLiteralName(FName(TEXT("IsEnemyOfDogAlive")));
	...
	if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_3__pf))
	{
		bpfv__CallFunc_GetBlackboard_ReturnValue_3__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_6__pf, false);
	}
	return; //KCST_EndOfThread
}
void AAIDogController_C__pf60788051::bpf__ExecuteUbergraph_AIDogController__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 10:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf = Cast<AEnemyDogCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
		...
		case 11:
			{
				int32  __Local__25 = 0;
				int32  __Local__26 = 0;
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpv__Squad__pf) : (__Local__25)), ((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__Squad__pf) : (__Local__26)));
		...
		case 13:
			{
				...
				{
					__Local__27 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
					check(__Local__27);
					__Local__28 = __Local__27;
				}
				bpf__MakeFocus__pf(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf, static_cast<E__EnumTypesOfCharacters__pf>(bpfv__CallFunc_MakeLiteralByte_ReturnValue_2__pf), (((FBoolProperty*)__Local__27)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				__CurrentState = -1;
				break;
			}
		case 30:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_2__pf = Cast<AEnemyDogCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_2__pf != nullptr);;
		...
		case 31:
			{
				int32  __Local__29 = 0;
				int32  __Local__30 = 0;
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue_1__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__Squad__pf) : (__Local__29)), ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_2__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_2__pf->bpv__Squad__pf) : (__Local__30)));
		...
		case 32:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf->bpv__IsDeath__pf) : (__Local__31)))
				{
					__CurrentState = 33;
					break;
				}
		...
		case 34:
			{
				...
				{
					__Local__32 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
					check(__Local__32);
					__Local__33 = __Local__32;
				}
				bpf__MakeFocus__pf(b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf, static_cast<E__EnumTypesOfCharacters__pf>(bpfv__CallFunc_MakeLiteralByte_ReturnValue_1__pf), (((FBoolProperty*)__Local__32)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				__CurrentState = -1;
				break;
			}
		case 35:
		...
		case 36:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_5__pf = (b0l__K2Node_DynamicCast_AsThird_Person_Character__pf != nullptr);;
		...
		case 37:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsThird_Person_Character__pf)) ? (b0l__K2Node_DynamicCast_AsThird_Person_Character__pf->bpv__IsDeath__pf) : (__Local__34)))
				{
					__CurrentState = 10;
					break;
				}
		...
		case 38:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_4__pf = (b0l__K2Node_DynamicCast_AsEnemy_Shooting_Ch__pf != nullptr);;
		...
		case 39:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_3__pf = Cast<AEnemyDogCh_C__pf3349424045>(b0l__K2Node_ComponentBoundEvent_Actor__pf);
				b0l__K2Node_DynamicCast_bSuccess_3__pf = (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_3__pf != nullptr);;
		...
		case 40:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_4__pf = Cast<AEnemyDogCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
				b0l__K2Node_DynamicCast_bSuccess_6__pf = (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_4__pf != nullptr);;
		...
		case 41:
			{
				int32  __Local__35 = 0;
				int32  __Local__36 = 0;
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue_2__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_4__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_4__pf->bpv__Squad__pf) : (__Local__35)), ((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_3__pf->bpv__Squad__pf) : (__Local__36)));
		...
		case 42:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_3__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_3__pf->bpv__IsDeath__pf) : (__Local__37)))
				{
					__CurrentState = 43;
					break;
				}
		...
		case 43:
			{
				bpv__EnemyReference__pf = b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_3__pf;
			}
		case 44:
			{
				...
				{
					__Local__38 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
					check(__Local__38);
					__Local__39 = __Local__38;
				}
				bpf__MakeFocus__pf(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_3__pf, static_cast<E__EnumTypesOfCharacters__pf>(bpfv__CallFunc_MakeLiteralByte_ReturnValue__pf), (((FBoolProperty*)__Local__38)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				__CurrentState = -1;
				break;
			}
		case 45:
		...
		case 46:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf))
				{
					...
					{
						__Local__40 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
						check(__Local__40);
						__Local__41 = __Local__40;
					}
					bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_2__pf, (((FBoolProperty*)__Local__40)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				}
			}
		case 47:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf))
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::SetValueAsVector(bpfv__CallFunc_MakeLiteralName_ReturnValue_4__pf, b0l__K2Node_ComponentBoundEvent_Stimulus__pf.StimulusLocation);
				}
				__CurrentState = -1;
				break;
			}
		case 48:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf))
				{
					...
					{
						__Local__42 = (FAIStimulus::StaticStruct())->FindPropertyByName(FName(TEXT("bSuccessfullySensed")));
						check(__Local__42);
						__Local__43 = __Local__42;
					}
					bpfv__CallFunc_GetBlackboard_ReturnValue_2__pf->UBlackboardComponent::SetValueAsBool(bpfv__CallFunc_MakeLiteralName_ReturnValue_3__pf, (((FBoolProperty*)__Local__42)->GetPropertyValue_InContainer(&(b0l__K2Node_ComponentBoundEvent_Stimulus__pf), 0)));
				}
				__CurrentState = -1;
				break;
			}
...
void AAIDogController_C__pf60788051::bpf__ExecuteUbergraph_AIDogController__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_RunBehaviorTree_ReturnValue__pf = RunBehaviorTree(CastChecked<UBehaviorTree>(CastChecked<UDynamicClass>(AAIDogController_C__pf60788051::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
			}
		case 2:
			{
		...
		case 4:
			{
				...
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_1__pf->bpv__PatrolPoints__pf) : (__Local__44)));
		...
		case 7:
			{
				...
				FCustomThunkTemplates::Array_Get(((::IsValid(b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_1__pf)) ? (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_1__pf->bpv__PatrolPoints__pf) : (__Local__45)), b0l__Temp_int_Array_Index_Variable__pf, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
		...
		case 15:
			{
				b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_1__pf = Cast<AEnemyDogCh_C__pf3349424045>(b0l__K2Node_Event_PossessedPawn__pf);
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_1__pf != nullptr);;
		...
		case 16:
			{
				bpv__ControlledCharacter__pf = b0l__K2Node_DynamicCast_AsEnemy_Dog_Ch_1__pf;
				__CurrentState = 1;
				break;
			}
		default:
...
void AAIDogController_C__pf60788051::bpf__ExecuteUbergraph_AIDogController__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 49);
	return; //KCST_EndOfThread
}
void AAIDogController_C__pf60788051::bpf__ExecuteUbergraph_AIDogController__pf_4(int32 bpp__EntryPoint__pf)
{
...
void AAIDogController_C__pf60788051::bpf__ExecuteUbergraph_AIDogController__pf_5(int32 bpp__EntryPoint__pf)
{
...
void AAIDogController_C__pf60788051::bpf__ExecuteUbergraph_AIDogController__pf_6(int32 bpp__EntryPoint__pf)
{
		...
		case 25:
			{
				...
				{
					bpfv__CallFunc_GetBlackboard_ReturnValue__pf->UBlackboardComponent::SetValueAsObject(bpfv__CallFunc_MakeLiteralName_ReturnValue__pf, b0l__CallFunc_Array_Get_Item__pf);
				}
				__CurrentState = -1;
				break;
			}
...
void AAIDogController_C__pf60788051::bpf__BndEvt__AIPerception_K2Node_ComponentBoundEvent_1_PerceptionUpdatedDelegate__DelegateSignature__pf(TArray<AActor*> const& bpp__UpdatedActors__pf__const)
{
	typedef TArray<AActor*>  T__Local__46;
	T__Local__46& bpp__UpdatedActors__pf = *const_cast<T__Local__46 *>(&bpp__UpdatedActors__pf__const);
	b0l__K2Node_ComponentBoundEvent_UpdatedActors__pf = bpp__UpdatedActors__pf;
	bpf__ExecuteUbergraph_AIDogController__pf_3(49);
}
void AAIDogController_C__pf60788051::bpf__BndEvt__AIPerception_K2Node_ComponentBoundEvent_0_ActorPerceptionUpdatedDelegate__DelegateSignature__pf(AActor* bpp__Actor__pf, FAIStimulus bpp__Stimulus__pf)
{
	b0l__K2Node_ComponentBoundEvent_Actor__pf = bpp__Actor__pf;
	b0l__K2Node_ComponentBoundEvent_Stimulus__pf = bpp__Stimulus__pf;
	bpf__ExecuteUbergraph_AIDogController__pf_1(35);
}
void AAIDogController_C__pf60788051::bpf__Walk__pf()
{
	bpf__ExecuteUbergraph_AIDogController__pf_4(28);
}
void AAIDogController_C__pf60788051::bpf__Run__pf()
{
	bpf__ExecuteUbergraph_AIDogController__pf_5(26);
}
void AAIDogController_C__pf60788051::bpf__GetNewPoint__pf()
{
	bpf__ExecuteUbergraph_AIDogController__pf_6(21);
}
void AAIDogController_C__pf60788051::bpf__Attack__pf()
{
	bpf__ExecuteUbergraph_AIDogController__pf_0(17);
}
void AAIDogController_C__pf60788051::bpf__ReceivePossess__pf(APawn* bpp__PossessedPawn__pf)
{
	b0l__K2Node_Event_PossessedPawn__pf = bpp__PossessedPawn__pf;
	bpf__ExecuteUbergraph_AIDogController__pf_2(14);
}
void AAIDogController_C__pf60788051::bpf__MakeFocus__pf(AActor* bpp__EnemyCast__pf, E__EnumTypesOfCharacters__pf bpp__TypeOfCharacter__pf, bool bpp__Successfully_Sensed__pf)
{
	...
	do
	{
		...
		case 3:
			{
				bpfv__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf = Cast<AEnemyDogCh_C__pf3349424045>(bpv__ControlledCharacter__pf);
		...
		case 4:
			{
				...
				{
					bpfv__K2Node_DynamicCast_AsEnemy_Dog_Ch__pf->bpf__EnemyDetected__pf();
				}
				__CurrentState = -1;
				break;
			}
...
void AAIDogController_C__pf60788051::bpf__GetSoundAlert__pf(AActor* bpp__EnemyCast__pf)
{
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue__pf{};
	FVector bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf(EForceInit::ForceInit);
	FName bpfv__CallFunc_MakeLiteralName_ReturnValue_1__pf{};
...
PRAGMA_DISABLE_OPTIMIZATION
void AAIDogController_C__pf60788051::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AAIDogController_C__pf60788051::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AAIDogController_C__pf60788051
{
	FRegisterHelper__AAIDogController_C__pf60788051()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Enemies/BehaviorDog/AIDogController"), &AAIDogController_C__pf60788051::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AAIDogController_C__pf60788051 Instance;
};
FRegisterHelper__AAIDogController_C__pf60788051 FRegisterHelper__AAIDogController_C__pf60788051::Instance;
