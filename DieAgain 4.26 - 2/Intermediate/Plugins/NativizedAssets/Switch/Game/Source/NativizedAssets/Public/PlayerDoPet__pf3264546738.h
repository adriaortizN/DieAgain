...
class AActor;
#include "PlayerDoPet__pf3264546738.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Conversations/Events/PlayerDoPet.PlayerDoPet_C", OverrideNativeName="PlayerDoPet_C"))
class UPlayerDoPet_C__pf3264546738 : public UDialogueEvents
{
public:
	GENERATED_BODY()
	...
	UPlayerDoPet_C__pf3264546738(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_PlayerDoPet__pf_0(int32 bpp__EntryPoint__pf);
