...
ATargetPoint_Cutscene_C__pf2030518057::ATargetPoint_Cutscene_C__pf2030518057(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__Turn180__pf = true;
	bpv__IsFirstTargetPoint__pf = false;
...
void ATargetPoint_Cutscene_C__pf2030518057::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ATargetPoint_Cutscene_C__pf2030518057::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ATargetPoint_Cutscene_C__pf2030518057::bpf__ExecuteUbergraph_TargetPoint_Cutscene__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				UKismetSystemLibrary::Delay(this, 1.733000, FLatentActionInfo(2, -2083169121, TEXT("ExecuteUbergraph_TargetPoint_Cutscene_0"), this));
				__CurrentState = -1;
				break;
			}
		case 2:
		...
		case 3:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf->bpf__PossesionEffect__pf();
				}
			}
		case 4:
			{
				UKismetSystemLibrary::Delay(this, 3.000000, FLatentActionInfo(5, 693569150, TEXT("ExecuteUbergraph_TargetPoint_Cutscene_0"), this));
				__CurrentState = -1;
				break;
			}
		case 5:
		...
		case 6:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf))
				{
					b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf->bpv__ToShoot__pf = true;
				}
			}
		case 7:
			{
				FRotator  __Local__7 = FRotator(0.000000,0.000000,0.000000);
				UKismetMathLibrary::BreakRotator(((::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf) && ::IsValid((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf), ACharacter::__PPO__Mesh() ))))) ? ((*(AccessPrivateProperty<FRotator >(((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf), ACharacter::__PPO__Mesh() )))), USceneComponent::__PPO__RelativeRotation() )))) : (__Local__7)), /*out*/ b0l__CallFunc_BreakRotator_Roll_2__pf, /*out*/ b0l__CallFunc_BreakRotator_Pitch_2__pf, /*out*/ b0l__CallFunc_BreakRotator_Yaw_2__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_2__pf = UKismetMathLibrary::Add_FloatFloat(b0l__CallFunc_BreakRotator_Yaw_2__pf, -70.000000);
				bpfv__CallFunc_MakeRotator_ReturnValue_2__pf = UKismetMathLibrary::MakeRotator(b0l__CallFunc_BreakRotator_Roll_2__pf, b0l__CallFunc_BreakRotator_Pitch_2__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_2__pf);
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf) && ::IsValid((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf), ACharacter::__PPO__Mesh() )))))
				{
					(*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf), ACharacter::__PPO__Mesh() )))->USceneComponent::K2_SetRelativeRotation(bpfv__CallFunc_MakeRotator_ReturnValue_2__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeRotation_SweepHitResult_2__pf, false);
				}
			}
		case 8:
			{
				UKismetSystemLibrary::Delay(this, 1.733000, FLatentActionInfo(9, 253274058, TEXT("ExecuteUbergraph_TargetPoint_Cutscene_0"), this));
				__CurrentState = -1;
				break;
			}
		case 9:
		...
		case 10:
			{
				FRotator  __Local__9 = FRotator(0.000000,0.000000,0.000000);
				UKismetMathLibrary::BreakRotator(((::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf) && ::IsValid((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf), ACharacter::__PPO__Mesh() ))))) ? ((*(AccessPrivateProperty<FRotator >(((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf), ACharacter::__PPO__Mesh() )))), USceneComponent::__PPO__RelativeRotation() )))) : (__Local__9)), /*out*/ b0l__CallFunc_BreakRotator_Roll_1__pf, /*out*/ b0l__CallFunc_BreakRotator_Pitch_1__pf, /*out*/ b0l__CallFunc_BreakRotator_Yaw_1__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::Add_FloatFloat(b0l__CallFunc_BreakRotator_Yaw_1__pf, 70.000000);
				bpfv__CallFunc_MakeRotator_ReturnValue_1__pf = UKismetMathLibrary::MakeRotator(b0l__CallFunc_BreakRotator_Roll_1__pf, b0l__CallFunc_BreakRotator_Pitch_1__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue_1__pf);
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf) && ::IsValid((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf), ACharacter::__PPO__Mesh() )))))
				{
					(*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf), ACharacter::__PPO__Mesh() )))->USceneComponent::K2_SetRelativeRotation(bpfv__CallFunc_MakeRotator_ReturnValue_1__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeRotation_SweepHitResult_1__pf, false);
				}
			}
		case 11:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf))
				{
					b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf->bpv__ToShoot__pf = false;
				}
			}
		case 12:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf))
				{
					b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf->bpf__GoToNextTarget__pf();
				}
				__CurrentState = -1;
				break;
			}
		...
		case 14:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf))
				{
					b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf->bpv__Turn180__pf = false;
				}
			}
		case 15:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf) && ::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf->bpv__Weapon__pf))
				{
					b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf->bpv__Weapon__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(6.366872,1.580058,-0.667078), FRotator(-1.229634,86.953934,176.521851), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult_1__pf, true);
				}
				__CurrentState = 1;
				break;
			}
		...
		case 17:
			{
				FRotator  __Local__10 = FRotator(0.000000,0.000000,0.000000);
				UKismetMathLibrary::BreakRotator(((::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf) && ::IsValid((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf), ACharacter::__PPO__Mesh() ))))) ? ((*(AccessPrivateProperty<FRotator >(((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf), ACharacter::__PPO__Mesh() )))), USceneComponent::__PPO__RelativeRotation() )))) : (__Local__10)), /*out*/ b0l__CallFunc_BreakRotator_Roll__pf, /*out*/ b0l__CallFunc_BreakRotator_Pitch__pf, /*out*/ b0l__CallFunc_BreakRotator_Yaw__pf);
				...
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf) && ::IsValid((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf), ACharacter::__PPO__Mesh() )))))
				{
					(*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf), ACharacter::__PPO__Mesh() )))->USceneComponent::K2_SetRelativeRotation(bpfv__CallFunc_MakeRotator_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeRotation_SweepHitResult__pf, true);
				}
			}
		case 18:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf->bpv__Shooting__pf = true;
				}
			}
		case 19:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf) && ::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf->bpv__Weapon__pf))
				{
					b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf->bpv__Weapon__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(2.908430,2.514500,0.572000), FRotator(0.183800,105.541000,180.250000), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult__pf, true);
				}
			}
		case 20:
			{
				UKismetSystemLibrary::Delay(this, 2.000000, FLatentActionInfo(21, 1792805644, TEXT("ExecuteUbergraph_TargetPoint_Cutscene_0"), this));
				__CurrentState = -1;
				break;
			}
		case 21:
		...
		case 22:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf))
				{
					b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf->bpf__MoveToSecondTarget__pf();
				}
				__CurrentState = -1;
				break;
			}
		case 23:
			{
				UKismetSystemLibrary::Delay(this, 1.300000, FLatentActionInfo(13, -571979708, TEXT("ExecuteUbergraph_TargetPoint_Cutscene_0"), this));
				__CurrentState = -1;
				break;
			}
		case 24:
			{
				UKismetSystemLibrary::Delay(this, 2.000000, FLatentActionInfo(16, 661351959, TEXT("ExecuteUbergraph_TargetPoint_Cutscene_0"), this));
				__CurrentState = -1;
				break;
			}
		case 25:
			{
				if (!bpv__IsFirstTargetPoint__pf)
				{
					__CurrentState = -1;
					break;
				}
		...
		case 26:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf))
				{
					b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf->bpv__Turn180__pf = bpv__Turn180__pf;
				}
				__CurrentState = 23;
				break;
			}
		...
		case 28:
			{
				b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf = Cast<ACharacter_Alfa_C__pf2030518057>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
		...
		case 29:
			{
				b0l__K2Node_DynamicCast_AsCharacter_Beta__pf = Cast<ACharacter_Beta_C__pf2030518057>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
		...
		case 30:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsCharacter_Beta__pf->bpv__Turn180__pf = true;
				}
				__CurrentState = -1;
				break;
			}
		case 31:
			{
				b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf = Cast<ACharacter_Gamma_C__pf2030518057>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
		...
		case 32:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf))
				{
					b0l__K2Node_DynamicCast_AsCharacter_Gamma__pf->bpv__Turn180__pf = true;
				}
				__CurrentState = 24;
				break;
			}
...
void ATargetPoint_Cutscene_C__pf2030518057::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_TargetPoint_Cutscene__pf_0(27);
}
PRAGMA_DISABLE_OPTIMIZATION
void ATargetPoint_Cutscene_C__pf2030518057::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ATargetPoint_Cutscene_C__pf2030518057::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ATargetPoint_Cutscene_C__pf2030518057
{
	FRegisterHelper__ATargetPoint_Cutscene_C__pf2030518057()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/Cutscene/TargetPoint_Cutscene"), &ATargetPoint_Cutscene_C__pf2030518057::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ATargetPoint_Cutscene_C__pf2030518057 Instance;
};
FRegisterHelper__ATargetPoint_Cutscene_C__pf2030518057 FRegisterHelper__ATargetPoint_Cutscene_C__pf2030518057::Instance;
