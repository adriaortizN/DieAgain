...
UVolume_WB_C__pf3479267681::UVolume_WB_C__pf3479267681(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Exit_Button__pf = nullptr;
	bpv__Slider_MusicVolume__pf = nullptr;
	bpv__Slider_SFXVolume__pf = nullptr;
	bpv__TextBlock_1__pf = nullptr;
	bpv__Voice_Button_0__pf = nullptr;
	bpv__TextAreaVisible__pf = FText::GetEmpty();
	bpv__MusicVolume__pf = 0.000000f;
	bpv__SFXVolume__pf = 0.000000f;
	bpv__VoiceActingIsActive__pf = true;
	bpv__ItsComingFromMainMenu__pf = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UVolume_WB_C__pf3479267681::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UVolume_WB_C__pf3479267681::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__2.ComponentPropertyName = FName(TEXT("Voice_Button_0"));
	__Local__2.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__Volume_WB_Voice_Button_0_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__3 = __Local__0->ComponentDelegateBindings[1];
	__Local__3.ComponentPropertyName = FName(TEXT("Slider_MusicVolume"));
	__Local__3.DelegatePropertyName = FName(TEXT("OnValueChanged"));
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__Volume_WB_Slider_SFXVolume_E_K2Node_ComponentBoundEvent_0_OnFloatValueChangedEvent__DelegateSignature"));
	auto& __Local__4 = __Local__0->ComponentDelegateBindings[2];
	__Local__4.ComponentPropertyName = FName(TEXT("Slider_SFXVolume"));
	__Local__4.DelegatePropertyName = FName(TEXT("OnValueChanged"));
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__Volume_WB_Slider_K2Node_ComponentBoundEvent_5_OnFloatValueChangedEvent__DelegateSignature"));
	auto& __Local__5 = __Local__0->ComponentDelegateBindings[3];
	__Local__5.ComponentPropertyName = FName(TEXT("Exit_Button"));
	__Local__5.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__5.FunctionNameToBind = FName(TEXT("BndEvt__Exit_Button_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__7.Reserve(7);
	auto __Local__8 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_5"), (EObjectFlags)0x00280008);
	__Local__8->LayoutData.Offsets.Left = -400.000000f;
	__Local__8->LayoutData.Offsets.Top = 320.000000f;
	__Local__8->LayoutData.Offsets.Right = 820.000000f;
	__Local__8->LayoutData.Offsets.Bottom = 120.000000f;
	...
	auto __Local__9 = NewObject<UButton>(__Local__1, TEXT("Exit_Button"), (EObjectFlags)0x00280008);
	__Local__9->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__10 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__9->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__10 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__11 = (*(AccessPrivateProperty<UObject* >(&(__Local__9->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__11 = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__9->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__12 = (*(AccessPrivateProperty<UObject* >(&(__Local__9->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__12 = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__9->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__13 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__9->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__13 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__14 = (*(AccessPrivateProperty<UObject* >(&(__Local__9->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__14 = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__15 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__9), UPanelWidget::__PPO__Slots() )));
	__Local__15 = TArray<UPanelSlot*> ();
	__Local__15.Reserve(1);
	auto __Local__16 = NewObject<UButtonSlot>(__Local__9, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__16->Parent = __Local__9;
	auto __Local__17 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_3"), (EObjectFlags)0x00280008);
	__Local__17->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[521AB1F14674BBE36F60F593BA41B1D5]\", \"07F901004055114DEE2DE8A6294FA867\", \"Go  back\")")	);
	auto& __Local__18 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__17->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__18 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__17->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__17->Font.OutlineSettings.OutlineSize = 5;
	__Local__17->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__17->Font.Size = 40;
	...
	auto __Local__20 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_2"), (EObjectFlags)0x00280008);
	__Local__20->LayoutData.Offsets.Left = -232.960938f;
	__Local__20->LayoutData.Offsets.Top = 100.000000f;
	__Local__20->LayoutData.Offsets.Right = 471.482574f;
	__Local__20->LayoutData.Offsets.Bottom = 96.733406f;
	__Local__20->LayoutData.Anchors.Minimum = FVector2D(0.500000, 0.000000);
	__Local__20->LayoutData.Anchors.Maximum = FVector2D(0.500000, 0.000000);
	__Local__20->Parent = __Local__6;
	auto __Local__21 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_65"), (EObjectFlags)0x00280008);
	__Local__21->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[521AB1F14674BBE36F60F593BA41B1D5]\", \"E856C7B844EF8765A4A5D7A77728BC07\", \"Audio Options\")")	);
	__Local__21->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__21->Font.OutlineSettings.OutlineSize = 5;
	__Local__21->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__21->Font.Size = 60;
	__Local__21->Slot = __Local__20;
	__Local__20->Content = __Local__21;
	__Local__7.Add(__Local__20);
	auto __Local__22 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_7"), (EObjectFlags)0x00280008);
	__Local__22->LayoutData.Offsets.Left = -400.000000f;
	__Local__22->LayoutData.Offsets.Top = -60.000000f;
	__Local__22->LayoutData.Offsets.Right = 820.000000f;
	__Local__22->LayoutData.Offsets.Bottom = 160.000000f;
	...
	__Local__22->Parent = __Local__6;
	auto __Local__23 = NewObject<USlider>(__Local__1, TEXT("Slider_SFXVolume"), (EObjectFlags)0x00280008);
	__Local__23->Value = 0.240000f;
	__Local__23->WidgetStyle.NormalBarImage.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__24 = (*(AccessPrivateProperty<UObject* >(&(__Local__23->WidgetStyle.NormalBarImage), FSlateBrush::__PPO__ResourceObject() )));
	__Local__24 = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__23->WidgetStyle.HoveredBarImage.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__25 = (*(AccessPrivateProperty<UObject* >(&(__Local__23->WidgetStyle.HoveredBarImage), FSlateBrush::__PPO__ResourceObject() )));
	__Local__25 = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__23->WidgetStyle.NormalThumbImage.ImageSize = FVector2D(60.000000, 135.000000);
	__Local__23->WidgetStyle.HoveredThumbImage.ImageSize = FVector2D(60.000000, 135.000000);
	__Local__23->WidgetStyle.DisabledThumbImage.ImageSize = FVector2D(60.000000, 135.000000);
	__Local__23->WidgetStyle.BarThickness = 150.000000f;
	__Local__23->SliderBarColor = FLinearColor(0.000000, 0.000000, 0.000000, 1.000000);
	__Local__23->SliderHandleColor = FLinearColor(1.000000, 0.180835, 0.000000, 1.000000);
	__Local__23->StepSize = 0.100000f;
	__Local__23->Slot = __Local__22;
	auto __Local__26 = NewObject<UWidgetNavigation>(__Local__23, TEXT("WidgetNavigation_0"), (EObjectFlags)0x00280008);
	__Local__26->Left.Rule = EUINavigationRule::Custom;
	__Local__26->Left.WidgetToFocus = FName(TEXT("LessVolume_SFX"));
	__Local__26->Right.Rule = EUINavigationRule::Custom;
	__Local__26->Right.WidgetToFocus = FName(TEXT("MoreVolume_SFX"));
	__Local__23->Navigation = __Local__26;
	__Local__22->Content = __Local__23;
	__Local__7.Add(__Local__22);
	auto __Local__27 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_18"), (EObjectFlags)0x00280008);
	__Local__27->LayoutData.Offsets.Left = -400.000000f;
	__Local__27->LayoutData.Offsets.Top = -250.000000f;
	__Local__27->LayoutData.Offsets.Right = 820.000000f;
	__Local__27->LayoutData.Offsets.Bottom = 160.000000f;
	...
	auto __Local__28 = NewObject<USlider>(__Local__1, TEXT("Slider_MusicVolume"), (EObjectFlags)0x00280008);
	__Local__28->Value = 0.320000f;
	__Local__28->WidgetStyle.NormalBarImage.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__29 = (*(AccessPrivateProperty<UObject* >(&(__Local__28->WidgetStyle.NormalBarImage), FSlateBrush::__PPO__ResourceObject() )));
	__Local__29 = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__28->WidgetStyle.HoveredBarImage.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__30 = (*(AccessPrivateProperty<UObject* >(&(__Local__28->WidgetStyle.HoveredBarImage), FSlateBrush::__PPO__ResourceObject() )));
	__Local__30 = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__28->WidgetStyle.NormalThumbImage.ImageSize = FVector2D(60.000000, 135.000000);
	__Local__28->WidgetStyle.HoveredThumbImage.ImageSize = FVector2D(60.000000, 135.000000);
	__Local__28->WidgetStyle.DisabledThumbImage.ImageSize = FVector2D(60.000000, 135.000000);
	__Local__28->WidgetStyle.BarThickness = 150.000000f;
	__Local__28->SliderBarColor = FLinearColor(0.000000, 0.000000, 0.000000, 1.000000);
	__Local__28->SliderHandleColor = FLinearColor(1.000000, 0.180835, 0.000000, 1.000000);
	__Local__28->StepSize = 0.100000f;
	__Local__28->Slot = __Local__27;
	auto __Local__31 = NewObject<UWidgetNavigation>(__Local__28, TEXT("WidgetNavigation_0"), (EObjectFlags)0x00280008);
	__Local__31->Left.Rule = EUINavigationRule::Custom;
	__Local__31->Left.WidgetToFocus = FName(TEXT("LessVolume_Music"));
	__Local__31->Right.Rule = EUINavigationRule::Custom;
	__Local__31->Right.WidgetToFocus = FName(TEXT("MoreVolume_Music"));
	__Local__28->Navigation = __Local__31;
	__Local__27->Content = __Local__28;
	__Local__7.Add(__Local__27);
	auto __Local__32 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_23"), (EObjectFlags)0x00280008);
	__Local__32->LayoutData.Offsets.Left = -400.960938f;
	__Local__32->LayoutData.Offsets.Top = 147.459473f;
	__Local__32->LayoutData.Offsets.Right = 820.000000f;
	__Local__32->LayoutData.Offsets.Bottom = 120.000000f;
	...
	__Local__32->Parent = __Local__6;
	auto __Local__33 = NewObject<UButton>(__Local__1, TEXT("Voice_Button_0"), (EObjectFlags)0x00280008);
	...
	__Local__35 = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__36 = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	__Local__38 = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	auto __Local__41 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_1"), (EObjectFlags)0x00280008);
	__Local__41->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[521AB1F14674BBE36F60F593BA41B1D5]\", \"CD04486A470DA0A0F9B3DEA43FE45651\", \"Voice Acting ON\")")	);
	...
	__Local__41->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__41->Font.OutlineSettings.OutlineSize = 5;
	__Local__41->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__41->Font.Size = 40;
	auto& __Local__43 = (*(AccessPrivateProperty<TEnumAsByte<ETextJustify::Type> >((__Local__41), UTextLayoutWidget::__PPO__Justification() )));
	...
	__Local__7.Add(__Local__32);
	auto __Local__44 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_12"), (EObjectFlags)0x00280008);
	__Local__44->LayoutData.Offsets.Left = -888.960938f;
	__Local__44->LayoutData.Offsets.Top = -216.540527f;
	__Local__44->LayoutData.Offsets.Right = 498.175964f;
	__Local__44->LayoutData.Offsets.Bottom = 81.162277f;
	...
	__Local__44->Parent = __Local__6;
	auto __Local__45 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_84"), (EObjectFlags)0x00280008);
	__Local__45->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[521AB1F14674BBE36F60F593BA41B1D5]\", \"4CB991E7423D5355FB005B83856BE9C5\", \"Music volume\")")	);
	__Local__45->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__45->Font.OutlineSettings.OutlineSize = 3;
	__Local__45->Font.TypefaceFontName = FName(TEXT("Regular"));
	__Local__45->Font.Size = 50;
	static TWeakFieldPtr<FProperty> __Local__47{};
	const FProperty* __Local__46 = __Local__47.Get();
	if (nullptr == __Local__46)
	{
		__Local__46 = (UTextLayoutWidget::StaticClass())->FindPropertyByName(FName(TEXT("AutoWrapText")));
		check(__Local__46);
		__Local__47 = __Local__46;
	}
	(((FBoolProperty*)__Local__46)->SetPropertyValue_InContainer((__Local__45), true, 0));
	__Local__45->Slot = __Local__44;
	__Local__44->Content = __Local__45;
	__Local__7.Add(__Local__44);
	auto __Local__48 = NewObject<UCanvasPanelSlot>(__Local__6, TEXT("CanvasPanelSlot_13"), (EObjectFlags)0x00280008);
	__Local__48->LayoutData.Offsets.Left = -896.960938f;
	__Local__48->LayoutData.Offsets.Top = -24.540527f;
	__Local__48->LayoutData.Offsets.Right = 511.522644f;
	__Local__48->LayoutData.Offsets.Bottom = 92.284508f;
...
TEXT("NSLOCTEXT(\"[521AB1F14674BBE36F60F593BA41B1D5]\", \"B727495F45AB30F53ACF818DB3646194\", \"SFX volume\")")	);
	__Local__49->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__49->Font.OutlineSettings.OutlineSize = 3;
	__Local__49->Font.TypefaceFontName = FName(TEXT("Regular"));
	__Local__49->Font.Size = 50;
	...
	__Local__7.Add(__Local__48);
	__Local__1->RootWidget = __Local__6;
}
PRAGMA_ENABLE_OPTIMIZATION
void UVolume_WB_C__pf3479267681::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__50;
	SlotNames.Append(__Local__50);
}
void UVolume_WB_C__pf3479267681::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__51;
	TArray<FDelegateRuntimeBinding>  __Local__52;
	__Local__52.AddUninitialized(3);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__52.GetData(), 3);
	auto& __Local__53 = __Local__52[0];
	__Local__53.ObjectName = FString(TEXT("Slider_SFXVolume"));
	__Local__53.PropertyName = FName(TEXT("Value"));
	__Local__53.FunctionName = FName(TEXT("GetValueSFXMusic"));
	...
	__Local__55.Name = FName(TEXT("GetValueSFXMusic"));
	auto& __Local__56 = __Local__52[1];
	__Local__56.ObjectName = FString(TEXT("Slider_MusicVolume"));
	__Local__56.PropertyName = FName(TEXT("Value"));
	__Local__56.FunctionName = FName(TEXT("Get_Slider_SFXVolume_E_Value_0"));
	...
	__Local__58.Name = FName(TEXT("Get_Slider_SFXVolume_E_Value_0"));
	auto& __Local__59 = __Local__52[2];
	__Local__59.ObjectName = FString(TEXT("TextBlock_1"));
	__Local__59.PropertyName = FName(TEXT("Text"));
	__Local__59.FunctionName = FName(TEXT("GetText_Voices"));
	auto& __Local__60 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__59.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__60 = TArray<FPropertyPathSegment> ();
	__Local__60.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__60.GetData(), 1);
	auto& __Local__61 = __Local__60[0];
	__Local__61.Name = FName(TEXT("GetText_Voices"));
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->MiscConvertedSubobjects[0]), __Local__51, __Local__52);
}
void UVolume_WB_C__pf3479267681::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UVolume_WB_C__pf3479267681::bpf__ExecuteUbergraph_Volume_WB__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 6:
			{
				UFMODBlueprintStatics::BusSetVolume(CastChecked<UFMODBus>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), bpv__SFXVolume__pf);
		...
		case 18:
			{
				...
				b1l__K2Node_MakeArray_Array__pf[0] = bpv__Exit_Button__pf;
		...
		case 21:
			{
				...
				b1l__K2Node_DynamicCast_bSuccess_3__pf = (b1l__K2Node_DynamicCast_AsSave_Game_BP_1__pf != nullptr);;
		...
		case 22:
			{
				...
				bpv__MusicVolume__pf = ((::IsValid(b1l__K2Node_DynamicCast_AsSave_Game_BP_1__pf)) ? (b1l__K2Node_DynamicCast_AsSave_Game_BP_1__pf->bpv__MusicVolume__pf) : (__Local__62));
			}
		case 23:
			{
				UFMODBlueprintStatics::BusSetVolume(CastChecked<UFMODBus>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed), bpv__MusicVolume__pf);
			}
		case 24:
			{
				float  __Local__63 = 0.000000;
				bpv__SFXVolume__pf = ((::IsValid(b1l__K2Node_DynamicCast_AsSave_Game_BP_1__pf)) ? (b1l__K2Node_DynamicCast_AsSave_Game_BP_1__pf->bpv__SFXVolume__pf) : (__Local__63));
				__CurrentState = 6;
				break;
			}
		default:
...
void UVolume_WB_C__pf3479267681::bpf__ExecuteUbergraph_Volume_WB__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 34:
			{
				...
				if (!((::IsValid(b1l__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (b1l__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__IsVoiceActive__pf) : (__Local__64)))
				{
					__CurrentState = 37;
					break;
				}
		...
		case 35:
			{
				bpv__VoiceActingIsActive__pf = false;
			}
		case 36:
			{
				if(::IsValid(b1l__K2Node_DynamicCast_AsMy_Game_Instance__pf))
				{
					b1l__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpf__SetVoiceActing__pf(false);
				}
				__CurrentState = -1;
				break;
			}
		...
		case 38:
			{
				if(::IsValid(b1l__K2Node_DynamicCast_AsMy_Game_Instance__pf))
				{
					b1l__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpf__SetVoiceActing__pf(true);
				}
				__CurrentState = -1;
				break;
			}
...
void UVolume_WB_C__pf3479267681::bpf__ExecuteUbergraph_Volume_WB__pf_2(int32 bpp__EntryPoint__pf)
{
		...
		case 10:
			{
				...
				{
					b1l__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__MusicVolume__pf = bpv__MusicVolume__pf;
				}
			}
		case 11:
			{
				if(::IsValid(b1l__K2Node_DynamicCast_AsSave_Game_BP__pf))
				{
					b1l__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__SFXVolume__pf = bpv__SFXVolume__pf;
				}
			}
		case 12:
			{
...
void UVolume_WB_C__pf3479267681::bpf__ExecuteUbergraph_Volume_WB__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 30);
	// optimized KCST_UnconditionalGoto
	bpv__MusicVolume__pf = b1l__K2Node_ComponentBoundEvent_Value__pf;
	// optimized KCST_UnconditionalGoto
	UFMODBlueprintStatics::BusSetVolume(CastChecked<UFMODBus>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed), bpv__MusicVolume__pf);
	return; //KCST_EndOfThread
}
void UVolume_WB_C__pf3479267681::bpf__ExecuteUbergraph_Volume_WB__pf_4(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 29);
	return; //KCST_EndOfThread
}
void UVolume_WB_C__pf3479267681::bpf__ExecuteUbergraph_Volume_WB__pf_5(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 27);
	// optimized KCST_UnconditionalGoto
	bpv__SFXVolume__pf = b1l__K2Node_ComponentBoundEvent_Value_1__pf;
	// optimized KCST_UnconditionalGoto
	UFMODBlueprintStatics::BusSetVolume(CastChecked<UFMODBus>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), bpv__SFXVolume__pf);
	return; //KCST_EndOfThread
}
void UVolume_WB_C__pf3479267681::bpf__ExecuteUbergraph_Volume_WB__pf_6(int32 bpp__EntryPoint__pf)
{
...
void UVolume_WB_C__pf3479267681::bpf__BndEvt__Volume_WB_Voice_Button_0_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Volume_WB__pf_1(32);
}
void UVolume_WB_C__pf3479267681::bpf__BndEvt__Volume_WB_Slider_SFXVolume_E_K2Node_ComponentBoundEvent_0_OnFloatValueChangedEvent__DelegateSignature__pf(float bpp__Value__pf)
{
	b1l__K2Node_ComponentBoundEvent_Value__pf = bpp__Value__pf;
	bpf__ExecuteUbergraph_Volume_WB__pf_3(30);
}
void UVolume_WB_C__pf3479267681::bpf__SliderEventFocus__pf()
{
	bpf__ExecuteUbergraph_Volume_WB__pf_4(29);
}
void UVolume_WB_C__pf3479267681::bpf__BndEvt__Volume_WB_Slider_K2Node_ComponentBoundEvent_5_OnFloatValueChangedEvent__DelegateSignature__pf(float bpp__Value__pf)
{
	b1l__K2Node_ComponentBoundEvent_Value_1__pf = bpp__Value__pf;
	bpf__ExecuteUbergraph_Volume_WB__pf_5(27);
}
void UVolume_WB_C__pf3479267681::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_Volume_WB__pf_0(16);
}
void UVolume_WB_C__pf3479267681::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_Volume_WB__pf_6(14);
}
void UVolume_WB_C__pf3479267681::bpf__BndEvt__Exit_Button_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Volume_WB__pf_2(7);
}
void UVolume_WB_C__pf3479267681::bpf__SetVisibilityPlayerArea__pf(bool bpp__Visibility__pf)
{
...
FText  UVolume_WB_C__pf3479267681::bpf__GetText_5__pf()
{
		...
		case 2:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__IsVoiceActive__pf) : (__Local__65)))
				{
					__CurrentState = 5;
					break;
				}
...
TEXT("NSLOCTEXT(\"[521AB1F14674BBE36F60F593BA41B1D5]\", \"0FF7576540BB8CBD52300980BF744C1B\", \"VOICE ACTING ON\")")	);
			}
		case 4:
			{
		...
		case 5:
			{
				bpfv__TextVoiceActing__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[521AB1F14674BBE36F60F593BA41B1D5]\", \"DF64131A4C9CABBC9E2061ABD153884F\", \"VOICE ACTING OFF\")")	);
				__CurrentState = 4;
				break;
			}
		default:
...
float  UVolume_WB_C__pf3479267681::bpf__GetValueMusicSlide__pf()
{
	float bpp__ReturnValue__pf{};
	bpp__ReturnValue__pf = bpv__MusicVolume__pf;
	return bpp__ReturnValue__pf;
}
float  UVolume_WB_C__pf3479267681::bpf__GetValueSFXMusic__pf()
{
	float bpp__ReturnValue__pf{};
	bpp__ReturnValue__pf = bpv__SFXVolume__pf;
	return bpp__ReturnValue__pf;
}
UWidget*  UVolume_WB_C__pf3479267681::bpf__MoreVolume_Music__pf(EUINavigation bpp__Navigation__pf)
{
	UWidget* bpp__ReturnValue__pf{};
	float bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf{};
	float bpfv__CallFunc_FClamp_ReturnValue__pf{};
	float  __Local__66 = 0.000000;
	bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(bpv__MusicVolume__pf, ((::IsValid(bpv__Slider_MusicVolume__pf)) ? (bpv__Slider_MusicVolume__pf->StepSize) : (__Local__66)));
	float  __Local__67 = 0.000000;
	float  __Local__68 = 0.000000;
	bpfv__CallFunc_FClamp_ReturnValue__pf = UKismetMathLibrary::FClamp(bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf, ((::IsValid(bpv__Slider_MusicVolume__pf)) ? (bpv__Slider_MusicVolume__pf->MinValue) : (__Local__67)), ((::IsValid(bpv__Slider_MusicVolume__pf)) ? (bpv__Slider_MusicVolume__pf->MaxValue) : (__Local__68)));
	bpv__MusicVolume__pf = bpfv__CallFunc_FClamp_ReturnValue__pf;
	UFMODBlueprintStatics::BusSetVolume(CastChecked<UFMODBus>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed), bpv__MusicVolume__pf);
	bpp__ReturnValue__pf = ((UWidget*)nullptr);
	return bpp__ReturnValue__pf;
}
UWidget*  UVolume_WB_C__pf3479267681::bpf__LessVolume_Music__pf(EUINavigation bpp__Navigation__pf)
{
	UWidget* bpp__ReturnValue__pf{};
	float bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf{};
	float bpfv__CallFunc_FClamp_ReturnValue__pf{};
	float  __Local__69 = 0.000000;
	bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(bpv__MusicVolume__pf, ((::IsValid(bpv__Slider_MusicVolume__pf)) ? (bpv__Slider_MusicVolume__pf->StepSize) : (__Local__69)));
	float  __Local__70 = 0.000000;
	float  __Local__71 = 0.000000;
	bpfv__CallFunc_FClamp_ReturnValue__pf = UKismetMathLibrary::FClamp(bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf, ((::IsValid(bpv__Slider_MusicVolume__pf)) ? (bpv__Slider_MusicVolume__pf->MinValue) : (__Local__70)), ((::IsValid(bpv__Slider_MusicVolume__pf)) ? (bpv__Slider_MusicVolume__pf->MaxValue) : (__Local__71)));
	bpv__MusicVolume__pf = bpfv__CallFunc_FClamp_ReturnValue__pf;
	UFMODBlueprintStatics::BusSetVolume(CastChecked<UFMODBus>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed), bpv__MusicVolume__pf);
	bpp__ReturnValue__pf = ((UWidget*)nullptr);
	return bpp__ReturnValue__pf;
}
UWidget*  UVolume_WB_C__pf3479267681::bpf__LessVolume_SFX__pf(EUINavigation bpp__Navigation__pf)
{
	UWidget* bpp__ReturnValue__pf{};
	float bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf{};
	float bpfv__CallFunc_FClamp_ReturnValue__pf{};
	float  __Local__72 = 0.000000;
	bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(bpv__SFXVolume__pf, ((::IsValid(bpv__Slider_SFXVolume__pf)) ? (bpv__Slider_SFXVolume__pf->StepSize) : (__Local__72)));
	float  __Local__73 = 0.000000;
	float  __Local__74 = 0.000000;
	bpfv__CallFunc_FClamp_ReturnValue__pf = UKismetMathLibrary::FClamp(bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf, ((::IsValid(bpv__Slider_SFXVolume__pf)) ? (bpv__Slider_SFXVolume__pf->MinValue) : (__Local__73)), ((::IsValid(bpv__Slider_SFXVolume__pf)) ? (bpv__Slider_SFXVolume__pf->MaxValue) : (__Local__74)));
	bpv__SFXVolume__pf = bpfv__CallFunc_FClamp_ReturnValue__pf;
	bpp__ReturnValue__pf = ((UWidget*)nullptr);
	return bpp__ReturnValue__pf;
}
UWidget*  UVolume_WB_C__pf3479267681::bpf__MoreVolume_SFX__pf(EUINavigation bpp__Navigation__pf)
{
	UWidget* bpp__ReturnValue__pf{};
	float bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf{};
	float bpfv__CallFunc_FClamp_ReturnValue__pf{};
	float  __Local__75 = 0.000000;
	bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(bpv__SFXVolume__pf, ((::IsValid(bpv__Slider_SFXVolume__pf)) ? (bpv__Slider_SFXVolume__pf->StepSize) : (__Local__75)));
	float  __Local__76 = 0.000000;
	float  __Local__77 = 0.000000;
	bpfv__CallFunc_FClamp_ReturnValue__pf = UKismetMathLibrary::FClamp(bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf, ((::IsValid(bpv__Slider_SFXVolume__pf)) ? (bpv__Slider_SFXVolume__pf->MinValue) : (__Local__76)), ((::IsValid(bpv__Slider_SFXVolume__pf)) ? (bpv__Slider_SFXVolume__pf->MaxValue) : (__Local__77)));
	bpv__SFXVolume__pf = bpfv__CallFunc_FClamp_ReturnValue__pf;
	UFMODBlueprintStatics::BusSetVolume(CastChecked<UFMODBus>(CastChecked<UDynamicClass>(UVolume_WB_C__pf3479267681::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), bpv__SFXVolume__pf);
	bpp__ReturnValue__pf = ((UWidget*)nullptr);
	return bpp__ReturnValue__pf;
}
float  UVolume_WB_C__pf3479267681::bpf__Get_Slider_SFXVolume_E_Value_0__pf()
{
	float bpp__ReturnValue__pf{};
	bpp__ReturnValue__pf = bpv__MusicVolume__pf;
	return bpp__ReturnValue__pf;
}
FText  UVolume_WB_C__pf3479267681::bpf__GetText_Voices__pf()
{
	FText bpp__ReturnValue__pf{};
	FText bpfv__TextVoiceActing__pf{};
	UGameInstance* bpfv__CallFunc_GetGameInstance_ReturnValue__pf{};
	...
	do
	{
		...
		case 2:
			{
				...
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__IsVoiceActive__pf) : (__Local__78)))
				{
					__CurrentState = 5;
					break;
				}
		...
		case 3:
			{
				bpfv__TextVoiceActing__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[521AB1F14674BBE36F60F593BA41B1D5]\", \"E2586BC64FA50353A69CD5B88AD3FB61\", \"VOICE ACTING ON\")")	);
			}
		case 4:
			{
				bpp__ReturnValue__pf = bpfv__TextVoiceActing__pf;
		...
		case 5:
			{
				bpfv__TextVoiceActing__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[521AB1F14674BBE36F60F593BA41B1D5]\", \"3F08142E49A59A80940A248346FA13E9\", \"VOICE ACTING OFF\")")	);
				__CurrentState = 4;
				break;
			}
		default:
...
PRAGMA_DISABLE_OPTIMIZATION
void UVolume_WB_C__pf3479267681::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UVolume_WB_C__pf3479267681::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{584, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.Slider 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UVolume_WB_C__pf3479267681
{
	FRegisterHelper__UVolume_WB_C__pf3479267681()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/ControlsWB/Volume_WB"), &UVolume_WB_C__pf3479267681::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UVolume_WB_C__pf3479267681 Instance;
};
FRegisterHelper__UVolume_WB_C__pf3479267681 FRegisterHelper__UVolume_WB_C__pf3479267681::Instance;
