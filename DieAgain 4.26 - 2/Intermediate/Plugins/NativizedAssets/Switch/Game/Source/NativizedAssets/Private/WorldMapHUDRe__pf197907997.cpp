...
#include "WorldMapHUDRe__pf197907997.h"
...
#include "Widget_KeySwap__pf3975599377.h"
...
UWorldMapHUDRe_C__pf197907997::UWorldMapHUDRe_C__pf197907997(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Gonorth__pf = nullptr;
	bpv__Image_170__pf = nullptr;
	bpv__Image_636__pf = nullptr;
	bpv__Image_LevelFondo__pf = nullptr;
	bpv__Image_NumberLevel__pf = nullptr;
	bpv__PuntuationLevel__pf = nullptr;
	bpv__Return__pf = nullptr;
	bpv__SizeBox_201__pf = nullptr;
	bpv__TextBlock_96__pf = nullptr;
	bpv__TextBlock_204__pf = nullptr;
	bpv__Widget_Information_1__pf = nullptr;
	bpv__Widget_KeySwap__pf = nullptr;
	bpv__Widget_KeySwap_277__pf = nullptr;
	bpv__NameOfTheLevel__pf = E__EnumLevelsNames__pf::NewEnumerator0;
	bpv__StringName__pf = FText::GetEmpty();
	bpv__ScoreLevel__pf = FString(TEXT(""));
	bpv__LevelsScore__pf = TArray<int32> ();
	bpv__LevelsScore__pf.Reserve(15);
	bpv__LevelsScore__pf.Add(0);
	bpv__LevelsScore__pf.Add(0);
	bpv__LevelsScore__pf.Add(0);
	bpv__LevelsScore__pf.Add(0);
	bpv__LevelsScore__pf.Add(0);
...
void UWorldMapHUDRe_C__pf197907997::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UWorldMapHUDRe_C__pf197907997::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(LoadObject<UEnum>(nullptr, TEXT("/Game/Enemies/EnumLevelsNames.EnumLevelsNames")));
	// List of all referenced converted classes
	InDynamicClass->ReferencedConvertedFields.Add(UMyGameInstance_C__pf2410127383::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(APlayerWorldMap_Character_C__pf2222656877::StaticClass());
	...
	InDynamicClass->ReferencedConvertedFields.Add(UWidget_KeySwap_C__pf3975599377::StaticClass());
	...
	auto __Local__1 = NewObject<UWidgetAnimation>(InDynamicClass, UWidgetAnimation::StaticClass(), TEXT("SaveGameAnim_INST"), (EObjectFlags)0x00280008);
	InDynamicClass->MiscConvertedSubobjects.Add(__Local__1);
	auto __Local__2 = NewObject<UWidgetAnimation>(InDynamicClass, UWidgetAnimation::StaticClass(), TEXT("NorthernFrontAnim_INST"), (EObjectFlags)0x00280008);
	InDynamicClass->MiscConvertedSubobjects.Add(__Local__2);
	auto __Local__3 = NewObject<UWidgetAnimation>(InDynamicClass, UWidgetAnimation::StaticClass(), TEXT("ALeftAnim_INST"), (EObjectFlags)0x00280008);
	InDynamicClass->MiscConvertedSubobjects.Add(__Local__3);
	auto __Local__4 = NewObject<UWidgetAnimation>(InDynamicClass, UWidgetAnimation::StaticClass(), TEXT("ARightAnim_INST"), (EObjectFlags)0x00280008);
	...
	__Local__6.Reserve(8);
	auto __Local__7 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_6"), (EObjectFlags)0x00280008);
	__Local__7->LayoutData.Offsets.Left = -479.483429f;
	__Local__7->LayoutData.Offsets.Top = -404.540527f;
	__Local__7->LayoutData.Offsets.Right = 314.837067f;
	__Local__7->LayoutData.Offsets.Bottom = 59.807587f;
	__Local__7->LayoutData.Anchors.Minimum = FVector2D(1.000000, 0.500000);
	__Local__7->LayoutData.Anchors.Maximum = FVector2D(1.000000, 0.500000);
	__Local__7->Parent = __Local__5;
	auto __Local__8 = NewObject<UTextBlock>(__Local__0, TEXT("PuntuationLevel"), (EObjectFlags)0x00280008);
	__Local__8->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"05D9CBFD44FBD5202B7A9BA7D7C5C554\", \"Score\")")	);
	__Local__8->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__8->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__8->Font.Size = 35;
	auto& __Local__9 = (*(AccessPrivateProperty<TEnumAsByte<ETextJustify::Type> >((__Local__8), UTextLayoutWidget::__PPO__Justification() )));
	__Local__9 = ETextJustify::Type::Right;
	__Local__8->Slot = __Local__7;
	__Local__7->Content = __Local__8;
	__Local__6.Add(__Local__7);
	auto __Local__10 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_2"), (EObjectFlags)0x00280008);
	__Local__10->LayoutData.Offsets.Left = 152.000000f;
	__Local__10->LayoutData.Offsets.Top = 132.000000f;
	__Local__10->LayoutData.Offsets.Right = 282.023315f;
	__Local__10->LayoutData.Offsets.Bottom = 30.730896f;
	__Local__10->Parent = __Local__5;
	auto __Local__11 = NewObject<UTextBlock>(__Local__0, TEXT("Text_SavingGame"), (EObjectFlags)0x00280008);
	__Local__11->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"E0CFC95640B95B0530BA65B6873DAC4B\", \"Saving game\")")	);
	__Local__11->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__11->RenderOpacity = 0.000000f;
	__Local__10->Content = __Local__11;
	__Local__6.Add(__Local__10);
	auto __Local__12 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_42"), (EObjectFlags)0x00280008);
	__Local__12->LayoutData.Offsets.Left = 50.000000f;
	__Local__12->LayoutData.Offsets.Top = 50.000000f;
	__Local__12->LayoutData.Offsets.Right = 510.000000f;
	__Local__12->LayoutData.Offsets.Bottom = 80.000000f;
	__Local__12->Parent = __Local__5;
	auto __Local__13 = NewObject<UCanvasPanel>(__Local__0, TEXT("CanvasPanel_1247"), (EObjectFlags)0x00280008);
	...
	__Local__15->LayoutData.Offsets.Right = 510.000000f;
	...
	__Local__15->LayoutData.Alignment = FVector2D(0.000000, 0.500000);
	__Local__15->Parent = __Local__13;
	auto __Local__16 = NewObject<UImage>(__Local__0, TEXT("Image_LevelFondo"), (EObjectFlags)0x00280008);
	__Local__16->Brush.ImageSize = FVector2D(478.000000, 97.000000);
	auto& __Local__17 = (*(AccessPrivateProperty<UObject* >(&(__Local__16->Brush), FSlateBrush::__PPO__ResourceObject() )));
	__Local__17 = CastChecked<UObject>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__16->Slot = __Local__15;
	__Local__15->Content = __Local__16;
	__Local__14.Add(__Local__15);
	auto __Local__18 = NewObject<UCanvasPanelSlot>(__Local__13, TEXT("CanvasPanelSlot_0"), (EObjectFlags)0x00280008);
	__Local__18->LayoutData.Offsets.Right = 510.000000f;
	__Local__18->LayoutData.Offsets.Bottom = 80.000000f;
	__Local__18->Parent = __Local__13;
	auto __Local__19 = NewObject<UHorizontalBox>(__Local__0, TEXT("Title"), (EObjectFlags)0x00280008);
	...
	auto __Local__21 = NewObject<UHorizontalBoxSlot>(__Local__19, TEXT("HorizontalBoxSlot_11"), (EObjectFlags)0x00280008);
	__Local__21->Parent = __Local__19;
	auto __Local__22 = NewObject<UCanvasPanel>(__Local__0, TEXT("CanvasPanel_803"), (EObjectFlags)0x00280008);
	...
	auto __Local__24 = NewObject<UCanvasPanelSlot>(__Local__22, TEXT("CanvasPanelSlot_0"), (EObjectFlags)0x00280008);
	__Local__24->LayoutData.Offsets.Right = 80.000000f;
	__Local__24->LayoutData.Offsets.Bottom = 80.000000f;
	__Local__24->Parent = __Local__22;
	auto __Local__25 = NewObject<UImage>(__Local__0, TEXT("Image_NumberLevel"), (EObjectFlags)0x00280008);
	__Local__25->Brush.ImageSize = FVector2D(91.000000, 91.000000);
	auto& __Local__26 = (*(AccessPrivateProperty<UObject* >(&(__Local__25->Brush), FSlateBrush::__PPO__ResourceObject() )));
	__Local__26 = CastChecked<UObject>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__25->Slot = __Local__24;
	__Local__24->Content = __Local__25;
	__Local__23.Add(__Local__24);
	auto __Local__27 = NewObject<UCanvasPanelSlot>(__Local__22, TEXT("CanvasPanelSlot_1"), (EObjectFlags)0x00280008);
	__Local__27->LayoutData.Offsets.Top = -5.000000f;
	__Local__27->LayoutData.Offsets.Right = 120.000000f;
	__Local__27->LayoutData.Offsets.Bottom = 120.000000f;
	...
	__Local__27->LayoutData.Alignment = FVector2D(0.500000, 0.500000);
	__Local__27->bAutoSize = true;
	__Local__27->Parent = __Local__22;
	auto __Local__28 = NewObject<UTextBlock>(__Local__0, TEXT("TextBlock_204"), (EObjectFlags)0x00280008);
	__Local__28->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"A2B72CD4427EEA5F717275B996F114CE\", \"0\")")	);
	__Local__28->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__28->Font.OutlineSettings.OutlineSize = 5;
	__Local__28->Font.OutlineSettings.bApplyOutlineToDropShadows = true;
	__Local__28->Font.TypefaceFontName = FName(TEXT("Regular"));
	...
	auto __Local__29 = NewObject<UHorizontalBoxSlot>(__Local__19, TEXT("HorizontalBoxSlot_12"), (EObjectFlags)0x00280008);
	__Local__29->Padding.Left = 10.000000f;
	__Local__29->Padding.Top = 10.000000f;
	__Local__29->Padding.Right = 10.000000f;
	__Local__29->Padding.Bottom = 10.000000f;
	__Local__29->Parent = __Local__19;
	auto __Local__30 = NewObject<USpacer>(__Local__0, TEXT("Spacer_362"), (EObjectFlags)0x00280008);
	__Local__30->Slot = __Local__29;
	__Local__29->Content = __Local__30;
	__Local__20.Add(__Local__29);
	auto __Local__31 = NewObject<UHorizontalBoxSlot>(__Local__19, TEXT("HorizontalBoxSlot_13"), (EObjectFlags)0x00280008);
	__Local__31->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__31->Parent = __Local__19;
	auto __Local__32 = NewObject<UCanvasPanel>(__Local__0, TEXT("CanvasPanel_1103"), (EObjectFlags)0x00280008);
	...
	auto __Local__34 = NewObject<UCanvasPanelSlot>(__Local__32, TEXT("CanvasPanelSlot_0"), (EObjectFlags)0x00280008);
	__Local__34->LayoutData.Offsets.Right = 274.174194f;
	__Local__34->LayoutData.Offsets.Bottom = 60.030029f;
	__Local__34->LayoutData.Anchors.Minimum = FVector2D(0.000000, 0.500000);
	__Local__34->LayoutData.Anchors.Maximum = FVector2D(0.000000, 0.500000);
	__Local__34->LayoutData.Alignment = FVector2D(0.000000, 0.500000);
	__Local__34->bAutoSize = true;
	__Local__34->Parent = __Local__32;
	auto __Local__35 = NewObject<UTextBlock>(__Local__0, TEXT("TextBlock_96"), (EObjectFlags)0x00280008);
	__Local__35->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"C0A17F1348AA658CFCE4359D6EDB1EF0\", \"Level Name\")")	);
	__Local__35->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__35->Font.OutlineSettings.OutlineSize = 3;
	__Local__35->Font.OutlineSettings.bApplyOutlineToDropShadows = true;
	__Local__35->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__35->Font.Size = 30;
	...
	__Local__6.Add(__Local__12);
	auto __Local__37 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_26"), (EObjectFlags)0x00280008);
	__Local__37->LayoutData.Offsets.Left = 50.000000f;
	__Local__37->LayoutData.Offsets.Top = -50.000000f;
	__Local__37->LayoutData.Offsets.Right = 50.000000f;
	__Local__37->LayoutData.Offsets.Bottom = 50.000000f;
	__Local__37->LayoutData.Anchors.Minimum = FVector2D(0.000000, 1.000000);
	__Local__37->LayoutData.Anchors.Maximum = FVector2D(1.000000, 1.000000);
	__Local__37->LayoutData.Alignment = FVector2D(0.000000, 1.000000);
	__Local__37->Parent = __Local__5;
	auto __Local__38 = NewObject<UHorizontalBox>(__Local__0, TEXT("HorizontalBox_931"), (EObjectFlags)0x00280008);
	...
	auto __Local__40 = NewObject<UHorizontalBoxSlot>(__Local__38, TEXT("HorizontalBoxSlot_13"), (EObjectFlags)0x00280008);
	__Local__40->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__40->Parent = __Local__38;
	auto __Local__41 = NewObject<USpacer>(__Local__0, TEXT("Spacer_2092"), (EObjectFlags)0x00280008);
	__Local__41->Slot = __Local__40;
	__Local__40->Content = __Local__41;
	__Local__39.Add(__Local__40);
	auto __Local__42 = NewObject<UHorizontalBoxSlot>(__Local__38, TEXT("HorizontalBoxSlot_6"), (EObjectFlags)0x00280008);
	__Local__42->Parent = __Local__38;
	auto __Local__43 = NewObject<USizeBox>(__Local__0, TEXT("SizeBox_201"), (EObjectFlags)0x00280008);
	__Local__43->WidthOverride = 640.462402f;
	...
	auto __Local__45 = NewObject<USizeBoxSlot>(__Local__43, TEXT("SizeBoxSlot_1"), (EObjectFlags)0x00280008);
	__Local__45->Parent = __Local__43;
	auto __Local__46 = NewObject<UCanvasPanel>(__Local__0, TEXT("CanvasPanel_229"), (EObjectFlags)0x00280008);
	...
	__Local__47.Reserve(2);
	auto __Local__48 = NewObject<UCanvasPanelSlot>(__Local__46, TEXT("CanvasPanelSlot_0"), (EObjectFlags)0x00280008);
	__Local__48->LayoutData.Offsets.Right = 600.000000f;
	__Local__48->LayoutData.Offsets.Bottom = 50.000000f;
	__Local__48->Parent = __Local__46;
	auto __Local__49 = NewObject<UWidget_Information_C__pf3975599377>(__Local__0, TEXT("Gonorth"), (EObjectFlags)0x00280008);
	__Local__49->bpv__KeyToShow__pf = E__Enum_Keys__pf::NewEnumerator2;
	__Local__49->bpv__InputToShow__pf = E__Enum_Gamepad__pf::NewEnumerator9;
	__Local__49->bpv__Text__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"4844FF964BE1D24D4D6FB2971708FD86\", \"northern front\")")	);
	__Local__49->Slot = __Local__48;
	__Local__48->Content = __Local__49;
	__Local__47.Add(__Local__48);
	auto __Local__50 = NewObject<UCanvasPanelSlot>(__Local__46, TEXT("CanvasPanelSlot_1"), (EObjectFlags)0x00280008);
	__Local__50->LayoutData.Offsets.Right = 600.000000f;
	__Local__50->LayoutData.Offsets.Bottom = 50.000000f;
	__Local__50->Parent = __Local__46;
	auto __Local__51 = NewObject<UWidget_Information_C__pf3975599377>(__Local__0, TEXT("Return"), (EObjectFlags)0x00280008);
	__Local__51->bpv__InputToShow__pf = E__Enum_Gamepad__pf::NewEnumerator8;
	__Local__51->bpv__Text__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"C7D8AFD34E30771B27A163BEC5D270C4\", \"return\")")	);
	...
	__Local__43->Visibility = ESlateVisibility::HitTestInvisible;
	__Local__42->Content = __Local__43;
	__Local__39.Add(__Local__42);
	auto __Local__52 = NewObject<UHorizontalBoxSlot>(__Local__38, TEXT("HorizontalBoxSlot_10"), (EObjectFlags)0x00280008);
	__Local__52->Parent = __Local__38;
	auto __Local__53 = NewObject<USizeBox>(__Local__0, TEXT("SizeBox"), (EObjectFlags)0x00280008);
	...
	auto __Local__55 = NewObject<USizeBoxSlot>(__Local__53, TEXT("SizeBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__55->Parent = __Local__53;
	auto __Local__56 = NewObject<UWidget_Information_C__pf3975599377>(__Local__0, TEXT("Widget_Information_1"), (EObjectFlags)0x00280008);
	__Local__56->bpv__KeyToShow__pf = E__Enum_Keys__pf::NewEnumerator6;
	__Local__56->bpv__Text__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"D6B923884A411DCF93786C98B95C947D\", \"play level\")")	);
	...
	__Local__39.Add(__Local__52);
	__Local__38->Slot = __Local__37;
	__Local__37->Content = __Local__38;
	__Local__6.Add(__Local__37);
	auto __Local__57 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_18"), (EObjectFlags)0x00280008);
	__Local__57->LayoutData.Offsets.Left = -400.000000f;
	__Local__57->LayoutData.Offsets.Bottom = 150.000000f;
	...
	__Local__57->Parent = __Local__5;
	auto __Local__58 = NewObject<UScaleBox>(__Local__0, TEXT("LeftScaleBox"), (EObjectFlags)0x00280008);
	...
	auto __Local__60 = NewObject<UScaleBoxSlot>(__Local__58, TEXT("ScaleBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__60->Parent = __Local__58;
	auto __Local__61 = NewObject<UImage>(__Local__0, TEXT("Image_170"), (EObjectFlags)0x00280008);
	__Local__61->Brush.ImageSize = FVector2D(419.000000, 608.000000);
	auto& __Local__62 = (*(AccessPrivateProperty<UObject* >(&(__Local__61->Brush), FSlateBrush::__PPO__ResourceObject() )));
	__Local__62 = CastChecked<UObject>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	...
	__Local__6.Add(__Local__57);
	auto __Local__63 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_17"), (EObjectFlags)0x00280008);
	__Local__63->LayoutData.Offsets.Left = 400.000000f;
	...
	__Local__63->LayoutData.Alignment = FVector2D(0.500000, 0.500000);
	__Local__63->Parent = __Local__5;
	auto __Local__64 = NewObject<UScaleBox>(__Local__0, TEXT("RightScaleBox"), (EObjectFlags)0x00280008);
	...
	auto __Local__66 = NewObject<UScaleBoxSlot>(__Local__64, TEXT("ScaleBoxSlot_1"), (EObjectFlags)0x00280008);
	__Local__66->Parent = __Local__64;
	auto __Local__67 = NewObject<UImage>(__Local__0, TEXT("Image_636"), (EObjectFlags)0x00280008);
	__Local__67->Brush.ImageSize = FVector2D(419.000000, 608.000000);
	auto& __Local__68 = (*(AccessPrivateProperty<UObject* >(&(__Local__67->Brush), FSlateBrush::__PPO__ResourceObject() )));
	__Local__68 = CastChecked<UObject>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	__Local__67->Slot = __Local__66;
	__Local__67->RenderTransform.Angle = 180.000000f;
	__Local__66->Content = __Local__67;
	__Local__65.Add(__Local__66);
	__Local__64->Slot = __Local__63;
	__Local__63->Content = __Local__64;
	__Local__6.Add(__Local__63);
	auto __Local__69 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_5"), (EObjectFlags)0x00280008);
	__Local__69->LayoutData.Offsets.Left = -300.000000f;
	__Local__69->LayoutData.Offsets.Right = 70.000000f;
	__Local__69->LayoutData.Offsets.Bottom = 70.000000f;
	__Local__69->LayoutData.Anchors.Minimum = FVector2D(0.500000, 0.500000);
	__Local__69->LayoutData.Anchors.Maximum = FVector2D(0.500000, 0.500000);
	__Local__69->LayoutData.Alignment = FVector2D(0.500000, 0.500000);
	__Local__69->Parent = __Local__5;
	auto __Local__70 = NewObject<UScaleBox>(__Local__0, TEXT("ScaleBox_395"), (EObjectFlags)0x00280008);
	...
	auto __Local__72 = NewObject<UScaleBoxSlot>(__Local__70, TEXT("ScaleBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__72->Parent = __Local__70;
	auto __Local__73 = NewObject<UWidget_KeySwap_C__pf3975599377>(__Local__0, TEXT("Widget_KeySwap"), (EObjectFlags)0x00280008);
	__Local__73->bpv__KeyToShow__pf = E__Enum_Keys__pf::NewEnumerator1;
	__Local__73->bpv__InputToShow__pf = E__Enum_Gamepad__pf::NewEnumerator12;
	...
	__Local__6.Add(__Local__69);
	auto __Local__74 = NewObject<UCanvasPanelSlot>(__Local__5, TEXT("CanvasPanelSlot_7"), (EObjectFlags)0x00280008);
	__Local__74->LayoutData.Offsets.Left = 300.000000f;
	__Local__74->LayoutData.Offsets.Right = 70.000000f;
	__Local__74->LayoutData.Offsets.Bottom = 70.000000f;
	__Local__74->LayoutData.Anchors.Minimum = FVector2D(0.500000, 0.500000);
	__Local__74->LayoutData.Anchors.Maximum = FVector2D(0.500000, 0.500000);
	__Local__74->LayoutData.Alignment = FVector2D(0.500000, 0.500000);
	__Local__74->Parent = __Local__5;
	auto __Local__75 = NewObject<UScaleBox>(__Local__0, TEXT("ScaleBox_534"), (EObjectFlags)0x00280008);
	...
	auto __Local__77 = NewObject<UScaleBoxSlot>(__Local__75, TEXT("ScaleBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__77->Parent = __Local__75;
	auto __Local__78 = NewObject<UWidget_KeySwap_C__pf3975599377>(__Local__0, TEXT("Widget_KeySwap_277"), (EObjectFlags)0x00280008);
	__Local__78->bpv__KeyToShow__pf = E__Enum_Keys__pf::NewEnumerator3;
	__Local__78->bpv__InputToShow__pf = E__Enum_Gamepad__pf::NewEnumerator13;
	...
	auto __Local__79 = NewObject<UMovieScene>(__Local__1, TEXT("SaveGameAnim"), (EObjectFlags)0x00280008);
	...
	__Local__87 = FGuid(0x64416728, 0x4464881C, 0xCE54D7B3, 0xB63EEEE9);
	auto& __Local__88 = (*(AccessPrivateProperty<FString >(&(__Local__86), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__88 = FString(TEXT("TextBlock_103"));
	...
	auto __Local__90 = NewObject<UMovieSceneFloatTrack>(__Local__79, TEXT("MovieSceneFloatTrack_0"), (EObjectFlags)0x00280008);
	...
	__Local__91.PropertyName = FName(TEXT("RenderOpacity"));
	__Local__91.PropertyPath = FName(TEXT("RenderOpacity"));
	...
	auto __Local__93 = NewObject<UMovieSceneFloatSection>(__Local__90, TEXT("MovieSceneFloatSection_0"), (EObjectFlags)0x00280008);
	...
	auto& __Local__96 = (*(AccessPrivateProperty<FMovieSceneFloatChannel >((__Local__93), UMovieSceneFloatSection::__PPO__FloatCurve() )));
	auto& __Local__97 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__96), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__97 = TArray<FFrameNumber> ();
	__Local__97.Reserve(4);
	__Local__97.Add(FFrameNumber{});
	__Local__97.Add(FFrameNumber{});
	__Local__97[1].Value = 60000;
	__Local__97.Add(FFrameNumber{});
	__Local__97[2].Value = 120000;
	__Local__97.Add(FFrameNumber{});
	__Local__97[3].Value = 180000;
	auto& __Local__98 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__96), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__98 = TArray<FMovieSceneFloatValue> ();
	__Local__98.AddUninitialized(4);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__98.GetData(), 4);
	auto& __Local__99 = __Local__98[0];
	auto& __Local__100 = __Local__98[1];
	__Local__100.Value = 1.000000f;
	auto& __Local__101 = __Local__98[2];
	__Local__101.Value = 1.000000f;
	auto& __Local__102 = __Local__98[3];
	__Local__93->Easing.EaseIn = __Local__94;
	__Local__93->Easing.EaseOut = __Local__95;
	__Local__93->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(180000)));
	auto& __Local__103 = (*(AccessPrivateProperty<FGuid >((__Local__93), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__103 = FGuid(0xD5EBB91A, 0x412BB77B, 0xAB5A9B94, 0x39E412B9);
	__Local__92.Add(__Local__93);
	auto& __Local__104 = (*(AccessPrivateProperty<FGuid >((__Local__90), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__104 = FGuid(0xDCE3FD14, 0x40B7B0D3, 0x0808DF9E, 0xD0341AA4);
	auto& __Local__105 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__90), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__105.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__105.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__105.Entries.GetData(), 1);
	auto& __Local__106 = __Local__105.Entries[0];
	__Local__106.Section = __Local__93;
	static TWeakFieldPtr<FProperty> __Local__108{};
	const FProperty* __Local__107 = __Local__108.Get();
	if (nullptr == __Local__107)
	{
		__Local__107 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("LowerBound")));
		check(__Local__107);
		__Local__108 = __Local__107;
	}
	auto& __Local__109 = (*(__Local__107->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__106.Range), 0)));
	static TWeakFieldPtr<FProperty> __Local__111{};
	const FProperty* __Local__110 = __Local__111.Get();
	if (nullptr == __Local__110)
	{
		__Local__110 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Type")));
		check(__Local__110);
		__Local__111 = __Local__110;
	}
	auto& __Local__112 = (*(__Local__110->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__109), 0)));
	__Local__112 = ERangeBoundTypes::Type::Inclusive;
	static TWeakFieldPtr<FProperty> __Local__114{};
	const FProperty* __Local__113 = __Local__114.Get();
	if (nullptr == __Local__113)
	{
		__Local__113 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("UpperBound")));
		check(__Local__113);
		__Local__114 = __Local__113;
	}
	auto& __Local__115 = (*(__Local__113->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__106.Range), 0)));
	auto& __Local__116 = (*(__Local__110->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__115), 0)));
	__Local__116 = ERangeBoundTypes::Type::Inclusive;
	static TWeakFieldPtr<FProperty> __Local__118{};
	const FProperty* __Local__117 = __Local__118.Get();
	if (nullptr == __Local__117)
	{
		__Local__117 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Value")));
		check(__Local__117);
		__Local__118 = __Local__117;
	}
	auto& __Local__119 = (*(__Local__117->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__115), 0)));
	__Local__119.Value = 180000;
	__Local__106.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__120 = (*(AccessPrivateProperty<FGuid >((__Local__90), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__120 = FGuid(0xDCE3FD14, 0x40B7B0D3, 0x0808DF9E, 0xD0341AA4);
	__Local__89.Add(__Local__90);
	auto& __Local__121 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__79), UMovieScene::__PPO__PlaybackRange() )));
	__Local__121 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(180001)));
	auto& __Local__122 = (*(AccessPrivateProperty<FFrameRate >((__Local__79), UMovieScene::__PPO__DisplayRate() )));
	static TWeakFieldPtr<FProperty> __Local__124{};
	const FProperty* __Local__123 = __Local__124.Get();
	if (nullptr == __Local__123)
	{
		__Local__123 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameRate"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Numerator")));
		check(__Local__123);
		__Local__124 = __Local__123;
	}
	auto& __Local__125 = (*(__Local__123->ContainerPtrToValuePtr<int32 >(&(__Local__122), 0)));
	__Local__125 = 20;
	auto& __Local__126 = (*(AccessPrivateProperty<FGuid >((__Local__79), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__126 = FGuid(0xEEA48F2F, 0x48D14A2F, 0x07C4E285, 0x4DDA1256);
	__Local__1->MovieScene = __Local__79;
	...
	auto& __Local__127 = __Local__1->AnimationBindings[0];
	__Local__127.WidgetName = FName(TEXT("Text_SavingGame"));
	__Local__127.AnimationGuid = FGuid(0x64416728, 0x4464881C, 0xCE54D7B3, 0xB63EEEE9);
	auto& __Local__128 = (*(AccessPrivateProperty<FString >((__Local__1), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__128 = FString(TEXT("SaveGameAnim"));
	__Local__1->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__129 = (*(AccessPrivateProperty<FGuid >((__Local__1), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__129 = FGuid(0x6D48F8F5, 0x43D36DA2, 0xF22EAA81, 0xED9CFCC3);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__1);
	auto __Local__130 = NewObject<UMovieScene>(__Local__2, TEXT("NorthernFrontAnim"), (EObjectFlags)0x00280008);
	auto& __Local__131 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__130), UMovieScene::__PPO__Possessables() )));
	__Local__131 = TArray<FMovieScenePossessable> ();
	__Local__131.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__131.GetData(), 1);
	auto& __Local__132 = __Local__131[0];
	auto& __Local__133 = (*(AccessPrivateProperty<FGuid >(&(__Local__132), FMovieScenePossessable::__PPO__Guid() )));
	__Local__133 = FGuid(0xB87C4015, 0x4B89106E, 0xB806FEA6, 0xC1D03D2E);
	auto& __Local__134 = (*(AccessPrivateProperty<FString >(&(__Local__132), FMovieScenePossessable::__PPO__Name() )));
	__Local__134 = FString(TEXT("TextBlock_34"));
	auto& __Local__135 = (*(AccessPrivateProperty<UClass* >(&(__Local__132), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__135 = UTextBlock::StaticClass();
	auto& __Local__136 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__130), UMovieScene::__PPO__ObjectBindings() )));
	__Local__136 = TArray<FMovieSceneBinding> ();
	__Local__136.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__136.GetData(), 1);
	auto& __Local__137 = __Local__136[0];
	auto& __Local__138 = (*(AccessPrivateProperty<FGuid >(&(__Local__137), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__138 = FGuid(0xB87C4015, 0x4B89106E, 0xB806FEA6, 0xC1D03D2E);
	auto& __Local__139 = (*(AccessPrivateProperty<FString >(&(__Local__137), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__139 = FString(TEXT("TextBlock_34"));
	auto& __Local__140 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__137), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__140 = TArray<UMovieSceneTrack*> ();
	__Local__140.Reserve(1);
	auto __Local__141 = NewObject<UMovieScene2DTransformTrack>(__Local__130, TEXT("MovieScene2DTransformTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__142 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__141), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__142.PropertyName = FName(TEXT("RenderTransform"));
	__Local__142.PropertyPath = FName(TEXT("RenderTransform"));
	__Local__142.bCanUseClassLookup = true;
	auto& __Local__143 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__141), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__143 = TArray<UMovieSceneSection*> ();
	__Local__143.Reserve(1);
	auto __Local__144 = NewObject<UMovieScene2DTransformSection>(__Local__141, TEXT("MovieScene2DTransformSection_0"), (EObjectFlags)0x00280008);
	auto __Local__145 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__144->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__146 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__144->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__145)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__147 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__144->Scale[0]), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__147 = TArray<FFrameNumber> ();
	__Local__147.Reserve(3);
	__Local__147.Add(FFrameNumber{});
	__Local__147.Add(FFrameNumber{});
	__Local__147[1].Value = 90000;
	__Local__147.Add(FFrameNumber{});
	__Local__147[2].Value = 180000;
	auto& __Local__148 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__144->Scale[0]), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__148 = TArray<FMovieSceneFloatValue> ();
	__Local__148.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__148.GetData(), 3);
	auto& __Local__149 = __Local__148[0];
	__Local__149.Value = 1.000000f;
	auto& __Local__150 = __Local__148[1];
	__Local__150.Value = 1.150000f;
	auto& __Local__151 = __Local__148[2];
	__Local__151.Value = 1.000000f;
	auto& __Local__152 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__144->Scale[1]), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__152 = TArray<FFrameNumber> ();
	__Local__152.Reserve(3);
	__Local__152.Add(FFrameNumber{});
	__Local__152.Add(FFrameNumber{});
	__Local__152[1].Value = 90000;
	__Local__152.Add(FFrameNumber{});
	__Local__152[2].Value = 180000;
	auto& __Local__153 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__144->Scale[1]), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__153 = TArray<FMovieSceneFloatValue> ();
	__Local__153.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__153.GetData(), 3);
	auto& __Local__154 = __Local__153[0];
	__Local__154.Value = 1.000000f;
	auto& __Local__155 = __Local__153[1];
	__Local__155.Value = 1.150000f;
	auto& __Local__156 = __Local__153[2];
	__Local__156.Value = 1.000000f;
	__Local__144->Easing.EaseIn = __Local__145;
	__Local__144->Easing.EaseOut = __Local__146;
	__Local__144->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(180000)));
	auto& __Local__157 = (*(AccessPrivateProperty<FGuid >((__Local__144), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__157 = FGuid(0xA3EAE546, 0x4832A911, 0x5F5118A7, 0x8B605870);
	__Local__143.Add(__Local__144);
	auto& __Local__158 = (*(AccessPrivateProperty<FGuid >((__Local__141), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__158 = FGuid(0xEC0ECD82, 0x461788F1, 0x5DAB6AA8, 0xA88B640C);
	auto& __Local__159 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__141), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__159.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__159.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__159.Entries.GetData(), 1);
	auto& __Local__160 = __Local__159.Entries[0];
	__Local__160.Section = __Local__144;
	auto& __Local__161 = (*(__Local__107->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__160.Range), 0)));
	auto& __Local__162 = (*(__Local__110->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__161), 0)));
	__Local__162 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__163 = (*(__Local__113->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__160.Range), 0)));
	auto& __Local__164 = (*(__Local__110->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__163), 0)));
	__Local__164 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__165 = (*(__Local__117->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__163), 0)));
	__Local__165.Value = 180000;
	__Local__160.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__166 = (*(AccessPrivateProperty<FGuid >((__Local__141), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__166 = FGuid(0xEC0ECD82, 0x461788F1, 0x5DAB6AA8, 0xA88B640C);
	__Local__140.Add(__Local__141);
	auto& __Local__167 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__130), UMovieScene::__PPO__PlaybackRange() )));
	__Local__167 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(180001)));
	auto& __Local__168 = (*(AccessPrivateProperty<FFrameRate >((__Local__130), UMovieScene::__PPO__DisplayRate() )));
	auto& __Local__169 = (*(__Local__123->ContainerPtrToValuePtr<int32 >(&(__Local__168), 0)));
	__Local__169 = 20;
	auto& __Local__170 = (*(AccessPrivateProperty<FGuid >((__Local__130), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__170 = FGuid(0x287C8A5D, 0x417C9993, 0xB04A26B6, 0x6A9B2DFB);
	__Local__2->MovieScene = __Local__130;
	...
	auto& __Local__171 = __Local__2->AnimationBindings[0];
	__Local__171.WidgetName = FName(TEXT("TextBlock_34"));
	__Local__171.AnimationGuid = FGuid(0xB87C4015, 0x4B89106E, 0xB806FEA6, 0xC1D03D2E);
	auto& __Local__172 = (*(AccessPrivateProperty<FString >((__Local__2), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__172 = FString(TEXT("NorthernFrontAnim"));
	__Local__2->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__173 = (*(AccessPrivateProperty<FGuid >((__Local__2), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__173 = FGuid(0x30FC7D18, 0x44B4D149, 0xC2728188, 0x0777FDC2);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__2);
	auto __Local__174 = NewObject<UMovieScene>(__Local__3, TEXT("ALeftAnim"), (EObjectFlags)0x00280008);
	auto& __Local__175 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__174), UMovieScene::__PPO__Possessables() )));
	__Local__175 = TArray<FMovieScenePossessable> ();
	__Local__175.AddUninitialized(2);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__175.GetData(), 2);
	auto& __Local__176 = __Local__175[0];
	auto& __Local__177 = (*(AccessPrivateProperty<FGuid >(&(__Local__176), FMovieScenePossessable::__PPO__Guid() )));
	__Local__177 = FGuid(0xF300A5DE, 0x429548C9, 0x1167CA9A, 0x59D5AEDF);
	auto& __Local__178 = (*(AccessPrivateProperty<FString >(&(__Local__176), FMovieScenePossessable::__PPO__Name() )));
	__Local__178 = FString(TEXT("LeftScaleBox"));
	auto& __Local__179 = (*(AccessPrivateProperty<UClass* >(&(__Local__176), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__179 = UScaleBox::StaticClass();
	auto& __Local__180 = __Local__175[1];
	auto& __Local__181 = (*(AccessPrivateProperty<FGuid >(&(__Local__180), FMovieScenePossessable::__PPO__Guid() )));
	__Local__181 = FGuid(0xEBD72EEF, 0x4301BAB6, 0x879048AB, 0x5EC6C022);
	auto& __Local__182 = (*(AccessPrivateProperty<FString >(&(__Local__180), FMovieScenePossessable::__PPO__Name() )));
	__Local__182 = FString(TEXT("CanvasPanelSlot_18"));
	auto& __Local__183 = (*(AccessPrivateProperty<UClass* >(&(__Local__180), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__183 = UCanvasPanelSlot::StaticClass();
	auto& __Local__184 = (*(AccessPrivateProperty<FGuid >(&(__Local__180), FMovieScenePossessable::__PPO__ParentGuid() )));
	__Local__184 = FGuid(0xF300A5DE, 0x429548C9, 0x1167CA9A, 0x59D5AEDF);
	auto& __Local__185 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__174), UMovieScene::__PPO__ObjectBindings() )));
	__Local__185 = TArray<FMovieSceneBinding> ();
	__Local__185.AddUninitialized(2);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__185.GetData(), 2);
	auto& __Local__186 = __Local__185[0];
	auto& __Local__187 = (*(AccessPrivateProperty<FGuid >(&(__Local__186), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__187 = FGuid(0xF300A5DE, 0x429548C9, 0x1167CA9A, 0x59D5AEDF);
	auto& __Local__188 = (*(AccessPrivateProperty<FString >(&(__Local__186), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__188 = FString(TEXT("LeftScaleBox"));
	auto& __Local__189 = __Local__185[1];
	auto& __Local__190 = (*(AccessPrivateProperty<FGuid >(&(__Local__189), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__190 = FGuid(0xEBD72EEF, 0x4301BAB6, 0x879048AB, 0x5EC6C022);
	auto& __Local__191 = (*(AccessPrivateProperty<FString >(&(__Local__189), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__191 = FString(TEXT("CanvasPanelSlot_18"));
	auto& __Local__192 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__189), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__192 = TArray<UMovieSceneTrack*> ();
	__Local__192.Reserve(1);
	auto __Local__193 = NewObject<UMovieSceneMarginTrack>(__Local__174, TEXT("MovieSceneMarginTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__194 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__193), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__194.PropertyName = FName(TEXT("Offsets"));
	__Local__194.PropertyPath = FName(TEXT("LayoutData.Offsets"));
	auto& __Local__195 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__193), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__195 = TArray<UMovieSceneSection*> ();
	__Local__195.Reserve(1);
	auto __Local__196 = NewObject<UMovieSceneMarginSection>(__Local__193, TEXT("MovieSceneMarginSection_0"), (EObjectFlags)0x00280008);
	auto __Local__197 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__196->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__198 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__196->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__197)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__199 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__196->LeftCurve), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__199 = TArray<FFrameNumber> ();
	__Local__199.Reserve(3);
	__Local__199.Add(FFrameNumber{});
	__Local__199.Add(FFrameNumber{});
	__Local__199[1].Value = 60000;
	__Local__199.Add(FFrameNumber{});
	__Local__199[2].Value = 120000;
	auto& __Local__200 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__196->LeftCurve), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__200 = TArray<FMovieSceneFloatValue> ();
	__Local__200.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__200.GetData(), 3);
	auto& __Local__201 = __Local__200[0];
	__Local__201.Value = -400.000000f;
	auto& __Local__202 = __Local__200[1];
	__Local__202.Value = -450.000000f;
	auto& __Local__203 = __Local__200[2];
	__Local__203.Value = -400.000000f;
	auto& __Local__204 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__196->RightCurve), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__204 = TArray<FFrameNumber> ();
	__Local__204.Reserve(3);
	__Local__204.Add(FFrameNumber{});
	__Local__204.Add(FFrameNumber{});
	__Local__204[1].Value = 60000;
	__Local__204.Add(FFrameNumber{});
	__Local__204[2].Value = 120000;
	auto& __Local__205 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__196->RightCurve), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__205 = TArray<FMovieSceneFloatValue> ();
	__Local__205.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__205.GetData(), 3);
	auto& __Local__206 = __Local__205[0];
	__Local__206.Value = 100.000000f;
	auto& __Local__207 = __Local__205[1];
	__Local__207.Value = 125.000000f;
	auto& __Local__208 = __Local__205[2];
	__Local__208.Value = 100.000000f;
	auto& __Local__209 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__196->BottomCurve), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__209 = TArray<FFrameNumber> ();
	__Local__209.Reserve(3);
	__Local__209.Add(FFrameNumber{});
	__Local__209.Add(FFrameNumber{});
	__Local__209[1].Value = 60000;
	__Local__209.Add(FFrameNumber{});
	__Local__209[2].Value = 120000;
	auto& __Local__210 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__196->BottomCurve), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__210 = TArray<FMovieSceneFloatValue> ();
	__Local__210.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__210.GetData(), 3);
	auto& __Local__211 = __Local__210[0];
	__Local__211.Value = 150.000000f;
	auto& __Local__212 = __Local__210[1];
	__Local__212.Value = 175.000000f;
	auto& __Local__213 = __Local__210[2];
	__Local__213.Value = 150.000000f;
	__Local__196->Easing.EaseIn = __Local__197;
	__Local__196->Easing.EaseOut = __Local__198;
	__Local__196->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(120000)));
	auto& __Local__214 = (*(AccessPrivateProperty<FGuid >((__Local__196), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__214 = FGuid(0x0EBADE8D, 0x41A23592, 0xEE6937AD, 0x07605376);
	__Local__195.Add(__Local__196);
	auto& __Local__215 = (*(AccessPrivateProperty<FGuid >((__Local__193), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__215 = FGuid(0x87197DC4, 0x4098F672, 0x892781BB, 0xB3D96C74);
	auto& __Local__216 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__193), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__216.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__216.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__216.Entries.GetData(), 1);
	auto& __Local__217 = __Local__216.Entries[0];
	__Local__217.Section = __Local__196;
	auto& __Local__218 = (*(__Local__107->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__217.Range), 0)));
	auto& __Local__219 = (*(__Local__110->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__218), 0)));
	__Local__219 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__220 = (*(__Local__113->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__217.Range), 0)));
	auto& __Local__221 = (*(__Local__110->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__220), 0)));
	__Local__221 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__222 = (*(__Local__117->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__220), 0)));
	__Local__222.Value = 120000;
	__Local__217.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__223 = (*(AccessPrivateProperty<FGuid >((__Local__193), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__223 = FGuid(0x87197DC4, 0x4098F672, 0x892781BB, 0xB3D96C74);
	__Local__192.Add(__Local__193);
	auto& __Local__224 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__174), UMovieScene::__PPO__PlaybackRange() )));
	__Local__224 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(120001)));
	auto& __Local__225 = (*(AccessPrivateProperty<FFrameRate >((__Local__174), UMovieScene::__PPO__DisplayRate() )));
	auto& __Local__226 = (*(__Local__123->ContainerPtrToValuePtr<int32 >(&(__Local__225), 0)));
	__Local__226 = 20;
	auto& __Local__227 = (*(AccessPrivateProperty<FGuid >((__Local__174), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__227 = FGuid(0xB58AE804, 0x4B9FE52D, 0x675DECB8, 0x2E78CA9A);
	__Local__3->MovieScene = __Local__174;
	...
	auto& __Local__228 = __Local__3->AnimationBindings[0];
	__Local__228.WidgetName = FName(TEXT("LeftScaleBox"));
	__Local__228.AnimationGuid = FGuid(0xF300A5DE, 0x429548C9, 0x1167CA9A, 0x59D5AEDF);
	auto& __Local__229 = __Local__3->AnimationBindings[1];
	__Local__229.WidgetName = FName(TEXT("LeftScaleBox"));
	__Local__229.SlotWidgetName = FName(TEXT("CanvasPanelSlot_18"));
	__Local__229.AnimationGuid = FGuid(0xEBD72EEF, 0x4301BAB6, 0x879048AB, 0x5EC6C022);
	auto& __Local__230 = (*(AccessPrivateProperty<FString >((__Local__3), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__230 = FString(TEXT("ALeftAnim"));
	__Local__3->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__231 = (*(AccessPrivateProperty<FGuid >((__Local__3), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__231 = FGuid(0x502612D3, 0x436297E1, 0xD202FD8A, 0x6207BCE1);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__3);
	auto __Local__232 = NewObject<UMovieScene>(__Local__4, TEXT("ARightAnim"), (EObjectFlags)0x00280008);
	auto& __Local__233 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__232), UMovieScene::__PPO__Possessables() )));
	__Local__233 = TArray<FMovieScenePossessable> ();
	__Local__233.AddUninitialized(2);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__233.GetData(), 2);
	auto& __Local__234 = __Local__233[0];
	auto& __Local__235 = (*(AccessPrivateProperty<FGuid >(&(__Local__234), FMovieScenePossessable::__PPO__Guid() )));
	__Local__235 = FGuid(0x57001E0C, 0x4B0BA5B4, 0x78374B8C, 0x2C5DA3A6);
	auto& __Local__236 = (*(AccessPrivateProperty<FString >(&(__Local__234), FMovieScenePossessable::__PPO__Name() )));
	__Local__236 = FString(TEXT("RightScaleBox"));
	auto& __Local__237 = (*(AccessPrivateProperty<UClass* >(&(__Local__234), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__237 = UScaleBox::StaticClass();
	auto& __Local__238 = __Local__233[1];
	auto& __Local__239 = (*(AccessPrivateProperty<FGuid >(&(__Local__238), FMovieScenePossessable::__PPO__Guid() )));
	__Local__239 = FGuid(0x4F90B6AC, 0x4868836F, 0x186419A3, 0xB3EE8904);
	auto& __Local__240 = (*(AccessPrivateProperty<FString >(&(__Local__238), FMovieScenePossessable::__PPO__Name() )));
	__Local__240 = FString(TEXT("CanvasPanelSlot_17"));
	auto& __Local__241 = (*(AccessPrivateProperty<UClass* >(&(__Local__238), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__241 = UCanvasPanelSlot::StaticClass();
	auto& __Local__242 = (*(AccessPrivateProperty<FGuid >(&(__Local__238), FMovieScenePossessable::__PPO__ParentGuid() )));
	__Local__242 = FGuid(0x57001E0C, 0x4B0BA5B4, 0x78374B8C, 0x2C5DA3A6);
	auto& __Local__243 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__232), UMovieScene::__PPO__ObjectBindings() )));
	__Local__243 = TArray<FMovieSceneBinding> ();
	__Local__243.AddUninitialized(2);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__243.GetData(), 2);
	auto& __Local__244 = __Local__243[0];
	auto& __Local__245 = (*(AccessPrivateProperty<FGuid >(&(__Local__244), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__245 = FGuid(0x57001E0C, 0x4B0BA5B4, 0x78374B8C, 0x2C5DA3A6);
	auto& __Local__246 = (*(AccessPrivateProperty<FString >(&(__Local__244), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__246 = FString(TEXT("RightScaleBox"));
	auto& __Local__247 = __Local__243[1];
	auto& __Local__248 = (*(AccessPrivateProperty<FGuid >(&(__Local__247), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__248 = FGuid(0x4F90B6AC, 0x4868836F, 0x186419A3, 0xB3EE8904);
	auto& __Local__249 = (*(AccessPrivateProperty<FString >(&(__Local__247), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__249 = FString(TEXT("CanvasPanelSlot_17"));
	auto& __Local__250 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__247), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__250 = TArray<UMovieSceneTrack*> ();
	__Local__250.Reserve(1);
	auto __Local__251 = NewObject<UMovieSceneMarginTrack>(__Local__232, TEXT("MovieSceneMarginTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__252 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__251), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__252.PropertyName = FName(TEXT("Offsets"));
	__Local__252.PropertyPath = FName(TEXT("LayoutData.Offsets"));
	auto& __Local__253 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__251), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__253 = TArray<UMovieSceneSection*> ();
	__Local__253.Reserve(1);
	auto __Local__254 = NewObject<UMovieSceneMarginSection>(__Local__251, TEXT("MovieSceneMarginSection_0"), (EObjectFlags)0x00280008);
	auto __Local__255 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__254->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__256 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__254->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__255)
	{
		// --- Default subobject 'EaseInFunction' //
		// --- END default subobject 'EaseInFunction' //
	...
	auto& __Local__257 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__254->LeftCurve), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__257 = TArray<FFrameNumber> ();
	__Local__257.Reserve(3);
	__Local__257.Add(FFrameNumber{});
	__Local__257.Add(FFrameNumber{});
	__Local__257[1].Value = 60000;
	__Local__257.Add(FFrameNumber{});
	__Local__257[2].Value = 120000;
	auto& __Local__258 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__254->LeftCurve), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__258 = TArray<FMovieSceneFloatValue> ();
	__Local__258.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__258.GetData(), 3);
	auto& __Local__259 = __Local__258[0];
	__Local__259.Value = 400.000000f;
	auto& __Local__260 = __Local__258[1];
	__Local__260.Value = 450.000000f;
	auto& __Local__261 = __Local__258[2];
	__Local__261.Value = 400.000000f;
	auto& __Local__262 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__254->RightCurve), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__262 = TArray<FFrameNumber> ();
	__Local__262.Reserve(3);
	__Local__262.Add(FFrameNumber{});
	__Local__262.Add(FFrameNumber{});
	__Local__262[1].Value = 60000;
	__Local__262.Add(FFrameNumber{});
	__Local__262[2].Value = 120000;
	auto& __Local__263 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__254->RightCurve), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__263 = TArray<FMovieSceneFloatValue> ();
	__Local__263.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__263.GetData(), 3);
	auto& __Local__264 = __Local__263[0];
	__Local__264.Value = 100.000000f;
	auto& __Local__265 = __Local__263[1];
	__Local__265.Value = 125.000000f;
	auto& __Local__266 = __Local__263[2];
	__Local__266.Value = 100.000000f;
	auto& __Local__267 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__254->BottomCurve), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__267 = TArray<FFrameNumber> ();
	__Local__267.Reserve(3);
	__Local__267.Add(FFrameNumber{});
	__Local__267.Add(FFrameNumber{});
	__Local__267[1].Value = 60000;
	__Local__267.Add(FFrameNumber{});
	__Local__267[2].Value = 120000;
	auto& __Local__268 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__254->BottomCurve), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__268 = TArray<FMovieSceneFloatValue> ();
	__Local__268.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__268.GetData(), 3);
	auto& __Local__269 = __Local__268[0];
	__Local__269.Value = 150.000000f;
	auto& __Local__270 = __Local__268[1];
	__Local__270.Value = 175.000000f;
	auto& __Local__271 = __Local__268[2];
	__Local__271.Value = 150.000000f;
	__Local__254->Easing.EaseIn = __Local__255;
	__Local__254->Easing.EaseOut = __Local__256;
	__Local__254->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(120000)));
	auto& __Local__272 = (*(AccessPrivateProperty<FGuid >((__Local__254), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__272 = FGuid(0xFFFFA9AA, 0x45C879E1, 0xED816EA4, 0x59838940);
	__Local__253.Add(__Local__254);
	auto& __Local__273 = (*(AccessPrivateProperty<FGuid >((__Local__251), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__273 = FGuid(0xEBEB4C7F, 0x4534E053, 0xC7301890, 0xA92E4B0D);
	auto& __Local__274 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__251), UMovieSceneTrack::__PPO__EvaluationField() )));
	__Local__274.Entries = TArray<FMovieSceneTrackEvaluationFieldEntry> ();
	__Local__274.Entries.AddUninitialized(1);
	FMovieSceneTrackEvaluationFieldEntry::StaticStruct()->InitializeStruct(__Local__274.Entries.GetData(), 1);
	auto& __Local__275 = __Local__274.Entries[0];
	__Local__275.Section = __Local__254;
	auto& __Local__276 = (*(__Local__107->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__275.Range), 0)));
	auto& __Local__277 = (*(__Local__110->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__276), 0)));
	__Local__277 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__278 = (*(__Local__113->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__275.Range), 0)));
	auto& __Local__279 = (*(__Local__110->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__278), 0)));
	__Local__279 = ERangeBoundTypes::Type::Inclusive;
	auto& __Local__280 = (*(__Local__117->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__278), 0)));
	__Local__280.Value = 120000;
	__Local__275.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__281 = (*(AccessPrivateProperty<FGuid >((__Local__251), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__281 = FGuid(0xEBEB4C7F, 0x4534E053, 0xC7301890, 0xA92E4B0D);
	__Local__250.Add(__Local__251);
	auto& __Local__282 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__232), UMovieScene::__PPO__PlaybackRange() )));
	__Local__282 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(120001)));
	auto& __Local__283 = (*(AccessPrivateProperty<FFrameRate >((__Local__232), UMovieScene::__PPO__DisplayRate() )));
	auto& __Local__284 = (*(__Local__123->ContainerPtrToValuePtr<int32 >(&(__Local__283), 0)));
	__Local__284 = 20;
	auto& __Local__285 = (*(AccessPrivateProperty<FGuid >((__Local__232), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__285 = FGuid(0x55AFD699, 0x46AFF1DD, 0xF91C8CB3, 0x8E2917C0);
	__Local__4->MovieScene = __Local__232;
	...
	auto& __Local__286 = __Local__4->AnimationBindings[0];
	__Local__286.WidgetName = FName(TEXT("RightScaleBox"));
	__Local__286.AnimationGuid = FGuid(0x57001E0C, 0x4B0BA5B4, 0x78374B8C, 0x2C5DA3A6);
	auto& __Local__287 = __Local__4->AnimationBindings[1];
	__Local__287.WidgetName = FName(TEXT("RightScaleBox"));
	__Local__287.SlotWidgetName = FName(TEXT("CanvasPanelSlot_17"));
	__Local__287.AnimationGuid = FGuid(0x4F90B6AC, 0x4868836F, 0x186419A3, 0xB3EE8904);
	auto& __Local__288 = (*(AccessPrivateProperty<FString >((__Local__4), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__288 = FString(TEXT("ARightAnim"));
	__Local__4->DefaultCompletionMode = EMovieSceneCompletionMode::KeepState;
	auto& __Local__289 = (*(AccessPrivateProperty<FGuid >((__Local__4), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__289 = FGuid(0x7600D33F, 0x4D7F4E60, 0x25C021A1, 0xE133D9F1);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__4);
}
PRAGMA_ENABLE_OPTIMIZATION
void UWorldMapHUDRe_C__pf197907997::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__290;
	SlotNames.Append(__Local__290);
}
void UWorldMapHUDRe_C__pf197907997::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__291;
	__Local__291.Reserve(4);
	__Local__291.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->MiscConvertedSubobjects[1]));
	__Local__291.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->MiscConvertedSubobjects[2]));
	__Local__291.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->MiscConvertedSubobjects[3]));
	__Local__291.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->MiscConvertedSubobjects[4]));
	TArray<FDelegateRuntimeBinding>  __Local__292;
	__Local__292.AddUninitialized(10);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__292.GetData(), 10);
	auto& __Local__293 = __Local__292[0];
	__Local__293.ObjectName = FString(TEXT("TextBlock_96"));
	__Local__293.PropertyName = FName(TEXT("Text"));
	__Local__293.FunctionName = FName(TEXT("GetText_0"));
	auto& __Local__294 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__293.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__294 = TArray<FPropertyPathSegment> ();
	__Local__294.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__294.GetData(), 1);
	auto& __Local__295 = __Local__294[0];
	__Local__295.Name = FName(TEXT("GetLevelName"));
	auto& __Local__296 = __Local__292[1];
	__Local__296.ObjectName = FString(TEXT("PuntuationLevel"));
	__Local__296.PropertyName = FName(TEXT("Text"));
	__Local__296.FunctionName = FName(TEXT("Get_PuntuationLevel_Text_1"));
	auto& __Local__297 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__296.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__297 = TArray<FPropertyPathSegment> ();
	__Local__297.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__297.GetData(), 1);
	auto& __Local__298 = __Local__297[0];
	__Local__298.Name = FName(TEXT("Get_PuntuationLevel_Text_1"));
	auto& __Local__299 = __Local__292[2];
	__Local__299.ObjectName = FString(TEXT("Image_170"));
	__Local__299.PropertyName = FName(TEXT("Visibility"));
	__Local__299.FunctionName = FName(TEXT("GetVisibility_0"));
	auto& __Local__300 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__299.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__300 = TArray<FPropertyPathSegment> ();
	__Local__300.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__300.GetData(), 1);
	auto& __Local__301 = __Local__300[0];
	__Local__301.Name = FName(TEXT("GetVisibility_0"));
	auto& __Local__302 = __Local__292[3];
	__Local__302.ObjectName = FString(TEXT("Image_636"));
	__Local__302.PropertyName = FName(TEXT("Visibility"));
	__Local__302.FunctionName = FName(TEXT("GetVisibility_1"));
	auto& __Local__303 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__302.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__303 = TArray<FPropertyPathSegment> ();
	__Local__303.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__303.GetData(), 1);
	auto& __Local__304 = __Local__303[0];
	__Local__304.Name = FName(TEXT("GetVisibility_1"));
	auto& __Local__305 = __Local__292[4];
	__Local__305.ObjectName = FString(TEXT("TextBlock_204"));
	__Local__305.PropertyName = FName(TEXT("Text"));
	__Local__305.FunctionName = FName(TEXT("GetText_4"));
	auto& __Local__306 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__305.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__306 = TArray<FPropertyPathSegment> ();
	__Local__306.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__306.GetData(), 1);
	auto& __Local__307 = __Local__306[0];
	__Local__307.Name = FName(TEXT("GetText_4"));
	auto& __Local__308 = __Local__292[5];
	__Local__308.ObjectName = FString(TEXT("SizeBox_201"));
	__Local__308.PropertyName = FName(TEXT("Visibility"));
	__Local__308.FunctionName = FName(TEXT("GetVisibility_2"));
	auto& __Local__309 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__308.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__309 = TArray<FPropertyPathSegment> ();
	__Local__309.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__309.GetData(), 1);
	auto& __Local__310 = __Local__309[0];
	__Local__310.Name = FName(TEXT("GetVisibility_2"));
	auto& __Local__311 = __Local__292[6];
	__Local__311.ObjectName = FString(TEXT("Return"));
	__Local__311.PropertyName = FName(TEXT("Visibility"));
	__Local__311.FunctionName = FName(TEXT("GetVisibility_3"));
	auto& __Local__312 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__311.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__312 = TArray<FPropertyPathSegment> ();
	__Local__312.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__312.GetData(), 1);
	auto& __Local__313 = __Local__312[0];
	__Local__313.Name = FName(TEXT("GetVisibility_3"));
	auto& __Local__314 = __Local__292[7];
	__Local__314.ObjectName = FString(TEXT("Gonorth"));
	__Local__314.PropertyName = FName(TEXT("Visibility"));
	__Local__314.FunctionName = FName(TEXT("GetVisibility_4"));
	auto& __Local__315 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__314.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__315 = TArray<FPropertyPathSegment> ();
	__Local__315.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__315.GetData(), 1);
	auto& __Local__316 = __Local__315[0];
	__Local__316.Name = FName(TEXT("GetVisibility_4"));
	auto& __Local__317 = __Local__292[8];
	__Local__317.ObjectName = FString(TEXT("Widget_KeySwap_277"));
	__Local__317.PropertyName = FName(TEXT("Visibility"));
	__Local__317.FunctionName = FName(TEXT("GetVisibility_1"));
	auto& __Local__318 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__317.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__318 = TArray<FPropertyPathSegment> ();
	__Local__318.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__318.GetData(), 1);
	auto& __Local__319 = __Local__318[0];
	__Local__319.Name = FName(TEXT("GetVisibility_1"));
	auto& __Local__320 = __Local__292[9];
	__Local__320.ObjectName = FString(TEXT("Widget_KeySwap"));
	__Local__320.PropertyName = FName(TEXT("Visibility"));
	__Local__320.FunctionName = FName(TEXT("GetVisibility_0"));
	auto& __Local__321 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__320.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__321 = TArray<FPropertyPathSegment> ();
	__Local__321.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__321.GetData(), 1);
	auto& __Local__322 = __Local__321[0];
	__Local__322.Name = FName(TEXT("GetVisibility_0"));
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UWorldMapHUDRe_C__pf197907997::StaticClass())->MiscConvertedSubobjects[0]), __Local__291, __Local__292);
}
void UWorldMapHUDRe_C__pf197907997::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UWorldMapHUDRe_C__pf197907997::bpf__ExecuteUbergraph_WorldMapHUDRe__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_PlayAnimation_ReturnValue_1__pf = UUserWidget::PlayAnimation(bpv__SaveGameAnim__pf, 0.000000, 1, EUMGSequencePlayMode::Forward, 1.000000, false);
	bpfv__CallFunc_PlayAnimation_ReturnValue_3__pf = UUserWidget::PlayAnimation(bpv__ALeftAnim__pf, 0.000000, 0, EUMGSequencePlayMode::Forward, 1.000000, false);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_PlayAnimation_ReturnValue__pf = UUserWidget::PlayAnimation(bpv__ARightAnim__pf, 0.000000, 0, EUMGSequencePlayMode::Forward, 1.000000, false);
	...
	bool  __Local__323 = false;
	if (!((::IsValid(b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (b0l__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__IsNorthernFrontActive__pf) : (__Local__323)))
	{
		return; //KCST_GotoReturnIfNot
	}
	bpfv__CallFunc_PlayAnimation_ReturnValue_2__pf = UUserWidget::PlayAnimation(bpv__NorthernFrontAnim__pf, 0.000000, 0, EUMGSequencePlayMode::Forward, 1.000000, false);
	return; // KCST_GotoReturn
}
void UWorldMapHUDRe_C__pf197907997::bpf__ExecuteUbergraph_WorldMapHUDRe__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void UWorldMapHUDRe_C__pf197907997::bpf__PreConstruct__pf(bool bpp__IsDesignTime__pf)
{
	b0l__K2Node_Event_IsDesignTime__pf = bpp__IsDesignTime__pf;
	bpf__ExecuteUbergraph_WorldMapHUDRe__pf_1(1);
}
void UWorldMapHUDRe_C__pf197907997::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_WorldMapHUDRe__pf_0(6);
}
FText  UWorldMapHUDRe_C__pf197907997::bpf__GetLevelName__pf()
{
	FText bpp__ReturnValue__pf{};
	ACharacter* bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf{};
	APlayerWorldMap_Character_C__pf2222656877* bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf{};
	...
	do
	{
		...
		case 1:
			{
				...
				bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf = Cast<APlayerWorldMap_Character_C__pf2222656877>(bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf);
				bpfv__K2Node_DynamicCast_bSuccess__pf = (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf != nullptr);;
		...
		case 2:
			{
				bool  __Local__324 = false;
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__IsInNorthernFront__pf) : (__Local__324)))
				{
					__CurrentState = 5;
					break;
				}
		...
		case 3:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"50FA82404BBDE14626B44ABC18EC3532\", \"Northern Front\")")	);
			}
		case 4:
			{
				bpp__ReturnValue__pf = bpv__StringName__pf;
				__CurrentState = -1;
				break;
			}
		case 5:
			{
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__325)), 0);
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__326)), 1);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 7;
					break;
				...
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__327)), 2);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 8;
					break;
				}
				int32  __Local__328 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__328)), 3);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 9;
					break;
				}
				int32  __Local__329 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__329)), 4);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 10;
					break;
				}
				int32  __Local__330 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__330)), 5);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 11;
					break;
				}
				int32  __Local__331 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__331)), 6);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 12;
					break;
				}
				int32  __Local__332 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__332)), 7);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				}
				int32  __Local__333 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__333)), 8);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				}
				int32  __Local__334 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__334)), 9);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 15;
					break;
				}
				int32  __Local__335 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__335)), 10);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
				}
				int32  __Local__336 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__336)), 11);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 17;
					break;
				}
				int32  __Local__337 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__337)), 12);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 18;
					break;
				}
				int32  __Local__338 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__338)), 13);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 19;
					break;
				}
				int32  __Local__339 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__339)), 14);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 20;
					break;
				}
				int32  __Local__340 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__340)), 15);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 21;
					break;
		...
		case 6:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"BA91CA584E6AE54E08A59E85A1C2EB04\", \"Play\")")	);
				__CurrentState = 4;
				break;
			}
		case 7:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"09259BD4450642A514543482F6CB91D5\", \"Tutorial\")")	);
				__CurrentState = 4;
				break;
			}
		case 8:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"C247A0DD47630E363BDA8BBA0871EFC2\", \"First Blood\")")	);
				__CurrentState = 4;
				break;
			}
		case 9:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"F04934004C032AC76764AFA960A16D3B\", \"necessity good\")")	);
				__CurrentState = 4;
				break;
			}
		case 10:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"7757D64146DF547336CC7BB09674594C\", \"Health comes first\")")	);
				__CurrentState = 4;
				break;
			}
		case 11:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"137EC6294EAF40EC0D7E38AECF83B681\", \"revenge\")")	);
				__CurrentState = 4;
				break;
			}
		case 12:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"2874BBE14C33A835048AC1BA8B161EAE\", \"Killer\")")	);
				__CurrentState = 4;
				break;
			}
		case 13:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"E2A791AC4A9FD12F7E6CA9AA1EC7421E\", \"Nuclear wish\")")	);
				__CurrentState = 4;
				break;
			}
		case 14:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"348EAACC412426FAE3847F88A15C8CCA\", \"Dead sea\")")	);
				__CurrentState = 4;
				break;
			}
		case 15:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"47A1458643F8454F181859B2C75B6600\", \"Horts\")")	);
				__CurrentState = 4;
				break;
			}
		case 16:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"C9B343BD4EE73E457DD83E962180945E\", \"Baptism\")")	);
				__CurrentState = 4;
				break;
			}
		case 17:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"2F4D5C9A403422D326E1DCBCA61FD11A\", \"To the end\")")	);
				__CurrentState = 4;
				break;
			}
		case 18:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"9A6EF40B4F8B1F3BC17F47B380C9D08D\", \"Dead ahead\")")	);
				__CurrentState = 4;
				break;
			}
		case 19:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"E9ED878B4B3B95CE292031B90E6DCDDF\", \"K12\")")	);
				__CurrentState = 4;
				break;
			}
		case 20:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"2A609534457A152331B67F829B21AE65\", \"Zero Zone\")")	);
				__CurrentState = 4;
				break;
			}
		case 21:
			{
				bpv__StringName__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"5DC19B094A08E17ECB68D6A4968B5376\", \"Perfect world\")")	);
				__CurrentState = 4;
				break;
			}
		default:
...
FText  UWorldMapHUDRe_C__pf197907997::bpf__Get_PuntuationLevel_Text_1__pf()
{
	FText bpp__ReturnValue__pf{};
	ACharacter* bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf{};
	...
	do
	{
		...
		case 2:
			{
				int32  __Local__341 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__341)), 0);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 3;
					break;
				}
				int32  __Local__342 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__342)), 1);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 5;
					break;
				}
				int32  __Local__343 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__343)), 2);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 6;
					break;
				}
				int32  __Local__344 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__344)), 3);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 7;
					break;
				}
				int32  __Local__345 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__345)), 4);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 8;
					break;
				}
				int32  __Local__346 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__346)), 5);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 9;
					break;
				}
				int32  __Local__347 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__347)), 6);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 10;
					break;
				}
				int32  __Local__348 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__348)), 7);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 11;
					break;
				}
				int32  __Local__349 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__349)), 8);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 12;
					break;
				}
				int32  __Local__350 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__350)), 9);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 13;
					break;
				}
				int32  __Local__351 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__351)), 10);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 14;
					break;
				}
				int32  __Local__352 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__352)), 11);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 15;
					break;
				}
				int32  __Local__353 = 0;
				bpfv__K2Node_SwitchInteger_CmpSuccess__pf = UKismetMathLibrary::NotEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__353)), 12);
				if (!bpfv__K2Node_SwitchInteger_CmpSuccess__pf)
				{
					__CurrentState = 16;
					break;
		...
		case 3:
			{
				bpf__LoadScoreLevel__pf(0);
			}
		case 4:
			{
				bpfv__CallFunc_Concat_StrStr_ReturnValue__pf = UKismetStringLibrary::Concat_StrStr(bpv__ScoreLevel__pf, FString(TEXT(" PTS")));
		...
		case 5:
			{
				bpf__LoadScoreLevel__pf(1);
				__CurrentState = 4;
				break;
			}
		case 6:
			{
				bpf__LoadScoreLevel__pf(2);
				__CurrentState = 4;
				break;
			}
		case 7:
			{
				bpf__LoadScoreLevel__pf(3);
				__CurrentState = 4;
				break;
			}
		case 8:
			{
				bpf__LoadScoreLevel__pf(4);
				__CurrentState = 4;
				break;
			}
		case 9:
			{
				bpf__LoadScoreLevel__pf(5);
				__CurrentState = 4;
				break;
			}
		case 10:
			{
				bpf__LoadScoreLevel__pf(6);
				__CurrentState = 4;
				break;
			}
		case 11:
			{
				bpf__LoadScoreLevel__pf(7);
				__CurrentState = 4;
				break;
			}
		case 12:
			{
				bpf__LoadScoreLevel__pf(8);
				__CurrentState = 4;
				break;
			}
		case 13:
			{
				bpf__LoadScoreLevel__pf(9);
				__CurrentState = 4;
				break;
			}
		case 14:
			{
				bpf__LoadScoreLevel__pf(10);
				__CurrentState = 4;
				break;
			}
		case 15:
			{
				bpf__LoadScoreLevel__pf(11);
				__CurrentState = 4;
				break;
			}
		case 16:
			{
				bpf__LoadScoreLevel__pf(12);
				__CurrentState = 4;
				break;
			}
		default:
...
void UWorldMapHUDRe_C__pf197907997::bpf__LoadScoreLevel__pf(int32 bpp__LevelNumber__pf)
{
	...
	do
	{
		...
		case 3:
			{
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(bpp__LevelNumber__pf, 1);
				TArray<int32>  __Local__354 = {};
				bpfv__CallFunc_Conv_IntToString_ReturnValue__pf = UKismetStringLibrary::Conv_IntToString(((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__PuntuationLevels__pf) : (__Local__354))[bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf]);
				bpv__ScoreLevel__pf = bpfv__CallFunc_Conv_IntToString_ReturnValue__pf;
			}
		case 4:
			{
				__CurrentState = -1;
...
void UWorldMapHUDRe_C__pf197907997::bpf__GetText_0__pf()
{
	FText bpfv__TextSpace__pf{};
}
void UWorldMapHUDRe_C__pf197907997::bpf__GetText_1__pf()
{
	FText bpfv__TextMove__pf{};
}
void UWorldMapHUDRe_C__pf197907997::bpf__GetText_2__pf()
{
	FText bpfv__TextSaving__pf{};
}
ESlateVisibility  UWorldMapHUDRe_C__pf197907997::bpf__GetVisibility_0__pf()
{
		...
		case 2:
			{
				...
				int32  __Local__355 = 0;
				bpfv__CallFunc_Less_IntInt_ReturnValue__pf = UKismetMathLibrary::Less_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__355)), 2);
				bool  __Local__356 = false;
				bpfv__CallFunc_NotEqual_BoolBool_ReturnValue__pf = UKismetMathLibrary::NotEqual_BoolBool(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__IsReadyToMove__pf) : (__Local__356)), true);
				bpfv__CallFunc_BooleanOR_ReturnValue__pf = UKismetMathLibrary::BooleanOR(bpfv__CallFunc_Less_IntInt_ReturnValue__pf, bpfv__CallFunc_NotEqual_BoolBool_ReturnValue__pf);
...
ESlateVisibility  UWorldMapHUDRe_C__pf197907997::bpf__GetVisibility_1__pf()
{
	ESlateVisibility bpp__ReturnValue__pf{};
	bool bpfv__Temp_bool_Variable__pf{};
	ESlateVisibility bpfv__Temp_byte_Variable__pf{};
		...
		case 2:
			{
				...
				TArray<ATargetPoint*>  __Local__357 = {};
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__ArrayTargetPoints__pf) : (__Local__357)));
				bool  __Local__358 = false;
				bpfv__CallFunc_EqualEqual_BoolBool_ReturnValue__pf = UKismetMathLibrary::EqualEqual_BoolBool(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__IsReadyToMove__pf) : (__Local__358)), true);
				int32  __Local__359 = 0;
				bpfv__CallFunc_Less_IntInt_ReturnValue__pf = UKismetMathLibrary::Less_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__359)), bpfv__CallFunc_Array_Length_ReturnValue__pf);
				bpfv__CallFunc_BooleanAND_ReturnValue__pf = UKismetMathLibrary::BooleanAND(bpfv__CallFunc_Less_IntInt_ReturnValue__pf, bpfv__CallFunc_EqualEqual_BoolBool_ReturnValue__pf);
...
ESlateVisibility  UWorldMapHUDRe_C__pf197907997::bpf__GetVisibility_NF_Text__pf()
{
	ESlateVisibility bpp__ReturnValue__pf{};
	bool bpfv__Temp_bool_Variable__pf{};
	ESlateVisibility bpfv__Temp_byte_Variable__pf{};
		...
		case 2:
			{
				bpfv__Temp_byte_Variable__pf = ESlateVisibility::Visible;
				bpfv__Temp_byte_Variable_1__pf = ESlateVisibility::Hidden;
				bool  __Local__360 = false;
				bpfv__Temp_bool_Variable__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__IsNorthernFrontActive__pf) : (__Local__360));
				bpp__ReturnValue__pf = TSwitchValue<bool , ESlateVisibility >(bpfv__Temp_bool_Variable__pf, bpfv__K2Node_Select_Default__pf, 2, TSwitchPair<bool , ESlateVisibility >(false, bpfv__Temp_byte_Variable_1__pf), TSwitchPair<bool , ESlateVisibility >(true, bpfv__Temp_byte_Variable__pf));
				__CurrentState = -1;
				break;
			}
...
FText  UWorldMapHUDRe_C__pf197907997::bpf__GetText_3__pf()
{
	FText bpp__ReturnValue__pf{};
	FText bpfv__TextNorthernFront__pf{};
	ACharacter* bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf{};
	APlayerWorldMap_Character_C__pf2222656877* bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	int32 __CurrentState = 1;
	do
	{
		...
		case 2:
			{
				bool  __Local__361 = false;
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__IsInNorthernFront__pf) : (__Local__361)))
				{
					__CurrentState = 5;
					break;
				}
		...
		case 3:
			{
				bpfv__TextNorthernFront__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"4F867B9E4A755D659FA7D3B2A7529A01\", \"Press W to exit the Northern Front\")")	);
			}
		case 4:
			{
				bpp__ReturnValue__pf = bpfv__TextNorthernFront__pf;
				__CurrentState = -1;
				break;
			}
		case 5:
			{
				bpfv__TextNorthernFront__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"8E2FD5BB495DFD4A1BAA2A8D5EC0FE2B\", \"Press S to go to the Northern Front\")")	);
				__CurrentState = 4;
				break;
			}
		default:
...
ESlateVisibility  UWorldMapHUDRe_C__pf197907997::bpf__GetVisibility_2__pf()
{
	ESlateVisibility bpp__ReturnValue__pf{};
	UGameInstance* bpfv__CallFunc_GetGameInstance_ReturnValue__pf{};
	UMyGameInstance_C__pf2410127383* bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf{};
	...
	do
	{
		...
		case 2:
			{
				bool  __Local__362 = false;
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__IsNorthernFrontActive__pf) : (__Local__362)))
				{
					__CurrentState = 4;
					break;
				}
		...
		case 3:
			{
				bpp__ReturnValue__pf = ESlateVisibility::HitTestInvisible;
				__CurrentState = -1;
				break;
			}
		case 4:
...
FText  UWorldMapHUDRe_C__pf197907997::bpf__GetText_4__pf()
{
	FText bpp__ReturnValue__pf{};
	ACharacter* bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf{};
	APlayerWorldMap_Character_C__pf2222656877* bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf{};
	...
	do
	{
		...
		case 2:
			{
				bool  __Local__363 = false;
				if (!((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__IsInNorthernFront__pf) : (__Local__363)))
				{
					__CurrentState = 4;
					break;
				}
		...
		case 3:
			{
				bpp__ReturnValue__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"DADD5A0F4A4EE293F10AEAB6C7D0FE9E\", \"NF\")")	);
				__CurrentState = -1;
				break;
			}
		case 4:
			{
				int32  __Local__364 = 0;
				bpfv__CallFunc_EqualEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::EqualEqual_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__364)), 15);
		...
		case 5:
			{
				bpp__ReturnValue__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"8DE459B348DFA30C4F8C829DF3AD94FA\", \"X\")")	);
				__CurrentState = -1;
				break;
			}
		case 6:
			{
				int32  __Local__365 = 0;
				bpfv__CallFunc_Greater_IntInt_ReturnValue__pf = UKismetMathLibrary::Greater_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__365)), 1);
		...
		case 7:
			{
				int32  __Local__366 = 0;
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__366)), 1);
				bpfv__CallFunc_Conv_IntToText_ReturnValue__pf = UKismetTextLibrary::Conv_IntToText(bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf, false, true, 1, 324);
		...
		case 8:
			{
				bpp__ReturnValue__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5D59A0804C126E0B66049B9340EBB8FB]\", \"AB0E158942F821BB776B00936687D4D4\", \"T\")")	);
				__CurrentState = -1;
				break;
			}
		default:
...
ESlateVisibility  UWorldMapHUDRe_C__pf197907997::bpf__GetVisibility_3__pf()
{
	ESlateVisibility bpp__ReturnValue__pf{};
	bool bpfv__Temp_bool_Variable__pf{};
	ESlateVisibility bpfv__Temp_byte_Variable__pf{};
		...
		case 2:
			{
				bpfv__Temp_byte_Variable__pf = ESlateVisibility::Visible;
				bpfv__Temp_byte_Variable_1__pf = ESlateVisibility::Hidden;
				bool  __Local__367 = false;
				bpfv__Temp_bool_Variable__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__IsInNorthernFront__pf) : (__Local__367));
				bpp__ReturnValue__pf = TSwitchValue<bool , ESlateVisibility >(bpfv__Temp_bool_Variable__pf, bpfv__K2Node_Select_Default__pf, 2, TSwitchPair<bool , ESlateVisibility >(false, bpfv__Temp_byte_Variable_1__pf), TSwitchPair<bool , ESlateVisibility >(true, bpfv__Temp_byte_Variable__pf));
				__CurrentState = -1;
				break;
			}
...
ESlateVisibility  UWorldMapHUDRe_C__pf197907997::bpf__GetVisibility_4__pf()
{
	ESlateVisibility bpp__ReturnValue__pf{};
	bool bpfv__Temp_bool_Variable__pf{};
	ESlateVisibility bpfv__Temp_byte_Variable__pf{};
		...
		case 2:
			{
				bpfv__Temp_byte_Variable__pf = ESlateVisibility::Hidden;
				bpfv__Temp_byte_Variable_1__pf = ESlateVisibility::Visible;
				bool  __Local__368 = false;
				bpfv__Temp_bool_Variable__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__IsInNorthernFront__pf) : (__Local__368));
				bpp__ReturnValue__pf = TSwitchValue<bool , ESlateVisibility >(bpfv__Temp_bool_Variable__pf, bpfv__K2Node_Select_Default__pf, 2, TSwitchPair<bool , ESlateVisibility >(false, bpfv__Temp_byte_Variable_1__pf), TSwitchPair<bool , ESlateVisibility >(true, bpfv__Temp_byte_Variable__pf));
				__CurrentState = -1;
				break;
			}
...
ESlateVisibility  UWorldMapHUDRe_C__pf197907997::bpf__GetVisibility_5__pf()
{
	ESlateVisibility bpp__ReturnValue__pf{};
	bool bpfv__Temp_bool_Variable__pf{};
	ESlateVisibility bpfv__Temp_byte_Variable__pf{};
		...
		case 1:
			{
				bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf = UGameplayStatics::GetPlayerCharacter(this, 0);
				bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf = Cast<APlayerWorldMap_Character_C__pf2222656877>(bpfv__CallFunc_GetPlayerCharacter_ReturnValue__pf);
				bpfv__K2Node_DynamicCast_bSuccess_1__pf = (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf != nullptr);;
		...
		case 3:
			{
				bpfv__Temp_byte_Variable__pf = ESlateVisibility::Hidden;
				bpfv__Temp_byte_Variable_1__pf = ESlateVisibility::Visible;
				bool  __Local__369 = false;
				bpfv__CallFunc_NotEqual_BoolBool_ReturnValue__pf = UKismetMathLibrary::NotEqual_BoolBool(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__IsReadyToMove__pf) : (__Local__369)), true);
				int32  __Local__370 = 0;
				bpfv__CallFunc_Less_IntInt_ReturnValue__pf = UKismetMathLibrary::Less_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__370)), 2);
				bpfv__CallFunc_BooleanOR_ReturnValue__pf = UKismetMathLibrary::BooleanOR(bpfv__CallFunc_Less_IntInt_ReturnValue__pf, bpfv__CallFunc_NotEqual_BoolBool_ReturnValue__pf);
				bool  __Local__371 = false;
				bpfv__CallFunc_BooleanOR_ReturnValue_1__pf = UKismetMathLibrary::BooleanOR(bpfv__CallFunc_BooleanOR_ReturnValue__pf, ((::IsValid(bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__isGamepad__pf) : (__Local__371)));
				bpfv__Temp_bool_Variable__pf = bpfv__CallFunc_BooleanOR_ReturnValue_1__pf;
				bpp__ReturnValue__pf = TSwitchValue<bool , ESlateVisibility >(bpfv__Temp_bool_Variable__pf, bpfv__K2Node_Select_Default__pf, 2, TSwitchPair<bool , ESlateVisibility >(false, bpfv__Temp_byte_Variable_1__pf), TSwitchPair<bool , ESlateVisibility >(true, bpfv__Temp_byte_Variable__pf));
				__CurrentState = -1;
				break;
			}
...
ESlateVisibility  UWorldMapHUDRe_C__pf197907997::bpf__GetVisibility_6__pf()
{
	ESlateVisibility bpp__ReturnValue__pf{};
	bool bpfv__Temp_bool_Variable__pf{};
	ESlateVisibility bpfv__Temp_byte_Variable__pf{};
		...
		case 3:
			{
				bpfv__Temp_byte_Variable__pf = ESlateVisibility::Visible;
				bpfv__Temp_byte_Variable_1__pf = ESlateVisibility::Hidden;
				bool  __Local__372 = false;
				bpfv__CallFunc_Not_PreBool_ReturnValue__pf = UKismetMathLibrary::Not_PreBool(((::IsValid(bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf)) ? (bpfv__K2Node_DynamicCast_AsMy_Game_Instance__pf->bpv__isGamepad__pf) : (__Local__372)));
				bool  __Local__373 = false;
				bpfv__CallFunc_EqualEqual_BoolBool_ReturnValue__pf = UKismetMathLibrary::EqualEqual_BoolBool(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__IsReadyToMove__pf) : (__Local__373)), true);
				TArray<ATargetPoint*>  __Local__374 = {};
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__ArrayTargetPoints__pf) : (__Local__374)));
				int32  __Local__375 = 0;
				bpfv__CallFunc_Less_IntInt_ReturnValue__pf = UKismetMathLibrary::Less_IntInt(((::IsValid(bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf)) ? (bpfv__K2Node_DynamicCast_AsPlayer_World_Map_Character__pf->bpv__Target__pf) : (__Local__375)), bpfv__CallFunc_Array_Length_ReturnValue__pf);
				...
				bpfv__CallFunc_BooleanAND_ReturnValue_1__pf = UKismetMathLibrary::BooleanAND(bpfv__CallFunc_BooleanAND_ReturnValue__pf, bpfv__CallFunc_EqualEqual_BoolBool_ReturnValue__pf);
				bpfv__Temp_bool_Variable__pf = bpfv__CallFunc_BooleanAND_ReturnValue_1__pf;
				bpp__ReturnValue__pf = TSwitchValue<bool , ESlateVisibility >(bpfv__Temp_bool_Variable__pf, bpfv__K2Node_Select_Default__pf, 2, TSwitchPair<bool , ESlateVisibility >(false, bpfv__Temp_byte_Variable_1__pf), TSwitchPair<bool , ESlateVisibility >(true, bpfv__Temp_byte_Variable__pf));
				__CurrentState = -1;
				break;
			}
...
PRAGMA_DISABLE_OPTIMIZATION
void UWorldMapHUDRe_C__pf197907997::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UWorldMapHUDRe_C__pf197907997::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{14, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  ScriptStruct /Script/SlateCore.Geometry 
		...
		{680, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/ThirdPersonBP/Blueprints/PlayerWorldMap_Character.PlayerWorldMap_Character_C 
		...
		{660, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Widgets/Widget_KeySwap.Widget_KeySwap_C 
		{681, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  UserDefinedEnum /Game/Enemies/EnumLevelsNames.EnumLevelsNames 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UWorldMapHUDRe_C__pf197907997
{
	FRegisterHelper__UWorldMapHUDRe_C__pf197907997()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/WorldMapHUDRe"), &UWorldMapHUDRe_C__pf197907997::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UWorldMapHUDRe_C__pf197907997 Instance;
};
FRegisterHelper__UWorldMapHUDRe_C__pf197907997 FRegisterHelper__UWorldMapHUDRe_C__pf197907997::Instance;
