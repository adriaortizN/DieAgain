...
class AActor;
#include "ACH_DOG__pf3264546738.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Conversations/Events/ACH_DOG.ACH_DOG_C", OverrideNativeName="ACH_DOG_C"))
class UACH_DOG_C__pf3264546738 : public UDialogueEvents
{
public:
	GENERATED_BODY()
	...
	UACH_DOG_C__pf3264546738(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_ACH_DOG__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_DOG__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_DOG__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_DOG__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_DOG__pf_4(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_6CE1B9984DAAF15F444EDD917A49D75F"))
	virtual void bpf__OnSuccess_6CE1B9984DAAF15F444EDD917A49D75F__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_6CE1B9984DAAF15F444EDD917A49D75F"))
	virtual void bpf__OnFailure_6CE1B9984DAAF15F444EDD917A49D75F__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_E8D7C13F42790AF8BF4E20A9E2DCC291"))
	virtual void bpf__OnSuccess_E8D7C13F42790AF8BF4E20A9E2DCC291__pf();
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_E8D7C13F42790AF8BF4E20A9E2DCC291"))
	virtual void bpf__OnFailure_E8D7C13F42790AF8BF4E20A9E2DCC291__pf();
public:
};
