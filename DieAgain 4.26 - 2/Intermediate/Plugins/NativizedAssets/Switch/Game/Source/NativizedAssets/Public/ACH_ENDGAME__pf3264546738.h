...
class AActor;
#include "ACH_ENDGAME__pf3264546738.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Conversations/Events/ACH_ENDGAME.ACH_ENDGAME_C", OverrideNativeName="ACH_ENDGAME_C"))
class UACH_ENDGAME_C__pf3264546738 : public UDialogueEvents
{
public:
	GENERATED_BODY()
	...
	UACH_ENDGAME_C__pf3264546738(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_ACH_ENDGAME__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_ENDGAME__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_ENDGAME__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_ENDGAME__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_ACH_ENDGAME__pf_4(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_86410737436CBAD76AB8958368F4A09F"))
	virtual void bpf__OnSuccess_86410737436CBAD76AB8958368F4A09F__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_86410737436CBAD76AB8958368F4A09F"))
	virtual void bpf__OnFailure_86410737436CBAD76AB8958368F4A09F__pf(FName bpp__WrittenAchievementName__pf, float bpp__WrittenProgress__pf, int32 bpp__WrittenUserTag__pf);
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnSuccess_D1998BF64AA69E650A9C0FBE84F0F8A9"))
	virtual void bpf__OnSuccess_D1998BF64AA69E650A9C0FBE84F0F8A9__pf();
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="OnFailure_D1998BF64AA69E650A9C0FBE84F0F8A9"))
	virtual void bpf__OnFailure_D1998BF64AA69E650A9C0FBE84F0F8A9__pf();
public:
};
