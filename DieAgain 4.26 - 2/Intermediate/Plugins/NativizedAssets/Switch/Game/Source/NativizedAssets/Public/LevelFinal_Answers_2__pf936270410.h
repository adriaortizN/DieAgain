...
class UButton;
class UImage;
#include "LevelFinal_Answers_2__pf936270410.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/HUD/LevelFinal/LevelFinal_Answers_2.LevelFinal_Answers_2_C", OverrideNativeName="LevelFinal_Answers_2_C"))
class ULevelFinal_Answers_2_C__pf936270410 : public UGamepadInteraction_C__pf197907997
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_99", Category="LevelFinal_Answers_2", OverrideNativeName="Button_99"))
	UButton* bpv__Button_99__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Image_43", Category="LevelFinal_Answers_2", OverrideNativeName="Image_43"))
	UImage* bpv__Image_43__pf;
	...
	ULevelFinal_Answers_2_C__pf936270410(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_LevelFinal_Answers_2__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_Answers_2__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LevelFinal_Answers_2__pf_2(int32 bpp__EntryPoint__pf);
