...
#include "GodMode_PutOff__pf575650485.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/HUD/GodMode/GodMode_PutOff.GodMode_PutOff_C", OverrideNativeName="GodMode_PutOff_C"))
class UGodMode_PutOff_C__pf575650485 : public UGamepadInteraction_C__pf197907997
{
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_ActivateGodMode", Category="GodMode_PutOff", OverrideNativeName="Button_ActivateGodMode"))
	UButton* bpv__Button_ActivateGodMode__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Button_GoBack", Category="GodMode_PutOff", OverrideNativeName="Button_GoBack"))
	UButton* bpv__Button_GoBack__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Image_45", Category="GodMode_PutOff", OverrideNativeName="Image_45"))
	...
	UGodMode_PutOff_C__pf575650485(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_GodMode_PutOff__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_GodMode_PutOff__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_GodMode_PutOff__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_GodMode_PutOff__pf_3(int32 bpp__EntryPoint__pf);
