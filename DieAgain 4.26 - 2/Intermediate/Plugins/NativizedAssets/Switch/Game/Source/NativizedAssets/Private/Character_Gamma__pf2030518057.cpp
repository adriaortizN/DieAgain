...
ACharacter_Gamma_C__pf2030518057::ACharacter_Gamma_C__pf2030518057(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	if(__Local__2)
	{
		...
		__Local__2->AnimationData.AnimToPlay = CastChecked<UAnimationAsset>(CastChecked<UDynamicClass>(ACharacter_Gamma_C__pf2030518057::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		__Local__2->AnimationData.bSavedLooping = false;
		__Local__2->ClothingSimulationFactory = UClothingSimulationFactoryNv::StaticClass();
		__Local__2->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(ACharacter_Gamma_C__pf2030518057::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
		...
		__Local__11 = FRotator(0.000000, -90.000000, 0.000000);
	...
	__Local__14 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ACharacter_Gamma_C__pf2030518057::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__Weapon__pf->bReceivesDecals = false;
	auto& __Local__15 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Weapon__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	(((FBoolProperty*)__Local__28)->SetPropertyValue_InContainer((bpv__Weapon__pf), true, 0));
	...
	bpv__MuzzleFlash__pf->Template = CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ACharacter_Gamma_C__pf2030518057::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	auto& __Local__30 = (*(AccessPrivateProperty<FVector >((bpv__MuzzleFlash__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__30 = FVector(-0.000120, 62.999992, 8.000000);
	auto& __Local__31 = (*(AccessPrivateProperty<FRotator >((bpv__MuzzleFlash__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__31 = FRotator(0.000000, 89.999992, 0.000000);
	bpv__MuzzleFlash__pf->PrimaryComponentTick.bStartWithTickEnabled = false;
	(((FBoolProperty*)__Local__28)->SetPropertyValue_InContainer((bpv__MuzzleFlash__pf), false, 0));
	...
	auto& __Local__32 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__GasMask__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__32 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ACharacter_Gamma_C__pf2030518057::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	auto& __Local__33 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__GasMask__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__33 = ECollisionChannel::ECC_WorldStatic;
	auto& __Local__34 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__GasMask__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__34 = ECollisionEnabled::Type::NoCollision;
	auto& __Local__35 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__GasMask__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__39.Channel = FName(TEXT("WorldStatic"));
	__Local__39.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__40 = __Local__36[3];
	__Local__40.Channel = FName(TEXT("WorldDynamic"));
	...
	auto& __Local__48 = (*(AccessPrivateProperty<FVector >((bpv__GasMask__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__48 = FVector(4.363847, -0.000047, 3.859407);
	auto& __Local__49 = (*(AccessPrivateProperty<FRotator >((bpv__GasMask__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__49 = FRotator(0.000690, 89.999947, -89.999680);
	auto& __Local__50 = (*(AccessPrivateProperty<FVector >((bpv__GasMask__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__50 = FVector(0.825000, 0.600000, 0.600000);
	(((FBoolProperty*)__Local__28)->SetPropertyValue_InContainer((bpv__GasMask__pf), false, 0));
	...
	auto& __Local__51 = (*(AccessPrivateProperty<FVector >((bpv__PointLight__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__51 = FVector(8.677920, -27.017000, 6.398310);
	auto& __Local__52 = (*(AccessPrivateProperty<FRotator >((bpv__PointLight__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__52 = FRotator(90.000000, 5.710610, 95.710983);
	auto& __Local__53 = (*(AccessPrivateProperty<FVector >((bpv__PointLight__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__53 = FVector(1.212121, 1.666667, 1.666667);
	(((FBoolProperty*)__Local__28)->SetPropertyValue_InContainer((bpv__PointLight__pf), false, 0));
	...
	auto& __Local__54 = (*(AccessPrivateProperty<USkeletalMeshComponent*>((this), ACharacter::__PPO__Mesh() )));
	__Local__54 = __Local__2;
	auto& __Local__55 = (*(AccessPrivateProperty<UCharacterMovementComponent*>((this), ACharacter::__PPO__CharacterMovement() )));
	__Local__55 = __Local__1;
	auto& __Local__56 = (*(AccessPrivateProperty<UCapsuleComponent*>((this), ACharacter::__PPO__CapsuleComponent() )));
	__Local__56 = __Local__0;
	auto& __Local__57 = (*(AccessPrivateProperty<EActorUpdateOverlapsMethod >((this), AActor::__PPO__DefaultUpdateOverlapsMethodDuringLevelStreaming() )));
	__Local__57 = EActorUpdateOverlapsMethod::OnlyUpdateMovable;
}
PRAGMA_ENABLE_OPTIMIZATION
void ACharacter_Gamma_C__pf2030518057::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ACharacter_Gamma_C__pf2030518057::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__58 = NewObject<USceneComponent>(InDynamicClass, USceneComponent::StaticClass(), TEXT("DefaultSceneRoot_GEN_VARIABLE"), (EObjectFlags)0x00280029);
	...
	(((FBoolProperty*)__Local__59)->SetPropertyValue_InContainer((__Local__58), false, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
void ACharacter_Gamma_C__pf2030518057::bpf__ExecuteUbergraph_Character_Gamma__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 9:
			{
				...
				b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf = Cast<ACharacter_Alfa_C__pf2030518057>(b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf != nullptr);;
		...
		case 10:
			{
				...
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, APossesionPT_Cutscene_C__pf2030518057::StaticClass(), b0l__CallFunc_GetTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AdjustIfPossibleButAlwaysSpawn, ((AActor*)nullptr));
			}
		case 11:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<APossesionPT_Cutscene_C__pf2030518057>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, b0l__CallFunc_GetTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 12:
			{
				b0l__K2Node_MakeStruct_ParticleSysParam__pf.Name = FName(TEXT("Source"));
				b0l__K2Node_MakeStruct_ParticleSysParam__pf.ParamType = EParticleSysParamType::PSPT_Actor;
				b0l__K2Node_MakeStruct_ParticleSysParam__pf.Scalar = 0.000000;
				b0l__K2Node_MakeStruct_ParticleSysParam__pf.Scalar_Low = 0.000000;
				b0l__K2Node_MakeStruct_ParticleSysParam__pf.Vector = FVector(0.000000,0.000000,0.000000);
				b0l__K2Node_MakeStruct_ParticleSysParam__pf.Vector_Low = FVector(0.000000,0.000000,0.000000);
				b0l__K2Node_MakeStruct_ParticleSysParam__pf.Color = FColor(0,0,0,0);
				b0l__K2Node_MakeStruct_ParticleSysParam__pf.Actor = this;
				b0l__K2Node_MakeStruct_ParticleSysParam__pf.Material = ((UMaterialInterface*)nullptr);
				b0l__K2Node_MakeStruct_ParticleSysParam_1__pf.Name = FName(TEXT("Target"));
				b0l__K2Node_MakeStruct_ParticleSysParam_1__pf.ParamType = EParticleSysParamType::PSPT_Actor;
				b0l__K2Node_MakeStruct_ParticleSysParam_1__pf.Scalar = 0.000000;
				b0l__K2Node_MakeStruct_ParticleSysParam_1__pf.Scalar_Low = 0.000000;
				b0l__K2Node_MakeStruct_ParticleSysParam_1__pf.Vector = FVector(0.000000,0.000000,0.000000);
				b0l__K2Node_MakeStruct_ParticleSysParam_1__pf.Vector_Low = FVector(0.000000,0.000000,0.000000);
				b0l__K2Node_MakeStruct_ParticleSysParam_1__pf.Color = FColor(0,0,0,0);
				b0l__K2Node_MakeStruct_ParticleSysParam_1__pf.Actor = b0l__K2Node_DynamicCast_AsCharacter_Alfa__pf;
				b0l__K2Node_MakeStruct_ParticleSysParam_1__pf.Material = ((UMaterialInterface*)nullptr);
				b0l__K2Node_MakeArray_Array__pf.SetNum(2, true);
				b0l__K2Node_MakeArray_Array__pf[0] = b0l__K2Node_MakeStruct_ParticleSysParam__pf;
				b0l__K2Node_MakeArray_Array__pf[1] = b0l__K2Node_MakeStruct_ParticleSysParam_1__pf;
				...
				{
					bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf->bpv__ParticleSystem__pf->InstanceParameters = b0l__K2Node_MakeArray_Array__pf;
				}
			}
		case 13:
			{
		...
		case 14:
			{
				...
				{
					bpv__Weapon__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(5.968900,1.685070,-2.587900), FRotator(-0.098500,106.195999,-175.210007), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult_1__pf, true);
				}
			}
		case 15:
			{
				UKismetSystemLibrary::Delay(this, 2.300000, FLatentActionInfo(3, 910396500, TEXT("ExecuteUbergraph_Character_Gamma_0"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 16:
		...
		case 30:
			{
				FRotator  __Local__62 = FRotator(0.000000,0.000000,0.000000);
				UKismetMathLibrary::BreakRotator(((::IsValid((*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() ))))) ? ((*(AccessPrivateProperty<FRotator >(((*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() )))), USceneComponent::__PPO__RelativeRotation() )))) : (__Local__62)), /*out*/ b0l__CallFunc_BreakRotator_Roll__pf, /*out*/ b0l__CallFunc_BreakRotator_Pitch__pf, /*out*/ b0l__CallFunc_BreakRotator_Yaw__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(b0l__CallFunc_BreakRotator_Yaw__pf, 160.000000);
				...
				{
					(*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() )))->USceneComponent::K2_SetRelativeRotation(bpfv__CallFunc_MakeRotator_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeRotation_SweepHitResult__pf, true);
				}
			}
		case 31:
			{
				(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Reset();
				UGameplayStatics::GetAllActorsOfClass(this, ACharacter_Alfa_C__pf2030518057::StaticClass(), /*out*/ TArrayCaster<ACharacter_Alfa_C__pf2030518057*>(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
				__CurrentState = 20;
				break;
			}
		default:
...
void ACharacter_Gamma_C__pf2030518057::bpf__ExecuteUbergraph_Character_Gamma__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 38:
			{
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_2__pf = UKismetMathLibrary::Add_FloatFloat(bpv__IntensityLight__pf, -7.500000);
				bpv__IntensityLight__pf = bpfv__CallFunc_Add_FloatFloat_ReturnValue_2__pf;
			}
		case 39:
			{
...
void ACharacter_Gamma_C__pf2030518057::bpf__ExecuteUbergraph_Character_Gamma__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 34:
			{
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::Add_FloatFloat(bpv__IntensityLight__pf, 15.000000);
...
void ACharacter_Gamma_C__pf2030518057::bpf__ExecuteUbergraph_Character_Gamma__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 27:
			{
				UKismetSystemLibrary::Delay(this, 12.900000, FLatentActionInfo(1, -1718239388, TEXT("ExecuteUbergraph_Character_Gamma_3"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void ACharacter_Gamma_C__pf2030518057::bpf__OffLightFunction__pf()
{
	bpf__ExecuteUbergraph_Character_Gamma__pf_1(36);
}
void ACharacter_Gamma_C__pf2030518057::bpf__LightFunction__pf()
{
	bpf__ExecuteUbergraph_Character_Gamma__pf_2(32);
}
void ACharacter_Gamma_C__pf2030518057::bpf__MoveToSecondTarget__pf()
{
	bpf__ExecuteUbergraph_Character_Gamma__pf_0(28);
}
void ACharacter_Gamma_C__pf2030518057::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Character_Gamma__pf_3(21);
}
void ACharacter_Gamma_C__pf2030518057::bpf__MoveTo__pf(ATargetPoint_Cutscene_C__pf2030518057* bpp__TargetPoint__pf)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ACharacter_Gamma_C__pf2030518057::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ACharacter_Gamma_C__pf2030518057::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{127, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/Engine.ParticleSysParam 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ACharacter_Gamma_C__pf2030518057
{
	FRegisterHelper__ACharacter_Gamma_C__pf2030518057()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Objects/Cutscene/Character_Gamma"), &ACharacter_Gamma_C__pf2030518057::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ACharacter_Gamma_C__pf2030518057 Instance;
};
FRegisterHelper__ACharacter_Gamma_C__pf2030518057 FRegisterHelper__ACharacter_Gamma_C__pf2030518057::Instance;
