...
#include "DeathTrigger_Steiner__pf2030518057.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Objects/Cutscene/DeathTrigger_Steiner.DeathTrigger_Steiner_C", OverrideNativeName="DeathTrigger_Steiner_C"))
class ADeathTrigger_Steiner_C__pf2030518057 : public AActor
{
public:
	GENERATED_BODY()
	...
	ADeathTrigger_Steiner_C__pf2030518057(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_DeathTrigger_Steiner__pf_0(int32 bpp__EntryPoint__pf);
