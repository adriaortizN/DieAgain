...
UGamepadInteraction_C__pf197907997::UGamepadInteraction_C__pf197907997(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	bpv__Buttons__pf = TArray<UButton*> ();
	bpv__hoverStyle__pf.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__0 = (*(AccessPrivateProperty<UObject* >(&(bpv__hoverStyle__pf.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__0 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGamepadInteraction_C__pf197907997::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__hoverStyle__pf.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__1 = (*(AccessPrivateProperty<UObject* >(&(bpv__hoverStyle__pf.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__1 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGamepadInteraction_C__pf197907997::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__hoverStyle__pf.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__2 = (*(AccessPrivateProperty<UObject* >(&(bpv__hoverStyle__pf.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__2 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGamepadInteraction_C__pf197907997::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__defaultStyle__pf.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__3 = (*(AccessPrivateProperty<UObject* >(&(bpv__defaultStyle__pf.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__3 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGamepadInteraction_C__pf197907997::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__defaultStyle__pf.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__4 = (*(AccessPrivateProperty<UObject* >(&(bpv__defaultStyle__pf.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__4 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGamepadInteraction_C__pf197907997::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__defaultStyle__pf.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__5 = (*(AccessPrivateProperty<UObject* >(&(bpv__defaultStyle__pf.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__5 = CastChecked<UObject>(CastChecked<UDynamicClass>(UGamepadInteraction_C__pf197907997::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bHasScriptImplementedPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UGamepadInteraction_C__pf197907997::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UGamepadInteraction_C__pf197907997::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__7 = NewObject<UCanvasPanel>(__Local__6, TEXT("CanvasPanel_0"), (EObjectFlags)0x00280008);
	__Local__6->RootWidget = __Local__7;
}
PRAGMA_ENABLE_OPTIMIZATION
void UGamepadInteraction_C__pf197907997::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__8;
	SlotNames.Append(__Local__8);
}
void UGamepadInteraction_C__pf197907997::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__9;
	TArray<FDelegateRuntimeBinding>  __Local__10;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UGamepadInteraction_C__pf197907997::StaticClass())->MiscConvertedSubobjects[0]), __Local__9, __Local__10);
}
void UGamepadInteraction_C__pf197907997::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UGamepadInteraction_C__pf197907997::bpf__ExecuteUbergraph_GamepadInteraction__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_AsDie_Again_Gamemode_1__pf = Cast<ADieAgainGamemode_C__pf1010915279>(bpfv__CallFunc_GetGameMode_ReturnValue_1__pf);
	b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsDie_Again_Gamemode_1__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess_1__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsDie_Again_Gamemode_1__pf))
	{
		b0l__K2Node_DynamicCast_AsDie_Again_Gamemode_1__pf->bpf__ResetWidget__pf(b0l__K2Node_CustomEvent_New_Widget__pf);
	}
	return; //KCST_EndOfThread
}
void UGamepadInteraction_C__pf197907997::bpf__ExecuteUbergraph_GamepadInteraction__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	UWidgetBlueprintLibrary::SetInputMode_GameAndUIEx(bpfv__CallFunc_GetPlayerController_ReturnValue__pf, this, EMouseLockMode::DoNotLock, false);
	...
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsDie_Again_Gamemode__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsDie_Again_Gamemode__pf))
	{
		b0l__K2Node_DynamicCast_AsDie_Again_Gamemode__pf->bpf__AddCustomCursor__pf();
	}
	return; //KCST_EndOfThread
}
void UGamepadInteraction_C__pf197907997::bpf__ExecuteUbergraph_GamepadInteraction__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	FCustomThunkTemplates::Array_Get(bpv__Buttons__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
	UWidgetBlueprintLibrary::SetInputMode_GameAndUIEx(bpfv__CallFunc_GetPlayerController_ReturnValue_1__pf, b0l__CallFunc_Array_Get_Item_1__pf, EMouseLockMode::DoNotLock, false);
	bpf__UpdateFocus__pf();
	return; //KCST_EndOfThread
}
void UGamepadInteraction_C__pf197907997::bpf__ExecuteUbergraph_GamepadInteraction__pf_3(int32 bpp__EntryPoint__pf)
{
...
void UGamepadInteraction_C__pf197907997::bpf__ExecuteUbergraph_GamepadInteraction__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 7:
			{
				FCustomThunkTemplates::Array_Get(bpv__Buttons__pf, b0l__Temp_int_Array_Index_Variable__pf, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
				if(::IsValid(b0l__CallFunc_Array_Get_Item__pf))
				{
					bpfv__CallFunc_HasAnyUserFocus_ReturnValue__pf = b0l__CallFunc_Array_Get_Item__pf->UWidget::HasAnyUserFocus();
				}
		...
		case 8:
			{
				...
				if(::IsValid(b0l__CallFunc_Array_Get_Item__pf))
				{
					b0l__CallFunc_Array_Get_Item__pf->UButton::SetStyle(bpv__hoverStyle__pf);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 10:
			{
				...
				if(::IsValid(b0l__CallFunc_Array_Get_Item__pf))
				{
					b0l__CallFunc_Array_Get_Item__pf->UButton::SetStyle(bpv__defaultStyle__pf);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
void UGamepadInteraction_C__pf197907997::bpf__ExecuteUbergraph_GamepadInteraction__pf_5(int32 bpp__EntryPoint__pf)
{
...
void UGamepadInteraction_C__pf197907997::bpf__ResetWidget__pf(UGamepadInteraction_C__pf197907997* bpp__NewxWidget__pfT)
{
	b0l__K2Node_CustomEvent_New_Widget__pf = bpp__NewxWidget__pfT;
	bpf__ExecuteUbergraph_GamepadInteraction__pf_0(24);
}
void UGamepadInteraction_C__pf197907997::bpf__UpdateFocus__pf()
{
	bpf__ExecuteUbergraph_GamepadInteraction__pf_4(23);
}
void UGamepadInteraction_C__pf197907997::bpf__InitFocus__pf()
{
	bpf__ExecuteUbergraph_GamepadInteraction__pf_2(20);
}
void UGamepadInteraction_C__pf197907997::bpf__RemoveFocus__pf()
{
	bpf__ExecuteUbergraph_GamepadInteraction__pf_3(17);
}
void UGamepadInteraction_C__pf197907997::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b0l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b0l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_GamepadInteraction__pf_5(15);
}
void UGamepadInteraction_C__pf197907997::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_GamepadInteraction__pf_1(12);
}
PRAGMA_DISABLE_OPTIMIZATION
void UGamepadInteraction_C__pf197907997::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UGamepadInteraction_C__pf197907997::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{23, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/DialoguePlugin.DialogueUserWidget 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UGamepadInteraction_C__pf197907997
{
	FRegisterHelper__UGamepadInteraction_C__pf197907997()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/GamepadInteraction"), &UGamepadInteraction_C__pf197907997::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UGamepadInteraction_C__pf197907997 Instance;
};
FRegisterHelper__UGamepadInteraction_C__pf197907997 FRegisterHelper__UGamepadInteraction_C__pf197907997::Instance;
