...
UPause_WorldMap_HUD_C__pf197907997::UPause_WorldMap_HUD_C__pf197907997(const FObjectInitializer& ObjectInitializer) : Super()
{
...
void UPause_WorldMap_HUD_C__pf197907997::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UPause_WorldMap_HUD_C__pf197907997::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UWorldMapHUDRe_C__pf197907997::StaticClass());
	...
	auto __Local__2 = NewObject<UWidgetAnimation>(InDynamicClass, UWidgetAnimation::StaticClass(), TEXT("ChangeAvatarAnim_INST"), (EObjectFlags)0x00280008);
	...
	__Local__3.ComponentPropertyName = FName(TEXT("Button_2"));
	__Local__3.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__Button_2_K2Node_ComponentBoundEvent_7_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__4 = __Local__0->ComponentDelegateBindings[1];
	__Local__4.ComponentPropertyName = FName(TEXT("Button_1"));
	__Local__4.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__Button_1_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature"));
	...
	__Local__5.FunctionNameToBind = FName(TEXT("BndEvt__Button_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__6 = __Local__0->ComponentDelegateBindings[3];
	__Local__6.ComponentPropertyName = FName(TEXT("Button_67"));
	__Local__6.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__6.FunctionNameToBind = FName(TEXT("BndEvt__Button_67_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__7 = __Local__0->ComponentDelegateBindings[4];
	__Local__7.ComponentPropertyName = FName(TEXT("Button_397"));
	__Local__7.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__7.FunctionNameToBind = FName(TEXT("BndEvt__Button_397_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__8 = __Local__0->ComponentDelegateBindings[5];
	__Local__8.ComponentPropertyName = FName(TEXT("Button_262"));
	__Local__8.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__8.FunctionNameToBind = FName(TEXT("BndEvt__Button_262_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__9 = __Local__0->ComponentDelegateBindings[6];
	__Local__9.ComponentPropertyName = FName(TEXT("Button_519"));
	__Local__9.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__9.FunctionNameToBind = FName(TEXT("BndEvt__Button_519_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	auto& __Local__10 = __Local__0->ComponentDelegateBindings[7];
	__Local__10.ComponentPropertyName = FName(TEXT("Button_56"));
	__Local__10.DelegatePropertyName = FName(TEXT("OnClicked"));
	__Local__10.FunctionNameToBind = FName(TEXT("BndEvt__Button_56_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	auto __Local__13 = NewObject<UCanvasPanelSlot>(__Local__11, TEXT("CanvasPanelSlot_1"), (EObjectFlags)0x00280008);
	__Local__13->LayoutData.Offsets.Left = -300.960938f;
	__Local__13->LayoutData.Offsets.Top = 104.000000f;
	__Local__13->LayoutData.Offsets.Right = 612.245605f;
	__Local__13->LayoutData.Offsets.Bottom = 338.308289f;
	__Local__13->LayoutData.Anchors.Minimum = FVector2D(0.500000, 0.000000);
	__Local__13->LayoutData.Anchors.Maximum = FVector2D(0.500000, 0.000000);
	__Local__13->Parent = __Local__11;
	auto __Local__14 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_56"), (EObjectFlags)0x00280008);
	__Local__14->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[6506F03B48BF37348FD4AD89E5D51268]\", \"1A2CC66F4FF5B1EBDC3D07B5C5EED8E2\", \"Pause\")")	);
	__Local__14->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPause_WorldMap_HUD_C__pf197907997::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__14->Font.OutlineSettings.OutlineSize = 5;
	__Local__14->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__14->Font.Size = 80;
	...
	auto __Local__18 = NewObject<UCanvasPanelSlot>(__Local__11, TEXT("CanvasPanelSlot_5"), (EObjectFlags)0x00280008);
	__Local__18->LayoutData.Offsets.Top = 77.509521f;
	__Local__18->LayoutData.Offsets.Right = 1599.277100f;
	__Local__18->LayoutData.Offsets.Bottom = 140.100098f;
	...
	auto __Local__19 = NewObject<UHorizontalBox>(__Local__1, TEXT("HorizontalBox_59"), (EObjectFlags)0x00280008);
	...
	auto __Local__21 = NewObject<UHorizontalBoxSlot>(__Local__19, TEXT("HorizontalBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__21->Padding.Right = 400.000000f;
	__Local__21->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__21->Parent = __Local__19;
	auto __Local__22 = NewObject<UButton>(__Local__1, TEXT("Button_519"), (EObjectFlags)0x00280008);
	...
	__Local__24 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPause_WorldMap_HUD_C__pf197907997::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	__Local__25 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPause_WorldMap_HUD_C__pf197907997::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	__Local__27 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPause_WorldMap_HUD_C__pf197907997::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	auto __Local__30 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_606"), (EObjectFlags)0x00280008);
	__Local__30->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[6506F03B48BF37348FD4AD89E5D51268]\", \"EAD1907747605E8D57322299F5DE99E8\", \"Resume\")")	);
	...
	__Local__30->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPause_WorldMap_HUD_C__pf197907997::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__30->Font.OutlineSettings.OutlineSize = 5;
	__Local__30->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__30->Font.Size = 60;
	...
	auto __Local__32 = NewObject<UHorizontalBoxSlot>(__Local__19, TEXT("HorizontalBoxSlot_2"), (EObjectFlags)0x00280008);
	__Local__32->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__32->Parent = __Local__19;
	auto __Local__33 = NewObject<UButton>(__Local__1, TEXT("Button_56"), (EObjectFlags)0x00280008);
	__Local__33->WidgetStyle.Normal.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__34 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__33->WidgetStyle.Normal.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__34 = FLinearColor(0.000000, 0.000000, 1.000000, 1.000000);
	auto& __Local__35 = (*(AccessPrivateProperty<UObject* >(&(__Local__33->WidgetStyle.Normal), FSlateBrush::__PPO__ResourceObject() )));
	__Local__35 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPause_WorldMap_HUD_C__pf197907997::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__33->WidgetStyle.Hovered.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__36 = (*(AccessPrivateProperty<UObject* >(&(__Local__33->WidgetStyle.Hovered), FSlateBrush::__PPO__ResourceObject() )));
	__Local__36 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPause_WorldMap_HUD_C__pf197907997::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	__Local__33->WidgetStyle.Pressed.ImageSize = FVector2D(809.000000, 207.000000);
	auto& __Local__37 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__33->WidgetStyle.Pressed.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__37 = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
	auto& __Local__38 = (*(AccessPrivateProperty<UObject* >(&(__Local__33->WidgetStyle.Pressed), FSlateBrush::__PPO__ResourceObject() )));
	__Local__38 = CastChecked<UObject>(CastChecked<UDynamicClass>(UPause_WorldMap_HUD_C__pf197907997::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	auto& __Local__39 = (*(AccessPrivateProperty<TArray<UPanelSlot*> >((__Local__33), UPanelWidget::__PPO__Slots() )));
	__Local__39 = TArray<UPanelSlot*> ();
	__Local__39.Reserve(1);
	auto __Local__40 = NewObject<UButtonSlot>(__Local__33, TEXT("ButtonSlot_0"), (EObjectFlags)0x00280008);
	__Local__40->Parent = __Local__33;
	auto __Local__41 = NewObject<UTextBlock>(__Local__1, TEXT("TextBlock_195"), (EObjectFlags)0x00280008);
	__Local__41->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[6506F03B48BF37348FD4AD89E5D51268]\", \"B27EA3FD415045130293A5B0DA73D8A3\", \"Go to Main Menu\")")	);
	auto& __Local__42 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__41->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__42 = FLinearColor(1.000000, 1.000000, 1.000000, 2.000000);
	__Local__41->Font.FontObject = CastChecked<UObject>(CastChecked<UDynamicClass>(UPause_WorldMap_HUD_C__pf197907997::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__41->Font.OutlineSettings.OutlineSize = 5;
	__Local__41->Font.TypefaceFontName = FName(TEXT("Default"));
	__Local__41->Font.Size = 60;
	...
	__Local__20.Add(__Local__32);
	__Local__19->Slot = __Local__18;
	auto __Local__43 = NewObject<UWidgetNavigation>(__Local__19, TEXT("WidgetNavigation_0"), (EObjectFlags)0x00280008);
	__Local__43->Left.Rule = EUINavigationRule::Stop;
	__Local__43->Right.Rule = EUINavigationRule::Stop;
	__Local__19->Navigation = __Local__43;
	__Local__18->Content = __Local__19;
	__Local__12.Add(__Local__18);
	__Local__1->RootWidget = __Local__11;
	auto __Local__44 = NewObject<UMovieScene>(__Local__2, TEXT("ChangeAvatarAnim"), (EObjectFlags)0x00280008);
	auto& __Local__45 = (*(AccessPrivateProperty<TArray<FMovieScenePossessable> >((__Local__44), UMovieScene::__PPO__Possessables() )));
	__Local__45 = TArray<FMovieScenePossessable> ();
	__Local__45.AddUninitialized(1);
	FMovieScenePossessable::StaticStruct()->InitializeStruct(__Local__45.GetData(), 1);
	...
	__Local__47 = FGuid(0x6FFD0D85, 0x46303CF4, 0x464C9E97, 0x1DAC50CD);
	auto& __Local__48 = (*(AccessPrivateProperty<FString >(&(__Local__46), FMovieScenePossessable::__PPO__Name() )));
	__Local__48 = FString(TEXT("TextBlock_2"));
	auto& __Local__49 = (*(AccessPrivateProperty<UClass* >(&(__Local__46), FMovieScenePossessable::__PPO__PossessedObjectClass() )));
	__Local__49 = UTextBlock::StaticClass();
	auto& __Local__50 = (*(AccessPrivateProperty<TArray<FMovieSceneBinding> >((__Local__44), UMovieScene::__PPO__ObjectBindings() )));
	__Local__50 = TArray<FMovieSceneBinding> ();
	__Local__50.AddUninitialized(1);
	FMovieSceneBinding::StaticStruct()->InitializeStruct(__Local__50.GetData(), 1);
	auto& __Local__51 = __Local__50[0];
	auto& __Local__52 = (*(AccessPrivateProperty<FGuid >(&(__Local__51), FMovieSceneBinding::__PPO__ObjectGuid() )));
	__Local__52 = FGuid(0x6FFD0D85, 0x46303CF4, 0x464C9E97, 0x1DAC50CD);
	auto& __Local__53 = (*(AccessPrivateProperty<FString >(&(__Local__51), FMovieSceneBinding::__PPO__BindingName() )));
	__Local__53 = FString(TEXT("TextBlock_2"));
	auto& __Local__54 = (*(AccessPrivateProperty<TArray<UMovieSceneTrack*> >(&(__Local__51), FMovieSceneBinding::__PPO__Tracks() )));
	__Local__54 = TArray<UMovieSceneTrack*> ();
	__Local__54.Reserve(1);
	auto __Local__55 = NewObject<UMovieScene2DTransformTrack>(__Local__44, TEXT("MovieScene2DTransformTrack_0"), (EObjectFlags)0x00280008);
	auto& __Local__56 = (*(AccessPrivateProperty<FMovieScenePropertyBinding >((__Local__55), UMovieScenePropertyTrack::__PPO__PropertyBinding() )));
	__Local__56.PropertyName = FName(TEXT("RenderTransform"));
	__Local__56.PropertyPath = FName(TEXT("RenderTransform"));
	__Local__56.bCanUseClassLookup = true;
	auto& __Local__57 = (*(AccessPrivateProperty<TArray<UMovieSceneSection*> >((__Local__55), UMovieScenePropertyTrack::__PPO__Sections() )));
	__Local__57 = TArray<UMovieSceneSection*> ();
	__Local__57.Reserve(1);
	auto __Local__58 = NewObject<UMovieScene2DTransformSection>(__Local__55, TEXT("MovieScene2DTransformSection_0"), (EObjectFlags)0x00280008);
	auto __Local__59 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__58->GetDefaultSubobjectByName(TEXT("EaseInFunction")), ECastCheckedType::NullAllowed);
	auto __Local__60 = CastChecked<UMovieSceneBuiltInEasingFunction>(__Local__58->GetDefaultSubobjectByName(TEXT("EaseOutFunction")), ECastCheckedType::NullAllowed);
	if(__Local__59)
	{
	...
	auto& __Local__61 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__58->Scale[0]), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__61 = TArray<FFrameNumber> ();
	__Local__61.Reserve(3);
	__Local__61.Add(FFrameNumber{});
	__Local__61.Add(FFrameNumber{});
	__Local__61[1].Value = 90000;
	__Local__61.Add(FFrameNumber{});
	__Local__61[2].Value = 180000;
	auto& __Local__62 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__58->Scale[0]), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__62 = TArray<FMovieSceneFloatValue> ();
	__Local__62.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__62.GetData(), 3);
	auto& __Local__63 = __Local__62[0];
	__Local__63.Value = 1.000000f;
	auto& __Local__64 = __Local__62[1];
	__Local__64.Value = 1.150000f;
	auto& __Local__65 = __Local__62[2];
	__Local__65.Value = 1.000000f;
	auto& __Local__66 = (*(AccessPrivateProperty<TArray<FFrameNumber> >(&(__Local__58->Scale[1]), FMovieSceneFloatChannel::__PPO__Times() )));
	__Local__66 = TArray<FFrameNumber> ();
	__Local__66.Reserve(3);
	__Local__66.Add(FFrameNumber{});
	__Local__66.Add(FFrameNumber{});
	__Local__66[1].Value = 90000;
	__Local__66.Add(FFrameNumber{});
	__Local__66[2].Value = 180000;
	auto& __Local__67 = (*(AccessPrivateProperty<TArray<FMovieSceneFloatValue> >(&(__Local__58->Scale[1]), FMovieSceneFloatChannel::__PPO__Values() )));
	__Local__67 = TArray<FMovieSceneFloatValue> ();
	__Local__67.AddUninitialized(3);
	FMovieSceneFloatValue::StaticStruct()->InitializeStruct(__Local__67.GetData(), 3);
	auto& __Local__68 = __Local__67[0];
	__Local__68.Value = 1.000000f;
	auto& __Local__69 = __Local__67[1];
	__Local__69.Value = 1.150000f;
	auto& __Local__70 = __Local__67[2];
	__Local__70.Value = 1.000000f;
	__Local__58->EvalOptions.CompletionMode = EMovieSceneCompletionMode::KeepState;
	__Local__58->Easing.EaseIn = __Local__59;
	__Local__58->Easing.EaseOut = __Local__60;
	__Local__58->SectionRange = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Inclusive(180000)));
	auto& __Local__71 = (*(AccessPrivateProperty<FGuid >((__Local__58), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__71 = FGuid(0x1628D079, 0x4BAF14BA, 0x500D35A6, 0x6E0B5DD7);
	__Local__57.Add(__Local__58);
	auto& __Local__72 = (*(AccessPrivateProperty<FGuid >((__Local__55), UMovieSceneTrack::__PPO__EvaluationFieldGuid() )));
	__Local__72 = FGuid(0xA48B3DB2, 0x4F9592F9, 0xA83934BF, 0xCDB327D4);
	auto& __Local__73 = (*(AccessPrivateProperty<FMovieSceneTrackEvaluationField >((__Local__55), UMovieSceneTrack::__PPO__EvaluationField() )));
	...
	__Local__74.Section = __Local__58;
	static TWeakFieldPtr<FProperty> __Local__76{};
	const FProperty* __Local__75 = __Local__76.Get();
	if (nullptr == __Local__75)
	{
		__Local__75 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("LowerBound")));
		check(__Local__75);
		__Local__76 = __Local__75;
	}
	auto& __Local__77 = (*(__Local__75->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__74.Range), 0)));
	static TWeakFieldPtr<FProperty> __Local__79{};
	const FProperty* __Local__78 = __Local__79.Get();
	if (nullptr == __Local__78)
	{
		__Local__78 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Type")));
		check(__Local__78);
		__Local__79 = __Local__78;
	}
	auto& __Local__80 = (*(__Local__78->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__77), 0)));
	__Local__80 = ERangeBoundTypes::Type::Inclusive;
	static TWeakFieldPtr<FProperty> __Local__82{};
	const FProperty* __Local__81 = __Local__82.Get();
	if (nullptr == __Local__81)
	{
		__Local__81 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRange"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("UpperBound")));
		check(__Local__81);
		__Local__82 = __Local__81;
	}
	auto& __Local__83 = (*(__Local__81->ContainerPtrToValuePtr<FFrameNumberRangeBound >(&(__Local__74.Range), 0)));
	auto& __Local__84 = (*(__Local__78->ContainerPtrToValuePtr<TEnumAsByte<ERangeBoundTypes::Type> >(&(__Local__83), 0)));
	__Local__84 = ERangeBoundTypes::Type::Inclusive;
	static TWeakFieldPtr<FProperty> __Local__86{};
	const FProperty* __Local__85 = __Local__86.Get();
	if (nullptr == __Local__85)
	{
		__Local__85 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameNumberRangeBound"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Value")));
		check(__Local__85);
		__Local__86 = __Local__85;
	}
	auto& __Local__87 = (*(__Local__85->ContainerPtrToValuePtr<FFrameNumber >(&(__Local__83), 0)));
	__Local__87.Value = 180000;
	__Local__74.ForcedTime.Value = (-2147483647 - 1);
	auto& __Local__88 = (*(AccessPrivateProperty<FGuid >((__Local__55), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__88 = FGuid(0xA48B3DB2, 0x4F9592F9, 0xA83934BF, 0xCDB327D4);
	__Local__54.Add(__Local__55);
	auto& __Local__89 = (*(AccessPrivateProperty<FMovieSceneFrameRange >((__Local__44), UMovieScene::__PPO__PlaybackRange() )));
	__Local__89 = FMovieSceneFrameRange(TRange<FFrameNumber>(TRangeBound<FFrameNumber>::Inclusive(0), TRangeBound<FFrameNumber>::Exclusive(180001)));
	auto& __Local__90 = (*(AccessPrivateProperty<FFrameRate >((__Local__44), UMovieScene::__PPO__DisplayRate() )));
	static TWeakFieldPtr<FProperty> __Local__92{};
	const FProperty* __Local__91 = __Local__92.Get();
	if (nullptr == __Local__91)
	{
		__Local__91 = (CastChecked<UScriptStruct>(FStructUtils::FindStructureInPackageChecked(TEXT("FrameRate"), TEXT("/Script/CoreUObject"))))->FindPropertyByName(FName(TEXT("Numerator")));
		check(__Local__91);
		__Local__92 = __Local__91;
	}
	auto& __Local__93 = (*(__Local__91->ContainerPtrToValuePtr<int32 >(&(__Local__90), 0)));
	__Local__93 = 20;
	auto& __Local__94 = (*(AccessPrivateProperty<FGuid >((__Local__44), UMovieSceneSignedObject::__PPO__Signature() )));
	__Local__94 = FGuid(0xF3D90AB7, 0x4715300F, 0xFDFCFAB8, 0xA937EE31);
	__Local__2->MovieScene = __Local__44;
	...
	__Local__95.WidgetName = FName(TEXT("TextBlock_2"));
	__Local__95.AnimationGuid = FGuid(0x6FFD0D85, 0x46303CF4, 0x464C9E97, 0x1DAC50CD);
	auto& __Local__96 = (*(AccessPrivateProperty<FString >((__Local__2), UWidgetAnimation::__PPO__DisplayLabel() )));
	__Local__96 = FString(TEXT("ChangeAvatarAnim"));
	...
	__Local__97 = FGuid(0xFE754F56, 0x4A15CE98, 0x7CE2E281, 0xC598761D);
	UMovieSceneCompiledDataManager::GetPrecompiledData()->Compile(__Local__2);
}
PRAGMA_ENABLE_OPTIMIZATION
void UPause_WorldMap_HUD_C__pf197907997::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__98;
	SlotNames.Append(__Local__98);
}
void UPause_WorldMap_HUD_C__pf197907997::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__99;
	__Local__99.Reserve(1);
	__Local__99.Add(CastChecked<UWidgetAnimation>(CastChecked<UDynamicClass>(UPause_WorldMap_HUD_C__pf197907997::StaticClass())->MiscConvertedSubobjects[1]));
	TArray<FDelegateRuntimeBinding>  __Local__100;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UPause_WorldMap_HUD_C__pf197907997::StaticClass())->MiscConvertedSubobjects[0]), __Local__99, __Local__100);
}
void UPause_WorldMap_HUD_C__pf197907997::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UPause_WorldMap_HUD_C__pf197907997::bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 12);
	// optimized KCST_UnconditionalGoto
	bpf__CreatexMenu__pfT();
	return; // KCST_GotoReturn
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	b1l__K2Node_MakeArray_Array__pf[0] = bpv__Button_519__pf;
	b1l__K2Node_MakeArray_Array__pf[1] = bpv__Button_56__pf;
	bpv__Buttons__pf = b1l__K2Node_MakeArray_Array__pf;
	Super::bpf__Construct__pf();
	return; // KCST_GotoReturn
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_2(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_SetGamePaused_ReturnValue_1__pf{};
	UWorldMapHUDRe_C__pf197907997* bpfv__CallFunc_Create_ReturnValue_2__pf{};
	check(bpp__EntryPoint__pf == 40);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Create_ReturnValue_2__pf = CastChecked<UWorldMapHUDRe_C__pf197907997>(UWidgetBlueprintLibrary::Create(this, UWorldMapHUDRe_C__pf197907997::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
...
void UPause_WorldMap_HUD_C__pf197907997::bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_3(int32 bpp__EntryPoint__pf)
{
...
void UPause_WorldMap_HUD_C__pf197907997::bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_4(int32 bpp__EntryPoint__pf)
{
...
void UPause_WorldMap_HUD_C__pf197907997::bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_5(int32 bpp__EntryPoint__pf)
{
...
void UPause_WorldMap_HUD_C__pf197907997::bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_6(int32 bpp__EntryPoint__pf)
{
...
void UPause_WorldMap_HUD_C__pf197907997::bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_7(int32 bpp__EntryPoint__pf)
{
...
void UPause_WorldMap_HUD_C__pf197907997::bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_8(int32 bpp__EntryPoint__pf)
{
...
void UPause_WorldMap_HUD_C__pf197907997::bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_9(int32 bpp__EntryPoint__pf)
{
...
void UPause_WorldMap_HUD_C__pf197907997::bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_10(int32 bpp__EntryPoint__pf)
{
...
void UPause_WorldMap_HUD_C__pf197907997::bpf__CreatexMenu__pfT()
{
	bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_2(40);
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__BndEvt__Button_2_K2Node_ComponentBoundEvent_7_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_5(38);
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__BndEvt__Button_1_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_6(34);
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__BndEvt__Button_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_7(32);
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__BndEvt__Button_67_K2Node_ComponentBoundEvent_4_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_8(28);
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__BndEvt__Button_397_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_4(19);
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__BndEvt__Button_262_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_9(14);
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__BndEvt__Button_519_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_0(12);
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__BndEvt__Button_56_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_3(10);
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b1l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b1l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_10(8);
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_Pause_WorldMap_HUD__pf_1(3);
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__GetText_0__pf()
{
	FText bpfv__TextPause__pf{};
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__GetText_1__pf()
{
	FText bpfv__TextFinalCredits__pf{};
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__GetText_2__pf()
{
	FText bpfv__TextClose__pf{};
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__GetText_3__pf()
{
	FText bpfv__TextResume__pf{};
}
void UPause_WorldMap_HUD_C__pf197907997::bpf__GetText_4__pf()
{
	FText bpfv__TextLanguage__pf{};
}
ESlateVisibility  UPause_WorldMap_HUD_C__pf197907997::bpf__GetVisibility_0__pf()
{
		...
		case 3:
			{
				...
				bpfv__Temp_bool_Variable__pf = ((::IsValid(bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf)) ? (bpfv__K2Node_DynamicCast_AsSave_Game_BP__pf->bpv__IsRobotUnlocked__pf) : (__Local__101));
...
PRAGMA_DISABLE_OPTIMIZATION
void UPause_WorldMap_HUD_C__pf197907997::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UPause_WorldMap_HUD_C__pf197907997::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{731, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/HUD/WorldMapHUDRe.WorldMapHUDRe_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UPause_WorldMap_HUD_C__pf197907997
{
	FRegisterHelper__UPause_WorldMap_HUD_C__pf197907997()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HUD/Pause_WorldMap_HUD"), &UPause_WorldMap_HUD_C__pf197907997::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UPause_WorldMap_HUD_C__pf197907997 Instance;
};
FRegisterHelper__UPause_WorldMap_HUD_C__pf197907997 FRegisterHelper__UPause_WorldMap_HUD_C__pf197907997::Instance;
