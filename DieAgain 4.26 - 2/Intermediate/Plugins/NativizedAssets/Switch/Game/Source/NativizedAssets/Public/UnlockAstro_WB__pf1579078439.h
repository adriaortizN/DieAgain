...
#include "UnlockAstro_WB__pf1579078439.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/HUD/Unlock_Skin/UnlockAstro_WB.UnlockAstro_WB_C", OverrideNativeName="UnlockAstro_WB_C"))
class UUnlockAstro_WB_C__pf1579078439 : public UUserWidget
{
public:
	GENERATED_BODY()
	...
	UUnlockAstro_WB_C__pf1579078439(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_UnlockAstro_WB_0"))
	void bpf__ExecuteUbergraph_UnlockAstro_WB__pf_0(int32 bpp__EntryPoint__pf);
