#undef ONLINESUBSYSTEMSWITCH_API
#define IS_PROGRAM 0
#define UE_GAME 1
...
#define WITH_NEX_LIBRARY 0
#define ONLINESUBSYSTEMSWITCH_PACKAGE 1
#define WITH_APPLICATION_SERVER_ENVIRONMENT_KIT 0
